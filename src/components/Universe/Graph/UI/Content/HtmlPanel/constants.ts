export const defaultDimensions = [-70, -440, 320, 270] as [number, number, number, number]
...
export const withTranscriptDimensionsMobile = [0, 50, 320, 300] as [number, number, number, number]
