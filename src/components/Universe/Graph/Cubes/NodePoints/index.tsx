...
const _NodePoints = () => {
  ...
  const roundedRectGeometry = useMemo(() => {
    ...
    const radius = nodeSize / 2 // Full rounded on left side

    const shape = new Shape()

    // Start at top-left corner (beginning of rounded section)
    ...
    // Bottom-left rounded corner (half circle)
    shape.absarc(-width / 2 + radius, -height / 2, radius, Math.PI / 2, -Math.PI / 2, true)
