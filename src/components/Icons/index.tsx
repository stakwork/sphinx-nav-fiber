...
export const Icons: Record<string, React.FC<React.SVGProps<SVGSVGElement>>> = {
  ...
  BoostIcon: BoostIcon,
  BrowseGalleryIcon: BrowseGalleryIcon,
  ...
  CreateEdgeIcon: CreateEdgeIcon,
  DefaultShowIcon: DefaultShowIcon,
  DeleteIcon: DeleteIcon,
  DeleteNodeIcon: DeleteNodeIcon,
  ...
  FamilyHistoryIcon: FamilyHistoryIcon,
  ...
  SearchFilterCloseIcon: SearchFilterCloseIcon,
  SearchFilterIcon: SearchFilterIcon,
  SearchIcon: SearchIcon,
  SensorsIcon: SensorsIcon,
  SentimentDataIcon: SentimentDataIcon,
  SettingsIcon: SettingsIcon,
  ShieldPersonIcon: ShieldPersonIcon,
  SortFilterIcon: SortFilterIcon,
  SoundIcon: SoundIcon,
  SourcesIcon: SourcesIcon,
  SourcesTableIcon: SourcesTableIcon,
  StackIcon: StackIcon,
