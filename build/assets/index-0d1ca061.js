import{r as i,j as e,s as u,g as S,F as j,o as X,c as Y,A as oe,p as ie,i as ae,q as ce,H as le,t as pe,v as de}from"./index-ae8d4d7a.js";import{t as O,u as H,C as ue}from"./index-8795bc5d.js";import{U as fe}from"./index-3057dcee.js";import{u as T,a as me,b as ge,I as he,c as J,d as xe}from"./index-d46fb781.js";import{M as ye,V as be}from"./index-9cd9869a.js";import{S as we,R as je,s as V,M as ve}from"./index-dd085e90.js";import"./string-a277709d.js";import"./index-9d83e731.js";import"./three.module-976f5d36.js";import"./index-680adb28.js";import"./TextareaAutosize-765f525b.js";import"./CheckIcon-1b0c2daf.js";import"./index-9277026b.js";import"./index-660392bb.js";import"./ClipLoader-b34f00f1.js";import"./clsx-edcab316.js";import"./SourcesTableIcon-bb7dcf98.js";import"./DeleteNodeIcon-d446df95.js";import"./SoundIcon-90518f3e.js";import"./SucessFeedBackIcon-9e1d0ead.js";import"./Skeleton-64a17d42.js";import"./index-304e6f98.js";import"./Stack-7c3260d3.js";import"./FormControlLabel-00d8eaf5.js";import"./Typography-1561846e.js";import"./createSvgIcon-17a5ce50.js";import"./isPlainObject-8a0584d1.js";const K=i.memo(()=>{const r=T(n=>n.isPlaying),a=T(n=>n.setIsPlaying),s=T(n=>n.setVolume),t=T(n=>n.setPlaybackSpeed),c=T(n=>n.playbackSpeed),o=T(n=>n.playerRef),[d,g]=i.useState(!1),m=[.5,1,1.5,2],h=()=>{if(o){const n=o.getCurrentTime()-15;o.seekTo(n,"seconds")}},f=()=>{if(o){const n=o.getCurrentTime()+15;o.seekTo(n,"seconds")}},w=()=>{a(!r)},p=()=>{g(!d),s(d?1:0)},l=()=>{const x=(m.indexOf(c)+1)%m.length,P=m[x];if(t(P),o){const k=o.getInternalPlayer();k&&typeof k.playbackRate<"u"&&(k.playbackRate=P)}};return e.jsxs(Se,{children:[e.jsx(Pe,{onClick:p,children:d?e.jsx(ye,{}):e.jsx(be,{})}),e.jsx(Ce,{onClick:h,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(ke,{"data-testid":"play-pause-button",onClick:w,size:"small",children:r?e.jsx(me,{"data-testid":"pause-icon"}):e.jsx(ge,{"data-testid":"play-icon"})}),e.jsx(Ie,{onClick:f,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(_e,{onClick:l,children:[c,"x"]})]})});K.displayName="Controls";const Se=u(j).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${S.BG1};
  border-radius: 40px;
