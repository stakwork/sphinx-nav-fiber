import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-4b808054.js";import{B as M}from"./index-a890e1ee.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-b6b87b8c.js";import{B as f,T as L,a as R}from"./index-3c500b0b.js";import{T as x}from"./index-da02ad42.js";import"./useSlotProps-b300d459.js";import"./index.esm-2a83afce.js";import"./InfoIcon-9cda504a.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
