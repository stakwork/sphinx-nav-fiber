import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,C as B,h as c,r as v,x as C}from"./index-71ad60ec.js";import{B as F}from"./index-3d2f1be5.js";import{u as M}from"./index-07b04513.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-8ed8fc2c.js";import{B as f,T as L,a as R}from"./index-938c0cfc.js";import{T as x}from"./index-c8ba709b.js";import"./useSlotProps-4112a37d.js";import"./index.esm-6fcc3f86.js";import"./InfoIcon-83e27d87.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
