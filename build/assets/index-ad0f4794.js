...
`,nr=b.lazy(()=>De(()=>import("./index-f4c8243d.js"),["assets/index-f4c8243d.js","assets/index-4f62fa2e.js","assets/index-b4d03b7b.css","assets/index-aeb19dec.js","assets/SourcesTableIcon-629212fc.js","assets/index-c8dccbe5.js","assets/CheckIcon-252a916b.js","assets/DeleteNodeIcon-ee17f57e.js","assets/SoundIcon-d70b2622.js","assets/SucessFeedBackIcon-1139aebd.js","assets/ClipLoader-2fb2d658.js","assets/TableRow-36db867f.js"]).then(({TweetAnalyze:e})=>({default:e}))),ir=()=>{const e=$(p=>p.setSelectedTweet),t=$(p=>p.selectedTweet),{tweetId:a}=ge(),[r,n]=b.useState(""),{open:i}=Re("tweetAnalyze"),l=(a==null?void 0:a.split("&"))||[],o=p=>{i(),n(p)};return s.jsx(s.Fragment,{children:s.jsxs(sr,{align:"stretch",basis:"100%",grow:1,shrink:1,children:[l.length>1?s.jsx(ar,{onClick:()=>{o("summary")},children:"Summary Report"}):null,l.map(p=>s.jsx(or,{className:t===p?"selected":"",onClick:()=>e(p),children:s.jsx(Vt,{handleAnalyzeClick:()=>{o(p)},nodeId:p})},p)),s.jsx(nr,{tweetId:r})]})})},ar=h.button`
  width: 100%;
  background: ${y.ANALYTICS_CARD_BG};
  color: ${y.white};
  padding: 16px 16px;
