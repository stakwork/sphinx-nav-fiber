import{o as s,F as o,T as w,p as C,r as f,j as e,q as c,A as S,aU as A,aV as b,aW as M,M as z,Q as y}from"./index-3003e728.js";import{B as D}from"./index-6bfee7cd.js";import{G,B as v,i as $,F as B}from"./index-e65ab257.js";import{C as T}from"./ClipLoader-90da0e79.js";import{T as j}from"./index-e069fbac.js";import{S as E}from"./index-70d61866.js";import{e as I}from"./index.esm-589cd253.js";import{T as k,a as F}from"./Tabs-e6f1c1be.js";import"./InfoIcon-01d22915.js";import"./useSlotProps-5478ea9b.js";import"./createSvgIcon-fa8eae99.js";const R=({onClose:a})=>{const[l]=C(d=>[d.graphStyle]),[r,i]=f.useState(!1),p=()=>{i(!0),localStorage.setItem("graphStyle",l),i(!1),a()};return e.jsxs(W,{direction:"column",children:[e.jsx(V,{children:"Default graph view:"}),e.jsx(G,{}),e.jsx(o,{mt:308,py:24,children:e.jsx(v,{color:"secondary",disabled:r,id:"add-node-submit-cta",onClick:p,size:"large",startIcon:r&&e.jsx(L,{children:e.jsx(T,{color:c.lightGray,size:12})}),type:"submit",variant:"contained",children:"Save Changes"})})]})},W=s(o)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,V=s(w)`
...
`,xe=()=>{const{close:a}=y("settings"),{visible:l}=y("addItem");return l?null:e.jsx(D,{background:"BG1",id:"settings",noWrap:!0,onClose:a,preventOutsideClose:!0,children:e.jsx(K,{onClose:a})})};export{xe as SettingsModal};
