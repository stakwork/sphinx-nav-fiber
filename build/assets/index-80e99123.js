import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,C as B,h as c,r as v,x as C}from"./index-866a46a7.js";import{B as F}from"./index-e05c71f5.js";import{u as M}from"./index-4892040c.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-2d5928c7.js";import{B as f,T as L,a as R}from"./index-b1ff3b8c.js";import{T as x}from"./index-adfa34a6.js";import"./useSlotProps-a08d6673.js";import"./index.esm-f0a63ba0.js";import"./InfoIcon-ae59157b.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
