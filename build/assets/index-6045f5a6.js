import{aR as ji,r as z,f as C,h as y,i as de,j as s,l as ze,F as g,T as X,O as $t,k as ce,aS as ur,aT as Si,x as cr,o as vi,aU as Ei,P as Ti,a4 as fe,aV as dn,a2 as Ii,aW as fn,ad as Ai,aX as Pi,J as _i}from"./index-088295c2.js";import{k as zi,l as mt,A as we,B as ye,d as Li,I as pr,f as at,g as hr,m as ut,P as Ht,C as Vt,n as Bi,i as dr,b as Oi,S as Mi}from"./react-toastify.esm-65e13871.js";import{C as fr}from"./CheckIcon-157749d7.js";import{C as xr}from"./ChevronDownIcon-4eb18646.js";import{C as Ri}from"./ChevronUpIcon-40b2527f.js";import{F as mr,a as Di,T as Fi}from"./Popover-8e85d4db.js";import{G as gr,L as Ut,B as Gt,H as Ni,M as $i,R as Hi,a as Vi,S as Ui,b as Gi,N as yr,C as Yi,D as wr,c as kr,d as qi,f as Wi,g as br,e as Qi,P as Xi,h as Cr,s as xn,V as Zi,F as Ki,E as Ji,i as eo,j as to,k as jr,l as no}from"./ChevronRightIcon-15a49c03.js";import{S as ro}from"./index-25bcd73c.js";import{f as rt,o as Sr,P as vr,n as io,X as oo,Y as lo,T as so,D as ao,S as Yt,q as Er}from"./generateCategoricalChart-9e213cf4.js";import{T as We}from"./index-1b85ca28.js";import{S as uo}from"./Skeleton-472cdecd.js";import{f as co,c as po}from"./index.esm-8bda1089.js";import{I as ho,S as fo,O as xo}from"./Select-59ead68d.js";import{I as mo}from"./InfoIcon-18edb8cb.js";import{P as go}from"./PlusIcon-5beeff2e.js";import{u as Pt}from"./index-3918d71a.js";import{B as yo}from"./index-6e76736b.js";import"./useSlotProps-5f5901c0.js";import"./dividerClasses-ab1664f1.js";const wo=(e,t="down")=>{const n=ji(),[r,i]=z.useState(!1),o=n.breakpoints[t](e).split("@media")[1].trim();return z.useEffect(()=>{const l=()=>{const{matches:a}=window.matchMedia(o);i(a)};return l(),window.addEventListener("resize",l),()=>window.removeEventListener("resize",l)},[o]),r},ko=e=>e.filter(t=>t.tldr).length>=2&&e.some(t=>t.audio_EN);function bo(e){return e.tldr_topic??e.name}var it=globalThis&&globalThis.__assign||function(){return it=Object.assign||function(e){for(var t,n=1,r=arguments.length;n<r;n++){t=arguments[n];for(var i in t)Object.prototype.hasOwnProperty.call(t,i)&&(e[i]=t[i])}return e},it.apply(this,arguments)},Co=globalThis&&globalThis.__rest||function(e,t){var n={};for(var r in e)Object.prototype.hasOwnProperty.call(e,r)&&t.indexOf(r)<0&&(n[r]=e[r]);if(e!=null&&typeof Object.getOwnPropertySymbols=="function")for(var i=0,r=Object.getOwnPropertySymbols(e);i<r.length;i++)t.indexOf(r[i])<0&&Object.prototype.propertyIsEnumerable.call(e,r[i])&&(n[r[i]]=e[r[i]]);return n},jo=zi("BeatLoader","50% {transform: scale(0.75);opacity: 0.2} 100% {transform: scale(1);opacity: 1}","beat");function So(e){var t=e.loading,n=t===void 0?!0:t,r=e.color,i=r===void 0?"#000000":r,o=e.speedMultiplier,l=o===void 0?1:o,a=e.cssOverride,u=a===void 0?{}:a,c=e.size,p=c===void 0?15:c,d=e.margin,f=d===void 0?2:d,h=Co(e,["loading","color","speedMultiplier","cssOverride","size","margin"]),w=it({display:"inherit"},u),k=function(E){return{display:"inline-block",backgroundColor:i,width:mt(p),height:mt(p),margin:mt(f),borderRadius:"100%",animation:"".concat(jo," ").concat(.7/l,"s ").concat(E%2?"0s":"".concat(.35/l,"s")," infinite linear"),animationFillMode:"both"}};return n?z.createElement("span",it({style:w},h),z.createElement("span",{style:k(1)}),z.createElement("span",{style:k(2)}),z.createElement("span",{style:k(3)})):null}const vo=()=>{var d;const[e,t]=z.useState(null),{sidebarFilter:n,setSidebarFilter:r,sidebarFilterCounts:i}=de(f=>f),o=n==="undefined"?"Other":n,l=((d=i.find(f=>f.name===o))==null?void 0:d.count)||0,a=f=>f?f.charAt(0).toUpperCase()+f.slice(1):"",u=f=>{t(f.currentTarget)},c=()=>{t(null)},p=f=>{r(f),c()};return s.jsxs("div",{children:[s.jsxs(Eo,{onClick:u,children:[s.jsx("div",{className:"text",children:"Show"}),s.jsx("div",{className:"value","data-testid":"value",children:`${a(o)} (${l})`}),s.jsx("div",{className:"icon",children:e?s.jsx(Ri,{}):s.jsx(xr,{})})]}),s.jsx(Io,{anchorEl:e,anchorOrigin:{vertical:"bottom",horizontal:"left"},anchorPosition:{top:62,left:0},onClose:c,open:!!e,transformOrigin:{vertical:"top",horizontal:"left"},children:s.jsx(mr,{children:i.map(({name:f,count:h})=>s.jsxs(To,{className:ze({active:f===n}),onClick:()=>p(f),children:[s.jsx("span",{className:"icon",children:f===n?s.jsx(fr,{}):null}),s.jsx("span",{children:`${a(f)} (${h})`})]},f))})})]})},Eo=C(g).attrs({direction:"row",align:"center"})`
  cursor: pointer;
  flex-grow: 1;
  color: ${y.GRAY6};
  font-family: Barlow;
...
`,Tr=({boostCount:e,date:t,episodeTitle:n,isSelectedView:r=!1,imageUrl:i,showTitle:o,type:l,text:a,name:u,sourceLink:c,verified:p=!1,twitterHandle:d,className:f="episode-wrapper",onClick:h})=>{const w=l==="show"?o:n,k=l==="show"?"":o,E=["tweet","person","guest","topic","document"],b=l==="youtube"?"video":"audio";return l?s.jsx(Wo,{className:f,onClick:h,children:E.includes(l)?s.jsxs(s.Fragment,{children:[l==="topic"&&s.jsxs(Qo,{children:[s.jsx(Ni,{}),s.jsx("p",{children:k})]}),["person","guest"].includes(l)&&s.jsx(No,{imageUrl:i,name:u||"",title:o||""}),["image"].includes(l)&&s.jsx(Bo,{imageUrl:c,name:u||""}),l==="tweet"&&s.jsx(Vo,{date:t,imageUrl:i,name:u||"",text:a||"",twitterHandle:d,verified:p}),l==="document"&&s.jsx(Ro,{sourceLink:c||"",text:a||"",type:l})]}):s.jsxs(g,{align:"center",direction:"row",justify:"center",children:[!r&&s.jsx(g,{align:"center",pr:16,children:s.jsx(we,{size:80,src:i||`${b}_default.svg`,type:l||""})}),s.jsxs(g,{grow:1,shrink:1,children:[s.jsxs(g,{align:"center",direction:"row",justify:"space-between",children:[s.jsx(g,{align:"center",direction:"row",children:l&&s.jsx(We,{type:l})}),l==="youtube"&&c?s.jsx(Zo,{href:`${c}${c.includes("?")?"&":"?"}open=system`,onClick:S=>S.stopPropagation(),target:"_blank",children:s.jsx(Ut,{})}):null]}),u&&s.jsx(_t,{"data-testid":"episode-name",children:u}),s.jsx(_t,{"data-testid":"episode-description",children:w}),s.jsxs(g,{align:"center",direction:"row",justify:"flex-start",children:[!!t&&s.jsx(ct,{children:$t.unix(t).fromNow()}),!!k&&s.jsx(Xo,{children:k}),!r&&e>0&&s.jsx(g,{style:{marginLeft:"auto"},children:s.jsx(Gt,{amt:e})})]})]})]})}):null},_t=C(g)`
  font-family: Barlow;
  font-size: 13px;
  font-style: normal;
  font-weight: 400;
...
`,Zo=C.a`
  ...
  font-size: 16px;
  height: 16px;
`,Ko=({isSearchResult:e})=>{const t=z.useRef(null),n=e?80:10,{setSelectedNode:r,setSelectedTimestamp:i}=de(b=>b),{currentSearch:o,setSidebarOpen:l,setRelevanceSelected:a}=ce(b=>b),[u,c]=z.useState(0),p=ur(),f=u*n+n,h=p&&p.length>0?p.length-1>f:!1,w=wo("sm","down"),k=z.useCallback(b=>{Si(b),i(b),a(!0),r(b),w&&l(!1)},[r,a,l,i,w]),E=z.useMemo(()=>{if(p){const b=[...p].sort((S,I)=>(I.date||0)-(S.date||0));return o&&b.sort((S,I)=>{const O=S.node_type==="topic"&&S.name.toLowerCase()===o.toLowerCase()?1:0;return(I.node_type==="topic"&&I.name.toLowerCase()===o.toLowerCase()?1:0)-O}),b.slice(0,f)}return[]},[p,o,f]);return s.jsx(s.Fragment,{children:s.jsxs(Lo,{ref:t,id:"search-result-list",shrink:1,children:[(E??[]).map((b,S)=>{const{image_url:I,date:O,boost:L,type:v,episode_title:D,show_title:G,node_type:$,text:V,source_link:A,link:_,name:H,verified:q=!1,twitter_handle:F}=b||{};return s.jsx(Tr,{boostCount:L||0,date:O||0,episodeTitle:rt(D),imageUrl:I||"",link:_,name:H||"",onClick:()=>{k(b)},showTitle:rt(G),sourceLink:A,text:V||"",twitterHandle:F,type:$||v,verified:q},S.toString())}),s.jsx(el,{align:"center",background:"BG1",direction:"row",justify:"center",children:h&&s.jsx(ye,{onClick:()=>{h&&c(u+1)},size:"medium",children:"Load More"})})]})})},Jo=z.memo(Ko),el=C(g)`
  flex: 0 0 86px;
`,tl=({isSearchResult:e})=>{const{nodeCount:t,setNodeCount:n,setBudget:r}=cr(l=>l),{fetchData:i}=de(l=>l),o=async()=>{t<1||(await i(r,{skip_cache:"true"}),n("CLEAR"))};return s.jsxs(il,{children:[!e&&s.jsxs("div",{className:"heading-container",children:[s.jsxs("div",{className:"heading",children:[s.jsx("span",{className:"heading__title",children:"Latest"}),s.jsx("span",{className:"heading__icon",children:s.jsx(_o,{})})]}),t?s.jsx("div",{className:"button_container",children:s.jsx(nl,{className:"button",onClick:o,startIcon:s.jsx(zo,{}),children:`See Latest (${t})`})}):null]}),s.jsx(Jo,{isSearchResult:e})]})},nl=C(ye)`
  && {
    width: 100%;
    margin-top: 1.2rem;
    font-weight: 500;
...
`;const al=48,ul=8,cl={PaperProps:{style:{maxHeight:al*4.5+ul,width:250}}},pl=["Beginner","Intermediate","Advanced","Expert"],hl=()=>{const e=de(S=>S.data),[t,n]=z.useState(""),[r,i]=z.useState("Beginner"),o=ce(S=>S.currentSearch),l=Li(),[a]=cr(S=>[S.setBudget]),[u,c,p,d,f]=Sr(S=>[S.askedQuestions,S.askedQuestionsAnswers,S.setAskedQuestion,S.setAskedQuestionAnswer,S.hasQuestionInProgress]),h=z.useCallback(S=>{d(S.answer)},[d]);z.useEffect(()=>{l&&h&&l.on("askquestionhook",h)},[h,l]);const w=async()=>{t&&(p(t),n(""));try{const S=e==null?void 0:e.nodes.filter(L=>L.text),I=S==null?void 0:S.slice(0,5),O=(I!=null&&I.length?I.map(L=>L.text).join(" "):"").substring(0,2500).replace(/[?&=+/#]/g,L=>`\\${L}`);o&&(await vi.enable(),await Ei({expertise_level:r,question_text:t,search_term:o,transcripts:O},a),await Ti(a))}catch(S){console.error(S)}},k=r&&t.trim()&&!f,E=S=>{i(S.target.value)},b=async S=>{if(f){S.preventDefault();return}S.keyCode===13&&S.shiftKey===!1&&k&&(S.preventDefault(),w())};return s.jsxs(dl,{children:[s.jsx(g,{children:s.jsx(g,{children:s.jsxs(mr,{component:"div",children:[s.jsx(xl,{id:"select-label",size:"small",children:"Expertise level"}),s.jsx(ml,{id:"demo-multiple-name",input:s.jsx(xo,{label:"Expertise level"}),labelId:"select-label",MenuProps:cl,onChange:E,size:"small",value:r,children:pl.map(S=>s.jsx($i,{component:"li",value:S,children:S},S))})]})})}),s.jsx(wl,{children:u==null?void 0:u.map((S,I)=>s.jsxs(g,{className:"response",py:12,children:[s.jsx(X,{kind:"medium",children:S}),s.jsx(g,{py:12,children:(c==null?void 0:c[I])!==void 0?s.jsx(X,{color:"unreadMsgText",children:c[I]}):s.jsxs(g,{align:"center",py:12,children:[s.jsx(g,{align:"center",py:12,children:s.jsx(vr,{color:y.white})}),s.jsx(g,{align:"center",py:12,children:s.jsx(X,{children:"Generating response"})})]})})]},S))}),s.jsxs(gl,{onKeyDown:b,py:12,tabIndex:-1,children:[s.jsx(fl,{disabled:f,onChange:S=>n(S.target.value),placeholder:"Enter your question",value:t}),s.jsx(yl,{children:s.jsx(co,{color:k?y.white:y.gray300,size:"18"})})]})]})},dl=C.div`
  margin-top: 20px;
`,fl=C(Fi)`
...
`,mn=({text:e})=>s.jsxs(g,{align:"center",justify:"center",py:12,children:[s.jsx(g,{align:"center",py:12,children:s.jsx(vr,{color:y.white})}),s.jsx(g,{align:"center",py:12,children:s.jsx(X,{children:e})})]}),kl=()=>{const[e,t,n,r]=Sr(o=>[o.teachMeAnswer,o.hasTeachingInProgress,o.instgraphAnswser,o.hasInstagraphInProgress]),i=!r&&!!(n!=null&&n.edges)&&!!(n!=null&&n.nodes);return s.jsxs(s.Fragment,{children:[i?s.jsx(Hi,{edges:n==null?void 0:n.edges,nodes:n==null?void 0:n.nodes}):s.jsx(mn,{text:"Generating instagraph"}),t?s.jsx(mn,{text:"Generating tutorial"}):s.jsxs(s.Fragment,{children:[s.jsx(bl,{children:s.jsx(X,{children:e})}),s.jsx(hl,{})]})]})};C(ye)``;const bl=C(g)`
  padding-left: 10px;
  padding-right: 10px;
...
`,Pl=({stateless:e,node:t})=>{var w;const[n,r]=ce(k=>[k.transcriptIsOpen,k.setTranscriptOpen]),[i,o]=z.useState(!1),[l,a]=z.useState(""),[u,c]=z.useState(!1);if(!e&&!n)return null;const p=async()=>{try{const k=await dn(t==null?void 0:t.ref_id);a(k.data.text)}catch(k){console.error("Error fetching full transcript",k)}},d=async()=>{if(l===""){const k=await dn(t==null?void 0:t.ref_id);h(k.data.text)}else h(l);setTimeout(()=>{o(!1)},2e3)},f=async()=>{u?c(!1):(await p(),c(!0))},h=k=>{k!==void 0&&(navigator.clipboard.writeText(k),o(!0))};return s.jsxs(g,{grow:1,shrink:1,children:[s.jsxs(zl,{children:[e&&s.jsxs(_l,{children:[s.jsx("div",{className:"icon",children:s.jsx(yr,{})}),s.jsx("div",{className:"title",children:"Transcript"})]}),t!=null&&t.text?s.jsx(s.Fragment,{children:i?s.jsxs(Ol,{align:"center",direction:"row",justify:"flex-start",children:[s.jsx("div",{className:"icon",children:s.jsx(fr,{})}),s.jsx("div",{className:"text",children:"Copied"})]}):s.jsx(ye,{endIcon:s.jsx(Yi,{}),onPointerDown:()=>d(),size:"small",variant:"outlined",children:"Copy"})}):s.jsx("div",{}),!e&&s.jsx(Ll,{onClick:()=>{r(!1)},children:s.jsx(po,{fontSize:35})})]}),s.jsxs(Bl,{children:[u?l:`${(w=t==null?void 0:t.text)==null?void 0:w.substring(0,100)}`,s.jsxs(Al,{onClick:f,children:["... ",u?"show less":"more"]})]})]})},_l=C(g).attrs({direction:"row",align:"center"})`
  .icon {
    font-size: 16px;
    color: ${y.GRAY3};
    margin-right: 7px;
...
`,Ir=({node:e})=>{const t=de(k=>k.selectedNode),n=ce(k=>k.currentSearch),{link:r,image_url:i,date:o,boost:l,node_type:a,type:u,id:c,show_title:p,episode_title:d,ref_id:f}=e||t||{},[h,w]=z.useState(l||0);return!e&&!t?null:s.jsx("div",{style:{overflow:"auto",flex:1,width:"100%"},children:s.jsxs(Ml,{children:[s.jsx(Dl,{boostCount:h||0,date:o||0,episodeTitle:rt(d),imageUrl:i,isSelectedView:!0,link:r,onClick:()=>null,showTitle:p,type:a||u}),s.jsx(yt,{}),s.jsxs(Rl,{children:[s.jsx(Gt,{amt:h}),s.jsx(kr,{content:e||t,count:h,refId:f,updateCount:w})]}),s.jsx(yt,{}),s.jsx(gn,{children:s.jsx(El,{node:e||t,searchTerm:n,stateless:!0})}),((t==null?void 0:t.text)||(e==null?void 0:e.text))&&s.jsxs(s.Fragment,{children:[s.jsx(yt,{}),s.jsx(gn,{children:s.jsx(Pl,{node:e||t,stateless:!0},c)})]})]})})},Ml=C(g)`
  flex: 1;
  min-height: 100%;
  flex-direction: column;
...
`,Ms=C.audio`
  height: 0;
  width: 0;
`,Rs=["clip","twitter_space","youtube","episode","podcast"],Ds=()=>{const e=fe(),{showTeachMe:t}=de(r=>r),{setPlayingNode:n}=at(r=>r);if(z.useEffect(()=>{Rs.includes((e==null?void 0:e.node_type)||"")&&n(e)},[n,e]),t)return s.jsx(kl,{});switch(e==null?void 0:e.node_type){case"guest":case"person":return s.jsx(ds,{});case"data_series":return s.jsx(jl,{});case"tribe_message":return s.jsx(us,{});case"tweet":return s.jsx(Cs,{});case"topic":return s.jsx(bs,{});case"show":return s.jsx(ks,{});case"youtube":case"podcast":case"clip":case"twitter_space":return s.jsx(Ir,{});case"document":return s.jsx(_s,{});case"episode":return s.jsx(is,{},e.ref_id);case"image":return s.jsx(as,{});default:return s.jsx(As,{})}},Fs=z.memo(Ds),Ns=({isPlaying:e,isFullScreen:t,setIsPlaying:n,playingTime:r,duration:i,handleProgressChange:o,handleVolumeChange:l,onFullScreenClick:a,showToolbar:u})=>s.jsxs(g,{children:[!u&&s.jsx(Gs,{"aria-label":"Small",max:i,onChange:o,size:"small",value:r}),s.jsxs($s,{align:"center",direction:"row",showToolbar:u,children:[s.jsx(Hs,{onClick:n,size:"small",children:e?s.jsx(ut,{}):s.jsx(Ht,{})}),s.jsxs(Ys,{direction:"row",children:[s.jsx("span",{children:xn(r)}),s.jsx("span",{className:"separator",children:"/"}),s.jsx("span",{className:"duration",children:xn(i)})]}),s.jsxs(Vs,{direction:"row",px:9,children:[s.jsx(Cr,{className:"volume-slider",defaultValue:.5,max:1,min:0,onChange:l,size:"small",step:.1}),s.jsx(Zi,{})]}),s.jsx(Us,{onClick:()=>a(),children:t?s.jsx(Ji,{}):s.jsx(Ki,{})})]})]}),$s=C(g)`
  height: 60px;
  padding: 12px 16px;
  ${e=>e.showToolbar&&`
    position: fixed;
...
`,qs=({hidden:e})=>{const t=z.useRef(null),n=z.useRef(null),[r,i]=z.useState(!1),[o,l]=z.useState(!1),[a,u]=z.useState(!1),[c,p]=z.useState("ready"),{isPlaying:d,playingTime:f,duration:h,setIsPlaying:w,setPlayingTime:k,setDuration:E,playingNode:b,volume:S,setVolume:I,setHasError:O,resetPlayer:L,isSeeking:v,setIsSeeking:D}=at(K=>K);z.useEffect(()=>()=>L(),[L]),z.useEffect(()=>{v&&t.current&&(t.current.seekTo(f,"seconds"),D(!1))},[f,v,D]);const G=()=>{w(!d)},$=()=>{w(!0)},V=()=>{w(!1)},A=(K,x)=>{const te=Array.isArray(x)?x[0]:x;t.current&&(t.current.seekTo(te),k(te))},_=(K,x)=>{const te=Array.isArray(x)?x[0]:x;I(te)},H=()=>{O(!0),p("error")},q=K=>{if(!v){const x=K.playedSeconds;k(x)}},F=()=>{if(t.current){p("ready");const K=t.current.getDuration();E(K)}},ee=()=>{n.current&&(document.fullscreenElement?(document.exitFullscreen(),l(!1)):n.current.requestFullscreen().then(()=>{document.addEventListener("fullscreenchange",Z)}))},Z=()=>{l(!!document.fullscreenElement),document.removeEventListener("fullscreenchange",Z)};z.useEffect(()=>()=>{document.removeEventListener("fullscreenchange",Z)}),z.useEffect(()=>{const K=x=>{if(o){const te=window.screen.height,me=x.clientY,m=te-me;u(m<=50)}};return document.addEventListener("mousemove",K),()=>{document.removeEventListener("mousemove",K)}},[o,a]),z.useEffect(()=>{const K=x=>{o&&x.key==="Escape"?(x.preventDefault(),x.stopPropagation()):r&&x.key===" "&&(x.preventDefault(),G())};return document.addEventListener("fullscreenchange",Z),document.addEventListener("keydown",K),()=>{document.removeEventListener("fullscreenchange",Z),document.removeEventListener("keydown",K)}});const le=()=>{G()};return b!=null&&b.link?s.jsxs(Ws,{ref:n,hidden:e,onBlur:()=>i(!1),onFocus:()=>i(!0),tabIndex:0,children:[s.jsx(Qs,{children:s.jsx(we,{size:120,src:(b==null?void 0:b.image_url)||"",type:"clip"})}),s.jsx(Ks,{onClick:le,children:s.jsx(eo,{ref:t,controls:!1,height:o?window.screen.height:"200px",onBuffer:()=>p("buffering"),onBufferEnd:()=>p("ready"),onError:H,onPause:V,onPlay:$,onProgress:q,onReady:F,playing:d,url:(b==null?void 0:b.link)||"",volume:S,width:"100%"})}),c==="error"?s.jsx(Zs,{className:"error-wrapper",children:"Error happened, please try later"}):null,c==="ready"?s.jsx(Ns,{duration:h,handleProgressChange:A,handleVolumeChange:_,isFullScreen:o,isPlaying:d,onFullScreenClick:ee,playingTime:f,setIsPlaying:G,showToolbar:a&&o}):null,c==="buffering"?s.jsx(Xs,{children:s.jsx(Vt,{color:y.lightGray})}):null]}):null},Ws=C(g)`
...
`,Vh=C(g)`
  ...
  gap: 10px;
`,Uh=["Drivechain","Ordinals","L402","Nostr","AI"],Gh=({onSubmit:e})=>{var V;const{open:t}=Pt("addContent"),[n,r]=z.useState(!1),[i,o]=z.useState(!1),[l,a]=z.useState(null),u=z.useRef(null),[c,p]=z.useState(0),[d,f]=z.useState(!1),{currentPlayingAudio:h,setCurrentPlayingAudio:w}=ce(A=>A),{open:k}=Pt("briefDescription"),{trendingTopics:E,setTrendingTopics:b}=de(A=>A),{setValue:S}=dr(),I=z.useCallback(async()=>{r(!0),o(!1),p(0),f(!1),w(null);try{const A=await Pi();A.length&&Array.isArray(A)&&b(A)}catch{b(Uh.map(_=>({name:_,count:0})))}finally{r(!1)}},[w,b]);z.useEffect(()=>{E.length||I()},[I,E.length]),z.useEffect(()=>{const A=setTimeout(()=>{o(!0)},5e3);return()=>clearTimeout(A)},[o,n]);const O=A=>{S("search",A),e==null||e()},L=(A,_)=>{A.stopPropagation(),A.currentTarget.blur(),_!=null&&_.tldr&&(a(_),k())},v=()=>{a(null)},D=A=>{A.stopPropagation(),A.currentTarget.blur(),f(!d),w(u)};z.useEffect(()=>{var A,_;d?(A=u.current)==null||A.play():(_=u.current)==null||_.pause()},[c,d]),z.useEffect(()=>{h||f(!1)},[h]);const G=()=>{p(A=>{var H,q;let _=(A+1)%E.length;for(;_!==A&&!((H=E[_])!=null&&H.audio_EN);)_=(_+1)%E.length;return _===A?(f(!1),_):((q=u.current)==null||q.load(),_===0&&(f(!1),p(0)),_)}),w(u)},$=n?"Loading":"No new trending topics in the last 24 hours";return s.jsxs(qh,{"data-testid":"trending-component",children:[s.jsxs("div",{children:[s.jsxs("div",{className:"heading-container",children:[s.jsxs("div",{className:"heading",children:[s.jsx("span",{className:"heading__title",children:"Trending Topics"}),s.jsx("span",{className:"heading__icon",children:n?s.jsx(Vt,{color:y.white,size:16}):s.jsx(s.Fragment,{children:i?s.jsx(Qh,{onClick:I,size:"small",startIcon:s.jsx(aa,{})}):s.jsx(ua,{})})})]}),ko(E)?s.jsxs("div",{children:[s.jsx(ye,{onClick:A=>D(A),startIcon:d?s.jsx(ut,{}):s.jsx(Ht,{}),children:d?"Pause":"Play All"}),s.jsx(Kh,{ref:u,onEnded:G,src:(V=E[c])==null?void 0:V.audio_EN,children:s.jsx("track",{kind:"captions"})})]}):null]}),E.length===0?s.jsxs("div",{className:"trending-empty",children:[s.jsx(Wh,{children:$}),s.jsx(ye,{color:"secondary",disabled:n,onClick:t,size:"medium",startIcon:s.jsx(go,{}),sx:{alignSelf:"flex-end",m:"0 36px 16px 0"},variant:"contained",children:"Add Content"})]}):s.jsx("ul",{className:"list",children:E.map((A,_)=>s.jsxs(g,{align:"center",className:"list-item",direction:"row",justify:"space-between",onClick:()=>O(A.name),children:[s.jsxs(Yh,{children:[s.jsx(Zh,{children:s.jsx(sa,{})}),s.jsx("span",{className:"tldr",children:bo(A)})]}),A.tldr&&s.jsx(Xh,{className:ze({isPlaying:c===_}),onClick:H=>L(H,A),children:"TLDR"})]},A.name))})]}),l&&s.jsx(Dh,{onClose:v,selectTrending:O,trend:l})]})},Yh=C.div`
  display: flex;
  align-items: center;
  width: 300px;
