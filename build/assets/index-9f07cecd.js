import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-86cbb277.js";import{B as F}from"./index-27a09eea.js";import{u as M}from"./index-b2f9393a.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-23f4bc38.js";import{B as f,T as R,a as L}from"./index-19ab59b6.js";import{T as x}from"./index-4b7d5307.js";import"./useSlotProps-5fc6fc55.js";import"./index.esm-4ee8207e.js";import"./InfoIcon-5ac259ba.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
