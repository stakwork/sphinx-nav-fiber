import{r as o,j as e,s as f,g as v,F as j,o as Y,c as J,A as ae,p as ie,i as ce,q as le,H as pe,t as de,v as ue}from"./index-d7e51bed.js";import{t as U,u as G,C as me}from"./index-a98bb1c8.js";import{U as fe}from"./index-04b69a4c.js";import{u as M,a as he,b as ge,I as xe,c as K,d as ye}from"./index-ab61dac3.js";import{M as we,V as be}from"./index-6dbe525d.js";import{S as je,R as ve,s as V,M as Se}from"./index-86dbc942.js";import"./string-a277709d.js";import"./index-52550f52.js";import"./three.module-9722a9fc.js";import"./isPlainObject-70892bc6.js";import"./TextareaAutosize-b25655b5.js";import"./CheckIcon-55d5e3f4.js";import"./index-927c4d38.js";import"./index-461d4c42.js";import"./index-8980e5b4.js";import"./ClipLoader-81a03b2a.js";import"./clsx-bf87f8e9.js";import"./SourcesTableIcon-b2b16a20.js";import"./DeleteNodeIcon-d7905546.js";import"./SoundIcon-d4dbeaa3.js";import"./SucessFeedBackIcon-0a9d6e2f.js";import"./Skeleton-d982aa8f.js";import"./index-d2af4314.js";import"./Stack-e12604a9.js";import"./FormControlLabel-0af3efff.js";import"./Typography-6a6608dd.js";import"./createSvgIcon-2e9bea4b.js";const Q=o.memo(()=>{const r=M(s=>s.isPlaying),a=M(s=>s.setIsPlaying),n=M(s=>s.setVolume),t=M(s=>s.setPlaybackSpeed),c=M(s=>s.playbackSpeed),i=M(s=>s.playerRef),[d,g]=o.useState(!1),y=[.5,1,1.5,2],h=()=>{if(i){const s=i.getCurrentTime()-15;i.seekTo(s,"seconds")}},u=()=>{if(i){const s=i.getCurrentTime()+15;i.seekTo(s,"seconds")}},b=()=>{a(!r)},l=()=>{g(!d),n(d?1:0)},p=()=>{const m=(y.indexOf(c)+1)%y.length,P=y[m];if(t(P),i){const _=i.getInternalPlayer();_&&typeof _.playbackRate<"u"&&(_.playbackRate=P)}};return e.jsxs(ke,{children:[e.jsx(_e,{onClick:l,children:d?e.jsx(we,{}):e.jsx(be,{})}),e.jsx(Ie,{onClick:h,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(Ce,{"data-testid":"play-pause-button",onClick:b,size:"small",children:r?e.jsx(he,{"data-testid":"pause-icon"}):e.jsx(ge,{"data-testid":"play-icon"})}),e.jsx(Pe,{onClick:u,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(Te,{onClick:p,children:[c,"x"]})]})});Q.displayName="Controls";const ke=f(j).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${v.BG1};
  border-radius: 40px;
