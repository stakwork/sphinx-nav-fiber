import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-986d962a.js";import{B}from"./index-c3b56469.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-92e86b41.js";import{B as f,T as $,a as k}from"./index-b18db625.js";import{T as u}from"./index-5c585d1d.js";import"./useSlotProps-491486b1.js";import"./index.esm-417c9ec0.js";import"./InfoIcon-ec8ed478.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
