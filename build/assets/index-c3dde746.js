import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-0dae50cb.js";import{B}from"./index-19df1d2f.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-c21829f7.js";import{B as f,T as $,a as k}from"./index-8fe98bb1.js";import{T as u}from"./index-aeeaf39a.js";import"./useSlotProps-51a32987.js";import"./index.esm-f2ec62ae.js";import"./InfoIcon-97243c86.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
