import{s as r,F as n,T as g,j as e,B as b,b as w,c as p,r as A,u as B}from"./index-a86e8971.js";import{B as v}from"./index-d8e76964.js";import{u as F}from"./index-d3885f89.js";import{u as M,l as $,b as f,q as C,F as D}from"./react-toastify.esm-a6c446c9.js";import{G}from"./index-59bc6038.js";import{T as x}from"./index-be89188e.js";import{C as k}from"./ClipLoader-0c6875fc.js";import{T as R,a as L}from"./Tabs-2ce8db3f.js";import"./index.esm-0e15041a.js";import"./InfoIcon-172362a7.js";import"./useSlotProps-0cc052d5.js";const P=({onClose:s})=>{const[a]=M(t=>[t.graphStyle]),i=()=>{localStorage.setItem("graphStyle",a),s()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(G,{}),e.jsx(n,{mt:308,children:e.jsx(b,{kind:"big",onClick:i,children:"Save changes"})})]})},V=r(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=r(g)`
