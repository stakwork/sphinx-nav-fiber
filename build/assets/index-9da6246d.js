import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-8315a78a.js";import{B as M}from"./index-36081304.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-c9bf8e06.js";import{B as f,T as L,a as R}from"./index-44cb4abb.js";import{T as x}from"./index-6f2dd91b.js";import"./useSlotProps-1af0a721.js";import"./index.esm-dcb6642f.js";import"./InfoIcon-0099963d.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
