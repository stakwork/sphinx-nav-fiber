import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-52024500.js";import{B as F}from"./index-cc66ee43.js";import{u as M}from"./index-2e55df55.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-739c0953.js";import{B as f,T as R,a as L}from"./index-264ef308.js";import{T as x}from"./index-e83f96cb.js";import"./useSlotProps-62fc3877.js";import"./index.esm-63ae20b6.js";import"./InfoIcon-3a6553a6.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
