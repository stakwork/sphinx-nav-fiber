import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-769d9852.js";import{B as F}from"./index-53820041.js";import{u as M}from"./index-24be33dd.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-6379dc0c.js";import{B as f,T as R,a as L}from"./index-8a3051c0.js";import{T as x}from"./index-87285af1.js";import"./useSlotProps-88e99761.js";import"./index.esm-22585c24.js";import"./InfoIcon-e424ef9e.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
