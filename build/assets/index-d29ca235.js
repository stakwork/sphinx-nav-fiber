import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-f5e44975.js";import{B as F}from"./index-b6d9cb2b.js";import{u as M}from"./index-210aa713.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-d23a87b7.js";import{B as f,T as R,a as L}from"./index-9f3d8d1a.js";import{T as x}from"./index-056388eb.js";import"./useSlotProps-81537b78.js";import"./index.esm-d3f71e65.js";import"./InfoIcon-874d377f.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
