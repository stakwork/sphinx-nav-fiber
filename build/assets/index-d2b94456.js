import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-4c0a1bb6.js";import{B as M}from"./index-608e37ff.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-4488f51d.js";import{B as f,T as L,a as R}from"./index-1142a538.js";import{T as x}from"./index-3d75b19c.js";import"./useSlotProps-81e9f64a.js";import"./index.esm-0c1f390f.js";import"./InfoIcon-0a1adb78.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
