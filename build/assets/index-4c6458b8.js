import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-92af3bc9.js";import{B as M}from"./index-71893029.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-872ff3c6.js";import{B as f,T as L,a as R}from"./index-30a757a8.js";import{T as x}from"./index-96c1dc06.js";import"./useSlotProps-6469fad0.js";import"./index.esm-51d19451.js";import"./InfoIcon-1816ee08.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
