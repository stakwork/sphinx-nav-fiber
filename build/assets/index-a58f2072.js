import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,x as D,B as F}from"./index-00c8de1c.js";import{B as M}from"./index-546477a8.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-1974ae2a.js";import{B as f,T as L,a as R}from"./index-aaf85693.js";import{T as x}from"./index-762f880d.js";import"./useSlotProps-bb3c3a09.js";import"./index.esm-d29a00f0.js";import"./InfoIcon-5f6968ca.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
