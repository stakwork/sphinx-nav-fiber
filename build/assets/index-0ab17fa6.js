import{s as c,a as t,F as i,j as e,a1 as j,r as l,u as C,B as w,bu as S,bw as R,aZ as D}from"./index-df66d2e5.js";import{g as I,e as T}from"./index-4fd7a16d.js";import{D as z}from"./DeleteNodeIcon-2f051464.js";import{S as E}from"./Skeleton-cbd8037e.js";import{C as L}from"./ClipLoader-6fb4fa6e.js";const M=({nodeName:p})=>e.jsx(i,{children:e.jsxs(i,{align:"center",direction:"column",justify:"space-between",children:[e.jsx(G,{children:e.jsx(z,{})}),e.jsxs(A,{children:["Are you sure you want to delete ",p||"this item","?"]})]})}),A=c(i)`
  color: ${t.white};
  font-family: 'Barlow';
  font-size: 20px;
  font-weight: 400;
