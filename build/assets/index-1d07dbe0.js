import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-6b8035a0.js";import{B as F}from"./index-20c51ea9.js";import{u as M}from"./index-dacc80d1.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-f4357339.js";import{B as f,T as R,a as L}from"./index-46d769de.js";import{T as x}from"./index-82a06da1.js";import"./useSlotProps-9149ef2d.js";import"./index.esm-d53e501d.js";import"./InfoIcon-c4102d48.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
