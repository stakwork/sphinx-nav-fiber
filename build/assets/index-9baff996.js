import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-d97e3632.js";import{B as F}from"./index-70d11934.js";import{u as M}from"./index-ccce1699.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-6591ac2c.js";import{B as f,T as R,a as L}from"./index-86ae2f66.js";import{T as x}from"./index-2f32162a.js";import"./useSlotProps-1f5024ba.js";import"./index.esm-ffc5e7c4.js";import"./InfoIcon-0266e6ff.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
