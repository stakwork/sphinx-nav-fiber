import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-7b36ec6a.js";import{B}from"./index-79b780a4.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-df410821.js";import{B as f,T as $,a as k}from"./index-75c4da1f.js";import{T as u}from"./index-7460f01a.js";import"./useSlotProps-84a66985.js";import"./index.esm-8348f3bd.js";import"./InfoIcon-09093f00.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
