import{s as r,F as n,T as g,j as e,h as w,b as c,r as A,g as B}from"./index-bcbf5606.js";import{B as v}from"./index-d95d1049.js";import{u as F}from"./index-2f98aaff.js";import{e as M,X as $,t as C,h as b,z as D,F as k,C as G}from"./react-toastify.esm-81c3fcd2.js";import{B as f,T as R,a as z}from"./index-ec881bee.js";import{T as x}from"./index-b6a6821a.js";import"./useSlotProps-9c0cd127.js";import"./index.esm-3df96c8c.js";import"./InfoIcon-4cb8ba78.js";const L=({onClose:s})=>{const[a]=M(t=>[t.graphStyle]),i=()=>{localStorage.setItem("graphStyle",a),s()};return e.jsxs(P,{direction:"column",children:[e.jsx(V,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:i,children:"Save changes"})})]})},P=r(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,V=r(g)`
