import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-8eaaaa30.js";import{B as M}from"./index-4e659267.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-03854d94.js";import{B as f,T as L,a as R}from"./index-fc23be6b.js";import{T as x}from"./index-e3822413.js";import"./useSlotProps-12a2271d.js";import"./index.esm-04287cd8.js";import"./InfoIcon-d0168ac7.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
