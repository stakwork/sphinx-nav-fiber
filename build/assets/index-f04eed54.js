import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-758a440b.js";import{B}from"./index-f6dd1ae3.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-47dc5d84.js";import{B as f,T as $,a as k}from"./index-04476a1d.js";import{T as u}from"./index-56df5078.js";import"./useSlotProps-15a3c690.js";import"./index.esm-9b32ee46.js";import"./InfoIcon-80b8d650.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
