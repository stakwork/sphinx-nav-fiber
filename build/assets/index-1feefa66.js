import{aM as Ci,r as A,f as b,h as w,i as fe,j as s,l as Ie,F as y,T as J,U as Ht,k as pe,aN as pr,aO as Si,x as hr,o as vi,V as Ei,a5 as xe,aP as xn,a3 as Ti,N as Ii,aQ as mn,ae as _i,B as At,J as Ai}from"./index-1bb978d6.js";import{l as Pi,m as mt,A as ke,B as we,d as zi,I as dr,f as at,g as Pt,n as ut,P as Vt,C as Ut,o as Li,i as fr,b as Bi,S as Mi}from"./react-toastify.esm-3e43abdf.js";import{C as xr}from"./CheckIcon-173f242c.js";import{C as mr}from"./ChevronDownIcon-cf7f00a2.js";import{C as Oi}from"./ChevronUpIcon-fee671ec.js";import{F as gr,a as Ri,T as Di}from"./Popover-81c9f521.js";import{G as yr,L as Gt,B as qt,H as Fi,M as Ni,p as $i,R as Hi,a as Vi,S as Ui,b as Gi,N as wr,C as qi,D as Yt,c as kr,d as Yi,f as Wi,g as br,e as Qi,P as Zi,h as jr,s as gn,V as Xi,F as Ki,E as Ji,i as eo,j as to,k as Cr,l as no}from"./ChevronRightIcon-38d7dadd.js";import{S as ro}from"./index-28c073bb.js";import{f as rt,o as Sr,P as vr,n as io,X as oo,Y as lo,T as so,D as ao,S as Wt,q as Er}from"./generateCategoricalChart-119af277.js";import{T as Ne,I as uo,S as co,O as po}from"./index-45ca60d3.js";import{S as ho}from"./Skeleton-bc20a247.js";import{f as fo,c as xo,g as mo,h as go}from"./index.esm-f645554c.js";import{I as yo}from"./InfoIcon-e7edbefb.js";import{P as wo}from"./PlusIcon-f1c5d055.js";import{B as ko}from"./index-c9feb6ef.js";import"./useSlotProps-248dd320.js";const bo=(e,t="down")=>{const n=Ci(),[r,i]=A.useState(!1),o=n.breakpoints[t](e).split("@media")[1].trim();return A.useEffect(()=>{const l=()=>{const{matches:a}=window.matchMedia(o);i(a)};return l(),window.addEventListener("resize",l),()=>window.removeEventListener("resize",l)},[o]),r},jo=e=>e.filter(t=>t.tldr).length>=2&&e.some(t=>t.audio_EN);function Co(e){return e.tldr_topic??e.name}var it=globalThis&&globalThis.__assign||function(){return it=Object.assign||function(e){for(var t,n=1,r=arguments.length;n<r;n++){t=arguments[n];for(var i in t)Object.prototype.hasOwnProperty.call(t,i)&&(e[i]=t[i])}return e},it.apply(this,arguments)},So=globalThis&&globalThis.__rest||function(e,t){var n={};for(var r in e)Object.prototype.hasOwnProperty.call(e,r)&&t.indexOf(r)<0&&(n[r]=e[r]);if(e!=null&&typeof Object.getOwnPropertySymbols=="function")for(var i=0,r=Object.getOwnPropertySymbols(e);i<r.length;i++)t.indexOf(r[i])<0&&Object.prototype.propertyIsEnumerable.call(e,r[i])&&(n[r[i]]=e[r[i]]);return n},vo=Pi("BeatLoader","50% {transform: scale(0.75);opacity: 0.2} 100% {transform: scale(1);opacity: 1}","beat");function Eo(e){var t=e.loading,n=t===void 0?!0:t,r=e.color,i=r===void 0?"#000000":r,o=e.speedMultiplier,l=o===void 0?1:o,a=e.cssOverride,c=a===void 0?{}:a,u=e.size,p=u===void 0?15:u,h=e.margin,f=h===void 0?2:h,d=So(e,["loading","color","speedMultiplier","cssOverride","size","margin"]),g=it({display:"inherit"},c),k=function(T){return{display:"inline-block",backgroundColor:i,width:mt(p),height:mt(p),margin:mt(f),borderRadius:"100%",animation:"".concat(vo," ").concat(.7/l,"s ").concat(T%2?"0s":"".concat(.35/l,"s")," infinite linear"),animationFillMode:"both"}};return n?A.createElement("span",it({style:g},d),A.createElement("span",{style:k(1)}),A.createElement("span",{style:k(2)}),A.createElement("span",{style:k(3)})):null}const To=()=>{var h;const[e,t]=A.useState(null),{sidebarFilter:n,setSidebarFilter:r,sidebarFilterCounts:i}=fe(f=>f),o=n==="undefined"?"":n.toLowerCase(),l=((h=i.find(f=>f.name===o))==null?void 0:h.count)||0,a=f=>f?f.charAt(0).toUpperCase()+f.slice(1):"",c=f=>{t(f.currentTarget)},u=()=>{t(null)},p=f=>{r(f),u()};return s.jsxs("div",{children:[s.jsxs(Io,{onClick:c,children:[s.jsx("div",{className:"text",children:"Show"}),s.jsx("div",{className:"value","data-testid":"value",children:`${a(o)} (${l})`}),s.jsx("div",{className:"icon",children:e?s.jsx(Oi,{}):s.jsx(mr,{})})]}),s.jsx(Ao,{anchorEl:e,anchorOrigin:{vertical:"bottom",horizontal:"left"},anchorPosition:{top:62,left:0},onClose:u,open:!!e,transformOrigin:{vertical:"top",horizontal:"left"},children:s.jsx(gr,{children:i.filter(({name:f})=>f).map(({name:f,count:d})=>s.jsxs(_o,{className:Ie({active:f===n}),onClick:g=>{g.preventDefault(),p(f)},children:[s.jsx("span",{className:"icon",children:f===n?s.jsx(xr,{}):null}),s.jsx("span",{children:`${a(f)} (${d})`})]},f))})})]})},Io=b(y).attrs({direction:"row",align:"center"})`
  cursor: pointer;
  flex-grow: 1;
  color: ${w.GRAY6};
  font-family: Barlow;
...
`,_o=b(y).attrs({direction:"row",align:"center"})`
  font-family: Barlow;
  font-size: 13px;
  font-style: normal;
  font-weight: 500;
...
`,gt=[["Searching","Podcast Index"],["Finding","Transcripts"],["Loading","Audio Clips"],["Loading","Video Clips"],["Preparing","Results"]],Po=()=>{const[e,t]=A.useState(0);return A.useEffect(()=>{if(e===gt.length-1)return;const n=setTimeout(()=>t(r=>(r+1)%gt.length),2e3);return()=>clearTimeout(n)},[e]),s.jsx(zo,{direction:"column",children:gt.map((n,r)=>s.jsxs(y,{className:Ie("raw-wrapper",{show:e===r}),direction:"row",children:[s.jsx("div",{className:Ie("action"),children:n[0]}),s.jsx("div",{className:Ie("entity"),children:n[1]}),s.jsx("div",{children:s.jsx(Eo,{color:w.SECONDARY_BLUE,size:2})})]},n[1]))})},zo=b(y)`
  overflow: hidden;
  height: 20px;
  position: relative;
  .action {
...
`,Do=b(y)`
  ...
  font-weight: 600;
  line-height: 17px;
`,Fo=({text:e,type:t,sourceLink:n})=>s.jsxs(y,{direction:"column",children:[s.jsx(y,{align:"center",direction:"row",children:s.jsx(Ne,{type:t})}),s.jsx(zt,{"data-testid":"episode-description",children:e}),s.jsx(y,{align:"center",direction:"row",justify:"flex-start",children:n&&s.jsxs(No,{href:n,onClick:r=>r.stopPropagation(),target:"_blank",children:[s.jsx(yr,{}),s.jsx($o,{children:n})]})})]}),No=b.a`
  color: ${w.GRAY6};
  font-size: 16px;
  height: 16px;
  display: flex;
...
`,$o=b(J)`
  ...
  font-weight: 400;
  line-height: 18px;
`,Ho=({title:e,imageUrl:t,name:n})=>s.jsxs(y,{align:"center",direction:"row",children:[s.jsx(Vo,{children:s.jsx(ke,{rounded:!0,size:64,src:t||"",type:"person"})}),(e||n)&&s.jsx(Uo,{children:e||n})]}),Vo=b(y)`
  img {
    width: 64px;
    height: 64px
    border-radius: 50%;
...
`,Uo=b(y)`
  ...
  font-weight: 600;
  line-height: 17px;
`,Go=({text:e,imageUrl:t,date:n,twitterHandle:r,name:i,verified:o})=>s.jsxs(y,{direction:"column",children:[s.jsxs(y,{align:"center",direction:"row",pr:16,children:[s.jsx(qo,{children:s.jsx(ke,{rounded:!0,size:27,src:t||"",type:"person"})}),s.jsxs(y,{children:[s.jsxs(Yo,{align:"center",direction:"row",children:[i,o&&s.jsx("div",{className:"verification",children:s.jsx("img",{alt:"verified",src:"verified_twitter.svg"})})]}),r&&s.jsxs(Wo,{children:["@",r]})]})]}),s.jsxs(y,{grow:1,shrink:1,children:[s.jsx(Qo,{"data-testid":"episode-description",children:e}),s.jsx(y,{"data-testid":"date-text",direction:"row",justify:"flex-start",children:!!n&&s.jsx(ct,{children:Ht.unix(n).fromNow()})})]})]}),qo=b(y)`
  img {
    width: 64px;
    height: 64px;
    border-radius: 50%;
...
`,Tr=({boostCount:e,date:t,episodeTitle:n,isSelectedView:r=!1,imageUrl:i,showTitle:o,type:l,text:a,name:c,sourceLink:u,verified:p=!1,twitterHandle:h,className:f="episode-wrapper",onClick:d})=>{const g=l==="show"?o:n,k=l==="show"?"":o,T=["tweet","person","guest","topic","document"],v=l==="video"?"video":"audio";return l?s.jsx(Zo,{className:f,onClick:d,children:T.includes(l)?s.jsxs(s.Fragment,{children:[l==="topic"&&s.jsxs(Xo,{children:[s.jsx(Fi,{}),s.jsx("p",{children:k})]}),["person","guest"].includes(l)&&s.jsx(Ho,{imageUrl:i,name:c||"",title:o||""}),["image"].includes(l)&&s.jsx(Oo,{imageUrl:u,name:c||""}),l==="tweet"&&s.jsx(Go,{date:t,imageUrl:i,name:c||"",text:a||"",twitterHandle:h,verified:p}),l==="document"&&s.jsx(Fo,{sourceLink:u||"",text:a||"",type:l})]}):s.jsxs(y,{align:"center",direction:"row",justify:"center",children:[!r&&s.jsx(y,{align:"center",pr:16,children:s.jsx(ke,{size:80,src:i||`${v}_default.svg`,type:l||""})}),s.jsxs(y,{grow:1,shrink:1,children:[s.jsxs(y,{align:"center",direction:"row",justify:"space-between",children:[s.jsx(y,{align:"center",direction:"row",children:l&&s.jsx(Ne,{type:l})}),l==="video"&&u?s.jsx(Jo,{href:`${u}${u.includes("?")?"&":"?"}open=system`,onClick:j=>j.stopPropagation(),target:"_blank",children:s.jsx(Gt,{})}):null]}),c&&s.jsx(zt,{"data-testid":"episode-name",children:c}),s.jsx(zt,{"data-testid":"episode-description",children:g}),s.jsxs(y,{align:"center",direction:"row",justify:"flex-start",children:[!!t&&s.jsx(ct,{children:Ht.unix(t).fromNow()}),!!k&&s.jsx(Ko,{children:k}),!r&&e>0&&s.jsx(y,{style:{marginLeft:"auto"},children:s.jsx(qt,{amt:e})})]})]})]})}):null},zt=b(y)`
  font-family: Barlow;
  font-size: 13px;
  font-style: normal;
  font-weight: 400;
...
`,Jo=b.a`
  ...
  font-size: 16px;
  height: 16px;
`,el=({isSearchResult:e})=>{const t=A.useRef(null),n=e?80:10,{setSelectedNode:r,setSelectedTimestamp:i}=fe(L=>L),{currentSearch:o,setSidebarOpen:l,setRelevanceSelected:a}=pe(L=>L),[c,u]=A.useState(0),[p,h]=A.useState(0),f=pr(),g=c*n+n,k=f&&f.length>0?f.length-1>g:!1,T=bo("sm","down"),v=A.useCallback(L=>{Si(L),i(L),a(!0),r(L),T&&l(!1)},[r,a,l,i,T]),j=()=>{k&&(u(c+1),h(L=>L+1))},S=A.useMemo(()=>{if(f){const L=[...f].sort((B,E)=>(E.date||0)-(B.date||0));return o&&L.sort((B,E)=>{const D=B.node_type==="topic"&&B.name.toLowerCase()===o.toLowerCase()?1:0;return(E.node_type==="topic"&&E.name.toLowerCase()===o.toLowerCase()?1:0)-D}),L.slice(0,g)}return[]},[f,o,g]);return s.jsx(s.Fragment,{children:s.jsxs(Mo,{ref:t,id:"search-result-list",shrink:1,children:[(S??[]).map((L,B)=>{const{image_url:E,date:D,boost:q,type:H,episode_title:V,show_title:_,node_type:P,text:N,source_link:G,link:F,name:te,verified:ee=!1,twitter_handle:ie}=L||{};return s.jsx(Tr,{boostCount:q||0,date:D||0,episodeTitle:rt(V),imageUrl:E||"",link:F,name:te||"",onClick:()=>{v(L)},showTitle:rt(_),sourceLink:G,text:N||"",twitterHandle:ie,type:P||H,verified:ee},B.toString())}),s.jsx(nl,{align:"center",background:"BG1",direction:"row",justify:"center",children:k&&s.jsx(we,{onClick:j,size:"medium",children:"Load More"},p)})]})})},tl=A.memo(el),nl=b(y)`
  flex: 0 0 86px;
`,rl=({isSearchResult:e})=>{const{nodeCount:t,setNodeCount:n,setBudget:r}=hr(a=>a),{fetchData:i,setAbortRequests:o}=fe(a=>a),l=async()=>{t<1||(await i(r,o,{skip_cache:"true"}),n("CLEAR"))};return s.jsxs(ll,{children:[!e&&s.jsxs("div",{className:"heading-container",children:[s.jsxs("div",{className:"heading",children:[s.jsx("span",{className:"heading__title",children:"Latest"}),s.jsx("span",{className:"heading__icon",children:s.jsx(Lo,{})})]}),t?s.jsx("div",{className:"button_container",children:s.jsx(il,{className:"button","data-testid":"see_latest_button",onClick:l,startIcon:s.jsx(Bo,{}),children:`See Latest (${t})`})}):null]}),s.jsx(tl,{isSearchResult:e})]})},il=b(we)`
  && {
    width: 100%;
    margin-top: 1.2rem;
    font-weight: 500;
...
`;const cl=48,pl=8,hl={PaperProps:{style:{maxHeight:cl*4.5+pl,width:250}}},dl=["Beginner","Intermediate","Advanced","Expert"],fl=()=>{const e=fe(j=>j.data),[t,n]=A.useState(""),[r,i]=A.useState("Beginner"),o=pe(j=>j.currentSearch),l=zi(),[a]=hr(j=>[j.setBudget]),[c,u,p,h,f]=Sr(j=>[j.askedQuestions,j.askedQuestionsAnswers,j.setAskedQuestion,j.setAskedQuestionAnswer,j.hasQuestionInProgress]),d=A.useCallback(j=>{h(j.answer)},[h]);A.useEffect(()=>{l&&d&&l.on("askquestionhook",d)},[d,l]);const g=async()=>{t&&(p(t),n(""));try{const j=e==null?void 0:e.nodes.filter(B=>B.text),S=j==null?void 0:j.slice(0,5),L=(S!=null&&S.length?S.map(B=>B.text).join(" "):"").substring(0,2500).replace(/[?&=+/#]/g,B=>`\\${B}`);o&&(await vi.enable(),await $i({expertise_level:r,question_text:t,search_term:o,transcripts:L},a),await Ei(a))}catch(j){console.error(j)}},k=r&&t.trim()&&!f,T=j=>{i(j.target.value)},v=async j=>{if(f){j.preventDefault();return}j.keyCode===13&&j.shiftKey===!1&&k&&(j.preventDefault(),g())};return s.jsxs(xl,{children:[s.jsx(y,{children:s.jsx(y,{children:s.jsxs(gr,{component:"div",children:[s.jsx(gl,{id:"select-label",size:"small",children:"Expertise level"}),s.jsx(yl,{id:"demo-multiple-name",input:s.jsx(po,{label:"Expertise level"}),labelId:"select-label",MenuProps:hl,onChange:T,size:"small",value:r,children:dl.map(j=>s.jsx(Ni,{component:"li",value:j,children:j},j))})]})})}),s.jsx(bl,{children:c==null?void 0:c.map((j,S)=>s.jsxs(y,{className:"response",py:12,children:[s.jsx(J,{kind:"medium",children:j}),s.jsx(y,{py:12,children:(u==null?void 0:u[S])!==void 0?s.jsx(J,{color:"unreadMsgText",children:u[S]}):s.jsxs(y,{align:"center",py:12,children:[s.jsx(y,{align:"center",py:12,children:s.jsx(vr,{color:w.white})}),s.jsx(y,{align:"center",py:12,children:s.jsx(J,{children:"Generating response"})})]})})]},j))}),s.jsxs(wl,{onKeyDown:v,py:12,tabIndex:-1,children:[s.jsx(ml,{disabled:f,onChange:j=>n(j.target.value),placeholder:"Enter your question",value:t}),s.jsx(kl,{children:s.jsx(fo,{color:k?w.white:w.gray300,size:"18"})})]})]})},xl=b.div`
  margin-top: 20px;
`,ml=b(Di)`
...
`,yn=({text:e})=>s.jsxs(y,{align:"center",justify:"center",py:12,children:[s.jsx(y,{align:"center",py:12,children:s.jsx(vr,{color:w.white})}),s.jsx(y,{align:"center",py:12,children:s.jsx(J,{children:e})})]}),jl=()=>{const[e,t,n,r]=Sr(o=>[o.teachMeAnswer,o.hasTeachingInProgress,o.instgraphAnswser,o.hasInstagraphInProgress]),i=!r&&!!(n!=null&&n.edges)&&!!(n!=null&&n.nodes);return s.jsxs(s.Fragment,{children:[i?s.jsx(Hi,{edges:n==null?void 0:n.edges,nodes:n==null?void 0:n.nodes}):s.jsx(yn,{text:"Generating instagraph"}),t?s.jsx(yn,{text:"Generating tutorial"}):s.jsxs(s.Fragment,{children:[s.jsx(Cl,{children:s.jsx(J,{children:e})}),s.jsx(fl,{})]})]})};b(we)``;const Cl=b(y)`
  padding-left: 10px;
  padding-right: 10px;
`,Sl=({cx:e,cy:t})=>s.jsx(ao,{cx:e,cy:t,fill:w.blueTextAccent,r:2}),vl=()=>{const e=xe(),t=[...(e==null?void 0:e.data)||[]].sort((i,o)=>(i.year||0)-(o.year||0)),n=t.map(i=>i.year).filter(i=>i),r=t.map(i=>i.rate).filter(i=>i);return s.jsx(El,{direction:"column",px:24,py:16,children:s.jsx(Vi,{height:"100%",width:"100%",children:s.jsxs(Ui,{margin:{bottom:20,left:20,right:20,top:20},children:[s.jsx(io,{stroke:"#f5f5f5"}),s.jsx(oo,{dataKey:"year",domain:[Math.min(...n),Math.max(...n)],label:{fill:w.white,fontSize:"12px",offset:-10,position:"insideBottom",value:e.x_axis_name},name:"X",tick:{fill:w.white,fontSize:"8px"},type:"number"}),s.jsx(lo,{color:"#000",dataKey:"rate",domain:[Math.min(...r),Math.max(...r)],label:{angle:-90,fill:w.white,fontSize:"12px",offset:0,position:"insideLeft",value:e.y_axis_name},name:"Y",tick:{fill:w.white,fontSize:"8px"},type:"number"}),s.jsx(so,{cursor:{strokeDasharray:"3 3"}}),s.jsx(Gi,{data:t,fill:w.blueTextAccent,line:!0,name:"A scatter",shape:s.jsx(Sl,{})})]})})})},El=b(y)`
  width: 100%;
  height: 100%;
`;function pt(e,t){if(!(t!=null&&t.trim()))return e;const n=new RegExp(`(${t})`,"gi"),r=e.split(n);return s.jsx(s.Fragment,{children:r.map((i,o)=>n.test(i)?s.jsx(Tl,{children:i},o):i)})}const Tl=b.span`
  background-color: rgba(0, 123, 255, 0.4);
  padding: 2;
  margin: 0;
  border-radius: 3px;
  color: inherit;
`,Il=({stateless:e,node:t,searchTerm:n})=>s.jsxs(y,{grow:1,shrink:1,children:[s.jsx(Al,{children:e&&s.jsxs(_l,{children:[s.jsx("div",{className:"icon",children:s.jsx(wr,{})}),s.jsx("div",{className:"title",children:"Description"})]})}),s.jsx(J,{children:t!=null&&t.description?pt(t.description,n):"..."})]}),_l=b(y).attrs({direction:"row",align:"center"})`
  .icon {
    font-size: 16px;
    color: ${w.GRAY3};
    margin-right: 7px;
...
`,Al=b(y).attrs({direction:"row",align:"center",justify:"space-between"})`
  margin-bottom: 18px;
`,Pl=b.span`
  color: ${w.white};
  cursor: pointer;
...
`,zl=({stateless:e,node:t})=>{var g;const[n,r]=pe(k=>[k.transcriptIsOpen,k.setTranscriptOpen]),[i,o]=A.useState(!1),[l,a]=A.useState(""),[c,u]=A.useState(!1);if(!e&&!n)return null;const p=async()=>{try{const k=await xn(t==null?void 0:t.ref_id);a(k.data.text)}catch(k){console.error("Error fetching full transcript",k)}},h=async()=>{if(l===""){const k=await xn(t==null?void 0:t.ref_id);d(k.data.text)}else d(l);setTimeout(()=>{o(!1)},2e3)},f=async()=>{c?u(!1):(await p(),u(!0))},d=k=>{k!==void 0&&(navigator.clipboard.writeText(k),o(!0))};return s.jsxs(y,{grow:1,shrink:1,children:[s.jsxs(Bl,{children:[e&&s.jsxs(Ll,{children:[s.jsx("div",{className:"icon",children:s.jsx(wr,{})}),s.jsx("div",{className:"title",children:"Transcript"})]}),t!=null&&t.text?s.jsx(s.Fragment,{children:i?s.jsxs(Rl,{align:"center",direction:"row",justify:"flex-start",children:[s.jsx("div",{className:"icon",children:s.jsx(xr,{})}),s.jsx("div",{className:"text",children:"Copied"})]}):s.jsx(we,{endIcon:s.jsx(qi,{}),onPointerDown:()=>h(),size:"small",variant:"outlined",children:"Copy"})}):s.jsx("div",{}),!e&&s.jsx(Ml,{onClick:()=>{r(!1)},children:s.jsx(xo,{fontSize:35})})]}),s.jsxs(Ol,{children:[c?l:`${(g=t==null?void 0:t.text)==null?void 0:g.substring(0,100)}`,s.jsxs(Pl,{onClick:f,children:["... ",c?"show less":"more"]})]})]})},Ll=b(y).attrs({direction:"row",align:"center"})`
  .icon {
    font-size: 16px;
    color: ${w.GRAY3};
    margin-right: 7px;
...
`,Bl=b(y).attrs({direction:"row",align:"center",justify:"space-between"})`
  margin-bottom: 18px;
`,Ml=b(y).attrs({})`
  color: ${w.mainBottomIcons};
  cursor: pointer;
...
`,Ir=({node:e})=>{const t=fe(k=>k.selectedNode),n=pe(k=>k.currentSearch),{link:r,image_url:i,date:o,boost:l,node_type:a,type:c,id:u,show_title:p,episode_title:h,ref_id:f}=e||t||{},[d,g]=A.useState(l||0);return A.useEffect(()=>{g(l??0)},[l]),!e&&!t?null:s.jsx("div",{style:{overflow:"auto",flex:1,width:"100%"},children:s.jsxs(Dl,{children:[s.jsx(Nl,{boostCount:d||0,date:o||0,episodeTitle:rt(h),imageUrl:i,isSelectedView:!0,link:r,onClick:()=>null,showTitle:p,type:a||c}),s.jsx(yt,{}),s.jsxs(Fl,{children:[s.jsx(qt,{amt:d}),s.jsx(kr,{content:e||t,count:d,refId:f,updateCount:g})]}),s.jsx(yt,{}),s.jsx(wn,{children:s.jsx(Il,{node:e||t,searchTerm:n,stateless:!0})}),((t==null?void 0:t.text)||(e==null?void 0:e.text))&&s.jsxs(s.Fragment,{children:[s.jsx(yt,{}),s.jsx(wn,{children:s.jsx(zl,{node:e||t,stateless:!0},u)})]})]})})},Dl=b(y)`
  flex: 1;
  min-height: 100%;
  flex-direction: column;
...
`,rs=({onClick:e,timestamp:t,isSelected:n,setOpenClip:r})=>{const i=n?"blueTextAccent":"placeholderText";return n?(mo,w[i]):(go,w[i]),s.jsxs(ns,{align:"center","data-testid":"wrapper",direction:"row",isSelected:n,justify:"flex-start",onClick:e,px:20,py:20,children:[s.jsxs("div",{children:[s.jsx(dr,{className:"play-pause",children:n?s.jsx(ts,{}):s.jsx(Yi,{})}),!1]}),s.jsxs(is,{align:"flex-start",direction:"column",justify:"center",children:[t.timestamp&&s.jsx("span",{className:"timestamp",children:Wi(t.timestamp)}),s.jsx("span",{className:"title",children:rt(t.show_title)})]}),s.jsx("div",{className:"info",children:s.jsx(y,{"data-testid":"info-icon-wrapper",onClick:()=>r(t),pt:4,children:s.jsx(yo,{})})})]})},is=b(y)`
  font-size: 13px;
  color: ${w.white};
  font-family: 'Barlow';
  margin: 0 16px;
...
`,ls=()=>{const e=xe(),t=Er(),[n,r]=A.useState(null),[i,o]=A.useState(null),[l,a,c,u,p]=at(g=>[g.playingNode,g.setPlayingNodeLink,g.setPlayingTime,g.setIsSeeking,g.playingTime]),h=A.useMemo(()=>br((t==null?void 0:t.nodes)||[],e),[t==null?void 0:t.nodes,e]),f=A.useMemo(()=>t==null?void 0:t.nodes.find(g=>g.node_type==="show"&&g.show_title===(e==null?void 0:e.show_title)),[t==null?void 0:t.nodes,e]),d=A.useCallback(g=>{var T;const k=Pt(((T=g==null?void 0:g.timestamp)==null?void 0:T.split("-")[0])||"00:00:01");(l&&g.link&&(l==null?void 0:l.link)!==g.link||(!l||(l==null?void 0:l.link)!==g.link)&&g.link!==void 0)&&(a(g.link),c(0),u(!0)),c(k),u(!0),o(g)},[l,a,u,o,c]);return A.useEffect(()=>{h!=null&&h.length&&!h.some(g=>g.ref_id===(i==null?void 0:i.ref_id))&&d(h[0])},[h,i,d]),A.useEffect(()=>{if(h!=null&&h.length){const g=h.find(k=>{if(!k.timestamp)return!1;const T=Pt(k.timestamp.split("-")[0]);return Math.abs(T-p)<1});g&&g.ref_id!==(i==null?void 0:i.ref_id)&&o(g)}},[p,h,i]),e?s.jsx("div",{style:{overflow:"auto",flex:1,width:"100%"},children:s.jsxs(as,{children:[n&&s.jsx(us,{className:"slide-me",direction:"up",in:!!n,children:s.jsxs(ss,{children:[s.jsx(y,{className:"close-info",onClick:()=>r(null),children:s.jsx(mr,{})}),n&&s.jsx(Ir,{node:n})]})}),s.jsx(Hl,{selectedNodeShow:f}),!!(h!=null&&h.length)&&s.jsx(os,{children:s.jsx(y,{pb:20,children:h==null?void 0:h.map((g,k)=>s.jsx(rs,{isSelected:(i==null?void 0:i.ref_id)===g.ref_id,onClick:()=>d(g),setOpenClip:r,timestamp:g},`${g.episode_title}_${k}`))})})]})}):null},ss=b(y)`
  border-radius: 20px;
  overflow: hidden;
  height: 100%;
...
`,Us=b.audio`
  height: 0;
  width: 0;
`,Gs=["clip","twitter_space","video","episode","podcast"],qs=()=>{const e=xe(),{showTeachMe:t}=fe(r=>r),{setPlayingNode:n}=at(r=>r);if(A.useEffect(()=>{Gs.includes((e==null?void 0:e.node_type)||"")&&n(e)},[n,e]),t)return s.jsx(jl,{});switch(e==null?void 0:e.node_type){case"guest":case"person":return s.jsx(xs,{});case"data_series":return s.jsx(vl,{});case"tribe_message":return s.jsx(ps,{});case"tweet":return s.jsx(Ss,{});case"topic":return s.jsx(Cs,{});case"show":return s.jsx(js,{});case"video":case"podcast":case"clip":case"twitter_space":return s.jsx(Ir,{});case"document":return s.jsx(Fs,{});case"episode":return s.jsx(ls,{},e.ref_id);case"image":return s.jsx(cs,{});default:return s.jsx(Ps,{})}},Ys=A.memo(qs),Ws=e=>s.jsx("svg",{width:"1em",height:"1em",viewBox:"0 0 24 24",fill:"currentColor",xmlns:"http://www.w3.org/2000/svg",children:s.jsxs("g",{id:"volume_mute",children:[s.jsx("mask",{id:"mask0_1483_75386",maskUnits:"userSpaceOnUse",x:"0",y:"0",width:"24",height:"24",children:s.jsx("rect",{id:"Bounding box",width:"1em",height:"1em",fill:"currentColor"})}),s.jsxs("g",{mask:"url(#mask0_1483_75386)",children:[s.jsx("path",{id:"volume_up_2",d:"M14.0384 20.1095V18.5595C15.4807 18.1005 16.6425 17.2672 17.5239 16.0595C18.4053 14.8518 18.8461 13.4903 18.8461 11.9749C18.8461 10.4595 18.4053 9.09799 17.5239 7.89031C16.6425 6.68261 15.4807 5.84927 14.0384 5.39031V3.84033C15.8999 4.33905 17.4165 5.33841 18.5883 6.83841C19.7601 8.33839 20.346 10.0506 20.346 11.9749C20.346 13.8993 19.7601 15.6114 18.5883 17.1114C17.4165 18.6114 15.8999 19.6108 14.0384 20.1095ZM3.65381 14.4999V9.49993H7.36531L11.6537 5.21153V18.7883L7.36531 14.4999H3.65381ZM14.0384 15.6537V8.29608C14.7127 8.66275 15.2339 9.17909 15.6018 9.84511C15.9698 10.5111 16.1537 11.2294 16.1537 11.9999C16.1537 12.7602 15.9682 13.4675 15.597 14.122C15.2259 14.7765 14.7063 15.2871 14.0384 15.6537Z",fill:"currentColor"}),s.jsx("path",{id:"mute_line",d:"M6 21L21 4",stroke:"#808080","stroke-width":"2","stroke-linecap":"round"})]})]})}),Qs=({isPlaying:e,isFullScreen:t,setIsPlaying:n,playingTime:r,duration:i,handleProgressChange:o,handleVolumeChange:l,onFullScreenClick:a,showToolbar:c})=>{const[u,p]=A.useState(.5),[h,f]=A.useState(!1),[d,g]=A.useState(.5),k=(v,j)=>{const S=Array.isArray(j)?j[0]:j;p(S),l(v,S),h&&f(!1)},T=()=>{h?(p(d),l(new Event("input"),d)):(g(u),p(0),l(new Event("input"),0)),f(!h)};return s.jsxs(y,{children:[(!c||t)&&s.jsx(na,{"aria-label":"Small","data-testid":"progress-bar",isFullScreen:t,max:i,onChange:o,size:"small",value:r}),s.jsxs(Zs,{align:"center",direction:"row",showToolbar:c||t,children:[s.jsx(Js,{onClick:n,size:"small",children:e?s.jsx(ut,{}):s.jsx(Vt,{})}),s.jsxs(ra,{direction:"row",children:[s.jsx("span",{children:gn(r)}),s.jsx("span",{className:"separator",children:"/"}),s.jsx("span",{className:"duration",children:gn(i)})]}),s.jsxs(ea,{direction:"row",px:9,children:[s.jsx(jr,{className:"volume-slider",max:1,min:0,onChange:k,size:"small",step:.1,value:u}),s.jsx(Xs,{onClick:T,children:h?s.jsx(Ks,{children:s.jsx(Ws,{})}):s.jsx(Xi,{})})]}),s.jsx(ta,{"data-testid":"fullscreen-button",onClick:a,children:t?s.jsx(Ji,{}):s.jsx(Ki,{})})]})]})},Zs=b(y)`
  height: 60px;
  padding: 12px 16px;
  ${e=>e.showToolbar&&`
    position: fixed;
...
`,ia=({hidden:e})=>{var he,m;const t=A.useRef(null),n=A.useRef(null),[r,i]=A.useState(!1),[o,l]=A.useState(!1),[a,c]=A.useState(!1),[u,p]=A.useState("ready"),[h,f]=A.useState(!1),{isPlaying:d,playingTime:g,duration:k,setIsPlaying:T,setPlayingTime:v,setDuration:j,playingNode:S,volume:L,setVolume:B,setHasError:E,resetPlayer:D,isSeeking:q,setIsSeeking:H}=at(Z=>Z),V=((he=S==null?void 0:S.link)==null?void 0:he.includes("youtube"))||((m=S==null?void 0:S.link)==null?void 0:m.includes("youtu.be"));A.useEffect(()=>()=>D(),[D]),A.useEffect(()=>{S&&!h&&(v(0),j(0),f(!1))},[S,v,j,f,h]),A.useEffect(()=>{q&&t.current&&(t.current.seekTo(g,"seconds"),H(!1))},[g,q,H]);const _=()=>{T(!d)},P=()=>{T(!0)},N=()=>{T(!1)},G=(Z,X)=>{const K=Array.isArray(X)?X[0]:X;t.current&&(t.current.seekTo(K),v(K))},F=(Z,X)=>{const K=Array.isArray(X)?X[0]:X;B(K)},te=()=>{E(!0),p("error")},ee=Z=>{if(!q){const X=Z.playedSeconds;v(X)}},ie=()=>{if(t.current){p("ready");const Z=t.current.getDuration();j(Z)}},ge=()=>{n.current&&(document.fullscreenElement?(document.exitFullscreen(),setTimeout(()=>l(!1),300)):n.current.requestFullscreen().then(()=>{document.addEventListener("fullscreenchange",x)}))},x=()=>{l(!!document.fullscreenElement),document.removeEventListener("fullscreenchange",x)};A.useEffect(()=>()=>{document.removeEventListener("fullscreenchange",x)}),A.useEffect(()=>{const Z=X=>{if(o){const K=window.screen.height,Ae=X.clientY,be=K-Ae;c(be<=50)}};return document.addEventListener("mousemove",Z),()=>{document.removeEventListener("mousemove",Z)}},[o,a]),A.useEffect(()=>{const Z=X=>{o&&X.key==="Escape"?(X.preventDefault(),X.stopPropagation()):r&&X.key===" "&&(X.preventDefault(),_())};return document.addEventListener("fullscreenchange",x),document.addEventListener("keydown",Z),()=>{document.removeEventListener("fullscreenchange",x),document.removeEventListener("keydown",Z)}});const se=()=>{_()};return S!=null&&S.link?s.jsxs(oa,{ref:n,hidden:e,onBlur:()=>i(!1),onFocus:()=>i(!0),tabIndex:0,children:[s.jsx(la,{isFullScreen:o,children:s.jsx(ke,{size:120,src:(S==null?void 0:S.image_url)||"",type:"clip"})}),s.jsx(ua,{onClick:se,children:s.jsx(eo,{ref:t,controls:!1,height:o?window.screen.height:"200px",onBuffer:()=>p("buffering"),onBufferEnd:()=>p("ready"),onError:te,onPause:N,onPlay:P,onProgress:ee,onReady:ie,playing:d,url:(S==null?void 0:S.link)||"",volume:L,width:"100%"})}),u==="error"?s.jsx(aa,{className:"error-wrapper",children:"Error happened, please try later"}):null,u==="ready"?s.jsx(Qs,{duration:k,handleProgressChange:G,handleVolumeChange:F,isFullScreen:o,isPlaying:d,onFullScreenClick:ge,playingTime:g,setIsPlaying:_,showToolbar:a&&o}):null,u==="buffering"&&!V?s.jsx(sa,{isFullScreen:o,children:s.jsx(Ut,{color:w.lightGray})}):null]}):null},oa=b(y)`
...
`,ua=b.div`
  width: 100%;
  cursor: pointer;
`,ca=A.memo(ia),pa=({open:e})=>{const{setSelectedNode:t,setTeachMe:n,showTeachMe:r}=fe(a=>a),i=xe(),{setSidebarOpen:o}=pe(a=>a),{playingNode:l}=at(a=>a);return s.jsx(Wt,{"data-testid":"sidebar-sub-view",direction:"right",in:e,style:{width:r?"700px":"",position:e?"relative":"absolute"},children:s.jsxs(ha,{children:[s.jsx(ca,{hidden:(i==null?void 0:i.ref_id)!==(l==null?void 0:l.ref_id)},l==null?void 0:l.ref_id),s.jsx(fa,{children:s.jsx(Ys,{})}),s.jsx(da,{"data-testid":"close-sidebar-sub-view",onClick:()=>{t(null),n(!1)},children:s.jsx(to,{})}),s.jsx(xa,{onClick:()=>{o(!1)},children:s.jsx(Cr,{})})]})})},ha=b(y)(({theme:e})=>({position:"relative",background:w.BG1,width:"100%",margin:"64px auto 20px 10px",borderRadius:"16px",zIndex:29,[e.breakpoints.up("sm")]:{width:"390px"}})),da=b(y)`
  font-size: 32px;
  color: ${w.white};
  cursor: pointer;
  position: absolute;
...
`});const u={type:"element",tagName:"li",properties:o,children:l};return e.patch(t,u),e.applyData(t,u)}function Vp(e){let t=!1;if(e.type==="list"){t=e.spread||!1;const n=e.children;let r=-1;for(;!t&&++r<n.length;)t=oi(n[r])}return t}function oi(e){const t=e.spread;return t??e.children.length>1}function Up(e,t){const n={},r=e.all(t);let i=-1;for(typeof t.start=="number"&&t.start!==1&&(n.start=t.start);++i<r.length;){const l=r[i];if(l.type==="element"&&l.tagName==="li"&&l.properties&&Array.isArray(l.properties.className)&&l.properties.className.includes("task-list-item")){n.className=["contains-task-list"];break}}const o={type:"element",tagName:t.ordered?"ol":"ul",properties:n,children:e.wrap(r,!0)};return e.patch(t,o),e.applyData(t,o)}function Gp(e,t){const n={type:"element",tagName:"p",properties:{},children:e.all(t)};return e.patch(t,n),e.applyData(t,n)}function qp(e,t){const n={type:"root",children:e.wrap(e.all(t))};return e.patch(t,n),e.applyData(t,n)}function Yp(e,t){const n={type:"element",tagName:"strong",properties:{},children:e.all(t)};return e.patch(t,n),e.applyData(t,n)}function Wp(e,t){const n=e.all(t),r=n.shift(),i=[];if(r){const l={type:"element",tagName:"thead",properties:{},children:e.wrap([r],!0)};e.patch(t.children[0],l),i.push(l)}if(n.length>0){const l={type:"element",tagName:"tbody",properties:{},children:e.wrap(n,!0)},a=Xt(t.children[1]),c=Dr(t.children[t.children.length-1]);a&&c&&(l.position={start:a,end:c}),i.push(l)}const o={type:"element",tagName:"table",properties:{},children:e.wrap(i,!0)};return e.patch(t,o),e.applyData(t,o)}function Qp(e,t,n){const r=n?n.children:void 0,o=(r?r.indexOf(t):1)===0?"th":"td",l=n&&n.type==="table"?n.align:void 0,a=l?l.length:t.children.length;let c=-1;const u=[];for(;++c<a;){const h=t.children[c],f={},d=l?l[c]:void 0;d&&(f.align=d);let g={type:"element",tagName:o,properties:f,children:[]};h&&(g.children=e.all(h),e.patch(h,g),g=e.applyData(h,g)),u.push(g)}const p={type:"element",tagName:"tr",properties:{},children:e.wrap(u,!0)};return e.patch(t,p),e.applyData(t,p)}function Zp(e,t){const n={type:"element",tagName:"td",properties:{},children:e.all(t)};return e.patch(t,n),e.applyData(t,n)}const Vn=9,Un=32;function Xp(e){const t=String(e),n=/\r?\n|\r/g;let r=n.exec(t),i=0;const o=[];for(;r;)o.push(Gn(t.slice(i,r.index),i>0,!0),r[0]),i=r.index+r[0].length,r=n.exec(t);return o.push(Gn(t.slice(i),i>0,!1)),o.join("")}function Gn(e,t,n){let r=0,i=e.length;if(t){let o=e.codePointAt(r);for(;o===Vn||o===Un;)r++,o=e.codePointAt(r)}if(n){let o=e.codePointAt(i-1);for(;o===Vn||o===Un;)i--,o=e.codePointAt(i-1)}return i>r?e.slice(r,i):""}function Kp(e,t){const n={type:"text",value:Xp(String(t.value))};return e.patch(t,n),e.applyData(t,n)}function Jp(e,t){const n={type:"element",tagName:"hr",properties:{},children:[]};return e.patch(t,n),e.applyData(t,n)}const e0={blockquote:_p,break:Ap,code:Pp,delete:zp,emphasis:Lp,footnoteReference:Bp,heading:Mp,html:Op,imageReference:Rp,image:Dp,inlineCode:Fp,linkReference:Np,link:$p,listItem:Hp,list:Up,paragraph:Gp,root:qp,strong:Yp,table:Wp,tableCell:Zp,tableRow:Qp,text:Kp,thematicBreak:Jp,toml:Ke,yaml:Ke,definition:Ke,footnoteDefinition:Ke};function Ke(){}const li=-1,dt=0,ot=1,lt=2,on=3,ln=4,sn=5,an=6,si=7,ai=8,qn=typeof self=="object"?self:globalThis,t0=(e,t)=>{const n=(i,o)=>(e.set(o,i),i),r=i=>{if(e.has(i))return e.get(i);const[o,l]=t[i];switch(o){case dt:case li:return n(l,i);case ot:{const a=n([],i);for(const c of l)a.push(r(c));return a}case lt:{const a=n({},i);for(const[c,u]of l)a[r(c)]=r(u);return a}case on:return n(new Date(l),i);case ln:{const{source:a,flags:c}=l;return n(new RegExp(a,c),i)}case sn:{const a=n(new Map,i);for(const[c,u]of l)a.set(r(c),r(u));return a}case an:{const a=n(new Set,i);for(const c of l)a.add(r(c));return a}case si:{const{name:a,message:c}=l;return n(new qn[a](c),i)}case ai:return n(BigInt(l),i);case"BigInt":return n(Object(BigInt(l)),i)}return n(new qn[o](l),i)};return r},Yn=e=>t0(new Map,e)(0),Re="",{toString:n0}={},{keys:r0}=Object,Ge=e=>{const t=typeof e;if(t!=="object"||!e)return[dt,t];const n=n0.call(e).slice(8,-1);switch(n){case"Array":return[ot,Re];case"Object":return[lt,Re];case"Date":return[on,Re];case"RegExp":return[ln,Re];case"Map":return[sn,Re];case"Set":return[an,Re]}return n.includes("Array")?[ot,n]:n.includes("Error")?[si,n]:[lt,n]},Je=([e,t])=>e===dt&&(t==="function"||t==="symbol"),i0=(e,t,n,r)=>{const i=(l,a)=>{const c=r.push(l)-1;return n.set(a,c),c},o=l=>{if(n.has(l))return n.get(l);let[a,c]=Ge(l);switch(a){case dt:{let p=l;switch(c){case"bigint":a=ai,p=l.toString();break;case"function":case"symbol":if(e)throw new TypeError("unable to serialize "+c);p=null;break;case"undefined":return i([li],l)}return i([a,p],l)}case ot:{if(c)return i([c,[...l]],l);const p=[],h=i([a,p],l);for(const f of l)p.push(o(f));return h}case lt:{if(c)switch(c){case"BigInt":return i([c,l.toString()],l);case"Boolean":case"Number":case"String":return i([c,l.valueOf()],l)}if(t&&"toJSON"in l)return o(l.toJSON());const p=[],h=i([a,p],l);for(const f of r0(l))(e||!Je(Ge(l[f])))&&p.push([o(f),o(l[f])]);return h}case on:return i([a,l.toISOString()],l);case ln:{const{source:p,flags:h}=l;return i([a,{source:p,flags:h}],l)}case sn:{const p=[],h=i([a,p],l);for(const[f,d]of l)(e||!(Je(Ge(f))||Je(Ge(d))))&&p.push([o(f),o(d)]);return h}case an:{const p=[],h=i([a,p],l);for(const f of l)(e||!Je(Ge(f)))&&p.push(o(f));return h}}const{message:u}=l;return i([a,{name:c,message:u}],l)};return o},Wn=(e,{json:t,lossy:n}={})=>{const r=[];return i0(!(t||n),!!t,new Map,r)(e),r},st=typeof structuredClone=="function"?(e,t)=>t&&("json"in t||"lossy"in t)?Yn(Wn(e,t)):structuredClone(e):(e,t)=>Yn(Wn(e,t));function o0(e,t){const n=[{type:"text",value:"↩"}];return t>1&&n.push({type:"element",tagName:"sup",properties:{},children:[{type:"text",value:String(t)}]}),n}function l0(e,t){return"Back to reference "+(e+1)+(t>1?"-"+t:"")}function s0(e){const t=typeof e.options.clobberPrefix=="string"?e.options.clobberPrefix:"user-content-",n=e.options.footnoteBackContent||o0,r=e.options.footnoteBackLabel||l0,i=e.options.footnoteLabel||"Footnotes",o=e.options.footnoteLabelTagName||"h2",l=e.options.footnoteLabelProperties||{className:["sr-only"]},a=[];let c=-1;for(;++c<e.footnoteOrder.length;){const u=e.footnoteById.get(e.footnoteOrder[c]);if(!u)continue;const p=e.all(u),h=String(u.identifier).toUpperCase(),f=He(h.toLowerCase());let d=0;const g=[],k=e.footnoteCounts.get(h);for(;k!==void 0&&++d<=k;){g.length>0&&g.push({type:"text",value:" "});let j=typeof n=="string"?n:n(c,d);typeof j=="string"&&(j={type:"text",value:j}),g.push({type:"element",tagName:"a",properties:{href:"#"+t+"fnref-"+f+(d>1?"-"+d:""),dataFootnoteBackref:"",ariaLabel:typeof r=="string"?r:r(c,d),className:["data-footnote-backref"]},children:Array.isArray(j)?j:[j]})}const T=p[p.length-1];if(T&&T.type==="element"&&T.tagName==="p"){const j=T.children[T.children.length-1];j&&j.type==="text"?j.value+=" ":T.children.push({type:"text",value:" "}),T.children.push(...g)}else p.push(...g);const v={type:"element",tagName:"li",properties:{id:t+"fn-"+f},children:e.wrap(p,!0)};e.patch(u,v),a.push(v)}if(a.length!==0)return{type:"element",tagName:"section",properties:{dataFootnotes:!0,className:["footnotes"]},children:[{type:"element",tagName:o,properties:{...st(l),id:"footnote-label"},children:[{type:"text",value:i}]},{type:"text",value:`
`},{type:"element",tagName:"ol",properties:{},children:e.wrap(a,!0)},{type:"text",value:`
`}]}}const ui=function(e){if(e==null)return p0;if(typeof e=="function")return ft(e);if(typeof e=="object")return Array.isArray(e)?a0(e):u0(e);if(typeof e=="string")return c0(e);throw new Error("Expected function, string, or object as test")};function a0(e){const t=[];let n=-1;for(;++n<e.length;)t[n]=ui(e[n]);return ft(r);function r(...i){let o=-1;for(;++o<t.length;)if(t[o].apply(this,i))return!0;return!1}}function u0(e){const t=e;return ft(n);function n(r){const i=r;let o;for(o in e)if(i[o]!==t[o])return!1;return!0}}function c0(e){return ft(t);function t(n){return n&&n.type===e}}function ft(e){return t;function t(n,r,i){return!!(h0(n)&&e.call(this,n,typeof r=="number"?r:void 0,i||void 0))}}function p0(){return!0}function h0(e){return e!==null&&typeof e=="object"&&"type"in e}const ci=[],d0=!0,Qn=!1,f0="skip";function x0(e,t,n,r){let i;typeof t=="function"&&typeof n!="function"?(r=n,n=t):i=t;const o=ui(i),l=r?-1:1;a(e,void 0,[])();function a(c,u,p){const h=c&&typeof c=="object"?c:{};if(typeof h.type=="string"){const d=typeof h.tagName=="string"?h.tagName:typeof h.name=="string"?h.name:void 0;Object.defineProperty(f,"name",{value:"node ("+(c.type+(d?"<"+d+">":""))+")"})}return f;function f(){let d=ci,g,k,T;if((!t||o(c,u,p[p.length-1]||void 0))&&(d=m0(n(c,p)),d[0]===Qn))return d;if("children"in c&&c.children){const v=c;if(v.children&&d[0]!==f0)for(k=(r?v.children.length:-1)+l,T=p.concat(v);k>-1&&k<v.children.length;){const j=v.children[k];if(g=a(j,k,T)(),g[0]===Qn)return g;k=typeof g[1]=="number"?g[1]:k+l}}return d}}}function m0(e){return Array.isArray(e)?e:typeof e=="number"?[d0,e]:e==null?ci:[e]}function pi(e,t,n,r){let i,o,l;typeof t=="function"&&typeof n!="function"?(o=void 0,l=t,i=n):(o=t,l=n,i=r),x0(e,o,a,i);function a(c,u){const p=u[u.length-1],h=p?p.children.indexOf(c):void 0;return l(c,h,p)}}const Ft={}.hasOwnProperty,g0={};function y0(e,t){const n=t||g0,r=new Map,i=new Map,o=new Map,l={...e0,...n.handlers},a={all:u,applyData:k0,definitionById:r,footnoteById:i,footnoteCounts:o,footnoteOrder:[],handlers:l,one:c,options:n,patch:w0,wrap:j0};return pi(e,function(p){if(p.type==="definition"||p.type==="footnoteDefinition"){const h=p.type==="definition"?r:i,f=String(p.identifier).toUpperCase();h.has(f)||h.set(f,p)}}),a;function c(p,h){const f=p.type,d=a.handlers[f];if(Ft.call(a.handlers,f)&&d)return d(a,p,h);if(a.options.passThrough&&a.options.passThrough.includes(f)){if("children"in p){const{children:k,...T}=p,v=st(T);return v.children=a.all(p),v}return st(p)}return(a.options.unknownHandler||b0)(a,p,h)}function u(p){const h=[];if("children"in p){const f=p.children;let d=-1;for(;++d<f.length;){const g=a.one(f[d],p);if(g){if(d&&f[d-1].type==="break"&&(!Array.isArray(g)&&g.type==="text"&&(g.value=Zn(g.value)),!Array.isArray(g)&&g.type==="element")){const k=g.children[0];k&&k.type==="text"&&(k.value=Zn(k.value))}Array.isArray(g)?h.push(...g):h.push(g)}}}return h}}function w0(e,t){e.position&&(t.position=tu(e))}function k0(e,t){let n=t;if(e&&e.data){const r=e.data.hName,i=e.data.hChildren,o=e.data.hProperties;if(typeof r=="string")if(n.type==="element")n.tagName=r;else{const l="children"in n?n.children:[n];n={type:"element",tagName:r,properties:{},children:l}}n.type==="element"&&o&&Object.assign(n.properties,st(o)),"children"in n&&n.children&&i!==null&&i!==void 0&&(n.children=i)}return n}function b0(e,t){const n=t.data||{},r="value"in t&&!(Ft.call(n,"hProperties")||Ft.call(n,"hChildren"))?{type:"text",value:t.value}:{type:"element",tagName:"div",properties:{},children:e.all(t)};return e.patch(t,r),e.applyData(t,r)}function j0(e,t){const n=[];let r=-1;for(t&&n.push({type:"text",value:`
...
`,th=b(y)`
  ...
  gap: 10px;
`,nh=["Drivechain","Ordinals","L402","Nostr","AI"],rh=({onSubmit:e})=>{var V;const{open:t}=At("addContent"),[n,r]=A.useState(!1),[i,o]=A.useState(!1),[l,a]=A.useState(null),c=A.useRef(null),[u,p]=A.useState(0),[h,f]=A.useState(!1),{currentPlayingAudio:d,setCurrentPlayingAudio:g}=pe(_=>_),{open:k}=At("briefDescription"),{trendingTopics:T,setTrendingTopics:v}=fe(_=>_),{setValue:j}=fr(),S=A.useCallback(async()=>{r(!0),o(!1),p(0),f(!1),g(null);try{const _=await ba();if(_.length&&Array.isArray(_)){const P=new Map(_.map(G=>[G.name,G])),N=Array.from(P.values());v(N)}}catch{v(nh.map(P=>({name:P,count:0})))}finally{r(!1)}},[g,v]);A.useEffect(()=>{T.length||S()},[S,T.length]),A.useEffect(()=>{const _=setTimeout(()=>{o(!0)},5e3);return()=>clearTimeout(_)},[o,n]);const L=_=>{j("search",_),e==null||e()},B=(_,P)=>{_.stopPropagation(),_.currentTarget.blur(),P!=null&&P.tldr&&(a(P),k())},E=()=>{a(null)},D=_=>{_.stopPropagation(),_.currentTarget.blur(),f(!h),g(c)};A.useEffect(()=>{var _,P;h?(_=c.current)==null||_.play():(P=c.current)==null||P.pause()},[u,h]),A.useEffect(()=>{d||f(!1)},[d]);const q=()=>{p(_=>{var N,G;let P=(_+1)%T.length;for(;P!==_&&!((N=T[P])!=null&&N.audio_EN);)P=(P+1)%T.length;return P===_?(f(!1),P):((G=c.current)==null||G.load(),P===0&&(f(!1),p(0)),P)}),g(c)},H=n?"Loading":"No new trending topics in the last 24 hours";return s.jsxs(oh,{"data-testid":"trending-component",children:[s.jsxs("div",{children:[s.jsxs("div",{className:"heading-container",children:[s.jsxs("div",{className:"heading",children:[s.jsx("span",{className:"heading__title",children:"Trending Topics"}),s.jsx("span",{className:"heading__icon",children:n?s.jsx(Ut,{color:w.white,size:16}):s.jsx(s.Fragment,{children:i?s.jsx(sh,{onClick:S,size:"small",startIcon:s.jsx(wa,{})}):s.jsx(ka,{})})})]}),jo(T)?s.jsxs("div",{children:[s.jsx(we,{onClick:_=>D(_),startIcon:h?s.jsx(ut,{}):s.jsx(Vt,{}),children:h?"Pause":"Play All"}),s.jsx(ch,{ref:c,onEnded:q,src:(V=T[u])==null?void 0:V.audio_EN,children:s.jsx("track",{kind:"captions"})})]}):null]}),T.length===0?s.jsxs("div",{className:"trending-empty",children:[s.jsx(lh,{children:H}),s.jsx(we,{color:"secondary",disabled:n,onClick:t,size:"medium",startIcon:s.jsx(wo,{}),sx:{alignSelf:"flex-end",m:"0 36px 16px 0"},variant:"contained",children:"Add Content"})]}):s.jsx("ul",{className:"list",children:T.map((_,P)=>s.jsxs(y,{align:"center",className:"list-item",direction:"row",justify:"space-between",onClick:()=>L(_.name),children:[s.jsxs(ih,{children:[s.jsx(uh,{children:s.jsx(ya,{})}),s.jsx("span",{className:"tldr",children:Co(_)})]}),_.tldr&&s.jsx(ah,{className:Ie({isPlaying:u===P&&h}),onClick:N=>B(N,_),children:"TLDR"})]},_.name))})]}),l&&s.jsx(Z0,{onClose:E,selectTrending:L,trend:l})]})},ih=b.div`
  display: flex;
  align-items: center;
  width: 300px;
...
`,ch=b.audio`
  height: 0;
  width: 0;
`,ph=390,hh=A.forwardRef(({onSubmit:e,subViewOpen:t},n)=>{const{isFetching:r,setTeachMe:i,setSidebarFilter:o,setSelectedNode:l}=fe(S=>S),a=pr(),{setSidebarOpen:c,currentSearch:u,clearSearch:p,searchFormValue:h}=pe(S=>S),[f]=Ai(S=>[S.trendingTopicsFeatureFlag]),{setValue:d,watch:g}=fr(),k=A.useRef(null),[T,v]=A.useState(!1);A.useEffect(()=>{d("search",h)},[d,h]),A.useEffect(()=>{const S=k.current;if(!S)return;const L=()=>{v((S==null?void 0:S.scrollTop)>0)};S.addEventListener("scroll",L)},[]);const j=g("search");return s.jsxs(xh,{ref:n,id:"sidebar-wrapper",children:[s.jsx(bh,{}),s.jsxs(fi,{className:Ie({"has-shadow":T}),children:[s.jsxs(mh,{children:[s.jsx(ro,{onSubmit:e}),s.jsx(yh,{"data-testid":"search_action_icon",onClick:()=>{if(u){d("search",""),p(),o("all"),l(null);return}j.trim()!==""&&(e==null||e())},children:r?s.jsx(Ut,{color:w.SECONDARY_BLUE,"data-testid":"loader",size:"20"}):s.jsx(s.Fragment,{children:u!=null&&u.trim()?s.jsx(Bi,{}):s.jsx(Mi,{})})})]}),u&&s.jsx(gh,{children:r?s.jsx(Po,{}):s.jsxs(s.Fragment,{children:[s.jsxs("div",{className:"left",children:[s.jsx("span",{className:"count",children:a.length}),s.jsx("span",{className:"label",children:" results"})]}),s.jsx("div",{className:"right",style:{alignItems:"center"},children:s.jsx(To,{})})]})})]}),!t&&s.jsx(wh,{onClick:()=>{c(!1),i(!1)},children:s.jsx(Cr,{})}),s.jsxs(kh,{ref:k,children:[!u&&f&&s.jsx(jh,{children:s.jsx(rh,{onSubmit:e})}),s.jsx(y,{children:r?s.jsx(al,{}):s.jsx(ol,{isSearchResult:!!u})})]})]})}),dh=["topic","person","guest","event","organization","place","project","software"],fh=({onSubmit:e})=>{const{sidebarIsOpen:t}=pe(o=>o),n=xe(),r=!!n&&t&&!dh.includes(n.node_type),{showTeachMe:i}=fe(o=>o);return s.jsxs(s.Fragment,{children:[s.jsx(Wt,{direction:"right",in:t,mountOnEnter:!0,unmountOnExit:!0,children:s.jsx(hh,{onSubmit:e,subViewOpen:r})}),s.jsx(pa,{open:r||!!i}),!t&&s.jsx(ma,{})]})},xh=b(y)(({theme:e})=>({position:"relative",background:w.BG1,height:"100vh",width:"100%",zIndex:30,[e.breakpoints.up("sm")]:{width:ph}})),fi=b(y).attrs({direction:"column",justify:"center",align:"stretch"})(({theme:e})=>({padding:e.spacing(3.75,2),[e.breakpoints.up("sm")]:{padding:"12px"},"&.has-shadow":{borderBottom:"1px solid rgba(0, 0, 0, 0.25)",background:w.BG1,boxShadow:"0px 1px 6px 0px rgba(0, 0, 0, 0.20)"}})),mh=b(y).attrs({direction:"row",justify:"center",align:"center"})`
  flex-grow: 1;
`,gh=b(y).attrs({direction:"row",justify:"space-between",align:"center"})`
  flex-grow: 1;
  color: ${w.GRAY6};
  font-family: Barlow;
  font-size: 13px;
...
`,yh=b(y).attrs({align:"center",justify:"center",p:5})`
  font-size: 32px;
  color: ${w.mainBottomIcons};
  cursor: pointer;
...
`,wh=b(y).attrs({align:"center",justify:"center",p:8})(({theme:e})=>({backgroundColor:w.BG1_NORMAL,cursor:"pointer",transitionDuration:"0.2s",position:"absolute",right:"0px",top:"50%",zIndex:1,width:"24px",height:"48px",transform:"translateY(-50%)",borderRadius:"0px 6px 6px 0px",boxShadow:"2px 0px 6px 0px rgba(0, 0, 0, 0.25) inset",color:w.white,[e.breakpoints.up("sm")]:{left:"100%"},"&:hover":{backgroundColor:w.BG1_HOVER},"&:active":{backgroundColor:w.BG1_PRESS,color:w.GRAY6}})),kh=b(y)(()=>({overflow:"auto",flex:1,width:"100%"})),bh=b(y)`
  height: 64px;
  background: ${w.BG2};
`,jh=b(y)`
  padding: 0;
