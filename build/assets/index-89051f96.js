import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,x as D,B as F}from"./index-7f808302.js";import{B as M}from"./index-9ec5ecf7.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-4df52b04.js";import{B as f,T as L,a as R}from"./index-3882507e.js";import{T as x}from"./index-2d8fa5f2.js";import"./useSlotProps-e49bab01.js";import"./index.esm-af752bfc.js";import"./InfoIcon-09d33252.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
