import{s as r,F as n,T as g,j as e,h as w,b as c,r as A,g as B}from"./index-5c5b2926.js";import{B as v}from"./index-4c13014e.js";import{u as F}from"./index-1f310504.js";import{u as M,U as $,q as C,e as b,x as D,F as k,C as G}from"./react-toastify.esm-7abd2405.js";import{B as f,T as R,a as L}from"./index-76645192.js";import{T as x}from"./index-19454506.js";import"./useSlotProps-c438f4f6.js";import"./index.esm-605225f9.js";import"./InfoIcon-e36216d7.js";const P=({onClose:s})=>{const[a]=M(t=>[t.graphStyle]),i=()=>{localStorage.setItem("graphStyle",a),s()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:i,children:"Save changes"})})]})},V=r(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=r(g)`
