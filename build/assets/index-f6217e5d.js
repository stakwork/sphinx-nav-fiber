import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h as x,r as T,x as v,B as m}from"./index-12ff6bcc.js";import{B}from"./index-38368720.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-6640765e.js";import{B as f,T as $,a as k}from"./index-a89dae4a.js";import{T as u}from"./index-03247c12.js";import"./useSlotProps-96fdb33b.js";import"./index.esm-5ff6ef30.js";import"./InfoIcon-8fb68dab.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
