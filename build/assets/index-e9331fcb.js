...
`,pt=d(g)`
  ...
  justify-content: center;
  align-items: center;
`,qs=()=>{const[t,s]=h.useState(!0),[n,r]=h.useState(""),[a,l]=ie(p=>[p.sources,p.setSources]),[i]=Ze(p=>[p.isAdmin]),[o,c]=h.useState("");h.useEffect(()=>{(async()=>{s(!0);try{const b=await Ge();l(b.data)}catch(b){console.warn(b)}finally{s(!1)}})()},[l]);const u=p=>{r(n===p||!p?"":p)},m=h.useMemo(()=>a==null?void 0:a.filter(p=>(!n||p.source_type===n)&&(p.source.toLowerCase().startsWith(o.toLowerCase())||p.source.toLowerCase().includes(o.toLowerCase())||`@${p.source.toLowerCase()}`.startsWith(o.toLowerCase())||`@${p.source.toLowerCase()}`.includes(o.toLowerCase()))),[o,n,a]);return e.jsxs(Qs,{align:"stretch",direction:"column",justify:"flex-end",children:[e.jsx(xe,{align:"center",direction:"row",justify:"space-between",children:e.jsx(L,{className:"title",children:"Sources for this Graph"})}),e.jsx(Ks,{children:e.jsx(dt,{activeIcon:e.jsx(te,{}),defaultIcon:e.jsx(ot,{}),loading:t,loadingIcon:e.jsx(M,{color:x.lightGray,size:24}),onSearch:c,placeholder:"Find Source"})}),e.jsxs(g,{className:"filters",direction:"row",pb:16,px:36,children:[e.jsx(re,{className:ne({selected:!n}),onClick:()=>u(""),size:"small",children:"All"}),Object.keys(D).map(p=>e.jsx(re,{className:ne({selected:p===n}),onClick:()=>u(p),size:"small",children:D[p]},p))]}),e.jsx(Js,{align:"center",justify:t?"center":"flex-start",children:t?e.jsx(M,{color:x.white}):e.jsx(Ds,{canEdit:i,data:m})})]})},Qs=d(g)`
  flex: 1;
  .title {
    font-size: 20px;
    color: ${x.white};
