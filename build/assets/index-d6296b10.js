...
`,ar=v.lazy(()=>Re(()=>import("./index-d570ca56.js"),["assets/index-d570ca56.js","assets/index-31948834.js","assets/index-b4d03b7b.css","assets/index-0ab4316b.js","assets/SourcesTableIcon-3d98a0a1.js","assets/index-8c95c680.js","assets/CheckIcon-259f2637.js","assets/DeleteNodeIcon-26cb904c.js","assets/SoundIcon-ce586e76.js","assets/SucessFeedBackIcon-d2a6d988.js","assets/ClipLoader-a1bda373.js","assets/TableRow-d090a071.js"]).then(({TweetAnalyze:e})=>({default:e}))),sr=()=>{const e=$(o=>o.setSelectedTweet),t=$(o=>o.selectedTweet),{tweetId:a}=ge(),[r,n]=v.useState(""),{open:i}=$e("tweetAnalyze"),l=(a==null?void 0:a.split("&"))||[],c=o=>{i(),n(o)};return s.jsxs(cr,{align:"stretch",basis:"100%",grow:1,shrink:1,children:[l.length>1?s.jsx(or,{onClick:()=>{c("summary")},children:"Summary Report"}):null,l.map(o=>s.jsx(lr,{className:t===o?"selected":"",onClick:()=>e(o),children:s.jsx(Ut,{handleAnalyzeClick:()=>{c(o)},nodeId:o})},o)),s.jsx(ar,{tweetId:r})]})},or=f.button`
  width: 100%;
  background: ${y.ANALYTICS_CARD_BG};
  color: ${y.white};
  padding: 16px 16px;
