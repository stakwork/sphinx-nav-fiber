import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-1f32104b.js";import{B as M}from"./index-e9915fcc.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-778eaf5b.js";import{B as f,T as L,a as R}from"./index-fa5ded45.js";import{T as x}from"./index-dd3c818a.js";import"./useSlotProps-f66c36b0.js";import"./index.esm-b5bec20a.js";import"./InfoIcon-651502b1.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
