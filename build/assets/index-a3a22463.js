import{Y as r,X as s,Z as b,j as e,ab as x,a0 as d,r as A,a1 as v}from"./index-9368326d.js";import{ax as M,cp as $,cq as j,cr as k,aH as y,cs as B,ct as D,cu as h,aN as C,cv as F,cw as G,u as L,ck as R}from"./index-713bedbb.js";const P=({onClose:a})=>{const[n]=M(t=>[t.graphStyle]),i=()=>{localStorage.setItem("graphStyle",n),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(s,{mt:308,children:e.jsx(j,{kind:"big",onClick:i,children:"Save changes"})})]})},V=r(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=r(b)`
