import{r as o,j as e,s as f,g as v,F as j,o as Y,c as J,A as ae,p as ie,i as ce,q as le,H as pe,t as de,v as ue}from"./index-60f01453.js";import{t as U,u as G,C as me}from"./index-7ebaf5dd.js";import{U as fe}from"./index-6530aacc.js";import{u as M,a as he,b as ge,I as xe,c as K,d as ye}from"./index-204e5ada.js";import{M as we,V as be}from"./index-d9e6ec60.js";import{S as je,R as ve,s as V,M as Se}from"./index-110cff94.js";import"./string-a277709d.js";import"./index-6da90996.js";import"./three.module-9722a9fc.js";import"./isPlainObject-78a1cc71.js";import"./TextareaAutosize-36d1b6eb.js";import"./CheckIcon-fece7859.js";import"./index-4fe6c716.js";import"./index-fb92296a.js";import"./index-4ab6c0a6.js";import"./ClipLoader-153af8d2.js";import"./clsx-978fb6ea.js";import"./SourcesTableIcon-897d7622.js";import"./DeleteNodeIcon-9e106e27.js";import"./SoundIcon-a91554cc.js";import"./SucessFeedBackIcon-89e68ba8.js";import"./Skeleton-e974afb8.js";import"./index-db3f2bf3.js";import"./Stack-d4a188a0.js";import"./FormControlLabel-170fc674.js";import"./Typography-757d1473.js";import"./createSvgIcon-dd3dc2ce.js";const Q=o.memo(()=>{const r=M(s=>s.isPlaying),a=M(s=>s.setIsPlaying),n=M(s=>s.setVolume),t=M(s=>s.setPlaybackSpeed),c=M(s=>s.playbackSpeed),i=M(s=>s.playerRef),[d,g]=o.useState(!1),y=[.5,1,1.5,2],h=()=>{if(i){const s=i.getCurrentTime()-15;i.seekTo(s,"seconds")}},u=()=>{if(i){const s=i.getCurrentTime()+15;i.seekTo(s,"seconds")}},b=()=>{a(!r)},l=()=>{g(!d),n(d?1:0)},p=()=>{const m=(y.indexOf(c)+1)%y.length,P=y[m];if(t(P),i){const _=i.getInternalPlayer();_&&typeof _.playbackRate<"u"&&(_.playbackRate=P)}};return e.jsxs(ke,{children:[e.jsx(_e,{onClick:l,children:d?e.jsx(we,{}):e.jsx(be,{})}),e.jsx(Ie,{onClick:h,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(Ce,{"data-testid":"play-pause-button",onClick:b,size:"small",children:r?e.jsx(he,{"data-testid":"pause-icon"}):e.jsx(ge,{"data-testid":"play-icon"})}),e.jsx(Pe,{onClick:u,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(Te,{onClick:p,children:[c,"x"]})]})});Q.displayName="Controls";const ke=f(j).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${v.BG1};
  border-radius: 40px;
