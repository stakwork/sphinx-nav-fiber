import { g as U, r as I, u as L, p as Y } from './index-82f7f87b.js'
function k(a, e) {
    ...
    if (typeof s != 'string' && !Array.isArray(s)) {
      for (const r in s)
        if (r !== 'default' && !(r in a)) {
          ...
          n && Object.defineProperty(a, r, n.get ? n : { enumerable: !0, get: () => s[r] })
        }
    }
  }
...
var M = Object.create,
  ...
  x = (a, e, t) => (e in a ? u(a, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : (a[e] = t)),
  K = (a, e) => {
  ...
  v = (a, e, t, s) => {
    if ((e && typeof e == 'object') || typeof e == 'function')
      for (let r of N(e))
        !B.call(a, r) && r !== t && u(a, r, { get: () => e[r], enumerable: !(s = j(e, r)) || s.enumerable })
    return a
  },
  F = (a, e, t) => (
    (t = a != null ? M(V(a)) : {}), v(e || !a || !a.__esModule ? u(t, 'default', { value: a, enumerable: !0 }) : t, a)
  ),
...
class O extends b.Component {
    ...
    super(...arguments),
      ...
      o(this, 'onStateChange', (e) => {
        const { data: t } = e,
          ...
          { UNSTARTED: d, PLAYING: c, PAUSED: i, BUFFERING: E, ENDED: A, CUED: C } = window[T].PlayerState
  ...
  load(e, t) {
    const { playing: s, muted: r, playsinline: n, controls: P, loop: _, config: g, onError: y } = this.props,
  ...
  render() {
    ...
    return b.default.createElement('div', { style: t }, b.default.createElement('div', { ref: this.ref }))
  }
}
