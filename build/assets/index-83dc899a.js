...
`,ar=v.lazy(()=>Re(()=>import("./index-8adf0883.js"),["assets/index-8adf0883.js","assets/index-94a99cb5.js","assets/index-b4d03b7b.css","assets/index-a600fa10.js","assets/SourcesTableIcon-08fbce7a.js","assets/index-57e1c14f.js","assets/CheckIcon-6ed45394.js","assets/DeleteNodeIcon-2a62c8a5.js","assets/SoundIcon-7b463ce2.js","assets/SucessFeedBackIcon-7659f508.js","assets/ClipLoader-e4e98d79.js","assets/TableRow-aa727643.js"]).then(({TweetAnalyze:e})=>({default:e}))),sr=()=>{const e=$(o=>o.setSelectedTweet),t=$(o=>o.selectedTweet),{tweetId:a}=ge(),[r,n]=v.useState(""),{open:i}=$e("tweetAnalyze"),l=(a==null?void 0:a.split("&"))||[],c=o=>{i(),n(o)};return s.jsxs(cr,{align:"stretch",basis:"100%",grow:1,shrink:1,children:[l.length>1?s.jsx(or,{onClick:()=>{c("summary")},children:"Summary Report"}):null,l.map(o=>s.jsx(lr,{className:t===o?"selected":"",onClick:()=>e(o),children:s.jsx(Ut,{handleAnalyzeClick:()=>{c(o)},nodeId:o})},o)),s.jsx(ar,{tweetId:r})]})},or=f.button`
  width: 100%;
  background: ${y.ANALYTICS_CARD_BG};
  color: ${y.white};
  padding: 16px 16px;
