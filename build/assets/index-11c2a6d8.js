import{s as i,a as t,F as c,j as e,e as j,r as l,u as $,B as w,bu as C,bw as R,aZ as z}from"./index-173367b0.js";import{az as I,f as D,l as E}from"./index-ae00d897.js";import{S as L}from"./Skeleton-c61d24ca.js";import{C as T}from"./ClipLoader-1925a497.js";const G=({nodeName:p})=>e.jsx(c,{children:e.jsxs(c,{align:"center",direction:"column",justify:"space-between",children:[e.jsx(A,{children:e.jsx(I,{})}),e.jsxs(M,{children:["Are you sure you want to delete ",p||"this item","?"]})]})}),M=i(c)`
  color: ${t.white};
  font-family: 'Barlow';
  font-size: 20px;
  font-weight: 400;
