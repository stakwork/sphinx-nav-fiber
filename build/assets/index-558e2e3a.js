import{p as s,q as l,F as n,t as w,j as e,v as G,w as T,E as S,r as f,C as v,aU as I,aV as b,aW as A,D as B,U as y}from"./index-02f7dfbc.js";import{B as z}from"./index-f1360f7c.js";import{u as D,G as M,C as k,x as E,E as R,B as $,q as W,F}from"./index-c6c9dcff.js";import{C}from"./ClipLoader-99421120.js";import{T as j}from"./index-32448089.js";import{S as P}from"./index-ff13149b.js";import{e as V}from"./index.esm-630054ef.js";import{T as L,a as N}from"./Tabs-c75c60e6.js";import"./createSvgIcon-d9f34ae0.js";const q={split:e.jsx(M,{}),force:e.jsx(k,{}),sphere:e.jsx(E,{}),earth:e.jsx(R,{})},O=()=>{const[i,p]=w(D(t=>[t.graphStyle,t.setGraphStyle])),r=t=>{p(t)};return e.jsx(U,{direction:"column",children:G.map(t=>e.jsx(n,{className:T("icon",{active:i===t}),onClick:()=>r(t),children:q[t]},t))})},U=s(n).attrs({direction:"row",align:"center",justify:"space-between"})`
  width: 447px;
  height: 48px;
