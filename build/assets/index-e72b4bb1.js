import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-bea49af7.js";import{B as M}from"./index-1fb3a29b.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-80c07171.js";import{B as f,T as L,a as R}from"./index-d6555e30.js";import{T as x}from"./index-79216f29.js";import"./useSlotProps-75ed05d5.js";import"./index.esm-4538792a.js";import"./InfoIcon-5b946ab4.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
