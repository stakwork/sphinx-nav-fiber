...
`,ar=v.lazy(()=>Re(()=>import("./index-16a40c61.js"),["assets/index-16a40c61.js","assets/index-3e423de1.js","assets/index-b4d03b7b.css","assets/index-3bd2e583.js","assets/SourcesTableIcon-8bf2d6c4.js","assets/index-3a7d80d5.js","assets/CheckIcon-74713451.js","assets/DeleteNodeIcon-825dd73b.js","assets/SoundIcon-b80419e2.js","assets/SucessFeedBackIcon-c3dded47.js","assets/ClipLoader-6fc4a312.js","assets/TableRow-856477e8.js"]).then(({TweetAnalyze:e})=>({default:e}))),sr=()=>{const e=$(o=>o.setSelectedTweet),t=$(o=>o.selectedTweet),{tweetId:a}=ge(),[r,n]=v.useState(""),{open:i}=$e("tweetAnalyze"),l=(a==null?void 0:a.split("&"))||[],c=o=>{i(),n(o)};return s.jsxs(cr,{align:"stretch",basis:"100%",grow:1,shrink:1,children:[l.length>1?s.jsx(or,{onClick:()=>{c("summary")},children:"Summary Report"}):null,l.map(o=>s.jsx(lr,{className:t===o?"selected":"",onClick:()=>e(o),children:s.jsx(Ut,{handleAnalyzeClick:()=>{c(o)},nodeId:o})},o)),s.jsx(ar,{tweetId:r})]})},or=f.button`
  width: 100%;
  background: ${y.ANALYTICS_CARD_BG};
  color: ${y.white};
  padding: 16px 16px;
