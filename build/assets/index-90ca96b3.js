...
`,$o=C(g)`
  ...
  font-weight: 600;
  line-height: 17px;
`,Ho=({text:e,imageUrl:t,date:n,twitterHandle:r,name:i,verified:o})=>s.jsxs(g,{direction:"column",children:[s.jsxs(g,{align:"center",direction:"row",pr:16,children:[s.jsx(Vo,{children:s.jsx(we,{rounded:!0,size:27,src:t||"",type:"person"})}),s.jsxs(g,{children:[s.jsxs(Uo,{align:"center",direction:"row",children:[i,o&&s.jsx("div",{className:"verification",children:s.jsx("img",{alt:"verified",src:"verified_twitter.svg"})})]}),r&&s.jsxs(Go,{children:["@",r]})]})]}),s.jsxs(g,{grow:1,shrink:1,children:[s.jsx(qo,{"data-testid":"episode-description",children:e}),s.jsx(g,{"data-testid":"date-text",direction:"row",justify:"flex-start",children:!!n&&s.jsx(ct,{children:$t.unix(n).fromNow()})})]})]}),Vo=C(g)`
  img {
    width: 64px;
    height: 64px;
    border-radius: 50%;
...
`,es=({onClick:e,timestamp:t,isSelected:n,setOpenClip:r})=>s.jsxs(Jl,{align:"center","data-testid":"wrapper",direction:"row",isSelected:n,justify:"flex-start",onClick:e,px:20,py:20,children:[s.jsxs("div",{children:[s.jsx(cr,{className:"play-pause",children:n?s.jsx(Kl,{}):s.jsx(qi,{})}),!1]}),s.jsxs(ts,{align:"flex-start",direction:"column",justify:"center",children:[t.timestamp&&s.jsx("span",{className:"timestamp",children:Yi(t.timestamp)}),s.jsx("span",{className:"title",children:rt(t.show_title)})]}),s.jsx("div",{className:"info",children:s.jsx(g,{"data-testid":"info-icon-wrapper",onClick:()=>r(t),pt:4,children:s.jsx(xo,{})})})]}),ts=C(g)`
  font-size: 13px;
  color: ${w.white};
  font-family: 'Barlow';
  margin: 0 16px;
