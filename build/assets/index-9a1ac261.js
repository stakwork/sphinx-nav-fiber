import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-7dcde225.js";import{B as M}from"./index-956697d9.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-8bcb4dda.js";import{B as f,T as L,a as R}from"./index-47a40130.js";import{T as x}from"./index-2b6cb1b8.js";import"./useSlotProps-aeebd459.js";import"./index.esm-8c214648.js";import"./InfoIcon-c9d1fdb1.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
