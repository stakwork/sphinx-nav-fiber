import{s as r,F as n,T as g,j as e,b as w,c,r as A,u as B}from"./index-5e402b8d.js";import{B as v}from"./index-c47d9c0b.js";import{u as F}from"./index-0692858f.js";import{u as M,G as $,l as C,b,q as D,F as G}from"./react-toastify.esm-2e91314a.js";import{B as f,T as k,a as R}from"./index-2967715c.js";import{T as x}from"./index-ea5825a7.js";import{C as L}from"./ClipLoader-f1f2aaad.js";import"./useSlotProps-d6233c22.js";import"./index.esm-58802bb8.js";import"./InfoIcon-21a8e098.js";const P=({onClose:s})=>{const[a]=M(t=>[t.graphStyle]),i=()=>{localStorage.setItem("graphStyle",a),s()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:i,children:"Save changes"})})]})},V=r(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=r(g)`
