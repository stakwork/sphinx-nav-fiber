import{s as f,c as y,u as L,r as x,j as e,F as t,T as h,b as C,w as R,n as U,ad as V,ae as g,d as G,a2 as q}from"./index-9bb53d68.js";import{ao as J,B as j,ap as Y,l as H,u as K,F as Q}from"./react-toastify.esm-4a8107b9.js";import{B as W}from"./index-c441576c.js";import{n as S}from"./toastMessage-599287a3.js";import{u as X}from"./index-fd921116.js";import{C as Z}from"./CheckIcon-b669f829.js";import{T as B}from"./index-d304b412.js";import{A as ee}from"./index-d80613d6.js";import{i as v,O as E}from"./constants-84edb5fc.js";import"./index.esm-bb054adf.js";import"./InfoIcon-114f7831.js";import"./index-29600eb3.js";import"./Popover-8dabc2ac.js";import"./useSlotProps-d348e93a.js";import"./Select-4e280586.js";import"./Stack-bc196f7f.js";import"./Popper-7982a003.js";const te=({onClick:n,loading:a})=>{const d=L(l=>l.budget),[c,m]=x.useState(10),s="node";return x.useEffect(()=>{(async()=>{try{const r=await Y(s);m(r.data.price)}catch(r){console.error("cannot fetch",r)}})()},[s]),e.jsxs(t,{children:[e.jsx(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:e.jsx(t,{align:"center",direction:"row",children:e.jsx(se,{children:"Approve Cost"})})}),e.jsxs(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:[e.jsxs(ne,{children:[e.jsx("div",{className:"title",children:"COST"}),e.jsxs("div",{className:"value","data-testid":"check-price",children:[c," sats"]})]}),e.jsxs(oe,{children:[e.jsx("div",{className:"title",children:"BUDGET"}),e.jsxs("div",{className:"value",children:[J(d)," sats"]})]})]}),e.jsx(t,{children:e.jsx(j,{color:"secondary","data-testid":"check-icon",disabled:a,onClick:n,size:"large",startIcon:e.jsx(Z,{}),type:"submit",variant:"contained",children:"Approve"})})]})},ne=f(t).attrs({direction:"column",align:"space-between",justify:"flex-start"})`
  width: 141px;
  height: 61px;
