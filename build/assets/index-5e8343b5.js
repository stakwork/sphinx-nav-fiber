import{p as s,q as l,F as n,t as w,j as e,v as T,w as G,E as S,r as f,C as v,aJ as I,aK as b,aL as A,D as B,Q as y}from"./index-f45d1995.js";import{B as z}from"./index-07f38537.js";import{u as D,H as M,C as k,x as E,J as R,B as $,q as F,F as W}from"./index-38f4e903.js";import{C}from"./ClipLoader-36b4c084.js";import{T as j}from"./index-9b726ac2.js";import{S as L}from"./index-28ea0f69.js";import{e as P}from"./index.esm-b741b4b6.js";import{T as V,a as N}from"./Tabs-98d2dd51.js";import"./createSvgIcon-17cae595.js";const q={split:e.jsx(M,{}),force:e.jsx(k,{}),sphere:e.jsx(E,{}),earth:e.jsx(R,{})},H=()=>{const[i,p]=w(D(t=>[t.graphStyle,t.setGraphStyle])),r=t=>{p(t)};return e.jsx(O,{direction:"column",children:T.map(t=>e.jsx(n,{className:G("icon",{active:i===t}),onClick:()=>r(t),children:q[t]},t))})},O=s(n).attrs({direction:"row",align:"center",justify:"space-between"})`
  width: 447px;
  height: 48px;
