import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-f4ce4d75.js";import{B}from"./index-06bbdfed.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-642b5131.js";import{B as f,T as $,a as k}from"./index-26f90609.js";import{T as u}from"./index-c7fb02c3.js";import"./useSlotProps-ea87b3c6.js";import"./index.esm-c2010acf.js";import"./InfoIcon-7fae6bf5.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
