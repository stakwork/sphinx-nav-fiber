import{o as s,F as o,T as w,p as C,r as f,j as e,q as c,A as S,aU as A,aV as b,aW as z,J as D,O as y}from"./index-f2d63ed8.js";import{B as G}from"./index-ece81284.js";import{G as M,B as v,i as $,F as B}from"./index-3d19d2e6.js";import{C as T}from"./ClipLoader-5e7653d2.js";import{T as j}from"./index-039cd2e7.js";import{S as E}from"./index-79ad4de5.js";import{e as I}from"./index.esm-87676509.js";import{T as k,a as F}from"./Tabs-5db9f566.js";import"./InfoIcon-ba8cb580.js";import"./useSlotProps-8c88519a.js";import"./createSvgIcon-fe17352d.js";const R=({onClose:a})=>{const[l]=C(d=>[d.graphStyle]),[r,i]=f.useState(!1),p=()=>{i(!0),localStorage.setItem("graphStyle",l),i(!1),a()};return e.jsxs(W,{direction:"column",children:[e.jsx(V,{children:"Default graph view:"}),e.jsx(M,{}),e.jsx(o,{mt:308,py:24,children:e.jsx(v,{color:"secondary",disabled:r,id:"add-node-submit-cta",onClick:p,size:"large",startIcon:r&&e.jsx(L,{children:e.jsx(T,{color:c.lightGray,size:12})}),type:"submit",variant:"contained",children:"Save Changes"})})]})},W=s(o)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,V=s(w)`
