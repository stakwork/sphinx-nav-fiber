import{o as s,F as o,T as w,p as C,r as f,j as e,q as c,A as S,aU as A,aV as b,aW as z,J as D,O as y}from"./index-e208270f.js";import{B as G}from"./index-a3b1c508.js";import{G as M,B as v,h as $,F as B}from"./index-a0132d12.js";import{C as T}from"./ClipLoader-5c214661.js";import{T as j}from"./index-31f0d6a6.js";import{S as E}from"./index-2d1acf9c.js";import{e as I}from"./index.esm-f4f38bd4.js";import{T as k,a as F}from"./Tabs-eb56b0f8.js";import"./InfoIcon-53e26b42.js";import"./useSlotProps-678efb71.js";import"./createSvgIcon-09eb1cd4.js";const R=({onClose:a})=>{const[l]=C(d=>[d.graphStyle]),[r,i]=f.useState(!1),p=()=>{i(!0),localStorage.setItem("graphStyle",l),i(!1),a()};return e.jsxs(W,{direction:"column",children:[e.jsx(V,{children:"Default graph view:"}),e.jsx(M,{}),e.jsx(o,{mt:308,py:24,children:e.jsx(v,{color:"secondary",disabled:r,id:"add-node-submit-cta",onClick:p,size:"large",startIcon:r&&e.jsx(L,{children:e.jsx(T,{color:c.lightGray,size:12})}),type:"submit",variant:"contained",children:"Save Changes"})})]})},W=s(o)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,V=s(w)`
