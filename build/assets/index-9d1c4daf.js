import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-ccbcf913.js";import{B}from"./index-afd26c51.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-8db1f6ed.js";import{B as f,T as $,a as k}from"./index-a6ae168c.js";import{T as u}from"./index-f2376303.js";import"./useSlotProps-261fbc24.js";import"./index.esm-4d529a46.js";import"./InfoIcon-f9bbc38f.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
