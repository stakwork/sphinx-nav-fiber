import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,x as D,B as F}from"./index-6b6c3d95.js";import{B as M}from"./index-c1fec392.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-8e9c29ed.js";import{B as f,T as L,a as R}from"./index-160368e6.js";import{T as x}from"./index-99571387.js";import"./useSlotProps-47302a76.js";import"./index.esm-71fb7992.js";import"./InfoIcon-f0f4c83e.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
