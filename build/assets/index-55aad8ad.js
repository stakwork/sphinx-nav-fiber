import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-12637ec5.js";import{B}from"./index-96ffccf3.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-4d843604.js";import{B as f,T as $,a as k}from"./index-2e08c4b8.js";import{T as u}from"./index-0701f53b.js";import"./useSlotProps-1342e9e1.js";import"./index.esm-549f4b29.js";import"./InfoIcon-b4bc37bd.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
