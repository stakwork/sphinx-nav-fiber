import{o,F as s,T as g,p as y,j as e,A as b,aT as w,aU as S,q as x,r as T,I as v,N as m}from"./index-4b35c83e.js";import{B as A}from"./index-24ce2fae.js";import{G as C,i as B,F as G}from"./index-67c0da52.js";import{B as f,T as M,a as $}from"./index-e532275e.js";import{T as u}from"./index-943f9fd9.js";import{C as k}from"./ClipLoader-b451caa9.js";import"./useSlotProps-d8b27a34.js";import"./createSvgIcon-08b8911f.js";import"./index.esm-6acdd520.js";import"./InfoIcon-7f571f66.js";const D=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(F,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},F=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
