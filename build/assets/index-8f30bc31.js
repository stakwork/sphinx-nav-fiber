import{s as r,F as n,T as g,j as e,h as w,b as c,r as A,g as B}from"./index-b289d19f.js";import{B as v}from"./index-fd5f6c5e.js";import{u as F}from"./index-910cbaf3.js";import{e as M,X as $,t as C,h as b,z as D,F as k,C as G}from"./react-toastify.esm-4c5c25b4.js";import{B as f,T as R,a as z}from"./index-a8890391.js";import{T as x}from"./index-1bb468a5.js";import"./useSlotProps-8944b131.js";import"./index.esm-4cc9982e.js";import"./InfoIcon-05337e3a.js";const L=({onClose:s})=>{const[a]=M(t=>[t.graphStyle]),i=()=>{localStorage.setItem("graphStyle",a),s()};return e.jsxs(P,{direction:"column",children:[e.jsx(V,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:i,children:"Save changes"})})]})},P=r(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,V=r(g)`
