import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-4c0a1bb6.js";import{B}from"./index-608e37ff.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-4488f51d.js";import{B as f,T as $,a as k}from"./index-1142a538.js";import{T as u}from"./index-3d75b19c.js";import"./useSlotProps-81e9f64a.js";import"./index.esm-0c1f390f.js";import"./InfoIcon-0a1adb78.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
