import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-0dae50cb.js";import{B as M}from"./index-19df1d2f.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-c21829f7.js";import{B as f,T as L,a as R}from"./index-8fe98bb1.js";import{T as x}from"./index-aeeaf39a.js";import"./useSlotProps-51a32987.js";import"./index.esm-f2ec62ae.js";import"./InfoIcon-97243c86.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
