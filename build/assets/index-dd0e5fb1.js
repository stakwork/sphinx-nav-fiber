...
`,Ct=_(k).attrs({align:"center",justify:"center",p:0})`
  position: relative;
  width: 64px;
  height: 58px;
  padding: 0;
...
`,rs=_.div`
  ...
  color: #6b7a8d;
  line-height: 1;
`,as=({onCancel:t})=>{const s=We({mode:"onChange"}),[i,e]=x.useState(!1),[c,a]=x.useState(""),[f,d]=x.useState(!1),[l,y]=x.useState(""),[r,h]=x.useState(""),p=s.watch("type");x.useEffect(()=>{a(p)},[p]);const v=s.handleSubmit(async b=>{if(!r||!l)return;e(!0);const C={source:l,target:r,edge_type:b.type};try{await xo(C)}catch(P){console.warn("API Error:",P)}finally{e(!1),t()}}),O=i||!r||!l||!c;return o.jsx($t,{...s,children:o.jsxs("form",{id:"add-type-form",onSubmit:v,children:[o.jsx(Jn,{isSwapped:f,selectedFromNode:l,selectedToNode:r,selectedType:c,setIsSwapped:()=>d(!f),setSelectedFromNode:y,setSelectedToNode:h}),o.jsxs(cs,{color:"secondary",disabled:O,onClick:v,size:"large",variant:"contained",children:["Confirm",i&&o.jsxs(ls,{children:[" ",o.jsx(xe,{color:R.lightGray,size:12})," "]})]})]})})},cs=_(Oe)`
  width: 293px !important;
  margin: 0 0 10px 35px !important;
`,ls=_.span`
  margin-top: 2px;
`,ds=({setIsAddEdgeNode:t})=>{const s=()=>{t(!1)};return o.jsxs(k,{children:[o.jsx(k,{direction:"row",justify:"flex-end",children:o.jsx(us,{"data-testid":"close-sidebar-sub-view",onClick:s,children:o.jsx(Ue,{})})}),o.jsx(as,{onCancel:s})]})},us=_(k)`
  font-size: 32px;
  color: ${R.white};
  cursor: pointer;
`,ps=()=>{const[t,s]=x.useState(""),[i,e]=x.useState(!1),[c,a]=x.useState(!1),[f,d]=x.useState(!1),[l,y]=x.useState(!1),[r,h,p,v]=zt(m=>[m.schemas,m.links,m.setSchemas,m.setSchemaLinks]);x.useEffect(()=>{(async()=>{a(!0);try{const g=await ht();p(g.schemas.filter(S=>S.ref_id&&!S.is_deleted&&S.ref_id)),v(g.edges),a(!1)}catch(g){console.error("Error fetching data:",g),a(!1)}})()},[p,v]);const O=m=>{if(r.some(S=>S.ref_id===m.ref_id))p(r.map(S=>S.ref_id===m.ref_id?{...m,children:[]}:S));else{p([...r,{...m,children:[]}]);const S=r.find(z=>m.parent===z.type);v([...h,{ref_id:`new-link-${h.length}`,edge_type:"CHILD_OF",source:m.ref_id||"new",target:(S==null?void 0:S.ref_id)||"new"}])}},b=async()=>{const m=await ht();p(m.schemas.filter(g=>g.ref_id&&!g.is_deleted&&g.ref_id)),v(m.edges)},C=m=>{p(r.filter(g=>g.type!==m))},P=r.map(m=>({...m,children:r.filter(g=>g.parent===m.type).map(g=>g.ref_id||"")})),T=h.filter(m=>m.edge_type==="CHILD_OF"&&P.some(g=>g.ref_id===m.source)&&P.some(g=>g.ref_id===m.target)),A=r.find(m=>m.ref_id===t)||null;return c?o.jsx(k,{align:"center",basis:"100%",grow:1,justify:"center",shrink:1,children:o.jsx(xe,{color:R.white})}):o.jsx(o.Fragment,{children:o.jsxs(k,{align:"stretch",direction:"row",grow:1,children:[o.jsx(k,{ml:-20,my:-20,children:o.jsx(Zn,{onAddEdgeNode:()=>{d(!0),e(!1),s("")},onCreateNew:()=>{d(!1),e(!0),s("")}})}),o.jsx(k,{children:A||i?o.jsx(Nt,{children:o.jsx(hs,{children:o.jsx(An,{graphLoading:l,onDelete:C,onSchemaCreate:O,onSchemaUpdate:b,selectedSchema:A,setGraphLoading:y,setIsCreateNew:e,setSelectedSchemaId:s})})}):null}),o.jsx(k,{children:f?o.jsx(Nt,{children:o.jsx(ds,{setIsAddEdgeNode:d})}):null}),o.jsx(fs,{direction:"row",grow:1,children:o.jsx(ms,{children:l?o.jsx(k,{align:"center",basis:"100%",grow:1,justify:"center",shrink:1,children:o.jsx(xe,{color:R.white})}):o.jsx(Xn,{links:T,schemasWithPositions:P,selectedSchemaId:t,setIsAddEdgeNode:d,setSelectedSchemaId:s})})})]})})},fs=_(k)`
  flex: 1 1 auto;
  justify-content: center;
  position: relative;
  overflow: hidden;
...
`,ms=_(k)`
  flex: 1 1 100%;
`,gs=()=>{const{close:t}=Lt("blueprintGraph"),s=()=>{t()};return o.jsx(bo,{background:"black",id:"blueprintGraph",kind:"full",onClose:s,preventOutsideClose:!0,children:o.jsx(ps,{})})},Fs=x.memo(gs);export{Fs as BlueprintModal};
