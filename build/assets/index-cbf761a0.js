import{o as s,F as o,T as w,p as C,r as f,j as e,q as c,A as S,aU as A,aV as b,aW as M,M as z,Q as y}from"./index-9a3f3db1.js";import{B as D}from"./index-8a92ca09.js";import{G,B as v,i as $,F as B}from"./index-ce1b9629.js";import{C as T}from"./ClipLoader-c6e21c15.js";import{T as j}from"./index-39f1abb7.js";import{S as E}from"./index-5d6431f8.js";import{e as I}from"./index.esm-ca179c1a.js";import{T as k,a as F}from"./Tabs-e53b132d.js";import"./InfoIcon-a94c117f.js";import"./useSlotProps-aeb317b1.js";import"./createSvgIcon-9726e760.js";const R=({onClose:a})=>{const[l]=C(d=>[d.graphStyle]),[r,i]=f.useState(!1),p=()=>{i(!0),localStorage.setItem("graphStyle",l),i(!1),a()};return e.jsxs(W,{direction:"column",children:[e.jsx(V,{children:"Default graph view:"}),e.jsx(G,{}),e.jsx(o,{mt:308,py:24,children:e.jsx(v,{color:"secondary",disabled:r,id:"add-node-submit-cta",onClick:p,size:"large",startIcon:r&&e.jsx(L,{children:e.jsx(T,{color:c.lightGray,size:12})}),type:"submit",variant:"contained",children:"Save Changes"})})]})},W=s(o)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,V=s(w)`
