import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-7ef32cb4.js";import{B as F}from"./index-ef5f20bc.js";import{u as M}from"./index-9ed22c96.js";import{j as $,e as k,F as D,C as G}from"./react-toastify.esm-b2ab4bbb.js";import{B as f,T as R,a as L}from"./index-2beba932.js";import{T as x}from"./index-e6ae8043.js";import"./useSlotProps-961e9128.js";import"./index.esm-53a37048.js";import"./InfoIcon-8e3a9b20.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
