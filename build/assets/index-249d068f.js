import{s as i,F as n,T as g,j as e,b as w,c as p,r as A,u as B}from"./index-0da5a7df.js";import{B as v}from"./index-65045ab2.js";import{u as F}from"./index-ccf23d9c.js";import{u as M,G as $,l as C,b,q as D,F as G}from"./react-toastify.esm-46ba9299.js";import{B as f,T as k,a as R}from"./index-ff07707b.js";import{T as x}from"./index-85601322.js";import{C as L}from"./ClipLoader-ff131482.js";import"./useSlotProps-aaa7b2e0.js";import"./index.esm-37caaf02.js";import"./InfoIcon-6afec7fe.js";const P=({onClose:s})=>{const[a]=M(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",a),s()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
