import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-61c60aaf.js";import{B}from"./index-7f8d72b7.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-b9ea12aa.js";import{B as f,T as $,a as k}from"./index-2fbb380f.js";import{T as u}from"./index-b7f4621d.js";import"./useSlotProps-87c77688.js";import"./index.esm-d055e8bc.js";import"./InfoIcon-edbb05e4.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
