import{r as i,j as e,s as u,g as S,F as j,o as X,c as Y,A as oe,p as ie,i as ae,q as ce,H as le,t as pe,v as de}from"./index-0b813395.js";import{t as O,u as H,C as ue}from"./index-f383b645.js";import{U as fe}from"./index-a520a4e4.js";import{u as T,a as me,b as ge,I as he,c as J,d as xe}from"./index-b0a2cb71.js";import{M as ye,V as be}from"./index-bf1871da.js";import{S as we,R as je,s as V,M as ve}from"./index-d63ae980.js";import"./string-a277709d.js";import"./index-342c264a.js";import"./three.module-976f5d36.js";import"./index-832ddf36.js";import"./TextareaAutosize-4a854c6c.js";import"./CheckIcon-da475de7.js";import"./index-99d40e83.js";import"./index-a4a926ea.js";import"./ClipLoader-3121fab9.js";import"./clsx-f6e21d78.js";import"./SourcesTableIcon-bdffb4fc.js";import"./DeleteNodeIcon-17602bc9.js";import"./SoundIcon-3b65da35.js";import"./SucessFeedBackIcon-147b952b.js";import"./Skeleton-ef417ef6.js";import"./index-9e7353a0.js";import"./Stack-9e1d470f.js";import"./FormControlLabel-9135cdb8.js";import"./Typography-3c9c1273.js";import"./createSvgIcon-5e185524.js";import"./isPlainObject-3ef32960.js";const K=i.memo(()=>{const r=T(n=>n.isPlaying),a=T(n=>n.setIsPlaying),s=T(n=>n.setVolume),t=T(n=>n.setPlaybackSpeed),c=T(n=>n.playbackSpeed),o=T(n=>n.playerRef),[d,g]=i.useState(!1),m=[.5,1,1.5,2],h=()=>{if(o){const n=o.getCurrentTime()-15;o.seekTo(n,"seconds")}},f=()=>{if(o){const n=o.getCurrentTime()+15;o.seekTo(n,"seconds")}},w=()=>{a(!r)},p=()=>{g(!d),s(d?1:0)},l=()=>{const x=(m.indexOf(c)+1)%m.length,P=m[x];if(t(P),o){const k=o.getInternalPlayer();k&&typeof k.playbackRate<"u"&&(k.playbackRate=P)}};return e.jsxs(Se,{children:[e.jsx(Pe,{onClick:p,children:d?e.jsx(ye,{}):e.jsx(be,{})}),e.jsx(Ce,{onClick:h,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(ke,{"data-testid":"play-pause-button",onClick:w,size:"small",children:r?e.jsx(me,{"data-testid":"pause-icon"}):e.jsx(ge,{"data-testid":"play-icon"})}),e.jsx(Ie,{onClick:f,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(_e,{onClick:l,children:[c,"x"]})]})});K.displayName="Controls";const Se=u(j).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${S.BG1};
  border-radius: 40px;
