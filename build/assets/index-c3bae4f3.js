import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-ce90e457.js";import{B as F}from"./index-b7e372a2.js";import{u as M}from"./index-6c725456.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-b633f53f.js";import{B as f,T as R,a as L}from"./index-14691ddc.js";import{T as x}from"./index-a1f17014.js";import"./useSlotProps-fa398015.js";import"./index.esm-92cdae54.js";import"./InfoIcon-c84041f8.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
