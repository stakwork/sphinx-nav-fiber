import{r as P,Z as bi,a0 as mt,s as S,b as y,j as s,F as g,T as X,p as $t,g as sr,P as ar,e as ji,q as Ci,z as dn,D as Si,k as vi}from"./index-bc5cffe2.js";import{av as Ei,e as ce,i as Ue,A as me,h as ge,aw as ur,ax as Ti,B as ue,E as Ii,ay as Ai,R as pe,O as Pi,I as cr,T as at,U as pr,az as ut,W as Ht,C as Vt,aA as zi,Y as hr,aB as _i,n as Li,o as Bi}from"./react-toastify.esm-f63251da.js";import{C as dr}from"./CheckIcon-6ed2ec6e.js";import{C as fr}from"./ChevronDownIcon-9f4e3dc3.js";import{d as Oi}from"./ChevronUpIcon-ec82a381.js";import{F as xr,a as Mi,T as Ri}from"./Popover-beb01804.js";import{G as mr,L as Ut,B as Gt,H as Di,M as Fi,R as Ni,a as $i,S as Hi,b as Vi,N as gr,C as Ui,D as yr,c as wr,d as Gi,f as qi,g as kr,e as Yi,P as Wi,h as br,s as fn,V as Qi,F as Xi,E as Zi,i as Ki,j as Ji,k as jr,l as eo}from"./ChevronRightIcon-9a6b436e.js";import{S as to}from"./index-70b89e27.js";import{f as rt,o as Cr,n as no,X as ro,Y as io,T as oo,D as lo,S as qt,q as Sr}from"./generateCategoricalChart-c51da526.js";import{T as We}from"./index-4dc93e7e.js";import{S as so}from"./Skeleton-9785ef40.js";import{g as ao,d as uo}from"./index.esm-12894123.js";import{I as co,S as po,O as ho}from"./Select-6ccb9801.js";import{I as fo}from"./InfoIcon-d8810c25.js";import{P as xo}from"./PlusIcon-7cf746b8.js";import{u as Pt}from"./index-8545cbb8.js";import{B as mo}from"./index-d967afb5.js";import"./index-cff0db1a.js";import"./useSlotProps-46cc50c8.js";const go=(e,t="down")=>{const n=Ei(),[r,i]=P.useState(!1),o=n.breakpoints[t](e).split("@media")[1].trim();return P.useEffect(()=>{const l=()=>{const{matches:a}=window.matchMedia(o);i(a)};return l(),window.addEventListener("resize",l),()=>window.removeEventListener("resize",l)},[o]),r},yo=e=>e.filter(t=>t.tldr).length>=2&&e.some(t=>t.audio_EN);function wo(e){return e.tldr_topic??e.topic}var it=globalThis&&globalThis.__assign||function(){return it=Object.assign||function(e){for(var t,n=1,r=arguments.length;n<r;n++){t=arguments[n];for(var i in t)Object.prototype.hasOwnProperty.call(t,i)&&(e[i]=t[i])}return e},it.apply(this,arguments)},ko=globalThis&&globalThis.__rest||function(e,t){var n={};for(var r in e)Object.prototype.hasOwnProperty.call(e,r)&&t.indexOf(r)<0&&(n[r]=e[r]);if(e!=null&&typeof Object.getOwnPropertySymbols=="function")for(var i=0,r=Object.getOwnPropertySymbols(e);i<r.length;i++)t.indexOf(r[i])<0&&Object.prototype.propertyIsEnumerable.call(e,r[i])&&(n[r[i]]=e[r[i]]);return n},bo=bi("BeatLoader","50% {transform: scale(0.75);opacity: 0.2} 100% {transform: scale(1);opacity: 1}","beat");function jo(e){var t=e.loading,n=t===void 0?!0:t,r=e.color,i=r===void 0?"#000000":r,o=e.speedMultiplier,l=o===void 0?1:o,a=e.cssOverride,c=a===void 0?{}:a,u=e.size,p=u===void 0?15:u,d=e.margin,f=d===void 0?2:d,h=ko(e,["loading","color","speedMultiplier","cssOverride","size","margin"]),w=it({display:"inherit"},c),k=function(T){return{display:"inline-block",backgroundColor:i,width:mt(p),height:mt(p),margin:mt(f),borderRadius:"100%",animation:"".concat(bo," ").concat(.7/l,"s ").concat(T%2?"0s":"".concat(.35/l,"s")," infinite linear"),animationFillMode:"both"}};return n?P.createElement("span",it({style:w},h),P.createElement("span",{style:k(1)}),P.createElement("span",{style:k(2)}),P.createElement("span",{style:k(3)})):null}const Co=()=>{var d;const[e,t]=P.useState(null),{sidebarFilter:n,setSidebarFilter:r,sidebarFilterCounts:i}=ce(f=>f),o=n==="undefined"?"Other":n,l=((d=i.find(f=>f.name===o))==null?void 0:d.count)||0,a=f=>f?f.charAt(0).toUpperCase()+f.slice(1):"",c=f=>{t(f.currentTarget)},u=()=>{t(null)},p=f=>{r(f),u()};return s.jsxs("div",{children:[s.jsxs(So,{onClick:c,children:[s.jsx("div",{className:"text",children:"Show"}),s.jsx("div",{className:"value","data-testid":"value",children:`${a(o)} (${l})`}),s.jsx("div",{className:"icon",children:e?s.jsx(Oi,{}):s.jsx(fr,{})})]}),s.jsx(Eo,{anchorEl:e,anchorOrigin:{vertical:"bottom",horizontal:"left"},anchorPosition:{top:62,left:0},onClose:u,open:!!e,transformOrigin:{vertical:"top",horizontal:"left"},children:s.jsx(xr,{children:i.map(({name:f,count:h})=>s.jsxs(vo,{className:Ue({active:f===n}),onClick:()=>p(f),children:[s.jsx("span",{className:"icon",children:f===n?s.jsx(dr,{}):null}),s.jsx("span",{children:`${a(f)} (${h})`})]},f))})})]})},So=S(g).attrs({direction:"row",align:"center"})`
  cursor: pointer;
  flex-grow: 1;
  color: ${y.GRAY6};
  font-family: Barlow;
...
`;const ll=48,sl=8,al={PaperProps:{style:{maxHeight:ll*4.5+sl,width:250}}},ul=["Beginner","Intermediate","Advanced","Expert"],cl=()=>{const e=ce(C=>C.data),[t,n]=P.useState(""),[r,i]=P.useState("Beginner"),o=ge(C=>C.currentSearch),l=Ii(),[a]=sr(C=>[C.setBudget]),[c,u,p,d,f]=Cr(C=>[C.askedQuestions,C.askedQuestionsAnswers,C.setAskedQuestion,C.setAskedQuestionAnswer,C.hasQuestionInProgress]),h=P.useCallback(C=>{d(C.answer)},[d]);P.useEffect(()=>{l&&h&&l.on("askquestionhook",h)},[h,l]);const w=async()=>{t&&(p(t),n(""));try{const C=e==null?void 0:e.nodes.filter(M=>M.text),I=C==null?void 0:C.slice(0,5),F=(I!=null&&I.length?I.map(M=>M.text).join(" "):"").substring(0,2500).replace(/[?&=+/#]/g,M=>`\\${M}`);o&&(await ji.enable(),await Ai({expertise_level:r,question_text:t,search_term:o,transcripts:F},a),await Ci(a))}catch(C){console.error(C)}},k=r&&t.trim()&&!f,T=C=>{i(C.target.value)},b=async C=>{if(f){C.preventDefault();return}C.keyCode===13&&C.shiftKey===!1&&k&&(C.preventDefault(),w())};return s.jsxs(pl,{children:[s.jsx(g,{children:s.jsx(g,{children:s.jsxs(xr,{component:"div",children:[s.jsx(dl,{id:"select-label",size:"small",children:"Expertise level"}),s.jsx(fl,{id:"demo-multiple-name",input:s.jsx(ho,{label:"Expertise level"}),labelId:"select-label",MenuProps:al,onChange:T,size:"small",value:r,children:ul.map(C=>s.jsx(Fi,{component:"li",value:C,children:C},C))})]})})}),s.jsx(gl,{children:c==null?void 0:c.map((C,I)=>s.jsxs(g,{className:"response",py:12,children:[s.jsx(X,{kind:"medium",children:C}),s.jsx(g,{py:12,children:(u==null?void 0:u[I])!==void 0?s.jsx(X,{color:"unreadMsgText",children:u[I]}):s.jsxs(g,{align:"center",py:12,children:[s.jsx(g,{align:"center",py:12,children:s.jsx(ar,{color:y.white})}),s.jsx(g,{align:"center",py:12,children:s.jsx(X,{children:"Generating response"})})]})})]},C))}),s.jsxs(xl,{onKeyDown:b,py:12,tabIndex:-1,children:[s.jsx(hl,{disabled:f,onChange:C=>n(C.target.value),placeholder:"Enter your question",value:t}),s.jsx(ml,{children:s.jsx(ao,{color:k?y.white:y.gray300,size:"18"})})]})]})},pl=S.div`
  margin-top: 20px;
`,hl=S(Ri)`
...
`,xn=({text:e})=>s.jsxs(g,{align:"center",justify:"center",py:12,children:[s.jsx(g,{align:"center",py:12,children:s.jsx(ar,{color:y.white})}),s.jsx(g,{align:"center",py:12,children:s.jsx(X,{children:e})})]}),yl=()=>{const[e,t,n,r]=Cr(o=>[o.teachMeAnswer,o.hasTeachingInProgress,o.instgraphAnswser,o.hasInstagraphInProgress]),i=!r&&!!(n!=null&&n.edges)&&!!(n!=null&&n.nodes);return s.jsxs(s.Fragment,{children:[i?s.jsx(Ni,{edges:n==null?void 0:n.edges,nodes:n==null?void 0:n.nodes}):s.jsx(xn,{text:"Generating instagraph"}),t?s.jsx(xn,{text:"Generating tutorial"}):s.jsxs(s.Fragment,{children:[s.jsx(wl,{children:s.jsx(X,{children:e})}),s.jsx(cl,{})]})]})};S(ue)``;const wl=S(g)`
  padding-left: 10px;
  padding-right: 10px;
...
`;function pt(e,t){if(!(t!=null&&t.trim()))return e;const n=new RegExp(`(${t})`,"gi"),r=e.split(n);return s.jsx(s.Fragment,{children:r.map((i,o)=>n.test(i)?s.jsx(Cl,{children:i},o):i)})}const Cl=S.span`
  ...
  border-radius: 3px;
  color: inherit;
`,Sl=({stateless:e,node:t,searchTerm:n})=>s.jsxs(g,{grow:1,shrink:1,children:[s.jsx(El,{children:e&&s.jsxs(vl,{children:[s.jsx("div",{className:"icon",children:s.jsx(gr,{})}),s.jsx("div",{className:"title",children:"Description"})]})}),s.jsx(X,{children:t!=null&&t.description?pt(t.description,n):"..."})]}),vl=S(g).attrs({direction:"row",align:"center"})`
  .icon {
    font-size: 16px;
    color: ${y.GRAY3};
    margin-right: 7px;
...
`,Il=({stateless:e,node:t})=>{var k;const[n,r]=ge(T=>[T.transcriptIsOpen,T.setTranscriptOpen]),[i,o]=P.useState(!1),[l,a]=P.useState(""),[c,u]=P.useState(!1);if(!e&&!n)return null;const p="https://knowledge-graph.sphinx.chat",d=async T=>{try{const b=await fetch(`${p}/node/text/${T}`);if(!b.ok)throw new Error("Network response was not ok");const C=await b.json();a(C.data.text),u(!0)}catch(b){console.error("Error fetching full transcript",b)}},f=()=>{w(t==null?void 0:t.text),setTimeout(()=>{o(!1)},2e3)},h=()=>{c?u(!1):t!=null&&t.ref_id&&d(t.ref_id)},w=T=>{T!==void 0&&(navigator.clipboard.writeText(T),o(!0))};return s.jsxs(g,{grow:1,shrink:1,children:[s.jsxs(Pl,{children:[e&&s.jsxs(Al,{children:[s.jsx("div",{className:"icon",children:s.jsx(gr,{})}),s.jsx("div",{className:"title",children:"Transcript"})]}),t!=null&&t.text?s.jsx(s.Fragment,{children:i?s.jsxs(Ll,{align:"center",direction:"row",justify:"flex-start",children:[s.jsx("div",{className:"icon",children:s.jsx(dr,{})}),s.jsx("div",{className:"text",children:"Copied"})]}):s.jsx(ue,{endIcon:s.jsx(Ui,{}),onPointerDown:()=>f(),size:"small",variant:"outlined",children:"Copy"})}):s.jsx("div",{}),!e&&s.jsx(zl,{onClick:()=>{r(!1)},children:s.jsx(uo,{fontSize:35})})]}),s.jsxs(_l,{children:[c?l:`${(k=t==null?void 0:t.text)==null?void 0:k.substring(0,100)}...`,s.jsx(Tl,{onClick:h,children:c?"less":"more"})]})]})},Al=S(g).attrs({direction:"row",align:"center"})`
  .icon {
    font-size: 16px;
    color: ${y.GRAY3};
    margin-right: 7px;
...
`,Er=({node:e})=>{const t=ce(k=>k.selectedNode),n=ge(k=>k.currentSearch),{link:r,image_url:i,date:o,boost:l,node_type:a,type:c,id:u,show_title:p,episode_title:d,ref_id:f}=e||t||{},[h,w]=P.useState(l||0);return t?s.jsx("div",{style:{overflow:"auto",flex:1,width:"100%"},children:s.jsxs(Bl,{children:[s.jsx(Ml,{boostCount:h||0,date:o||0,episodeTitle:rt(d),imageUrl:i,isSelectedView:!0,link:r,onClick:()=>null,showTitle:p,type:a||c}),s.jsx(yt,{}),s.jsxs(Ol,{children:[s.jsx(Gt,{amt:h}),s.jsx(wr,{content:t,count:h,refId:f,updateCount:w})]}),s.jsx(yt,{}),s.jsx(mn,{children:s.jsx(Sl,{node:t,searchTerm:n,stateless:!0})}),s.jsx(yt,{}),s.jsx(mn,{children:s.jsx(Il,{node:t,stateless:!0},u)})]})}):null},Bl=S(g)`
  flex: 1;
  min-height: 100%;
  flex-direction: column;
...
`,ns=()=>{const e=pe(),t=Sr(),[n,r]=P.useState(null),[i,o]=P.useState(null),[l,a,c]=at(f=>[f.playingNode,f.setPlayingNodeLink,f.setPlayingTime]),u=P.useMemo(()=>kr((t==null?void 0:t.nodes)||[],e),[t==null?void 0:t.nodes,e]),p=P.useMemo(()=>t==null?void 0:t.nodes.find(f=>f.node_type==="show"&&f.show_title===(e==null?void 0:e.show_title)),[t==null?void 0:t.nodes,e]),d=P.useCallback(f=>{var h;l&&f.link&&(l==null?void 0:l.link)!==f.link&&a(f.link),c(pr(((h=f==null?void 0:f.timestamp)==null?void 0:h.split("-")[0])||"00:00:01")),o(f)},[l,a,o,c]);return P.useEffect(()=>{u!=null&&u.length&&!u.some(f=>f.ref_id===(i==null?void 0:i.ref_id))&&d(u[0])},[u,i,d]),e?s.jsx("div",{style:{overflow:"auto",flex:1,width:"100%"},children:s.jsxs(is,{children:[n&&s.jsx(os,{className:"slide-me",direction:"up",in:!!n,children:s.jsxs(rs,{children:[s.jsx(g,{className:"close-info",onClick:()=>r(null),children:s.jsx(fr,{})}),n&&s.jsx(Er,{node:n})]})}),s.jsx(Dl,{selectedNodeShow:p}),!!(u!=null&&u.length)&&s.jsx(ts,{children:s.jsx(g,{pb:20,children:u==null?void 0:u.map((f,h)=>s.jsx(Jl,{isSelected:(i==null?void 0:i.ref_id)===f.ref_id,onClick:()=>d(f),setOpenClip:r,timestamp:f},`${f.episode_title}_${h}`))})})]})}):null},rs=S(g)`
  border-radius: 20px;
  overflow: hidden;
  height: 100%;
...
`,Ts=()=>{const e=pe();if(!e)return null;const{name:t}=e;return s.jsx(g,{align:"flex-start",basis:"100%",direction:"column",grow:1,justify:"center",shrink:1,children:s.jsx(Is,{grow:1,justify:"flex-start",p:12,shrink:1,children:s.jsxs(g,{children:[s.jsx(X,{color:"primaryText1",kind:"regular",children:"Name:"}),s.jsx(X,{color:"primaryText1",kind:"regular",children:t})]})})})},Is=S(g)`
  overflow: auto;
`,As=()=>{var a,c;const[e,t]=P.useState(!1),n=pe(),r=!!(n!=null&&n.source_link),i=P.useRef(null),o=ge(u=>u.currentSearch),l=u=>{u.stopPropagation(),u.currentTarget.blur(),t(!e)};return P.useEffect(()=>{var u,p;e?(u=i.current)==null||u.play():(p=i.current)==null||p.pause()},[e]),s.jsxs(g,{align:"flex-start",basis:"100%",direction:"column",grow:1,justify:"center",pt:r?62:0,shrink:1,children:[r&&s.jsxs(Ps,{children:[s.jsx(mr,{color:y.GRAY6}),s.jsx(Ls,{children:n==null?void 0:n.source_link}),s.jsx(zs,{href:`${n==null?void 0:n.source_link}?open=system`,onClick:u=>u.stopPropagation(),target:"_blank",children:s.jsx(Ut,{})})]}),(a=n==null?void 0:n.audio)!=null&&a.length?s.jsxs(g,{justify:"flex-start",p:12,children:[s.jsx(ue,{onClick:u=>l(u),startIcon:e?s.jsx(ut,{}):s.jsx(Ht,{}),children:e?"Pause":"Play"}),s.jsx(Bs,{ref:i,src:((c=n.audio[0])==null?void 0:c.link)||"",children:s.jsx("track",{kind:"captions"})})]}):null,s.jsx(_s,{grow:1,justify:"flex-start",p:12,shrink:1,children:s.jsx(X,{color:"primaryText1",kind:"regular",children:pt((n==null?void 0:n.text)||"",o)})})]})},Ps=S(g)`
  top: 0px;
  position: absolute;
