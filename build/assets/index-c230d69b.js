...
`;U.displayName="WebTextInput";const ae=I.forwardRef(({autoComplete:e=O.autoComplete,autoFocus:r,className:t,colorName:n=O.colorName,dataTestId:o,defaultValue:i,disabled:s=O.disabled,id:u,maxLength:f=O.maxLength,name:p,onBlur:l,onChange:a,onFocus:c,onKeyDown:h,placeholder:w=O.placeholder,placeholderTextColor:g=O.placeholderTextColor,textAlign:d=O.textAlign,type:E=O.type,value:y},C)=>{const F=I.useCallback(M=>{a&&a(M.target.value)},[a]);return P.jsx(U,{ref:C,autoComplete:e,autoFocus:r,className:t,colorName:n,"data-testid":o,defaultValue:i,disabled:s,id:u,maxLength:f,name:p,onBlur:l,onChange:F,onFocus:c,onKeyDown:h,placeholder:w,placeholderTextColor:g,spellCheck:!1,textAlign:d,type:E,value:y})});ae.displayName="BaseTextInput";const Me=e=>e.hasError?S.primaryRed:e.hasContent||e.isFocused||e.isHovered?S.primaryBlue:"transparent",Ae=N(L)`
...
`,Te=N.textarea`
  ...
  text-align: left;
`,Ne=({id:e,dataTestId:r,label:t,mask:n="",message:o,name:i,rules:s,showMask:u=!1,maskPlaceholder:f=null,isTextArea:p=!1,placeholder:l="",maxLength:a,...c})=>{const{register:h,control:w,formState:{errors:g},getValues:d}=he()||{},E=ge(g,i),y=d(i),[C,F]=I.useState(!1),[M,A]=I.useState(!1);return I.useEffect(()=>{const V=document.getElementById(e);V&&V.focus()},[e]),P.jsxs(L,{shrink:1,children:[P.jsxs(L,{align:"center",direction:"row",children:[t&&P.jsx(Ie,{htmlFor:e,children:t}),o&&P.jsxs(Re,{name:i,role:"tooltip",children:[P.jsx(ve,{}),P.jsx("div",{className:"tooltip",children:o})]})]}),P.jsx(Ae,{hasContent:!!y,hasError:!!E,isFocused:C,isHovered:M,onMouseEnter:()=>A(!0),onMouseLeave:()=>A(!1),children:P.jsx(me,{control:w,...h(i),render:({field:{onBlur:V,onChange:T,value:D,ref:$}})=>{const{disabled:v=O.disabled,textAlign:m=O.textAlign}=c;return p?P.jsx(Te,{ref:$,"data-testid":r,disabled:v,id:e,maxLength:a,onBlur:()=>{F(!1),V()},onChange:T,onFocus:()=>F(!0),placeholder:l,value:D||""}):n?P.jsx(Le,{alwaysShowMask:u,disabled:!1,inputRef:$,mask:n,...h(i),maskPlaceholder:f,onBlur:V,onChange:T,value:D,children:P.jsx(U,{colorName:"white","data-testid":r,disabled:v,...h(i),id:e,onBlur:()=>F(!1),onFocus:()=>F(!0),placeholderTextColor:"inputPlaceholder",textAlign:m})}):P.jsx(ae,{...c,colorName:"white",dataTestId:r,id:e,...h(i),onBlur:()=>{F(!1),V()},onChange:T,onFocus:()=>F(!0),placeholder:l,placeholderTextColor:"inputPlaceholder",value:D||""})},rules:s})}),E&&P.jsx(L,{pl:4,pt:8,shrink:1,tabIndex:0,children:P.jsx(pe,{color:"primaryRed",kind:"regularBold",children:P.jsxs(L,{align:"center",direction:"row",shrink:1,children:[P.jsx(xe,{fontSize:18}),P.jsx(L,{pl:4,shrink:1,children:E.message!==""?E.message:"Please enter a valid URL"})]})})})]})};export{ae as B,Ne as T};
