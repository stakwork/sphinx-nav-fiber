import{g as Bt,a as Ot,s as Oe,c as at,_ as me,r as f,u as Mt,b as zt,j as e,d as Dt,e as Rt,F as p,T as S,f as d,h,i as re,k as ne,l as X,m as F,n as Ft,S as Wt,o as Vt,p as Ut,q as lt,t as ct,v as We,Y as Ve,R as Ue,w as Gt,x as de,y as Ht,z as dt,A as Yt,B as Zt,C as Kt,D as je,E as qt,G as Xt,H as N,I as Qt,J as Jt,K as er,L as tr,M as rr,N as nr,O as or,P as pt,Q as sr,U as ir}from"./index-6e8bad83.js";import{A as ar,a as ht,C as I,u as lr,B as G,I as V,b as Q,S as Me,c as pe,F as he,Q as cr,d as dr,G as pr,L as hr,v as ur}from"./react-toastify.esm-3a360dcb.js";import{f as Ge,G as xr,u as fr,c as He,D as ut,a as mr,E as gr,L as Se,b as xe,C as yr,A as jr,i as ie,d as br,e as Ee,g as Cr,h as vr,j as xt,k as Ye,l as wr,X as ft,Y as mt,m as Sr,n as _r,T as Tr,P as kr,S as Ar,o as Lr,p as $r}from"./generateCategoricalChart-0a438eaa.js";import{M as Er,a as Ir,b as Pr,c as Nr,d as gt,e as Br}from"./index.esm-bc67c355.js";import{T as Or,a as J,b as Mr,F as Ie,M as be,C as yt,N as zr,c as Dr,D as Rr}from"./NoFilterResultIcon-2c048380.js";import{s as ee,T as jt,u as O,A as ze,I as Fr,E as Wr,D as Vr,a as Ze,b as bt,Q as Ct,V as vt,S as Ur}from"./index-d363dcc8.js";import{P as De,I as Re,a as wt}from"./Popover-553ef027.js";import{B as Gr,T as le}from"./index-19b3fdb0.js";import{u as U}from"./index-3b4e56fc.js";import{B as Fe}from"./index-ca94c6d7.js";import{e as Hr,A as St,T as _t,S as Yr}from"./index-1d8a6231.js";import{P as Zr}from"./Popper-023ba167.js";import{C as Tt}from"./CheckIcon-126c62a6.js";import{P as Kr}from"./PlusIcon-23d24d15.js";import{T as qr,a as Xr,B as kt}from"./index-57f59967.js";function Qr(t){return Bt("MuiTypography",t)}Ot("MuiTypography",["root","h1","h2","h3","h4","h5","h6","subtitle1","subtitle2","body1","body2","inherit","button","caption","overline","alignLeft","alignRight","alignCenter","alignJustify","noWrap","gutterBottom","paragraph"]);const Jr=["align","className","component","gutterBottom","noWrap","paragraph","variant","variantMapping"],en=t=>{const{align:r,gutterBottom:o,noWrap:n,paragraph:i,variant:l,classes:a}=t,s={root:["root",l,t.align!=="inherit"&&`align${at(r)}`,o&&"gutterBottom",n&&"noWrap",i&&"paragraph"]};return Rt(s,Qr,a)},tn=Oe("span",{name:"MuiTypography",slot:"Root",overridesResolver:(t,r)=>{const{ownerState:o}=t;return[r.root,o.variant&&r[o.variant],o.align!=="inherit"&&r[`align${at(o.align)}`],o.noWrap&&r.noWrap,o.gutterBottom&&r.gutterBottom,o.paragraph&&r.paragraph]}})(({theme:t,ownerState:r})=>me({margin:0},r.variant==="inherit"&&{font:"inherit"},r.variant!=="inherit"&&t.typography[r.variant],r.align!=="inherit"&&{textAlign:r.align},r.noWrap&&{overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},r.gutterBottom&&{marginBottom:"0.35em"},r.paragraph&&{marginBottom:16})),Ke={h1:"h1",h2:"h2",h3:"h3",h4:"h4",h5:"h5",h6:"h6",subtitle1:"h6",subtitle2:"h6",body1:"p",body2:"p",inherit:"p"},rn={primary:"primary.main",textPrimary:"text.primary",secondary:"secondary.main",textSecondary:"text.secondary",error:"error.main"},nn=t=>rn[t]||t,on=f.forwardRef(function(r,o){const n=Mt({props:r,name:"MuiTypography"}),i=nn(n.color),l=Hr(me({},n,{color:i})),{align:a="inherit",className:s,component:c,gutterBottom:u=!1,noWrap:g=!1,paragraph:x=!1,variant:m="body1",variantMapping:y=Ke}=l,j=zt(l,Jr),b=me({},l,{align:a,color:i,className:s,component:c,gutterBottom:u,noWrap:g,paragraph:x,variant:m,variantMapping:y}),C=c||(x?"p":y[m]||Ke[m])||"span",_=en(b);return e.jsx(tn,me({as:C,ref:o,ownerState:b,className:Dt(_.root,s)},j))}),qe=on;function Pe(t){const r=new Date(Number(t)*1e3),o=r.getFullYear(),n=(1+r.getMonth()).toString().padStart(2,"0");return`${r.getDate().toString().padStart(2,"0")}/${n}/${o}`}const sn=({twitterHandle:t})=>e.jsx(e.Fragment,{children:e.jsx(p,{direction:"row",children:e.jsx(p,{align:"flex-start",pb:12,children:e.jsxs(S,{children:["Tweet by @",t]})})})}),an=d(p)(({theme:t})=>({position:"absolute",top:"65px",right:"55px",width:"300px",pointerEvents:"none",background:h.dashboardHeader,boxShadow:"0px 1px 6px rgba(0, 0, 0, 0.1)",color:h.primaryText1,zIndex:100,transition:"opacity 0.6s",padding:t.spacing(2,3),[t.breakpoints.down("sm")]:{padding:t.spacing(1,1.5)}})),ln=d(p)`
  width: 22.5%;
`,cn=({node:t})=>{if(!t)return null;const{node_type:r,show_title:o,episode_title:n,description:i,label:l,text:a,type:s,twitter_handle:c}=t,u=t.guests;let g=!1,x=!1;u&&(u.length&&u[0]!==null&&(g=!0),typeof u[0]=="object"&&(x=!0));let m=t.image_url;if(s==="twitter_space"&&(m="twitter_placeholder.png"),m==null)switch(r){case"guest":m="person_placeholder2.png";break;default:m="noimage.jpeg"}return r==="topic"?null:e.jsx(an,{borderRadius:8,px:24,py:16,children:r==="tweet"?e.jsx(sn,{twitterHandle:c}):e.jsxs(e.Fragment,{children:[e.jsxs(p,{direction:"row",children:[e.jsx(ln,{}),e.jsx(p,{align:"flex-start",pb:12,children:e.jsx(S,{children:r==null?void 0:r.toUpperCase()})})]}),e.jsxs(p,{direction:"row",children:[e.jsx(p,{pr:12,children:e.jsx(ar,{src:m,type:"person"})}),e.jsxs("div",{children:[s==="guest"?e.jsxs(p,{direction:"column",children:[e.jsx(S,{children:l}),a&&e.jsx(p,{pt:4,children:e.jsxs(S,{color:"primaryText1",kind:"tiny",children:["@",a]})})]}):e.jsx(S,{color:"primaryText1",kind:"tiny",children:o}),e.jsxs(p,{pt:4,children:[r==="clip"||r==="episode"&&e.jsx(S,{color:"primaryText1",children:"Episode"}),r==="clip"?e.jsx(S,{as:"div",kind:"regularBold",children:Ge(i)}):e.jsx(S,{color:"primaryText1",kind:"tiny",children:n})]}),e.jsxs(p,{pt:12,children:[r==="clip"&&e.jsx(S,{color:"primaryText1",children:"Episode"}),e.jsx(S,{color:"primaryText1",kind:"tiny",children:r==="clip"?n:Ge(i)})]}),g&&e.jsxs(p,{pt:12,children:[e.jsx(S,{color:"primaryText1",children:"People"}),e.jsx(p,{pt:4,children:e.jsx(S,{color:"primaryText1",kind:"tiny",children:x?u.map(y=>y.name?y.name:`@${y.twitter_handle}`).join(", "):u==null?void 0:u.join(", ")})})]})]})]})]})})},dn=()=>{const[t]=re(r=>[r.hoveredNode]);return e.jsxs(pn,{children:[t&&e.jsx("div",{id:"tooltip-portal",children:e.jsx(cn,{node:t})}),e.jsx(ht,{})]})},pn=d("div")(({theme:t})=>({position:"absolute",zIndex:1,top:0,left:0,userSelect:"none",pointerEvents:"none",display:"flex",justifyContent:"flex-end",alignItems:"flex-start",height:"100%",width:"100%",padding:"16px",[t.breakpoints.down("sm")]:{top:50}})),hn=({fullSize:t=!0})=>{const r=ne(o=>o.sidebarIsOpen);return e.jsx(un,{align:"center",className:X({"sidebar-is-open":r&&!t}),justify:"center",children:e.jsx(I,{color:h.SECONDARY_BLUE,size:64})})},un=d(p)`
  position: absolute;
  left: 0;
  right: 0;
  bottom: 0;
  ...
  z-index: 1;
`,xn=f.lazy(()=>F(()=>import("./index-92a8ec17.js"),["assets/index-92a8ec17.js","assets/index-6e8bad83.js","assets/index-3f17fe3b.css","assets/index-ca94c6d7.js","assets/index-3b4e56fc.js","assets/react-toastify.esm-3a360dcb.js","assets/react-toastify-b60658ac.css","assets/index-57f59967.js","assets/useSlotProps-d61c8ba6.js","assets/index-19b3fdb0.js","assets/index.esm-bc67c355.js","assets/InfoIcon-3467a98d.js","assets/index-1d8a6231.js","assets/Popover-553ef027.js","assets/Select-d5ac8f5d.js","assets/Popper-023ba167.js","assets/index-30d16895.js","assets/DeleteIcon-ddc02c6b.js","assets/PlusIcon-23d24d15.js","assets/EditIcon-3958fade.js","assets/NoFilterResultIcon-2c048380.js","assets/dividerClasses-38a67d46.js","assets/generateCategoricalChart-0a438eaa.js","assets/index-d363dcc8.js","assets/CheckIcon-126c62a6.js"]).then(({SettingsModal:t})=>({default:t}))),fn=f.lazy(()=>F(()=>import("./index-d528d938.js"),["assets/index-d528d938.js","assets/index-6e8bad83.js","assets/index-3f17fe3b.css","assets/react-toastify.esm-3a360dcb.js","assets/react-toastify-b60658ac.css","assets/index-ca94c6d7.js","assets/index-3b4e56fc.js","assets/index-0a094972.js","assets/index.esm-bc67c355.js","assets/CheckIcon-126c62a6.js","assets/index-19b3fdb0.js","assets/InfoIcon-3467a98d.js"]).then(({AddContentModal:t})=>({default:t}))),mn=f.lazy(()=>F(()=>import("./index-0e065828.js"),["assets/index-0e065828.js","assets/index-6e8bad83.js","assets/index-3f17fe3b.css","assets/react-toastify.esm-3a360dcb.js","assets/react-toastify-b60658ac.css","assets/index-ca94c6d7.js","assets/index-3b4e56fc.js","assets/index-0a094972.js","assets/index.esm-bc67c355.js","assets/CheckIcon-126c62a6.js","assets/index-19b3fdb0.js","assets/InfoIcon-3467a98d.js","assets/index-30d16895.js","assets/index-1d8a6231.js","assets/Popover-553ef027.js","assets/useSlotProps-d61c8ba6.js","assets/Select-d5ac8f5d.js","assets/Popper-023ba167.js","assets/generateCategoricalChart-0a438eaa.js","assets/NoFilterResultIcon-2c048380.js","assets/dividerClasses-38a67d46.js","assets/index-57f59967.js","assets/index-d363dcc8.js","assets/PlusIcon-23d24d15.js"]).then(({AddItemModal:t})=>({default:t}))),gn=f.lazy(()=>F(()=>import("./index-e8fc227a.js"),["assets/index-e8fc227a.js","assets/index-6e8bad83.js","assets/index-3f17fe3b.css","assets/index-ca94c6d7.js","assets/index-3b4e56fc.js","assets/react-toastify.esm-3a360dcb.js","assets/react-toastify-b60658ac.css","assets/generateCategoricalChart-0a438eaa.js","assets/Popover-553ef027.js","assets/useSlotProps-d61c8ba6.js","assets/InfoIcon-3467a98d.js","assets/index.esm-bc67c355.js","assets/NoFilterResultIcon-2c048380.js","assets/dividerClasses-38a67d46.js","assets/index-57f59967.js","assets/index-d363dcc8.js","assets/index-19b3fdb0.js","assets/index-1d8a6231.js","assets/Select-d5ac8f5d.js","assets/Popper-023ba167.js","assets/CheckIcon-126c62a6.js","assets/PlusIcon-23d24d15.js"]).then(({SourcesTableModal:t})=>({default:t}))),yn=f.lazy(()=>F(()=>import("./index-2ed45e0c.js"),["assets/index-2ed45e0c.js","assets/index-6e8bad83.js","assets/index-3f17fe3b.css","assets/index-ca94c6d7.js","assets/index-3b4e56fc.js","assets/react-toastify.esm-3a360dcb.js","assets/react-toastify-b60658ac.css","assets/index-19b3fdb0.js","assets/index.esm-bc67c355.js","assets/InfoIcon-3467a98d.js","assets/Skeleton-151964c4.js"]).then(({EditNodeNameModal:t})=>({default:t}))),jn=f.lazy(()=>F(()=>import("./index-61c67d06.js"),["assets/index-61c67d06.js","assets/index-6e8bad83.js","assets/index-3f17fe3b.css","assets/index-ca94c6d7.js","assets/index-3b4e56fc.js","assets/react-toastify.esm-3a360dcb.js","assets/react-toastify-b60658ac.css","assets/Skeleton-151964c4.js"]).then(({RemoveNodeModal:t})=>({default:t}))),bn=f.lazy(()=>F(()=>import("./index-519050af.js"),["assets/index-519050af.js","assets/index-6e8bad83.js","assets/index-3f17fe3b.css","assets/index-ca94c6d7.js","assets/index-3b4e56fc.js","assets/react-toastify.esm-3a360dcb.js","assets/react-toastify-b60658ac.css","assets/index-1d8a6231.js","assets/Popover-553ef027.js","assets/useSlotProps-d61c8ba6.js","assets/Select-d5ac8f5d.js","assets/Popper-023ba167.js","assets/index-d363dcc8.js","assets/generateCategoricalChart-0a438eaa.js","assets/InfoIcon-3467a98d.js","assets/index.esm-bc67c355.js","assets/NoFilterResultIcon-2c048380.js","assets/dividerClasses-38a67d46.js","assets/index-57f59967.js","assets/index-19b3fdb0.js","assets/CheckIcon-126c62a6.js","assets/PlusIcon-23d24d15.js"]).then(({AddNodeEdgeModal:t})=>({default:t}))),Cn=()=>e.jsxs(e.Fragment,{children:[e.jsx(mn,{}),e.jsx(fn,{}),e.jsx(xn,{}),e.jsx(yn,{}),e.jsx(jn,{}),e.jsx(gn,{}),e.jsx(bn,{})]}),vn=()=>{const t=ne(r=>r.appMetaData);return t?e.jsxs(wn,{children:[e.jsxs(Sn,{children:[e.jsx(e.Fragment,{children:t.title&&e.jsx(S,{className:"title",color:"white",children:t.title})}),e.jsx(S,{className:"subtitle",children:" Second Brain"})]}),e.jsx(Wt,{})]}):null},wn=d(p).attrs({align:"center",direction:"row",grow:1,justify:"flex-start"})`
  height: 64px;
  position: absolute;
  top: 0px;
  left: 64px;
...
`,Pn=d(p)`
  ...
  flex: 1;
  width: 100%;
`,Nn=({onSearch:t,placeholder:r,activeIcon:o,loadingIcon:n,defaultIcon:i,...l})=>{const[a,s]=f.useState(""),[c,u]=f.useState(!1),g=()=>{s(""),t(""),u(!1)},x=j=>{!j.target.value&&g(),s(j.target.value)},m=j=>{const{value:b}=j.currentTarget;s(b),!c&&(u(!0),setTimeout(()=>{t(b),b||g(),u(!1)},1e3),b||g())},y=()=>c?e.jsx(Je,{children:e.jsx(Te,{type:"button",children:n})}):e.jsx(Je,{children:a?e.jsx(Te,{onClick:g,type:"button",children:o}):e.jsx(Te,{type:"button",children:i})});return e.jsxs(Bn,{children:[e.jsx(On,{autoComplete:"off",autoCorrect:"off",inputProps:{"aria-label":"search sources"},onChange:x,onKeyDown:j=>{j.key==="Enter"&&m(j)},placeholder:r,value:a,...l}),y()]})},Je=d(p)`
  top: -50%;
  right: -3%;
  z-index: 3;
  position: absolute;
...
`,Vn=()=>{const[t,r]=f.useState(!0),[o,n]=f.useState(""),[i,l]=re(x=>[x.sources,x.setSources]),[a]=de(x=>[x.isAdmin]),[s,c]=f.useState("");f.useEffect(()=>{(async()=>{r(!0);try{const m=await ct();l(m.data)}catch(m){console.warn(m)}finally{r(!1)}})()},[l]);const u=x=>{n(o===x||!x?"":x)},g=f.useMemo(()=>i==null?void 0:i.filter(x=>(!o||x.source_type===o)&&(x.source.toLowerCase().startsWith(s.toLowerCase())||x.source.toLowerCase().includes(s.toLowerCase()))),[s,o,i]);return e.jsxs(Un,{align:"stretch",direction:"column",justify:"flex-end",children:[e.jsx(we,{align:"center",direction:"row",justify:"space-between",children:e.jsx(S,{className:"title",children:"Sources for this Graph"})}),e.jsx(Hn,{children:e.jsx(Nn,{activeIcon:e.jsx(Q,{}),defaultIcon:e.jsx(Me,{}),loadingIcon:e.jsx(I,{color:h.PRIMARY_BLUE,size:24}),onSearch:c,placeholder:"Find Source"})}),e.jsxs(p,{className:"filters",direction:"row",pb:16,px:36,children:[e.jsx(ge,{className:X({selected:!o}),onClick:()=>u(""),size:"small",children:"All"}),Object.keys(ee).map(x=>e.jsx(ge,{className:X({selected:x===o}),onClick:()=>u(x),size:"small",children:ee[x]},x))]}),e.jsx(Gn,{align:"center",justify:t?"center":"flex-start",children:t?e.jsx(I,{color:h.white}):e.jsx(Mn,{canEdit:a,data:g})})]})},Un=d(p)`
  flex: 1;
  .title {
    font-size: 20px;
    color: ${h.white};
...
`,co=d.div`
  ...
  color: #6b7a8d;
  line-height: 1;
`,po=({topic:t,onClose:r})=>{const{close:o}=U("addEdge"),[n]=O(C=>[C.data]),i=pe({mode:"onChange"}),[l,a]=f.useState(!1),[s,c]=f.useState(!1),[u,g]=f.useState(""),[x,m]=f.useState(null),y=()=>{r(),o()},j=async()=>{if(!(!x||!n)){c(!0);try{await Zt({from:t.ref_id,to:x==null?void 0:x.ref_id,relationship:u});const{ref_id:C}=t,{ref_id:_}=x;if(n){const k={...n};k[C]={...k[C],edgeList:[...k[C].edgeList,u]},k[_]&&(k[_]={...k[_],edgeList:[...k[_].edgeList,u]}),O.setState({data:k})}y()}catch(C){console.warn(C)}finally{c(!1)}}},b=s||!x||!u;return e.jsx(Fe,{id:"addEdge",kind:"small",onClose:y,preventOutsideClose:!0,children:e.jsxs(he,{...i,children:[e.jsx(Jn,{from:t.name,isSwapped:l,onSelect:m,selectedToNode:x,selectedType:u,setIsSwapped:()=>a(!l),setSelectedType:g}),e.jsxs(G,{color:"secondary",disabled:b,onClick:j,size:"large",variant:"contained",children:["Confirm",s&&e.jsx(I,{color:h.BLUE_PRESS_STATE,size:10})]})]})})},ho=()=>e.jsxs(p,{children:[e.jsx(p,{align:"center",direction:"row",justify:"space-between",mb:18,children:e.jsx(p,{align:"center",direction:"row",children:e.jsx(uo,{children:"Edit topic"})})}),e.jsx(p,{mb:12,children:e.jsx(le,{id:"cy-topic",maxLength:50,name:"name",placeholder:"Add your topic",rules:{...Kt}})})]}),uo=d(S)`
  font-size: 22px;
  font-weight: 600;
  font-family: 'Barlow';
`,xo=({topic:t,onClose:r})=>{const{close:o}=U("editTopic"),[n]=O(y=>[y.data]),i=pe({mode:"onChange"}),{watch:l,setValue:a,reset:s}=i,[c,u]=f.useState(!1);f.useEffect(()=>(t&&a("name",t==null?void 0:t.name),()=>{s()}),[t,a,s]);const g=l("name"),x=()=>{r(),o()},m=async()=>{u(!0);try{if(await je((t==null?void 0:t.ref_id)||"",{name:g.trim()}),n){const y={...n};y[t==null?void 0:t.ref_id].name=g.trim(),O.setState({data:y})}x()}catch(y){console.warn(y)}finally{u(!1)}};return e.jsx(Fe,{id:"editTopic",kind:"regular",onClose:x,preventOutsideClose:!0,children:e.jsxs(he,{...i,children:[e.jsx(ho,{}),e.jsxs(G,{color:"secondary",disabled:c,onClick:m,size:"large",variant:"contained",children:["Save",c&&e.jsx(I,{color:h.BLUE_PRESS_STATE,size:10})]})]})})},fo=({onSelect:t,selectedTopic:r})=>{const[o,n]=f.useState(!1),[i,l]=f.useState(""),[a,s]=f.useState([]),[c,u]=f.useState(!1),g=f.useRef(null);f.useEffect(()=>()=>s([]),[s]);const x=async b=>{const C={is_muted:"False",sort_by:ze,search:b,skip:"0",limit:"1000"};u(!0);try{const _=await qt(C);s(_.data)}catch{s([])}finally{u(!1)}},m=f.useMemo(()=>dt.debounce(x,300),[]),y=b=>{t(b)},j=b=>{if(l(b),!b){s([]);return}b.length>2&&m(b)};return r?e.jsxs(yo,{children:[e.jsx("div",{className:"value",children:r.name}),e.jsx(p,{className:"icon",onClick:()=>t(null),children:e.jsx(Q,{})})]}):e.jsxs(e.Fragment,{children:[e.jsxs(De,{ref:g,component:"form",onSubmit:b=>b.preventDefault(),sx:{p:"2px 4px",display:"flex",alignItems:"center",width:200},children:[e.jsx(Re,{inputProps:{"aria-label":"search topic"},onChange:b=>j(b.target.value),onFocus:()=>n(!0),placeholder:"Search",size:"small",sx:{ml:1,flex:1},value:i}),i&&e.jsxs(e.Fragment,{children:[e.jsx(tt,{"aria-label":"search",onClick:()=>j(""),type:"button",children:e.jsx(Q,{})}),e.jsx(Rr,{orientation:"vertical",sx:{height:28,m:.5}})]}),e.jsx(tt,{"aria-label":"search",type:"button",children:c?e.jsx(I,{color:h.white,size:24}):e.jsx(Me,{})})]}),g.current&&a.length?e.jsx(go,{anchorEl:g.current,open:o,placement:"bottom",children:e.jsx(e.Fragment,{children:a.map(b=>e.jsx(mo,{className:X({active:r===b.ref_id}),onClick:()=>y(b),children:b.name},"option"))})}):null]})},mo=d(p).attrs({direction:"row",align:"center"})`
  font-family: Barlow;
  font-size: 13px;
  font-style: normal;
  font-weight: 500;
...
`,yo=d(p).attrs({direction:"row",justify:"flex-start",align:"center"})`
  .value {
    overflow: hidden;
    text-overflow: ellipsis;
  }
...
`,tt=d(V)`
  font-size: 24px;
`,jo=({from:t,onSelect:r,selectedTopic:o,isSwapped:n,setIsSwapped:i})=>e.jsxs(p,{children:[e.jsx(p,{align:"center",direction:"row",justify:"space-between",mb:18,children:e.jsx(p,{align:"center",direction:"row",children:e.jsx(bo,{children:"Merge topic"})})}),e.jsxs(wo,{swap:n,children:[e.jsx(Co,{children:e.jsx(So,{disabled:!0,label:n?"To":"From",swap:n,value:t})}),e.jsxs(p,{my:16,children:[e.jsx(To,{children:"Type"}),e.jsx(S,{children:"IS AlIAS"})]}),e.jsx(p,{children:e.jsxs(_o,{children:[e.jsx(ko,{children:n?"From":"To"}),e.jsx(fo,{onSelect:r,selectedTopic:o})]})}),e.jsxs(vo,{children:[e.jsx(Ao,{children:e.jsx($t,{})}),e.jsx(Lo,{onClick:i,children:e.jsx(Lt,{})}),e.jsx($o,{children:e.jsx(At,{})})]})]})]}),bo=d(S)`
  font-size: 22px;
  font-weight: 600;
  font-family: 'Barlow';
`,Co=d(p)`
...
`,$e=d.span`
  ...
  gap: 4px;
  align-items: center;
`,ae=d(p).attrs({direction:"row",px:12,py:8})`
  display: flex;
  align-items: center;
...
`,as=f.memo(is),ls=({nodes:t})=>{const{open:r}=U("addContent"),o=async()=>{r()};return!t||(t==null?void 0:t.length)===0?e.jsx(e.Fragment,{children:e.jsxs(cs,{children:[e.jsx(ds,{align:"center",direction:"row",justify:"space-between",children:e.jsx(S,{className:"subtitle",children:"Contribute to the graph by adding content."})}),e.jsx(p,{children:e.jsx(G,{color:"secondary",onClick:o,size:"medium",startIcon:e.jsx(Kr,{}),type:"submit",variant:"contained",children:"Add Content"})})]})}):e.jsxs(be,{component:"table",children:[e.jsx(ve,{children:e.jsxs(J,{component:"tr",children:[e.jsx(v,{className:"empty"}),e.jsx(v,{children:"Date"}),e.jsx(v,{children:"Type"}),e.jsx(v,{children:"Source"}),e.jsx(v,{children:"Status"})]})}),e.jsx("tbody",{children:t==null?void 0:t.map(n=>e.jsx(as,{node:n},n==null?void 0:n.ref_id))})]})},cs=Oe(p)`
  display: flex;
  align-items: center;
  justify-content: center;
  margin: 100px auto;
...
`,ps=()=>{const[t,r]=f.useState([]),[o,n]=f.useState(!0),[i,l]=f.useState(10),[a,s]=f.useState(!0),c={only_content:"true",sort_by:"date",limit:i.toString()},u=async()=>{n(!0);try{const x=await Qt(c);r(x.nodes),n(!1)}catch(x){console.error("Error fetching data:",x),n(!1)}};f.useEffect(()=>{u()},[i]);const g=()=>{l(i+10),u()};return e.jsxs(hs,{direction:"column",justify:"flex-end",children:[e.jsx(we,{align:"center",direction:"row",justify:"space-between",children:e.jsx(S,{className:"title",children:"Content I've added to the graph"})}),e.jsxs(us,{align:"center",justify:o?"center":"flex-start",children:[o?e.jsx(I,{color:h.white}):e.jsx(e.Fragment,{children:e.jsx(ls,{nodes:t})}),o?null:a?e.jsx(G,{onClick:g,size:"medium",children:"Load More"}):e.jsx(xs,{children:"No new nodes available"})]})]})},hs=d(p)`
  flex: 1;
...
`,vs=d(p)`
  min-height: 0;
  flex: 1;
`,fe={required:{message:"The field is required",value:!0}},ws=({initialValues:t})=>{const r=pe({defaultValues:t,mode:"onSubmit"}),{isSubmitting:o}=r.formState,n=r.handleSubmit(async i=>{try{await tr(i)}catch(l){console.warn(l)}});return e.jsx(he,{...r,children:e.jsx("form",{id:"add-node-form",onSubmit:n,children:e.jsxs(e.Fragment,{children:[e.jsxs(p,{children:[e.jsx(p,{pt:12,children:e.jsx(le,{id:"cy-about-title-id",label:"Graph Title",maxLength:50,name:"title",placeholder:"Type graph title here...",rules:{...fe}})}),e.jsx(p,{pt:12,children:e.jsx(le,{id:"cy-about-id",label:"Graph Description",maxLength:50,name:"description",placeholder:"Type graph description here...",rules:{...fe}})}),e.jsx(p,{pt:12,children:e.jsx(le,{id:"cy-about-mission_statement-id",label:"Mission Statement",maxLength:50,name:"mission_statement",placeholder:"Type mission statement here...",rules:{...fe}})}),e.jsx(p,{pt:12,children:e.jsx(le,{id:"cy-about-search_term-id",label:"Search Term",maxLength:50,name:"search_term",placeholder:"Type search term here...",rules:{...fe}})})]}),e.jsx(p,{pt:8,children:o?e.jsx(Ss,{children:e.jsx(I,{color:h.white,size:20})}):e.jsx(kt,{disabled:o,id:"add-node-submit-cta",kind:"big",type:"submit",children:"Save changes"})})]})})})},Ss=d(p).attrs({align:"center",background:"primaryButton",borderRadius:8,justify:"center"})`
  padding: 16px 24px;
  opacity: 0.5;
...
`,ni=d(p)`
  ...
  font-size: 12px;
  opacity: 0.5;
`,oi=f.lazy(()=>F(()=>import("./index-aa615b61.js"),["assets/index-aa615b61.js","assets/index-6e8bad83.js","assets/index-3f17fe3b.css","assets/SourcesTableIcon-7a70562a.js","assets/SettingsIcon-1611798c.js","assets/index-3b4e56fc.js"]).then(({MainToolbar:t})=>({default:t}))),si=f.lazy(()=>F(()=>import("./index-6abe8fc5.js"),["assets/index-6abe8fc5.js","assets/index-6e8bad83.js","assets/index-3f17fe3b.css","assets/index-47aaad76.js","assets/react-toastify.esm-3a360dcb.js","assets/react-toastify-b60658ac.css","assets/generateCategoricalChart-0a438eaa.js","assets/Popover-553ef027.js","assets/useSlotProps-d61c8ba6.js","assets/InfoIcon-3467a98d.js","assets/index-d0b652c1.js","assets/index.esm-bc67c355.js","assets/EditIcon-3958fade.js","assets/PlusIcon-23d24d15.js","assets/index-3b4e56fc.js","assets/NoFilterResultIcon-2c048380.js","assets/dividerClasses-38a67d46.js","assets/index-57f59967.js","assets/index-d363dcc8.js","assets/index-19b3fdb0.js","assets/index-ca94c6d7.js","assets/index-1d8a6231.js","assets/Select-d5ac8f5d.js","assets/Popper-023ba167.js","assets/CheckIcon-126c62a6.js"]).then(({Universe:t})=>({default:t}))),ii=f.lazy(()=>F(()=>import("./index-25e73346.js"),["assets/index-25e73346.js","assets/index-6e8bad83.js","assets/index-3f17fe3b.css","assets/react-toastify.esm-3a360dcb.js","assets/react-toastify-b60658ac.css","assets/CheckIcon-126c62a6.js","assets/ChevronDownIcon-683594b9.js","assets/ChevronUpIcon-5e7511c4.js","assets/Popover-553ef027.js","assets/useSlotProps-d61c8ba6.js","assets/ChevronRightIcon-b44fc7ef.js","assets/Select-d5ac8f5d.js","assets/dividerClasses-38a67d46.js","assets/generateCategoricalChart-0a438eaa.js","assets/InfoIcon-3467a98d.js","assets/index.esm-bc67c355.js","assets/ChevronRightIcon-6125620a.css","assets/index-3332fa06.js","assets/index-d0b652c1.js","assets/Skeleton-151964c4.js","assets/PlusIcon-23d24d15.js","assets/index-3b4e56fc.js","assets/index-ca94c6d7.js"]).then(({SideBar:t})=>({default:t}))),ai=()=>{const[t,r]=de(w=>[w.setBudget,w.setNodeCount]),[o,n]=f.useState(!1),{setSidebarOpen:i,currentSearch:l,setCurrentSearch:a,setRelevanceSelected:s,setTranscriptOpen:c}=ne(w=>w),u=Lr(w=>w.setTeachMeAnswer),{data:g,setData:x,fetchData:m,graphStyle:y,setSelectedNode:j,setCategoryFilter:b}=re(w=>w),C=dr(),_=pe({mode:"onChange"}),k=_.handleSubmit(({search:w})=>{c(!1),j(null),s(!1),a(w),u(""),b(null)}),L=f.useCallback(async()=>{await m(t,{...l?{word:l}:{}}),i(!0),l?await pt(t):j(null)},[m,t,l,i,j]);f.useEffect(()=>{L()},[l,L]);const E=()=>{if(g){n(!0);const w=ir(y,g.nodes);x(w),n(!1)}};f.useEffect(()=>{E()},[y]);const A=f.useCallback(()=>{r("INCREMENT")},[r]);return f.useEffect(()=>(C&&(C.connect(),C.on("connect_error",w=>{console.error("Socket connection error:",w)}),C.on("newnode",A)),()=>{C&&C.off()}),[C,A]),e.jsxs(e.Fragment,{children:[e.jsx(pr,{}),e.jsx(_n,{}),e.jsx(hr,{hidden:!sr}),e.jsx(f.Suspense,{fallback:e.jsx("div",{children:"Loading..."}),children:e.jsxs(ri,{direction:"row",children:[e.jsx($r,{children:e.jsxs(he,{..._,children:[e.jsx(oi,{}),e.jsx(ii,{onSubmit:k}),e.jsx(si,{}),o&&e.jsx(hn,{fullSize:!1}),e.jsx(dn,{}),e.jsx(Qs,{}),e.jsx(vn,{}),e.jsxs(ni,{children:["v",ur]}),e.jsx(ht,{})]})}),e.jsx(Cn,{}),e.jsx(ti,{}),e.jsx(Ln,{})]})})]})},Ti=Object.freeze(Object.defineProperty({__proto__:null,App:ai},Symbol.toStringTag,{value:"Module"}));export{At as A,Po as E,Lt as F,Si as N,dn as O,hn as P,Ce as S,_i as a,v as b,ve as c,Xn as d,ys as e,$t as f,Ti as g,wi as i};
