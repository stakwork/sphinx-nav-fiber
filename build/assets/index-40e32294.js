import{r as i,j as e,s as u,g as h,F as y,o as Z,c as ee,A as pe,p as X,i as de,q as ue,H as me,t as fe,v as he}from"./index-5d91095a.js";import{t as Y,u as F,C as ge}from"./index-03f51b0e.js";import{U as xe}from"./index-ed5a6d89.js";import{u as P,a as ye,b as be,I as we,c as te,d as je}from"./index-0824eecd.js";import{M as ve,V as ke}from"./index-68ee0ada.js";import{S as Se,R as Ce,s as U,M as Te}from"./index-aa58a06e.js";import"./index-d122f1a8.js";import"./string-a277709d.js";import"./index-b7bf02a5.js";import"./three.module-a9c166f5.js";import"./isPlainObject-0a4f165c.js";import"./TextareaAutosize-e0da0eee.js";import"./CheckIcon-675f17ec.js";import"./index-84fa4231.js";import"./index-21ae0fc8.js";import"./index-cbd6f5a8.js";import"./ClipLoader-8427fdc9.js";import"./clsx-8d5121b3.js";import"./SourcesTableIcon-d0f9046e.js";import"./DeleteNodeIcon-636b7b24.js";import"./SoundIcon-afae563b.js";import"./SucessFeedBackIcon-c817e6a8.js";import"./Skeleton-ee2aa5bc.js";import"./index-6bd994fe.js";import"./Stack-456ffbfd.js";import"./FormControlLabel-872f15d2.js";import"./Typography-31f9c371.js";import"./createSvgIcon-710f0773.js";const re=i.memo(()=>{const s=P(a=>a.isPlaying),c=P(a=>a.setIsPlaying),t=P(a=>a.setVolume),r=P(a=>a.setPlaybackSpeed),l=P(a=>a.playbackSpeed),n=P(a=>a.playerRef),[p,g]=i.useState(!1),b=[.5,1,1.5,2],f=()=>{if(n){const a=n.getCurrentTime()-15;n.seekTo(a,"seconds")}},m=()=>{if(n){const a=n.getCurrentTime()+15;n.seekTo(a,"seconds")}},v=()=>{c(!s)},d=()=>{g(!p),t(p?1:0)},o=()=>{const j=(b.indexOf(l)+1)%b.length,C=b[j];if(r(C),n){const E=n.getInternalPlayer();E&&typeof E.playbackRate<"u"&&(E.playbackRate=C)}};return e.jsxs($e,{children:[e.jsx(Re,{onClick:d,children:p?e.jsx(ve,{}):e.jsx(ke,{})}),e.jsx(Ie,{onClick:f,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(Pe,{"data-testid":"play-pause-button",onClick:v,size:"small",children:s?e.jsx(ye,{"data-testid":"pause-icon"}):e.jsx(be,{"data-testid":"play-icon"})}),e.jsx(_e,{onClick:m,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(Ee,{onClick:o,children:[l,"x"]})]})});re.displayName="Controls";const $e=u(y).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${h.BG1};
  border-radius: 40px;
