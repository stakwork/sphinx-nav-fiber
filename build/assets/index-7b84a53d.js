import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,C as B,h as c,r as v,x as C}from"./index-641e204e.js";import{B as F}from"./index-f0a861b6.js";import{u as M}from"./index-b9e548e8.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-1af9f089.js";import{B as f,T as L,a as R}from"./index-508e7d1f.js";import{T as x}from"./index-b4fe9bbe.js";import"./useSlotProps-f59403fc.js";import"./index.esm-677c26b3.js";import"./InfoIcon-e0815edb.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
