import{s as t,g as o,F as a,T as S,r as b,j as e,B as v,l as B,b as $,a as T,b0 as C,b1 as G,b2 as y,n as z,b3 as w,b4 as k,b5 as M,E as j,b6 as D}from"./index-81cc0adb.js";import{u as E,f as R}from"./index-03e41c84.js";import{C as A}from"./ClipLoader-94779f0e.js";import{T as I,a as L}from"./Tabs-9a4ee761.js";import"./createSvgIcon-78b85614.js";const F=()=>(E(R(i=>[i.graphStyle,i.setGraphStyle])),null);t(a).attrs({direction:"row",align:"center",justify:"space-between"})`
  width: 447px;
  height: 48px;
...
`,Q=i=>{const{children:l,value:d,index:r,...c}=i;return d===r?e.jsx(ne,{"aria-labelledby":`simple-tab-${r}`,hidden:d!==r,id:`simple-tabpanel-${r}`,role:"tabpanel",...c,children:l}):null};function X(i){return{id:`simple-tab-${i}`,"aria-controls":`simple-tabpanel-${i}`}}const Z=({onClose:i})=>{const[l,d]=b.useState(0),[r]=T(n=>[n.isAdmin,n.setPubKey]),c=$(n=>n.appMetaData),h=()=>r?"Admin Settings":"Settings",x=({children:n})=>e.jsxs(te,{children:[e.jsx(a,{direction:"row",pt:3,children:e.jsx(se,{"data-testid":"setting-label",children:h()})}),n]}),g=(n,s)=>{d(s)},m=[...r?[{label:"General",component:Y}]:[],{label:"Appearance",component:P}];return e.jsxs(ae,{"data-testid":"settings-modal",direction:"column",children:[e.jsx(x,{children:e.jsx(ee,{"aria-label":"settings tabs",onChange:g,value:l,children:m.map((n,s)=>e.jsx(ie,{disableRipple:!0,label:n.label,...X(s)},n.label))})}),m.map((n,s)=>e.jsx(Q,{index:s,value:l,children:c&&e.jsx(n.component,{initialValues:c,onClose:i})},n.label))]})},ee=t(I)`
  && {
    .MuiTabs-indicator {
      background: ${o.primaryBlue};
    }
