...
`,ir=v.lazy(()=>ke(()=>import("./index-8b36f624.js"),["assets/index-8b36f624.js","assets/index-a2c8d9e8.js","assets/index-b4d03b7b.css","assets/index-5cb2056c.js","assets/SourcesTableIcon-47084140.js","assets/index-3bc9014e.js","assets/CheckIcon-0cb79077.js","assets/DeleteNodeIcon-f4bc9209.js","assets/SoundIcon-7148f7e9.js","assets/SucessFeedBackIcon-d7c64501.js","assets/ClipLoader-40c52708.js","assets/TableRow-39a5e0d9.js"]).then(({TweetAnalyze:e})=>({default:e}))),ar=()=>{const e=$(o=>o.setSelectedTweet),t=$(o=>o.selectedTweet),{tweetId:a}=fe(),[r,n]=v.useState(""),{open:i}=De("tweetAnalyze"),l=(a==null?void 0:a.split("&"))||[],c=o=>{i(),n(o)};return s.jsxs(or,{align:"stretch",basis:"100%",grow:1,shrink:1,children:[l.length>1?s.jsx(sr,{onClick:()=>{c("summary")},children:"Summary Report"}):null,l.map(o=>s.jsx(cr,{className:t===o?"selected":"",onClick:()=>e(o),children:s.jsx(Vt,{handleAnalyzeClick:()=>{c(o)},nodeId:o})},o)),s.jsx(ir,{tweetId:r})]})},sr=f.button`
  width: 100%;
  background: ${y.ANALYTICS_CARD_BG};
  color: ${y.white};
  padding: 16px 16px;
