...
`,jo=d.span`
  margin-top: 2px;
`,yo=()=>e.jsxs(g,{children:[e.jsx(g,{align:"center",direction:"row",justify:"space-between",mb:18,children:e.jsx(g,{align:"center",direction:"row",children:e.jsx(wo,{children:"Edit topic"})})}),e.jsx(g,{mb:12,children:e.jsx(Ot,{id:"cy-topic",maxLength:50,name:"name",placeholder:"Add your topic",rules:{...wt}})})]}),wo=d(_)`
  font-size: 22px;
  font-weight: 600;
  font-family: 'Barlow';
