import{o as s,F as o,T as w,p as C,r as f,j as e,q as c,A as S,aU as A,aV as b,aW as z,J as D,O as y}from"./index-7e126a86.js";import{B as G}from"./index-ce6a3693.js";import{G as M,B as v,h as $,F as B}from"./index-46a586e6.js";import{C as T}from"./ClipLoader-2a2e8e58.js";import{T as j}from"./index-231e1110.js";import{S as E}from"./index-50d62080.js";import{e as I}from"./index.esm-b2f284a8.js";import{T as k,a as F}from"./Tabs-1f01e683.js";import"./InfoIcon-e9e554cf.js";import"./useSlotProps-a44f9b77.js";import"./createSvgIcon-fcad6d72.js";const R=({onClose:a})=>{const[l]=C(d=>[d.graphStyle]),[r,i]=f.useState(!1),p=()=>{i(!0),localStorage.setItem("graphStyle",l),i(!1),a()};return e.jsxs(W,{direction:"column",children:[e.jsx(V,{children:"Default graph view:"}),e.jsx(M,{}),e.jsx(o,{mt:308,py:24,children:e.jsx(v,{color:"secondary",disabled:r,id:"add-node-submit-cta",onClick:p,size:"large",startIcon:r&&e.jsx(L,{children:e.jsx(T,{color:c.lightGray,size:12})}),type:"submit",variant:"contained",children:"Save Changes"})})]})},W=s(o)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,V=s(w)`
