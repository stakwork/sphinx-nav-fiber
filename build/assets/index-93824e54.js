import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-a69a3f4c.js";import{B as M}from"./index-b1f9ac4d.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-a10ef41b.js";import{B as f,T as L,a as R}from"./index-fe61f9ee.js";import{T as x}from"./index-49d2f161.js";import"./useSlotProps-897fde8b.js";import"./index.esm-1210bfcf.js";import"./InfoIcon-1164b0f5.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
