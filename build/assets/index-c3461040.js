import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-243bacb7.js";import{B as F}from"./index-08397a82.js";import{u as M}from"./index-46266415.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-e229b502.js";import{B as f,T as R,a as L}from"./index-3e6920b5.js";import{T as x}from"./index-49667ada.js";import"./useSlotProps-9fa9d517.js";import"./index.esm-af5ef772.js";import"./InfoIcon-b8ce886b.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
