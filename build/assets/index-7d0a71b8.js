import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h as x,r as T,x as v,B as m}from"./index-f14c52f6.js";import{B}from"./index-454a2500.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-7be85797.js";import{B as f,T as $,a as k}from"./index-04666d84.js";import{T as u}from"./index-f98e65fe.js";import"./useSlotProps-6020ee6e.js";import"./index.esm-da72a889.js";import"./InfoIcon-576dab03.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
