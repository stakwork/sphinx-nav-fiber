import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,x as D,B as F}from"./index-add05fa5.js";import{B as M}from"./index-64624ff4.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-ac073886.js";import{B as f,T as L,a as R}from"./index-474d4761.js";import{T as x}from"./index-f569f26e.js";import"./useSlotProps-40587b81.js";import"./index.esm-40911bdd.js";import"./InfoIcon-f87f0f10.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
