import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-14394df5.js";import{B}from"./index-38187ea6.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-fad760e9.js";import{B as f,T as $,a as k}from"./index-f3ed0f96.js";import{T as u}from"./index-e96fb03c.js";import"./useSlotProps-edc11bc0.js";import"./index.esm-e0569e1c.js";import"./InfoIcon-2754c927.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
