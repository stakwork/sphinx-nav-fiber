import{f as y,h as w,F as t,T as S,x as O,r as f,j as e,aX as W,aY as H,D as L,b1 as K,J as X,b2 as Z,B as P,i as Q,aZ as C,W as $,b3 as ee,o as te,a$ as se}from"./index-98fd1490.js";import{B as T,C as D,i as oe,c as re,F as ne}from"./react-toastify.esm-b3e70d0f.js";import{B as ie}from"./index-c53f84d0.js";import{S as ae}from"./index-1cd19c14.js";import{i as ce}from"./index.esm-4b0e6fd5.js";import{C as le}from"./CheckIcon-20f9488b.js";import{p as de}from"./index-30d16895.js";import{T as _}from"./index-8bc7dcda.js";import{n as pe,a as E,b as me,i as xe}from"./index-b63e9dea.js";import{A as ue}from"./index-718ca31c.js";import{c as he}from"./index-64f1c910.js";import"./InfoIcon-52e4d134.js";import"./generateCategoricalChart-013386ba.js";import"./Popover-928c5f23.js";import"./useSlotProps-bf7cabc4.js";import"./NoFilterResultIcon-0e74c9de.js";import"./index-0acee7a9.js";import"./index-bc55caf9.js";import"./PlusIcon-728f6768.js";import"./index-f4a0603a.js";import"./Popper-ad2bbba1.js";const fe=({onClick:o,loading:p,error:c})=>{const u=O(a=>a.budget),[m,s]=f.useState(10),i="node";return f.useEffect(()=>{(async()=>{try{const h=await H(i);s(h.data.price)}catch(h){console.error("cannot fetch",h)}})()},[i]),e.jsxs(t,{children:[e.jsx(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:e.jsx(t,{align:"center",direction:"row",children:e.jsx(we,{children:"Approve Cost"})})}),e.jsxs(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:[e.jsxs(ye,{children:[e.jsx("div",{className:"title",children:"COST"}),e.jsxs("div",{className:"value","data-testid":"check-price",children:[m," sats"]})]}),e.jsxs(ge,{children:[e.jsx("div",{className:"title",children:"BUDGET"}),e.jsxs("div",{className:"value",children:[W(u)," sats"]})]})]}),e.jsx(t,{children:e.jsx(T,{color:"secondary","data-testid":"check-icon",disabled:p||!!c,onClick:o,size:"large",startIcon:p?e.jsx(D,{size:24}):e.jsx(le,{}),type:"submit",variant:"contained",children:"Approve"})}),c?e.jsxs(be,{role:"tooltip",children:[e.jsxs(je,{children:[e.jsx(ce,{fontSize:13}),e.jsx("span",{children:c})]}),e.jsx("div",{className:"tooltip",children:c})]}):null]})},ye=y(t).attrs({direction:"column",align:"space-between",justify:"flex-start"})`
  width: 141px;
  height: 61px;
