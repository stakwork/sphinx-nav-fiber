import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-02dfa4a2.js";import{B as M}from"./index-d3f304eb.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-38d31a46.js";import{B as f,T as L,a as R}from"./index-6a640f5b.js";import{T as x}from"./index-82eace29.js";import"./useSlotProps-15b68baf.js";import"./index.esm-ca635697.js";import"./InfoIcon-aee6b701.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
