import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-12637ec5.js";import{B as M}from"./index-96ffccf3.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-4d843604.js";import{B as f,T as L,a as R}from"./index-2e08c4b8.js";import{T as x}from"./index-0701f53b.js";import"./useSlotProps-1342e9e1.js";import"./index.esm-549f4b29.js";import"./InfoIcon-b4bc37bd.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
