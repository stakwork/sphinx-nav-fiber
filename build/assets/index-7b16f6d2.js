import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-3a3e4220.js";import{B as F}from"./index-dcba3bc0.js";import{u as M}from"./index-9f2e3a81.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-907351a7.js";import{B as f,T as R,a as L}from"./index-b9d52337.js";import{T as x}from"./index-264c1622.js";import"./useSlotProps-3d3bf750.js";import"./index.esm-db881b4b.js";import"./InfoIcon-a8781b05.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
