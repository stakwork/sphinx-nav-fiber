import{o as s,p as l,F as n,q as w,j as e,t as G,v as T,D as S,r as f,B as v,aU as B,aV as b,aW as I,C as A,Q as y}from"./index-7b7b6a63.js";import{B as z}from"./index-249ecc16.js";import{u as D,G as M,C as k,l as E,o as R,B as $,i as W,F}from"./index-89f7d5c3.js";import{C}from"./ClipLoader-de8a7b2d.js";import{T as j}from"./index-ce6cb01e.js";import{S as P}from"./index-8b371ad4.js";import{e as V}from"./index.esm-fcc4717d.js";import{T as L,a as N}from"./Tabs-ca1ff5cb.js";import"./InfoIcon-36540533.js";import"./useSlotProps-539dc266.js";import"./createSvgIcon-2495d767.js";const O={split:e.jsx(M,{}),force:e.jsx(k,{}),sphere:e.jsx(E,{}),earth:e.jsx(R,{})},Y=()=>{const[i,p]=w(D(t=>[t.graphStyle,t.setGraphStyle])),r=t=>{p(t)};return e.jsx(q,{direction:"column",children:G.map(t=>e.jsx(n,{className:T("icon",{active:i===t}),onClick:()=>r(t),children:O[t]},t))})},q=s(n).attrs({direction:"row",align:"center",justify:"space-between"})`
  width: 447px;
  height: 48px;
...
`,H=({onClose:i})=>{const[p]=w(d=>[d.graphStyle]),[r,t]=f.useState(!1),c=()=>{t(!0),localStorage.setItem("graphStyle",p),t(!1),i()};return e.jsxs(U,{direction:"column",children:[e.jsx(_,{children:"Default graph view:"}),e.jsx(Y,{}),e.jsx(n,{mt:308,py:8,children:e.jsx($,{color:"secondary",disabled:r,id:"add-node-submit-cta",onClick:c,size:"large",startIcon:r&&e.jsx(K,{children:e.jsx(C,{color:l.lightGray,size:12})}),type:"submit",variant:"contained",children:"Save Changes"})})]})},U=s(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,_=s(S)`
