import{s as r,F as n,T as g,j as e,h as w,b as c,r as A,g as B}from"./index-27793e43.js";import{B as v}from"./index-17ffc772.js";import{u as F}from"./index-b45b09e1.js";import{u as M,U as $,q as C,e as b,x as D,F as k,C as G}from"./react-toastify.esm-b83b1a00.js";import{B as f,T as R,a as L}from"./index-8951b11f.js";import{T as x}from"./index-50796a31.js";import"./useSlotProps-2ae1512f.js";import"./index.esm-965872a3.js";import"./InfoIcon-048a630f.js";const P=({onClose:s})=>{const[a]=M(t=>[t.graphStyle]),i=()=>{localStorage.setItem("graphStyle",a),s()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:i,children:"Save changes"})})]})},V=r(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=r(g)`
