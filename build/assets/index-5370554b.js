import{o as s,F as o,T as w,p as C,r as f,j as e,q as c,A as S,aU as A,aV as b,aW as z,J as D,O as y}from"./index-f50d1ab5.js";import{B as G}from"./index-cc30c812.js";import{G as M,B as v,i as $,F as B}from"./index-f857b04d.js";import{C as T}from"./ClipLoader-f52b169b.js";import{T as j}from"./index-bd1e0bc6.js";import{S as E}from"./index-4f7525f2.js";import{e as I}from"./index.esm-22240fd2.js";import{T as k,a as F}from"./Tabs-6e4fbac2.js";import"./InfoIcon-89f3f76d.js";import"./useSlotProps-f1483ce3.js";import"./createSvgIcon-c64a52be.js";const R=({onClose:a})=>{const[l]=C(d=>[d.graphStyle]),[r,i]=f.useState(!1),p=()=>{i(!0),localStorage.setItem("graphStyle",l),i(!1),a()};return e.jsxs(W,{direction:"column",children:[e.jsx(V,{children:"Default graph view:"}),e.jsx(M,{}),e.jsx(o,{mt:308,py:24,children:e.jsx(v,{color:"secondary",disabled:r,id:"add-node-submit-cta",onClick:p,size:"large",startIcon:r&&e.jsx(L,{children:e.jsx(T,{color:c.lightGray,size:12})}),type:"submit",variant:"contained",children:"Save Changes"})})]})},W=s(o)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,V=s(w)`
