import{o as s,F as o,T as w,p as C,r as f,j as e,q as c,A as S,aU as A,aV as b,aW as z,J as D,O as y}from"./index-d6bd55af.js";import{B as G}from"./index-9a4028d4.js";import{G as M,B as v,h as $,F as B}from"./index-7611d32d.js";import{C as T}from"./ClipLoader-d8209e3c.js";import{T as j}from"./index-174daea8.js";import{S as E}from"./index-1455048b.js";import{e as I}from"./index.esm-c8b15d3b.js";import{T as k,a as F}from"./Tabs-d9ee24d2.js";import"./InfoIcon-7e73ca64.js";import"./useSlotProps-c8a40689.js";import"./createSvgIcon-9c0dec58.js";const R=({onClose:a})=>{const[l]=C(d=>[d.graphStyle]),[r,i]=f.useState(!1),p=()=>{i(!0),localStorage.setItem("graphStyle",l),i(!1),a()};return e.jsxs(W,{direction:"column",children:[e.jsx(V,{children:"Default graph view:"}),e.jsx(M,{}),e.jsx(o,{mt:308,py:24,children:e.jsx(v,{color:"secondary",disabled:r,id:"add-node-submit-cta",onClick:p,size:"large",startIcon:r&&e.jsx(L,{children:e.jsx(T,{color:c.lightGray,size:12})}),type:"submit",variant:"contained",children:"Save Changes"})})]})},W=s(o)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,V=s(w)`
