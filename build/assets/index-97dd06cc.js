import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,x as D,B as F}from"./index-fb31d390.js";import{B as M}from"./index-7e2f0a96.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-57f40ec2.js";import{B as f,T as L,a as R}from"./index-55fe2d6c.js";import{T as x}from"./index-7a31d9a5.js";import"./useSlotProps-ce20eba7.js";import"./index.esm-519381f7.js";import"./InfoIcon-20459dc9.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
