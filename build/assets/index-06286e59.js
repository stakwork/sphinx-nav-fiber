import{r as o,j as e,s as f,g as v,F as j,o as Y,c as J,A as ie,p as ae,i as ce,q as le,H as pe,t as de,v as ue}from"./index-61b1c9f9.js";import{ClaimsModal as me}from"./index-3cdeb4ee.js";import{U as fe}from"./index-72bd51cb.js";import{t as U,u as G}from"./index-beac8566.js";import{u as M,a as he,b as ge,I as xe,c as K,d as ye}from"./index-4c7ad28b.js";import{M as we,V as be}from"./index-862ffbdc.js";import{S as je,R as ve,s as V,M as Se}from"./index-b6c3f24a.js";import"./string-a277709d.js";import"./index-79bf3be3.js";import"./three.module-0192f2a3.js";import"./isPlainObject-71588dc0.js";import"./TextareaAutosize-06c16b0c.js";import"./CheckIcon-d589cc24.js";import"./index-c8c1137f.js";import"./index-da33e6b5.js";import"./index-78e5856f.js";import"./ClipLoader-ad277083.js";import"./clsx-d1085406.js";import"./SourcesTableIcon-026190c7.js";import"./DeleteNodeIcon-38d26483.js";import"./SoundIcon-ac977acc.js";import"./SucessFeedBackIcon-f8de5613.js";import"./Skeleton-32e84f0f.js";import"./index-dfd68206.js";import"./Stack-db54ffef.js";import"./FormControlLabel-e1fdf4e0.js";import"./Typography-0c1e8cc9.js";import"./createSvgIcon-75708ac9.js";const Q=o.memo(()=>{const r=M(s=>s.isPlaying),i=M(s=>s.setIsPlaying),n=M(s=>s.setVolume),t=M(s=>s.setPlaybackSpeed),c=M(s=>s.playbackSpeed),a=M(s=>s.playerRef),[d,g]=o.useState(!1),y=[.5,1,1.5,2],h=()=>{if(a){const s=a.getCurrentTime()-15;a.seekTo(s,"seconds")}},u=()=>{if(a){const s=a.getCurrentTime()+15;a.seekTo(s,"seconds")}},b=()=>{i(!r)},l=()=>{g(!d),n(d?1:0)},p=()=>{const m=(y.indexOf(c)+1)%y.length,P=y[m];if(t(P),a){const _=a.getInternalPlayer();_&&typeof _.playbackRate<"u"&&(_.playbackRate=P)}};return e.jsxs(ke,{children:[e.jsx(_e,{onClick:l,children:d?e.jsx(we,{}):e.jsx(be,{})}),e.jsx(Ie,{onClick:h,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(Ce,{"data-testid":"play-pause-button",onClick:b,size:"small",children:r?e.jsx(he,{"data-testid":"pause-icon"}):e.jsx(ge,{"data-testid":"play-icon"})}),e.jsx(Pe,{onClick:u,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(Te,{onClick:p,children:[c,"x"]})]})});Q.displayName="Controls";const ke=f(j).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${v.BG1};
  border-radius: 40px;
