import{s as r,F as n,T as g,j as e,h as w,b as c,r as A,g as B}from"./index-0f50bdbb.js";import{B as v}from"./index-592f1d67.js";import{u as F}from"./index-dde0b953.js";import{e as M,X as $,t as C,h as b,z as D,F as k,C as G}from"./react-toastify.esm-d795285c.js";import{B as f,T as R,a as z}from"./index-516ba95a.js";import{T as x}from"./index-5587f6b8.js";import"./useSlotProps-f40772fa.js";import"./index.esm-28dab1a8.js";import"./InfoIcon-5580d469.js";const L=({onClose:s})=>{const[a]=M(t=>[t.graphStyle]),i=()=>{localStorage.setItem("graphStyle",a),s()};return e.jsxs(P,{direction:"column",children:[e.jsx(V,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:i,children:"Save changes"})})]})},P=r(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,V=r(g)`
