import{f as u,h as m,T as w,j as e,F as o,C as V,r,a3 as $,bj as A,D as P,i as q}from"./index-6dca5d13.js";import{B as G}from"./index-15eb1140.js";import{u as f}from"./index-f636bdd9.js";import{c as H,F as O,B as T,C as W}from"./react-toastify.esm-e56106e5.js";import{T as S}from"./index-e074e0be.js";import{S as Y}from"./Skeleton-f69a477a.js";import"./index.esm-03733bc4.js";import"./InfoIcon-a916da3e.js";const B=/^https:\/\/.*\.(png|jpe?g|svg)$/;function E(i){return!!B.test(i)}const J=()=>e.jsxs(o,{children:[e.jsx(o,{align:"center",direction:"row",justify:"space-between",mb:18,children:e.jsx(o,{align:"center",direction:"row",children:e.jsx(K,{children:"Edit Node"})})}),e.jsxs(o,{mb:18,children:[e.jsx(b,{style:{marginBottom:8},children:"Node Name"}),e.jsx(S,{id:"cy-topic",maxLength:50,name:"name",placeholder:"Node name",rules:{...V}})]}),e.jsxs(o,{mb:36,children:[e.jsx(b,{style:{marginBottom:8},children:"image_url"}),e.jsx(S,{id:"cy-image_url",maxLength:500,name:"image_url",placeholder:"image_url",rules:{pattern:{message:"Please enter a valid URL",value:B},validate:{source:E}}})]})]}),K=u(w)`
  font-size: 22px;
  font-weight: 600;
  font-family: 'Barlow';
`,b=u(w)`
