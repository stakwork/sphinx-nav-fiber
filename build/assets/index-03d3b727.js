import{N as Q,f as y,h as b,F as t,T,y as G,r as f,j as e,aW as Z,aX as ee,D as F,a_ as te,J as se,a$ as ne,B as P,i as oe,aY as I,b0 as re,o as ie,O as ae}from"./index-a69a3f4c.js";import{B as C,C as V,i as ce,c as le,F as de}from"./react-toastify.esm-a10ef41b.js";import{B as pe}from"./index-b1f9ac4d.js";import{S as me}from"./index-ad23e6aa.js";import{i as xe}from"./index.esm-1210bfcf.js";import{C as ue}from"./CheckIcon-c4ce35b5.js";import{n as z,a as he,i as fe}from"./index-d4497f67.js";import{p as ye}from"./index-86dfdb70.js";import{T as L}from"./index-49d2f161.js";import{A as ge}from"./index-9fa00766.js";import{c as je}from"./index-64f1c910.js";import"./generateCategoricalChart-8f14472c.js";import"./Popover-5e0c4343.js";import"./useSlotProps-897fde8b.js";import"./InfoIcon-1164b0f5.js";import"./NoFilterResultIcon-b5957be0.js";import"./index-fe61f9ee.js";import"./index-603d676c.js";import"./PlusIcon-65a8011b.js";import"./index-d07abe92.js";import"./Popper-57aa97eb.js";const we=async(o,i,a="")=>await Q.post(`/${o}`,JSON.stringify(i),{Authorization:a}),be=async(o,i,a,x,d,r)=>{const m=o==="Create custom type"?"schema":"node",l={node_data:{...i,...o==="Image"&&{source_link:a}},node_type:o,name:x,pubkey:r};return we(m,l,d)},Se=({onClick:o,loading:i,error:a})=>{const x=G(l=>l.budget),[d,r]=f.useState(10),m="node";return f.useEffect(()=>{(async()=>{try{const u=await ee(m);r(u.data.price)}catch(u){console.error("cannot fetch",u)}})()},[m]),e.jsxs(t,{children:[e.jsx(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:e.jsx(t,{align:"center",direction:"row",children:e.jsx(Ce,{children:"Approve Cost"})})}),e.jsxs(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:[e.jsxs(Ne,{children:[e.jsx("div",{className:"title",children:"COST"}),e.jsxs("div",{className:"value","data-testid":"check-price",children:[d," sats"]})]}),e.jsxs(Te,{children:[e.jsx("div",{className:"title",children:"BUDGET"}),e.jsxs("div",{className:"value",children:[Z(x)," sats"]})]})]}),e.jsx(t,{children:e.jsx(C,{color:"secondary","data-testid":"check-icon",disabled:i||!!a,onClick:o,size:"large",startIcon:i?e.jsx(R,{children:e.jsx(V,{color:b.lightGray,size:12})}):e.jsxs(R,{children:[" ",e.jsx(ue,{})]}),type:"submit",variant:"contained",children:"Approve"})}),a?e.jsx(ve,{children:e.jsxs(ke,{children:[e.jsx(xe,{className:"errorIcon"}),e.jsx("span",{children:a})]})}):null]})},Ne=y(t).attrs({direction:"column",align:"space-between",justify:"flex-start"})`
  width: 141px;
  height: 61px;
