...
`,rr=b.lazy(()=>De(()=>import("./index-8f992b8f.js"),["assets/index-8f992b8f.js","assets/index-617108ab.js","assets/index-b4d03b7b.css","assets/index-f5f8bf66.js","assets/SourcesTableIcon-a2f51da6.js","assets/index-fe840d80.js","assets/CheckIcon-43f0ace3.js","assets/DeleteNodeIcon-fd4b5d5d.js","assets/SoundIcon-9172a46f.js","assets/SucessFeedBackIcon-8676941f.js","assets/ClipLoader-6fccbe20.js","assets/TableRow-a0a9b5b6.js"]).then(({TweetAnalyze:e})=>({default:e}))),nr=()=>{const e=O(p=>p.setSelectedTweet),t=O(p=>p.selectedTweet),{tweetId:a}=ge(),[r,n]=b.useState(""),{open:i}=Re("tweetAnalyze"),l=(a==null?void 0:a.split("&"))||[],o=p=>{i(),n(p)};return s.jsx(s.Fragment,{children:s.jsxs(ar,{align:"stretch",basis:"100%",grow:1,shrink:1,children:[l.length>1?s.jsx(ir,{onClick:()=>{o("summary")},children:"Summary Report"}):null,l.map(p=>s.jsx(sr,{className:t===p?"selected":"",onClick:()=>e(p),children:s.jsx(Gt,{handleAnalyzeClick:()=>{o(p)},nodeId:p})},p)),s.jsx(rr,{tweetId:r})]})})},ir=h.button`
  width: 100%;
  background: ${x.ANALYTICS_CARD_BG};
  color: ${x.white};
  padding: 16px 16px;
