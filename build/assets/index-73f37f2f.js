import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-df064103.js";import{B as M}from"./index-ff675c0b.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-ce8a56f6.js";import{B as f,T as L,a as R}from"./index-ec247264.js";import{T as x}from"./index-b470549c.js";import"./useSlotProps-53ce33e6.js";import"./index.esm-df329d64.js";import"./InfoIcon-8635b005.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
