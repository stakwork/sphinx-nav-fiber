import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-8eaaaa30.js";import{B}from"./index-4e659267.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-03854d94.js";import{B as f,T as $,a as k}from"./index-fc23be6b.js";import{T as u}from"./index-e3822413.js";import"./useSlotProps-12a2271d.js";import"./index.esm-04287cd8.js";import"./InfoIcon-d0168ac7.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
