import{f as y,h as w,F as t,T as S,x as M,r as f,j as e,bd as V,be as W,C as z,b1 as H,I as K,b3 as Q,i as X,b2 as N,U as A,bi as Z,o as ee,bg as te}from"./index-aa76214e.js";import{B as T,C as O,i as oe,c as se,F as re}from"./react-toastify.esm-983de2b3.js";import{B as ne}from"./index-0ff3ebae.js";import{u as I}from"./index-5a27753a.js";import{S as ie}from"./index-f0921ab2.js";import{g as ae}from"./index.esm-816c4a04.js";import{C as ce}from"./CheckIcon-576d2ee6.js";import{p as le}from"./index-30d16895.js";import{T as E}from"./index-d368ba67.js";import{A as de}from"./index-0b03b6fb.js";import{c as pe}from"./index-64f1c910.js";import{d as me,i as xe}from"./index-3891d646.js";import"./InfoIcon-19456e74.js";import"./index-e6865c46.js";import"./Popover-508ec29c.js";import"./useSlotProps-f7ca023e.js";import"./Popper-776a6341.js";import"./generateCategoricalChart-68ff353d.js";import"./NoFilterResultIcon-046496e6.js";import"./index-d11487ff.js";import"./index-5feb1daa.js";import"./PlusIcon-d4e9f673.js";const ue=({onClick:o,loading:p,error:c})=>{const u=M(i=>i.budget),[x,s]=f.useState(10),a="node";return f.useEffect(()=>{(async()=>{try{const h=await W(a);s(h.data.price)}catch(h){console.error("cannot fetch",h)}})()},[a]),e.jsxs(t,{children:[e.jsx(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:e.jsx(t,{align:"center",direction:"row",children:e.jsx(ye,{children:"Approve Cost"})})}),e.jsxs(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:[e.jsxs(he,{children:[e.jsx("div",{className:"title",children:"COST"}),e.jsxs("div",{className:"value","data-testid":"check-price",children:[x," sats"]})]}),e.jsxs(fe,{children:[e.jsx("div",{className:"title",children:"BUDGET"}),e.jsxs("div",{className:"value",children:[V(u)," sats"]})]})]}),e.jsx(t,{children:e.jsx(T,{color:"secondary","data-testid":"check-icon",disabled:p||!!c,onClick:o,size:"large",startIcon:p?e.jsx(O,{size:24}):e.jsx(ce,{}),type:"submit",variant:"contained",children:"Approve"})}),c?e.jsxs(je,{role:"tooltip",children:[e.jsxs(ge,{children:[e.jsx(ae,{fontSize:13}),e.jsx("span",{children:c})]}),e.jsx("div",{className:"tooltip",children:c})]}):null]})},he=y(t).attrs({direction:"column",align:"space-between",justify:"flex-start"})`
  width: 141px;
  height: 61px;
