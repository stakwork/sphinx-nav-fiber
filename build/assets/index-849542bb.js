import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h as x,r as T,x as v,B as m}from"./index-ce9eea71.js";import{B}from"./index-e83a796e.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-02c4cf81.js";import{B as f,T as $,a as k}from"./index-35107dc5.js";import{T as u}from"./index-8c9f9a3f.js";import"./useSlotProps-817fc2b7.js";import"./index.esm-59f7d1cc.js";import"./InfoIcon-2e95a383.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
