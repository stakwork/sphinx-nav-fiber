import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-23e00704.js";import{B as F}from"./index-fb2d0926.js";import{u as M}from"./index-02104d30.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-6044d8e4.js";import{B as f,T as R,a as L}from"./index-00ae5a7b.js";import{T as x}from"./index-452f3baf.js";import"./useSlotProps-9c0663cc.js";import"./index.esm-29183c01.js";import"./InfoIcon-2a2697d9.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
