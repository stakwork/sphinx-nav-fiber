import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-250def76.js";import{B as M}from"./index-170d05c7.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-6411ef97.js";import{B as f,T as L,a as R}from"./index-882edfa2.js";import{T as x}from"./index-ad0b45db.js";import"./useSlotProps-80fa8401.js";import"./index.esm-bb22e3c3.js";import"./InfoIcon-0963be15.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
