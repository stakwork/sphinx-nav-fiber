import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,x as D,B as F}from"./index-7acb9fa0.js";import{B as M}from"./index-cbd06229.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-3d0c63a1.js";import{B as f,T as L,a as R}from"./index-a2ca3f36.js";import{T as x}from"./index-5c00c1b5.js";import"./useSlotProps-607947df.js";import"./index.esm-2f7683c0.js";import"./InfoIcon-1e02f89b.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
