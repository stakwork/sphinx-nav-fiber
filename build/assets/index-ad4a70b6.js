import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-6dca5d13.js";import{B as F}from"./index-15eb1140.js";import{u as M}from"./index-f636bdd9.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-e56106e5.js";import{B as f,T as R,a as L}from"./index-1f403064.js";import{T as x}from"./index-e074e0be.js";import"./useSlotProps-126bb4ad.js";import"./index.esm-03733bc4.js";import"./InfoIcon-a916da3e.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
