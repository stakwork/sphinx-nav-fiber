import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-1f32104b.js";import{B}from"./index-e9915fcc.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-778eaf5b.js";import{B as f,T as $,a as k}from"./index-fa5ded45.js";import{T as u}from"./index-dd3c818a.js";import"./useSlotProps-f66c36b0.js";import"./index.esm-b5bec20a.js";import"./InfoIcon-651502b1.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
