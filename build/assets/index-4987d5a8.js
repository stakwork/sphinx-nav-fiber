import{s as r,F as s,T as m,j as e,b as w,c as u,r as T,u as B,f as A}from"./index-8fb39b9b.js";import{B as F}from"./index-d1e98921.js";import{u as G}from"./index-2142cd26.js";import{u as M,M as $,k as v,b as g,q as k,F as C,C as D}from"./react-toastify.esm-309129e5.js";import{B as b,T as z,a as L}from"./index-de4887cb.js";import{T as x}from"./index-f15bce2a.js";import"./useSlotProps-54c1e557.js";import"./index.esm-b92f54d4.js";import"./InfoIcon-624f7e1b.js";const P=({onClose:n})=>{const[i]=M(a=>[a.graphStyle]),o=()=>{localStorage.setItem("graphStyle",i),n()};return e.jsxs(R,{direction:"column",children:[e.jsx(V,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(s,{mt:308,children:e.jsx(b,{kind:"big",onClick:o,children:"Save changes"})})]})},R=r(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,V=r(m)`
