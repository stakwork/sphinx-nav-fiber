...
`,ia=({hidden:e})=>{var he,m;const t=A.useRef(null),n=A.useRef(null),[r,i]=A.useState(!1),[o,l]=A.useState(!1),[a,c]=A.useState(!1),[u,p]=A.useState("ready"),[h,f]=A.useState(!1),{isPlaying:d,playingTime:g,duration:k,setIsPlaying:T,setPlayingTime:v,setDuration:j,playingNode:S,volume:L,setVolume:B,setHasError:E,resetPlayer:D,isSeeking:G,setIsSeeking:$}=at(Z=>Z),V=((he=S==null?void 0:S.link)==null?void 0:he.includes("youtube"))||((m=S==null?void 0:S.link)==null?void 0:m.includes("youtu.be"));A.useEffect(()=>()=>D(),[D]),A.useEffect(()=>{S&&!h&&(v(0),j(0),f(!1))},[S,v,j,f,h]),A.useEffect(()=>{G&&t.current&&(t.current.seekTo(g,"seconds"),$(!1))},[g,G,$]);const _=()=>{T(!d)},z=()=>{T(!0)},H=()=>{T(!1)},q=(Z,X)=>{const K=Array.isArray(X)?X[0]:X;t.current&&(t.current.seekTo(K),v(K))},F=(Z,X)=>{const K=Array.isArray(X)?X[0]:X;B(K)},te=()=>{E(!0),p("error")},ee=Z=>{if(!G){const X=Z.playedSeconds;v(X)}},ie=()=>{if(t.current){p("ready");const Z=t.current.getDuration();j(Z)}},ge=()=>{n.current&&(document.fullscreenElement?(document.exitFullscreen(),setTimeout(()=>l(!1),300)):n.current.requestFullscreen().then(()=>{document.addEventListener("fullscreenchange",x)}))},x=()=>{l(!!document.fullscreenElement),document.removeEventListener("fullscreenchange",x)};A.useEffect(()=>()=>{document.removeEventListener("fullscreenchange",x)}),A.useEffect(()=>{const Z=X=>{if(o){const K=window.screen.height,Ae=X.clientY,be=K-Ae;c(be<=50)}};return document.addEventListener("mousemove",Z),()=>{document.removeEventListener("mousemove",Z)}},[o,a]),A.useEffect(()=>{const Z=X=>{o&&X.key==="Escape"?(X.preventDefault(),X.stopPropagation()):r&&X.key===" "&&(X.preventDefault(),_())};return document.addEventListener("fullscreenchange",x),document.addEventListener("keydown",Z),()=>{document.removeEventListener("fullscreenchange",x),document.removeEventListener("keydown",Z)}});const se=()=>{_()};return S!=null&&S.link?s.jsxs(oa,{ref:n,hidden:e,onBlur:()=>i(!1),onFocus:()=>i(!0),tabIndex:0,children:[s.jsx(la,{isFullScreen:o,children:s.jsx(ke,{size:120,src:(S==null?void 0:S.image_url)||"",type:"clip"})}),s.jsx(ua,{onClick:se,children:s.jsx(eo,{ref:t,controls:!1,height:o?window.screen.height:"200px",onBuffer:()=>p("buffering"),onBufferEnd:()=>p("ready"),onError:te,onPause:H,onPlay:z,onProgress:ee,onReady:ie,playing:d,url:(S==null?void 0:S.link)||"",volume:L,width:"100%"})}),u==="error"?s.jsx(aa,{className:"error-wrapper",children:"Error happened, please try later"}):null,u==="ready"?s.jsx(Qs,{duration:k,handleProgressChange:q,handleVolumeChange:F,isFullScreen:o,isPlaying:d,onFullScreenClick:ge,playingTime:g,setIsPlaying:_,showToolbar:a&&o}):null,u==="buffering"&&!V?s.jsx(sa,{isFullScreen:o,children:s.jsx(Ut,{color:w.lightGray})}):null]}):null},oa=b(y)`
...
`,th=b(y)`
  ...
  gap: 10px;
`,nh=["Drivechain","Ordinals","L402","Nostr","AI"],rh=({onSubmit:e})=>{var V;const{open:t}=At("addContent"),[n,r]=A.useState(!1),[i,o]=A.useState(!1),[l,a]=A.useState(null),c=A.useRef(null),[u,p]=A.useState(0),[h,f]=A.useState(!1),{currentPlayingAudio:d,setCurrentPlayingAudio:g}=pe(_=>_),{open:k}=At("briefDescription"),{trendingTopics:T,setTrendingTopics:v}=fe(_=>_),{setValue:j}=fr(),S=A.useCallback(async()=>{r(!0),o(!1),p(0),f(!1),g(null);try{const _=await ba();_.length&&Array.isArray(_)&&v(_)}catch{v(nh.map(z=>({name:z,count:0})))}finally{r(!1)}},[g,v]);A.useEffect(()=>{T.length||S()},[S,T.length]),A.useEffect(()=>{const _=setTimeout(()=>{o(!0)},5e3);return()=>clearTimeout(_)},[o,n]);const L=_=>{j("search",_),e==null||e()},B=(_,z)=>{_.stopPropagation(),_.currentTarget.blur(),z!=null&&z.tldr&&(a(z),k())},E=()=>{a(null)},D=_=>{_.stopPropagation(),_.currentTarget.blur(),f(!h),g(c)};A.useEffect(()=>{var _,z;h?(_=c.current)==null||_.play():(z=c.current)==null||z.pause()},[u,h]),A.useEffect(()=>{d||f(!1)},[d]);const G=()=>{p(_=>{var H,q;let z=(_+1)%T.length;for(;z!==_&&!((H=T[z])!=null&&H.audio_EN);)z=(z+1)%T.length;return z===_?(f(!1),z):((q=c.current)==null||q.load(),z===0&&(f(!1),p(0)),z)}),g(c)},$=n?"Loading":"No new trending topics in the last 24 hours";return s.jsxs(oh,{"data-testid":"trending-component",children:[s.jsxs("div",{children:[s.jsxs("div",{className:"heading-container",children:[s.jsxs("div",{className:"heading",children:[s.jsx("span",{className:"heading__title",children:"Trending Topics"}),s.jsx("span",{className:"heading__icon",children:n?s.jsx(Ut,{color:w.white,size:16}):s.jsx(s.Fragment,{children:i?s.jsx(sh,{onClick:S,size:"small",startIcon:s.jsx(wa,{})}):s.jsx(ka,{})})})]}),jo(T)?s.jsxs("div",{children:[s.jsx(we,{onClick:_=>D(_),startIcon:h?s.jsx(ut,{}):s.jsx(Vt,{}),children:h?"Pause":"Play All"}),s.jsx(ch,{ref:c,onEnded:G,src:(V=T[u])==null?void 0:V.audio_EN,children:s.jsx("track",{kind:"captions"})})]}):null]}),T.length===0?s.jsxs("div",{className:"trending-empty",children:[s.jsx(lh,{children:$}),s.jsx(we,{color:"secondary",disabled:n,onClick:t,size:"medium",startIcon:s.jsx(wo,{}),sx:{alignSelf:"flex-end",m:"0 36px 16px 0"},variant:"contained",children:"Add Content"})]}):s.jsx("ul",{className:"list",children:T.map((_,z)=>s.jsxs(y,{align:"center",className:"list-item",direction:"row",justify:"space-between",onClick:()=>L(_.name),children:[s.jsxs(ih,{children:[s.jsx(uh,{children:s.jsx(ya,{})}),s.jsx("span",{className:"tldr",children:Co(_)})]}),_.tldr&&s.jsx(ah,{className:Ie({isPlaying:u===z&&h}),onClick:H=>B(H,_),children:"TLDR"})]},_.name))})]}),l&&s.jsx(Z0,{onClose:E,selectTrending:L,trend:l})]})},ih=b.div`
  display: flex;
  align-items: center;
  width: 300px;
