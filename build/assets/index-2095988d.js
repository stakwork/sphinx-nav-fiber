import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-7b63cb4a.js";import{B as M}from"./index-4a55926a.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-0954c8b1.js";import{B as f,T as L,a as R}from"./index-b064ac59.js";import{T as x}from"./index-10171590.js";import"./useSlotProps-4a81fffb.js";import"./index.esm-a81337f5.js";import"./InfoIcon-282f58ab.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
