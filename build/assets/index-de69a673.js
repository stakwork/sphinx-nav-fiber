import{f as y,h as w,F as t,T as S,x as M,r as f,j as e,aX as W,aY as H,D as E,b1 as K,J as X,b2 as Z,B as I,i as Q,aZ as C,W as P,b3 as ee,o as te,a$ as se}from"./index-00c8de1c.js";import{B as T,C as O,i as oe,c as ne,F as re}from"./react-toastify.esm-1974ae2a.js";import{B as ie}from"./index-546477a8.js";import{S as ae}from"./index-40755048.js";import{i as ce}from"./index.esm-d29a00f0.js";import{C as le}from"./CheckIcon-a6fb6ba4.js";import{p as de}from"./index-30d16895.js";import{T as L}from"./index-762f880d.js";import{n as pe,a as z,b as me,i as xe}from"./index-0fcfbfd4.js";import{A as ue}from"./index-84d82caa.js";import{c as he}from"./index-64f1c910.js";import"./InfoIcon-5f6968ca.js";import"./generateCategoricalChart-c29904a2.js";import"./Popover-cd8b9007.js";import"./useSlotProps-bb3c3a09.js";import"./NoFilterResultIcon-94320f18.js";import"./index-aaf85693.js";import"./index-a687d645.js";import"./PlusIcon-77850742.js";import"./index-80c9ed78.js";import"./Popper-cc71079a.js";const fe=({onClick:o,loading:p,error:c})=>{const u=M(a=>a.budget),[m,s]=f.useState(10),i="node";return f.useEffect(()=>{(async()=>{try{const h=await H(i);s(h.data.price)}catch(h){console.error("cannot fetch",h)}})()},[i]),e.jsxs(t,{children:[e.jsx(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:e.jsx(t,{align:"center",direction:"row",children:e.jsx(je,{children:"Approve Cost"})})}),e.jsxs(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:[e.jsxs(ye,{children:[e.jsx("div",{className:"title",children:"COST"}),e.jsxs("div",{className:"value","data-testid":"check-price",children:[m," sats"]})]}),e.jsxs(ge,{children:[e.jsx("div",{className:"title",children:"BUDGET"}),e.jsxs("div",{className:"value",children:[W(u)," sats"]})]})]}),e.jsx(t,{children:e.jsx(T,{color:"secondary","data-testid":"check-icon",disabled:p||!!c,onClick:o,size:"large",startIcon:p?e.jsx(O,{size:24}):e.jsx(le,{}),type:"submit",variant:"contained",children:"Approve"})}),c?e.jsxs(be,{role:"tooltip",children:[e.jsxs(we,{children:[e.jsx(ce,{fontSize:13}),e.jsx("span",{children:c})]}),e.jsx("div",{className:"tooltip",children:c})]}):null]})},ye=y(t).attrs({direction:"column",align:"space-between",justify:"flex-start"})`
  width: 141px;
  height: 61px;
...
`,ke=({type:o,skipToStep:p,name:c,sourceLink:u})=>{const m=i=>z.test(i??""),s=o==="Image"?m(c)&&m(u):m(c);return e.jsxs(t,{children:[e.jsx(t,{align:"center",direction:"row",justify:"space-between",mb:18,children:e.jsx(t,{align:"center",direction:"row",children:e.jsx(Be,{children:"Enter details"})})}),e.jsx(t,{mb:4,children:e.jsxs(S,{children:[o," name"]})}),e.jsx(t,{mb:12,children:e.jsx(L,{id:"cy-item-name",maxLength:250,name:"typeName",placeholder:"Paste name here...",rules:{...E,pattern:{message:"Please avoid special characters and spaces",value:z}}})}),o==="Image"?e.jsxs(e.Fragment,{children:[e.jsx(t,{mb:4,children:e.jsx(S,{children:"Link"})}),e.jsx(t,{mb:12,children:e.jsx(L,{id:"cy-item-link",maxLength:250,name:"sourceLink",placeholder:"Paste link here...",rules:{...E,pattern:{message:"Please avoid special characters and spaces",value:z}}})})]}):null,e.jsxs(t,{direction:"row",children:[e.jsx(t,{grow:1,children:e.jsx(T,{color:"secondary",onClick:()=>p("sourceType"),size:"large",variant:"contained",children:"Prev"})}),e.jsx(t,{grow:1,ml:20,children:e.jsx(T,{color:"secondary",disabled:!s,onClick:()=>p("setBudget"),size:"large",variant:"contained",children:"Next"})})]})]})},Be=y(S)`
  ...
  font-weight: 600;
  font-family: 'Barlow';
`,ze=({skipToStep:o,allowNextStep:p,onSelectType:c,selectedType:u})=>{const[m]=X(x=>[x.customSchemaFeatureFlag]),[s,i]=f.useState(null),[a,h]=f.useState(!1);f.useEffect(()=>{(async()=>{if(m){h(!0);try{const n=await Z(),r=["about","schema"],l=n.schemas.filter(j=>j.ref_id&&!r.includes(j.type)&&!j.is_deleted).map(j=>({label:he(j.type),value:j.type,action:()=>o("setAttribues")}));i(l)}catch(n){console.warn(n)}finally{h(!1)}}else i([...me,xe])})()},[u,m,o]);const g=x=>{c((x==null?void 0:x.label)||"")};return e.jsxs(t,{children:[e.jsx(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:e.jsx(t,{align:"center",direction:"row",children:e.jsx(Ee,{children:"Select Type"})})}),e.jsx(t,{direction:"row",mb:20,children:e.jsx(ue,{autoFocus:!0,isLoading:a,onSelect:g,options:s})}),e.jsx(t,{children:e.jsx(T,{color:"secondary",disabled:!p,onClick:()=>o("source"),size:"large",type:"button",variant:"contained",children:"Next"})})]})},Ee=y(S)`
  font-size: 22px;
  font-weight: 600;
  font-family: 'Barlow';
`,Le=async(o,p,c)=>{var u,m;if(o.nodeType==="Create custom type"){o.type;try{const s=await P.post("/schema",JSON.stringify(o),{});if(s.error){const{message:i}=s.error;throw new Error(i)}c(o,(u=s==null?void 0:s.data)==null?void 0:u.ref_id),close()}catch(s){let i=C;if(s.status===400){const a=await s.json();i=a.errorCode||(a==null?void 0:a.status)||C}else s instanceof Error&&(i=s.message);throw new Error(i)}}else{const s="node",{nodeType:i,typeName:a,...h}=o,g={node_data:{...h},node_type:i,name:a};o.nodeType==="Image"&&(g.node_data={...o.node_data,source_link:o.sourceLink});let x="";await ee(async()=>{const n=await te.enable();g.pubkey=n==null?void 0:n.pubkey,x=await se()});try{const n=await P.post(`/${s}`,JSON.stringify(g),{Authorization:x});if(n.error){const{message:r}=n.error;throw new Error(r)}c(o,(m=n==null?void 0:n.data)==null?void 0:m.ref_id),close()}catch(n){let r=C;if(n.status===400)try{const l=await n.json();r=l.message||l.errorCode||(l==null?void 0:l.status)||C}catch{r=C}else n instanceof Error&&(r=n.message);throw new Error(r)}}},Qe=()=>{const[o,p]=f.useState("sourceType"),{close:c,visible:u}=I("addItem"),{open:m}=I("addType"),[s]=M(d=>[d.setBudget]),i=ne({mode:"onChange"}),{watch:a,setValue:h,reset:g}=i,[x,n]=f.useState(!1),[r,l]=f.useState(""),[j,D]=Q(d=>[d.addNewNode,d.setSelectedNode]);f.useEffect(()=>()=>{p("sourceType"),g()},[u,g]);const k=a("nodeType"),R=a("typeName"),q=a("sourceLink"),Y=a("type");a("title");const _=()=>{c()},B=d=>{p(d)},G=(d,b)=>{const N=b||`new-id-${Math.random()}`,v=d.nodeType.toLocaleLowerCase(),F={name:d.typeName,type:v,label:d.typeName,node_type:v,id:N,ref_id:N,x:Math.random(),y:Math.random(),z:Math.random(),date:parseInt((new Date().getTime()/1e3).toFixed(0),10),weight:4,...d.sourceLink?{source_link:d.sourceLink}:{}};j(F),D(F)},J=i.handleSubmit(async d=>{n(!0);try{await Le(d,s,G),ae("Item Added"),_()}catch(b){let N=C;if((b==null?void 0:b.status)===400){const v=await b.json();N=v.errorCode||(v==null?void 0:v.status)||C}else b instanceof Error&&(N=b.message);l(String(N))}finally{n(!1)}}),A=d=>{d==="Create custom type"?m():h("nodeType",d)},U={sourceType:e.jsx(ze,{allowNextStep:!!k,onSelectType:A,selectedType:k,skipToStep:B}),source:e.jsx(ke,{name:R,skipToStep:B,sourceLink:q||"",type:k}),setBudget:e.jsx(fe,{loading:x,onClick:()=>null}),createConfirmation:e.jsx(Se,{onclose:_,type:Y}),setAttribues:e.jsx(Te,{handleSelectType:A,nodeType:k,skipToStep:B})},V="small";return e.jsx(ie,{id:"addItem",kind:V,onClose:c,preventOutsideClose:!0,children:e.jsx(re,{...i,children:e.jsx("form",{id:"add-node-form",onSubmit:J,children:U[o]})})})};export{Qe as AddItemModal};
