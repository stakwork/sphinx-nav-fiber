import{s as r,F as n,T as g,j as e,h as w,b as c,r as A,g as B}from"./index-bf74149a.js";import{B as v}from"./index-70c12bfe.js";import{u as F}from"./index-a6c4785f.js";import{e as M,X as $,t as C,h as b,z as D,F as k,C as G}from"./react-toastify.esm-e3832827.js";import{B as f,T as R,a as z}from"./index-02d855d1.js";import{T as x}from"./index-3e40747b.js";import"./useSlotProps-51daee35.js";import"./index.esm-18be29a9.js";import"./InfoIcon-52c678b1.js";const L=({onClose:s})=>{const[a]=M(t=>[t.graphStyle]),i=()=>{localStorage.setItem("graphStyle",a),s()};return e.jsxs(P,{direction:"column",children:[e.jsx(V,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:i,children:"Save changes"})})]})},P=r(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,V=r(g)`
