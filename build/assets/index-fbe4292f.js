...
`,re=r(n)`
  align-items: center;
  cursor: pointer;
`,ie=()=>{var T,b,C;const{close:s}=g("editNodeName"),u=Q({mode:"onChange"}),{watch:c,setValue:a,reset:h,getValues:d}=u,[x,N]=l.useState(!1),[j,w]=l.useState(!1),[o,E]=l.useState(),t=F(),{open:L}=g("removeNode");l.useEffect(()=>(o?a("name",o==null?void 0:o.name):t&&(a("name",t.name),a("image_url",(t==null?void 0:t.image_url)??"")),()=>{h()}),[o,a,h,t]),l.useEffect(()=>{(async()=>{if(!(!t||t.type!=="topic")){w(!0);try{const{data:i}=await P({search:t==null?void 0:t.name}),p=i.find(H=>H.name===t.name);E(p)}catch(i){console.log(i)}finally{w(!1)}}})()},[t]);const D=c("imageInputType"),R=c("name"),f=c("image_url");l.useEffect(()=>{a("imageInputType",te(f))},[f,a]);const A=()=>{s()},m=o||t,M=async()=>{N(!0);const i={["name"]:R.trim(),image_url:f.trim()};try{await q((m==null?void 0:m.ref_id)||"",{node_data:i});const{updateNode:p}=K.getState();p({...m,...i}),A()}catch(p){console.warn(p)}finally{N(!1)}},z=async()=>{L()},v=(b=(T=d())==null?void 0:T.name)==null?void 0:b.trim(),U=v&&(o==null?void 0:o.name.trim())!==v,V=d().image_url&&(t==null?void 0:t.image_url)!==((C=d())==null?void 0:C.image_url),W=x||j||!!f&&!D||!U&&!V;return e.jsx(le,{children:e.jsxs(X,{...u,children:[j?e.jsx(n,{my:24,children:e.jsx(Z,{})}):e.jsx(oe,{}),e.jsxs(n,{direction:"row",mb:6,children:[e.jsx(ce,{color:"secondary",disabled:j||!m,onClick:z,size:"large",style:{marginRight:20},variant:"contained",children:"Delete"}),e.jsxs(k,{color:"secondary",disabled:W,onClick:M,size:"large",style:{flex:1},variant:"contained",children:["Save Changes",x&&e.jsx(de,{children:e.jsx(ee,{color:y.lightGray,size:12})})]})]})]})})},le=r(n)`
  padding: 20px;
`,ce=r(k)`
  && {
    color: ${y.primaryRed};
