import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,C as B,h as c,r as v,x as C}from"./index-3e3c0d47.js";import{B as F}from"./index-be1e563b.js";import{u as M}from"./index-d1ecce63.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-c19b1263.js";import{B as f,T as L,a as R}from"./index-48ad8ad3.js";import{T as x}from"./index-661a13dd.js";import"./useSlotProps-470c82ac.js";import"./index.esm-40c93ca5.js";import"./InfoIcon-e5d1de7f.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
