import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,C as B,h as c,r as v,x as C}from"./index-652706b4.js";import{B as F}from"./index-083bf858.js";import{u as M}from"./index-ab04921d.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-db251548.js";import{B as f,T as L,a as R}from"./index-a5d8ca28.js";import{T as x}from"./index-9b997d91.js";import"./useSlotProps-4e8b1ce5.js";import"./index.esm-91c7105f.js";import"./InfoIcon-423a01a0.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
