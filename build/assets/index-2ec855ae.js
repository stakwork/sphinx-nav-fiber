...
`,F=()=>{const{close:d}=y("removeNode"),{close:u}=y("editNodeName"),[x,p]=l.useState(!1),[g]=b(r=>[r.setSelectedNode]),[v]=S(r=>[r.removeNode]),[k,w]=l.useState(!1),[n,C]=l.useState(),[a,L]=l.useState(),o=D(),h=()=>{d()};l.useEffect(()=>{(async()=>{if(o){w(!0);try{if(o.type==="topic"){const{data:s}=await M({search:o==null?void 0:o.name}),m=s.find(f=>f.name===o.name);L(m)}else C(o)}catch(s){console.log(s)}finally{w(!1)}}})()},[o]);const B=async()=>{p(!0);try{g(null),h(),u()}catch(r){console.warn(r)}finally{p(!1)}},N=async()=>{let r="";const s=n||a;if(!s)return;s!=null&&s.ref_id&&(r=s.ref_id),p(!0);const m=o==null?void 0:o.ref_id;try{await $(r),v(m),g(null),h(),u()}catch(f){console.warn(f)}finally{p(!1)}};return e.jsxs(W,{children:[e.jsx(E,{nodeName:(n==null?void 0:n.name)||(a==null?void 0:a.name)||""}),k?e.jsx(z,{}):e.jsxs(i,{direction:"row",mt:34,children:[e.jsx(_,{color:"secondary",onClick:h,size:"large",style:{flex:1,marginRight:20},variant:"contained",children:"Cancel"}),e.jsxs(V,{color:"secondary",disabled:x||!n&&!a,onClick:n||a?N:B,size:"large",style:{flex:1},variant:"contained",children:["Delete",x&&e.jsx(Z,{children:e.jsx(I,{color:t.lightGray,size:12})})]})]})]})},W=c(i)`
