import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-2d3d8e17.js";import{B as M}from"./index-3c9aee47.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-6cb29e2e.js";import{B as f,T as L,a as R}from"./index-f2958598.js";import{T as x}from"./index-88bd5774.js";import"./useSlotProps-18e843b2.js";import"./index.esm-016ad9de.js";import"./InfoIcon-811cd12e.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
