import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-84e6feed.js";import{B as F}from"./index-7a17970d.js";import{u as M}from"./index-b5061f1d.js";import{j as $,e as k,F as D,C as G}from"./react-toastify.esm-7ad05984.js";import{B as f,T as R,a as L}from"./index-0dbd6808.js";import{T as x}from"./index-424e2ae8.js";import"./useSlotProps-d59d983c.js";import"./index.esm-7bc36a0c.js";import"./InfoIcon-d232d482.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
