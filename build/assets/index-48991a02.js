...
`,Os=j(Yt)`
  margin: auto 0px 2px 0px;
  opacity: 0.75;
`,Ms=()=>{var a,u;const[e,t]=z.useState(!1),n=xe(),r=!!(n!=null&&n.source_link),i=z.useRef(null),o=pe(c=>c.currentSearch),l=c=>{c.stopPropagation(),c.currentTarget.blur(),t(!e)};return z.useEffect(()=>{var c,h;e?(c=i.current)==null||c.play():(h=i.current)==null||h.pause()},[e]),s.jsxs(g,{align:"flex-start",basis:"100%",direction:"column",grow:1,justify:"center",pt:r?62:0,shrink:1,children:[r&&s.jsxs(Rs,{children:[s.jsx(yr,{color:y.GRAY6}),s.jsx(Ns,{children:n==null?void 0:n.source_link}),s.jsx(Ds,{href:`${n==null?void 0:n.source_link}?open=system`,onClick:c=>c.stopPropagation(),target:"_blank",children:s.jsx(Ut,{})})]}),(a=n==null?void 0:n.audio)!=null&&a.length?s.jsxs(g,{justify:"flex-start",p:12,children:[s.jsx(we,{onClick:c=>l(c),startIcon:e?s.jsx(ut,{}):s.jsx(Ht,{}),children:e?"Pause":"Play"}),s.jsx($s,{ref:i,src:((u=n.audio[0])==null?void 0:u.link)||"",children:s.jsx("track",{kind:"captions"})})]}):null,s.jsx(Fs,{grow:1,justify:"flex-start",p:12,shrink:1,children:s.jsx(J,{color:"primaryText1",kind:"regular",children:pt((n==null?void 0:n.text)||"",o)})})]})},Rs=j(g)`
  top: 0px;
  position: absolute;
...
`,$s=j.audio`
  height: 0;
  width: 0;
`,Hs=["clip","twitter_space","youtube","episode","podcast"],Vs=()=>{const e=xe(),{showTeachMe:t}=fe(r=>r),{setPlayingNode:n}=at(r=>r);if(z.useEffect(()=>{Hs.includes((e==null?void 0:e.node_type)||"")&&n(e)},[n,e]),t)return s.jsx(bl,{});switch(e==null?void 0:e.node_type){case"guest":case"person":return s.jsx(ds,{});case"data_series":return s.jsx(Cl,{});case"tribe_message":return s.jsx(us,{});case"tweet":return s.jsx(js,{});case"topic":return s.jsx(ks,{});case"show":return s.jsx(bs,{});case"youtube":case"podcast":case"clip":case"twitter_space":return s.jsx(Ir,{});case"document":return s.jsx(Ms,{});case"episode":return s.jsx(is,{},e.ref_id);case"image":return s.jsx(as,{});default:return s.jsx(_s,{})}},Us=z.memo(Vs),Gs=({isPlaying:e,isFullScreen:t,setIsPlaying:n,playingTime:r,duration:i,handleProgressChange:o,handleVolumeChange:l,onFullScreenClick:a,showToolbar:u})=>s.jsxs(g,{children:[(!u||t)&&s.jsx(Xs,{"aria-label":"Small","data-testid":"progress-bar",isFullScreen:t,max:i,onChange:o,size:"small",value:r}),s.jsxs(Ys,{align:"center",direction:"row",showToolbar:u||t,children:[s.jsx(qs,{onClick:n,size:"small",children:e?s.jsx(ut,{}):s.jsx(Ht,{})}),s.jsxs(Zs,{direction:"row",children:[s.jsx("span",{children:mn(r)}),s.jsx("span",{className:"separator",children:"/"}),s.jsx("span",{className:"duration",children:mn(i)})]}),s.jsxs(Ws,{direction:"row",px:9,children:[s.jsx(jr,{className:"volume-slider",defaultValue:.5,max:1,min:0,onChange:l,size:"small",step:.1}),s.jsx(Zi,{})]}),s.jsx(Qs,{"data-testid":"fullscreen-button",onClick:()=>a(),children:t?s.jsx(Ji,{}):s.jsx(Ki,{})})]})]}),Ys=j(g)`
  height: 60px;
  padding: 12px 16px;
  ${e=>e.showToolbar&&`
    position: fixed;
