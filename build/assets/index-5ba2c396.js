import{s as r,F as n,T as g,j as e,h as w,b as c,r as A,g as B}from"./index-84e0b589.js";import{B as v}from"./index-42cc1ddd.js";import{u as F}from"./index-6ab12e0f.js";import{u as M,U as $,q as C,e as b,x as D,F as k,C as G}from"./react-toastify.esm-1ef9dd2a.js";import{B as f,T as R,a as L}from"./index-664cf71e.js";import{T as x}from"./index-ec028522.js";import"./useSlotProps-636ece8e.js";import"./index.esm-8b73d840.js";import"./InfoIcon-ce270097.js";const P=({onClose:s})=>{const[a]=M(t=>[t.graphStyle]),i=()=>{localStorage.setItem("graphStyle",a),s()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:i,children:"Save changes"})})]})},V=r(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=r(g)`
