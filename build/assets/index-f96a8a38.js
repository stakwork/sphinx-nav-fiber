import{s as f,c as y,u as z,r as p,j as e,F as t,T as h,b as N,x as R,o as U,ad as V,ae as g,d as G,a2 as q}from"./index-324d51ec.js";import{ak as J,B as j,al as Y,l as H,u as K,F as Q}from"./react-toastify.esm-31fcbb2e.js";import{B as W}from"./index-14a3a191.js";import{n as S}from"./toastMessage-e7ad6d20.js";import{u as X}from"./index-9edcc142.js";import{C as Z}from"./CheckIcon-4d4b2f64.js";import{C as ee}from"./ClipLoader-a5b03afd.js";import{T as B}from"./index-9ad82c31.js";import{A as te}from"./index-30cf16d2.js";import{i as v,O as L}from"./constants-84edb5fc.js";import"./index.esm-b5625140.js";import"./InfoIcon-9f2b633d.js";import"./index-ccb1ef85.js";import"./Popover-46949e68.js";import"./useSlotProps-6ca3381f.js";import"./Select-18ff8597.js";import"./Stack-7d79a4c4.js";import"./Popper-7b1335fa.js";const ne=({onClick:n,loading:a})=>{const d=z(l=>l.budget),[c,m]=p.useState(10),s="node";return p.useEffect(()=>{(async()=>{try{const r=await Y(s);m(r.data.price)}catch(r){console.error("cannot fetch",r)}})()},[s]),e.jsxs(t,{children:[e.jsx(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:e.jsx(t,{align:"center",direction:"row",children:e.jsx(re,{children:"Approve Cost"})})}),e.jsxs(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:[e.jsxs(oe,{children:[e.jsx("div",{className:"title",children:"COST"}),e.jsxs("div",{className:"value","data-testid":"check-price",children:[c," sats"]})]}),e.jsxs(se,{children:[e.jsx("div",{className:"title",children:"BUDGET"}),e.jsxs("div",{className:"value",children:[J(d)," sats"]})]})]}),e.jsx(t,{children:e.jsx(j,{color:"secondary","data-testid":"check-icon",disabled:a,onClick:n,size:"large",startIcon:a?e.jsx(ee,{size:24}):e.jsx(Z,{}),type:"submit",variant:"contained",children:"Approve"})})]})},oe=f(t).attrs({direction:"column",align:"space-between",justify:"flex-start"})`
  width: 141px;
  height: 61px;
