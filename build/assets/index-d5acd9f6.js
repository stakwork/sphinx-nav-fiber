import{Q as o,U as s,a4 as g,O as y,j as e,a3 as b,av as w,aq as S,S as x,r as v,N as T,ac as m}from"./index-fc907f2a.js";import{aE as A,aF as f,aG as C,aH as B,aI as u,aA as G,aJ as M,aK as $,aB as k}from"./index-21d7e193.js";const D=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(z,{direction:"column",children:[e.jsx(F,{children:"Default graph view:"}),e.jsx(A,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},z=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,F=o(g)`
