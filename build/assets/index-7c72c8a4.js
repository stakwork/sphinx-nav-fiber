import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-320d06ce.js";import{B as F}from"./index-17cdd249.js";import{u as M}from"./index-5a4d0b20.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-5cfb56a4.js";import{B as f,T as R,a as L}from"./index-4d08c8fd.js";import{T as x}from"./index-3977c91a.js";import"./useSlotProps-b689034b.js";import"./index.esm-9662c281.js";import"./InfoIcon-24ccd98c.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
