import{r as i,j as e,s as u,g as S,F as j,o as X,c as Y,A as oe,p as ie,i as ae,q as ce,H as le,t as pe,v as de}from"./index-431d76f4.js";import{t as O,u as H,C as ue}from"./index-b5896d9a.js";import{U as fe}from"./index-0ef0d224.js";import{u as T,a as me,b as ge,I as he,c as J,d as xe}from"./index-d5a78730.js";import{M as ye,V as be}from"./index-75c899cd.js";import{S as we,R as je,s as V,M as ve}from"./index-d4b3e32e.js";import"./string-a277709d.js";import"./index-17aabe58.js";import"./three.module-976f5d36.js";import"./index-c44e7ab4.js";import"./TextareaAutosize-392a7a2c.js";import"./CheckIcon-64f55349.js";import"./index-b4386479.js";import"./index-25756053.js";import"./ClipLoader-44a82ea4.js";import"./clsx-fa4a1317.js";import"./SourcesTableIcon-1d777f00.js";import"./DeleteNodeIcon-4345e1bf.js";import"./SoundIcon-52f066d1.js";import"./SucessFeedBackIcon-139eb95f.js";import"./Skeleton-51b3ff8f.js";import"./index-2d7958e9.js";import"./Stack-05415c27.js";import"./FormControlLabel-07e27eb7.js";import"./Typography-060e6b80.js";import"./createSvgIcon-917d5a63.js";import"./isPlainObject-09bd30ad.js";const K=i.memo(()=>{const r=T(n=>n.isPlaying),a=T(n=>n.setIsPlaying),s=T(n=>n.setVolume),t=T(n=>n.setPlaybackSpeed),c=T(n=>n.playbackSpeed),o=T(n=>n.playerRef),[d,g]=i.useState(!1),m=[.5,1,1.5,2],h=()=>{if(o){const n=o.getCurrentTime()-15;o.seekTo(n,"seconds")}},f=()=>{if(o){const n=o.getCurrentTime()+15;o.seekTo(n,"seconds")}},w=()=>{a(!r)},p=()=>{g(!d),s(d?1:0)},l=()=>{const x=(m.indexOf(c)+1)%m.length,P=m[x];if(t(P),o){const k=o.getInternalPlayer();k&&typeof k.playbackRate<"u"&&(k.playbackRate=P)}};return e.jsxs(Se,{children:[e.jsx(Pe,{onClick:p,children:d?e.jsx(ye,{}):e.jsx(be,{})}),e.jsx(Ce,{onClick:h,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(ke,{"data-testid":"play-pause-button",onClick:w,size:"small",children:r?e.jsx(me,{"data-testid":"pause-icon"}):e.jsx(ge,{"data-testid":"play-icon"})}),e.jsx(Ie,{onClick:f,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(_e,{onClick:l,children:[c,"x"]})]})});K.displayName="Controls";const Se=u(j).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${S.BG1};
  border-radius: 40px;
