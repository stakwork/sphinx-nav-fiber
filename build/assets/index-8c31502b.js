import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-126e8d6c.js";import{B as M}from"./index-756d12f6.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-c1afeea3.js";import{B as f,T as L,a as R}from"./index-a343af12.js";import{T as x}from"./index-fd0bf0d0.js";import"./useSlotProps-70ad245a.js";import"./index.esm-e6fc98a8.js";import"./InfoIcon-f9e1801f.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
