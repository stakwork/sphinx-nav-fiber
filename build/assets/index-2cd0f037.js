import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-764dd9e8.js";import{B as M}from"./index-871e0036.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-f273c043.js";import{B as f,T as L,a as R}from"./index-24db84f5.js";import{T as x}from"./index-b660f407.js";import"./useSlotProps-4dea8ecb.js";import"./index.esm-493909c5.js";import"./InfoIcon-607a1426.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
