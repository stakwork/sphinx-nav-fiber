...
`,Z=async(t,r,s,a)=>{const x=B(s)?"radar":"add_node",o={};if(s===z)o.media_url=t.source,o.content_type="audio_video";else if(s===k){if(/(?:https?:\/\/)?(?:www\.)?twitter\.com\/\w+\/status\/\d+/s.test(t.source)){const l=/\/status\/(\d+)/,f=t.source.match(l);if(f!=null&&f[1]){const[,p]=f;o.tweet_id=p}}else o.tweet_id=t.source;o.content_type="tweet"}else if(s===E)o.content_type="webpage",o.web_page=t.source;else if(s===L)o.content_type="document",o.text=t.source;else if(s===m){const[,i]=(t.source||"").match(C)||[];if(i)o.source=i,o.source_type=s;else return}else(s===b||s===j)&&(o.source=t.source,o.source_type=s);t.latitude&&t.longitude&&(o.latitude=t.latitude,o.longitude=t.longitude);let c="";await q(async()=>{const i=await Q.enable();o.pubkey=i==null?void 0:i.pubkey,c=await X()});try{const i=await H.post(`/${x}`,JSON.stringify(o),{Authorization:c});if(i.error){const{message:l}=i.error;throw new Error(l)}r()}catch(i){i.status===402&&(await J(a),await K(a),await Z(t,r,s,a)),i.status===400&&(await i.json(),r()),i instanceof Error&&r()}},Oe=()=>{const[t,r]=h.useState(0),{close:s,visible:a}=se("addContent"),[x]=N(v=>[v.setBudget]),o=ee({mode:"onChange"}),{watch:c,setValue:i,reset:l}=o,[f,p]=h.useState(!1);h.useEffect(()=>()=>{r(0),l()},[a,l]);const g=c("inputType"),R=c("source"),I=c("longitude"),U=c("latitude"),A=c("source"),O=T(R);h.useEffect(()=>{i("inputType",he(A))},[A,i]);const F=()=>{s()},S=()=>{r(t+1)},G=()=>{r(t-1)},D=o.handleSubmit(async v=>{p(!0);try{await Z(v,F,g,x)}catch{console.error(W)}finally{p(!1)}});return e.jsx(ne,{id:"addContent",kind:"small",onClose:s,preventOutsideClose:!0,children:e.jsx(te,{...o,children:e.jsxs("form",{id:"add-node-form",onSubmit:D,children:[t===0&&e.jsx(Be,{allowNextStep:O,onNextStep:S,type:g}),t===1&&e.jsx(e.Fragment,{children:B(g)?e.jsx($e,{onNextStep:S,onPrevStep:G,type:g,value:R}):e.jsx(_e,{form:o,latitude:U,longitude:I,onNextStep:S})}),t===2&&e.jsx(ge,{loading:f,onClick:()=>null,type:g})]})})})};export{Oe as AddContentModal};
