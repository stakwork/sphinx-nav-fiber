import{s as r,F as n,T as g,j as e,h as w,b as c,r as A,g as B}from"./index-667e34ea.js";import{B as v}from"./index-98347147.js";import{u as F}from"./index-a41a2a8d.js";import{u as M,T as $,o as C,e as b,w as D,F as k,C as G}from"./react-toastify.esm-7fe703b8.js";import{B as f,T as R,a as L}from"./index-d56c5fb7.js";import{T as x}from"./index-eed32d88.js";import"./useSlotProps-19f4a057.js";import"./index.esm-44199b5b.js";import"./InfoIcon-f73e6792.js";const P=({onClose:s})=>{const[a]=M(t=>[t.graphStyle]),i=()=>{localStorage.setItem("graphStyle",a),s()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:i,children:"Save changes"})})]})},V=r(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=r(g)`
