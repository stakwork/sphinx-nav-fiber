import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,x as D,B as F}from"./index-7a5d5012.js";import{B as M}from"./index-7b0476c6.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-c046aa1a.js";import{B as f,T as L,a as R}from"./index-7c5635c1.js";import{T as x}from"./index-53f859b4.js";import"./useSlotProps-51b9a9ac.js";import"./index.esm-3ce2f4b9.js";import"./InfoIcon-bc59d455.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
