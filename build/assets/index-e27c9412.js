...
`,s=a(c).attrs({align:"center",justify:"center",p:0})`
  ...
  color: ${e.GRAY6};
  cursor: pointer;
  transition: ${({theme:o})=>o.transitions.create(["opacity","box-shadow","background-color"])};
  ...
  ${i} {
    ...
    font-style: normal;
    font-weight: 400;
    transition: ${({theme:o})=>o.transitions.create(["opacity","visually"])};
  }
  ...
  &:hover {
    ...
    &:before {
      width: 3px;
      height: 32px;
      background-color: ${e.primaryBlue};
    }
