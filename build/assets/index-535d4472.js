import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-4d613fad.js";import{B as M}from"./index-92fc850f.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-875d11f8.js";import{B as f,T as L,a as R}from"./index-fe3ed52c.js";import{T as x}from"./index-c21c8d9e.js";import"./useSlotProps-cf7383ca.js";import"./index.esm-eaabd1f8.js";import"./InfoIcon-6d67f05a.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
