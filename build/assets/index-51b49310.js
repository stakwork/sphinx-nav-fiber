import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-fc1aaaf0.js";import{B as M}from"./index-83648741.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-c684bf66.js";import{B as f,T as L,a as R}from"./index-2f560094.js";import{T as x}from"./index-7c5e4be9.js";import"./useSlotProps-4def1bf0.js";import"./index.esm-5267ebda.js";import"./InfoIcon-d44e2789.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
