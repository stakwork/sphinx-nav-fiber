import{s as c,g as t,F as i,j as e,D as j,r as l,c as C,B as w,bD as D,bF as S,b6 as R}from"./index-5d91095a.js";import{i as I,e as T}from"./index-0824eecd.js";import{D as z}from"./DeleteNodeIcon-636b7b24.js";import{S as E}from"./Skeleton-ee2aa5bc.js";import{C as L}from"./ClipLoader-8427fdc9.js";const M=({nodeName:p})=>e.jsx(i,{children:e.jsxs(i,{align:"center",direction:"column",justify:"space-between",children:[e.jsx(F,{children:e.jsx(z,{})}),e.jsxs(A,{children:["Are you sure you want to delete ",p||"this item","?"]})]})}),A=c(i)`
  color: ${t.white};
  font-family: 'Barlow';
  font-size: 20px;
  font-weight: 400;
