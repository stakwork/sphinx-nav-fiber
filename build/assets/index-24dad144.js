...
`,Uo=b(y)`
  ...
  font-weight: 600;
  line-height: 17px;
`,Go=({text:e,imageUrl:t,date:n,twitterHandle:r,name:i,verified:o})=>s.jsxs(y,{direction:"column",children:[s.jsxs(y,{align:"center",direction:"row",pr:16,children:[s.jsx(Yo,{children:s.jsx(ke,{rounded:!0,size:27,src:t||"",type:"person"})}),s.jsxs(y,{children:[s.jsxs(qo,{align:"center",direction:"row",children:[i,o&&s.jsx("div",{className:"verification",children:s.jsx("img",{alt:"verified",src:"verified_twitter.svg"})})]}),r&&s.jsxs(Wo,{children:["@",r]})]})]}),s.jsxs(y,{grow:1,shrink:1,children:[s.jsx(Qo,{"data-testid":"episode-description",children:e}),s.jsx(y,{"data-testid":"date-text",direction:"row",justify:"flex-start",children:!!n&&s.jsx(ct,{children:Ht.unix(n).fromNow()})})]})]}),Yo=b(y)`
  img {
    width: 64px;
    height: 64px;
    border-radius: 50%;
...
`,Ir=({node:e})=>{const t=fe(k=>k.selectedNode),n=pe(k=>k.currentSearch),{link:r,image_url:i,date:o,boost:l,node_type:a,type:c,id:u,show_title:p,episode_title:h,ref_id:f}=e||t||{},[d,g]=A.useState(l||0);return A.useEffect(()=>{g(l??0)},[l]),!e&&!t?null:s.jsx("div",{style:{overflow:"auto",flex:1,width:"100%"},children:s.jsxs(Dl,{children:[s.jsx(Nl,{boostCount:d||0,date:o||0,episodeTitle:rt(h),imageUrl:i,isSelectedView:!0,link:r,onClick:()=>null,showTitle:p,type:a||c}),s.jsx(yt,{}),s.jsxs(Fl,{children:[s.jsx(Yt,{amt:d}),s.jsx(kr,{content:e||t,count:d,refId:f,updateCount:g})]}),s.jsx(yt,{}),s.jsx(wn,{children:s.jsx(Il,{node:e||t,searchTerm:n,stateless:!0})}),((t==null?void 0:t.text)||(e==null?void 0:e.text))&&s.jsxs(s.Fragment,{children:[s.jsx(yt,{}),s.jsx(wn,{children:s.jsx(zl,{node:e||t,stateless:!0},u)})]})]})})},Dl=b(y)`
  flex: 1;
  min-height: 100%;
  flex-direction: column;
...
`,ua=b.div`
  width: 100%;
  cursor: pointer;
`,ca=A.memo(ia),pa=({open:e})=>{const{setSelectedNode:t,setTeachMe:n,showTeachMe:r}=fe(a=>a),i=xe(),{setSidebarOpen:o}=pe(a=>a),{playingNode:l}=at(a=>a);return s.jsx(Wt,{"data-testid":"sidebar-sub-view",direction:"right",in:e,style:{width:r?"700px":"",position:e?"relative":"absolute"},children:s.jsxs(ha,{children:[s.jsx(ca,{hidden:(i==null?void 0:i.ref_id)!==(l==null?void 0:l.ref_id)},l==null?void 0:l.ref_id),s.jsx(fa,{children:s.jsx(qs,{})}),s.jsx(da,{"data-testid":"close-sidebar-sub-view",onClick:()=>{t(null),n(!1)},children:s.jsx(to,{})}),s.jsx(xa,{onClick:()=>{o(!1)},children:s.jsx(Cr,{})})]})})},ha=b(y)(({theme:e})=>({position:"relative",background:w.BG1,width:"100%",margin:"64px auto 20px 10px",borderRadius:"16px",zIndex:29,[e.breakpoints.up("sm")]:{width:"390px"}})),da=b(y)`
  font-size: 32px;
  color: ${w.white};
  cursor: pointer;
  position: absolute;
