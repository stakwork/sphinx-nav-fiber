import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-f842b4a8.js";import{B as F}from"./index-4a0cf058.js";import{u as M}from"./index-68d1ccbb.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-df6632eb.js";import{B as f,T as R,a as L}from"./index-149b7b19.js";import{T as x}from"./index-09d8cf9c.js";import"./useSlotProps-796f1c4e.js";import"./index.esm-d0aef4eb.js";import"./InfoIcon-fb436e5f.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
