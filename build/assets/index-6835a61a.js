import{o as s,F as o,T as w,p as C,r as f,j as e,q as c,A as S,aU as A,aV as b,aW as z,J as D,O as y}from"./index-47516e4c.js";import{B as G}from"./index-0ea961d0.js";import{G as M,B as v,h as $,F as B}from"./index-a07c4456.js";import{C as T}from"./ClipLoader-ce8b12a0.js";import{T as j}from"./index-1854f954.js";import{S as E}from"./index-e844304d.js";import{e as I}from"./index.esm-634e1db3.js";import{T as k,a as F}from"./Tabs-8ffe4461.js";import"./InfoIcon-693ea716.js";import"./useSlotProps-79be829e.js";import"./createSvgIcon-7bf4031d.js";const R=({onClose:a})=>{const[l]=C(d=>[d.graphStyle]),[r,i]=f.useState(!1),p=()=>{i(!0),localStorage.setItem("graphStyle",l),i(!1),a()};return e.jsxs(W,{direction:"column",children:[e.jsx(V,{children:"Default graph view:"}),e.jsx(M,{}),e.jsx(o,{mt:308,py:24,children:e.jsx(v,{color:"secondary",disabled:r,id:"add-node-submit-cta",onClick:p,size:"large",startIcon:r&&e.jsx(L,{children:e.jsx(T,{color:c.lightGray,size:12})}),type:"submit",variant:"contained",children:"Save Changes"})})]})},W=s(o)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,V=s(w)`
