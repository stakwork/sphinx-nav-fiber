import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-383e0c8b.js";import{B}from"./index-80cb1ac9.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-064ddb25.js";import{B as f,T as $,a as k}from"./index-76264462.js";import{T as u}from"./index-b9c662ce.js";import"./useSlotProps-39eda9f8.js";import"./index.esm-32fe5a81.js";import"./InfoIcon-00f7404d.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
