import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,C as B,h as c,r as v,x as C}from"./index-8b56f4fe.js";import{B as F}from"./index-452400ee.js";import{u as M}from"./index-c56162e9.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-50228881.js";import{B as f,T as L,a as R}from"./index-1af52257.js";import{T as x}from"./index-35b55efc.js";import"./useSlotProps-d4d40b43.js";import"./index.esm-6540f135.js";import"./InfoIcon-0ae6f610.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
