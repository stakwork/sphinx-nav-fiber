import{r as n,j as e,s as f,g as T,F as S,o as K,c as U,A as ae,p as ce,i as le,q as pe,H as de,t as ue,v as fe,f as q}from"./index-6273d8a8.js";import{Universe as me}from"./index-b13c07b3.js";import{u as he}from"./index-52c444a4.js";import{u as W,a as ge,b as xe,I as ye,c as Q,d as V}from"./index-8ed1ad7c.js";import{M as be,V as we}from"./VolumeIcon-ff0d949a.js";import{S as je,R as ve,s as X,M as Se}from"./index-648759b7.js";import"./index-cf1afc0c.js";import"./VisibilityOn-f28f0e31.js";import"./SourcesTableIcon-26a1b2e5.js";import"./NodeCircleIcon-7df9d4c4.js";import"./CheckIcon-0f8c3251.js";import"./DeleteNodeIcon-47913c81.js";import"./EditNodeIcon-a3060c79.js";import"./SearchIcon-1de71d4a.js";import"./SoundIcon-7a64873f.js";import"./SucessFeedBackIcon-7d434a6a.js";import"./three.module-1c1ec8b9.js";import"./TextareaAutosize-8e4fa733.js";import"./index-96aaf132.js";import"./index-290c72c7.js";import"./index-70550717.js";import"./ClipLoader-15e924cd.js";import"./Skeleton-604a7c7b.js";import"./Stack-6ab21d61.js";import"./index-add9eb36.js";import"./FormControlLabel-aac600ef.js";import"./Typography-9fff7cad.js";import"./createSvgIcon-97f66f4e.js";import"./isPlainObject-2c369cd7.js";function D(t){const[i,s,r]=t.split(":").map(Number);return Number((i*60*60*1e3+s*60*1e3+r*1e3).toFixed(6))}const Z=n.memo(()=>{const t=W(a=>a.isPlaying),i=W(a=>a.setIsPlaying),s=W(a=>a.setVolume),r=W(a=>a.setPlaybackSpeed),c=W(a=>a.playbackSpeed),o=W(a=>a.playerRef),[x,b]=n.useState(!1),m=[.5,1,1.5,2],g=()=>{if(o){const a=o.getCurrentTime()-15;o.seekTo(a,"seconds")}},p=()=>{if(o){const a=o.getCurrentTime()+15;o.seekTo(a,"seconds")}},j=()=>{i(!t)},d=()=>{b(!x),s(x?1:0)},h=()=>{const I=(m.indexOf(c)+1)%m.length,F=m[I];if(r(F),o){const P=o.getInternalPlayer();P&&typeof P.playbackRate<"u"&&(P.playbackRate=F)}};return e.jsxs(ke,{children:[e.jsx(Pe,{onClick:d,children:x?e.jsx(be,{}):e.jsx(we,{})}),e.jsx(Te,{onClick:g,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(Ce,{"data-testid":"play-pause-button",onClick:j,size:"small",children:t?e.jsx(ge,{"data-testid":"pause-icon"}):e.jsx(xe,{"data-testid":"play-icon"})}),e.jsx(Ie,{onClick:p,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(_e,{onClick:h,children:[c,"x"]})]})});Z.displayName="Controls";const ke=f(S).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${T.BG1};
  border-radius: 40px;
