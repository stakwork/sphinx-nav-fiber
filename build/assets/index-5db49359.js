import{Y as i,X as n,Z as m,j as e,ac as T,a0 as p,r as A,a1 as v}from"./index-8faf46a6.js";import{aA as M,ch as $,ci as b,cj as k,aK as j,ck as B,cl as D,cm as x,cb as C,cn as F,co as G,u as R,cc as L}from"./index-71ade4e6.js";const P=({onClose:a})=>{const[s]=M(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(b,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(m)`
...
`,E=i.form`
  padding: 36px;
`,h=a=>{const{children:s,value:r,index:t,...c}=a;return r===t?e.jsx(q,{"aria-labelledby":`simple-tab-${t}`,hidden:r!==t,id:`simple-tabpanel-${t}`,role:"tabpanel",...c,children:s}):null};function u(a){return{id:`simple-tab-${a}`,"aria-controls":`simple-tabpanel-${a}`}}const H=({onClose:a})=>{const[s,r]=A.useState(0),[t,c]=v(l=>[l.isAdmin,l.setPubKey,l.pubKey]),o=j(l=>l.appMetaData),d=()=>t?"Admin Settings":"Settings",f=({children:l})=>e.jsxs(Y,{children:[e.jsxs(n,{direction:"row",pt:3,children:[e.jsx(X,{"data-testid":"setting-label",children:d()}),y()]}),l]}),y=()=>!c||t?null:e.jsx(e.Fragment,{}),S=(l,w)=>{r(w)};return e.jsxs(U,{direction:"column",children:[e.jsx(f,{children:e.jsxs(I,{"aria-label":"settings tabs",onChange:S,value:s,children:[t&&e.jsx(g,{disableRipple:!0,label:"General",...u(0)}),e.jsx(g,{color:p.white,disableRipple:!0,label:"Appearance",...u(1)})]})}),t&&e.jsx(e.Fragment,{children:e.jsx(h,{index:0,value:s,children:e.jsx(K,{initialValues:o})})}),e.jsx(h,{index:t?1:0,value:s,children:e.jsx(P,{onClose:a})})]})},I=i(F)`
  && {
    .MuiTabs-indicator {
