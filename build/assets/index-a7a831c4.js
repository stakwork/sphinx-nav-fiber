import{f as r,F as i,T as g,i as y,j as e,k as b,L as S,D as w,h as x,r as T,x as v,B as m}from"./index-8f0fe879.js";import{B}from"./index-d20a2c64.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-1cafe5b3.js";import{B as f,T as $,a as k}from"./index-1afba01d.js";import{T as u}from"./index-b2d69e89.js";import"./useSlotProps-24d3a778.js";import"./index.esm-eaea2432.js";import"./InfoIcon-c57ee9a7.js";const F=({onClose:t})=>{const[s]=y(n=>[n.graphStyle]),o=()=>{localStorage.setItem("graphStyle",s),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(L,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(i,{mt:308,children:e.jsx(f,{kind:"big",onClick:o,children:"Save Changes"})})]})},G=r(i)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,L=r(g)`
