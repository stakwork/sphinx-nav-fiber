import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-70bf1cd1.js";import{B as M}from"./index-a48065f6.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-6b2a5193.js";import{B as f,T as L,a as R}from"./index-92a046fe.js";import{T as x}from"./index-77fe4f2e.js";import"./useSlotProps-814ba413.js";import"./index.esm-adce71f0.js";import"./InfoIcon-4dc4c8e8.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
