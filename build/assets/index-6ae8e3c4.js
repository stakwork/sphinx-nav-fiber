import{p as a,q as r,F as i,t as S,j as e,v as B,w as I,E as v,r as b,C as $,D as C,aJ as A,aK as y,aL as k,Q as w}from"./index-1f98d9ca.js";import{B as z}from"./index-72da1f39.js";import{u as M,H as D,C as E,x as R,J as L,B as T,q as F,F as P}from"./index-678ad053.js";import{C as G}from"./ClipLoader-1ea6bda3.js";import{e as W}from"./index.esm-12e999a1.js";import{S as V}from"./index-3b5c0797.js";import{T as j}from"./index-b0915f30.js";import{T as U,a as N}from"./Tabs-d3e141ab.js";import"./createSvgIcon-d71ef45b.js";const Y={split:e.jsx(D,{}),force:e.jsx(E,{}),sphere:e.jsx(R,{}),earth:e.jsx(L,{})},q=()=>{const[n,p]=S(M(t=>[t.graphStyle,t.setGraphStyle])),l=t=>{p(t)};return e.jsx(H,{direction:"column",children:B.map(t=>e.jsx(i,{className:I("icon",{active:n===t}),onClick:()=>l(t),children:Y[t]},t))})},H=a(i).attrs({direction:"row",align:"center",justify:"space-between"})`
  width: 447px;
  height: 48px;
