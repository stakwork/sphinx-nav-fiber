import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,C as B,h as c,r as v,x as C}from"./index-d440f76e.js";import{B as F}from"./index-c19948cb.js";import{u as M}from"./index-4c1d247d.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-ab80e8b0.js";import{B as f,T as L,a as R}from"./index-1d5f1d1a.js";import{T as x}from"./index-59c7c63a.js";import"./useSlotProps-2e34ad42.js";import"./index.esm-5f5b7364.js";import"./InfoIcon-73b5f775.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
