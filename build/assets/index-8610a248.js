import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-2b2e50af.js";import{B as M}from"./index-8896a668.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-52859160.js";import{B as f,T as L,a as R}from"./index-6f897188.js";import{T as x}from"./index-f05ece84.js";import"./useSlotProps-e8abd4ce.js";import"./index.esm-12a2c494.js";import"./InfoIcon-e1d5caeb.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
