import{o as s,F as o,T as w,p as C,r as f,j as e,q as c,A as S,aU as A,aV as b,aW as M,M as z,Q as y}from"./index-fed06baa.js";import{B as D}from"./index-873180a9.js";import{G,B as v,i as $,F as B}from"./index-fb3eaf2c.js";import{C as T}from"./ClipLoader-a761bbaf.js";import{T as j}from"./index-b5cd46d4.js";import{S as E}from"./index-eb5e05cf.js";import{e as I}from"./index.esm-4149fe02.js";import{T as k,a as F}from"./Tabs-d37e82f1.js";import"./InfoIcon-b5a99a56.js";import"./useSlotProps-e6063bc9.js";import"./createSvgIcon-71c191ae.js";const R=({onClose:a})=>{const[l]=C(d=>[d.graphStyle]),[r,i]=f.useState(!1),p=()=>{i(!0),localStorage.setItem("graphStyle",l),i(!1),a()};return e.jsxs(W,{direction:"column",children:[e.jsx(V,{children:"Default graph view:"}),e.jsx(G,{}),e.jsx(o,{mt:308,py:24,children:e.jsx(v,{color:"secondary",disabled:r,id:"add-node-submit-cta",onClick:p,size:"large",startIcon:r&&e.jsx(L,{children:e.jsx(T,{color:c.lightGray,size:12})}),type:"submit",variant:"contained",children:"Save Changes"})})]})},W=s(o)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,V=s(w)`
