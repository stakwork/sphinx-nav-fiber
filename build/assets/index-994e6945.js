import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-10ba6357.js";import{B}from"./index-e1510dd9.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-0311feb0.js";import{B as f,T as $,a as k}from"./index-e6b7dc22.js";import{T as u}from"./index-43fb0a19.js";import"./useSlotProps-1ec3b865.js";import"./index.esm-12fd3e0f.js";import"./InfoIcon-7e45a0a9.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
