import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-2d3d8e17.js";import{B}from"./index-3c9aee47.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-6cb29e2e.js";import{B as f,T as $,a as k}from"./index-f2958598.js";import{T as u}from"./index-88bd5774.js";import"./useSlotProps-18e843b2.js";import"./index.esm-016ad9de.js";import"./InfoIcon-811cd12e.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
