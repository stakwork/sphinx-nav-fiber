...
`,Ze=p.div`
  ...
  width: 100%;
  cursor: pointer;
`,Ve=s.memo(ze),ee=s.forwardRef(({active:t,start:o,text:r},c)=>e.jsxs(Oe,{ref:c,className:oe({active:t}),children:[e.jsx(qe,{children:o}),e.jsx(Ue,{children:e.jsx("span",{children:r})})]}));ee.displayName="ParagraphComponent";const O=s.memo(ee,(t,o)=>t.active===o.active),Oe=p(v)`
  flex-direction: row;
