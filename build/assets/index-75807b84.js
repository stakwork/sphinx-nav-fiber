import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-9f975889.js";import{B as M}from"./index-284735c6.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-069fa716.js";import{B as f,T as L,a as R}from"./index-e66ee42b.js";import{T as x}from"./index-39d3ead8.js";import"./useSlotProps-a7d6430a.js";import"./index.esm-b8208375.js";import"./InfoIcon-a417ded5.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
