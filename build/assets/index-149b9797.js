...
`,ir=v.lazy(()=>ke(()=>import("./index-8cb74346.js"),["assets/index-8cb74346.js","assets/index-cde1947e.js","assets/index-b4d03b7b.css","assets/index-13a86562.js","assets/SourcesTableIcon-d767bffd.js","assets/index-a57539fa.js","assets/CheckIcon-e1b3e689.js","assets/DeleteNodeIcon-3cd6f727.js","assets/SoundIcon-b5ab64d8.js","assets/SucessFeedBackIcon-752148e4.js","assets/ClipLoader-c970f843.js","assets/TableRow-05fd2596.js"]).then(({TweetAnalyze:e})=>({default:e}))),ar=()=>{const e=$(o=>o.setSelectedTweet),t=$(o=>o.selectedTweet),{tweetId:a}=fe(),[r,n]=v.useState(""),{open:i}=De("tweetAnalyze"),l=(a==null?void 0:a.split("&"))||[],c=o=>{i(),n(o)};return s.jsxs(or,{align:"stretch",basis:"100%",grow:1,shrink:1,children:[l.length>1?s.jsx(sr,{onClick:()=>{c("summary")},children:"Summary Report"}):null,l.map(o=>s.jsx(cr,{className:t===o?"selected":"",onClick:()=>e(o),children:s.jsx(Vt,{handleAnalyzeClick:()=>{c(o)},nodeId:o})},o)),s.jsx(ir,{tweetId:r})]})},sr=f.button`
  width: 100%;
  background: ${y.ANALYTICS_CARD_BG};
  color: ${y.white};
  padding: 16px 16px;
