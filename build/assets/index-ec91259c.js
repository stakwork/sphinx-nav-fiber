import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-a4c64423.js";import{B as F}from"./index-85565bb3.js";import{u as M}from"./index-77834080.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-ef542b01.js";import{B as f,T as R,a as L}from"./index-4f71bcbe.js";import{T as x}from"./index-e70a78c4.js";import"./useSlotProps-85785303.js";import"./index.esm-8f3b8db4.js";import"./InfoIcon-3c0fbdc4.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
