import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-d7ba324c.js";import{B as M}from"./index-aecf6f59.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-54f99a09.js";import{B as f,T as L,a as R}from"./index-0c5828d4.js";import{T as x}from"./index-c8eb0ffe.js";import"./useSlotProps-dc4e15c3.js";import"./index.esm-75a1d543.js";import"./InfoIcon-62a74ee1.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
