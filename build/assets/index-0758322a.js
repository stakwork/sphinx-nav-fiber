import{r as o,j as e,s as f,g as v,F as j,o as Y,c as J,A as ie,p as ae,i as ce,q as le,H as pe,t as de,v as ue}from"./index-955e3483.js";import{ClaimsModal as me}from"./index-cf1b6867.js";import{U as fe}from"./index-d9e6d614.js";import{t as U,u as G}from"./index-da5fefee.js";import{u as M,a as he,b as ge,I as xe,c as K,d as ye}from"./index-40a0299c.js";import{M as we,V as be}from"./index-42f17c08.js";import{S as je,R as ve,s as V,M as Se}from"./index-7e44574b.js";import"./string-a277709d.js";import"./index-97937e32.js";import"./three.module-0192f2a3.js";import"./isPlainObject-7848c088.js";import"./TextareaAutosize-f4b23bcd.js";import"./CheckIcon-5d4463f8.js";import"./index-011bc1f0.js";import"./index-ecb0c9b7.js";import"./index-d86c459d.js";import"./ClipLoader-0e81d132.js";import"./clsx-40eb567e.js";import"./SourcesTableIcon-40bc7934.js";import"./DeleteNodeIcon-d05062e3.js";import"./SoundIcon-0dfae750.js";import"./SucessFeedBackIcon-56acdd4b.js";import"./Skeleton-c7de2e86.js";import"./index-17293fbe.js";import"./Stack-a952704d.js";import"./FormControlLabel-be80017e.js";import"./Typography-7898505e.js";import"./createSvgIcon-a53ed9c6.js";const Q=o.memo(()=>{const r=M(s=>s.isPlaying),i=M(s=>s.setIsPlaying),n=M(s=>s.setVolume),t=M(s=>s.setPlaybackSpeed),c=M(s=>s.playbackSpeed),a=M(s=>s.playerRef),[d,g]=o.useState(!1),y=[.5,1,1.5,2],h=()=>{if(a){const s=a.getCurrentTime()-15;a.seekTo(s,"seconds")}},u=()=>{if(a){const s=a.getCurrentTime()+15;a.seekTo(s,"seconds")}},b=()=>{i(!r)},l=()=>{g(!d),n(d?1:0)},p=()=>{const m=(y.indexOf(c)+1)%y.length,P=y[m];if(t(P),a){const _=a.getInternalPlayer();_&&typeof _.playbackRate<"u"&&(_.playbackRate=P)}};return e.jsxs(ke,{children:[e.jsx(_e,{onClick:l,children:d?e.jsx(we,{}):e.jsx(be,{})}),e.jsx(Ie,{onClick:h,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(Ce,{"data-testid":"play-pause-button",onClick:b,size:"small",children:r?e.jsx(he,{"data-testid":"pause-icon"}):e.jsx(ge,{"data-testid":"play-icon"})}),e.jsx(Pe,{onClick:u,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(Te,{onClick:p,children:[c,"x"]})]})});Q.displayName="Controls";const ke=f(j).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${v.BG1};
  border-radius: 40px;
