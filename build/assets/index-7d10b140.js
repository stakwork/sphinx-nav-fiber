import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-6073401a.js";import{B}from"./index-13a2d914.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-dc7c60da.js";import{B as f,T as $,a as k}from"./index-44c0478b.js";import{T as u}from"./index-b8f3fc2b.js";import"./useSlotProps-4ac496cf.js";import"./index.esm-3262925e.js";import"./InfoIcon-9b7fc1c3.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
