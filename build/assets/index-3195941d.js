import{s as x,c as f,u as P,r as m,j as e,F as o,T as u,b as N,x as V,o as q,ad as J,g as Y,ae as S,d as H,a2 as K}from"./index-324d51ec.js";import{ak as Q,B as w,al as W,l as X,F as Z,am as ee}from"./react-toastify.esm-31fcbb2e.js";import{B as te}from"./index-14a3a191.js";import{n as y}from"./toastMessage-e7ad6d20.js";import{a as C}from"./index-c23c9d51.js";import{u as oe}from"./index-9edcc142.js";import{C as ne}from"./CheckIcon-4d4b2f64.js";import{T as _}from"./index-9ad82c31.js";import{A as se}from"./index-30cf16d2.js";import"./index.esm-b5625140.js";import"./InfoIcon-9f2b633d.js";import"./index-ccb1ef85.js";import"./Popover-46949e68.js";import"./useSlotProps-6ca3381f.js";import"./Select-18ff8597.js";import"./Stack-7d79a4c4.js";import"./Popper-7b1335fa.js";const ae=({onClick:n,loading:r})=>{const i=P(l=>l.budget),[c,p]=m.useState(10),a="node";return m.useEffect(()=>{(async()=>{try{const t=await W(a);p(t.data.price)}catch(t){console.error("cannot fetch",t)}})()},[a]),e.jsxs(o,{children:[e.jsx(o,{align:"center",direction:"row",justify:"space-between",mb:20,children:e.jsx(o,{align:"center",direction:"row",children:e.jsx(ce,{children:"Approve Cost"})})}),e.jsxs(o,{align:"center",direction:"row",justify:"space-between",mb:20,children:[e.jsxs(re,{children:[e.jsx("div",{className:"title",children:"COST"}),e.jsxs("div",{className:"value","data-testid":"check-price",children:[c," sats"]})]}),e.jsxs(ie,{children:[e.jsx("div",{className:"title",children:"BUDGET"}),e.jsxs("div",{className:"value",children:[Q(i)," sats"]})]})]}),e.jsx(o,{children:e.jsx(w,{color:"secondary","data-testid":"check-icon",disabled:r,onClick:n,size:"large",startIcon:e.jsx(ne,{}),type:"submit",variant:"contained",children:"Approve"})})]})},re=x(o).attrs({direction:"column",align:"space-between",justify:"flex-start"})`
  width: 141px;
  height: 61px;
