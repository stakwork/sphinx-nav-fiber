...
`,wn=({setIsAddEdgeNode:t,edgeData:n,setGraphLoading:s})=>{const e=()=>{t(!1)};return o.jsxs(w,{children:[o.jsx(w,{direction:"row",justify:"flex-end",children:o.jsx(jn,{"data-testid":"close-sidebar-sub-view",onClick:e,children:o.jsx(lt,{})})}),o.jsx(xn,{edgeLinkData:n,onCancel:e,setGraphLoading:s})]})},jn=V(w)`
  font-size: 32px;
  color: ${D.white};
  cursor: pointer;
`,vn=/^[a-z0-9_]+$/,Cn=({parentParam:t,onDelete:n})=>{const[s,e]=g.useState(!1),[a,l]=g.useState([]),{fields:u,append:i,replace:c,remove:E}=bo({name:"attributes"}),{setValue:d,watch:h}=yo();return g.useEffect(()=>{const m=async()=>{try{let x=[{required:!1,type:"string",key:""}];if(t!==Qt.value.toLowerCase()){e(!0);const b=await Zt(t);b.attributes&&typeof b.attributes=="object"?x=st(b.attributes):x=st(b)}x=x.filter(b=>b.key!=="node_key"),c(x),l(x)}catch(x){console.warn(x)}finally{e(!1)}};a.length===0&&m()},[t,d,c,a.length]),o.jsxs(o.Fragment,{children:[s?o.jsx(w,{align:"center",children:o.jsx(le,{color:D.SECONDARY_BLUE,size:"30"})}):o.jsx(En,{py:8,children:o.jsx(ce,{container:!0,spacing:2,children:u.map((m,x)=>{const b=h(`attributes[${x}].type`),y=h(`attributes[${x}].required`),P=m.isNew||!1,v=["name"].includes(h(`attributes[${x}].key`));return o.jsxs(g.Fragment,{children:[o.jsx(ce,{item:!0,xs:5,children:o.jsx(We,{autoComplete:"off",className:"text-input",dataTestId:`cy-item-name-${x}`,disabled:!P,id:`cy-item-name-${x}`,maxLength:50,name:`attributes.${x}.key`,placeholder:"Enter value",rules:{...Be,pattern:{message:"Please avoid special characters, spaces and uppercase",value:vn}}})}),o.jsx(ce,{item:!0,xs:4,children:o.jsx(Fe,{dataTestId:`cy-item-select-${x}`,disabled:v,onSelect:j=>d(`attributes[${x}].type`,j==null?void 0:j.value),options:vt,selectedValue:vt.find(j=>j.value===b)})}),o.jsxs(ce,{item:!0,xs:3,children:[o.jsx(fn,{checked:y,"data-testid":`cy-item-${x}`,disabled:v,name:`attributes.${x}.required`,onChange:j=>d(`attributes[${x}].required`,j.target.checked),size:"small"}),!v&&o.jsx(wo,{onClick:()=>{E(x),m.key!==void 0&&n&&n(m.key)},children:o.jsx(Co,{})})]})]},m.id)})})}),o.jsx(w,{align:"flex-start",py:12,children:o.jsx(Oe,{"data-testid":"add-attribute-btn",onClick:()=>i({key:"",type:"string",required:!0,isNew:!0}),size:"medium",startIcon:o.jsx(Eo,{}),variant:"contained",children:"Add Attribute"})})]})},En=V(w)`
  overflow-y: auto;
  width: calc(100% + 20px);
  max-height: calc(80vh - 300px);
`,Pn=({parent:t,onDelete:n})=>{const s=t;return o.jsxs(w,{children:[o.jsx(w,{direction:"row",mb:10,children:o.jsxs(ce,{container:!0,spacing:2,children:[o.jsx(ce,{item:!0,xs:5,children:o.jsx(tt,{style:{marginRight:180},children:"Attributes"})}),o.jsx(ce,{item:!0,xs:4,children:o.jsx(tt,{style:{marginRight:130},children:"Type"})}),o.jsx(ce,{item:!0,xs:3,children:o.jsx(tt,{children:"Required"})})]})}),s&&o.jsx(Cn,{onDelete:n,parentParam:s},s)]})},tt=V(K)`
  font-size: 15px;
  color: gray;
`,Tn={type:"",parent:""},On=(t,n)=>t.length!==n.length?!0:t.some((s,e)=>{const a=n[e];return s.required!==a.required||s.type!==a.type||s.key!==a.key}),An=async(t,n=!1,s)=>{try{const{attributes:e,...a}=t,l={...Po(e),...s.reduce((c,E)=>({...c,[E]:"delete"}),{})},u={...a,attributes:l};let i;if(n?i=await Le.put(`/schema/${t.ref_id}`,JSON.stringify(u),{}):i=await Le.post("/schema",JSON.stringify({...u,node_key:"name"}),{}),i.status!=="success")throw new Error("error");return i==null?void 0:i.ref_id}catch(e){let a=pe;if(e.status===400){const l=await e.json();a=l.errorCode||(l==null?void 0:l.status)||pe}else e instanceof Error&&(a=e.message);throw new Error(a)}},Mn=t=>t.charAt(0).toUpperCase()+t.slice(1),$t=async(t,n)=>{try{const l=((await at()).schemas||[]).filter(u=>!u.is_deleted&&u.type&&(!n||n(u))).map(u=>u.type==="thing"?{label:"No Parent",value:u.type}:{label:Mn(u.type),value:u.type});t(l)}catch(s){console.warn(s)}},$n=({graphLoading:t,onSchemaCreate:n,selectedSchema:s,onDelete:e,setSelectedSchemaId:a,setGraphLoading:l,setIsCreateNew:u,onSchemaUpdate:i})=>{const{close:c,visible:E}=Xt("addType"),d=ct({mode:"onChange",defaultValues:s?{type:s.type,parent:s.parent}:Tn}),{watch:h,setValue:m,reset:x,getValues:b}=d,[y,P]=g.useState(!1),[v,j]=g.useState(!1),[M,A]=g.useState(!1),[C,_]=g.useState(null),[B,z]=g.useState(!1),[F,f]=g.useState(null),[$,L]=g.useState(""),[S,W]=g.useState(null),[X,te]=g.useState([]),[re,J]=g.useState([]),[me,Ae]=g.useState(!0);g.useEffect(()=>()=>{x()},[E,x]);const Me=()=>{u(!1),a("")};g.useEffect(()=>{s||(A(!0),$t(_).finally(()=>A(!1)))},[s]),g.useEffect(()=>{(async()=>{if(s){m("type",s==null?void 0:s.type),m("parent",s.parent);let k=[{required:!1,type:"string",key:""}];if(s.type!==Qt.value.toLowerCase()){const Y=await Zt(s.type);k=Y?st(Y):k}k=k.filter(Y=>Y.key!=="node_key"),J(k),await $t(f,Y=>Y.type!==s.type)}})()},[s,m]);const U=h("parent");h("type");const $e=I=>Array.isArray(I)&&I.every(k=>typeof k=="object"&&"key"in k),ge=h("attributes"),xe=g.useMemo(()=>$e(ge)?ge:[],[ge]),He=()=>{c()},Ue=I=>{te(k=>[...k,I])},Ze=async()=>{if(s!=null&&s.type){j(!0),l(!0);try{await Le.delete(`/schema/${s.ref_id}`),e(s.type),c()}catch(I){let k=pe;if((I==null?void 0:I.status)===400){const Y=await I.json();k=Y.errorCode||(Y==null?void 0:Y.status)||pe}else I instanceof Error&&(k=I.message);W(k)}finally{j(!1),l(!1),u(!1)}}},Se=d.handleSubmit(async I=>{if(!U){z(!0);return}P(!0);try{if(s&&I.type!==(s==null?void 0:s.type)||s&&b().parent!==(s==null?void 0:s.parent)){const Y=b().parent??(s==null?void 0:s.parent);l(!0),await Le.put(`/schema/${s==null?void 0:s.ref_id}`,JSON.stringify({type:I.type,parent:Y})),await i()}const k=await An({...I,...s?{ref_id:s==null?void 0:s.ref_id}:{}},!!s,X);n({type:I.type,parent:U||"",ref_id:(s==null?void 0:s.ref_id)||k||"new"}),He()}catch(k){let Y=pe;if((k==null?void 0:k.status)===400){const ie=await k.json();Y=ie.errorCode||(ie==null?void 0:ie.status)||pe}else k instanceof Error&&(Y=k.message);L(Y)}finally{P(!1),l(!1),u(!1)}});g.useEffect(()=>{const I=d.watch(k=>{var ye,we,Ie,Ne,je;const Y=On(xe,re),ie=((ye=k.type)==null?void 0:ye.trim())!==((we=s==null?void 0:s.type)==null?void 0:we.trim())||((Ie=k.parent)==null?void 0:Ie.trim())!==((Ne=s==null?void 0:s.parent)==null?void 0:Ne.trim())||Y,be=!!((je=k.type)!=null&&je.trim());Ae(s?y||!ie||!be||B:y||B||!be)});return()=>I.unsubscribe()},[d,xe,re,s,y,B]);const Xe=()=>C==null?void 0:C.find(I=>I.value===U),_e=()=>{const I=F==null?void 0:F.find(k=>k.value===U);if(I)return I;if(U)return{label:U,value:U}};return o.jsxs(w,{children:[o.jsx(w,{direction:"row",justify:"flex-end",children:o.jsx(In,{"data-testid":"close-sidebar-sub-view",onClick:Me,children:o.jsx(lt,{})})}),o.jsx(w,{children:o.jsx(Kt,{...d,children:o.jsxs("form",{id:"add-type-form",onSubmit:Se,children:[o.jsx(w,{children:s?o.jsxs(o.Fragment,{children:[o.jsxs(w,{mb:12,children:[o.jsx(w,{mb:12,children:o.jsx(K,{children:"Name"})}),o.jsx(w,{mb:12,children:o.jsx(We,{dataTestId:"cy-item-name",defaultValue:s==null?void 0:s.type,id:"cy-item-name",maxLength:250,name:"type",placeholder:"Enter type name",rules:{...Be},value:U})})]}),o.jsxs(w,{mb:12,children:[o.jsx(w,{mb:12,children:o.jsx(K,{children:"Parent"})}),o.jsx(Fe,{isLoading:M||t,onSelect:I=>{m("parent",(I==null?void 0:I.value)||""),z(!1)},options:F||[],selectedValue:_e()}),$&&o.jsx(ot,{children:$})]})]}):o.jsxs(o.Fragment,{children:[o.jsxs(w,{mb:12,children:[o.jsx(w,{mb:12,children:o.jsx(K,{children:"Select Parent"})}),o.jsx(Fe,{isLoading:M,onSelect:I=>{m("parent",(I==null?void 0:I.value)||""),z(!1)},options:C,selectedValue:Xe()}),B&&o.jsx(ot,{children:"A parent type must be selected"})]}),o.jsxs(w,{children:[o.jsx(w,{mb:12,children:o.jsx(K,{children:"Type name"})}),o.jsx(w,{mb:12,children:o.jsx(We,{id:"cy-item-name",maxLength:250,name:"type",placeholder:"Enter type name",rules:{...Be},value:U})})]})]})}),o.jsx(Pn,{onDelete:Ue,parent:s?s.type:U}),o.jsxs(w,{direction:"row",justify:"space-between",mt:20,children:[s&&o.jsxs(w,{direction:"column",children:[o.jsxs(_n,{color:"secondary",disabled:v,onClick:Ze,size:"large",style:{marginRight:20},variant:"contained",children:["Delete",v&&o.jsxs(St,{children:[o.jsx(le,{color:D.lightGray,size:12})," "]})]}),S&&o.jsx(ot,{children:S})]}),o.jsxs(Sn,{color:"secondary",disabled:me,onClick:Se,size:"large",variant:"contained",children:["Confirm",y&&o.jsxs(St,{children:[o.jsx(le,{color:D.lightGray,size:12})," "]})]})]})]})})})]})},Sn=V(Oe)`
  width: 100% !important;
...
`,is=({onCreateNew:t,onAddEdgeNode:n})=>o.jsxs(as,{children:[o.jsxs(Dt,{"data-testid":"add-schema-type",onClick:t,children:[o.jsx(Vt,{children:o.jsx(Tt,{})}),o.jsx(K,{children:"Add Type"})]}),o.jsxs(Dt,{"data-testid":"add-edge",onClick:n,children:[o.jsx(Vt,{children:o.jsx(Tt,{})}),o.jsx(K,{children:"Add Edge"})]})]}),as=V(w).attrs({align:"flex-start",direction:"column",justify:"flex-start"})`
  flex: 1 1 auto;
  z-index: 31;
...
`,Dt=V(w).attrs({align:"center",justify:"center",p:0})`
  position: relative;
  width: 64px;
  height: 58px;
  padding: 0;
...
`,Vt=V(w)`
  ...
  align-items: center;
  font-size: 24px;
`,cs=({Close:t})=>{const[n,s]=g.useState(""),[e,a]=g.useState(!1),[l,u]=g.useState(!1),[i,c]=g.useState(!1),[E,d]=g.useState({refId:"",edgeType:"",source:"",target:""}),[h,m]=g.useState(!1),[x,b]=g.useState("all"),[y,P,v,j]=qt(f=>[f.schemas,f.links,f.setSchemas,f.setSchemaLinks]);g.useEffect(()=>{(async()=>{u(!0);try{const $=await jt(),L=$.schemas.filter(S=>S.ref_id&&!S.is_deleted);v(L.length>0?L:$.schemas),j($.edges.length>0?$.edges:[]),u(!1)}catch($){console.error("Error fetching data:",$),u(!1)}})()},[v,j]);const M=f=>{if(y.some(L=>L.ref_id===f.ref_id))v(y.map(L=>L.ref_id===f.ref_id?{...f,children:[]}:L));else{v([...y,{...f,children:[]}]);const L=y.find(S=>f.parent===S.type);j([...P,{ref_id:`new-link-${P.length}`,edge_type:"CHILD_OF",source:f.ref_id||"new",target:(L==null?void 0:L.ref_id)||"new"}])}},A=async()=>{const f=await jt();v(f.schemas.filter($=>$.ref_id&&!$.is_deleted&&$.ref_id)),j(f.edges)},C=f=>{v(y.filter($=>$.type!==f))},_=y.map(f=>({...f,children:y.filter($=>$.parent===f.type).map($=>$.ref_id||"")})),B=P.filter(f=>_.some($=>$.ref_id===f.source)&&_.some($=>$.ref_id===f.target)),z=y.find(f=>f.ref_id===n)||null;if(l)return o.jsx(w,{align:"center",basis:"100%",grow:1,justify:"center",shrink:1,children:o.jsx(le,{color:D.white})});const F=x==="all"?B:B.filter(f=>f.edge_type==="CHILD_OF");return o.jsxs(o.Fragment,{children:[o.jsx(w,{ml:-20,mr:-20,mt:-20,children:o.jsx(es,{activeTab:x,onClose:t,setActiveTab:b})}),o.jsxs(w,{align:"stretch",direction:"row",grow:1,children:[o.jsx(w,{mb:-20,ml:-20,children:o.jsx(is,{onAddEdgeNode:()=>{c(!0),a(!1),s(""),d({refId:"",edgeType:"",source:"",target:""})},onCreateNew:()=>{c(!1),a(!0),s("")}})}),o.jsx(w,{children:z||e?o.jsx(Bt,{children:o.jsx(Lt,{children:o.jsx($n,{graphLoading:h,onDelete:C,onSchemaCreate:M,onSchemaUpdate:A,selectedSchema:z,setGraphLoading:m,setIsCreateNew:a,setSelectedSchemaId:s})})}):null}),o.jsx(w,{children:i?o.jsx(Bt,{children:o.jsx(Lt,{children:o.jsx(wn,{edgeData:E,setGraphLoading:m,setIsAddEdgeNode:c})})}):null}),o.jsx(ls,{direction:"row",grow:1,children:o.jsx(ds,{children:h?o.jsx(w,{align:"center",basis:"100%",grow:1,justify:"center",shrink:1,children:o.jsx(le,{color:D.white})}):o.jsx(qn,{links:F,onEdgeClick:(f,$,L,S)=>{d({refId:f,edgeType:$,source:L,target:S}),c(!0),a(!1),s("")},schemasWithPositions:_,selectedSchemaId:n,setIsAddEdgeNode:c,setSelectedSchemaId:s})})})]})]})},ls=V(w)`
  flex: 1 1 auto;
  justify-content: center;
  position: relative;
  overflow: hidden;
...
`,ds=V(w)`
  flex: 1 1 100%;
`,us=()=>{const{close:t}=Xt("blueprintGraph"),n=()=>{t()};return o.jsx(xo,{background:"black",id:"blueprintGraph",kind:"full",preventOutsideClose:!0,children:o.jsx(cs,{Close:n})})},Ns=g.memo(us);export{Ns as BlueprintModal};
