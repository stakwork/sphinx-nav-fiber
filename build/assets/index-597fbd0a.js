import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-07376ddf.js";import{B as M}from"./index-136e7e49.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-ef97e95f.js";import{B as f,T as L,a as R}from"./index-c94f3285.js";import{T as x}from"./index-f7c5891b.js";import"./useSlotProps-1cdafe6e.js";import"./index.esm-584ca0de.js";import"./InfoIcon-e196eea3.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
