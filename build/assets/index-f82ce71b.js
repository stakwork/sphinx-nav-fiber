import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h as x,r as T,x as v,B as m}from"./index-7acb9fa0.js";import{B}from"./index-cbd06229.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-3d0c63a1.js";import{B as f,T as $,a as k}from"./index-a2ca3f36.js";import{T as u}from"./index-5c00c1b5.js";import"./useSlotProps-607947df.js";import"./index.esm-2f7683c0.js";import"./InfoIcon-1e02f89b.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
