import{N as Q,f as y,h as b,F as t,T,y as G,r as f,j as e,aY as X,aZ as ee,D as F,b0 as te,J as se,b1 as ne,B as $,i as oe,a_ as I,b2 as re,o as ie,O as ae}from"./index-0be95a0b.js";import{B as C,C as V,i as ce,c as le,F as de}from"./react-toastify.esm-8047c6c1.js";import{B as pe}from"./index-63adb6de.js";import{S as me}from"./index-171592ab.js";import{i as xe}from"./index.esm-576dc558.js";import{C as ue}from"./CheckIcon-092ada0c.js";import{n as z,a as he,i as fe}from"./index-99f52185.js";import{p as ye}from"./index-26122ad0.js";import{T as L}from"./index-d97174fd.js";import{A as ge}from"./index-9731198c.js";import{c as je}from"./index-64f1c910.js";import"./generateCategoricalChart-7ab1cc0e.js";import"./Popover-5d96b8f6.js";import"./useSlotProps-2df1bc54.js";import"./InfoIcon-036e38f2.js";import"./NoFilterResultIcon-5772e0b5.js";import"./index-c69ff232.js";import"./index-55dba4cc.js";import"./PlusIcon-d7359d9d.js";import"./index-10b5ab45.js";import"./Popper-c6a06880.js";const we=async(o,i,a="")=>await Q.post(`/${o}`,JSON.stringify(i),{Authorization:a}),be=async(o,i,a,x,d,r)=>{const m=o==="Create custom type"?"schema":"node",l={node_data:{...i,...o==="Image"&&{source_link:a}},node_type:o,name:x,pubkey:r};return we(m,l,d)},Se=({onClick:o,loading:i,error:a})=>{const x=G(l=>l.budget),[d,r]=f.useState(10),m="node";return f.useEffect(()=>{(async()=>{try{const u=await ee(m);r(u.data.price)}catch(u){console.error("cannot fetch",u)}})()},[m]),e.jsxs(t,{children:[e.jsx(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:e.jsx(t,{align:"center",direction:"row",children:e.jsx(Ce,{children:"Approve Cost"})})}),e.jsxs(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:[e.jsxs(Ne,{children:[e.jsx("div",{className:"title",children:"COST"}),e.jsxs("div",{className:"value","data-testid":"check-price",children:[d," sats"]})]}),e.jsxs(Te,{children:[e.jsx("div",{className:"title",children:"BUDGET"}),e.jsxs("div",{className:"value",children:[X(x)," sats"]})]})]}),e.jsx(t,{children:e.jsx(C,{color:"secondary","data-testid":"check-icon",disabled:i||!!a,onClick:o,size:"large",startIcon:i?e.jsx(R,{children:e.jsx(V,{color:b.lightGray,size:12})}):e.jsxs(R,{children:[" ",e.jsx(ue,{})]}),type:"submit",variant:"contained",children:"Approve"})}),a?e.jsx(ve,{children:e.jsxs(ke,{children:[e.jsx(xe,{className:"errorIcon"}),e.jsx("span",{children:a})]})}):null]})},Ne=y(t).attrs({direction:"column",align:"space-between",justify:"flex-start"})`
  width: 141px;
  height: 61px;
