import{s as i,F as n,T as g,j as e,b as w,c as p,r as A,u as B}from"./index-01782a69.js";import{B as v}from"./index-aa46beb1.js";import{u as F}from"./index-aba16a9a.js";import{u as M,G as $,l as C,b,q as D,F as G}from"./react-toastify.esm-d4c7807c.js";import{B as f,T as k,a as R}from"./index-bdc7fdec.js";import{T as x}from"./index-9298a825.js";import{C as L}from"./ClipLoader-e8b8ddb1.js";import"./useSlotProps-2c201f6d.js";import"./index.esm-b2fe6b9a.js";import"./InfoIcon-7fd329ae.js";const P=({onClose:s})=>{const[a]=M(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",a),s()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
