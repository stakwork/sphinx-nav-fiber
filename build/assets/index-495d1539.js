import{o as s,F as o,T as w,p as C,r as f,j as e,q as c,A as S,aU as A,aV as b,aW as M,M as z,Q as y}from"./index-bbace952.js";import{B as D}from"./index-23fd056d.js";import{G,B as v,i as $,F as B}from"./index-b59d760f.js";import{C as T}from"./ClipLoader-d274d5dc.js";import{T as j}from"./index-8532a5b1.js";import{S as E}from"./index-d6a32355.js";import{e as I}from"./index.esm-41375590.js";import{T as k,a as F}from"./Tabs-f157e692.js";import"./InfoIcon-bbdc5b1e.js";import"./useSlotProps-4a2948f6.js";import"./createSvgIcon-558893a9.js";const R=({onClose:a})=>{const[l]=C(d=>[d.graphStyle]),[r,i]=f.useState(!1),p=()=>{i(!0),localStorage.setItem("graphStyle",l),i(!1),a()};return e.jsxs(W,{direction:"column",children:[e.jsx(V,{children:"Default graph view:"}),e.jsx(G,{}),e.jsx(o,{mt:308,py:24,children:e.jsx(v,{color:"secondary",disabled:r,id:"add-node-submit-cta",onClick:p,size:"large",startIcon:r&&e.jsx(L,{children:e.jsx(T,{color:c.lightGray,size:12})}),type:"submit",variant:"contained",children:"Save Changes"})})]})},W=s(o)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,V=s(w)`
