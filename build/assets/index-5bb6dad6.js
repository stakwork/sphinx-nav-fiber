...
`,ir=v.lazy(()=>ke(()=>import("./index-808ee6d1.js"),["assets/index-808ee6d1.js","assets/index-bfdac096.js","assets/index-b4d03b7b.css","assets/index-c07b705d.js","assets/SourcesTableIcon-05f9b5c9.js","assets/index-bdf9e970.js","assets/CheckIcon-c2fd0a17.js","assets/DeleteNodeIcon-4ab5ca45.js","assets/SoundIcon-05dcab23.js","assets/SucessFeedBackIcon-9d08a611.js","assets/ClipLoader-d3b77358.js","assets/TableRow-b99300ac.js"]).then(({TweetAnalyze:e})=>({default:e}))),ar=()=>{const e=$(o=>o.setSelectedTweet),t=$(o=>o.selectedTweet),{tweetId:a}=fe(),[r,n]=v.useState(""),{open:i}=De("tweetAnalyze"),l=(a==null?void 0:a.split("&"))||[],c=o=>{i(),n(o)};return s.jsxs(or,{align:"stretch",basis:"100%",grow:1,shrink:1,children:[l.length>1?s.jsx(sr,{onClick:()=>{c("summary")},children:"Summary Report"}):null,l.map(o=>s.jsx(cr,{className:t===o?"selected":"",onClick:()=>e(o),children:s.jsx(Vt,{handleAnalyzeClick:()=>{c(o)},nodeId:o})},o)),s.jsx(ir,{tweetId:r})]})},sr=f.button`
  width: 100%;
  background: ${y.ANALYTICS_CARD_BG};
  color: ${y.white};
  padding: 16px 16px;
