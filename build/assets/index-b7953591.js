import{Q as o,U as s,a4 as g,O as y,j as e,a3 as b,av as w,aq as S,S as x,r as v,N as T,ac as m}from"./index-920ff334.js";import{aF as C,aG as f,aH as A,aI as B,aJ as u,aB as G,aK as M,aL as $,aC as k}from"./index-8dff2046.js";const D=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(z,{direction:"column",children:[e.jsx(F,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},z=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,F=o(g)`
