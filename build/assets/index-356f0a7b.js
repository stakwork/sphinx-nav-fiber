import{s as x,c as f,u as P,r as m,j as e,F as o,T as u,b as N,x as V,o as q,ad as J,g as Y,ae as S,d as H,a2 as K}from"./index-01782a69.js";import{ak as Q,B as w,al as W,l as X,F as Z,am as ee}from"./react-toastify.esm-d4c7807c.js";import{B as te}from"./index-aa46beb1.js";import{n as y}from"./toastMessage-71cf2792.js";import{a as C}from"./index-e9e9f998.js";import{u as oe}from"./index-aba16a9a.js";import{C as ne}from"./CheckIcon-cabeb6b1.js";import{T as _}from"./index-9298a825.js";import{A as se}from"./index-c3a779a9.js";import"./index.esm-b2fe6b9a.js";import"./InfoIcon-7fd329ae.js";import"./index-d463d61e.js";import"./Popover-b826ddf0.js";import"./useSlotProps-2c201f6d.js";import"./Select-150c9580.js";import"./Stack-17d482e0.js";import"./Popper-60e6b823.js";const ae=({onClick:n,loading:r})=>{const i=P(l=>l.budget),[c,p]=m.useState(10),a="node";return m.useEffect(()=>{(async()=>{try{const t=await W(a);p(t.data.price)}catch(t){console.error("cannot fetch",t)}})()},[a]),e.jsxs(o,{children:[e.jsx(o,{align:"center",direction:"row",justify:"space-between",mb:20,children:e.jsx(o,{align:"center",direction:"row",children:e.jsx(ce,{children:"Approve Cost"})})}),e.jsxs(o,{align:"center",direction:"row",justify:"space-between",mb:20,children:[e.jsxs(re,{children:[e.jsx("div",{className:"title",children:"COST"}),e.jsxs("div",{className:"value","data-testid":"check-price",children:[c," sats"]})]}),e.jsxs(ie,{children:[e.jsx("div",{className:"title",children:"BUDGET"}),e.jsxs("div",{className:"value",children:[Q(i)," sats"]})]})]}),e.jsx(o,{children:e.jsx(w,{color:"secondary","data-testid":"check-icon",disabled:r,onClick:n,size:"large",startIcon:e.jsx(ne,{}),type:"submit",variant:"contained",children:"Approve"})})]})},re=x(o).attrs({direction:"column",align:"space-between",justify:"flex-start"})`
  width: 141px;
  height: 61px;
