import{f as r,F as i,T as g,i as y,j as e,k as b,L as S,D as w,h as x,r as T,x as v,B as m}from"./index-dae18a7b.js";import{B}from"./index-4459d726.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-b2fbd024.js";import{B as f,T as $,a as k}from"./index-fef36e51.js";import{T as u}from"./index-97d901c2.js";import"./useSlotProps-25d62d1d.js";import"./index.esm-f388d3bf.js";import"./InfoIcon-4b1a98c3.js";const F=({onClose:t})=>{const[s]=y(n=>[n.graphStyle]),o=()=>{localStorage.setItem("graphStyle",s),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(L,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(i,{mt:308,children:e.jsx(f,{kind:"big",onClick:o,children:"Save Changes"})})]})},G=r(i)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,L=r(g)`
