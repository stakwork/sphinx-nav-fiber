import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,x as D,B as F}from"./index-1baf07e2.js";import{B as M}from"./index-7b5901f2.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-54b4ce32.js";import{B as f,T as L,a as R}from"./index-b5275642.js";import{T as x}from"./index-9e854179.js";import"./useSlotProps-411d1b80.js";import"./index.esm-b4b9dfc0.js";import"./InfoIcon-8011a09a.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
