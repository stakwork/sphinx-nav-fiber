...
`,ir=v.lazy(()=>ke(()=>import("./index-3e7a1804.js"),["assets/index-3e7a1804.js","assets/index-abe596c2.js","assets/index-b4d03b7b.css","assets/index-a934f93d.js","assets/SourcesTableIcon-98e217ce.js","assets/index-e24fdddd.js","assets/CheckIcon-c4465b66.js","assets/DeleteNodeIcon-ed1ed550.js","assets/SoundIcon-33304203.js","assets/SucessFeedBackIcon-ec6549cd.js","assets/ClipLoader-faf5a781.js","assets/TableRow-e77a846f.js"]).then(({TweetAnalyze:e})=>({default:e}))),ar=()=>{const e=$(o=>o.setSelectedTweet),t=$(o=>o.selectedTweet),{tweetId:a}=fe(),[r,n]=v.useState(""),{open:i}=De("tweetAnalyze"),l=(a==null?void 0:a.split("&"))||[],c=o=>{i(),n(o)};return s.jsxs(or,{align:"stretch",basis:"100%",grow:1,shrink:1,children:[l.length>1?s.jsx(sr,{onClick:()=>{c("summary")},children:"Summary Report"}):null,l.map(o=>s.jsx(cr,{className:t===o?"selected":"",onClick:()=>e(o),children:s.jsx(Vt,{handleAnalyzeClick:()=>{c(o)},nodeId:o})},o)),s.jsx(ir,{tweetId:r})]})},sr=f.button`
  width: 100%;
  background: ${y.ANALYTICS_CARD_BG};
  color: ${y.white};
  padding: 16px 16px;
