import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-fffb68b5.js";import{B as F}from"./index-6cc8a98f.js";import{u as M}from"./index-10e5a3d3.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-743cfc19.js";import{B as f,T as R,a as L}from"./index-4d9ccd08.js";import{T as x}from"./index-96500165.js";import"./useSlotProps-3f19cccd.js";import"./index.esm-55221a47.js";import"./InfoIcon-c211880f.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
