import{s as r,F as n,T as g,j as e,h as w,b as c,r as A,g as B}from"./index-bc5cffe2.js";import{B as v}from"./index-d967afb5.js";import{u as F}from"./index-8545cbb8.js";import{e as M,X as $,t as C,h as b,z as D,F as k,C as G}from"./react-toastify.esm-f63251da.js";import{B as f,T as R,a as z}from"./index-cff0db1a.js";import{T as x}from"./index-4952c9c0.js";import"./useSlotProps-46cc50c8.js";import"./index.esm-12894123.js";import"./InfoIcon-d8810c25.js";const L=({onClose:s})=>{const[a]=M(t=>[t.graphStyle]),i=()=>{localStorage.setItem("graphStyle",a),s()};return e.jsxs(P,{direction:"column",children:[e.jsx(V,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:i,children:"Save changes"})})]})},P=r(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,V=r(g)`
