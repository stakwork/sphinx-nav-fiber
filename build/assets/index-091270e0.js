import{s as n,c as i,F as s,j as e,T,h as ee,r as h,u as le,P as ce,d as Ie,f as Re}from"./index-63250ce8.js";import{A as I,u as R,b as G,ai as xe,aj as Pe,B as z,s as Ae,ak as X,al as Ee,a as P,M as Me,I as de,c as W,v as pe,P as te,J as Ge,am as he,an as Ne,e as Le,d as De}from"./react-toastify.esm-47c4d49e.js";import{G as ue,L as se,B as Ye,H as Fe,u as Oe,S as We,a as He,D as Ve,M as Ue,R as Qe,b as qe,c as Ke,d as Xe,z as Je,N as ye,C as Ze,e as fe,f as ge,g as et,h as tt,i as me,j as st,P as it,k as we,s as oe,V as ot,F as nt,E as rt,l as at,m as lt,n as je,o as ct,p as xt,q as dt,r as pt,t as ht,v as ut,w as yt,x as ft,y as gt}from"./SoundIcon-cde54680.js";import{C as mt,S as wt}from"./ChevronUpIcon-03ea0ff2.js";import{f as F,o as be,n as jt,X as bt,Y as kt,T as vt,D as St,S as ie,q as ke,P as H}from"./generateCategoricalChart-ca929a89.js";import{T as D}from"./index-7a5b7f8f.js";import{S as ve}from"./Skeleton-1070741e.js";import{T as ne}from"./toastMessage-19e5091f.js";import{g as $t,d as Tt}from"./index.esm-e5a952b5.js";import{T as _t,F as Bt}from"./Popover-991c891c.js";import{I as Ct,S as zt,O as It}from"./Select-18e5d995.js";import{C as Rt}from"./CheckIcon-e4d5b936.js";import{I as Pt}from"./InfoIcon-814ef8a2.js";import{C as O}from"./ClipLoader-14f8878e.js";import{P as At}from"./PlusIcon-898065e4.js";import{u as Z}from"./index-d14291b1.js";import{B as Et}from"./index-a35ac1b8.js";import"./useSlotProps-76a0b95d.js";const Mt=({imageUrl:t,name:o})=>e.jsxs(s,{align:"center",direction:"row",children:[t&&e.jsx(Gt,{children:e.jsx(I,{rounded:!0,size:64,src:t||"",type:"image"})}),o&&e.jsx(Nt,{children:o})]}),Gt=n(s)`
  img {
    width: 64px;
    height: 64px
    border-radius: 50%;
...
`,oi=({onClick:t,timestamp:o,isSelected:r,setOpenClip:a})=>e.jsxs(ii,{align:"center","data-testid":"wrapper",direction:"row",isSelected:r,justify:"flex-start",onClick:t,px:20,py:20,children:[e.jsxs("div",{children:[e.jsx(de,{className:"play-pause",children:r?e.jsx(si,{}):e.jsx(et,{})}),!1]}),e.jsxs(ni,{align:"flex-start",direction:"column",justify:"center",children:[o.timestamp&&e.jsx("span",{className:"timestamp",children:tt(o.timestamp)}),e.jsx("span",{className:"title",children:F(o.show_title)})]}),e.jsx("div",{className:"info",children:e.jsx(s,{"data-testid":"info-icon-wrapper",onClick:()=>a(o),pt:4,children:e.jsx(Pt,{})})})]}),ni=n(s)`
  font-size: 13px;
  color: ${i.white};
  font-family: 'Barlow';
  margin: 0 16px;
...
`,di=()=>{const t=P(),o=t==null?void 0:t.name;return e.jsxs(s,{direction:"column",px:24,py:16,children:[e.jsx(I,{"data-testid":"person-image",size:80,src:(t==null?void 0:t.source_link)||"",type:"image"}),e.jsx(s,{py:20,children:e.jsx(T,{color:"primaryText1",kind:"bigHeading",children:o})})]})},pi=()=>{const{sender_pic:t,sender_alias:o,date:r,message_content:a}=P()||{};return e.jsxs(s,{direction:"row",children:[e.jsx(yi,{src:t}),e.jsxs(hi,{children:[e.jsxs(s,{align:"flex-end",className:"info",direction:"row",children:[o&&e.jsx("span",{className:"info__name",children:o}),r&&e.jsx("span",{className:"info__date",children:r})]}),a&&e.jsx(ui,{dangerouslySetInnerHTML:{__html:st(a)}})]})]})},hi=n(s)`
  color: ${i.black};
  border-radius: 8px;
  font-size: 20px;
  margin-left: 8px;
...
`,zi=n(z)`
  width: 100%;
`,Ii=()=>{var l,y;const[t,o]=h.useState(!1),r=P(),a=!!(r!=null&&r.source_link),c=h.useRef(null),d=u=>{u.stopPropagation(),u.currentTarget.blur(),o(!t)};return h.useEffect(()=>{var u,x;t?(u=c.current)==null||u.play():(x=c.current)==null||x.pause()},[t]),e.jsxs(s,{align:"flex-start",basis:"100%",direction:"column",grow:1,justify:"center",pt:a?62:0,shrink:1,children:[a&&e.jsxs(Ri,{children:[e.jsx(ue,{color:i.GRAY6}),e.jsx(Ei,{children:r==null?void 0:r.source_link}),e.jsx(Pi,{href:r==null?void 0:r.source_link,onClick:u=>u.stopPropagation(),target:"_blank",children:e.jsx(se,{})})]}),(l=r==null?void 0:r.audio)!=null&&l.length?e.jsxs(s,{justify:"flex-start",p:12,children:[e.jsx(z,{onClick:u=>d(u),startIcon:t?e.jsx(H,{}):e.jsx(te,{}),children:t?"Pause":"Play"}),e.jsx(Mi,{ref:c,src:((y=r.audio[0])==null?void 0:y.link)||"",children:e.jsx("track",{kind:"captions"})})]}):null,e.jsx(Ai,{grow:1,justify:"flex-start",p:12,shrink:1,children:e.jsx(T,{color:"primaryText1",kind:"regular",children:r==null?void 0:r.text})})]})},Ri=n(s)`
  top: 0px;
  position: absolute;
...
`,xo=n.audio`
  height: 0;
  width: 0;
`,po=["Drivechain","Ordinals","L402","Nostr","AI"],ho=({onSubmit:t})=>{var A;const{open:o}=Z("addContent"),[r,a]=h.useState(!1),[c,d]=h.useState(null),l=h.useRef(null),[y,u]=h.useState(0),[x,k]=h.useState(!1),{open:S}=Z("briefDescription"),[p,j]=R(g=>[g.trendingTopics,g.setTrendingTopics]),{setValue:b}=he();h.useEffect(()=>{const g=async()=>{a(!0);try{const v=await Ne();v.length&&Array.isArray(v)&&j(v)}catch{j(po.map(E=>({topic:E,count:0})))}finally{a(!1)}};p.length||g()},[p,j]);const m=g=>{b("search",g),t==null||t()},w=(g,v)=>{g.stopPropagation(),g.currentTarget.blur(),v!=null&&v.tldr&&(d(v),S())},B=()=>{d(null)},f=g=>{g.stopPropagation(),g.currentTarget.blur(),k(!x)};h.useEffect(()=>{var g,v;x?(g=l.current)==null||g.play():(v=l.current)==null||v.pause()},[y,x]);const C=()=>{u(g=>{var E,N;let v=(g+1)%p.length;for(;v!==g&&!((E=p[v])!=null&&E.audio_EN);)v=(v+1)%p.length;return v===g?(k(!1),v):((N=l.current)==null||N.load(),v===0&&(k(!1),u(0)),v)})};return e.jsxs(yo,{children:[e.jsxs("div",{children:[e.jsxs("div",{className:"heading-container",children:[e.jsxs("div",{className:"heading",children:[e.jsx("span",{className:"heading__title",children:"Trending Topics"}),e.jsx("span",{className:"heading__icon",children:r?e.jsx(O,{color:i.PRIMARY_BLUE,size:16}):e.jsx(pt,{})})]}),ht(p)?e.jsxs("div",{children:[e.jsx(z,{onClick:g=>f(g),startIcon:x?e.jsx(H,{}):e.jsx(te,{}),children:x?"Pause":"Play All"}),e.jsx(wo,{ref:l,onEnded:C,src:(A=p[y])==null?void 0:A.audio_EN,children:e.jsx("track",{kind:"captions"})})]}):null]}),p.length===0&&!r?e.jsxs("div",{className:"Trendingwrapper",children:[e.jsx(go,{children:"No new trending topics in the last 24 hours"}),e.jsx(mo,{color:"secondary",onClick:o,size:"medium",startIcon:e.jsx(At,{}),sx:{alignSelf:"flex-end",m:"0 36px 16px 0"},variant:"contained",children:"Add Content"})]}):e.jsx("ul",{className:"list",children:r?e.jsxs("div",{children:[e.jsx(O,{color:i.PRIMARY_BLUE,size:16}),[...Array(5)].map((g,v)=>e.jsx(fo,{animation:"wave","data-testid":"loading-skeleton",height:47,variant:"rectangular",width:382},v))]}):e.jsx(e.Fragment,{children:p.map(g=>e.jsxs(s,{align:"center",className:"list-item",direction:"row",justify:"space-between",onClick:()=>m(g.topic),children:[e.jsxs(uo,{children:[" #",ut(g)]}),g.tldr&&e.jsx(z,{onClick:v=>w(v,g),children:"TLDR"})]},g.topic))})})]}),c&&e.jsx(ro,{onClose:B,selectTrending:m,trend:c})]})},uo=n.div`
  width: 300px;
  overflow: hidden;
  text-overflow: ellipsis;
  line-height: 1.5;
