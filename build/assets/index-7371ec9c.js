import{r as i,j as e,s as u,g as S,F as j,o as X,c as Y,A as oe,p as ie,i as ae,q as ce,H as le,t as pe,v as de}from"./index-f20ba850.js";import{t as O,u as H,C as ue}from"./index-c46cbbe9.js";import{U as fe}from"./index-8729d8fd.js";import{u as T,a as me,b as ge,I as he,c as J,d as xe}from"./index-aeaf3376.js";import{M as ye,V as be}from"./index-62b9c3cb.js";import{S as we,R as je,s as V,M as ve}from"./index-0c66ae29.js";import"./string-a277709d.js";import"./index-078a8e90.js";import"./three.module-976f5d36.js";import"./index-5cc449d4.js";import"./TextareaAutosize-45ea2c7a.js";import"./CheckIcon-33cabb73.js";import"./index-6d8a863b.js";import"./index-1fb88931.js";import"./ClipLoader-e3f80492.js";import"./clsx-7f9f44b1.js";import"./SourcesTableIcon-c486e0b8.js";import"./DeleteNodeIcon-92f265c1.js";import"./SoundIcon-21941c5b.js";import"./SucessFeedBackIcon-80f7345e.js";import"./Skeleton-d3106483.js";import"./index-d660a1a5.js";import"./Stack-027fe54d.js";import"./FormControlLabel-5f9d6d60.js";import"./Typography-a3b0f2ab.js";import"./createSvgIcon-ac71da48.js";import"./isPlainObject-7cf5c488.js";const K=i.memo(()=>{const r=T(n=>n.isPlaying),a=T(n=>n.setIsPlaying),s=T(n=>n.setVolume),t=T(n=>n.setPlaybackSpeed),c=T(n=>n.playbackSpeed),o=T(n=>n.playerRef),[d,g]=i.useState(!1),m=[.5,1,1.5,2],h=()=>{if(o){const n=o.getCurrentTime()-15;o.seekTo(n,"seconds")}},f=()=>{if(o){const n=o.getCurrentTime()+15;o.seekTo(n,"seconds")}},w=()=>{a(!r)},p=()=>{g(!d),s(d?1:0)},l=()=>{const x=(m.indexOf(c)+1)%m.length,P=m[x];if(t(P),o){const k=o.getInternalPlayer();k&&typeof k.playbackRate<"u"&&(k.playbackRate=P)}};return e.jsxs(Se,{children:[e.jsx(Pe,{onClick:p,children:d?e.jsx(ye,{}):e.jsx(be,{})}),e.jsx(Ce,{onClick:h,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(ke,{"data-testid":"play-pause-button",onClick:w,size:"small",children:r?e.jsx(me,{"data-testid":"pause-icon"}):e.jsx(ge,{"data-testid":"play-icon"})}),e.jsx(Ie,{onClick:f,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(_e,{onClick:l,children:[c,"x"]})]})});K.displayName="Controls";const Se=u(j).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${S.BG1};
  border-radius: 40px;
