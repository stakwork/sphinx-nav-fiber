...
`,_r=_(v)`
  flex: 1 1 100%;
`,Or=()=>{const{close:t}=no("blueprintGraph"),r=()=>{t()};return o.jsx(ko,{background:"black",id:"blueprintGraph",kind:"full",preventOutsideClose:!0,children:o.jsx($r,{Close:r})})},Qr=x.memo(Or);export{Qr as BlueprintModal};
