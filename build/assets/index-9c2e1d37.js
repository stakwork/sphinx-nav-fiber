import{s as i,F as n,T as g,j as e,b as w,c as p,r as A,u as B}from"./index-e90126f3.js";import{B as v}from"./index-81d4583b.js";import{u as F}from"./index-f78eda89.js";import{u as M,G as $,l as C,b,q as D,F as G}from"./react-toastify.esm-22f05de4.js";import{B as f,T as k,a as R}from"./index-4dddd8d8.js";import{T as x}from"./index-5147f614.js";import{C as L}from"./ClipLoader-805cbf79.js";import"./useSlotProps-45e36f47.js";import"./index.esm-0d3f0902.js";import"./InfoIcon-37b7ba25.js";const P=({onClose:s})=>{const[a]=M(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",a),s()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
