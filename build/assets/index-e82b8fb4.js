import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-22832e12.js";import{B as F}from"./index-f042a1ae.js";import{u as M}from"./index-f2e4bd2e.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-ffc605e6.js";import{B as f,T as R,a as L}from"./index-5ae5ba2d.js";import{T as x}from"./index-073dc009.js";import"./useSlotProps-0fbf8407.js";import"./index.esm-dad82672.js";import"./InfoIcon-c672fc58.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
