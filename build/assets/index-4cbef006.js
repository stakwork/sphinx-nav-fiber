import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-4a78cd26.js";import{B as F}from"./index-83dfab66.js";import{u as M}from"./index-999e7802.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-8990f63e.js";import{B as f,T as R,a as L}from"./index-a02ce198.js";import{T as x}from"./index-1883a19d.js";import"./useSlotProps-c61e4754.js";import"./index.esm-2d76192c.js";import"./InfoIcon-3a7ceaf1.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
