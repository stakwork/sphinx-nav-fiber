import{s as i,g as t,F as c,j as e,a7 as j,r as l,c as C,B as w,by as S,bA as R,b1 as D}from"./index-f609b2a5.js";import{g as I,e as T}from"./index-1dc04084.js";import{D as z}from"./DeleteNodeIcon-068d6e70.js";import{S as E}from"./Skeleton-51f0bb91.js";import{C as L}from"./ClipLoader-871d4b5d.js";const A=({nodeName:p})=>e.jsx(c,{children:e.jsxs(c,{align:"center",direction:"column",justify:"space-between",children:[e.jsx(G,{children:e.jsx(z,{})}),e.jsxs(M,{children:["Are you sure you want to delete ",p||"this item","?"]})]})}),M=i(c)`
  color: ${t.white};
  font-family: 'Barlow';
  font-size: 20px;
  font-weight: 400;
