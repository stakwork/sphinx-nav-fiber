import{s as h,b as f,g as P,r as m,j as e,F as o,T as u,h as k,C as V,v as q,aT as J,q as K,ai as S,e as Y,a5 as H}from"./index-1ee61b3a.js";import{aJ as Q,B as w,aK as W,t as X,F as Z,aL as ee}from"./react-toastify.esm-72d67069.js";import{B as te}from"./index-6761adb5.js";import{n as y}from"./toastMessage-753bc38e.js";import{a as C}from"./index-fcb2ec29.js";import{u as oe}from"./index-2c4ca382.js";import{C as ne}from"./CheckIcon-f61c081a.js";import{T as _}from"./index-a7f34ac7.js";import{A as se}from"./index-99b45fac.js";import"./index.esm-00343a7f.js";import"./index-2d32aa80.js";import"./InfoIcon-99f0cb4c.js";import"./Popover-d5b38327.js";import"./useSlotProps-6cdee9a7.js";import"./Select-ef7db6d0.js";import"./Stack-dde24edb.js";import"./Popper-1c28e189.js";const re=({onClick:n,loading:a})=>{const i=P(l=>l.budget),[c,p]=m.useState(10),r="node";return m.useEffect(()=>{(async()=>{try{const t=await W(r);p(t.data.price)}catch(t){console.error("cannot fetch",t)}})()},[r]),e.jsxs(o,{children:[e.jsx(o,{align:"center",direction:"row",justify:"space-between",mb:20,children:e.jsx(o,{align:"center",direction:"row",children:e.jsx(ce,{children:"Approve Cost"})})}),e.jsxs(o,{align:"center",direction:"row",justify:"space-between",mb:20,children:[e.jsxs(ae,{children:[e.jsx("div",{className:"title",children:"COST"}),e.jsxs("div",{className:"value","data-testid":"check-price",children:[c," sats"]})]}),e.jsxs(ie,{children:[e.jsx("div",{className:"title",children:"BUDGET"}),e.jsxs("div",{className:"value",children:[Q(i)," sats"]})]})]}),e.jsx(o,{children:e.jsx(w,{color:"secondary","data-testid":"check-icon",disabled:a,onClick:n,size:"large",startIcon:e.jsx(ne,{}),type:"submit",variant:"contained",children:"Approve"})})]})},ae=h(o).attrs({direction:"column",align:"space-between",justify:"flex-start"})`
  width: 141px;
  height: 61px;
