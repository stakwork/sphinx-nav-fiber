import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-7b63cb4a.js";import{B}from"./index-4a55926a.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-0954c8b1.js";import{B as f,T as $,a as k}from"./index-b064ac59.js";import{T as u}from"./index-10171590.js";import"./useSlotProps-4a81fffb.js";import"./index.esm-a81337f5.js";import"./InfoIcon-282f58ab.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
