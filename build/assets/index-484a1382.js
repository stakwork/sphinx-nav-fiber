import{r as i,j as e,s as u,g as S,F as j,o as X,c as Y,A as oe,p as ie,i as ae,q as ce,H as le,t as pe,v as de}from"./index-651d47c5.js";import{t as O,u as H,C as ue}from"./index-7e285c52.js";import{U as fe}from"./index-2f663cec.js";import{u as T,a as me,b as ge,I as he,c as J,d as xe}from"./index-c0df39d7.js";import{M as ye,V as be}from"./index-53b4ef67.js";import{S as we,R as je,s as V,M as ve}from"./index-bedb714c.js";import"./string-a277709d.js";import"./index-29b13237.js";import"./three.module-9722a9fc.js";import"./index-097272ef.js";import"./TextareaAutosize-439f242c.js";import"./CheckIcon-4743000d.js";import"./index-e4d9970c.js";import"./index-d8a2f826.js";import"./ClipLoader-dc28513d.js";import"./clsx-28c71a1d.js";import"./SourcesTableIcon-584eee47.js";import"./DeleteNodeIcon-ac54dff5.js";import"./SoundIcon-2145eafb.js";import"./SucessFeedBackIcon-43a115c1.js";import"./Skeleton-433f9697.js";import"./index-82aed6b8.js";import"./Stack-82c2ebb5.js";import"./FormControlLabel-de4ace1d.js";import"./Typography-47dfbb28.js";import"./createSvgIcon-b8c44b42.js";import"./isPlainObject-9880d587.js";const K=i.memo(()=>{const r=T(n=>n.isPlaying),a=T(n=>n.setIsPlaying),s=T(n=>n.setVolume),t=T(n=>n.setPlaybackSpeed),c=T(n=>n.playbackSpeed),o=T(n=>n.playerRef),[d,g]=i.useState(!1),m=[.5,1,1.5,2],h=()=>{if(o){const n=o.getCurrentTime()-15;o.seekTo(n,"seconds")}},f=()=>{if(o){const n=o.getCurrentTime()+15;o.seekTo(n,"seconds")}},w=()=>{a(!r)},p=()=>{g(!d),s(d?1:0)},l=()=>{const x=(m.indexOf(c)+1)%m.length,P=m[x];if(t(P),o){const k=o.getInternalPlayer();k&&typeof k.playbackRate<"u"&&(k.playbackRate=P)}};return e.jsxs(Se,{children:[e.jsx(Pe,{onClick:p,children:d?e.jsx(ye,{}):e.jsx(be,{})}),e.jsx(Ce,{onClick:h,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(ke,{"data-testid":"play-pause-button",onClick:w,size:"small",children:r?e.jsx(me,{"data-testid":"pause-icon"}):e.jsx(ge,{"data-testid":"play-icon"})}),e.jsx(Ie,{onClick:f,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(_e,{onClick:l,children:[c,"x"]})]})});K.displayName="Controls";const Se=u(j).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${S.BG1};
  border-radius: 40px;
