import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,x as D,B as F}from"./index-f14c52f6.js";import{B as M}from"./index-454a2500.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-7be85797.js";import{B as f,T as L,a as R}from"./index-04666d84.js";import{T as x}from"./index-f98e65fe.js";import"./useSlotProps-6020ee6e.js";import"./index.esm-da72a889.js";import"./InfoIcon-576dab03.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
