import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h as x,r as T,x as v,B as m}from"./index-530f6618.js";import{B}from"./index-a101b3f5.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-7264a5d3.js";import{B as f,T as $,a as k}from"./index-2f843e70.js";import{T as u}from"./index-fa56e81c.js";import"./useSlotProps-11e18c14.js";import"./index.esm-51a0b245.js";import"./InfoIcon-1357a1ce.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
