import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-2842476b.js";import{B as F}from"./index-72b1919f.js";import{u as M}from"./index-c2d97ac1.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-e7016879.js";import{B as f,T as R,a as L}from"./index-87915600.js";import{T as x}from"./index-c3dc7586.js";import"./useSlotProps-ec551c05.js";import"./index.esm-d0716fd8.js";import"./InfoIcon-7c96d4e9.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
