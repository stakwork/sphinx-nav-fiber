import{s as a,a as r,F as i,j as e,a5 as B,T as S,r as b,B as v,t as I,k as $,b as C,aT as k,aU as A,N as y,w as z,aV as w,aW as M,aX as D,e as j,aY as E}from"./index-9411005d.js";import{h as T,r as R,aB as L,aC as W,C as P,aD as V,aE as F}from"./index-ab2c2a50.js";import{C as G}from"./ClipLoader-23c91b09.js";import{T as U,a as N}from"./Tabs-0bacd443.js";import"./createSvgIcon-3f43ff5f.js";const Y={split:e.jsx(W,{}),force:e.jsx(P,{}),sphere:e.jsx(V,{}),earth:e.jsx(F,{})},O=()=>{const[n,c]=T(R(t=>[t.graphStyle,t.setGraphStyle])),l=t=>{c(t)};return e.jsx(_,{direction:"column",children:L.map(t=>e.jsx(i,{className:B("icon",{active:n===t}),onClick:()=>l(t),children:Y[t]},t))})},_=a(i).attrs({direction:"row",align:"center",justify:"space-between"})`
  width: 447px;
  height: 48px;
