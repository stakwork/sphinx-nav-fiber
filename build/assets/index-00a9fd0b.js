import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-7ee359cb.js";import{B as F}from"./index-d0b79e83.js";import{u as M}from"./index-49086f24.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-359f8370.js";import{B as f,T as R,a as L}from"./index-51ed42d9.js";import{T as x}from"./index-1adf111d.js";import"./useSlotProps-b08a5e19.js";import"./index.esm-9da994b4.js";import"./InfoIcon-61f4dbf9.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
