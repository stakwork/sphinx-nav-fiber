import{Q as o,U as s,a4 as g,O as y,j as e,a3 as b,av as w,aq as S,S as x,r as v,N as T,ac as m}from"./index-e0f8a2e2.js";import{aE as A,aF as f,aG as C,aH as B,aI as u,aA as G,aJ as M,aK as $,aB as k}from"./index-012f8558.js";const D=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(z,{direction:"column",children:[e.jsx(F,{children:"Default graph view:"}),e.jsx(A,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},z=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,F=o(g)`
...
`,R=o.form`
  padding: 36px;
`,V=t=>{const{children:i,value:r,index:n,...l}=t;return r===n?e.jsx(K,{"aria-labelledby":`simple-tab-${n}`,hidden:r!==n,id:`simple-tabpanel-${n}`,role:"tabpanel",...l,children:i}):null};function I(t){return{id:`simple-tab-${t}`,"aria-controls":`simple-tabpanel-${t}`}}const W=({onClose:t})=>{const[i,r]=v.useState(0),[n]=T(a=>[a.isAdmin,a.setPubKey]),l=b(a=>a.appMetaData),d=()=>n?"Admin Settings":"Settings",c=({children:a})=>e.jsxs(H,{children:[e.jsx(s,{direction:"row",pt:3,children:e.jsx(U,{"data-testid":"setting-label",children:d()})}),a]}),j=(a,p)=>{r(p)},h=[...n?[{label:"General",component:L}]:[],{label:"Appearance",component:D}];return e.jsxs(O,{"data-testid":"settings-modal",direction:"column",children:[e.jsx(c,{children:e.jsx(E,{"aria-label":"settings tabs",onChange:j,value:i,children:h.map((a,p)=>e.jsx(q,{disableRipple:!0,label:a.label,...I(p)},a.label))})}),h.map((a,p)=>e.jsx(V,{index:p,value:i,children:l&&e.jsx(a.component,{initialValues:l,onClose:t})},a.label))]})},E=o(M)`
  && {
    .MuiTabs-indicator {
