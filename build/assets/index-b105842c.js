import{o,F as s,T as g,p as y,j as e,A as b,aT as w,aU as S,q as h,r as T,J as v,O as m}from"./index-d7050062.js";import{B as A}from"./index-013a003a.js";import{G as C,h as B,F as G}from"./index-23e327af.js";import{B as f,T as M,a as $}from"./index-bed8e1e5.js";import{T as u}from"./index-687c2266.js";import{C as k}from"./ClipLoader-51c13a34.js";import"./useSlotProps-030211e8.js";import"./createSvgIcon-d73b5655.js";import"./index.esm-954c512a.js";import"./InfoIcon-ab6fe4e5.js";const D=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(F,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},F=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
