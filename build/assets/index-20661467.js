import{s as r,F as n,T as g,j as e,h as w,b as c,r as A,g as B}from"./index-fbea16ad.js";import{B as v}from"./index-7b5195df.js";import{u as F}from"./index-73d5b24f.js";import{u as M,U as $,q as C,e as b,x as D,F as k,C as G}from"./react-toastify.esm-ee4152bf.js";import{B as f,T as R,a as L}from"./index-e2f44253.js";import{T as x}from"./index-c28e550d.js";import"./useSlotProps-22211fec.js";import"./index.esm-08135425.js";import"./InfoIcon-8f72a8b2.js";const P=({onClose:s})=>{const[a]=M(t=>[t.graphStyle]),i=()=>{localStorage.setItem("graphStyle",a),s()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:i,children:"Save changes"})})]})},V=r(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=r(g)`
