import{s as r,F as s,T as m,j as e,h as w,b as h,r as T,g as B,k as A}from"./index-8a12d07f.js";import{B as F}from"./index-6c710d98.js";import{u as G}from"./index-7c4aea71.js";import{u as $,T as v,o as M,e as g,w as k,F as C,C as D}from"./react-toastify.esm-93f93bff.js";import{B as b,T as z,a as L}from"./index-0804c30b.js";import{T as x}from"./index-aa3a38ea.js";import"./useSlotProps-5ee0f16c.js";import"./index.esm-b5fe068c.js";import"./InfoIcon-537b5032.js";const P=({onClose:n})=>{const[i]=$(a=>[a.graphStyle]),o=()=>{localStorage.setItem("graphStyle",i),n()};return e.jsxs(R,{direction:"column",children:[e.jsx(V,{children:"Default graph view:"}),e.jsx(v,{}),e.jsx(s,{mt:308,children:e.jsx(b,{kind:"big",onClick:o,children:"Save changes"})})]})},R=r(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,V=r(m)`
