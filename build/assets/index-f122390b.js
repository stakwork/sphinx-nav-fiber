import{o as s,F as o,T as w,p as C,r as f,j as e,q as c,A as S,aU as A,aV as b,aW as z,J as D,O as y}from"./index-4e1be44a.js";import{B as G}from"./index-8e78fcf1.js";import{G as M,B as v,h as $,F as B}from"./index-e6c54684.js";import{C as T}from"./ClipLoader-2239c3c7.js";import{T as j}from"./index-e170c2c8.js";import{S as E}from"./index-770c3d27.js";import{e as I}from"./index.esm-5c5d8abf.js";import{T as k,a as F}from"./Tabs-a40cd1b4.js";import"./InfoIcon-2fcdc0d6.js";import"./useSlotProps-ed18ba4b.js";import"./createSvgIcon-f67705ce.js";const R=({onClose:a})=>{const[l]=C(d=>[d.graphStyle]),[r,i]=f.useState(!1),p=()=>{i(!0),localStorage.setItem("graphStyle",l),i(!1),a()};return e.jsxs(W,{direction:"column",children:[e.jsx(V,{children:"Default graph view:"}),e.jsx(M,{}),e.jsx(o,{mt:308,py:24,children:e.jsx(v,{color:"secondary",disabled:r,id:"add-node-submit-cta",onClick:p,size:"large",startIcon:r&&e.jsx(L,{children:e.jsx(T,{color:c.lightGray,size:12})}),type:"submit",variant:"contained",children:"Save Changes"})})]})},W=s(o)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,V=s(w)`
