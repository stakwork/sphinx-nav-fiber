...
`,Lt=n(k)`
  ...
  font-weight: 400;
  line-height: 18px;
`,Ht=({title:t,imageUrl:o,name:r})=>e.jsxs(s,{align:"center",direction:"row",children:[e.jsx(Ot,{children:e.jsx(z,{rounded:!0,size:64,src:o||"",type:"person"})}),(t||r)&&e.jsx(Wt,{children:t||r})]}),Ot=n(s)`
  img {
    width: 64px;
    height: 64px
    border-radius: 50%;
...
`,_s=({onClick:t,timestamp:o,isSelected:r,setOpenClip:a})=>e.jsxs(Ts,{align:"center","data-testid":"wrapper",direction:"row",isSelected:r,justify:"flex-start",onClick:t,px:20,py:20,children:[e.jsxs("div",{children:[e.jsx(Q,{className:"play-pause",children:r?e.jsx(Ss,{}):e.jsx(He,{})}),!1]}),e.jsxs(zs,{align:"flex-start",direction:"column",justify:"center",children:[o.timestamp&&e.jsx("span",{className:"timestamp",children:Oe(o.timestamp)}),e.jsx("span",{className:"title",children:ne(o.show_title)})]}),e.jsx("div",{className:"info",children:e.jsx(s,{"data-testid":"info-icon-wrapper",onClick:()=>a(o),pt:4,children:e.jsx(ht,{})})})]}),zs=n(s)`
  font-size: 13px;
  color: ${i.white};
  font-family: 'Barlow';
  margin: 0 16px;
