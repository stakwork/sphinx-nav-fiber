import{s as d,c as o,T as _,F as x,R as J,a as X,Y as Z,r as h,j as e,d as Fe,u as we,l as ye,b as Pe,e as de,f as Me}from"./index-71257a51.js";import{B as F}from"./index-fcf46a2b.js";import{u as E}from"./index-81b7e2b0.js";import{B,u as P,g as Oe,h as be,e as z,i as Se,I as R,p as Ge,d as A,j as ve,k as De,l as te,F as se,m as We,n as Te,o as Ye}from"./react-toastify.esm-80f7abc3.js";import{T as Ue,a as M,b as Ve,F as ee,M as oe,C as Ce,N as He,c as qe,D as ne}from"./NoFilterResultIcon-c88b17b5.js";import{M as $e,a as _e,b as Qe,c as Ke,d as Je,e as Xe}from"./index.esm-5156b765.js";import{C as T}from"./ClipLoader-954a7bed.js";import{S as O,C as ke,a as ze}from"./ChevronUpIcon-575c29ba.js";import{P as G,I as D,a as re,F as Ee}from"./Popover-750f866a.js";import{B as Ze,T as et}from"./index-905dce1b.js";import{A as Ne,u as $}from"./index-c48d2dab.js";import{P as Be}from"./Popper-52fdc8f0.js";import{C as Ae}from"./CheckIcon-1df7b8a8.js";import{S as tt}from"./SettingsIcon-72698ff8.js";import{T as st,a as ot}from"./index-f7b92541.js";import"./useSlotProps-e0213659.js";import"./InfoIcon-b5d1954e.js";const j=d(Ue)`
  && {
    color: ${o.white};
    border: none;
...
`,I={[J]:"RSS link",[X]:"Twitter Handle",[Z]:"Youtube channel"},nt="date",rt="edge_count",it="alphabetically",W={[nt]:"Date",[rt]:"Edge Count",[it]:"Alphabetically"},Ie="https://twitter.com",Re="IS_ALIAS",lt=({data:t})=>{const a=P(n=>n.setQueuedSources),[r,i]=h.useState(""),p=async n=>{if(t!=null&&t.length)try{const s=await Fe.enable();await Oe(n,s.pubkey),a(t.filter(l=>l.ref_id!==n))}catch(s){console.warn(s)}},f=async n=>{if(!(!n||!(t!=null&&t.length))){i(n);try{await be(n),a(t==null?void 0:t.filter(s=>s.ref_id!==n))}catch(s){console.warn(s)}finally{i("")}}};return t!=null&&t.length?e.jsxs(oe,{component:"table",children:[e.jsx(le,{children:e.jsxs(M,{component:"tr",children:[e.jsx(j,{className:"empty"}),e.jsx(j,{children:"Type"}),e.jsx(j,{children:"Source"}),e.jsx(j,{}),e.jsx(j,{className:"empty"})]})}),(t==null?void 0:t.length)&&e.jsx("tbody",{children:t==null?void 0:t.map(n=>e.jsxs(ie,{children:[e.jsx(j,{className:"empty"}),e.jsx(j,{children:I[n.source_type]}),e.jsx(j,{width:"268px",children:n.source_type==="twitter_handle"?e.jsxs(pe,{href:`${Ie}/${n.source}?open=system`,target:"_blank",children:["@",n.source]}):e.jsx(pe,{href:`${n.source}?open=system`,target:"_blank",children:n.source})}),e.jsx(j,{className:"cell-center",children:e.jsxs(x,{direction:"row",justify:"space-between",children:[e.jsx("div",{className:"approve-wrapper",children:e.jsx(he,{className:"centered",onClick:()=>p(n.ref_id),children:e.jsx($e,{color:o.primaryGreen,fontSize:24})})}),e.jsx("div",{className:"delete-wrapper",children:r===n.ref_id?e.jsx(T,{color:o.white,size:16}):e.jsx(Ce,{message:"Are you sure ?",onConfirm:()=>f(n.ref_id),children:e.jsx(he,{className:"centered",children:e.jsx(_e,{color:o.primaryRed,fontSize:24})})})})]})}),e.jsx(j,{className:"empty"})]},n.source))})]}):e.jsxs(x,{children:[e.jsx(_,{children:"There is not any results for selected filters"}),e.jsx(ee,{})]})},he=d(x)`
  width: 20px;
  height: 20px;
  border-radius: 50%;
  cursor: pointer;
...
`,Tt=({onSelect:t,selectedTopic:a})=>{const[r,i]=h.useState(!1),[p,f]=h.useState(""),[n,s]=h.useState([]),[l,c]=h.useState(!1),g=h.useRef(null);h.useEffect(()=>()=>s([]),[s]);const m=async u=>{const v={muted:"False",sort_by:Ne,search:u,skip:"0",limit:"1000"};c(!0);try{const S=await ve(v);s(S.data)}catch{s([])}finally{c(!1)}},w=h.useMemo(()=>ye.debounce(m,300),[]),y=u=>{t(u)},b=u=>{if(f(u),!u){s([]);return}u.length>2&&w(u)};return a?e.jsxs(_t,{children:[e.jsx("div",{className:"value",children:a.topic}),e.jsx(x,{className:"icon",onClick:()=>t(null),children:e.jsx(A,{})})]}):e.jsxs(e.Fragment,{children:[e.jsxs(G,{ref:g,component:"form",onSubmit:u=>u.preventDefault(),sx:{p:"2px 4px",display:"flex",alignItems:"center",width:200},children:[e.jsx(D,{inputProps:{"aria-label":"search topic"},onChange:u=>b(u.target.value),onFocus:()=>i(!0),placeholder:"Search",size:"small",sx:{ml:1,flex:1},value:p}),p&&e.jsxs(e.Fragment,{children:[e.jsx(ue,{"aria-label":"search",onClick:()=>b(""),type:"button",children:e.jsx(A,{})}),e.jsx(ne,{orientation:"vertical",sx:{height:28,m:.5}})]}),e.jsx(ue,{"aria-label":"search",type:"button",children:l?e.jsx(T,{color:o.white,size:24}):e.jsx(O,{})})]}),g.current&&n.length?e.jsx($t,{anchorEl:g.current,open:r,placement:"bottom",children:e.jsx(e.Fragment,{children:n.map(u=>e.jsx(Ct,{className:z({active:a===u.ref_id}),onClick:()=>y(u),children:u.topic},"option"))})}):null]})},Ct=d(x).attrs({direction:"row",align:"center"})`
  font-family: Barlow;
  font-size: 13px;
  font-style: normal;
  font-weight: 500;
...
`,ue=d(R)`
  font-size: 24px;
`,kt=({selectedType:t,setSelectedType:a})=>{const[r,i]=h.useState(null),[p,f]=h.useState([]);h.useEffect(()=>{(async()=>{try{const{data:g}=await De();f(g.edge_types)}catch(g){console.warn(g)}})()},[f]);const n=c=>{i(c.currentTarget)},s=()=>{i(null)},l=c=>{a(c),s()};return e.jsxs("div",{children:[e.jsxs(zt,{onClick:n,children:[e.jsx("div",{className:"text",children:"Type"}),e.jsx("div",{className:"value",children:t}),e.jsx("div",{className:"icon",children:r?e.jsx(ze,{}):e.jsx(ke,{})})]}),e.jsx(Nt,{anchorEl:r,anchorOrigin:{vertical:"bottom",horizontal:"left"},anchorPosition:{top:62,left:0},onClose:s,open:!!r,transformOrigin:{vertical:"top",horizontal:"left"},children:e.jsx(Ee,{children:p.map(c=>e.jsxs(Et,{className:z({active:c===t}),onClick:()=>l(c),children:[e.jsx("span",{className:"icon",children:c===t?e.jsx(Ae,{}):null}),e.jsx("span",{children:c})]},c))})})]})},zt=d(x).attrs({direction:"row",align:"center"})`
  cursor: pointer;
  flex-grow: 1;
  color: ${o.GRAY6};
  font-family: Barlow;
...
`,V=d(x)`
  flex: 1 1 100%;
`,Rt=({topic:t,onClose:a})=>{const{close:r}=E("addEdge"),[i]=$(b=>[b.data]),p=te({mode:"onChange"}),[f,n]=h.useState(!1),[s,l]=h.useState(null),[c,g]=h.useState(""),m=()=>{a(),r()},w=async()=>{if(!(!s||!i)){n(!0);try{await We({from:t.ref_id,to:s==null?void 0:s.ref_id,relationship:c});const{ref_id:b}=t,{ref_id:u}=s;if(i){const v={...i};v[b]={...v[b],edgeList:[...v[b].edgeList,c]},v[u]&&(v[u]={...v[u],edgeList:[...v[u].edgeList,c]}),$.setState({data:v})}m()}catch(b){console.warn(b)}finally{n(!1)}}},y=f||!s||!c;return e.jsx(F,{id:"addEdge",kind:"large",onClose:m,preventOutsideClose:!0,children:e.jsxs(se,{...p,children:[e.jsx(Bt,{from:t.topic,onSelect:l,selectedTopic:s,selectedType:c,setSelectedType:g}),e.jsxs(B,{color:"secondary",disabled:y,onClick:w,size:"large",variant:"contained",children:["Confirm",f&&e.jsx(T,{color:o.BLUE_PRESS_STATE,size:10})]})]})})},Lt=()=>e.jsxs(x,{children:[e.jsx(x,{align:"center",direction:"row",justify:"space-between",mb:18,children:e.jsx(x,{align:"center",direction:"row",children:e.jsx(Ft,{children:"Edit topic"})})}),e.jsx(x,{mb:12,children:e.jsx(et,{id:"cy-topic",maxLength:50,name:"topic",placeholder:"Add your topic",rules:{...Pe}})})]}),Ft=d(_)`
  font-size: 22px;
  font-weight: 600;
  font-family: 'Barlow';
`,Pt=({topic:t,onClose:a})=>{const{close:r}=E("editTopic"),[i]=$(y=>[y.data]),p=te({mode:"onChange"}),{watch:f,setValue:n,reset:s}=p,[l,c]=h.useState(!1);h.useEffect(()=>(t&&n("topic",t==null?void 0:t.topic),()=>{s()}),[t,n,s]);const g=f("topic"),m=()=>{a(),r()},w=async()=>{c(!0);try{if(await Te((t==null?void 0:t.ref_id)||"",{topic:g.trim()}),i){const y={...i};y[t==null?void 0:t.ref_id].topic=g.trim(),$.setState({data:y})}m()}catch(y){console.warn(y)}finally{c(!1)}};return e.jsx(F,{id:"editTopic",kind:"regular",onClose:m,preventOutsideClose:!0,children:e.jsxs(se,{...p,children:[e.jsx(Lt,{}),e.jsxs(B,{color:"secondary",disabled:l,onClick:w,size:"large",variant:"contained",children:["Save",l&&e.jsx(T,{color:o.BLUE_PRESS_STATE,size:10})]})]})})},Mt=({onSelect:t,selectedTopic:a})=>{const[r,i]=h.useState(!1),[p,f]=h.useState(""),[n,s]=h.useState([]),[l,c]=h.useState(!1),g=h.useRef(null);h.useEffect(()=>()=>s([]),[s]);const m=async u=>{const v={muted:"False",sort_by:Ne,search:u,skip:"0",limit:"1000"};c(!0);try{const S=await ve(v);s(S.data)}catch{s([])}finally{c(!1)}},w=h.useMemo(()=>ye.debounce(m,300),[]),y=u=>{t(u)},b=u=>{if(f(u),!u){s([]);return}u.length>2&&w(u)};return a?e.jsxs(Dt,{children:[e.jsx("div",{className:"value",children:a.topic}),e.jsx(x,{className:"icon",onClick:()=>t(null),children:e.jsx(A,{})})]}):e.jsxs(e.Fragment,{children:[e.jsxs(G,{ref:g,component:"form",onSubmit:u=>u.preventDefault(),sx:{p:"2px 4px",display:"flex",alignItems:"center",width:200},children:[e.jsx(D,{inputProps:{"aria-label":"search topic"},onChange:u=>b(u.target.value),onFocus:()=>i(!0),placeholder:"Search",size:"small",sx:{ml:1,flex:1},value:p}),p&&e.jsxs(e.Fragment,{children:[e.jsx(fe,{"aria-label":"search",onClick:()=>b(""),type:"button",children:e.jsx(A,{})}),e.jsx(ne,{orientation:"vertical",sx:{height:28,m:.5}})]}),e.jsx(fe,{"aria-label":"search",type:"button",children:l?e.jsx(T,{color:o.white,size:24}):e.jsx(O,{})})]}),g.current&&n.length?e.jsx(Gt,{anchorEl:g.current,open:r,placement:"bottom",children:e.jsx(e.Fragment,{children:n.map(u=>e.jsx(Ot,{className:z({active:a===u.ref_id}),onClick:()=>y(u),children:u.topic},"option"))})}):null]})},Ot=d(x).attrs({direction:"row",align:"center"})`
  font-family: Barlow;
  font-size: 13px;
  font-style: normal;
  font-weight: 500;
...
`,me=d(x)`
  flex: 1 1 100%;
`,Vt=({topic:t,onClose:a})=>{const{close:r}=E("mergeTopic"),[i,p,f]=$(S=>[S.data,S.ids,S.total]),n=te({mode:"onChange"}),{watch:s,setValue:l,reset:c}=n,[g,m]=h.useState(!1),[w,y]=h.useState(null);h.useEffect(()=>(t&&l("topic",t==null?void 0:t.topic),()=>{c()}),[t,l,c]);const b=s("topic"),u=()=>{a(),r()},v=async()=>{if(!(!w||!i)){m(!0);try{await Ye({from:t.ref_id,to:w==null?void 0:w.ref_id});const{ref_id:S}=t;if(i[S]={...i[S],edgeList:[Re],edgeCount:i[S].edgeCount-1},$.setState({ids:p.filter(k=>k!==w.ref_id),total:f-1}),i){const k={...i};k[t==null?void 0:t.ref_id].topic=b.trim(),$.setState({data:k})}u()}catch(S){console.warn(S)}finally{m(!1)}}};return e.jsx(F,{id:"mergeTopic",kind:"regular",onClose:u,preventOutsideClose:!0,children:e.jsxs(se,{...n,children:[e.jsx(Wt,{from:t.topic,onSelect:y,selectedTopic:w}),e.jsxs(B,{color:"secondary",disabled:g,onClick:v,size:"large",variant:"contained",children:["Merge topics",g&&e.jsx(T,{color:o.BLUE_PRESS_STATE,size:10})]})]})})},Ht=()=>{const[t,a]=$(n=>[n.filters,n.setFilters]),[r,i]=h.useState(""),p=n=>{n.preventDefault(),a({search:r})},f=()=>{i(""),t.search&&a({search:""})};return e.jsxs(G,{component:"form",onSubmit:p,sx:{p:"2px 4px",display:"flex",alignItems:"center",width:300},children:[e.jsx(D,{autoComplete:"off",autoCorrect:"off",inputProps:{"aria-label":"search topic"},onChange:n=>i(n.target.value),placeholder:"Search",size:"small",spellCheck:"false",sx:{ml:1,flex:1},value:r}),r&&e.jsxs(e.Fragment,{children:[e.jsx(ge,{"aria-label":"search",onClick:f,type:"button",children:e.jsx(A,{})}),e.jsx(ne,{orientation:"vertical",sx:{height:28,m:.5}})]}),e.jsx(ge,{"aria-label":"search",onClick:p,type:"button",children:e.jsx(O,{})})]})},ge=d(R)`
  font-size: 24px;
...
`,Xt=({topic:t,onClick:a})=>{const[r,i]=$(l=>[l.ids,l.total]),[p,f]=h.useState(!1),n=t.date_added_to_graph.toString(),s=async(l,c)=>{f(!0);try{await Te(l,{muted_topic:c}),$.setState({ids:r.filter(g=>g!==l),total:i-1})}catch(g){console.warn(g)}};return e.jsxs(ie,{children:[e.jsx(j,{className:"empty"}),e.jsx(j,{children:t.topic}),e.jsx(j,{children:t.edgeCount}),e.jsx(j,{children:t.edgeList.join(", ")}),e.jsx(j,{children:e.jsx("span",{children:new Date(Number(n)*1e3).toDateString()})}),e.jsx(j,{className:"cell-center",children:e.jsx(x,{direction:"row",justify:"space-between",children:e.jsx("div",{className:"approve-wrapper",children:p?e.jsx(T,{color:o.white,size:16}):e.jsx(e.Fragment,{children:t.muted_topic?e.jsx(je,{className:"centered",onClick:()=>s(t.ref_id,!1),children:e.jsx($e,{color:o.primaryGreen,fontSize:24})}):e.jsx(je,{className:"centered",onClick:()=>s(t.ref_id,!0),children:e.jsx(_e,{color:o.primaryRed,fontSize:24})})})})})}),e.jsx(j,{children:e.jsx(R,{onClick:l=>a(l,t.ref_id),children:e.jsx(tt,{})})})]},t.topic)},je=d(x)`
  width: 20px;
  height: 20px;
  border-radius: 50%;
  cursor: pointer;
...
`,cs=d(x)`
  min-height: 0;
  flex: 1;
`,_s=()=>{const{close:t}=E("sourcesTable");return e.jsx(F,{background:"BG1",id:"sourcesTable",kind:"large",noWrap:!0,onClose:t,children:e.jsx(is,{})})};export{_s as SourcesTableModal};
