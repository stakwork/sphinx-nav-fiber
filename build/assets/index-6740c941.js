import{o as s,F as o,T as w,p as C,r as f,j as e,q as c,A as S,aU as A,aV as b,aW as M,M as z,Q as y}from"./index-030ad25f.js";import{B as D}from"./index-75c3e524.js";import{G,B as v,i as $,F as B}from"./index-1817bd2f.js";import{C as T}from"./ClipLoader-6c77f878.js";import{T as j}from"./index-373404f8.js";import{S as E}from"./index-8674e09c.js";import{e as I}from"./index.esm-9d8fef3b.js";import{T as k,a as F}from"./Tabs-e94479c9.js";import"./InfoIcon-a192bed5.js";import"./useSlotProps-38fba3ac.js";import"./createSvgIcon-3f6852b5.js";const R=({onClose:a})=>{const[l]=C(d=>[d.graphStyle]),[r,i]=f.useState(!1),p=()=>{i(!0),localStorage.setItem("graphStyle",l),i(!1),a()};return e.jsxs(W,{direction:"column",children:[e.jsx(V,{children:"Default graph view:"}),e.jsx(G,{}),e.jsx(o,{mt:308,py:24,children:e.jsx(v,{color:"secondary",disabled:r,id:"add-node-submit-cta",onClick:p,size:"large",startIcon:r&&e.jsx(L,{children:e.jsx(T,{color:c.lightGray,size:12})}),type:"submit",variant:"contained",children:"Save Changes"})})]})},W=s(o)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,V=s(w)`
