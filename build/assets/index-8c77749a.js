import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-8c6e7d86.js";import{B as F}from"./index-2db2798f.js";import{u as M}from"./index-3a2e60ff.js";import{j as $,e as k,F as D,C as G}from"./react-toastify.esm-fcf4c1e7.js";import{B as f,T as R,a as L}from"./index-d010b8aa.js";import{T as x}from"./index-c3d690f6.js";import"./useSlotProps-723c9ba2.js";import"./index.esm-5e8d1785.js";import"./InfoIcon-27e3afdb.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
