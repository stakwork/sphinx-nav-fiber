import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-0be95a0b.js";import{B}from"./index-63adb6de.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-8047c6c1.js";import{B as f,T as $,a as k}from"./index-c69ff232.js";import{T as u}from"./index-d97174fd.js";import"./useSlotProps-2df1bc54.js";import"./index.esm-576dc558.js";import"./InfoIcon-036e38f2.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
