import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-f573449f.js";import{B as F}from"./index-35e5f653.js";import{u as M}from"./index-b5b45532.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-9af0426a.js";import{B as f,T as R,a as L}from"./index-e6268d41.js";import{T as x}from"./index-f5614c3a.js";import"./useSlotProps-ac29076b.js";import"./index.esm-48892139.js";import"./InfoIcon-71c27dce.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
