import{t as i,v as N,T as E,F as s,N as U,r as c,j as e,aA as W,a_ as P,aY as V,q as k}from"./index-5c0ac6ff.js";import{B as q}from"./index-fb069593.js";import{u as h,e as F,T as G,aZ as Y,a0 as H,a1 as Z,B as I}from"./index-3e23255c.js";import{T as J}from"./index-74d567bf.js";import{S as K}from"./Skeleton-96e16623.js";import{C as Q}from"./ClipLoader-e77a9c56.js";import"./index.esm-99836bec.js";const X=/^https:\/\/\S+\.(png|jpe?g|svg)$/;function ee(l){return!!X.test(l)}const te=()=>{const{open:l}=h("changeNodeType"),{close:x}=h("editNodeName"),{changeNodeTypeFeatureFlag:f}=U(o=>({changeNodeTypeFeatureFlag:o.changeNodeTypeFeatureFlag})),a=F(),j=a==null?void 0:a.node_type,[p,m]=c.useState({});c.useEffect(()=>{a!=null&&a.properties&&m(a.properties)},[a]);const y=()=>{x(),l()},g=(o,n)=>{m(T=>({...T,[o]:n}))};return e.jsxs(s,{children:[e.jsx(s,{align:"center",direction:"row",justify:"space-between",mb:18,children:e.jsxs(s,{align:"center",direction:"row",children:[e.jsx(ae,{children:"Edit Node"}),e.jsxs(ne,{children:[e.jsx(G,{type:j}),f&&e.jsx(se,{onClick:y,children:e.jsx(Y,{})})]})]})}),e.jsx(re,{children:Object.keys(p).map(o=>e.jsxs(s,{mb:18,children:[e.jsx(oe,{style:{marginBottom:8},children:o}),e.jsx(J,{id:`cy-${o}`,maxLength:50,name:`properties.${o}`,onChange:n=>g(o,n),placeholder:`Please Enter the ${o}`,rules:o==="name"?{...W}:{}})]},o))})]})},ae=i(E)`
  font-size: 22px;
  font-weight: 600;
  font-family: 'Barlow';
`,oe=i(E)`
