import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-05afde16.js";import{B}from"./index-740f2ffd.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-3cc87da8.js";import{B as f,T as $,a as k}from"./index-b94509d7.js";import{T as u}from"./index-e0641c2a.js";import"./useSlotProps-00cd5537.js";import"./index.esm-2dfabbab.js";import"./InfoIcon-0804607b.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
