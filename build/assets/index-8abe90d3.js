import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-3d723af8.js";import{B as M}from"./index-32c35bfc.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-0038a851.js";import{B as f,T as L,a as R}from"./index-9f45e01e.js";import{T as x}from"./index-e7b4a9f5.js";import"./useSlotProps-ef742437.js";import"./index.esm-94a3931d.js";import"./InfoIcon-1cf069e7.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
