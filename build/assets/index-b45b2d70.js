import{s as r,F as n,T as g,j as e,h as w,b as c,r as A,g as B}from"./index-7a3017bc.js";import{B as v}from"./index-72845d56.js";import{u as F}from"./index-ca99b93a.js";import{u as M,U as $,q as C,e as b,x as D,F as k,C as G}from"./react-toastify.esm-558803b1.js";import{B as f,T as R,a as L}from"./index-3597604a.js";import{T as x}from"./index-55656401.js";import"./useSlotProps-22051b00.js";import"./index.esm-bae92ed7.js";import"./InfoIcon-82d10ef5.js";const P=({onClose:s})=>{const[a]=M(t=>[t.graphStyle]),i=()=>{localStorage.setItem("graphStyle",a),s()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:i,children:"Save changes"})})]})},V=r(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=r(g)`
