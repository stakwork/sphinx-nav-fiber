import{s as f,c as y,u as L,r as x,j as e,F as t,T as h,b as C,w as R,n as U,ad as V,ae as g,d as G,a2 as q}from"./index-192c4af5.js";import{ao as J,B as j,ap as Y,l as H,u as K,F as Q}from"./react-toastify.esm-322b754b.js";import{B as W}from"./index-f7a083b8.js";import{n as S}from"./toastMessage-0572f501.js";import{u as X}from"./index-8ba7564d.js";import{C as Z}from"./CheckIcon-cd9ee8ed.js";import{T as B}from"./index-091f2c6c.js";import{A as ee}from"./index-8adc0141.js";import{i as v,O as E}from"./constants-84edb5fc.js";import"./index.esm-2729db2b.js";import"./InfoIcon-e42de8ec.js";import"./index-69158b78.js";import"./Popover-624804ea.js";import"./useSlotProps-8086a3a5.js";import"./Select-0d94085d.js";import"./Stack-b94a741a.js";import"./Popper-a42dd332.js";const te=({onClick:n,loading:a})=>{const d=L(l=>l.budget),[c,m]=x.useState(10),s="node";return x.useEffect(()=>{(async()=>{try{const r=await Y(s);m(r.data.price)}catch(r){console.error("cannot fetch",r)}})()},[s]),e.jsxs(t,{children:[e.jsx(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:e.jsx(t,{align:"center",direction:"row",children:e.jsx(se,{children:"Approve Cost"})})}),e.jsxs(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:[e.jsxs(ne,{children:[e.jsx("div",{className:"title",children:"COST"}),e.jsxs("div",{className:"value","data-testid":"check-price",children:[c," sats"]})]}),e.jsxs(oe,{children:[e.jsx("div",{className:"title",children:"BUDGET"}),e.jsxs("div",{className:"value",children:[J(d)," sats"]})]})]}),e.jsx(t,{children:e.jsx(j,{color:"secondary","data-testid":"check-icon",disabled:a,onClick:n,size:"large",startIcon:e.jsx(Z,{}),type:"submit",variant:"contained",children:"Approve"})})]})},ne=f(t).attrs({direction:"column",align:"space-between",justify:"flex-start"})`
  width: 141px;
  height: 61px;
