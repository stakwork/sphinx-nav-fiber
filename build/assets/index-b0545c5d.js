import{p as i,q as t,F as c,j as e,Q as j,r as l,t as $,x as C,A as R,ba as D,bb as I}from"./index-81b641ae.js";import{B as z}from"./index-338873a6.js";import{D as E}from"./DeleteNodeIcon-e1ca9a52.js";import{S as L}from"./Skeleton-577112f1.js";import{C as T}from"./ClipLoader-8d8eb5d1.js";import{B as w}from"./index-30eadeae.js";const A=({nodeName:p})=>e.jsx(c,{children:e.jsxs(c,{align:"center",direction:"column",justify:"space-between",children:[e.jsx(M,{children:e.jsx(E,{})}),e.jsxs(G,{children:["Are you sure you want to delete ",p||"this item","?"]})]})}),G=i(c)`
  color: ${t.white};
  font-family: 'Barlow';
  font-size: 20px;
  font-weight: 400;
