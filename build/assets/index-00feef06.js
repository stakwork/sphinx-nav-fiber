import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-dab5a5eb.js";import{B as F}from"./index-e35002f3.js";import{u as M}from"./index-7ce03c3e.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-3b3c2d0b.js";import{B as f,T as R,a as L}from"./index-9406450c.js";import{T as x}from"./index-0a5d4d03.js";import"./useSlotProps-c1fd1b5e.js";import"./index.esm-4ea8735e.js";import"./InfoIcon-e2794383.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
