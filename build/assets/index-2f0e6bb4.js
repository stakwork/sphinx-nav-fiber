import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-8315a78a.js";import{B}from"./index-36081304.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-c9bf8e06.js";import{B as f,T as $,a as k}from"./index-44cb4abb.js";import{T as u}from"./index-6f2dd91b.js";import"./useSlotProps-1af0a721.js";import"./index.esm-dcb6642f.js";import"./InfoIcon-0099963d.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
