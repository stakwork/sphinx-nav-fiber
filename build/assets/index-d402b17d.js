import{s as x,c as f,u as P,r as m,j as e,F as n,T as u,b as N,x as V,n as q,aQ as J,g as Q,ai as S,d as Y,a4 as H}from"./index-2a9d3beb.js";import{av as K,B as w,aw as W,k as X,F as Z,ax as ee}from"./react-toastify.esm-07017734.js";import{B as te}from"./index-5c9cd044.js";import{n as y}from"./toastMessage-b961f51d.js";import{a as C}from"./index-6d52fb5c.js";import{u as ne}from"./index-82f4c095.js";import{C as oe}from"./CheckIcon-820446e3.js";import{T as _}from"./index-8d47b5aa.js";import{A as se}from"./index-09a9a174.js";import"./index.esm-7c2c6137.js";import"./InfoIcon-fa5df30b.js";import"./index-69eec19b.js";import"./Popover-dabdecb4.js";import"./useSlotProps-28bca2ab.js";import"./Select-cbc0a71e.js";import"./Stack-5524f850.js";import"./Popper-449923bf.js";const re=({onClick:o,loading:a})=>{const i=P(l=>l.budget),[c,p]=m.useState(10),r="node";return m.useEffect(()=>{(async()=>{try{const t=await W(r);p(t.data.price)}catch(t){console.error("cannot fetch",t)}})()},[r]),e.jsxs(n,{children:[e.jsx(n,{align:"center",direction:"row",justify:"space-between",mb:20,children:e.jsx(n,{align:"center",direction:"row",children:e.jsx(ce,{children:"Approve Cost"})})}),e.jsxs(n,{align:"center",direction:"row",justify:"space-between",mb:20,children:[e.jsxs(ae,{children:[e.jsx("div",{className:"title",children:"COST"}),e.jsxs("div",{className:"value","data-testid":"check-price",children:[c," sats"]})]}),e.jsxs(ie,{children:[e.jsx("div",{className:"title",children:"BUDGET"}),e.jsxs("div",{className:"value",children:[K(i)," sats"]})]})]}),e.jsx(n,{children:e.jsx(w,{color:"secondary","data-testid":"check-icon",disabled:a,onClick:o,size:"large",startIcon:e.jsx(oe,{}),type:"submit",variant:"contained",children:"Approve"})})]})},ae=x(n).attrs({direction:"column",align:"space-between",justify:"flex-start"})`
  width: 141px;
  height: 61px;
