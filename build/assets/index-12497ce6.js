import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-bf817944.js";import{B as M}from"./index-6580f146.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-e242efec.js";import{B as f,T as L,a as R}from"./index-21a7903e.js";import{T as x}from"./index-2b5f4101.js";import"./useSlotProps-1f7f153d.js";import"./index.esm-7a8df79a.js";import"./InfoIcon-aa3fbeee.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
