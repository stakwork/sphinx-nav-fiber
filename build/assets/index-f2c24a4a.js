import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-fdf7f64f.js";import{B as M}from"./index-3eef7e1d.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-a21689b0.js";import{B as f,T as L,a as R}from"./index-f5d6bf52.js";import{T as x}from"./index-31ef6a3c.js";import"./useSlotProps-2bd0b107.js";import"./index.esm-b2e306d3.js";import"./InfoIcon-9fa8c43b.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
