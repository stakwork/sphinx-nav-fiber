import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-fdf7f64f.js";import{B}from"./index-3eef7e1d.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-a21689b0.js";import{B as f,T as $,a as k}from"./index-f5d6bf52.js";import{T as u}from"./index-31ef6a3c.js";import"./useSlotProps-2bd0b107.js";import"./index.esm-b2e306d3.js";import"./InfoIcon-9fa8c43b.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
