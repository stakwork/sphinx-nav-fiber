import{p as a,q as r,F as i,t as S,j as e,v as B,w as I,E as v,r as b,C as $,D as C,aJ as A,aK as y,aL as k,Q as w}from"./index-15dc49aa.js";import{B as z}from"./index-aea34727.js";import{u as M,H as D,C as E,x as R,J as L,B as T,q as F,F as P}from"./index-eb8682b1.js";import{C as G}from"./ClipLoader-68b2e276.js";import{e as W}from"./index.esm-c0334e89.js";import{S as V}from"./index-9a1fa2f0.js";import{T as j}from"./index-a0c012ba.js";import{T as U,a as N}from"./Tabs-9ce0bc8e.js";import"./createSvgIcon-993d3f43.js";const Y={split:e.jsx(D,{}),force:e.jsx(E,{}),sphere:e.jsx(R,{}),earth:e.jsx(L,{})},q=()=>{const[n,p]=S(M(t=>[t.graphStyle,t.setGraphStyle])),l=t=>{p(t)};return e.jsx(H,{direction:"column",children:B.map(t=>e.jsx(i,{className:I("icon",{active:n===t}),onClick:()=>l(t),children:Y[t]},t))})},H=a(i).attrs({direction:"row",align:"center",justify:"space-between"})`
  width: 447px;
  height: 48px;
