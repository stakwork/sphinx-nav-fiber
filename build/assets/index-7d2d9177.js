import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,x as D,B as F}from"./index-098ddbcf.js";import{B as M}from"./index-a7b1abe8.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-896961cd.js";import{B as f,T as L,a as R}from"./index-fe30444c.js";import{T as x}from"./index-742d0467.js";import"./useSlotProps-8fa59e2c.js";import"./index.esm-dbc85712.js";import"./InfoIcon-3c28434f.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
