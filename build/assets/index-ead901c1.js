import{r as i,j as e,s as u,g as S,F as j,o as X,c as Y,A as oe,p as ie,i as ae,q as ce,H as le,t as pe,v as de}from"./index-c87d54e6.js";import{t as O,u as H,C as ue}from"./index-8ff7f8df.js";import{U as fe}from"./index-5b0bc810.js";import{u as T,a as me,b as ge,I as he,c as J,d as xe}from"./index-b3abab7a.js";import{M as ye,V as be}from"./index-9a0cea29.js";import{S as we,R as je,s as V,M as ve}from"./index-67013b7a.js";import"./string-a277709d.js";import"./index-a5ee8e21.js";import"./three.module-976f5d36.js";import"./index-cc78a759.js";import"./TextareaAutosize-cef8d7b8.js";import"./CheckIcon-ebe3f096.js";import"./index-00036bad.js";import"./index-76cd72e0.js";import"./ClipLoader-105d2570.js";import"./clsx-7feca982.js";import"./SourcesTableIcon-b444b8bf.js";import"./DeleteNodeIcon-34f59508.js";import"./SoundIcon-e650d9b0.js";import"./SucessFeedBackIcon-486186a0.js";import"./Skeleton-340cada7.js";import"./index-b3307076.js";import"./Stack-0c5c70b4.js";import"./FormControlLabel-f6c27a00.js";import"./Typography-6da1c758.js";import"./createSvgIcon-238745d4.js";import"./isPlainObject-c7fe07b3.js";const K=i.memo(()=>{const r=T(n=>n.isPlaying),a=T(n=>n.setIsPlaying),s=T(n=>n.setVolume),t=T(n=>n.setPlaybackSpeed),c=T(n=>n.playbackSpeed),o=T(n=>n.playerRef),[d,g]=i.useState(!1),m=[.5,1,1.5,2],h=()=>{if(o){const n=o.getCurrentTime()-15;o.seekTo(n,"seconds")}},f=()=>{if(o){const n=o.getCurrentTime()+15;o.seekTo(n,"seconds")}},w=()=>{a(!r)},p=()=>{g(!d),s(d?1:0)},l=()=>{const x=(m.indexOf(c)+1)%m.length,P=m[x];if(t(P),o){const k=o.getInternalPlayer();k&&typeof k.playbackRate<"u"&&(k.playbackRate=P)}};return e.jsxs(Se,{children:[e.jsx(Pe,{onClick:p,children:d?e.jsx(ye,{}):e.jsx(be,{})}),e.jsx(Ce,{onClick:h,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(ke,{"data-testid":"play-pause-button",onClick:w,size:"small",children:r?e.jsx(me,{"data-testid":"pause-icon"}):e.jsx(ge,{"data-testid":"play-icon"})}),e.jsx(Ie,{onClick:f,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(_e,{onClick:l,children:[c,"x"]})]})});K.displayName="Controls";const Se=u(j).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${S.BG1};
  border-radius: 40px;
