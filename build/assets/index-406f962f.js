import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-07376ddf.js";import{B}from"./index-136e7e49.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-ef97e95f.js";import{B as f,T as $,a as k}from"./index-c94f3285.js";import{T as u}from"./index-f7c5891b.js";import"./useSlotProps-1cdafe6e.js";import"./index.esm-584ca0de.js";import"./InfoIcon-e196eea3.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
