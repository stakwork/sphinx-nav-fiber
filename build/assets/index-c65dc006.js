import{s as r,F as n,T as g,j as e,h as w,b as c,r as A,g as B}from"./index-fffd6c14.js";import{B as v}from"./index-0ec30624.js";import{u as F}from"./index-bb0d1196.js";import{u as M,U as $,q as C,e as b,x as D,F as k,C as G}from"./react-toastify.esm-c6a3f8fb.js";import{B as f,T as R,a as L}from"./index-ed9aa46a.js";import{T as x}from"./index-0cbeb3a0.js";import"./useSlotProps-bbcdc4e8.js";import"./index.esm-de5a2811.js";import"./InfoIcon-0d439864.js";const P=({onClose:s})=>{const[a]=M(t=>[t.graphStyle]),i=()=>{localStorage.setItem("graphStyle",a),s()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:i,children:"Save changes"})})]})},V=r(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=r(g)`
