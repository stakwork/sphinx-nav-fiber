import{s as r,F as n,T as g,j as e,h as w,b as c,r as A,g as B}from"./index-49119fea.js";import{B as v}from"./index-9783c4d9.js";import{u as F}from"./index-3098c379.js";import{e as M,X as $,t as C,h as b,z as D,F as k,C as G}from"./react-toastify.esm-cab56736.js";import{B as f,T as R,a as z}from"./index-2077986c.js";import{T as x}from"./index-b4e4a884.js";import"./useSlotProps-e5ef1c74.js";import"./index.esm-abe4cb74.js";import"./InfoIcon-49f77bdb.js";const L=({onClose:s})=>{const[a]=M(t=>[t.graphStyle]),i=()=>{localStorage.setItem("graphStyle",a),s()};return e.jsxs(P,{direction:"column",children:[e.jsx(V,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:i,children:"Save changes"})})]})},P=r(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,V=r(g)`
