import{s as r,F as n,T as g,j as e,h as w,b as c,r as A,g as B}from"./index-5fb1066b.js";import{B as v}from"./index-336ec8a7.js";import{u as F}from"./index-8c752204.js";import{u as M,T as $,o as C,e as b,w as D,F as k,C as G}from"./react-toastify.esm-74a6e79d.js";import{B as f,T as R,a as L}from"./index-dba1eeb7.js";import{T as x}from"./index-9bd962af.js";import"./useSlotProps-4cfb1cc9.js";import"./index.esm-a4700a64.js";import"./InfoIcon-3763223f.js";const P=({onClose:s})=>{const[a]=M(t=>[t.graphStyle]),i=()=>{localStorage.setItem("graphStyle",a),s()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:i,children:"Save changes"})})]})},V=r(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=r(g)`
