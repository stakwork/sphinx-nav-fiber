import{r,j as e,by as B,ap as O,F as h,C as k,bn as F,bz as _,s as l,T as z,D as E,l as D,n as N,g as C,B as M,bA as Y,b6 as P}from"./index-0e71550c.js";import{e as X}from"./index-cc42c491.js";import{O as G,Q as H,U as R}from"./index-c6eb4ffc.js";import{A as I,T as Q}from"./index-a9c352d4.js";import{S as U,A as V}from"./constants-cfb40f65.js";import{C as T}from"./ClipLoader-39b0e414.js";import"./SourcesTableIcon-733f4b62.js";import"./CheckIcon-22fc4102.js";import"./DeleteNodeIcon-c15a0339.js";import"./SoundIcon-348b8e0c.js";import"./SucessFeedBackIcon-3537b830.js";import"./Stack-b78ed822.js";import"./clsx-45ad0b2f.js";import"./createSvgIcon-8cb8232a.js";import"./TextareaAutosize-982d3f42.js";const W=({selectedType:t,setSelectedType:c})=>{const[p,d]=r.useState([]);r.useEffect(()=>{(async()=>{try{const{data:x}=await B();d(x.edge_types)}catch(x){console.warn(x)}})()},[d]);const n=o=>({label:o,value:o}),f=o=>{c((o==null?void 0:o.value)||"")};return e.jsx(I,{onSelect:f,options:p.map(n),selectedValue:t?n(t):null})},$=({onSelect:t,selectedValue:c,topicId:p})=>{const[d,n]=r.useState([]),[f,o]=r.useState(!1),x=r.useMemo(()=>{const s=async u=>{const i={is_muted:"False",sort_by:V,search:u,skip:"0",limit:"1000"};o(!0);try{const w=(await _(i.search)).data.filter(b=>(b==null?void 0:b.ref_id)!==p);n(w)}catch{n([])}finally{o(!1)}};return O.debounce(s,300)},[p]),m=s=>{const u=s.trim();if(!u){n([]);return}u.length>2&&x(s)},j=s=>{const u=s?d.find(i=>i.ref_id===s.value):null;t(u||null)},a=s=>({label:s.search_value,value:s.ref_id,type:s.node_type}),v=s=>s.map(a);return c?e.jsxs(h,{align:"center",basis:"100%",direction:"row",grow:1,shrink:1,children:[e.jsx("span",{children:c.search_value}),e.jsx(U,{onClick:()=>t(null),size:"medium",children:e.jsx(k,{})})]}):e.jsx(I,{handleInputChange:m,isLoading:f,onSelect:j,options:v(d)||F,selectedValue:c?a(c):null})},q=({from:t,onSelect:c,selectedType:p,setSelectedType:d,selectedToNode:n,setIsSwapped:f,isSwapped:o})=>{const x=()=>{f()},m=t&&("search_value"in t?t.search_value:t.name);return e.jsxs(h,{mb:20,children:[e.jsx(h,{align:"center",direction:"row",justify:"space-between",mb:18,children:e.jsx(h,{align:"center",direction:"row",children:e.jsx(K,{children:"Add Edge"})})}),e.jsxs(Z,{swap:o,children:[e.jsx(h,{children:e.jsx(ee,{disabled:!0,label:o?"To":"From",swap:o,value:m})}),e.jsxs(h,{my:16,children:[e.jsx(oe,{children:"Type"}),e.jsx(W,{selectedType:p,setSelectedType:d})]}),e.jsx(h,{children:e.jsxs(te,{children:[e.jsx(se,{children:o?"From":"To"}),e.jsx($,{onSelect:c,selectedValue:n,topicId:t==null?void 0:t.ref_id})]})}),e.jsxs(J,{children:[e.jsx(ne,{children:e.jsx(G,{})}),e.jsx(ae,{onClick:x,children:e.jsx(H,{})}),e.jsx(ie,{children:e.jsx(R,{})})]})]})]})},J=l.div`
  position: absolute;
  top: 26px;
  bottom: 26px;
  left: 4px;
