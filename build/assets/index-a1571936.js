import{s as x,c as f,u as P,r as m,j as e,F as o,T as u,b as N,x as V,o as q,ad as J,g as Y,ae as S,d as H,a2 as K}from"./index-e90126f3.js";import{ak as Q,B as w,al as W,l as X,F as Z,am as ee}from"./react-toastify.esm-22f05de4.js";import{B as te}from"./index-81d4583b.js";import{n as y}from"./toastMessage-e329366a.js";import{a as C}from"./index-f5dd9e35.js";import{u as oe}from"./index-f78eda89.js";import{C as ne}from"./CheckIcon-1d361e8e.js";import{T as _}from"./index-5147f614.js";import{A as se}from"./index-58c815b4.js";import"./index.esm-0d3f0902.js";import"./InfoIcon-37b7ba25.js";import"./index-43c2b4f5.js";import"./Popover-7cee3222.js";import"./useSlotProps-45e36f47.js";import"./Select-31a37e50.js";import"./Stack-d3e9c50f.js";import"./Popper-20cbe04d.js";const ae=({onClick:n,loading:r})=>{const i=P(l=>l.budget),[c,p]=m.useState(10),a="node";return m.useEffect(()=>{(async()=>{try{const t=await W(a);p(t.data.price)}catch(t){console.error("cannot fetch",t)}})()},[a]),e.jsxs(o,{children:[e.jsx(o,{align:"center",direction:"row",justify:"space-between",mb:20,children:e.jsx(o,{align:"center",direction:"row",children:e.jsx(ce,{children:"Approve Cost"})})}),e.jsxs(o,{align:"center",direction:"row",justify:"space-between",mb:20,children:[e.jsxs(re,{children:[e.jsx("div",{className:"title",children:"COST"}),e.jsxs("div",{className:"value","data-testid":"check-price",children:[c," sats"]})]}),e.jsxs(ie,{children:[e.jsx("div",{className:"title",children:"BUDGET"}),e.jsxs("div",{className:"value",children:[Q(i)," sats"]})]})]}),e.jsx(o,{children:e.jsx(w,{color:"secondary","data-testid":"check-icon",disabled:r,onClick:n,size:"large",startIcon:e.jsx(ne,{}),type:"submit",variant:"contained",children:"Approve"})})]})},re=x(o).attrs({direction:"column",align:"space-between",justify:"flex-start"})`
  width: 141px;
  height: 61px;
