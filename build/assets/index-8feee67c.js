import{s as t,a as o,F as n,T as S,r as b,j as e,B as v,i as C,b as $,g as T,aQ as G,aR as k,aS as y,k as z,aT as w,aU as M,aV as R,a0 as j,aW as D}from"./index-92866164.js";import{e as A,h as I}from"./index-d2d5ee01.js";import{C as B}from"./ClipLoader-1643ba29.js";import{T as E,a as L}from"./Tabs-030fb10e.js";import"./createSvgIcon-f1fa1953.js";const V=()=>(A(I(a=>[a.graphStyle,a.setGraphStyle])),null);t(n).attrs({direction:"row",align:"center",justify:"space-between"})`
  width: 447px;
  height: 48px;
...
`,ce=()=>{const{close:a}=j("settings"),{visible:d}=j("addItem");return d?null:e.jsx(D,{background:"BG1",id:"settings",noWrap:!0,onClose:a,preventOutsideClose:!0,children:e.jsx(Z,{onClose:a})})};export{ce as SettingsModal};
