import{ba as z,Y as b,v as m,bb as k,R as j,bc as E,bd as L,f as u,h as d,x as N,r as f,j as e,F as n,be as M,T as y,bf as V,D as Y,B as W,b3 as q,bj as H,W as J,bi as K,P as Q,o as X,bh as ee}from"./index-f84c5caa.js";import{B as w,c as te,F as ne}from"./react-toastify.esm-dd7332df.js";import{B as se}from"./index-2eac630c.js";import{C as oe}from"./CheckIcon-94edf20b.js";import{T as _}from"./index-d9e6bbd2.js";import"./index.esm-90978199.js";import"./InfoIcon-200eb276.js";const B=/\btwitter\.com\/(?:@)?([\w_]+)(?:$|\?[^/]*$)/,re=/(https?:\/\/)?(www\.)?youtube\.com\/watch\?v=([A-Za-z0-9_-]+)/,ie=/(https?:\/\/)?(www\.)?youtube\.com\/live\/([A-Za-z0-9_-]+)/,ae=/https:\/\/twitter\.com\/i\/spaces\/([A-Za-z0-9_-]+)/,ce=/https:\/\/twitter\.com\/[^/]+\/status\/(\d+)/,de=/(https?:\/\/)?([A-Za-z0-9_-]+)\.mp3/,le=/(https?:\/\/)?(.*\.)?.+\/(feed|rss|rss.xml|.*.rss|.*\?(feed|format)=rss)$/,ue=/https?:\/\/(www\.)?youtube\.com\/(user\/)?(@)?([\w-]+)/,xe=/^(https?|ftp):\/\/[^\s/$.?#].[^\s]*$/,he=/https:\/\/twitter\.com\/i\/broadcasts\/([A-Za-z0-9_-]+)/;function fe(t){return[ie,he,re,ae,de].some(s=>s.test(t))?z:ue.test(t)?b:B.test(t)?m:ce.test(t)?k:le.test(t)?j:xe.test(t)?E:L}const we=(t,r="")=>{const a=(r===m?B:/@(\w+)/).exec(t);return a?a[1]:null},C=t=>!!t&&[m,b,j].includes(t),ge=({onClick:t,loading:r,type:s})=>{const a=N(i=>i.budget),[x,o]=f.useState(10),c=C(s)?"radar":"add_node";return f.useEffect(()=>{(async()=>{try{const l=await V(c);o(l.data.price)}catch(l){console.error("cannot fetch",l)}})()},[c]),e.jsxs(n,{children:[e.jsx(n,{align:"center",direction:"row",justify:"space-between",mb:20,children:e.jsx(n,{align:"center",direction:"row",children:e.jsx(be,{children:"Approve Cost"})})}),e.jsxs(n,{align:"center",direction:"row",justify:"space-between",mb:20,children:[e.jsxs(me,{children:[e.jsx("div",{className:"title",children:"COST"}),e.jsxs("div",{className:"value","data-testid":"check-price",children:[x," sats"]})]}),e.jsxs(pe,{children:[e.jsx("div",{className:"title",children:"BUDGET"}),e.jsxs("div",{className:"value",children:[M(a)," sats"]})]})]}),e.jsx(n,{children:e.jsx(w,{color:"secondary","data-testid":"check-icon",disabled:r,onClick:t,size:"large",startIcon:e.jsx(oe,{}),type:"submit",variant:"contained",children:"Approve"})})]})},me=u(n).attrs({direction:"column",align:"space-between",justify:"flex-start"})`
  width: 141px;
  height: 61px;
...
`,Z=async(t,r,s,a)=>{const x=C(s)?"radar":"add_node",o={};if(s===z)o.media_url=t.source,o.content_type="audio_video";else if(s===k){if(/(?:https?:\/\/)?(?:www\.)?twitter\.com\/\w+\/status\/\d+/s.test(t.source)){const l=/\/status\/(\d+)/,h=t.source.match(l);if(h!=null&&h[1]){const[,p]=h;o.tweet_id=p}}else o.tweet_id=t.source;o.content_type="tweet"}else if(s===E)o.content_type="webpage",o.web_page=t.source;else if(s===L)o.content_type="document",o.text=t.source;else if(s===m){const[,i]=(t.source||"").match(B)||[];if(i)o.source=i,o.source_type=s;else return}else(s===b||s===j)&&(o.source=t.source,o.source_type=s);t.latitude&&t.longitude&&(o.latitude=t.latitude,o.longitude=t.longitude);let c="";await H(async()=>{const i=await X.enable();o.pubkey=i==null?void 0:i.pubkey,c=await ee()});try{const i=await J.post(`/${x}`,JSON.stringify(o),{Authorization:c});if(i.error){const{message:l}=i.error;throw new Error(l)}r()}catch(i){i.status===402&&(await K(a),await Q(a),await Z(t,r,s,a)),i.status===400&&(await i.json(),r()),i instanceof Error&&r()}},Ue=()=>{const[t,r]=f.useState(0),{close:s,visible:a}=W("addContent"),[x]=N(v=>[v.setBudget]),o=te({mode:"onChange"}),{watch:c,setValue:i,reset:l}=o,[h,p]=f.useState(!1);f.useEffect(()=>()=>{r(0),l()},[a,l]);const g=c("inputType"),R=c("source"),I=c("longitude"),U=c("latitude"),A=c("source"),O=T(R);f.useEffect(()=>{i("inputType",fe(A))},[A,i]);const F=()=>{s()},S=()=>{r(t+1)},D=()=>{r(t-1)},G=o.handleSubmit(async v=>{p(!0);try{await Z(v,F,g,x)}catch{console.error(q)}finally{p(!1)}});return e.jsx(se,{id:"addContent",kind:"small",onClose:s,preventOutsideClose:!0,children:e.jsx(ne,{...o,children:e.jsxs("form",{id:"add-node-form",onSubmit:G,children:[t===0&&e.jsx(Ce,{allowNextStep:O,onNextStep:S,type:g}),t===1&&e.jsx(e.Fragment,{children:C(g)?e.jsx($e,{onNextStep:S,onPrevStep:D,type:g,value:R}):e.jsx(_e,{form:o,latitude:U,longitude:I,onNextStep:S})}),t===2&&e.jsx(ge,{loading:h,onClick:()=>null,type:g})]})})})};export{Ue as AddContentModal};
