import{r as o,j as e,s as f,g as v,F as j,o as Y,c as J,A as ae,p as ie,i as ce,q as le,H as pe,t as de,v as ue}from"./index-11b3d6c9.js";import{t as U,u as G,C as me}from"./index-5a04c2a6.js";import{U as fe}from"./index-01c2307a.js";import{u as M,a as he,b as ge,I as xe,c as K,d as ye}from"./index-bc719ac8.js";import{M as we,V as be}from"./index-76ac83ae.js";import{S as je,R as ve,s as V,M as Se}from"./index-2b7d81ae.js";import"./string-a277709d.js";import"./index-88d46c7a.js";import"./three.module-9722a9fc.js";import"./isPlainObject-15a76a63.js";import"./TextareaAutosize-f881e19a.js";import"./CheckIcon-4fa5db29.js";import"./index-02c807b3.js";import"./index-41891942.js";import"./index-09080cad.js";import"./ClipLoader-89d347a0.js";import"./clsx-02ac72d2.js";import"./SourcesTableIcon-21616e47.js";import"./DeleteNodeIcon-8589b4d2.js";import"./SoundIcon-af53df50.js";import"./SucessFeedBackIcon-45557d62.js";import"./Skeleton-87b9b181.js";import"./index-d2e0f83c.js";import"./Stack-17957c49.js";import"./FormControlLabel-ce74f9d3.js";import"./Typography-6d23f39f.js";import"./createSvgIcon-07cb4d49.js";const Q=o.memo(()=>{const r=M(s=>s.isPlaying),a=M(s=>s.setIsPlaying),n=M(s=>s.setVolume),t=M(s=>s.setPlaybackSpeed),c=M(s=>s.playbackSpeed),i=M(s=>s.playerRef),[d,g]=o.useState(!1),y=[.5,1,1.5,2],h=()=>{if(i){const s=i.getCurrentTime()-15;i.seekTo(s,"seconds")}},u=()=>{if(i){const s=i.getCurrentTime()+15;i.seekTo(s,"seconds")}},b=()=>{a(!r)},l=()=>{g(!d),n(d?1:0)},p=()=>{const m=(y.indexOf(c)+1)%y.length,P=y[m];if(t(P),i){const _=i.getInternalPlayer();_&&typeof _.playbackRate<"u"&&(_.playbackRate=P)}};return e.jsxs(ke,{children:[e.jsx(_e,{onClick:l,children:d?e.jsx(we,{}):e.jsx(be,{})}),e.jsx(Ie,{onClick:h,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(Ce,{"data-testid":"play-pause-button",onClick:b,size:"small",children:r?e.jsx(he,{"data-testid":"pause-icon"}):e.jsx(ge,{"data-testid":"play-icon"})}),e.jsx(Pe,{onClick:u,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(Te,{onClick:p,children:[c,"x"]})]})});Q.displayName="Controls";const ke=f(j).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${v.BG1};
  border-radius: 40px;
