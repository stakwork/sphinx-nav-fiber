import{s as i,F as n,T as g,j as e,b as w,c as p,r as A,u as B}from"./index-2dc20e7d.js";import{B as v}from"./index-bc676046.js";import{u as F}from"./index-f893b044.js";import{u as M,G as $,l as C,b,q as D,F as G}from"./react-toastify.esm-56d4c274.js";import{B as f,T as k,a as R}from"./index-a007b820.js";import{T as x}from"./index-ee192526.js";import{C as L}from"./ClipLoader-1a6edc53.js";import"./useSlotProps-dfe63508.js";import"./index.esm-67eceb68.js";import"./InfoIcon-925c8f4d.js";const P=({onClose:s})=>{const[a]=M(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",a),s()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
