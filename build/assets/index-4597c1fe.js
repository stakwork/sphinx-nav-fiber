import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-758a440b.js";import{B as M}from"./index-f6dd1ae3.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-47dc5d84.js";import{B as f,T as L,a as R}from"./index-04476a1d.js";import{T as x}from"./index-56df5078.js";import"./useSlotProps-15a3c690.js";import"./index.esm-9b32ee46.js";import"./InfoIcon-80b8d650.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
