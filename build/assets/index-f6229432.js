import{s as i,a as t,F as c,j as e,e as j,r as l,u as $,B as w,bt as C,bu as R,aY as I}from"./index-23df4f53.js";import{aH as z,h as D,m as E}from"./index-5c99801f.js";import{S as L}from"./Skeleton-e16ab60f.js";import{C as T}from"./ClipLoader-d3b2c7c9.js";const G=({nodeName:p})=>e.jsx(c,{children:e.jsxs(c,{align:"center",direction:"column",justify:"space-between",children:[e.jsx(A,{children:e.jsx(z,{})}),e.jsxs(M,{children:["Are you sure you want to delete ",p||"this item","?"]})]})}),M=i(c)`
  color: ${t.white};
  font-family: 'Barlow';
  font-size: 20px;
  font-weight: 400;
