import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-424b4312.js";import{B}from"./index-802ba261.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-ecfee1d0.js";import{B as f,T as $,a as k}from"./index-58f2a380.js";import{T as u}from"./index-e2daefe8.js";import"./useSlotProps-de1f26a0.js";import"./index.esm-43956ff5.js";import"./InfoIcon-ff1ffccb.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
