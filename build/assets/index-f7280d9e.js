import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,C as B,h as c,r as v,x as C}from"./index-f1afa603.js";import{B as F}from"./index-02757351.js";import{u as M}from"./index-98484c47.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-0d29ca0a.js";import{B as f,T as L,a as R}from"./index-067179a3.js";import{T as x}from"./index-147cd606.js";import"./useSlotProps-ebe611c3.js";import"./index.esm-de060844.js";import"./InfoIcon-cf868331.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
