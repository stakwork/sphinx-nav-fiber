import{s as r,F as n,T as g,j as e,B as b,b as w,c as p,r as A,u as B}from"./index-9bb53d68.js";import{B as v}from"./index-c441576c.js";import{u as F}from"./index-fd921116.js";import{u as M,l as $,b as f,q as C,F as D}from"./react-toastify.esm-4a8107b9.js";import{G}from"./index-a7919d25.js";import{T as x}from"./index-d304b412.js";import{C as k}from"./ClipLoader-ad7641ab.js";import{T as R,a as L}from"./Tabs-a6459233.js";import"./index.esm-bb054adf.js";import"./InfoIcon-114f7831.js";import"./useSlotProps-d348e93a.js";const P=({onClose:s})=>{const[a]=M(t=>[t.graphStyle]),i=()=>{localStorage.setItem("graphStyle",a),s()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(G,{}),e.jsx(n,{mt:308,children:e.jsx(b,{kind:"big",onClick:i,children:"Save changes"})})]})},V=r(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=r(g)`
