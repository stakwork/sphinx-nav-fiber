import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-a69a3f4c.js";import{B}from"./index-b1f9ac4d.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-a10ef41b.js";import{B as f,T as $,a as k}from"./index-fe61f9ee.js";import{T as u}from"./index-49d2f161.js";import"./useSlotProps-897fde8b.js";import"./index.esm-1210bfcf.js";import"./InfoIcon-1164b0f5.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
