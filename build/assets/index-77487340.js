import{aR as Ci,r as z,f as j,h as y,i as de,j as s,l as Ie,F as g,T as X,N as $t,k as pe,aS as cr,aT as Si,x as pr,o as vi,aU as Ei,O as Ti,a3 as fe,aV as fn,a1 as Ii,aW as xn,ac as _i,aX as Ai,I as Pi}from"./index-3d529579.js";import{k as zi,l as mt,A as we,B as ye,d as Li,I as hr,f as at,g as dr,m as ut,P as Ht,C as Vt,n as Bi,i as fr,b as Oi,S as Mi}from"./react-toastify.esm-78a3d92b.js";import{C as xr}from"./CheckIcon-e1b8fcd9.js";import{C as mr}from"./ChevronDownIcon-9b853df9.js";import{C as Ri}from"./ChevronUpIcon-3911cb0b.js";import{F as gr,a as Di,T as Fi}from"./Popover-05a88ac7.js";import{G as yr,L as Ut,B as Gt,H as Ni,M as $i,R as Hi,a as Vi,S as Ui,b as Gi,N as wr,C as Yi,D as Yt,c as br,d as qi,f as Wi,g as kr,e as Qi,P as Xi,h as jr,s as mn,V as Zi,F as Ki,E as Ji,i as eo,j as to,k as Cr,l as no}from"./ChevronRightIcon-c152fac4.js";import{S as ro}from"./index-268e9442.js";import{f as rt,o as Sr,P as vr,n as io,X as oo,Y as lo,T as so,D as ao,S as qt,q as Er}from"./generateCategoricalChart-53ed1737.js";import{T as Ne,I as uo,S as co,O as po}from"./index-87fed42d.js";import{S as ho}from"./Skeleton-d3401a28.js";import{f as fo,c as xo}from"./index.esm-857085de.js";import{I as mo}from"./InfoIcon-37ad32a2.js";import{P as go}from"./PlusIcon-d5a2fc08.js";import{u as At}from"./index-d711a7c6.js";import{B as yo}from"./index-fecb082c.js";import"./useSlotProps-222b5b1d.js";const wo=(e,t="down")=>{const n=Ci(),[r,i]=z.useState(!1),o=n.breakpoints[t](e).split("@media")[1].trim();return z.useEffect(()=>{const l=()=>{const{matches:a}=window.matchMedia(o);i(a)};return l(),window.addEventListener("resize",l),()=>window.removeEventListener("resize",l)},[o]),r},bo=e=>e.filter(t=>t.tldr).length>=2&&e.some(t=>t.audio_EN);function ko(e){return e.tldr_topic??e.name}var it=globalThis&&globalThis.__assign||function(){return it=Object.assign||function(e){for(var t,n=1,r=arguments.length;n<r;n++){t=arguments[n];for(var i in t)Object.prototype.hasOwnProperty.call(t,i)&&(e[i]=t[i])}return e},it.apply(this,arguments)},jo=globalThis&&globalThis.__rest||function(e,t){var n={};for(var r in e)Object.prototype.hasOwnProperty.call(e,r)&&t.indexOf(r)<0&&(n[r]=e[r]);if(e!=null&&typeof Object.getOwnPropertySymbols=="function")for(var i=0,r=Object.getOwnPropertySymbols(e);i<r.length;i++)t.indexOf(r[i])<0&&Object.prototype.propertyIsEnumerable.call(e,r[i])&&(n[r[i]]=e[r[i]]);return n},Co=zi("BeatLoader","50% {transform: scale(0.75);opacity: 0.2} 100% {transform: scale(1);opacity: 1}","beat");function So(e){var t=e.loading,n=t===void 0?!0:t,r=e.color,i=r===void 0?"#000000":r,o=e.speedMultiplier,l=o===void 0?1:o,a=e.cssOverride,u=a===void 0?{}:a,c=e.size,p=c===void 0?15:c,d=e.margin,x=d===void 0?2:d,h=jo(e,["loading","color","speedMultiplier","cssOverride","size","margin"]),w=it({display:"inherit"},u),b=function(E){return{display:"inline-block",backgroundColor:i,width:mt(p),height:mt(p),margin:mt(x),borderRadius:"100%",animation:"".concat(Co," ").concat(.7/l,"s ").concat(E%2?"0s":"".concat(.35/l,"s")," infinite linear"),animationFillMode:"both"}};return n?z.createElement("span",it({style:w},h),z.createElement("span",{style:b(1)}),z.createElement("span",{style:b(2)}),z.createElement("span",{style:b(3)})):null}const vo=()=>{var p;const[e,t]=z.useState(null),{sidebarFilter:n,setSidebarFilter:r,sidebarFilterCounts:i}=de(d=>d),o=((p=i.find(d=>d.name===n))==null?void 0:p.count)||0,l=d=>d?d.charAt(0).toUpperCase()+d.slice(1):"",a=d=>{t(d.currentTarget)},u=()=>{t(null)},c=d=>{r(d),u()};return s.jsxs("div",{children:[s.jsxs(Eo,{onClick:a,children:[s.jsx("div",{className:"text",children:"Show"}),s.jsx("div",{className:"value","data-testid":"value",children:`${l(n)} (${o})`}),s.jsx("div",{className:"icon",children:e?s.jsx(Ri,{}):s.jsx(mr,{})})]}),s.jsx(Io,{anchorEl:e,anchorOrigin:{vertical:"bottom",horizontal:"left"},anchorPosition:{top:62,left:0},onClose:u,open:!!e,transformOrigin:{vertical:"top",horizontal:"left"},children:s.jsx(gr,{children:i.map(({name:d,count:x})=>s.jsxs(To,{className:Ie({active:d===n}),onClick:()=>c(d),children:[s.jsx("span",{className:"icon",children:d===n?s.jsx(xr,{}):null}),s.jsx("span",{children:`${l(d)} (${x})`})]},d))})})]})},Eo=j(g).attrs({direction:"row",align:"center"})`
  cursor: pointer;
  flex-grow: 1;
  color: ${y.GRAY6};
  font-family: Barlow;
...
`,Tr=({boostCount:e,date:t,episodeTitle:n,isSelectedView:r=!1,imageUrl:i,showTitle:o,type:l,text:a,name:u,sourceLink:c,verified:p=!1,twitterHandle:d,className:x="episode-wrapper",onClick:h})=>{const w=l==="show"?o:n,b=l==="show"?"":o,E=["tweet","person","guest","topic","document"],k=l==="youtube"?"video":"audio";return l?s.jsx(Wo,{className:x,onClick:h,children:E.includes(l)?s.jsxs(s.Fragment,{children:[l==="topic"&&s.jsxs(Qo,{children:[s.jsx(Ni,{}),s.jsx("p",{children:b})]}),["person","guest"].includes(l)&&s.jsx(No,{imageUrl:i,name:u||"",title:o||""}),["image"].includes(l)&&s.jsx(Bo,{imageUrl:c,name:u||""}),l==="tweet"&&s.jsx(Vo,{date:t,imageUrl:i,name:u||"",text:a||"",twitterHandle:d,verified:p}),l==="document"&&s.jsx(Ro,{sourceLink:c||"",text:a||"",type:l})]}):s.jsxs(g,{align:"center",direction:"row",justify:"center",children:[!r&&s.jsx(g,{align:"center",pr:16,children:s.jsx(we,{size:80,src:i||`${k}_default.svg`,type:l||""})}),s.jsxs(g,{grow:1,shrink:1,children:[s.jsxs(g,{align:"center",direction:"row",justify:"space-between",children:[s.jsx(g,{align:"center",direction:"row",children:l&&s.jsx(Ne,{type:l})}),l==="youtube"&&c?s.jsx(Zo,{href:`${c}${c.includes("?")?"&":"?"}open=system`,onClick:S=>S.stopPropagation(),target:"_blank",children:s.jsx(Ut,{})}):null]}),u&&s.jsx(Pt,{"data-testid":"episode-name",children:u}),s.jsx(Pt,{"data-testid":"episode-description",children:w}),s.jsxs(g,{align:"center",direction:"row",justify:"flex-start",children:[!!t&&s.jsx(ct,{children:$t.unix(t).fromNow()}),!!b&&s.jsx(Xo,{children:b}),!r&&e>0&&s.jsx(g,{style:{marginLeft:"auto"},children:s.jsx(Gt,{amt:e})})]})]})]})}):null},Pt=j(g)`
  font-family: Barlow;
  font-size: 13px;
  font-style: normal;
  font-weight: 400;
...
`,Zo=j.a`
  ...
  font-size: 16px;
  height: 16px;
`,Ko=({isSearchResult:e})=>{const t=z.useRef(null),n=e?80:10,{setSelectedNode:r,setSelectedTimestamp:i}=de(k=>k),{currentSearch:o,setSidebarOpen:l,setRelevanceSelected:a}=pe(k=>k),[u,c]=z.useState(0),p=cr(),x=u*n+n,h=p&&p.length>0?p.length-1>x:!1,w=wo("sm","down"),b=z.useCallback(k=>{Si(k),i(k),a(!0),r(k),w&&l(!1)},[r,a,l,i,w]),E=z.useMemo(()=>{if(p){const k=[...p].sort((S,I)=>(I.date||0)-(S.date||0));return o&&k.sort((S,I)=>{const O=S.node_type==="topic"&&S.name.toLowerCase()===o.toLowerCase()?1:0;return(I.node_type==="topic"&&I.name.toLowerCase()===o.toLowerCase()?1:0)-O}),k.slice(0,x)}return[]},[p,o,x]);return s.jsx(s.Fragment,{children:s.jsxs(Lo,{ref:t,id:"search-result-list",shrink:1,children:[(E??[]).map((k,S)=>{const{image_url:I,date:O,boost:L,type:v,episode_title:D,show_title:q,node_type:N,text:V,source_link:_,link:P,name:H,verified:Y=!1,twitter_handle:F}=k||{};return s.jsx(Tr,{boostCount:L||0,date:O||0,episodeTitle:rt(D),imageUrl:I||"",link:P,name:H||"",onClick:()=>{b(k)},showTitle:rt(q),sourceLink:_,text:V||"",twitterHandle:F,type:N||v,verified:Y},S.toString())}),s.jsx(el,{align:"center",background:"BG1",direction:"row",justify:"center",children:h&&s.jsx(ye,{onClick:()=>{h&&c(u+1)},size:"medium",children:"Load More"})})]})})},Jo=z.memo(Ko),el=j(g)`
  flex: 0 0 86px;
...
`;const al=48,ul=8,cl={PaperProps:{style:{maxHeight:al*4.5+ul,width:250}}},pl=["Beginner","Intermediate","Advanced","Expert"],hl=()=>{const e=de(S=>S.data),[t,n]=z.useState(""),[r,i]=z.useState("Beginner"),o=pe(S=>S.currentSearch),l=Li(),[a]=pr(S=>[S.setBudget]),[u,c,p,d,x]=Sr(S=>[S.askedQuestions,S.askedQuestionsAnswers,S.setAskedQuestion,S.setAskedQuestionAnswer,S.hasQuestionInProgress]),h=z.useCallback(S=>{d(S.answer)},[d]);z.useEffect(()=>{l&&h&&l.on("askquestionhook",h)},[h,l]);const w=async()=>{t&&(p(t),n(""));try{const S=e==null?void 0:e.nodes.filter(L=>L.text),I=S==null?void 0:S.slice(0,5),O=(I!=null&&I.length?I.map(L=>L.text).join(" "):"").substring(0,2500).replace(/[?&=+/#]/g,L=>`\\${L}`);o&&(await vi.enable(),await Ei({expertise_level:r,question_text:t,search_term:o,transcripts:O},a),await Ti(a))}catch(S){console.error(S)}},b=r&&t.trim()&&!x,E=S=>{i(S.target.value)},k=async S=>{if(x){S.preventDefault();return}S.keyCode===13&&S.shiftKey===!1&&b&&(S.preventDefault(),w())};return s.jsxs(dl,{children:[s.jsx(g,{children:s.jsx(g,{children:s.jsxs(gr,{component:"div",children:[s.jsx(xl,{id:"select-label",size:"small",children:"Expertise level"}),s.jsx(ml,{id:"demo-multiple-name",input:s.jsx(po,{label:"Expertise level"}),labelId:"select-label",MenuProps:cl,onChange:E,size:"small",value:r,children:pl.map(S=>s.jsx($i,{component:"li",value:S,children:S},S))})]})})}),s.jsx(wl,{children:u==null?void 0:u.map((S,I)=>s.jsxs(g,{className:"response",py:12,children:[s.jsx(X,{kind:"medium",children:S}),s.jsx(g,{py:12,children:(c==null?void 0:c[I])!==void 0?s.jsx(X,{color:"unreadMsgText",children:c[I]}):s.jsxs(g,{align:"center",py:12,children:[s.jsx(g,{align:"center",py:12,children:s.jsx(vr,{color:y.white})}),s.jsx(g,{align:"center",py:12,children:s.jsx(X,{children:"Generating response"})})]})})]},S))}),s.jsxs(gl,{onKeyDown:k,py:12,tabIndex:-1,children:[s.jsx(fl,{disabled:x,onChange:S=>n(S.target.value),placeholder:"Enter your question",value:t}),s.jsx(yl,{children:s.jsx(fo,{color:b?y.white:y.gray300,size:"18"})})]})]})},dl=j.div`
  margin-top: 20px;
`,fl=j(Fi)`
...
`,Al=({stateless:e,node:t})=>{var w;const[n,r]=pe(b=>[b.transcriptIsOpen,b.setTranscriptOpen]),[i,o]=z.useState(!1),[l,a]=z.useState(""),[u,c]=z.useState(!1);if(!e&&!n)return null;const p=async()=>{try{const b=await fn(t==null?void 0:t.ref_id);a(b.data.text)}catch(b){console.error("Error fetching full transcript",b)}},d=async()=>{if(l===""){const b=await fn(t==null?void 0:t.ref_id);h(b.data.text)}else h(l);setTimeout(()=>{o(!1)},2e3)},x=async()=>{u?c(!1):(await p(),c(!0))},h=b=>{b!==void 0&&(navigator.clipboard.writeText(b),o(!0))};return s.jsxs(g,{grow:1,shrink:1,children:[s.jsxs(zl,{children:[e&&s.jsxs(Pl,{children:[s.jsx("div",{className:"icon",children:s.jsx(wr,{})}),s.jsx("div",{className:"title",children:"Transcript"})]}),t!=null&&t.text?s.jsx(s.Fragment,{children:i?s.jsxs(Ol,{align:"center",direction:"row",justify:"flex-start",children:[s.jsx("div",{className:"icon",children:s.jsx(xr,{})}),s.jsx("div",{className:"text",children:"Copied"})]}):s.jsx(ye,{endIcon:s.jsx(Yi,{}),onPointerDown:()=>d(),size:"small",variant:"outlined",children:"Copy"})}):s.jsx("div",{}),!e&&s.jsx(Ll,{onClick:()=>{r(!1)},children:s.jsx(xo,{fontSize:35})})]}),s.jsxs(Bl,{children:[u?l:`${(w=t==null?void 0:t.text)==null?void 0:w.substring(0,100)}`,s.jsxs(_l,{onClick:x,children:["... ",u?"show less":"more"]})]})]})},Pl=j(g).attrs({direction:"row",align:"center"})`
  .icon {
    font-size: 16px;
    color: ${y.GRAY3};
    margin-right: 7px;
...
`,Ir=({node:e})=>{const t=de(b=>b.selectedNode),n=pe(b=>b.currentSearch),{link:r,image_url:i,date:o,boost:l,node_type:a,type:u,id:c,show_title:p,episode_title:d,ref_id:x}=e||t||{},[h,w]=z.useState(l||0);return z.useEffect(()=>{w(l??0)},[l]),!e&&!t?null:s.jsx("div",{style:{overflow:"auto",flex:1,width:"100%"},children:s.jsxs(Ml,{children:[s.jsx(Dl,{boostCount:h||0,date:o||0,episodeTitle:rt(d),imageUrl:i,isSelectedView:!0,link:r,onClick:()=>null,showTitle:p,type:a||u}),s.jsx(yt,{}),s.jsxs(Rl,{children:[s.jsx(Gt,{amt:h}),s.jsx(br,{content:e||t,count:h,refId:x,updateCount:w})]}),s.jsx(yt,{}),s.jsx(yn,{children:s.jsx(El,{node:e||t,searchTerm:n,stateless:!0})}),((t==null?void 0:t.text)||(e==null?void 0:e.text))&&s.jsxs(s.Fragment,{children:[s.jsx(yt,{}),s.jsx(yn,{children:s.jsx(Al,{node:e||t,stateless:!0},c)})]})]})})},Ml=j(g)`
  flex: 1;
  min-height: 100%;
  flex-direction: column;
...
`,Os=j(Yt)`
  margin: auto 0px 2px 0px;
  opacity: 0.75;
`,Ms=()=>{var a,u;const[e,t]=z.useState(!1),n=fe(),r=!!(n!=null&&n.source_link),i=z.useRef(null),o=pe(c=>c.currentSearch),l=c=>{c.stopPropagation(),c.currentTarget.blur(),t(!e)};return z.useEffect(()=>{var c,p;e?(c=i.current)==null||c.play():(p=i.current)==null||p.pause()},[e]),s.jsxs(g,{align:"flex-start",basis:"100%",direction:"column",grow:1,justify:"center",pt:r?62:0,shrink:1,children:[r&&s.jsxs(Rs,{children:[s.jsx(yr,{color:y.GRAY6}),s.jsx(Ns,{children:n==null?void 0:n.source_link}),s.jsx(Ds,{href:`${n==null?void 0:n.source_link}?open=system`,onClick:c=>c.stopPropagation(),target:"_blank",children:s.jsx(Ut,{})})]}),(a=n==null?void 0:n.audio)!=null&&a.length?s.jsxs(g,{justify:"flex-start",p:12,children:[s.jsx(ye,{onClick:c=>l(c),startIcon:e?s.jsx(ut,{}):s.jsx(Ht,{}),children:e?"Pause":"Play"}),s.jsx($s,{ref:i,src:((u=n.audio[0])==null?void 0:u.link)||"",children:s.jsx("track",{kind:"captions"})})]}):null,s.jsx(Fs,{grow:1,justify:"flex-start",p:12,shrink:1,children:s.jsx(X,{color:"primaryText1",kind:"regular",children:pt((n==null?void 0:n.text)||"",o)})})]})},Rs=j(g)`
  top: 0px;
  position: absolute;
...
`,Ks=({hidden:e})=>{var m,oe;const t=z.useRef(null),n=z.useRef(null),[r,i]=z.useState(!1),[o,l]=z.useState(!1),[a,u]=z.useState(!1),[c,p]=z.useState("ready"),{isPlaying:d,playingTime:x,duration:h,setIsPlaying:w,setPlayingTime:b,setDuration:E,playingNode:k,volume:S,setVolume:I,setHasError:O,resetPlayer:L,isSeeking:v,setIsSeeking:D}=at(Z=>Z),q=((m=k==null?void 0:k.link)==null?void 0:m.includes("youtube"))||((oe=k==null?void 0:k.link)==null?void 0:oe.includes("youtu.be"));z.useEffect(()=>()=>L(),[L]),z.useEffect(()=>{v&&t.current&&(t.current.seekTo(x,"seconds"),D(!1))},[x,v,D]);const N=()=>{w(!d)},V=()=>{w(!0)},_=()=>{w(!1)},P=(Z,f)=>{const ne=Array.isArray(f)?f[0]:f;t.current&&(t.current.seekTo(ne),b(ne))},H=(Z,f)=>{const ne=Array.isArray(f)?f[0]:f;I(ne)},Y=()=>{O(!0),p("error")},F=Z=>{if(!v){const f=Z.playedSeconds;b(f)}},te=()=>{if(t.current){p("ready");const Z=t.current.getDuration();E(Z)}},J=()=>{n.current&&(document.fullscreenElement?(document.exitFullscreen(),setTimeout(()=>l(!1),300)):n.current.requestFullscreen().then(()=>{document.addEventListener("fullscreenchange",re)}))},re=()=>{l(!!document.fullscreenElement),document.removeEventListener("fullscreenchange",re)};z.useEffect(()=>()=>{document.removeEventListener("fullscreenchange",re)}),z.useEffect(()=>{const Z=f=>{if(o){const ne=window.screen.height,Ce=f.clientY,ee=ne-Ce;u(ee<=50)}};return document.addEventListener("mousemove",Z),()=>{document.removeEventListener("mousemove",Z)}},[o,a]),z.useEffect(()=>{const Z=f=>{o&&f.key==="Escape"?(f.preventDefault(),f.stopPropagation()):r&&f.key===" "&&(f.preventDefault(),N())};return document.addEventListener("fullscreenchange",re),document.addEventListener("keydown",Z),()=>{document.removeEventListener("fullscreenchange",re),document.removeEventListener("keydown",Z)}});const me=()=>{N()};return k!=null&&k.link?s.jsxs(Js,{ref:n,hidden:e,onBlur:()=>i(!1),onFocus:()=>i(!0),tabIndex:0,children:[s.jsx(ea,{isFullScreen:o,children:s.jsx(we,{size:120,src:(k==null?void 0:k.image_url)||"",type:"clip"})}),s.jsx(ra,{onClick:me,children:s.jsx(eo,{ref:t,controls:!1,height:o?window.screen.height:"200px",onBuffer:()=>p("buffering"),onBufferEnd:()=>p("ready"),onError:Y,onPause:_,onPlay:V,onProgress:F,onReady:te,playing:d,url:(k==null?void 0:k.link)||"",volume:S,width:"100%"})}),c==="error"?s.jsx(na,{className:"error-wrapper",children:"Error happened, please try later"}):null,c==="ready"?s.jsx(Gs,{duration:h,handleProgressChange:P,handleVolumeChange:H,isFullScreen:o,isPlaying:d,onFullScreenClick:J,playingTime:x,setIsPlaying:N,showToolbar:a&&o}):null,c==="buffering"&&!q?s.jsx(ta,{isFullScreen:o,children:s.jsx(Vt,{color:y.lightGray})}):null]}):null},Js=j(g)`
...
`,Wh=j(g)`
  ...
  gap: 10px;
`,Qh=["Drivechain","Ordinals","L402","Nostr","AI"],Xh=({onSubmit:e})=>{var V;const{open:t}=At("addContent"),[n,r]=z.useState(!1),[i,o]=z.useState(!1),[l,a]=z.useState(null),u=z.useRef(null),[c,p]=z.useState(0),[d,x]=z.useState(!1),{currentPlayingAudio:h,setCurrentPlayingAudio:w}=pe(_=>_),{open:b}=At("briefDescription"),{trendingTopics:E,setTrendingTopics:k}=de(_=>_),{setValue:S}=fr(),I=z.useCallback(async()=>{r(!0),o(!1),p(0),x(!1),w(null);try{const _=await Ai();_.length&&Array.isArray(_)&&k(_)}catch{k(Qh.map(P=>({name:P,count:0})))}finally{r(!1)}},[w,k]);z.useEffect(()=>{E.length||I()},[I,E.length]),z.useEffect(()=>{const _=setTimeout(()=>{o(!0)},5e3);return()=>clearTimeout(_)},[o,n]);const O=_=>{S("search",_),e==null||e()},L=(_,P)=>{_.stopPropagation(),_.currentTarget.blur(),P!=null&&P.tldr&&(a(P),b())},v=()=>{a(null)},D=_=>{_.stopPropagation(),_.currentTarget.blur(),x(!d),w(u)};z.useEffect(()=>{var _,P;d?(_=u.current)==null||_.play():(P=u.current)==null||P.pause()},[c,d]),z.useEffect(()=>{h||x(!1)},[h]);const q=()=>{p(_=>{var H,Y;let P=(_+1)%E.length;for(;P!==_&&!((H=E[P])!=null&&H.audio_EN);)P=(P+1)%E.length;return P===_?(x(!1),P):((Y=u.current)==null||Y.load(),P===0&&(x(!1),p(0)),P)}),w(u)},N=n?"Loading":"No new trending topics in the last 24 hours";return s.jsxs(Kh,{"data-testid":"trending-component",children:[s.jsxs("div",{children:[s.jsxs("div",{className:"heading-container",children:[s.jsxs("div",{className:"heading",children:[s.jsx("span",{className:"heading__title",children:"Trending Topics"}),s.jsx("span",{className:"heading__icon",children:n?s.jsx(Vt,{color:y.white,size:16}):s.jsx(s.Fragment,{children:i?s.jsx(e0,{onClick:I,size:"small",startIcon:s.jsx(da,{})}):s.jsx(fa,{})})})]}),bo(E)?s.jsxs("div",{children:[s.jsx(ye,{onClick:_=>D(_),startIcon:d?s.jsx(ut,{}):s.jsx(Ht,{}),children:d?"Pause":"Play All"}),s.jsx(r0,{ref:u,onEnded:q,src:(V=E[c])==null?void 0:V.audio_EN,children:s.jsx("track",{kind:"captions"})})]}):null]}),E.length===0?s.jsxs("div",{className:"trending-empty",children:[s.jsx(Jh,{children:N}),s.jsx(ye,{color:"secondary",disabled:n,onClick:t,size:"medium",startIcon:s.jsx(go,{}),sx:{alignSelf:"flex-end",m:"0 36px 16px 0"},variant:"contained",children:"Add Content"})]}):s.jsx("ul",{className:"list",children:E.map((_,P)=>s.jsxs(g,{align:"center",className:"list-item",direction:"row",justify:"space-between",onClick:()=>O(_.name),children:[s.jsxs(Zh,{children:[s.jsx(n0,{children:s.jsx(ha,{})}),s.jsx("span",{className:"tldr",children:ko(_)})]}),_.tldr&&s.jsx(t0,{className:Ie({isPlaying:c===P&&d}),onClick:H=>L(H,_),children:"TLDR"})]},_.name))})]}),l&&s.jsx(Vh,{onClose:v,selectTrending:O,trend:l})]})},Zh=j.div`
  display: flex;
  align-items: center;
  width: 300px;
