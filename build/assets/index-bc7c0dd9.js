import{s as r,F as n,T as g,j as e,h as w,b as c,r as A,g as B}from"./index-18fc0e43.js";import{B as v}from"./index-428c84a1.js";import{u as F}from"./index-11a400fc.js";import{e as M,X as $,t as C,h as b,z as D,F as k,C as G}from"./react-toastify.esm-179563aa.js";import{B as f,T as R,a as z}from"./index-0c7683a2.js";import{T as x}from"./index-c6eb3db0.js";import"./useSlotProps-31dd494b.js";import"./index.esm-f623dcff.js";import"./InfoIcon-1c22d78e.js";const L=({onClose:s})=>{const[a]=M(t=>[t.graphStyle]),i=()=>{localStorage.setItem("graphStyle",a),s()};return e.jsxs(P,{direction:"column",children:[e.jsx(V,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:i,children:"Save changes"})})]})},P=r(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,V=r(g)`
