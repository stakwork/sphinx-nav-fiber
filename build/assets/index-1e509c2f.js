import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h as x,r as T,x as v,B as m}from"./index-eba3c070.js";import{B}from"./index-ef5a61f0.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-5ea62688.js";import{B as f,T as $,a as k}from"./index-dd77d757.js";import{T as u}from"./index-674965d1.js";import"./useSlotProps-914bfc12.js";import"./index.esm-343c86ec.js";import"./InfoIcon-9f631892.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
