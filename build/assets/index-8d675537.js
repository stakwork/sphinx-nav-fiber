import{r as n,j as e,s as m,g as T,F as S,o as K,c as U,A as ae,p as ce,i as le,q as pe,H as de,t as ue,v as fe,f as q}from"./index-a5e35926.js";import{Universe as me}from"./index-1bb478b5.js";import{u as he}from"./index-25e48ca2.js";import{u as W,a as ge,b as xe,I as ye,c as Q,d as V}from"./index-977a2ab4.js";import{M as be,V as we}from"./VolumeIcon-89044c41.js";import{S as je,R as ve,s as X,M as Se}from"./index-bfb79f00.js";import"./index-b7a308d5.js";import"./VisibilityOn-af30551e.js";import"./SourcesTableIcon-6623308a.js";import"./NodeCircleIcon-554343da.js";import"./CheckIcon-5fa204f8.js";import"./DeleteNodeIcon-a7f6a5b8.js";import"./EditNodeIcon-4818eef6.js";import"./SearchIcon-7822f52a.js";import"./SoundIcon-066c9962.js";import"./SucessFeedBackIcon-1124b582.js";import"./three.module-4d3d7244.js";import"./TextareaAutosize-33bfb0cf.js";import"./index-6c4eb6ff.js";import"./index-05ab3ac9.js";import"./index-fb26e04d.js";import"./ClipLoader-bf9e964c.js";import"./Skeleton-28c3d9cb.js";import"./Stack-0d5f9a05.js";import"./index-6003aaec.js";import"./FormControlLabel-b8266572.js";import"./Typography-f9944dc2.js";import"./createSvgIcon-9dc430af.js";import"./isPlainObject-00bf8cba.js";function D(r){const[i,t,s]=r.split(":").map(Number);return Number((i*60*60*1e3+t*60*1e3+s*1e3).toFixed(6))}const Z=n.memo(()=>{const r=W(a=>a.isPlaying),i=W(a=>a.setIsPlaying),t=W(a=>a.setVolume),s=W(a=>a.setPlaybackSpeed),c=W(a=>a.playbackSpeed),o=W(a=>a.playerRef),[x,b]=n.useState(!1),h=[.5,1,1.5,2],g=()=>{if(o){const a=o.getCurrentTime()-15;o.seekTo(a,"seconds")}},p=()=>{if(o){const a=o.getCurrentTime()+15;o.seekTo(a,"seconds")}},j=()=>{i(!r)},d=()=>{b(!x),t(x?1:0)},f=()=>{const I=(h.indexOf(c)+1)%h.length,F=h[I];if(s(F),o){const P=o.getInternalPlayer();P&&typeof P.playbackRate<"u"&&(P.playbackRate=F)}};return e.jsxs(ke,{children:[e.jsx(Pe,{onClick:d,children:x?e.jsx(be,{}):e.jsx(we,{})}),e.jsx(Te,{onClick:g,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(Ce,{"data-testid":"play-pause-button",onClick:j,size:"small",children:r?e.jsx(ge,{"data-testid":"pause-icon"}):e.jsx(xe,{"data-testid":"play-icon"})}),e.jsx(Ie,{onClick:p,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(_e,{onClick:f,children:[c,"x"]})]})});Z.displayName="Controls";const ke=m(S).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${T.BG1};
  border-radius: 40px;
...
`,Le=m.div`
  ...
  width: 100%;
  cursor: pointer;
`,Oe=n.memo(ze),ie=n.forwardRef(({active:r,start:i,text:t},s)=>e.jsxs(qe,{ref:s,className:ce({active:r}),children:[e.jsx(Xe,{children:i}),e.jsx(Ye,{children:e.jsx("span",{children:t})})]}));ie.displayName="ParagraphComponent";const Y=n.memo(ie,(r,i)=>r.active===i.active),qe=m(S)`
  flex-direction: row;
