import{o as s,F as o,T as w,p as C,r as f,j as e,q as c,A as S,aU as A,aV as b,aW as z,J as D,O as y}from"./index-1a3014d2.js";import{B as G}from"./index-a6236c2f.js";import{G as M,B as v,i as $,F as B}from"./index-945bc2fb.js";import{C as T}from"./ClipLoader-536b1b65.js";import{T as j}from"./index-d0ca765c.js";import{S as E}from"./index-dbc29f05.js";import{e as I}from"./index.esm-084fbb7c.js";import{T as k,a as F}from"./Tabs-34159b45.js";import"./InfoIcon-a9d0c663.js";import"./useSlotProps-84737601.js";import"./createSvgIcon-f7803a9c.js";const R=({onClose:a})=>{const[l]=C(d=>[d.graphStyle]),[r,i]=f.useState(!1),p=()=>{i(!0),localStorage.setItem("graphStyle",l),i(!1),a()};return e.jsxs(W,{direction:"column",children:[e.jsx(V,{children:"Default graph view:"}),e.jsx(M,{}),e.jsx(o,{mt:308,py:24,children:e.jsx(v,{color:"secondary",disabled:r,id:"add-node-submit-cta",onClick:p,size:"large",startIcon:r&&e.jsx(L,{children:e.jsx(T,{color:c.lightGray,size:12})}),type:"submit",variant:"contained",children:"Save Changes"})})]})},W=s(o)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,V=s(w)`
