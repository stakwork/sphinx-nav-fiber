import{Q as v,S as q,a5 as P,U as r,r as u,j as e,ar as H,bC as U,a4 as J,a1 as $,bD as Q,ad as R,bA as z,am as K,bF as X}from"./index-ec59f7fb.js";import{ad as V,aE as G,aJ as Z,B as _,aO as W,ae as N,aF as ee,af as te}from"./index-633c2c46.js";import{p as Y}from"./index-bbc7c996.js";import{c as ne}from"./index-64f1c910.js";import"./three.module-a2e04964.js";const re=({handleSelectType:i,skipToStep:x,nodeType:d,selectedValues:n})=>{const[h,w]=u.useState(!1),[f,C]=u.useState(),{watch:j,formState:{isValid:t}}=V();u.useEffect(()=>{(async()=>{w(!0);const b=await U(d),m=Y(b);C(m),w(!1)})()},[d,j]);const a=o=>o.charAt(0).toUpperCase()+o.slice(1).replace(/_/g," "),c=(f?[...f].sort((o,b)=>o.required&&!b.required?-1:!o.required&&b.required?1:0):[]).filter(o=>!!(o.required&&!Object.values(n).includes(o.key))),S=()=>{i(""),x("sourceType")};return e.jsxs(r,{children:[e.jsx(r,{align:"center",direction:"row",justify:"space-between",mb:18,children:e.jsx(r,{align:"center",direction:"row",children:e.jsx(oe,{children:"Required Properties"})})}),e.jsx(ae,{children:h?e.jsx(r,{style:{margin:"auto"},children:e.jsx(G,{color:q.SECONDARY_BLUE})}):e.jsx(r,{className:"input__wrapper",children:c==null?void 0:c.map(({key:o,required:b})=>e.jsx(e.Fragment,{children:e.jsxs(se,{children:[e.jsx(P,{children:a(o)}),e.jsx(Z,{id:"item-name",maxLength:50,name:o,placeholder:b?"Required":"Optional",rules:{...b?H:{}}})]})}))})}),e.jsxs(r,{direction:"row",children:[e.jsx(r,{grow:1,children:e.jsx(_,{color:"secondary",onClick:S,size:"large",variant:"contained",children:"Prev"})}),e.jsx(r,{grow:1,ml:20,children:e.jsx(_,{color:"secondary",disabled:!t||h||(c==null?void 0:c.some(o=>o.required&&!j(o.key))),onClick:()=>x("createConfirmation"),size:"large",variant:"contained",children:"Next"})})]})]})},oe=v(P)`
  font-size: 22px;
  font-weight: 600;
  font-family: 'Barlow';
`,ae=v(r)`
