import{s as i,g as t,F as c,j as e,a6 as j,r as l,c as C,B as w,by as S,bA as R,b1 as D}from"./index-c4bc7e2e.js";import{g as I,e as T}from"./index-8d72ccbc.js";import{D as z}from"./DeleteNodeIcon-97f08559.js";import{S as E}from"./Skeleton-db8268cb.js";import{C as L}from"./ClipLoader-cad81fde.js";const A=({nodeName:p})=>e.jsx(c,{children:e.jsxs(c,{align:"center",direction:"column",justify:"space-between",children:[e.jsx(G,{children:e.jsx(z,{})}),e.jsxs(M,{children:["Are you sure you want to delete ",p||"this item","?"]})]})}),M=i(c)`
  color: ${t.white};
  font-family: 'Barlow';
  font-size: 20px;
  font-weight: 400;
