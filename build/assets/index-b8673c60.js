import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-71fbded9.js";import{B as F}from"./index-a1e92b5b.js";import{u as M}from"./index-c71f9105.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-1475a827.js";import{B as f,T as R,a as L}from"./index-9a160b66.js";import{T as x}from"./index-7ea2b210.js";import"./useSlotProps-d302defd.js";import"./index.esm-a636ab2b.js";import"./InfoIcon-f2602cc1.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
