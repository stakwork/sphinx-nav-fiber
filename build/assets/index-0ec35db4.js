import{aa as Z,o as g,q as b,F as t,T,J as V,r as y,j as e,b1 as ee,b2 as te,aV as F,b8 as se,C as ne,b9 as oe,O as D,B as re,p as ie,b3 as I,ac as ae,ab as ce,b6 as le}from"./index-369c6756.js";import{B as C,g as de,h as pe,F as me}from"./index-46d6ff89.js";import{B as xe}from"./index-e220f2d2.js";import{S as ue}from"./index-7829aeae.js";import{e as he}from"./index.esm-1761dbdb.js";import{C as fe}from"./CheckIcon-2e515dea.js";import{C as J}from"./ClipLoader-575b4d56.js";import{n as z,A as ye,O as ge,i as je}from"./index-80b931f2.js";import{p as q}from"./index-44e303ef.js";import{T as L}from"./index-e5f6dda4.js";import{c as we}from"./index-64f1c910.js";import"./index-cc2c25d9.js";import"./Stack-55af056d.js";import"./useSlotProps-a1a7d336.js";import"./Popover-81ea9630.js";import"./createSvgIcon-e09467d4.js";import"./TextareaAutosize-b70a046e.js";import"./three.module-2ce81f73.js";import"./InfoIcon-853ba6bc.js";const be=async(o,a,c="")=>await Z.post(`/${o}`,JSON.stringify(a),{Authorization:c}),Se=async(o,a,c,x,d,r)=>{const m=o==="Create custom type"?"schema":"node",l={node_data:{...a,...o==="Image"&&{source_link:c}},node_type:o,name:x,pubkey:r};return be(m,l,d)},Ne=({onClick:o,loading:a,error:c})=>{const x=V(l=>l.budget),[d,r]=y.useState(10),m="node";return y.useEffect(()=>{(async()=>{try{const h=await te(m);r(h.data.price)}catch(h){console.error("cannot fetch",h)}})()},[m]),e.jsxs(t,{children:[e.jsx(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:e.jsx(t,{align:"center",direction:"row",children:e.jsx(ke,{children:"Approve Cost"})})}),e.jsxs(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:[e.jsxs(Te,{children:[e.jsx("div",{className:"title",children:"COST"}),e.jsxs("div",{className:"value","data-testid":"check-price",children:[d," sats"]})]}),e.jsxs(Ce,{children:[e.jsx("div",{className:"title",children:"BUDGET"}),e.jsxs("div",{className:"value",children:[ee(x)," sats"]})]})]}),e.jsx(t,{children:e.jsx(C,{color:"secondary","data-testid":"check-icon",disabled:a||!!c,onClick:o,size:"large",startIcon:a?e.jsx(R,{children:e.jsx(J,{color:b.lightGray,size:12})}):e.jsxs(R,{children:[" ",e.jsx(fe,{})]}),type:"submit",variant:"contained",children:"Approve"})}),c?e.jsx(Be,{children:e.jsxs(ve,{children:[e.jsx(he,{className:"errorIcon"}),e.jsx("span",{children:c})]})}):null]})},Te=g(t).attrs({direction:"column",align:"space-between",justify:"flex-start"})`
  width: 141px;
  height: 61px;
