import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-7f2e3c8a.js";import{B as F}from"./index-cb40dcd6.js";import{u as M}from"./index-b0a85b9b.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-899feea8.js";import{B as f,T as R,a as L}from"./index-8a0e2410.js";import{T as x}from"./index-30d9dcd9.js";import"./useSlotProps-dc10645e.js";import"./index.esm-464f5136.js";import"./InfoIcon-6a7dd9f7.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
