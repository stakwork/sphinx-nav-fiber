import{f as d,h as l,T as B,j as e,F as a,C as w,r as n,a3 as V,z as $,D as A}from"./index-23e00704.js";import{B as P}from"./index-fb2d0926.js";import{u as g}from"./index-02104d30.js";import{c as q,F as G,B as E,C as H}from"./react-toastify.esm-6044d8e4.js";import{T as S}from"./index-452f3baf.js";import{S as O}from"./Skeleton-bba82538.js";import"./index.esm-29183c01.js";import"./InfoIcon-2a2697d9.js";const _=/^https:\/\/.*\.(png|jpg|svg)$/;function C(s){return!!_.test(s)}const W=({isValidImageUrl:s})=>e.jsxs(a,{children:[e.jsx(a,{align:"center",direction:"row",justify:"space-between",mb:18,children:e.jsx(a,{align:"center",direction:"row",children:e.jsx(Y,{children:"Edit Node"})})}),e.jsxs(a,{mb:18,children:[e.jsx(T,{style:{marginBottom:8},children:"Node Name"}),e.jsx(S,{id:"cy-topic",maxLength:50,name:"topic",placeholder:"Node name",rules:{...w}})]}),e.jsxs(a,{mb:36,children:[e.jsx(T,{style:{marginBottom:8},children:"image_url"}),e.jsx(S,{id:"cy-image_url",maxLength:500,name:"image_url",placeholder:"image_url",rules:{...w,...s?{}:{pattern:{message:"Please enter a valid URL",value:_},validate:{source:C}}}})]})]}),Y=d(B)`
  font-size: 22px;
  font-weight: 600;
  font-family: 'Barlow';
`,T=d(B)`
