...
`,ar=v.lazy(()=>Re(()=>import("./index-f7242a56.js"),["assets/index-f7242a56.js","assets/index-60f01453.js","assets/index-b4d03b7b.css","assets/index-d9e6ec60.js","assets/SourcesTableIcon-897d7622.js","assets/index-204e5ada.js","assets/CheckIcon-fece7859.js","assets/DeleteNodeIcon-9e106e27.js","assets/SoundIcon-a91554cc.js","assets/SucessFeedBackIcon-89e68ba8.js","assets/ClipLoader-153af8d2.js","assets/TableRow-2f1217f2.js"]).then(({TweetAnalyze:e})=>({default:e}))),sr=()=>{const e=$(o=>o.setSelectedTweet),t=$(o=>o.selectedTweet),{tweetId:a}=ge(),[r,n]=v.useState(""),{open:i}=$e("tweetAnalyze"),l=(a==null?void 0:a.split("&"))||[],c=o=>{i(),n(o)};return s.jsxs(cr,{align:"stretch",basis:"100%",grow:1,shrink:1,children:[l.length>1?s.jsx(or,{onClick:()=>{c("summary")},children:"Summary Report"}):null,l.map(o=>s.jsx(lr,{className:t===o?"selected":"",onClick:()=>e(o),children:s.jsx(Ut,{handleAnalyzeClick:()=>{c(o)},nodeId:o})},o)),s.jsx(ar,{tweetId:r})]})},or=f.button`
  width: 100%;
  background: ${y.ANALYTICS_CARD_BG};
  color: ${y.white};
  padding: 16px 16px;
