import{r as n,j as e,s as f,g as T,F as S,o as K,c as U,A as ae,p as ce,i as le,q as pe,H as de,t as ue,v as fe,f as q}from"./index-16f8189c.js";import{Universe as me}from"./index-6da7b7b4.js";import{a as W,b as he,c as ge,I as xe,d as Q,e as V,u as ye}from"./index-64a0193c.js";import{M as be,V as we}from"./VolumeIcon-5e01bfa1.js";import{S as je,R as ve,s as X,M as Se}from"./index-653a0856.js";import"./index-f3a2b3e9.js";import"./VisibilityOn-16deb1bb.js";import"./SourcesTableIcon-f3c3dd9b.js";import"./NodeCircleIcon-c675266e.js";import"./CheckIcon-11e7bd8b.js";import"./DeleteNodeIcon-f3ddf2e3.js";import"./EditNodeIcon-6e17cb86.js";import"./SearchIcon-ee5dd0bc.js";import"./SoundIcon-aa2350a7.js";import"./SucessFeedBackIcon-e147d4d4.js";import"./three.module-1c1ec8b9.js";import"./TextareaAutosize-e742d46c.js";import"./index-ac0a920c.js";import"./index-838c4cb4.js";import"./index-172ec90d.js";import"./ClipLoader-e9aea057.js";import"./Skeleton-9e640441.js";import"./Stack-4b481127.js";import"./index-ae4d0e1c.js";import"./FormControlLabel-b361164d.js";import"./Typography-18010304.js";import"./createSvgIcon-25611775.js";import"./isPlainObject-a35cead7.js";function D(t){const[i,s,r]=t.split(":").map(Number);return Number((i*60*60*1e3+s*60*1e3+r*1e3).toFixed(6))}const Z=n.memo(()=>{const t=W(a=>a.isPlaying),i=W(a=>a.setIsPlaying),s=W(a=>a.setVolume),r=W(a=>a.setPlaybackSpeed),c=W(a=>a.playbackSpeed),o=W(a=>a.playerRef),[x,b]=n.useState(!1),m=[.5,1,1.5,2],g=()=>{if(o){const a=o.getCurrentTime()-15;o.seekTo(a,"seconds")}},p=()=>{if(o){const a=o.getCurrentTime()+15;o.seekTo(a,"seconds")}},j=()=>{i(!t)},d=()=>{b(!x),s(x?1:0)},h=()=>{const I=(m.indexOf(c)+1)%m.length,F=m[I];if(r(F),o){const P=o.getInternalPlayer();P&&typeof P.playbackRate<"u"&&(P.playbackRate=F)}};return e.jsxs(ke,{children:[e.jsx(Pe,{onClick:d,children:x?e.jsx(be,{}):e.jsx(we,{})}),e.jsx(Te,{onClick:g,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(Ce,{"data-testid":"play-pause-button",onClick:j,size:"small",children:t?e.jsx(he,{"data-testid":"pause-icon"}):e.jsx(ge,{"data-testid":"play-icon"})}),e.jsx(Ie,{onClick:p,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(_e,{onClick:h,children:[c,"x"]})]})});Z.displayName="Controls";const ke=f(S).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${T.BG1};
  border-radius: 40px;
