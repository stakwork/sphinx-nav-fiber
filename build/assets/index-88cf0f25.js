import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-aa76214e.js";import{B as F}from"./index-0ff3ebae.js";import{u as M}from"./index-5a27753a.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-983de2b3.js";import{B as f,T as R,a as L}from"./index-d11487ff.js";import{T as x}from"./index-d368ba67.js";import"./useSlotProps-f7ca023e.js";import"./index.esm-816c4a04.js";import"./InfoIcon-19456e74.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
