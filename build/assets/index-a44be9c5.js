import{Y as i,X as s,Z as b,j as e,ab as x,a0 as d,r as A,a1 as v}from"./index-d3758f34.js";import{aA as M,ct as $,cu as j,cv as B,aK as y,cw as D,cx as k,cy as h,aR as C,cz as F,cA as G,u as L,co as R}from"./index-23497f02.js";const z=({onClose:a})=>{const[n]=M(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",n),a()};return e.jsxs(P,{direction:"column",children:[e.jsx(V,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(s,{mt:308,children:e.jsx(j,{kind:"big",onClick:r,children:"Save changes"})})]})},P=i(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,V=i(b)`
