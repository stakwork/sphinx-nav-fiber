import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-ed80bd96.js";import{B}from"./index-c51e0ecb.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-5f8b7feb.js";import{B as f,T as $,a as k}from"./index-32999536.js";import{T as u}from"./index-2560aa4e.js";import"./useSlotProps-69db817a.js";import"./index.esm-7e88b758.js";import"./InfoIcon-401223be.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
