import{s as r,F as n,T as g,j as e,h as w,b as c,r as A,g as B}from"./index-411fe9a5.js";import{B as v}from"./index-f40006ff.js";import{u as F}from"./index-5cc32178.js";import{u as M,U as $,q as C,e as b,x as D,F as k,C as G}from"./react-toastify.esm-650aec5d.js";import{B as f,T as R,a as L}from"./index-23f4836a.js";import{T as x}from"./index-c81ffe9a.js";import"./useSlotProps-7dd44e72.js";import"./index.esm-6ff8d86e.js";import"./InfoIcon-796e7b8c.js";const P=({onClose:s})=>{const[a]=M(t=>[t.graphStyle]),i=()=>{localStorage.setItem("graphStyle",a),s()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:i,children:"Save changes"})})]})},V=r(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=r(g)`
