import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-3d723af8.js";import{B}from"./index-32c35bfc.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-0038a851.js";import{B as f,T as $,a as k}from"./index-9f45e01e.js";import{T as u}from"./index-e7b4a9f5.js";import"./useSlotProps-ef742437.js";import"./index.esm-94a3931d.js";import"./InfoIcon-1cf069e7.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
