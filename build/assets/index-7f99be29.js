import{s as a,a as r,F as n,j as e,a5 as B,T as S,r as b,B as v,t as I,k as $,b as T,aT as k,aU as A,N as y,w as z,aV as w,aW as M,aX as D,e as j,aY as E}from"./index-45c6190d.js";import{j as C,t as R,aB as L,aC as W,n as P,aD as V,aE as F}from"./index-4de90dc3.js";import{C as G}from"./ClipLoader-348c26ec.js";import{T as U,a as N}from"./Tabs-de4899f3.js";import"./createSvgIcon-6652d33b.js";const Y={split:e.jsx(W,{}),force:e.jsx(P,{}),sphere:e.jsx(V,{}),earth:e.jsx(F,{})},O=()=>{const[i,c]=C(R(t=>[t.graphStyle,t.setGraphStyle])),l=t=>{c(t)};return e.jsx(_,{direction:"column",children:L.map(t=>e.jsx(n,{className:B("icon",{active:i===t}),onClick:()=>l(t),children:Y[t]},t))})},_=a(n).attrs({direction:"row",align:"center",justify:"space-between"})`
  width: 447px;
  height: 48px;
...
`,H=({onClose:i})=>{const[c]=C(x=>[x.graphStyle]),[l,t]=b.useState(!1),p=()=>{t(!0),localStorage.setItem("graphStyle",c),t(!1),i()};return e.jsxs(q,{direction:"column",children:[e.jsx(K,{children:"Default graph view:"}),e.jsx(O,{}),e.jsx(n,{mt:308,py:8,children:e.jsx(v,{color:"secondary",disabled:l,id:"add-node-submit-cta",onClick:p,size:"large",startIcon:l&&e.jsx(X,{children:e.jsx(G,{color:r.lightGray,size:12})}),type:"submit",variant:"contained",children:"Save Changes"})})]})},q=a(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,K=a(S)`
...
`,ye=()=>{const{close:i}=j("settings"),{visible:c}=j("addItem");return c?null:e.jsx(E,{background:"BG1",id:"settings",noWrap:!0,onClose:i,preventOutsideClose:!0,children:e.jsx(re,{onClose:i})})};export{ye as SettingsModal};
