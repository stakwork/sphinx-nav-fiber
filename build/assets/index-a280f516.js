import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-3e4e4e52.js";import{B}from"./index-170b92a0.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-b9a6c99a.js";import{B as f,T as $,a as k}from"./index-5fe28467.js";import{T as u}from"./index-755b85d5.js";import"./useSlotProps-21fc0095.js";import"./index.esm-dab760fc.js";import"./InfoIcon-cd13b5d8.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
