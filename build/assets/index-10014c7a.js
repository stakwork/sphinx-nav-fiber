import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-3e4e4e52.js";import{B as M}from"./index-170b92a0.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-b9a6c99a.js";import{B as f,T as L,a as R}from"./index-5fe28467.js";import{T as x}from"./index-755b85d5.js";import"./useSlotProps-21fc0095.js";import"./index.esm-dab760fc.js";import"./InfoIcon-cd13b5d8.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
