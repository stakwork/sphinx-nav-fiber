import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,x as D,B as F}from"./index-eba3c070.js";import{B as M}from"./index-ef5a61f0.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-5ea62688.js";import{B as f,T as L,a as R}from"./index-dd77d757.js";import{T as x}from"./index-674965d1.js";import"./useSlotProps-914bfc12.js";import"./index.esm-343c86ec.js";import"./InfoIcon-9f631892.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
