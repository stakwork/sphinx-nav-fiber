import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-6e53b845.js";import{B as M}from"./index-1641e3f9.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-6f404510.js";import{B as f,T as L,a as R}from"./index-2ed6b8a3.js";import{T as x}from"./index-08ed1ddf.js";import"./useSlotProps-c04af8a9.js";import"./index.esm-6d9dcba1.js";import"./InfoIcon-975a9ea1.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
