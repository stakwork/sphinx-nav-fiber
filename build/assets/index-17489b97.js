import{s as o,g as p,T as N,B as F,F as h,r as f,j as e,N as de,D as B,bo as Je,ao as H,R as Q,c as Z,bp as et,bq as tt,ar as st,br as nt,bs as ze,p as X,bt as Ee,an as pe,b6 as je,b7 as be,b8 as ye,bu as ot,bv as rt,am as it,bw as at,a as Be,C as V,bx as lt,bm as Ae,by as Fe,l as xe,b5 as J,n as he,bz as ct,b2 as dt,b3 as pt,bA as ee,bB as xt,b as ht,k as ut,a8 as ft}from"./index-b5ecf585.js";import{y as gt,c as mt,z as le,J as jt,d as bt,f as Me,K as Oe,O as Re,Q as We,U as yt,W as wt,X as Ct,Y as we,Z as Ce,a as ve,_ as oe,$ as vt,b as St}from"./index-df73ba4d.js";import{T as Tt,a as R,b as De,M as te,c as $t}from"./TableRow-1d0714db.js";import{T as Se,s as W,a as Pe,S as Ge,A as ue,E as kt,D as _t,b as Ye,Q as Ue,V as Ve,c as Nt}from"./constants-02a492f1.js";import{C as I}from"./ClipLoader-ebec20fb.js";import{P as fe,I as U,z as It}from"./index-37d766d2.js";import{I as Lt,A as ge,T as He}from"./index-d5fa04ed.js";import{u as L}from"./index-edd776a9.js";import{C as qe}from"./CheckIcon-397d6076.js";import{T as Te}from"./Typography-27aca46d.js";import{T as zt,a as Et}from"./Tabs-51b7a5cf.js";import"./SourcesTableIcon-76623bd8.js";import"./DeleteNodeIcon-294007fa.js";import"./SoundIcon-6d509bc3.js";import"./SucessFeedBackIcon-04cd4db4.js";import"./Stack-ff6a6a00.js";import"./clsx-6afd75e8.js";import"./createSvgIcon-84909391.js";import"./TextareaAutosize-43932985.js";function ce(t){const n=new Date(Number(t)*1e3),i=n.getFullYear(),a=(1+n.getMonth()).toString().padStart(2,"0");return`${n.getDate().toString().padStart(2,"0")}/${a}/${i}`}const g=o(Tt)`
  && {
    color: ${p.white};
    border: none;
...
`,Jt=o.div`
  margin-right: 40px;
`,es=()=>{const[t,n]=f.useState(!0),[i,a]=f.useState(""),[c,x]=Z(l=>[l.queuedSources,l.setQueuedSources]);f.useEffect(()=>{(async()=>{n(!0);try{const u=await Ee({approved:"False"});x(u.data)}catch(u){console.warn(u)}finally{n(!1)}})()},[x]);const r=l=>{a(i===l||!l?"":l)},s=c==null?void 0:c.filter(l=>!i||l.source_type===i);return e.jsxs(ts,{align:"stretch",direction:"column",justify:"flex-end",children:[e.jsxs(me,{align:"flex-start",justify:"space-between",children:[e.jsx(N,{className:"title",children:"Queued Sources"}),e.jsx(N,{className:"subtitle",children:"This is a queue of pending sources waiting for approval or denial from graph users. If you think a source will provide good content for the graph, you can pay to approve it. Think of this as an investment: you pay to add it to the source table, and if the content is popular you will earn from it. If content is not relevant to the graph, you should deny it."})]}),e.jsxs(h,{className:"filters",direction:"row",pb:16,px:36,children:[e.jsx(K,{className:X({selected:!i}),onClick:()=>r(""),size:"small",children:"All"}),Object.keys(W).map(l=>e.jsx(K,{className:X({selected:l===i}),onClick:()=>r(l),size:"small",children:W[l]},l))]}),e.jsx(ss,{align:"center",justify:t?"center":"flex-start",children:t?e.jsx(I,{color:p.white}):e.jsx(Zt,{data:s})})]})},ts=o(h)`
  flex: 1;
...
`,Ks=o.span`
  margin-top: 2px;
`,Zs=({topic:t,onClick:n,onSearch:i,checkedStates:a,setCheckedStates:c,isMuteDisabled:x})=>{const[r,s]=L(k=>[k.ids,k.total]),[l,u]=f.useState(!1),[j,d]=f.useState(!1),m=ce(t.date_added_to_graph),b=async(k,C)=>{u(!0);try{await ee(k,{node_type:t==null?void 0:t.node_type,node_data:{is_muted:C}}),L.setState({ids:r.filter(_=>_!==k),total:s-1})}catch(_){console.warn(_)}},y=k=>{c(C=>({...C,[k]:!C[k]}))},w=(k,C)=>{var _;(_=window.getSelection())!=null&&_.toString()?k.preventDefault():i(C.name)},v=t.edgeList.slice(0,1),T=t.edgeList.length-v.length,[$,D]=Q.useState(null),P=k=>{D(k.currentTarget),d(!0)},z=()=>{d(!1)},M=!!$&&j,E=a[t.ref_id]?"visible":"";return e.jsxs(se,{className:a[t.ref_id]?"checked":"",children:[e.jsx(g,{children:e.jsx(tn,{className:`checkbox-section ${E}`,"data-testid":"topic-check-box",onClick:()=>y(t.ref_id),children:e.jsx(sn,{checked:a[t.ref_id],children:e.jsx(nn,{children:a[t.ref_id]&&e.jsx(qe,{})})})})}),e.jsx(g,{onClick:k=>w(k,t),children:e.jsx(en,{children:t.name})}),e.jsx(g,{children:t.node_type}),e.jsx(g,{children:e.jsx(on,{children:t.edgeCount})}),e.jsxs(g,{children:[e.jsx(fe,{anchorEl:$,anchorOrigin:{vertical:"top",horizontal:"center"},disableRestoreFocus:!0,id:"mouse-over-popover",onClose:z,onMouseEnter:()=>d(!0),onMouseLeave:z,open:M,sx:{pointerEvents:"auto","& .MuiPaper-root":{backgroundColor:"rgba(0, 0, 0, 0.9)",borderRadius:"4px",width:"160px",maxHeight:"200px",overflowY:"scroll"}},transformOrigin:{vertical:"bottom",horizontal:"center"},children:e.jsx(Te,{sx:{p:1.5,fontSize:"13px",fontWeight:400,lineHeight:"1.8",wordWrap:"break-word"},children:t.edgeList.join(", ")})}),v.join(", "),T>0&&e.jsx(Te,{"aria-haspopup":"true","aria-owns":M?"mouse-over-popover":void 0,component:"span",onMouseEnter:P,onMouseLeave:z,sx:{cursor:"pointer"},children:",..."})]}),e.jsx(g,{children:e.jsx("span",{children:m})}),e.jsx(g,{className:"cell-center",children:e.jsx(h,{direction:"row",justify:"space-between",children:e.jsx("div",{className:"approve-wrapper",children:l?e.jsx(Js,{children:e.jsx(I,{color:p.white,size:16})}):e.jsxs(h,{direction:"row",children:[t.is_muted?e.jsx(U,{className:"centered",disabled:x,onClick:()=>b(t.ref_id,!1),children:e.jsx(yt,{})}):e.jsx(U,{className:"centered",disabled:x,onClick:()=>b(t.ref_id,!0),children:e.jsx(wt,{})}),e.jsx(U,{disabled:x,onClick:k=>n(k,t.ref_id),children:e.jsx(Ct,{"data-testid":"ThreeDotsIcons"})})]})})})})]},t.name)},Js=o.span`
  margin-left: 12px;
`,en=o.span`
  cursor: pointer;
  :hover {
...
`,gn=o.div`
  ...
  align-items: center;
  justify-content: center;
`,mn=()=>{const[t,n,i,a,c,x,r,s]=L(C=>[C.data,C.ids,C.total,C.setTopics,C.filters,C.setFilters,C.terminate,C.loading]),{open:l}=B("editTopic"),{open:u}=B("mergeTopic"),{open:j}=B("addEdge"),[d,m]=f.useState(null),[b,y]=f.useState([]),[w,v]=f.useState({}),T={editTopic:l,mergeTopic:u,addEdge:j},$=f.useRef([]);f.useEffect(()=>{n.length&&($.current=n)},[n]),f.useEffect(()=>{(async()=>{try{await a()}catch{console.error("err")}})()},[a,c]);const D=async()=>{x({page:c.page+1})};f.useEffect(()=>()=>{r()},[r]);const P=C=>{x({sortBy:C})},z=()=>{m(null),y([])},M=async(C,_)=>{try{await ee(C,{node_data:{is_muted:_==="mute"}}),L.setState({ids:n.filter(A=>A!==C),total:i-1})}catch(A){console.warn(A)}},E=async(C,_)=>{if(t)if(_==="mergeTopic")if(Object.values(w).filter(A=>A).length>0){const A=Object.entries(w).filter(([,S])=>S).map(([S])=>t[S]);y(A),u()}else y([t[C]]),m(t[C]),u();else["mute","unMute"].includes(_)&&await M(C,_),typeof T[_]=="function"&&T[_](),m(t[C])},k=C=>{x({...c,search:C})};return e.jsxs(e.Fragment,{children:[e.jsxs(jn,{direction:"column",justify:"flex-end",children:[e.jsx(me,{align:"flex-start",direction:"row",justify:"space-between",children:e.jsx(N,{className:"title",children:"Topics"})}),e.jsx(yn,{"data-testid":"topic-search-container",children:e.jsx(Xe,{activeIcon:e.jsx(V,{}),defaultIcon:e.jsx(Me,{}),loading:s,loadingIcon:e.jsx(I,{color:p.lightGray,size:24}),onSearch:k,placeholder:"Search ..."})}),e.jsxs(bn,{align:"center",justify:s&&!t?"center":"flex-start",children:[e.jsx(an,{checkedStates:w,loading:s,onChangeFilter:P,onTopicEdit:E,setCheckedStates:v,setShowMuteUnmute:()=>x({is_muted:!c.is_muted}),showMuted:c.is_muted}),i>n.length?e.jsxs(F,{className:"load-more",disabled:s,onClick:D,children:["Load more",s&&e.jsx(I,{color:p.lightGray,size:10})]}):null]})]}),b.length>0&&e.jsx(Qs,{multiTopics:b,onClose:z}),d&&e.jsx(Bs,{onClose:z,topic:d}),d&&e.jsx(Ns,{onClose:z,topic:d})]})},jn=o(h)`
  flex: 1;
...
`,yn=o(h)`
  margin: 0 0 16px 36px;
`,wn=[{label:Ve,component:Pt},{label:Nt,component:xs},{label:Ue,component:es},{label:Ye,component:mn}],Cn=t=>{const{children:n,value:i,index:a,...c}=t;return i===a?e.jsx(kn,{"aria-labelledby":`simple-tab-${a}`,hidden:i!==a,id:`simple-tabpanel-${a}`,role:"tabpanel",...c,children:n}):null};function vn(t){return{id:`simple-tab-${t}`,"aria-controls":`simple-tabpanel-${t}`}}const Sn=()=>{const[t,n]=f.useState(0),[i]=Be(s=>[s.isAdmin]),[a]=ut(s=>[s.queuedSourcesFeatureFlag]),c=ft(),x=(s,l)=>{n(l)},r=wn.filter(({label:s})=>s===Ye?i:s===Ue?i&&a:s===Ve?c:!0);return e.jsxs(_n,{"data-testid":"sources-table",direction:"column",children:[e.jsx(Tn,{"aria-label":"sources tabs",onChange:x,value:t,children:r.map((s,l)=>e.jsx($n,{color:p.white,disableRipple:!0,label:s.label,...vn(l)},s.label))}),r.map((s,l)=>e.jsx(Cn,{index:l,value:t,children:e.jsx(s.component,{})},s.label))]})},Tn=o(zt)`
  && {
