import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-f83c07d7.js";import{B as M}from"./index-f421e98d.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-e027ecdc.js";import{B as f,T as L,a as R}from"./index-65bec831.js";import{T as x}from"./index-9c815080.js";import"./useSlotProps-5ba61589.js";import"./index.esm-e0dc085e.js";import"./InfoIcon-5d651515.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
