import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,x as D,B as F}from"./index-a51c1203.js";import{B as M}from"./index-ef995c38.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-8f6319a9.js";import{B as f,T as L,a as R}from"./index-0335a7a4.js";import{T as x}from"./index-af0e9ad5.js";import"./useSlotProps-505825b2.js";import"./index.esm-f2605fed.js";import"./InfoIcon-806a9320.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
