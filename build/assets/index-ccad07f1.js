import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,x as D,B as F}from"./index-dae18a7b.js";import{B as M}from"./index-4459d726.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-b2fbd024.js";import{B as f,T as L,a as R}from"./index-fef36e51.js";import{T as x}from"./index-97d901c2.js";import"./useSlotProps-25d62d1d.js";import"./index.esm-f388d3bf.js";import"./InfoIcon-4b1a98c3.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
