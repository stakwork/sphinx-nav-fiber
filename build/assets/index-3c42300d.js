import{s as r,F as n,T as g,j as e,h as w,b as c,r as A,g as B}from"./index-1ee61b3a.js";import{B as v}from"./index-6761adb5.js";import{u as F}from"./index-2c4ca382.js";import{e as M,X as $,t as C,h as b,z as D,F as k,C as G}from"./react-toastify.esm-72d67069.js";import{B as f,T as R,a as z}from"./index-86ec57ed.js";import{T as x}from"./index-a7f34ac7.js";import"./useSlotProps-6cdee9a7.js";import"./index.esm-00343a7f.js";import"./InfoIcon-99f0cb4c.js";const L=({onClose:s})=>{const[a]=M(t=>[t.graphStyle]),i=()=>{localStorage.setItem("graphStyle",a),s()};return e.jsxs(P,{direction:"column",children:[e.jsx(V,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:i,children:"Save changes"})})]})},P=r(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,V=r(g)`
