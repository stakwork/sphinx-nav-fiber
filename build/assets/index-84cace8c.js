import{aT as R,Y as S,v as b,aU as P,R as $,aV as U,aW as D,f as u,h as l,x as Z,r as f,j as e,F as o,aX as X,T as y,aY as J,D as K,B as Q,aZ as h,X as ee,o as te,a_ as se,a$ as oe,W as ne,b0 as ie,P as re}from"./index-dae18a7b.js";import{B as w,C as ae,c as le,F as ce}from"./react-toastify.esm-b2fbd024.js";import{B as de}from"./index-4459d726.js";import{S as ue}from"./index-acece642.js";import{i as xe}from"./index.esm-f388d3bf.js";import{C as pe}from"./CheckIcon-9542b389.js";import{T as k}from"./index-97d901c2.js";import"./InfoIcon-4b1a98c3.js";const C=/\btwitter\.com\/(?:@)?([\w_]+)(?:$|\?[^/]*$)/,fe=/(https?:\/\/)?(www\.)?youtube\.com\/watch\?v=([A-Za-z0-9_-]+)/,ge=/(https?:\/\/)?(www\.)?youtube\.com\/live\/([A-Za-z0-9_-]+)/,he=/(https?:\/\/)?(www\.)?youtu\.be\/([A-Za-z0-9_-]+)/,we=/https:\/\/twitter\.com\/i\/spaces\/([A-Za-z0-9_-]+)/,me=/https:\/\/twitter\.com\/[^/]+\/status\/(\d+)/,be=/(https?:\/\/)?([A-Za-z0-9_-]+)\.mp3/,ye=/(https?:\/\/)?(.*\.)?.+\/(feed|rss|rss.xml|.*.rss|.*\?(feed|format)=rss)$/,je=/https?:\/\/(www\.)?youtube\.com\/(user\/)?(@)?([\w-]+)/,ve=/^(https?|ftp):\/\/[^\s/$.?#].[^\s]*$/,Se=/https:\/\/twitter\.com\/i\/broadcasts\/([A-Za-z0-9_-]+)/;function $e(t){return[ge,Se,fe,he,we,be].some(i=>i.test(t))?R:je.test(t)?S:C.test(t)?b:me.test(t)?P:ye.test(t)?$:ve.test(t)?U:D}const _e=(t,s="")=>{const r=(s===b?C:/@(\w+)/).exec(t);return r?r[1]:null},A=t=>!!t&&[b,S,$].includes(t),Ee=({onClick:t,loading:s,type:i,error:r})=>{const n=Z(d=>d.budget),[p,c]=f.useState(10),a=A(i)?"radar":"add_node";return f.useEffect(()=>{(async()=>{try{const x=await J(a);c(x.data.price)}catch(x){console.error("cannot fetch",x)}})()},[a]),e.jsxs(o,{children:[e.jsx(o,{align:"center",direction:"row",justify:"space-between",mb:20,children:e.jsx(o,{align:"center",direction:"row",children:e.jsx(ke,{children:"Approve Cost"})})}),e.jsxs(o,{align:"center",direction:"row",justify:"space-between",mb:20,children:[e.jsxs(ze,{children:[e.jsx("div",{className:"title",children:"COST"}),e.jsxs("div",{className:"value","data-testid":"check-price",children:[p," sats"]})]}),e.jsxs(Be,{children:[e.jsx("div",{className:"title",children:"BUDGET"}),e.jsxs("div",{className:"value",children:[X(n)," sats"]})]})]}),e.jsx(o,{children:e.jsx(w,{color:"secondary","data-testid":"check-icon",disabled:s||!!r,onClick:t,size:"large",startIcon:s?e.jsx(ae,{size:24}):e.jsx(pe,{}),type:"submit",variant:"contained",children:"Approve"})}),r?e.jsxs(Ce,{role:"tooltip",children:[e.jsxs(Re,{children:[e.jsx(xe,{fontSize:13}),e.jsx("span",{children:r})]}),e.jsx("div",{className:"tooltip",children:r})]}):null]})},ze=u(o).attrs({direction:"column",align:"space-between",justify:"flex-start"})`
  width: 141px;
  height: 61px;
