import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-8690fe0c.js";import{B as F}from"./index-54bcbd0c.js";import{u as M}from"./index-055a6337.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-b81c55df.js";import{B as f,T as R,a as L}from"./index-8df13ef2.js";import{T as x}from"./index-9fe8c5dc.js";import"./useSlotProps-fa42cffd.js";import"./index.esm-062e4fc4.js";import"./InfoIcon-25e3eb52.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
