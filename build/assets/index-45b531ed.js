import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-d939ea8c.js";import{B}from"./index-7bef8ad5.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-cf8782e0.js";import{B as f,T as $,a as k}from"./index-134efb9a.js";import{T as u}from"./index-6fe2dc08.js";import"./useSlotProps-e80d3e5c.js";import"./index.esm-289835b5.js";import"./InfoIcon-d7130bbb.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
