...
`,zr=({boostCount:e,date:t,episodeTitle:n,isSelectedView:r=!1,imageUrl:i,showTitle:o,type:l,text:a,name:c,sourceLink:u,verified:h=!1,twitterHandle:d,className:f="episode-wrapper",onClick:p})=>{const g=l==="show"?o:n,k=l==="show"?"":o,T=["tweet","person","guest","topic","document"];return l?s.jsx(ml,{className:f,onClick:p,children:T.includes(l)?s.jsxs(s.Fragment,{children:[l==="topic"&&s.jsxs(gl,{children:[s.jsx(Hi,{}),s.jsx("p",{children:k})]}),["person","guest"].includes(l)&&s.jsx(al,{imageUrl:i,name:c||"",title:o||""}),["image"].includes(l)&&s.jsx(nl,{imageUrl:u,name:c||""}),l==="tweet"&&s.jsx(pl,{date:t,imageUrl:i,name:c||"",text:a||"",twitterHandle:d,verified:h}),l==="document"&&s.jsx(ol,{sourceLink:u||"",text:a||"",type:l})]}):s.jsxs(w,{align:"center",direction:"row",justify:"center",children:[!r&&i&&s.jsx(w,{align:"center",pr:16,children:s.jsx(be,{size:80,src:i,type:l||""})}),s.jsxs(w,{grow:1,shrink:1,children:[s.jsxs(w,{align:"center",direction:"row",justify:"space-between",children:[s.jsx(w,{align:"center",direction:"row",children:l&&s.jsx($e,{type:l})}),l==="video"&&u?s.jsx(wl,{href:`${u}${u.includes("?")?"&":"?"}open=system`,onClick:j=>j.stopPropagation(),target:"_blank",children:s.jsx(Gt,{})}):null]}),c&&s.jsx(zt,{"data-testid":"episode-name",children:c}),s.jsx(zt,{"data-testid":"episode-description",children:g}),s.jsxs(w,{align:"center",direction:"row",justify:"flex-start",children:[!!t&&s.jsx(pt,{children:Ht.unix(t).fromNow()}),!!k&&s.jsx(yl,{children:k}),!r&&e>0&&s.jsx(w,{style:{marginLeft:"auto"},children:s.jsx(Yt,{amt:e})})]})]})]})}):null},zt=b(w)`
  font-family: Barlow;
  font-size: 13px;
  font-style: normal;
  font-weight: 400;
...
`,wl=b.a`
  ...
  font-size: 16px;
  height: 16px;
`,bl=({isSearchResult:e})=>{const t=P.useRef(null),n=e?80:10,{setSelectedNode:r,setSelectedTimestamp:i}=fe(L=>L),{currentSearch:o,setSidebarOpen:l,setRelevanceSelected:a}=he(L=>L),[c,u]=P.useState(0),[h,d]=P.useState(0),f=dr(),g=c*n+n,k=f&&f.length>0?f.length-1>g:!1,T=jo("sm","down"),j=P.useCallback(L=>{Pi(L),i(L),a(!0),r(L),T&&l(!1)},[r,a,l,i,T]),S=()=>{k&&(u(c+1),d(L=>L+1))},E=P.useMemo(()=>{if(f){const L=[...f].sort((B,v)=>(v.date||0)-(B.date||0));return o&&L.sort((B,v)=>{const F=B.node_type==="topic"&&B.name.toLowerCase()===o.toLowerCase()?1:0;return(v.node_type==="topic"&&v.name.toLowerCase()===o.toLowerCase()?1:0)-F}),L.slice(0,g)}return[]},[f,o,g]);return s.jsx(s.Fragment,{children:s.jsxs(tl,{ref:t,id:"search-result-list",shrink:1,children:[(E??[]).map((L,B)=>{const{image_url:v,date:F,boost:U,type:H,episode_title:D,show_title:_,node_type:A,text:N,source_link:G,link:M,name:q,verified:J=!1,twitter_handle:oe}=L||{};return s.jsx(zr,{boostCount:U||0,date:F||0,episodeTitle:it(D),imageUrl:v||"",link:M,name:q||"",onClick:()=>{j(L)},showTitle:it(_),sourceLink:G,text:N||"",twitterHandle:oe,type:A||H,verified:J},B.toString())}),s.jsx(Cl,{align:"center",background:"BG1",direction:"row",justify:"center",children:k&&s.jsx(pe,{onClick:S,size:"medium",children:"Load More"},h)})]})})},kl=P.memo(bl),Cl=b(w)`
  flex: 0 0 86px;
...
`;const Pl=48,Al=8,zl={PaperProps:{style:{maxHeight:Pl*4.5+Al,width:250}}},Ll=["Beginner","Intermediate","Advanced","Expert"],Bl=()=>{const e=fe(S=>S.data),[t,n]=P.useState(""),[r,i]=P.useState("Beginner"),o=he(S=>S.currentSearch),l=Ri(),[a]=fr(S=>[S.setBudget]),[c,u,h,d,f]=_r(S=>[S.askedQuestions,S.askedQuestionsAnswers,S.setAskedQuestion,S.setAskedQuestionAnswer,S.hasQuestionInProgress]),p=P.useCallback(S=>{d(S.answer)},[d]);P.useEffect(()=>{l&&p&&l.on("askquestionhook",p)},[p,l]);const g=async()=>{t&&(h(t),n(""));try{const S=e==null?void 0:e.nodes.filter(B=>B.text),E=S==null?void 0:S.slice(0,5),L=(E!=null&&E.length?E.map(B=>B.text).join(" "):"").substring(0,2500).replace(/[?&=+/#]/g,B=>`\\${B}`);o&&(await Ai.enable(),await Ui({expertise_level:r,question_text:t,search_term:o,transcripts:L},a),await zi(a))}catch(S){console.error(S)}},k=r&&t.trim()&&!f,T=S=>{i(S.target.value)},j=async S=>{if(f){S.preventDefault();return}S.keyCode===13&&S.shiftKey===!1&&k&&(S.preventDefault(),g())};return s.jsxs(Ml,{children:[s.jsx(w,{children:s.jsx(w,{children:s.jsxs(br,{component:"div",children:[s.jsx(Rl,{id:"select-label",size:"small",children:"Expertise level"}),s.jsx(Fl,{id:"demo-multiple-name",input:s.jsx(xo,{label:"Expertise level"}),labelId:"select-label",MenuProps:zl,onChange:T,size:"small",value:r,children:Ll.map(S=>s.jsx(Vi,{component:"li",value:S,children:S},S))})]})})}),s.jsx(Nl,{children:c==null?void 0:c.map((S,E)=>s.jsxs(w,{className:"response",py:12,children:[s.jsx(K,{kind:"medium",children:S}),s.jsx(w,{py:12,children:(u==null?void 0:u[E])!==void 0?s.jsx(K,{color:"unreadMsgText",children:u[E]}):s.jsxs(w,{align:"center",py:12,children:[s.jsx(w,{align:"center",py:12,children:s.jsx(Pr,{color:y.white})}),s.jsx(w,{align:"center",py:12,children:s.jsx(K,{children:"Generating response"})})]})})]},S))}),s.jsxs(Dl,{onKeyDown:j,py:12,tabIndex:-1,children:[s.jsx(Ol,{disabled:f,onChange:S=>n(S.target.value),placeholder:"Enter your question",value:t}),s.jsx($l,{children:s.jsx(go,{color:k?y.white:y.gray300,size:"18"})})]})]})},Ml=b.div`
  margin-top: 20px;
`,Ol=b(Ni)`
...
`,ha=b.div`
  width: 100%;
  cursor: pointer;
`,Br=P.memo(sa),da=()=>{const e=xe();if(!e)return null;const t=!!e.image_url,n=!!e.media_url||!!e.link,r=e.properties||{};return s.jsxs(ba,{children:[t?s.jsx(ga,{children:s.jsx("img",{alt:"img_a11y",onError:i=>{i.currentTarget.src="generic_placeholder_img.png",i.currentTarget.className="default-img"},src:e.image_url})}):null,n?s.jsx(Br,{hidden:!1}):null,s.jsxs(xa,{grow:1,justify:"flex-start",pt:t?0:8,shrink:1,children:[s.jsx(w,{ml:24,mt:20,style:{width:"fit-content"},children:s.jsx($e,{type:e.type||""})}),s.jsx(ma,{children:Object.entries(r).filter(([i])=>i!=="media_url"&&i!=="link").map(([i,o])=>s.jsx(fa,{label:i,value:o},i))})]})]})},fa=({label:e,value:t})=>{const n=t.length>140;return s.jsxs(s.Fragment,{children:[s.jsxs(ya,{className:Ie("node-detail",{"node-detail__long":n}),children:[s.jsx(K,{className:"node-detail__label",children:e}),s.jsx(K,{className:"node-detail__value",children:t})]}),s.jsx(wa,{})]})},xa=b(w)`
  overflow: auto;
  width: 100%;
  flex-grow: 1;
  padding-top: 16px;
