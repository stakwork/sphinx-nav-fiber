...
`,Ge=L.h2`
  ...
  margin-bottom: 16px;
  color: ${T.white};
`,M={[ie]:{label:"Engagement",value:"impression_count"},[le]:{label:"Followers",value:"followers"},[ae]:{label:"Top Reposters",value:"top_reposters"},[pe]:{label:"Sentiment",value:"sentiment"}},Oe=({tweetId:t})=>{var f;const[p,v]=C.useState(M.ENGAGEMENT.value),{tweetId:y}=we(),S=C.useMemo(()=>{const x=(y==null?void 0:y.split("&"))||[];return t==="summary"?x:x.filter(U=>U===t)},[y,t]),w=(f=Object.entries(M).find(([,x])=>x.value===p))==null?void 0:f[0],N=w?Fe[w]:null;return e.jsxs(ke,{children:[e.jsxs($,{p:24,children:[e.jsx(Ge,{children:"Engagement Report"}),e.jsx($,{direction:"row",children:Object.keys(M).map(x=>e.jsx(Le,{active:p===M[x].value,onClick:()=>v(M[x].value),children:M[x].label},x))})]}),N&&e.jsx(N,{idsToAnalyze:S,sortBy:p})]})},ke=L($)`
  display: flex;
  flex: 1;
  min-height: 572px;
  overflow: auto;
