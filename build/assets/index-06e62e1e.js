import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h as x,r as T,x as v,B as m}from"./index-6f683887.js";import{B}from"./index-fd6fe90b.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-00724a2d.js";import{B as f,T as $,a as k}from"./index-be7e134c.js";import{T as u}from"./index-69d18388.js";import"./useSlotProps-7b782c1a.js";import"./index.esm-f608fb77.js";import"./InfoIcon-6cbc83e0.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
