import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-c702fad0.js";import{B as M}from"./index-a09f3859.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-3aab803b.js";import{B as f,T as L,a as R}from"./index-4c80c8a3.js";import{T as x}from"./index-17e7e9b9.js";import"./useSlotProps-5c22f7c9.js";import"./index.esm-7bb24454.js";import"./InfoIcon-23a924e9.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
