import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-78c1e94a.js";import{B as F}from"./index-ad3822cb.js";import{u as M}from"./index-f751514a.js";import{j as $,e as k,F as D,C as G}from"./react-toastify.esm-26d0fce1.js";import{B as f,T as R,a as L}from"./index-6dccf3f8.js";import{T as x}from"./index-b44336fa.js";import"./useSlotProps-f1c9137a.js";import"./index.esm-8585a75f.js";import"./InfoIcon-69713509.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
