import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,x as D,B as F}from"./index-530f6618.js";import{B as M}from"./index-a101b3f5.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-7264a5d3.js";import{B as f,T as L,a as R}from"./index-2f843e70.js";import{T as x}from"./index-fa56e81c.js";import"./useSlotProps-11e18c14.js";import"./index.esm-51a0b245.js";import"./InfoIcon-1357a1ce.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
