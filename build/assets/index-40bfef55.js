...
`,le=({nodeType:o,onclose:l,selectedNodeType:x})=>e.jsxs(r,{children:[e.jsx(r,{mb:20,children:e.jsx(R,{children:"Confirm Type Change"})}),e.jsx(r,{mb:25,children:e.jsxs(R,{children:["From: ",x]})}),e.jsx(r,{mb:25,children:e.jsxs(R,{children:["To: ",o]})}),e.jsxs(r,{direction:"row",children:[e.jsx(r,{grow:1,children:e.jsx(P,{color:"secondary",onClick:l,size:"large",variant:"contained",children:"Cancel"})}),e.jsx(r,{grow:1,ml:20,children:e.jsx(P,{color:"secondary",size:"large",type:"submit",variant:"contained",children:"Confirm"})})]})]}),R=v(F)`
  font-size: 22px;
  font-weight: 600;
  font-family: 'Barlow';
`,de=({handleSelectType:o,skipToStep:l,selectedNodeType:x,nodeType:n,selectedValues:f,setSelectedValues:w})=>{const[m,C]=h.useState(!1),[j,t]=h.useState(),[s,i]=h.useState(),{watch:d}=V();h.useEffect(()=>{const p=async(u,y)=>{C(!0);const g=await U(u),O=K(g),_=W(O);y(_),C(!1)};n&&p(n,t),x&&p(x,i)},[n,x,d]);const S=h.useMemo(()=>k(j),[j]),b=h.useMemo(()=>k(s),[s]),c=()=>{o(""),l("sourceType")};h.useEffect(()=>{if(j&&s){const p=s.reduce((u,y)=>{const g=j.find(O=>O.key===y.key);return u[y.key]=g?y.key:"none",u},{});w(p)}},[j,s,w]);const a=(p,u)=>{w(y=>({...y,[p]:u}))},T=()=>{const p=S.every(({key:u,required:y})=>!y||y&&f[u]&&f[u]!=="none");l(p?"createConfirmation":"requiredProperties")},E=h.useMemo(()=>b.map(({key:p})=>{const u=f[p]||"none",y=S.filter(g=>!Object.values(f).includes(g.key)||g.key===u).map(g=>({label:B(g.key),value:g.key}));return y.unshift({label:"None",value:"none"}),{key:p,autoCompleteOptions:y,selectedValue:u}}),[b,S,f]);return e.jsxs(r,{children:[e.jsx(r,{align:"center",direction:"row",justify:"space-between",mb:18,children:e.jsx(r,{align:"center",direction:"row",children:e.jsx(pe,{children:"Map Properties"})})}),e.jsx(ue,{children:m?e.jsx(r,{style:{margin:"auto"},children:e.jsx(G,{color:q.lightGray})}):e.jsxs(xe,{children:[e.jsxs(he,{children:[e.jsx(I,{children:B(x)}),b.map(({key:p})=>e.jsx(fe,{children:e.jsx(F,{children:B(p)})},p))]}),e.jsxs(me,{children:[e.jsx(I,{children:B(n)}),E.map(({key:p,autoCompleteOptions:u,selectedValue:y})=>e.jsx(r,{children:e.jsx(H,{isLoading:m,onSelect:g=>a(p,g?g.value:"none"),options:u,selectedValue:u.find(g=>g.value===y)})},p))]})]})}),e.jsxs(r,{direction:"row",children:[e.jsx(r,{grow:1,children:e.jsx(P,{color:"secondary",onClick:c,size:"large",variant:"contained",children:"Prev"})}),e.jsx(r,{grow:1,ml:20,children:e.jsx(P,{color:"secondary",disabled:m,onClick:T,size:"large",variant:"contained",children:"Next"})})]})]})},pe=v(F)`
  font-size: 22px;
  font-weight: 600;
  font-family: 'Barlow';
`,ue=v(r)`
