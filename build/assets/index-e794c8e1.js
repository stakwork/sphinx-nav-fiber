import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,x as D,B as F}from"./index-691b8c4d.js";import{B as M}from"./index-d0f2742e.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-434dbc20.js";import{B as f,T as L,a as R}from"./index-3d13a698.js";import{T as x}from"./index-c6b11564.js";import"./useSlotProps-9e2514e4.js";import"./index.esm-b23f86d3.js";import"./InfoIcon-0b045cc0.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
