import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,C as B,h as c,r as v,x as C}from"./index-16ea0b62.js";import{B as F}from"./index-d17b741d.js";import{u as M}from"./index-f79d8d98.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-61460506.js";import{B as f,T as L,a as R}from"./index-25118e04.js";import{T as x}from"./index-6caa7048.js";import"./useSlotProps-d1aef4fa.js";import"./index.esm-cd6c9c6f.js";import"./InfoIcon-c4e47262.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
