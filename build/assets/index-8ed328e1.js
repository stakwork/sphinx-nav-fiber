import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-7dcde225.js";import{B}from"./index-956697d9.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-8bcb4dda.js";import{B as f,T as $,a as k}from"./index-47a40130.js";import{T as u}from"./index-2b6cb1b8.js";import"./useSlotProps-aeebd459.js";import"./index.esm-8c214648.js";import"./InfoIcon-c9d1fdb1.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
