import{r as n,j as e,s as f,g as T,F as S,o as K,c as U,A as ae,p as ce,i as le,q as pe,H as de,t as ue,v as fe,f as q}from"./index-6e95c531.js";import{Universe as me}from"./index-87590c8e.js";import{u as he}from"./index-6265e2c5.js";import{u as W,a as ge,b as xe,I as ye,c as Q,d as V}from"./index-1026aced.js";import{M as be,V as we}from"./VolumeIcon-be09c787.js";import{S as je,R as ve,s as X,M as Se}from"./index-e2fbb6bc.js";import"./index-c2055fee.js";import"./VisibilityOn-98d357ce.js";import"./SourcesTableIcon-a1fb7b24.js";import"./NodeCircleIcon-7d32f0be.js";import"./CheckIcon-d4919c70.js";import"./DeleteNodeIcon-fd3b3625.js";import"./EditNodeIcon-682e5d5f.js";import"./SearchIcon-3d5e5741.js";import"./SoundIcon-7e32990e.js";import"./SucessFeedBackIcon-717cfecc.js";import"./three.module-4d3d7244.js";import"./TextareaAutosize-ca5a314f.js";import"./index-77f329ab.js";import"./index-ed3b5c9d.js";import"./index-8bddda2c.js";import"./ClipLoader-4c9d3bfc.js";import"./Skeleton-b36112e3.js";import"./Stack-3c15d206.js";import"./index-b966eb92.js";import"./FormControlLabel-c7e5849c.js";import"./Typography-c57cf9fb.js";import"./createSvgIcon-2669c688.js";import"./isPlainObject-430588de.js";function D(t){const[i,s,r]=t.split(":").map(Number);return Number((i*60*60*1e3+s*60*1e3+r*1e3).toFixed(6))}const Z=n.memo(()=>{const t=W(a=>a.isPlaying),i=W(a=>a.setIsPlaying),s=W(a=>a.setVolume),r=W(a=>a.setPlaybackSpeed),c=W(a=>a.playbackSpeed),o=W(a=>a.playerRef),[x,b]=n.useState(!1),m=[.5,1,1.5,2],g=()=>{if(o){const a=o.getCurrentTime()-15;o.seekTo(a,"seconds")}},p=()=>{if(o){const a=o.getCurrentTime()+15;o.seekTo(a,"seconds")}},j=()=>{i(!t)},d=()=>{b(!x),s(x?1:0)},h=()=>{const I=(m.indexOf(c)+1)%m.length,F=m[I];if(r(F),o){const P=o.getInternalPlayer();P&&typeof P.playbackRate<"u"&&(P.playbackRate=F)}};return e.jsxs(ke,{children:[e.jsx(Pe,{onClick:d,children:x?e.jsx(be,{}):e.jsx(we,{})}),e.jsx(Te,{onClick:g,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(Ce,{"data-testid":"play-pause-button",onClick:j,size:"small",children:t?e.jsx(ge,{"data-testid":"pause-icon"}):e.jsx(xe,{"data-testid":"play-icon"})}),e.jsx(Ie,{onClick:p,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(_e,{onClick:h,children:[c,"x"]})]})});Z.displayName="Controls";const ke=f(S).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${T.BG1};
  border-radius: 40px;
