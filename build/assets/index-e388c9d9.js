import{s as r,F as n,T as g,j as e,h as w,b as c,r as A,g as B}from"./index-803fed4c.js";import{B as v}from"./index-78b80aab.js";import{u as F}from"./index-d9332946.js";import{e as M,X as $,t as C,h as b,z as D,F as k,C as G}from"./react-toastify.esm-a643f0aa.js";import{B as f,T as R,a as z}from"./index-25ce0e07.js";import{T as x}from"./index-d88d85b8.js";import"./useSlotProps-ed176cd2.js";import"./index.esm-737473f0.js";import"./InfoIcon-3542168a.js";const L=({onClose:s})=>{const[a]=M(t=>[t.graphStyle]),i=()=>{localStorage.setItem("graphStyle",a),s()};return e.jsxs(P,{direction:"column",children:[e.jsx(V,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:i,children:"Save changes"})})]})},P=r(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,V=r(g)`
