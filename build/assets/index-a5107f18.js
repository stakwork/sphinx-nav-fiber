import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-10ba6357.js";import{B as M}from"./index-e1510dd9.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-0311feb0.js";import{B as f,T as L,a as R}from"./index-e6b7dc22.js";import{T as x}from"./index-43fb0a19.js";import"./useSlotProps-1ec3b865.js";import"./index.esm-12fd3e0f.js";import"./InfoIcon-7e45a0a9.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
