import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h as x,r as T,x as v,B as m}from"./index-7db479c4.js";import{B}from"./index-29c651f1.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-2a3173e7.js";import{B as f,T as $,a as k}from"./index-c1ff6617.js";import{T as u}from"./index-2ad151d6.js";import"./useSlotProps-a6d6f46a.js";import"./index.esm-03fb1f26.js";import"./InfoIcon-c95557bd.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
