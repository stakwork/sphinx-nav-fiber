import{s as r,F as n,T as g,j as e,h as w,b as c,r as A,g as B}from"./index-96b41805.js";import{B as v}from"./index-263d0c1a.js";import{u as F}from"./index-ec3446f8.js";import{e as M,X as $,t as C,h as b,z as D,F as k,C as G}from"./react-toastify.esm-4df78b0d.js";import{B as f,T as R,a as z}from"./index-48aaa3ce.js";import{T as x}from"./index-a7c441bc.js";import"./useSlotProps-df85f21c.js";import"./index.esm-ff9ef8aa.js";import"./InfoIcon-5fcce5a0.js";const L=({onClose:s})=>{const[a]=M(t=>[t.graphStyle]),i=()=>{localStorage.setItem("graphStyle",a),s()};return e.jsxs(P,{direction:"column",children:[e.jsx(V,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:i,children:"Save changes"})})]})},P=r(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,V=r(g)`
