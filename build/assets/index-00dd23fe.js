import{s as f,c as y,u as z,r as p,j as e,F as t,T as h,b as N,x as R,o as U,ad as V,ae as g,d as G,a2 as q}from"./index-f76464f2.js";import{ak as J,B as j,al as Y,l as H,u as K,F as Q}from"./react-toastify.esm-bb128754.js";import{B as W}from"./index-47dde8aa.js";import{n as S}from"./toastMessage-3f5b8d92.js";import{u as X}from"./index-9c3b490f.js";import{C as Z}from"./CheckIcon-455b6076.js";import{C as ee}from"./ClipLoader-634bea35.js";import{T as B}from"./index-2c3c416b.js";import{A as te}from"./index-4c19b844.js";import{i as v,O as L}from"./constants-84edb5fc.js";import"./index.esm-a945e31d.js";import"./InfoIcon-d72751f5.js";import"./index-c4f67241.js";import"./Popover-e081ddff.js";import"./useSlotProps-2c3c97df.js";import"./Select-f31fbaee.js";import"./Stack-9daff4b0.js";import"./Popper-0477edac.js";const ne=({onClick:n,loading:a})=>{const d=z(l=>l.budget),[c,m]=p.useState(10),s="node";return p.useEffect(()=>{(async()=>{try{const r=await Y(s);m(r.data.price)}catch(r){console.error("cannot fetch",r)}})()},[s]),e.jsxs(t,{children:[e.jsx(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:e.jsx(t,{align:"center",direction:"row",children:e.jsx(re,{children:"Approve Cost"})})}),e.jsxs(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:[e.jsxs(oe,{children:[e.jsx("div",{className:"title",children:"COST"}),e.jsxs("div",{className:"value","data-testid":"check-price",children:[c," sats"]})]}),e.jsxs(se,{children:[e.jsx("div",{className:"title",children:"BUDGET"}),e.jsxs("div",{className:"value",children:[J(d)," sats"]})]})]}),e.jsx(t,{children:e.jsx(j,{color:"secondary","data-testid":"check-icon",disabled:a,onClick:n,size:"large",startIcon:a?e.jsx(ee,{size:24}):e.jsx(Z,{}),type:"submit",variant:"contained",children:"Approve"})})]})},oe=f(t).attrs({direction:"column",align:"space-between",justify:"flex-start"})`
  width: 141px;
  height: 61px;
