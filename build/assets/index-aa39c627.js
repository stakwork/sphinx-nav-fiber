import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-2d3ee110.js";import{B as M}from"./index-d35ce9ec.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-7ae93696.js";import{B as f,T as L,a as R}from"./index-9937aba5.js";import{T as x}from"./index-7d05f8cf.js";import"./useSlotProps-7d67fc74.js";import"./index.esm-9ab25bf0.js";import"./InfoIcon-8ff3338a.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
