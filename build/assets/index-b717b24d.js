import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h as x,r as T,x as v,B as m}from"./index-1bb978d6.js";import{B}from"./index-c9feb6ef.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-3e43abdf.js";import{B as f,T as $,a as k}from"./index-110166cd.js";import{T as u}from"./index-ccd8f1e7.js";import"./useSlotProps-248dd320.js";import"./index.esm-f645554c.js";import"./InfoIcon-e7edbefb.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
