import{o as s,q as l,F as n,p as w,j as e,t as G,v as C,T as S,r as f,A as v,aU as A,aV as b,aW as I,J as B,O as y}from"./index-dc9ddf58.js";import{B as z}from"./index-f9fb983e.js";import{u as M,G as k,C as D,l as E,o as R,B as T,i as W,F}from"./index-710f902f.js";import{C as $}from"./ClipLoader-123f85e8.js";import{T as j}from"./index-07ef61dc.js";import{S as P}from"./index-12b80aac.js";import{e as V}from"./index.esm-29ecd038.js";import{T as L,a as N}from"./Tabs-d2354bbd.js";import"./InfoIcon-e28735ee.js";import"./useSlotProps-8fc486b4.js";import"./createSvgIcon-30257468.js";const O={split:e.jsx(k,{}),force:e.jsx(D,{}),sphere:e.jsx(E,{}),earth:e.jsx(R,{})},Y=()=>{const[i,p]=w(M(t=>[t.graphStyle,t.setGraphStyle])),r=t=>{p(t)};return e.jsx(q,{direction:"column",children:G.map(t=>e.jsx(n,{className:C("icon",{active:i===t}),onClick:()=>r(t),children:O[t]},t))})},q=s(n).attrs({direction:"row",align:"center",justify:"space-between"})`
  width: 447px;
  height: 48px;
