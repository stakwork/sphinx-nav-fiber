import{Q as o,U as s,a5 as g,O as y,j as e,a3 as b,av as w,ar as S,S as x,r as v,N as T,ad as m}from"./index-c937f9eb.js";import{aN as A,aO as f,ak as C,al as M,aP as u,an as $,aQ as k,aR as B,aL as G}from"./index-6f8cb5f0.js";const D=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(z,{direction:"column",children:[e.jsx(L,{children:"Default graph view:"}),e.jsx(A,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},z=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,L=o(g)`
