import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-61c60aaf.js";import{B as M}from"./index-7f8d72b7.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-b9ea12aa.js";import{B as f,T as L,a as R}from"./index-2fbb380f.js";import{T as x}from"./index-b7f4621d.js";import"./useSlotProps-87c77688.js";import"./index.esm-d055e8bc.js";import"./InfoIcon-edbb05e4.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
