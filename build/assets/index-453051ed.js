import{s as r,c as o,F as s,j as e,T as _,h as ee,r as d,u as xe,P as de,d as ze,f as Ee,a3 as Re}from"./index-2dc07d34.js";import{A as E,u as R,b as P,ad as pe,ae as Pe,B as z,s as Ae,af as X,ag as Me,a as A,E as Le,I as he,c as U,v as ue,P as te,ah as Ge,ai as ge,aj as De,e as Ne,d as Fe}from"./react-toastify.esm-8204b115.js";import{G as ye,L as se,B as ie,H as Ye,u as Oe,S as We,a as He,D as Ve,M as Ue,R as Qe,b as qe,c as Ke,d as Xe,N as fe,C as Ze,e as me,f as we,g as Je,h as et,i as je,j as tt,P as st,k as be,s as re,V as it,F as ot,E as nt,l as rt,m as at,n as ke,o as lt,p as ct,q as xt,r as dt,t as pt,v as ht,w as ut,x as gt,y as yt}from"./SoundIcon-6334b525.js";import{C as ft,S as mt}from"./ChevronUpIcon-ce00d371.js";import{f as V,o as ve,n as wt,X as jt,Y as bt,T as kt,D as vt,S as oe,q as Ce,P as Q}from"./generateCategoricalChart-cf2be85f.js";import{T as W}from"./index-93713b62.js";import{S as Ct}from"./Skeleton-4f660552.js";import{T as ae}from"./toastMessage-a2b0b96c.js";import{g as St,d as $t}from"./index.esm-554a6801.js";import{T as _t,F as Tt}from"./Popover-74fa4a02.js";import{I as Bt,S as It,O as zt}from"./Select-cd205776.js";import{C as Et}from"./CheckIcon-1ef4fe85.js";import{I as Rt}from"./InfoIcon-ccb1bb98.js";import{C as ne}from"./ClipLoader-a01d94b5.js";import{P as Pt}from"./PlusIcon-931e82e0.js";import{u as J}from"./index-d0a19889.js";import{B as At}from"./index-196a7a56.js";import"./useSlotProps-de8da9de.js";const Mt=({imageUrl:t,name:i})=>e.jsxs(s,{align:"center",direction:"row",children:[t&&e.jsx(Lt,{children:e.jsx(E,{rounded:!0,size:64,src:t||"",type:"image"})}),i&&e.jsx(Gt,{children:i})]}),Lt=r(s)`
  img {
    width: 64px;
    height: 64px
    border-radius: 50%;
...
`,Se=({boostCount:t,date:i,episodeTitle:n,isSelectedView:a=!1,imageUrl:c,showTitle:x,type:l,text:y,name:g,profilePicture:p,sourceLink:f,verified:C=!1,twitterHandle:u,className:j="episode-wrapper",onClick:v})=>{const m=l==="show"?x:n,b=l==="show"?"":x,k=["tweet","person","guest","topic","document"],h=l==="youtube"?"video":"audio";return l?e.jsx(Kt,{className:j,onClick:v,children:k.includes(l)?e.jsxs(e.Fragment,{children:[l==="topic"&&e.jsxs(Xt,{children:[e.jsx(Ye,{}),e.jsx("p",{children:b})]}),["person","guest"].includes(l)&&e.jsx(Yt,{imageUrl:c,name:g||"",title:x||""}),["image"].includes(l)&&e.jsx(Mt,{imageUrl:f,name:g||""}),l==="tweet"&&e.jsx(Ht,{date:i,imageUrl:p,name:g||"",text:y||"",twitterHandle:u,verified:C}),l==="document"&&e.jsx(Dt,{sourceLink:f||"",text:y||"",type:l})]}):e.jsxs(s,{direction:"row",children:[!a&&e.jsx(s,{align:"center",pr:16,children:e.jsx(E,{size:64,src:c||`${h}_default.svg`,type:l||""})}),e.jsxs(s,{grow:1,shrink:1,children:[e.jsxs(s,{align:"center",direction:"row",justify:"space-between",children:[e.jsx(s,{align:"center",direction:"row",children:l&&e.jsx(W,{type:l})}),l==="youtube"&&f?e.jsx(Jt,{href:`${f}?open=system`,onClick:T=>T.stopPropagation(),children:e.jsx(se,{})}):null]}),e.jsx($e,{"data-testid":"episode-description",children:m}),e.jsxs(s,{align:"center",direction:"row",justify:"flex-start",children:[!!i&&e.jsx(q,{children:ee.unix(i).fromNow()}),!!b&&e.jsx(Zt,{children:b}),!a&&t>0&&e.jsx(s,{style:{marginLeft:"auto"},children:e.jsx(ie,{amt:t})})]})]})]})}):null},$e=r(s)`
  font-family: Barlow;
  font-size: 13px;
  font-style: normal;
  font-weight: 400;
...
`,Jt=r.a`
  ...
  font-size: 16px;
  height: 16px;
`,es=({isSearchResult:t})=>{const i=d.useRef(null),n=t?80:10,{setSelectedNode:a,setSelectedTimestamp:c}=R(k=>k),{currentSearch:x,setSidebarOpen:l,setRelevanceSelected:y}=P(k=>k),[g,p]=d.useState(0),f=pe(),u=g*n+n,j=f&&f.length>0?f.length-1>u:!1,v=Oe("sm","down"),m=d.useMemo(()=>{if(f){const k=[...f].sort((h,T)=>(T.date||0)-(h.date||0));return x&&k.sort((h,T)=>{const M=h.node_type==="topic"&&h.name.toLowerCase()===x.toLowerCase()?1:0;return(T.node_type==="topic"&&T.name.toLowerCase()===x.toLowerCase()?1:0)-M}),k.slice(0,u)}return[]},[f,u,x]),b=d.useCallback(k=>{Pe(k),c(k),y(!0),a(k),v&&l(!1)},[a,y,l,c,v]);return e.jsx(e.Fragment,{children:e.jsxs(We,{ref:i,id:"search-result-list",shrink:1,children:[(m??[]).map((k,h)=>{const{image_url:T,date:M,boost:I,type:Y,episode_title:O,show_title:D,node_type:w,text:$,source_link:N,link:F,name:G,profile_picture:S,verified:B=!1,twitter_handle:L}=k||{};return e.jsx(Se,{boostCount:I||0,date:M||0,episodeTitle:V(O),imageUrl:T||"",link:F,name:G||"",onClick:()=>{b(k)},profilePicture:S,showTitle:V(D),sourceLink:N,text:$||"",twitterHandle:L,type:w||Y,verified:B},h.toString())}),e.jsx(ss,{align:"center",background:"BG1",direction:"row",justify:"center",children:j&&e.jsx(z,{onClick:()=>{j&&p(g+1)},size:"medium",children:"Load More"})})]})})},ts=d.memo(es),ss=r(s)`
  flex: 0 0 86px;
...
`,Es=({stateless:t,node:i})=>{var v;const[n,a]=P(m=>[m.transcriptIsOpen,m.setTranscriptOpen]),[c,x]=d.useState(!1),[l,y]=d.useState(""),[g,p]=d.useState(!1);if(!t&&!n)return null;const f="https://knowledge-graph.sphinx.chat",C=async m=>{try{const b=await fetch(`${f}/node/text/${m}`);if(!b.ok)throw new Error("Network response was not ok");const k=await b.json();y(k.data.text),p(!0)}catch(b){console.error("Error fetching full transcript",b)}},u=()=>{g?p(!1):i!=null&&i.ref_id&&C(i.ref_id)},j=m=>{m!==void 0&&(navigator.clipboard.writeText(m),x(!0))};return e.jsxs(s,{grow:1,shrink:1,children:[e.jsxs(Ps,{children:[t&&e.jsxs(Rs,{children:[e.jsx("div",{className:"icon",children:e.jsx(fe,{})}),e.jsx("div",{className:"title",children:"Transcript"})]}),i!=null&&i.text?e.jsx(e.Fragment,{children:c?e.jsxs(Ls,{align:"center",direction:"row",justify:"flex-start",children:[e.jsx("div",{className:"icon",children:e.jsx(Et,{})}),e.jsx("div",{className:"text",children:"Copied"})]}):e.jsx(z,{endIcon:e.jsx(Ze,{}),onPointerDown:()=>j(i==null?void 0:i.text),size:"small",variant:"outlined",children:"Copy"})}):e.jsx("div",{}),!t&&e.jsx(As,{onClick:()=>{a(!1)},children:e.jsx($t,{fontSize:35})})]}),e.jsxs(Ms,{children:[g?l:`${(v=i==null?void 0:i.text)==null?void 0:v.substring(0,100)}...`,e.jsx(zs,{onClick:u,children:g?"less":"more"})]})]})},Rs=r(s).attrs({direction:"row",align:"center"})`
  .icon {
    font-size: 16px;
    color: ${o.GRAY3};
    margin-right: 7px;
...
`,_e=({node:t})=>{const i=R(m=>m.selectedNode),n=P(m=>m.currentSearch),{link:a,image_url:c,date:x,boost:l,node_type:y,type:g,id:p,show_title:f,episode_title:C,ref_id:u}=t||i||{},[j,v]=d.useState(l||0);return i?e.jsx("div",{style:{overflow:"auto",flex:1,width:"100%"},children:e.jsxs(Gs,{children:[e.jsx(Ns,{boostCount:j||0,date:x||0,episodeTitle:V(C),imageUrl:c,isSelectedView:!0,link:a,onClick:()=>null,showTitle:f,type:y||g}),e.jsx(Z,{}),e.jsxs(Ds,{children:[e.jsx(ie,{amt:j}),e.jsx(we,{content:i,count:j,refId:u,updateCount:v})]}),e.jsx(Z,{}),e.jsx(ce,{children:e.jsx(Ts,{node:i,searchTerm:n,stateless:!0})}),e.jsx(Z,{}),e.jsx(ce,{children:e.jsx(Es,{node:i,stateless:!0},p)})]})}):null},Gs=r(s)`
  flex: 1;
  min-height: 100%;
  flex-direction: column;
...
`,ii=({onClick:t,timestamp:i,isSelected:n,setOpenClip:a})=>e.jsxs(si,{align:"center","data-testid":"wrapper",direction:"row",isSelected:n,justify:"flex-start",onClick:t,px:20,py:20,children:[e.jsxs("div",{children:[e.jsx(he,{className:"play-pause",children:n?e.jsx(ti,{}):e.jsx(Je,{})}),!1]}),e.jsxs(oi,{align:"flex-start",direction:"column",justify:"center",children:[i.timestamp&&e.jsx("span",{className:"timestamp",children:et(i.timestamp)}),e.jsx("span",{className:"title",children:V(i.show_title)})]}),e.jsx("div",{className:"info",children:e.jsx(s,{"data-testid":"info-icon-wrapper",onClick:()=>a(i),pt:4,children:e.jsx(Rt,{})})})]}),oi=r(s)`
  font-size: 13px;
  color: ${o.white};
  font-family: 'Barlow';
  margin: 0 16px;
...
`,ji=r(_)`
  ...
  display: -webkit-box;
  -webkit-line-clamp: 2;
`,bi=()=>{const[t,i]=R(l=>[l.selectedNode,l.setSelectedNode]),n=Ce(),[a,c]=d.useState([]),x=d.useMemo(()=>{var g;const l=new Set,y={};if((g=t==null?void 0:t.children)!=null&&g.length){t.children.forEach((f,C)=>{var v,m,b,k;const u=je((n==null?void 0:n.nodes)||[],t)||[],j=n==null?void 0:n.nodes.find(h=>h.ref_id===f);if(j){j.timestamp=(v=u[0])==null?void 0:v.timestamp;const h=(k=(b=(m=u[C])==null?void 0:m.hosts)==null?void 0:b[0])==null?void 0:k.name;h&&l.add(h),y[f]=j,y[f]=j}});const p=Array.from(l);c(p)}return Object.values(y).filter(p=>p.node_type==="episode").sort((p,f)=>(f.weight||0)-(p.weight||0))},[n==null?void 0:n.nodes,t]);return e.jsxs(mi,{children:[e.jsx(wi,{children:e.jsxs(s,{direction:"row",children:[e.jsx(s,{pr:24,children:e.jsx(E,{size:80,src:(t==null?void 0:t.image_url)||"audio_default.svg",type:"show"})}),e.jsx(s,{direction:"column",children:e.jsxs(s,{direction:"column",grow:1,justify:"space-between",children:[e.jsxs(s,{align:"center",direction:"row",justify:"flex-start",mb:16,children:[e.jsx(W,{type:"show"})," ",e.jsxs("div",{className:"subtitle",children:["by ",a.join(", ")||(t==null?void 0:t.show_title)]})]}),e.jsx(ji,{kind:"bigHeading",title:(t==null?void 0:t.show_title)||"Unknown",children:(t==null?void 0:t.show_title)||"Unknown"})]})})]})}),e.jsxs(s,{direction:"column",children:[e.jsx(s,{p:24,children:e.jsx(_,{className:"relatedHeader",kind:"medium",children:"Related Episodes"})}),x.map(l=>e.jsx(yi,{node:l,onClick:()=>i(l)},l.ref_id))]})]})},ki=()=>{const t=A();return e.jsx(s,{align:"center",justify:"center",children:e.jsx(_,{color:"primaryText1",kind:"hugeHeading",children:t==null?void 0:t.label})})},vi=()=>{const t=A(),{date:i,boost:n,text:a,name:c,verified:x,profile_picture:l,twitter_handle:y,ref_id:g}=t||{},p=(t==null?void 0:t.tweet_id)||"",[f,C]=d.useState(n||0),u=P(j=>j.currentSearch);return t&&e.jsxs(e.Fragment,{children:[e.jsxs(s,{direction:"column",p:24,children:[e.jsxs(s,{align:"center",direction:"row",pr:16,children:[e.jsx(Ci,{children:e.jsx(E,{rounded:!0,size:58,src:l||"",type:"person"})}),e.jsxs(s,{children:[e.jsxs(Si,{align:"center",direction:"row",children:[c,x&&e.jsx("div",{className:"verification",children:e.jsx("img",{alt:"verified",src:"verified_twitter.svg"})})]}),y&&e.jsxs($i,{children:["@",y]})]})]}),e.jsxs(s,{grow:1,shrink:1,children:[e.jsx(_i,{"data-testid":"episode-description",children:K(a||"",u)}),e.jsx(s,{direction:"row",justify:"flex-start",children:!!i&&e.jsx(q,{children:ee.unix(i).format("ll")})})]}),e.jsx(s,{align:"stretch",mt:22,children:e.jsx("a",{href:`https://twitter.com/Interior/status/${p}?open=system`,children:e.jsx(Bi,{endIcon:e.jsx(se,{}),children:"View Tweet "})})})]}),e.jsx(Ti,{}),e.jsxs(s,{direction:"row",justify:"space-between",pt:14,px:24,children:[e.jsx(ie,{amt:f}),e.jsx(we,{content:t,count:f,refId:g,updateCount:C})]})]})},Ci=r(s)`
  img {
    width: 64px;
    height: 64px
    border-radius: 50%;
...
`,Ai=r.audio`
  height: 0;
  width: 0;
`,Mi=["clip","twitter_space","youtube","episode","podcast"],Li=()=>{const t=A(),{showTeachMe:i}=R(a=>a),{setPlayingNode:n}=U(a=>a);if(d.useEffect(()=>{Mi.includes((t==null?void 0:t.node_type)||"")&&n(t)},[n,t]),i)return e.jsx(ks,{});switch(t==null?void 0:t.node_type){case"guest":case"person":return e.jsx(gi,{});case"data_series":return e.jsx(Ss,{});case"tribe_message":return e.jsx(di,{});case"tweet":return e.jsx(vi,{});case"topic":return e.jsx(ki,{});case"show":return e.jsx(bi,{});case"youtube":case"podcast":case"clip":case"twitter_space":return e.jsx(_e,{});case"document":return e.jsx(Ii,{});case"episode":return e.jsx(ri,{},t.ref_id);case"image":return e.jsx(xi,{});default:return null}},Gi=d.memo(Li),Di=({isPlaying:t,setIsPlaying:i,playingTime:n,duration:a,handleProgressChange:c,handleVolumeChange:x,onFullScreenClick:l,showToolbar:y})=>e.jsxs(s,{children:[!y&&e.jsx(Wi,{"aria-label":"Small",max:a,onChange:c,size:"small",value:n}),e.jsxs(Ni,{align:"center",direction:"row",showToolbar:y,children:[e.jsx(Fi,{onClick:i,size:"small",children:t?e.jsx(Q,{}):e.jsx(te,{})}),e.jsxs(Hi,{direction:"row",children:[e.jsx("span",{children:re(n)}),e.jsx("span",{className:"separator",children:"/"}),e.jsx("span",{className:"duration",children:re(a)})]}),e.jsxs(Yi,{direction:"row",px:9,children:[e.jsx(be,{className:"volume-slider",defaultValue:.5,max:1,min:0,onChange:x,size:"small",step:.1}),e.jsx(it,{})]}),e.jsx(Oi,{onClick:()=>l(),children:y?e.jsx(nt,{}):e.jsx(ot,{})})]})]}),Ni=r(s)`
  height: 60px;
  padding: 12px 16px;
  ${t=>t.showToolbar&&`
    position: fixed;
...
`,Vi=({hidden:t})=>{const i=d.useRef(null),n=d.useRef(null),[a,c]=d.useState(!1),[x,l]=d.useState(!1),[y,g]=d.useState("ready"),[p,f,C,u,j,v,m,b,k,h,T]=U(S=>[S.isPlaying,S.playingTime,S.duration,S.setIsPlaying,S.setPlayingTime,S.setDuration,S.playingNode,S.volume,S.setVolume,S.setHasError,S.resetPlayer]);d.useEffect(()=>()=>T(),[T]);const M=()=>{u(!p)},I=()=>{u(!0)},Y=()=>{u(!1)},O=(S,B)=>{const L=Array.isArray(B)?B[0]:B;i.current&&(i.current.seekTo(L),j(L))},D=(S,B)=>{const L=Array.isArray(B)?B[0]:B;k(L)},w=()=>{h(!0),g("error")},$=S=>{const B=S.playedSeconds;j(B)},N=()=>{if(i.current){g("ready");const S=i.current.getDuration();v(S)}},F=()=>{n.current&&(document.fullscreenElement?(document.exitFullscreen(),c(!1)):n.current.requestFullscreen().then(()=>{document.addEventListener("fullscreenchange",G)}))},G=()=>{c(!!document.fullscreenElement),document.removeEventListener("fullscreenchange",G)};return d.useEffect(()=>()=>{document.removeEventListener("fullscreenchange",G)}),d.useEffect(()=>{const S=B=>{if(a){const L=window.screen.height,Be=B.clientY,Ie=L-Be;l(Ie<=50)}};return document.addEventListener("mousemove",S),()=>{document.removeEventListener("mousemove",S)}},[a,x]),d.useEffect(()=>{const S=B=>{a&&B.key==="Escape"&&(B.preventDefault(),B.stopPropagation())};return document.addEventListener("fullscreenchange",G),document.addEventListener("keydown",S),()=>{document.removeEventListener("fullscreenchange",G),document.removeEventListener("keydown",S)}}),m!=null&&m.link?e.jsxs(Ui,{ref:n,hidden:t,children:[e.jsx(Qi,{children:e.jsx(E,{size:120,src:(m==null?void 0:m.image_url)||"",type:"clip"})}),e.jsx(rt,{ref:i,controls:!1,height:a?window.screen.height:"200px",onBuffer:()=>g("buffering"),onBufferEnd:()=>g("ready"),onError:w,onPause:Y,onPlay:I,onProgress:$,onReady:N,playing:p,url:(m==null?void 0:m.link)||"",volume:b,width:"100%"}),y==="error"?e.jsx(Ki,{className:"error-wrapper",children:"Error happened, please try later"}):null,y==="ready"?e.jsx(Di,{duration:C,handleProgressChange:O,handleVolumeChange:D,isPlaying:p,onFullScreenClick:F,playingTime:f,setIsPlaying:M,showToolbar:x&&a}):null,y==="buffering"?e.jsx(qi,{children:e.jsx(ne,{color:o.lightGray})}):null]}):null},Ui=r(s)`
...
`,Ki=r(s)`
  ...
  padding: 12px 16px;
  color: ${o.primaryRed};
`,Xi=d.memo(Vi),Zi=({open:t})=>{const{setSelectedNode:i,setTeachMe:n,showTeachMe:a}=R(y=>y),c=A(),{setSidebarOpen:x}=P(y=>y),{playingNode:l}=U(y=>y);return e.jsx(oe,{"data-testid":"sidebar-sub-view",direction:"right",in:t,style:{width:a?"700px":"",position:t?"relative":"absolute"},children:e.jsxs(Ji,{children:[e.jsx(Xi,{hidden:(c==null?void 0:c.ref_id)!==(l==null?void 0:l.ref_id)},l==null?void 0:l.ref_id),e.jsx(to,{children:e.jsx(Gi,{})}),e.jsx(eo,{onClick:()=>{i(null),n(!1)},children:e.jsx(at,{})}),e.jsx(so,{onClick:()=>{x(!1)},children:e.jsx(ke,{})})]})})},Ji=r(s)(({theme:t})=>({position:"relative",background:o.BG1,width:"100%",margin:"64px auto 20px 10px",borderRadius:"16px",zIndex:29,[t.breakpoints.up("sm")]:{width:"390px"}})),eo=r(s)`
  font-size: 32px;
  color: ${o.white};
  cursor: pointer;
  position: absolute;
...
`,xo=r.audio`
  height: 0;
  width: 0;
`,po=["Drivechain","Ordinals","L402","Nostr","AI"],ho=({onSubmit:t})=>{var D;const{open:i}=J("addContent"),[n,a]=d.useState(!1),[c,x]=d.useState(!1),[l,y]=d.useState(null),g=d.useRef(null),[p,f]=d.useState(0),[C,u]=d.useState(!1),{open:j}=J("briefDescription"),{trendingTopics:v,setTrendingTopics:m}=R(w=>w),{setValue:b}=ge(),k=d.useCallback(async()=>{a(!0),x(!1);try{const w=await De();w.length&&Array.isArray(w)&&m(w)}catch{m(po.map($=>({topic:$,count:0})))}finally{a(!1)}},[m,x]);d.useEffect(()=>{v.length||k()},[k,v.length]),d.useEffect(()=>{const w=setTimeout(()=>{x(!0)},5e3);return()=>clearTimeout(w)},[x,n]);const h=w=>{b("search",w),t==null||t()},T=(w,$)=>{w.stopPropagation(),w.currentTarget.blur(),$!=null&&$.tldr&&(y($),j())},M=()=>{y(null)},I=w=>{w.stopPropagation(),w.currentTarget.blur(),u(!C)};d.useEffect(()=>{var w,$;C?(w=g.current)==null||w.play():($=g.current)==null||$.pause()},[p,C]);const Y=()=>{f(w=>{var N,F;let $=(w+1)%v.length;for(;$!==w&&!((N=v[$])!=null&&N.audio_EN);)$=($+1)%v.length;return $===w?(u(!1),$):((F=g.current)==null||F.load(),$===0&&(u(!1),f(0)),$)})},O=n?"Loading":"No new trending topics in the last 24 hours";return e.jsxs(go,{"data-testid":"trending-component",children:[e.jsxs("div",{children:[e.jsxs("div",{className:"heading-container",children:[e.jsxs("div",{className:"heading",children:[e.jsx("span",{className:"heading__title",children:"Trending Topics"}),e.jsx("span",{className:"heading__icon",children:n?e.jsx(ne,{color:o.white,size:16}):e.jsx(e.Fragment,{children:c?e.jsx(fo,{onClick:k,size:"small",startIcon:e.jsx(no,{})}):e.jsx(dt,{})})})]}),pt(v)?e.jsxs("div",{children:[e.jsx(z,{onClick:w=>I(w),startIcon:C?e.jsx(Q,{}):e.jsx(te,{}),children:C?"Pause":"Play All"}),e.jsx(mo,{ref:g,onEnded:Y,src:(D=v[p])==null?void 0:D.audio_EN,children:e.jsx("track",{kind:"captions"})})]}):null]}),v.length===0?e.jsxs("div",{className:"trending-empty",children:[e.jsx(yo,{children:O}),e.jsx(z,{color:"secondary",disabled:n,onClick:i,size:"medium",startIcon:e.jsx(Pt,{}),sx:{alignSelf:"flex-end",m:"0 36px 16px 0"},variant:"contained",children:"Add Content"})]}):e.jsx("ul",{className:"list",children:v.map(w=>e.jsxs(s,{align:"center",className:"list-item",direction:"row",justify:"space-between",onClick:()=>h(w.topic),children:[e.jsxs(uo,{children:[" #",ht(w)]}),w.tldr&&e.jsx(z,{onClick:$=>T($,w),children:"TLDR"})]},w.topic))})]}),l&&e.jsx(ro,{onClose:M,selectTrending:h,trend:l})]})},uo=r.div`
  width: 300px;
  overflow: hidden;
  text-overflow: ellipsis;
  line-height: 1.5;
...
`,mo=r.audio`
  height: 0;
  width: 0;
`,wo=390,jo=d.forwardRef(({onSubmit:t,subViewOpen:i},n)=>{const{isFetching:a,setTeachMe:c,setSidebarFilter:x}=R(b=>b),l=pe(),{setSidebarOpen:y,currentSearch:g,clearSearch:p,searchFormValue:f}=P(b=>b),[C]=Re(b=>[b.trendingTopicsFlag]),{setValue:u}=ge(),j=d.useRef(null),[v,m]=d.useState(!1);return d.useEffect(()=>{u("search",f)},[u,f]),d.useEffect(()=>{const b=j.current;if(!b)return;const k=()=>{m((b==null?void 0:b.scrollTop)>0)};b.addEventListener("scroll",k)},[]),e.jsxs(vo,{ref:n,id:"sidebar-wrapper",children:[e.jsx(Bo,{}),e.jsxs(Te,{className:Ne({"has-shadow":v}),children:[e.jsxs(Co,{children:[e.jsx(ut,{onSubmit:t}),e.jsx($o,{onClick:()=>{if(g){u("search",""),p(),x("all");return}t==null||t()},children:a?e.jsx(ne,{color:o.SECONDARY_BLUE,"data-testid":"loader",size:"20"}):e.jsx(e.Fragment,{children:g?e.jsx(Fe,{}):e.jsx(mt,{})})})]}),g&&e.jsx(So,{children:a?e.jsx(gt,{}):e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"left",children:[e.jsx("span",{className:"count",children:l.length}),e.jsx("span",{className:"label",children:" results"})]}),e.jsx("div",{className:"right",style:{alignItems:"center"},children:e.jsx(yt,{})})]})})]}),!i&&e.jsx(_o,{onClick:()=>{y(!1),c(!1)},children:e.jsx(ke,{})}),e.jsxs(To,{ref:j,children:[!g&&C&&e.jsx(Io,{children:e.jsx(ho,{onSubmit:t})}),e.jsx(s,{children:a?e.jsx(ls,{}):e.jsx(ns,{isSearchResult:!!g})})]})]})}),bo=["topic","person","guest","event","organization","place","project","software"],ko=({onSubmit:t})=>{const{sidebarIsOpen:i}=P(x=>x),n=A(),a=!!n&&i&&!bo.includes(n.node_type),{showTeachMe:c}=R(x=>x);return e.jsxs(e.Fragment,{children:[e.jsx(oe,{direction:"right",in:i,mountOnEnter:!0,unmountOnExit:!0,children:e.jsx(jo,{onSubmit:t,subViewOpen:a})}),e.jsx(Zi,{open:a||!!c}),!i&&e.jsx(io,{})]})},vo=r(s)(({theme:t})=>({position:"relative",background:o.BG1,height:"100vh",width:"100%",zIndex:30,[t.breakpoints.up("sm")]:{width:wo}})),Te=r(s).attrs({direction:"column",justify:"center",align:"stretch"})(({theme:t})=>({padding:t.spacing(3.75,2),[t.breakpoints.up("sm")]:{padding:"12px"},"&.has-shadow":{borderBottom:"1px solid rgba(0, 0, 0, 0.25)",background:o.BG1,boxShadow:"0px 1px 6px 0px rgba(0, 0, 0, 0.20)"}})),Co=r(s).attrs({direction:"row",justify:"center",align:"center"})`
  flex-grow: 1;
