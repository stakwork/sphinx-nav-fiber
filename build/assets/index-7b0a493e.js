import{o as s,F as o,T as w,p as C,r as f,j as e,q as c,A as S,aU as A,aV as b,aW as z,J as D,O as y}from"./index-a1863c79.js";import{B as G}from"./index-7f75954a.js";import{G as M,B as v,i as $,F as B}from"./index-2256eeb3.js";import{C as T}from"./ClipLoader-3f3df1ff.js";import{T as j}from"./index-3d5f41f8.js";import{S as E}from"./index-a6d1d079.js";import{e as I}from"./index.esm-72f2dc28.js";import{T as k,a as F}from"./Tabs-aa4538d6.js";import"./InfoIcon-3f256ad6.js";import"./useSlotProps-927602df.js";import"./createSvgIcon-5cf5e712.js";const R=({onClose:a})=>{const[l]=C(d=>[d.graphStyle]),[r,i]=f.useState(!1),p=()=>{i(!0),localStorage.setItem("graphStyle",l),i(!1),a()};return e.jsxs(W,{direction:"column",children:[e.jsx(V,{children:"Default graph view:"}),e.jsx(M,{}),e.jsx(o,{mt:308,py:24,children:e.jsx(v,{color:"secondary",disabled:r,id:"add-node-submit-cta",onClick:p,size:"large",startIcon:r&&e.jsx(L,{children:e.jsx(T,{color:c.lightGray,size:12})}),type:"submit",variant:"contained",children:"Save Changes"})})]})},W=s(o)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,V=s(w)`
