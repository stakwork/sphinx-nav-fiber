import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h as x,r as T,x as v,B as m}from"./index-1baf07e2.js";import{B}from"./index-7b5901f2.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-54b4ce32.js";import{B as f,T as $,a as k}from"./index-b5275642.js";import{T as u}from"./index-9e854179.js";import"./useSlotProps-411d1b80.js";import"./index.esm-b4b9dfc0.js";import"./InfoIcon-8011a09a.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
