...
`,ir=v.lazy(()=>ke(()=>import("./index-bffc7956.js"),["assets/index-bffc7956.js","assets/index-3953f5c7.js","assets/index-b4d03b7b.css","assets/index-f5c0a6ac.js","assets/SourcesTableIcon-cede0655.js","assets/index-77fd02b9.js","assets/CheckIcon-e323d974.js","assets/DeleteNodeIcon-2e5b1a42.js","assets/SoundIcon-d55715d0.js","assets/SucessFeedBackIcon-26120d5f.js","assets/ClipLoader-7b76ab2c.js","assets/TableRow-4d575251.js"]).then(({TweetAnalyze:e})=>({default:e}))),ar=()=>{const e=$(o=>o.setSelectedTweet),t=$(o=>o.selectedTweet),{tweetId:a}=fe(),[r,n]=v.useState(""),{open:i}=De("tweetAnalyze"),l=(a==null?void 0:a.split("&"))||[],c=o=>{i(),n(o)};return s.jsxs(or,{align:"stretch",basis:"100%",grow:1,shrink:1,children:[l.length>1?s.jsx(sr,{onClick:()=>{c("summary")},children:"Summary Report"}):null,l.map(o=>s.jsx(cr,{className:t===o?"selected":"",onClick:()=>e(o),children:s.jsx(Vt,{handleAnalyzeClick:()=>{c(o)},nodeId:o})},o)),s.jsx(ir,{tweetId:r})]})},sr=f.button`
  width: 100%;
  background: ${y.ANALYTICS_CARD_BG};
  color: ${y.white};
  padding: 16px 16px;
