...
`,re=r(o)`
  align-items: center;
  cursor: pointer;
`,ie=()=>{var b,C,S;const{close:s}=g("editNodeName"),u=Y({mode:"onChange"}),{watch:c,setValue:t,reset:h,getValues:d}=u,[x,N]=l.useState(!1),[j,w]=l.useState(!1),[n,F]=l.useState(),a=k(),{open:L}=g("removeNode");l.useEffect(()=>(n?t("name",n==null?void 0:n.name):a&&(t("name",a.name),t("image_url",(a==null?void 0:a.image_url)??"")),()=>{h()}),[n,t,h,a]),l.useEffect(()=>{(async()=>{if(!(!a||a.type!=="topic")){w(!0);try{const{data:i}=await q({search:a==null?void 0:a.name}),p=i.find(G=>G.name===a.name);F(p)}catch(i){console.log(i)}finally{w(!1)}}})()},[a]);const D=c("imageInputType"),R=c("name"),f=c("image_url");l.useEffect(()=>{t("imageInputType",ae(f))},[f,t]);const M=()=>{s()},m=n||a,A=async()=>{N(!0);const i={["name"]:R.trim(),image_url:f.trim()};try{await K((m==null?void 0:m.ref_id)||"",{node_data:i});const{updateNode:p}=O.getState();p({...m,...i}),M()}catch(p){console.warn(p)}finally{N(!1)}},U=async()=>{L()},v=(C=(b=d())==null?void 0:b.name)==null?void 0:C.trim(),V=v&&(n==null?void 0:n.name.trim())!==v,z=d().image_url&&(a==null?void 0:a.image_url)!==((S=d())==null?void 0:S.image_url),W=x||j||!!f&&!D||!V&&!z;return e.jsx(le,{children:e.jsxs(J,{...u,children:[j?e.jsx(o,{my:24,children:e.jsx(ee,{})}):e.jsx(ne,{}),e.jsxs(o,{direction:"row",mb:6,children:[e.jsx(ce,{color:"secondary",disabled:j||!m,onClick:U,size:"large",style:{marginRight:20},variant:"contained",children:"Delete"}),e.jsxs(_,{color:"secondary",disabled:W,onClick:A,size:"large",style:{flex:1},variant:"contained",children:["Save Changes",x&&e.jsx(de,{children:e.jsx(X,{color:y.lightGray,size:12})})]})]})]})})},le=r(o)`
  padding: 20px;
`,ce=r(_)`
  && {
    color: ${y.primaryRed};
