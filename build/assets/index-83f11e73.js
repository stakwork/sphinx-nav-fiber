...
`,ir=v.lazy(()=>ke(()=>import("./index-0ef45bf3.js"),["assets/index-0ef45bf3.js","assets/index-16330c52.js","assets/index-b4d03b7b.css","assets/index-69afc39c.js","assets/SourcesTableIcon-36fcc5af.js","assets/index-2547ffb2.js","assets/CheckIcon-60c6c98a.js","assets/DeleteNodeIcon-78f49b28.js","assets/SoundIcon-06d51d2e.js","assets/SucessFeedBackIcon-8807a76f.js","assets/ClipLoader-aec19a05.js","assets/TableRow-55ed2ca7.js"]).then(({TweetAnalyze:e})=>({default:e}))),ar=()=>{const e=$(o=>o.setSelectedTweet),t=$(o=>o.selectedTweet),{tweetId:a}=fe(),[r,n]=v.useState(""),{open:i}=De("tweetAnalyze"),l=(a==null?void 0:a.split("&"))||[],c=o=>{i(),n(o)};return s.jsxs(or,{align:"stretch",basis:"100%",grow:1,shrink:1,children:[l.length>1?s.jsx(sr,{onClick:()=>{c("summary")},children:"Summary Report"}):null,l.map(o=>s.jsx(cr,{className:t===o?"selected":"",onClick:()=>e(o),children:s.jsx(Vt,{handleAnalyzeClick:()=>{c(o)},nodeId:o})},o)),s.jsx(ir,{tweetId:r})]})},sr=f.button`
  width: 100%;
  background: ${y.ANALYTICS_CARD_BG};
  color: ${y.white};
  padding: 16px 16px;
