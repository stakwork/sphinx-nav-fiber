import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-ccbcf913.js";import{B as M}from"./index-afd26c51.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-8db1f6ed.js";import{B as f,T as L,a as R}from"./index-a6ae168c.js";import{T as x}from"./index-f2376303.js";import"./useSlotProps-261fbc24.js";import"./index.esm-4d529a46.js";import"./InfoIcon-f9bbc38f.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
