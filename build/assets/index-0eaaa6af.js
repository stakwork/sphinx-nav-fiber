import{r as h,g as q,c as Q,s as O,b as B,u as X,_ as K,j as e,e as J,f as Z,h as P,ak as ut,d as se,al as gt,p as d,q as x,E as N,F as g,U as M,bh as ft,an as te,R as ne,x as ie,ai as mt,bi as bt,bj as Ve,w as re,bk as Ye,af as ye,b1 as ke,b2 as _e,b3 as Ne,bl as jt,D as qe,bm as yt,bn as Qe,bo as wt,b0 as Ct,bp as le,bq as vt,C as Tt,N as St,V as $t}from"./index-225daac3.js";import{B as ce}from"./index-028e8fcd.js";import{C as kt,F as be,E as _t,b as Nt,P as zt,T as Bt,c as ze,V as Be,M as Ie,S as ue,a as It,A as Lt}from"./ThreeDotsIcons-3bdbc694.js";import{P as Rt}from"./PlusIcon-28e7a15d.js";import{B as H,h as we,E as Y,J as Et,d as ee,z as Ce,F as ve}from"./index-fb074efe.js";import{T as Le,s as D,a as Xe,S as Ke,A as Te,E as Mt,D as At,b as Je,Q as Ze,V as et,c as Ft}from"./constants-bb16bb34.js";import{C as z}from"./ClipLoader-b9823bf7.js";import{f as Ot,g as Wt,h as Ht,a as Pt}from"./index.esm-cd3ac1d1.js";import{S as tt}from"./SearchIcon-94b9de96.js";import{I as Dt,A as Se,T as ot}from"./index-df7a05d6.js";import{B as Ut,T as Gt}from"./index-5b6a0657.js";import{D as Vt}from"./DeleteIcon-7143f4c7.js";import{u as R}from"./index-6bd5411e.js";import{N as st,F as nt,A as rt}from"./NodeCircleIcon-78d6c44d.js";import{O as at}from"./constants-a6b58f4d.js";import{C as it}from"./CheckIcon-25c778f2.js";import{T as Re}from"./Typography-b784a560.js";import{T as Yt,a as qt}from"./Tabs-a63f10dd.js";import"./Stack-96c37d84.js";import"./createSvgIcon-fa89ed60.js";import"./TextareaAutosize-2d25e0aa.js";const Qt=h.createContext(),lt=Qt;function Xt(t){return q("MuiTable",t)}Q("MuiTable",["root","stickyHeader"]);const Kt=["className","component","padding","size","stickyHeader"],Jt=t=>{const{classes:o,stickyHeader:n}=t;return Z({root:["root",n&&"stickyHeader"]},Xt,o)},Zt=O("table",{name:"MuiTable",slot:"Root",overridesResolver:(t,o)=>{const{ownerState:n}=t;return[o.root,n.stickyHeader&&o.stickyHeader]}})(({theme:t,ownerState:o})=>B({display:"table",width:"100%",borderCollapse:"collapse",borderSpacing:0,"& caption":B({},t.typography.body2,{padding:t.spacing(2),color:(t.vars||t).palette.text.secondary,textAlign:"left",captionSide:"bottom"})},o.stickyHeader&&{borderCollapse:"separate"})),Ee="table",eo=h.forwardRef(function(o,n){const r=X({props:o,name:"MuiTable"}),{className:i,component:l=Ee,padding:a="normal",size:s="medium",stickyHeader:c=!1}=r,u=K(r,Kt),m=B({},r,{component:l,padding:a,size:s,stickyHeader:c}),p=Jt(m),j=h.useMemo(()=>({padding:a,size:s,stickyHeader:c}),[a,s,c]);return e.jsx(lt.Provider,{value:j,children:e.jsx(Zt,B({as:l,role:l===Ee?null:"table",ref:n,className:J(p.root,i),ownerState:m},u))})}),de=eo,to=h.createContext(),pe=to;function oo(t){return q("MuiTableBody",t)}Q("MuiTableBody",["root"]);const so=["className","component"],no=t=>{const{classes:o}=t;return Z({root:["root"]},oo,o)},ro=O("tbody",{name:"MuiTableBody",slot:"Root",overridesResolver:(t,o)=>o.root})({display:"table-row-group"}),ao={variant:"body"},Me="tbody",io=h.forwardRef(function(o,n){const r=X({props:o,name:"MuiTableBody"}),{className:i,component:l=Me}=r,a=K(r,so),s=B({},r,{component:l}),c=no(s);return e.jsx(pe.Provider,{value:ao,children:e.jsx(ro,B({className:J(c.root,i),as:l,ref:n,role:l===Me?null:"rowgroup",ownerState:s},a))})}),lo=io;function co(t){return q("MuiTableCell",t)}const po=Q("MuiTableCell",["root","head","body","footer","sizeSmall","sizeMedium","paddingCheckbox","paddingNone","alignLeft","alignCenter","alignRight","alignJustify","stickyHeader"]),xo=po,ho=["align","className","component","padding","scope","size","sortDirection","variant"],uo=t=>{const{classes:o,variant:n,align:r,padding:i,size:l,stickyHeader:a}=t,s={root:["root",n,a&&"stickyHeader",r!=="inherit"&&`align${P(r)}`,i!=="normal"&&`padding${P(i)}`,`size${P(l)}`]};return Z(s,co,o)},go=O("td",{name:"MuiTableCell",slot:"Root",overridesResolver:(t,o)=>{const{ownerState:n}=t;return[o.root,o[n.variant],o[`size${P(n.size)}`],n.padding!=="normal"&&o[`padding${P(n.padding)}`],n.align!=="inherit"&&o[`align${P(n.align)}`],n.stickyHeader&&o.stickyHeader]}})(({theme:t,ownerState:o})=>B({},t.typography.body2,{display:"table-cell",verticalAlign:"inherit",borderBottom:t.vars?`1px solid ${t.vars.palette.TableCell.border}`:`1px solid
    ${t.palette.mode==="light"?ut(se(t.palette.divider,1),.88):gt(se(t.palette.divider,1),.68)}`,textAlign:"left",padding:16},o.variant==="head"&&{color:(t.vars||t).palette.text.primary,lineHeight:t.typography.pxToRem(24),fontWeight:t.typography.fontWeightMedium},o.variant==="body"&&{color:(t.vars||t).palette.text.primary},o.variant==="footer"&&{color:(t.vars||t).palette.text.secondary,lineHeight:t.typography.pxToRem(21),fontSize:t.typography.pxToRem(12)},o.size==="small"&&{padding:"6px 16px",[`&.${xo.paddingCheckbox}`]:{width:24,padding:"0 12px 0 16px","& > *":{padding:0}}},o.padding==="checkbox"&&{width:48,padding:"0 0 0 4px"},o.padding==="none"&&{padding:0},o.align==="left"&&{textAlign:"left"},o.align==="center"&&{textAlign:"center"},o.align==="right"&&{textAlign:"right",flexDirection:"row-reverse"},o.align==="justify"&&{textAlign:"justify"},o.stickyHeader&&{position:"sticky",top:0,zIndex:2,backgroundColor:(t.vars||t).palette.background.default})),fo=h.forwardRef(function(o,n){const r=X({props:o,name:"MuiTableCell"}),{align:i="inherit",className:l,component:a,padding:s,scope:c,size:u,sortDirection:m,variant:p}=r,j=K(r,ho),b=h.useContext(lt),y=h.useContext(pe),C=y&&y.variant==="head";let w;a?w=a:w=C?"th":"td";let S=c;w==="td"?S=void 0:!S&&C&&(S="col");const $=p||y&&y.variant,A=B({},r,{align:i,component:w,padding:s||(b&&b.padding?b.padding:"normal"),size:u||(b&&b.size?b.size:"medium"),sortDirection:m,stickyHeader:$==="head"&&b&&b.stickyHeader,variant:$}),F=uo(A);let I=null;return m&&(I=m==="asc"?"ascending":"descending"),e.jsx(go,B({as:w,ref:n,className:J(F.root,l),"aria-sort":I,scope:S,ownerState:A},j))}),mo=fo;function bo(t){return q("MuiTableHead",t)}Q("MuiTableHead",["root"]);const jo=["className","component"],yo=t=>{const{classes:o}=t;return Z({root:["root"]},bo,o)},wo=O("thead",{name:"MuiTableHead",slot:"Root",overridesResolver:(t,o)=>o.root})({display:"table-header-group"}),Co={variant:"head"},Ae="thead",vo=h.forwardRef(function(o,n){const r=X({props:o,name:"MuiTableHead"}),{className:i,component:l=Ae}=r,a=K(r,jo),s=B({},r,{component:l}),c=yo(s);return e.jsx(pe.Provider,{value:Co,children:e.jsx(wo,B({as:l,className:J(c.root,i),ref:n,role:l===Ae?null:"rowgroup",ownerState:s},a))})}),ct=vo;function To(t){return q("MuiTableRow",t)}const So=Q("MuiTableRow",["root","selected","hover","head","footer"]),Fe=So,$o=["className","component","hover","selected"],ko=t=>{const{classes:o,selected:n,hover:r,head:i,footer:l}=t;return Z({root:["root",n&&"selected",r&&"hover",i&&"head",l&&"footer"]},To,o)},_o=O("tr",{name:"MuiTableRow",slot:"Root",overridesResolver:(t,o)=>{const{ownerState:n}=t;return[o.root,n.head&&o.head,n.footer&&o.footer]}})(({theme:t})=>({color:"inherit",display:"table-row",verticalAlign:"middle",outline:0,[`&.${Fe.hover}:hover`]:{backgroundColor:(t.vars||t).palette.action.hover},[`&.${Fe.selected}`]:{backgroundColor:t.vars?`rgba(${t.vars.palette.primary.mainChannel} / ${t.vars.palette.action.selectedOpacity})`:se(t.palette.primary.main,t.palette.action.selectedOpacity),"&:hover":{backgroundColor:t.vars?`rgba(${t.vars.palette.primary.mainChannel} / calc(${t.vars.palette.action.selectedOpacity} + ${t.vars.palette.action.hoverOpacity}))`:se(t.palette.primary.main,t.palette.action.selectedOpacity+t.palette.action.hoverOpacity)}}})),Oe="tr",No=h.forwardRef(function(o,n){const r=X({props:o,name:"MuiTableRow"}),{className:i,component:l=Oe,hover:a=!1,selected:s=!1}=r,c=K(r,$o),u=h.useContext(pe),m=B({},r,{component:l,hover:a,selected:s,head:u&&u.variant==="head",footer:u&&u.variant==="footer"}),p=ko(m);return e.jsx(_o,B({as:l,ref:n,className:J(p.root,i),role:l===Oe?null:"row",ownerState:m},c))}),U=No;function je(t){const o=new Date(Number(t)*1e3),n=o.getFullYear(),r=(1+o.getMonth()).toString().padStart(2,"0");return`${o.getDate().toString().padStart(2,"0")}/${r}/${n}`}const f=d(mo)`
  && {
    color: ${x.white};
    border: none;
...
`,xt=d(g)`
  ...
  justify-content: center;
  align-items: center;
`,ls=()=>{const[t,o]=h.useState(!0),[n,r]=h.useState(""),[i,l]=ie(p=>[p.sources,p.setSources]),[a]=qe(p=>[p.isAdmin]),[s,c]=h.useState("");h.useEffect(()=>{(async()=>{o(!0);try{const j=await Ye();l(j.data)}catch(j){console.warn(j)}finally{o(!1)}})()},[l]);const u=p=>{r(n===p||!p?"":p)},m=h.useMemo(()=>i==null?void 0:i.filter(p=>(!n||p.source_type===n)&&(p.source.toLowerCase().startsWith(s.toLowerCase())||p.source.toLowerCase().includes(s.toLowerCase())||`@${p.source.toLowerCase()}`.startsWith(s.toLowerCase())||`@${p.source.toLowerCase()}`.includes(s.toLowerCase()))),[s,n,i]);return e.jsxs(cs,{align:"stretch",direction:"column",justify:"flex-end",children:[e.jsx($e,{align:"center",direction:"row",justify:"space-between",children:e.jsx(N,{className:"title",children:"Sources for this Graph"})}),e.jsx(ps,{children:e.jsx(pt,{activeIcon:e.jsx(ee,{}),defaultIcon:e.jsx(tt,{}),loading:t,loadingIcon:e.jsx(z,{color:x.lightGray,size:24}),onSearch:c,placeholder:"Find Source"})}),e.jsxs(g,{className:"filters",direction:"row",pb:16,px:36,children:[e.jsx(ae,{className:re({selected:!n}),onClick:()=>u(""),size:"small",children:"All"}),Object.keys(D).map(p=>e.jsx(ae,{className:re({selected:p===n}),onClick:()=>u(p),size:"small",children:D[p]},p))]}),e.jsx(ds,{align:"center",justify:t?"center":"flex-start",children:t?e.jsx(z,{color:x.white}):e.jsx(os,{canEdit:a,data:m})})]})},cs=d(g)`
  flex: 1;
  .title {
    font-size: 20px;
    color: ${x.white};
...
`,Ys=d.span`
  margin-top: 2px;
`,qs=({topic:t,onClick:o,onSearch:n,checkedStates:r,setCheckedStates:i,isMuteDisabled:l})=>{const[a,s]=R(k=>[k.ids,k.total]),[c,u]=h.useState(!1),[m,p]=h.useState(!1),j=je(t.date_added_to_graph),b=async(k,T)=>{u(!0);try{await le(k,{node_data:{is_muted:T}}),R.setState({ids:a.filter(_=>_!==k),total:s-1})}catch(_){console.warn(_)}},y=k=>{i(T=>({...T,[k]:!T[k]}))},C=(k,T)=>{var _;(_=window.getSelection())!=null&&_.toString()?k.preventDefault():n(T.name)},w=t.edgeList.slice(0,1),S=t.edgeList.length-w.length,[$,A]=ne.useState(null),F=k=>{A(k.currentTarget),p(!0)},I=()=>{p(!1)},L=!!$&&m,W=r[t.ref_id]?"visible":"";return e.jsxs(xe,{className:r[t.ref_id]?"checked":"",children:[e.jsx(f,{children:e.jsx(Ks,{className:`checkbox-section ${W}`,"data-testid":"topic-check-box",onClick:()=>y(t.ref_id),children:e.jsx(Js,{checked:r[t.ref_id],children:e.jsx(Zs,{children:r[t.ref_id]&&e.jsx(it,{})})})})}),e.jsx(f,{onClick:k=>C(k,t),children:e.jsx(Xs,{children:t.name})}),e.jsx(f,{children:t.node_type}),e.jsx(f,{children:e.jsx(en,{children:t.edgeCount})}),e.jsxs(f,{children:[e.jsx(we,{anchorEl:$,anchorOrigin:{vertical:"top",horizontal:"center"},disableRestoreFocus:!0,id:"mouse-over-popover",onClose:I,onMouseEnter:()=>p(!0),onMouseLeave:I,open:L,sx:{pointerEvents:"auto","& .MuiPaper-root":{backgroundColor:"rgba(0, 0, 0, 0.9)",borderRadius:"4px",width:"160px",maxHeight:"200px",overflowY:"scroll"}},transformOrigin:{vertical:"bottom",horizontal:"center"},children:e.jsx(Re,{sx:{p:1.5,fontSize:"13px",fontWeight:400,lineHeight:"1.8",wordWrap:"break-word"},children:t.edgeList.join(", ")})}),w.join(", "),S>0&&e.jsx(Re,{"aria-haspopup":"true","aria-owns":L?"mouse-over-popover":void 0,component:"span",onMouseEnter:F,onMouseLeave:I,sx:{cursor:"pointer"},children:",..."})]}),e.jsx(f,{children:e.jsx("span",{children:j})}),e.jsx(f,{className:"cell-center",children:e.jsx(g,{direction:"row",justify:"space-between",children:e.jsx("div",{className:"approve-wrapper",children:c?e.jsx(Qs,{children:e.jsx(z,{color:x.white,size:16})}):e.jsxs(g,{direction:"row",children:[t.is_muted?e.jsx(Y,{className:"centered",disabled:l,onClick:()=>b(t.ref_id,!1),children:e.jsx(Nt,{})}):e.jsx(Y,{className:"centered",disabled:l,onClick:()=>b(t.ref_id,!0),children:e.jsx(zt,{})}),e.jsx(Y,{disabled:l,onClick:k=>o(k,t.ref_id),children:e.jsx(Bt,{"data-testid":"ThreeDotsIcons"})})]})})})})]},t.name)},Qs=d.span`
  margin-left: 12px;
`,Xs=d.span`
  cursor: pointer;
  :hover {
...
`,en=d.span`
  ...
  align-items: center;
  justify-content: center;
`,tn=h.memo(qs),on=({setShowMuteUnmute:t,showMuted:o,onTopicEdit:n,onChangeFilter:r,checkedStates:i,setCheckedStates:l})=>{const{close:a}=M("sourcesTable"),[s,c]=h.useState(!1),[u,m]=ne.useState(null),[p,j]=ne.useState(""),b=Object.values(i).filter(v=>v).length,[y,C]=Tt(v=>[v.setSearchFormValue,v.setCurrentSearch]),[w,S,$]=R(v=>[v.data,v.ids,v.total]),A=h.useCallback((v,E)=>{m(v.currentTarget),j(E)},[]),F=()=>{m(null)},I=v=>{y(v),C(v),a()},L=v=>{n(p,v),F()},W=v=>{r(v)},k=!!u,T=k?"simple-popover":void 0,_=async()=>{c(!0);try{const v=Object.keys(i).map(async G=>{if(i[G])try{return await le(G,{node_data:{is_muted:!o}}),G}catch(ht){return console.error("Error updating node data:",ht),null}return null}),E=await Promise.all(v);R.setState({ids:S.filter(G=>!E.includes(G)),total:$-E.length}),l({}),c(!1)}catch(v){console.error("Error:",v),c(!1)}};return w?e.jsx(e.Fragment,{children:Object.keys(w).length?e.jsx(pn,{align:"center",justify:s?"center":"flex-start",children:s?e.jsx(z,{color:x.white}):e.jsxs(e.Fragment,{children:[e.jsxs(de,{component:"table",children:[b>0?e.jsx(zo,{children:e.jsxs(U,{component:"tr",children:[e.jsx(f,{children:e.jsx(Y,{onClick:()=>l({}),children:e.jsx(ee,{})})}),e.jsx(f,{colSpan:12,children:e.jsxs(dn,{children:[e.jsxs(cn,{children:[e.jsx(ln,{children:b}),"selected"]}),e.jsx(f,{className:"empty"}),e.jsx(Ge,{onClick:_,role:"button",children:o?e.jsxs(e.Fragment,{children:[e.jsx(ze,{})," Unmute ALL"]}):e.jsxs(e.Fragment,{children:[e.jsx(Be,{})," Mute ALL"]})}),e.jsx(f,{className:"empty"}),e.jsxs(Ge,{onClick:()=>L("mergeTopic"),children:[e.jsx(Ie,{})," Merge"]})]})}),e.jsx(f,{className:"empty"})]})}):e.jsx(he,{children:e.jsxs(U,{component:"tr",children:[e.jsx(f,{className:"empty"}),e.jsx(f,{children:e.jsxs(me,{onClick:()=>W(Te),children:["Name ",e.jsx(ue,{})]})}),e.jsx(f,{children:"Type"}),e.jsx(f,{children:e.jsxs(me,{onClick:()=>W(Mt),children:["Count ",e.jsx(ue,{})]})}),e.jsx(f,{children:"Edge list"}),e.jsx(f,{children:e.jsxs(me,{onClick:()=>W(At),children:["Date ",e.jsx(ue,{})]})}),e.jsx(f,{children:e.jsx(g,{px:8,children:e.jsxs(sn,{onClick:t,children:[e.jsx(nn,{checked:o,children:e.jsx(rn,{children:o&&e.jsx(it,{})})}),"Muted"]})})})]})}),w&&e.jsx("tbody",{children:S==null?void 0:S.map(v=>e.jsx(tn,{checkedStates:i,isMuteDisabled:Object.values(i).filter(E=>E).length>1,onClick:A,onSearch:I,setCheckedStates:l,topic:w[v]},v))})]}),p?e.jsxs(an,{anchorEl:u,anchorOrigin:{vertical:"bottom",horizontal:"right"},id:T,onClose:F,open:k,transformOrigin:{vertical:"top",horizontal:"right"},children:[o?e.jsxs(V,{"data-testid":"unmute",onClick:()=>L("unMute"),children:[" ",e.jsx(ze,{"data-testid":""})," Unmute"]}):e.jsxs(V,{"data-testid":"mute",onClick:()=>L("mute"),children:[" ",e.jsx(Be,{"data-testid":"VisibilityOff"})," Mute"]}),e.jsxs(V,{"data-testid":"rename",onClick:()=>L("editTopic"),children:[e.jsx(It,{"data-testid":"EditTopicIcon"})," Rename"]}),e.jsxs(V,{"data-testid":"merge",onClick:()=>L("mergeTopic"),children:[e.jsx(Ie,{"data-testid":"MergeIcon"})," Merge"]}),e.jsxs(V,{"data-testid":"add_edge",onClick:()=>L("addEdge"),children:[e.jsx(Lt,{"data-testid":"AddCircleIcon"})," Add edge"]})]}):null]})}):e.jsxs(g,{children:[e.jsx(N,{children:"There is not any results for selected filters"}),e.jsx(be,{})]})}):e.jsxs(g,{children:[e.jsx(N,{children:"There is not any results for selected filters"}),e.jsx(be,{})]})},sn=d.td`
  cursor: pointer;
  display: flex;
  align-items: center;
`,nn=d.div`
...
`,me=d.span`
  ...
  gap: 4px;
  align-items: center;
`,V=d(g).attrs({direction:"row",px:12,py:8})`
  display: flex;
  align-items: center;
...
`,pn=d(g)`
  ...
  width: 100%;
  position: relative;
`,xn=()=>{const[t,o,n,r,i,l,a,s]=R(T=>[T.data,T.ids,T.total,T.setTopics,T.filters,T.setFilters,T.terminate,T.loading]),{open:c}=M("editTopic"),{open:u}=M("mergeTopic"),{open:m}=M("addEdge"),[p,j]=h.useState(null),[b,y]=h.useState([]),[C,w]=h.useState({}),S={editTopic:c,mergeTopic:u,addEdge:m},$=h.useRef([]);h.useEffect(()=>{o.length&&($.current=o)},[o]),h.useEffect(()=>{(async()=>{try{await r()}catch{console.error("err")}})()},[r,i]);const A=async()=>{l({page:i.page+1})};h.useEffect(()=>()=>{a()},[a]);const F=T=>{l({sortBy:T})},I=()=>{j(null),y([])},L=async(T,_)=>{try{await le(T,{node_data:{is_muted:_==="mute"}}),R.setState({ids:o.filter(v=>v!==T),total:n-1})}catch(v){console.warn(v)}},W=async(T,_)=>{if(t)if(_==="mergeTopic")if(Object.values(C).filter(v=>v).length>0){const v=Object.entries(C).filter(([,E])=>E).map(([E])=>t[E]);y(v),u()}else y([t[T]]),j(t[T]),u();else["mute","unMute"].includes(_)&&await L(T,_),typeof S[_]=="function"&&S[_](),j(t[T])},k=T=>{l({...i,search:T})};return e.jsxs(e.Fragment,{children:[e.jsxs(hn,{direction:"column",justify:"flex-end",children:[e.jsx($e,{align:"flex-start",direction:"row",justify:"space-between",children:e.jsx(N,{className:"title",children:"Topics"})}),e.jsx(gn,{"data-testid":"topic-search-container",children:e.jsx(pt,{activeIcon:e.jsx(ee,{}),defaultIcon:e.jsx(tt,{}),loading:s,loadingIcon:e.jsx(z,{color:x.lightGray,size:24}),onSearch:k,placeholder:"Search ..."})}),e.jsx(un,{align:"center",justify:s&&!t?"center":"flex-start",children:s&&!t?e.jsx(z,{color:x.white}):e.jsxs(e.Fragment,{children:[e.jsx(on,{checkedStates:C,onChangeFilter:F,onTopicEdit:W,setCheckedStates:w,setShowMuteUnmute:()=>l({is_muted:!i.is_muted}),showMuted:i.is_muted}),n>o.length?e.jsxs(H,{className:"load-more",disabled:s,onClick:A,children:["Load more",s&&e.jsx(z,{color:x.lightGray,size:10})]}):null]})})]}),b.length>0&&e.jsx(Gs,{multiTopics:b,onClose:I}),p&&e.jsx(zs,{onClose:I,topic:p}),p&&e.jsx(Ss,{onClose:I,topic:p})]})},hn=d(g)`
  flex: 1;
...
`,gn=d(g)`
  margin: 0 0 16px 36px;
`,fn=[{label:et,component:Fo},{label:Ft,component:ls},{label:Ze,component:Xo},{label:Je,component:xn}],mn=t=>{const{children:o,value:n,index:r,...i}=t;return n===r?e.jsx(Cn,{"aria-labelledby":`simple-tab-${r}`,hidden:n!==r,id:`simple-tabpanel-${r}`,role:"tabpanel",...i,children:o}):null};function bn(t){return{id:`simple-tab-${t}`,"aria-controls":`simple-tabpanel-${t}`}}const jn=()=>{const[t,o]=h.useState(0),[n]=qe(s=>[s.isAdmin]),[r]=St(s=>[s.queuedSourcesFeatureFlag]),i=$t(),l=(s,c)=>{o(c)},a=fn.filter(({label:s})=>s===Je?n:s===Ze?n&&r:s===et?i:!0);return e.jsxs(vn,{"data-testid":"sources-table",direction:"column",children:[e.jsx(yn,{"aria-label":"sources tabs",onChange:l,value:t,children:a.map((s,c)=>e.jsx(wn,{color:x.white,disableRipple:!0,label:s.label,...bn(c)},s.label))}),a.map((s,c)=>e.jsx(mn,{index:c,value:t,children:e.jsx(s.component,{})},s.label))]})},yn=d(Yt)`
  && {
...
`,Vn=()=>{const{close:t}=M("sourcesTable"),{visible:o}=M("addContent");return o?null:e.jsx(ce,{background:"BG1",id:"sourcesTable",kind:"large",noWrap:!0,onClose:t,preventOutsideClose:!0,children:e.jsx(jn,{})})};export{Vn as SourcesTableModal};
