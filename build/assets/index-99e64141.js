import{s as f,c as y,u as z,r as p,j as e,F as t,T as h,b as N,x as R,o as U,ad as V,ae as g,d as G,a2 as q}from"./index-8bba1ac7.js";import{ak as J,B as j,al as Y,l as H,u as K,F as Q}from"./react-toastify.esm-5ee78250.js";import{B as W}from"./index-6478aa51.js";import{n as S}from"./toastMessage-a6b5717c.js";import{u as X}from"./index-7c39f604.js";import{C as Z}from"./CheckIcon-297ff908.js";import{C as ee}from"./ClipLoader-1e33f199.js";import{T as B}from"./index-28b591f6.js";import{A as te}from"./index-6d78266f.js";import{i as v,O as L}from"./constants-84edb5fc.js";import"./index.esm-8f5ab791.js";import"./InfoIcon-efa6a53f.js";import"./index-ba879fc6.js";import"./Popover-d30a9834.js";import"./useSlotProps-cf9b0d61.js";import"./Select-14e93e9e.js";import"./Stack-22c0aa66.js";import"./Popper-e6f73086.js";const ne=({onClick:n,loading:a})=>{const d=z(l=>l.budget),[c,m]=p.useState(10),s="node";return p.useEffect(()=>{(async()=>{try{const r=await Y(s);m(r.data.price)}catch(r){console.error("cannot fetch",r)}})()},[s]),e.jsxs(t,{children:[e.jsx(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:e.jsx(t,{align:"center",direction:"row",children:e.jsx(re,{children:"Approve Cost"})})}),e.jsxs(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:[e.jsxs(oe,{children:[e.jsx("div",{className:"title",children:"COST"}),e.jsxs("div",{className:"value","data-testid":"check-price",children:[c," sats"]})]}),e.jsxs(se,{children:[e.jsx("div",{className:"title",children:"BUDGET"}),e.jsxs("div",{className:"value",children:[J(d)," sats"]})]})]}),e.jsx(t,{children:e.jsx(j,{color:"secondary","data-testid":"check-icon",disabled:a,onClick:n,size:"large",startIcon:a?e.jsx(ee,{size:24}):e.jsx(Z,{}),type:"submit",variant:"contained",children:"Approve"})})]})},oe=f(t).attrs({direction:"column",align:"space-between",justify:"flex-start"})`
  width: 141px;
  height: 61px;
