import{o as s,F as o,T as w,p as C,r as f,j as e,q as c,A as S,aU as A,aV as b,aW as M,M as z,Q as y}from"./index-13285a6c.js";import{B as D}from"./index-8db36a05.js";import{G,B as v,i as $,F as B}from"./index-ca8a4a56.js";import{C as T}from"./ClipLoader-7890335c.js";import{T as j}from"./index-dbbb49e1.js";import{S as E}from"./index-25117663.js";import{e as I}from"./index.esm-5284d15d.js";import{T as k,a as F}from"./Tabs-54a3bb0e.js";import"./InfoIcon-b40eb594.js";import"./useSlotProps-79473e42.js";import"./createSvgIcon-5193327e.js";const R=({onClose:a})=>{const[l]=C(d=>[d.graphStyle]),[r,i]=f.useState(!1),p=()=>{i(!0),localStorage.setItem("graphStyle",l),i(!1),a()};return e.jsxs(W,{direction:"column",children:[e.jsx(V,{children:"Default graph view:"}),e.jsx(G,{}),e.jsx(o,{mt:308,py:24,children:e.jsx(v,{color:"secondary",disabled:r,id:"add-node-submit-cta",onClick:p,size:"large",startIcon:r&&e.jsx(L,{children:e.jsx(T,{color:c.lightGray,size:12})}),type:"submit",variant:"contained",children:"Save Changes"})})]})},W=s(o)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,V=s(w)`
