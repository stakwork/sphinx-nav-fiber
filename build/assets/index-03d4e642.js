import{s as r,F as n,T as g,j as e,b as w,c,r as A,u as B}from"./index-56a19120.js";import{B as v}from"./index-7de98fdb.js";import{u as F}from"./index-eda8d570.js";import{u as M,G as $,l as C,b,q as D,F as G}from"./react-toastify.esm-943194c6.js";import{B as f,T as k,a as R}from"./index-2b2cce26.js";import{T as x}from"./index-fc21fb19.js";import{C as L}from"./ClipLoader-fbb11b80.js";import"./useSlotProps-9ca51873.js";import"./index.esm-2a1100f5.js";import"./InfoIcon-ecf7fa88.js";const P=({onClose:s})=>{const[a]=M(t=>[t.graphStyle]),i=()=>{localStorage.setItem("graphStyle",a),s()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:i,children:"Save changes"})})]})},V=r(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=r(g)`
