...
`,gt=[["Searching","Podcast Index"],["Searching","YouTube"],["Searching","Twitter Spaces"],["Finding","Transcripts"],["Loading","Audio Clips"],["Loading","Video Clips"],["Preparing","Results"]],Ao=()=>{const[e,t]=z.useState(0);return z.useEffect(()=>{if(e===gt.length-1)return;const n=setTimeout(()=>t(r=>(r+1)%gt.length),2e3);return()=>clearTimeout(n)},[e]),s.jsx(Po,{direction:"column",children:gt.map((n,r)=>s.jsxs(g,{className:ze("raw-wrapper",{show:e===r}),direction:"row",children:[s.jsx("div",{className:ze("action"),children:n[0]}),s.jsx("div",{className:ze("entity"),children:n[1]}),s.jsx("div",{children:s.jsx(So,{color:y.SECONDARY_BLUE,size:2})})]},n[1]))})},Po=j(g)`
  overflow: hidden;
  height: 20px;
  position: relative;
  .action {
...
`,Mo=j(g)`
  ...
  font-weight: 600;
  line-height: 17px;
`,Ro=({text:e,type:t,sourceLink:n})=>s.jsxs(g,{direction:"column",children:[s.jsx(g,{align:"center",direction:"row",children:s.jsx(We,{type:t})}),s.jsx(_t,{"data-testid":"episode-description",children:e}),s.jsx(g,{align:"center",direction:"row",justify:"flex-start",children:n&&s.jsxs(Do,{href:n,onClick:r=>r.stopPropagation(),target:"_blank",children:[s.jsx(gr,{}),s.jsx(Fo,{children:n})]})})]}),Do=j.a`
  color: ${y.GRAY6};
  font-size: 16px;
  height: 16px;
  display: flex;
...
`,Ko=({isSearchResult:e})=>{const t=z.useRef(null),n=e?80:10,{setSelectedNode:r,setSelectedTimestamp:i}=de(k=>k),{currentSearch:o,setSidebarOpen:l,setRelevanceSelected:a}=ce(k=>k),[u,c]=z.useState(0),p=ur(),f=u*n+n,h=p&&p.length>0?p.length-1>f:!1,w=wo("sm","down"),b=z.useCallback(k=>{Si(k),i(k),a(!0),r(k),w&&l(!1)},[r,a,l,i,w]),E=z.useMemo(()=>{if(p){const k=[...p].sort((S,I)=>(I.date||0)-(S.date||0));return o&&k.sort((S,I)=>{const O=S.node_type==="topic"&&S.name.toLowerCase()===o.toLowerCase()?1:0;return(I.node_type==="topic"&&I.name.toLowerCase()===o.toLowerCase()?1:0)-O}),k.slice(0,f)}return[]},[p,o,f]);return s.jsx(s.Fragment,{children:s.jsxs(Lo,{ref:t,id:"search-result-list",shrink:1,children:[(E??[]).map((k,S)=>{const{image_url:I,date:O,boost:L,type:v,episode_title:D,show_title:G,node_type:$,text:V,source_link:A,link:_,name:H,verified:q=!1,twitter_handle:F}=k||{};return s.jsx(Tr,{boostCount:L||0,date:O||0,episodeTitle:rt(D),imageUrl:I||"",link:_,name:H||"",onClick:()=>{b(k)},showTitle:rt(G),sourceLink:A,text:V||"",twitterHandle:F,type:$||v,verified:q},S.toString())}),s.jsx(el,{align:"center",background:"BG1",direction:"row",justify:"center",children:h&&s.jsx(ye,{onClick:()=>{h&&c(u+1)},size:"medium",children:"Load More"})})]})})},Jo=z.memo(Ko),el=j(g)`
  flex: 0 0 86px;
`,tl=({isSearchResult:e})=>{const{nodeCount:t,setNodeCount:n,setBudget:r}=cr(l=>l),{fetchData:i}=de(l=>l),o=async()=>{t<1||(await i(r,{skip_cache:"true"}),n("CLEAR"))};return s.jsxs(il,{children:[!e&&s.jsxs("div",{className:"heading-container",children:[s.jsxs("div",{className:"heading",children:[s.jsx("span",{className:"heading__title",children:"Latest"}),s.jsx("span",{className:"heading__icon",children:s.jsx(_o,{})})]}),t?s.jsx("div",{className:"button_container",children:s.jsx(nl,{className:"button","data-testid":"see_latest_button",onClick:o,startIcon:s.jsx(zo,{}),children:`See Latest (${t})`})}):null]}),s.jsx(Jo,{isSearchResult:e})]})},nl=j(ye)`
  && {
    width: 100%;
    margin-top: 1.2rem;
    font-weight: 500;
...
`,mn=({text:e})=>s.jsxs(g,{align:"center",justify:"center",py:12,children:[s.jsx(g,{align:"center",py:12,children:s.jsx(vr,{color:y.white})}),s.jsx(g,{align:"center",py:12,children:s.jsx(X,{children:e})})]}),bl=()=>{const[e,t,n,r]=Sr(o=>[o.teachMeAnswer,o.hasTeachingInProgress,o.instgraphAnswser,o.hasInstagraphInProgress]),i=!r&&!!(n!=null&&n.edges)&&!!(n!=null&&n.nodes);return s.jsxs(s.Fragment,{children:[i?s.jsx(Hi,{edges:n==null?void 0:n.edges,nodes:n==null?void 0:n.nodes}):s.jsx(mn,{text:"Generating instagraph"}),t?s.jsx(mn,{text:"Generating tutorial"}):s.jsxs(s.Fragment,{children:[s.jsx(kl,{children:s.jsx(X,{children:e})}),s.jsx(hl,{})]})]})};j(ye)``;const kl=j(g)`
  padding-left: 10px;
  padding-right: 10px;
...
`;function pt(e,t){if(!(t!=null&&t.trim()))return e;const n=new RegExp(`(${t})`,"gi"),r=e.split(n);return s.jsx(s.Fragment,{children:r.map((i,o)=>n.test(i)?s.jsx(vl,{children:i},o):i)})}const vl=j.span`
  ...
  border-radius: 3px;
  color: inherit;
`,El=({stateless:e,node:t,searchTerm:n})=>s.jsxs(g,{grow:1,shrink:1,children:[s.jsx(Il,{children:e&&s.jsxs(Tl,{children:[s.jsx("div",{className:"icon",children:s.jsx(yr,{})}),s.jsx("div",{className:"title",children:"Description"})]})}),s.jsx(X,{children:t!=null&&t.description?pt(t.description,n):"..."})]}),Tl=j(g).attrs({direction:"row",align:"center"})`
  .icon {
    font-size: 16px;
    color: ${y.GRAY3};
    margin-right: 7px;
...
`,Ir=({node:e})=>{const t=de(b=>b.selectedNode),n=ce(b=>b.currentSearch),{link:r,image_url:i,date:o,boost:l,node_type:a,type:u,id:c,show_title:p,episode_title:d,ref_id:f}=e||t||{},[h,w]=z.useState(l||0);return!e&&!t?null:s.jsx("div",{style:{overflow:"auto",flex:1,width:"100%"},children:s.jsxs(Ml,{children:[s.jsx(Dl,{boostCount:h||0,date:o||0,episodeTitle:rt(d),imageUrl:i,isSelectedView:!0,link:r,onClick:()=>null,showTitle:p,type:a||u}),s.jsx(yt,{}),s.jsxs(Rl,{children:[s.jsx(Gt,{amt:h}),s.jsx(br,{content:e||t,count:h,refId:f,updateCount:w})]}),s.jsx(yt,{}),s.jsx(gn,{children:s.jsx(El,{node:e||t,searchTerm:n,stateless:!0})}),((t==null?void 0:t.text)||(e==null?void 0:e.text))&&s.jsxs(s.Fragment,{children:[s.jsx(yt,{}),s.jsx(gn,{children:s.jsx(Pl,{node:e||t,stateless:!0},c)})]})]})})},Ml=j(g)`
  flex: 1;
  min-height: 100%;
  flex-direction: column;
...
`,Ms=j.audio`
  height: 0;
  width: 0;
`,Rs=["clip","twitter_space","youtube","episode","podcast"],Ds=()=>{const e=fe(),{showTeachMe:t}=de(r=>r),{setPlayingNode:n}=at(r=>r);if(z.useEffect(()=>{Rs.includes((e==null?void 0:e.node_type)||"")&&n(e)},[n,e]),t)return s.jsx(bl,{});switch(e==null?void 0:e.node_type){case"guest":case"person":return s.jsx(ds,{});case"data_series":return s.jsx(Cl,{});case"tribe_message":return s.jsx(us,{});case"tweet":return s.jsx(js,{});case"topic":return s.jsx(ks,{});case"show":return s.jsx(bs,{});case"youtube":case"podcast":case"clip":case"twitter_space":return s.jsx(Ir,{});case"document":return s.jsx(_s,{});case"episode":return s.jsx(is,{},e.ref_id);case"image":return s.jsx(as,{});default:return s.jsx(As,{})}},Fs=z.memo(Ds),Ns=({isPlaying:e,isFullScreen:t,setIsPlaying:n,playingTime:r,duration:i,handleProgressChange:o,handleVolumeChange:l,onFullScreenClick:a,showToolbar:u})=>s.jsxs(g,{children:[(!u||t)&&s.jsx(Gs,{"aria-label":"Small","data-testid":"progress-bar",isFullScreen:t,max:i,onChange:o,size:"small",value:r}),s.jsxs($s,{align:"center",direction:"row",showToolbar:u||t,children:[s.jsx(Hs,{onClick:n,size:"small",children:e?s.jsx(ut,{}):s.jsx(Ht,{})}),s.jsxs(Ys,{direction:"row",children:[s.jsx("span",{children:xn(r)}),s.jsx("span",{className:"separator",children:"/"}),s.jsx("span",{className:"duration",children:xn(i)})]}),s.jsxs(Vs,{direction:"row",px:9,children:[s.jsx(jr,{className:"volume-slider",defaultValue:.5,max:1,min:0,onChange:l,size:"small",step:.1}),s.jsx(Zi,{})]}),s.jsx(Us,{"data-testid":"fullscreen-button",onClick:()=>a(),children:t?s.jsx(Ji,{}):s.jsx(Ki,{})})]})]}),$s=j(g)`
  height: 60px;
  padding: 12px 16px;
  ${e=>e.showToolbar&&`
    position: fixed;
...
`,l0=j(g).attrs({align:"center",justify:"center",p:5})`
  font-size: 32px;
  color: ${y.mainBottomIcons};
  cursor: pointer;
...
`,s0=j(g).attrs({align:"center",justify:"center",p:8})(({theme:e})=>({backgroundColor:y.BG1_NORMAL,cursor:"pointer",transitionDuration:"0.2s",position:"absolute",right:"0px",top:"50%",zIndex:1,width:"24px",height:"48px",transform:"translateY(-50%)",borderRadius:"0px 6px 6px 0px",boxShadow:"2px 0px 6px 0px rgba(0, 0, 0, 0.25) inset",color:y.white,[e.breakpoints.up("sm")]:{left:"100%"},"&:hover":{backgroundColor:y.BG1_HOVER},"&:active":{backgroundColor:y.BG1_PRESS,color:y.GRAY6}})),a0=j(g)(()=>({overflow:"auto",flex:1,width:"100%"})),u0=j(g)`
  height: 64px;
  background: ${y.BG2};
`,c0=j(g)`
  padding: 0;
