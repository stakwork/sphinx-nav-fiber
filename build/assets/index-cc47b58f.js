import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-b2ff16a5.js";import{B}from"./index-199b4cde.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-01a5e0c7.js";import{B as f,T as $,a as k}from"./index-658208c4.js";import{T as u}from"./index-79e8d037.js";import"./useSlotProps-ce221909.js";import"./index.esm-ed5215c3.js";import"./InfoIcon-25e60a0e.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
