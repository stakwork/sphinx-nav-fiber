import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-d0e1c078.js";import{B as F}from"./index-e3af0b5c.js";import{u as M}from"./index-856fadec.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-25edabcb.js";import{B as f,T as R,a as L}from"./index-80c488e8.js";import{T as x}from"./index-dd16ccf9.js";import"./useSlotProps-f3572359.js";import"./index.esm-3845eb66.js";import"./InfoIcon-5181f5af.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
