import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-b648bda2.js";import{B as F}from"./index-47846cf0.js";import{u as M}from"./index-508aaedf.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-97ee9838.js";import{B as f,T as R,a as L}from"./index-f6ada33d.js";import{T as x}from"./index-70164c7c.js";import"./useSlotProps-0887689d.js";import"./index.esm-cd549611.js";import"./InfoIcon-bd087e20.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
