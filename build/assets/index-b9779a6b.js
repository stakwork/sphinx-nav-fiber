import{s as i,F as n,T as g,j as e,b as w,c as p,r as A,u as B}from"./index-8bba1ac7.js";import{B as v}from"./index-6478aa51.js";import{u as F}from"./index-7c39f604.js";import{u as M,G as $,l as C,b,q as D,F as G}from"./react-toastify.esm-5ee78250.js";import{B as f,T as k,a as R}from"./index-a97925f0.js";import{T as x}from"./index-28b591f6.js";import{C as L}from"./ClipLoader-1e33f199.js";import"./useSlotProps-cf9b0d61.js";import"./index.esm-8f5ab791.js";import"./InfoIcon-efa6a53f.js";const P=({onClose:s})=>{const[a]=M(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",a),s()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
