import{r as n,j as e,s as f,g as T,F as S,o as K,c as U,A as ae,p as ce,i as le,q as pe,H as de,t as ue,v as fe,f as q}from"./index-33d20918.js";import{Universe as me}from"./index-0660699a.js";import{u as he}from"./index-eab7361b.js";import{u as W,a as ge,b as xe,I as ye,c as Q,d as V}from"./index-800db796.js";import{M as be,V as we}from"./VolumeIcon-b797f11b.js";import{S as je,R as ve,s as X,M as Se}from"./index-34e895af.js";import"./index-7a74e4cc.js";import"./VisibilityOn-88c09f53.js";import"./SourcesTableIcon-ffc54863.js";import"./NodeCircleIcon-4358d821.js";import"./CheckIcon-b1296d72.js";import"./DeleteNodeIcon-94e0e7d1.js";import"./EditNodeIcon-3a23ae7e.js";import"./SearchIcon-b74a18fa.js";import"./SoundIcon-450b8c36.js";import"./SucessFeedBackIcon-9fa75dac.js";import"./three.module-1c1ec8b9.js";import"./TextareaAutosize-58bdd08c.js";import"./index-df9b5920.js";import"./index-1ef4a765.js";import"./index-868179de.js";import"./ClipLoader-7825dac3.js";import"./Skeleton-81c1526a.js";import"./Stack-4c05965e.js";import"./index-2cc9d5d6.js";import"./FormControlLabel-de7fb8ed.js";import"./Typography-fda875f5.js";import"./createSvgIcon-4e46db87.js";import"./isPlainObject-050e7b2d.js";function D(t){const[i,s,r]=t.split(":").map(Number);return Number((i*60*60*1e3+s*60*1e3+r*1e3).toFixed(6))}const Z=n.memo(()=>{const t=W(a=>a.isPlaying),i=W(a=>a.setIsPlaying),s=W(a=>a.setVolume),r=W(a=>a.setPlaybackSpeed),c=W(a=>a.playbackSpeed),o=W(a=>a.playerRef),[x,b]=n.useState(!1),m=[.5,1,1.5,2],g=()=>{if(o){const a=o.getCurrentTime()-15;o.seekTo(a,"seconds")}},p=()=>{if(o){const a=o.getCurrentTime()+15;o.seekTo(a,"seconds")}},j=()=>{i(!t)},d=()=>{b(!x),s(x?1:0)},h=()=>{const I=(m.indexOf(c)+1)%m.length,F=m[I];if(r(F),o){const P=o.getInternalPlayer();P&&typeof P.playbackRate<"u"&&(P.playbackRate=F)}};return e.jsxs(ke,{children:[e.jsx(Pe,{onClick:d,children:x?e.jsx(be,{}):e.jsx(we,{})}),e.jsx(Te,{onClick:g,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(Ce,{"data-testid":"play-pause-button",onClick:j,size:"small",children:t?e.jsx(ge,{"data-testid":"pause-icon"}):e.jsx(xe,{"data-testid":"play-icon"})}),e.jsx(Ie,{onClick:p,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(_e,{onClick:h,children:[c,"x"]})]})});Z.displayName="Controls";const ke=f(S).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${T.BG1};
  border-radius: 40px;
