import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-bea49af7.js";import{B}from"./index-1fb3a29b.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-80c07171.js";import{B as f,T as $,a as k}from"./index-d6555e30.js";import{T as u}from"./index-79216f29.js";import"./useSlotProps-75ed05d5.js";import"./index.esm-4538792a.js";import"./InfoIcon-5b946ab4.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
