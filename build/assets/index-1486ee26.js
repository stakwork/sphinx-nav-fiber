import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-70bf1cd1.js";import{B}from"./index-a48065f6.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-6b2a5193.js";import{B as f,T as $,a as k}from"./index-92a046fe.js";import{T as u}from"./index-77fe4f2e.js";import"./useSlotProps-814ba413.js";import"./index.esm-adce71f0.js";import"./InfoIcon-4dc4c8e8.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
