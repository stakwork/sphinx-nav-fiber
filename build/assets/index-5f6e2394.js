import{r as n,j as e,s as f,g as T,F as S,o as K,c as U,A as ae,p as ce,i as le,q as pe,H as de,t as ue,v as fe,f as q}from"./index-aa3f7c3e.js";import{Universe as me}from"./index-6855f6a3.js";import{u as he}from"./index-0b2fb7b6.js";import{u as W,a as ge,b as xe,I as ye,c as Q,d as V}from"./index-25c6daa7.js";import{M as be,V as we}from"./VolumeIcon-9b1a5788.js";import{S as je,R as ve,s as X,M as Se}from"./index-bf5b5937.js";import"./index-43438d75.js";import"./VisibilityOn-78ee8ba9.js";import"./SourcesTableIcon-f63602ba.js";import"./NodeCircleIcon-c52d6fa4.js";import"./CheckIcon-89adf22b.js";import"./DeleteNodeIcon-c22b6179.js";import"./EditNodeIcon-797b1558.js";import"./SearchIcon-023bc698.js";import"./SoundIcon-5b2d6e8e.js";import"./SucessFeedBackIcon-b858aa62.js";import"./three.module-4d3d7244.js";import"./TextareaAutosize-b3029b43.js";import"./index-af0d207e.js";import"./index-a339f0ca.js";import"./index-92d62591.js";import"./ClipLoader-155dca99.js";import"./Skeleton-c111bb41.js";import"./Stack-b4a3e0db.js";import"./index-3143af42.js";import"./FormControlLabel-aa9aac12.js";import"./Typography-8f286ca3.js";import"./createSvgIcon-9136ee64.js";import"./isPlainObject-ccdecae5.js";function D(t){const[i,s,r]=t.split(":").map(Number);return Number((i*60*60*1e3+s*60*1e3+r*1e3).toFixed(6))}const Z=n.memo(()=>{const t=W(a=>a.isPlaying),i=W(a=>a.setIsPlaying),s=W(a=>a.setVolume),r=W(a=>a.setPlaybackSpeed),c=W(a=>a.playbackSpeed),o=W(a=>a.playerRef),[x,b]=n.useState(!1),m=[.5,1,1.5,2],g=()=>{if(o){const a=o.getCurrentTime()-15;o.seekTo(a,"seconds")}},p=()=>{if(o){const a=o.getCurrentTime()+15;o.seekTo(a,"seconds")}},j=()=>{i(!t)},d=()=>{b(!x),s(x?1:0)},h=()=>{const I=(m.indexOf(c)+1)%m.length,F=m[I];if(r(F),o){const P=o.getInternalPlayer();P&&typeof P.playbackRate<"u"&&(P.playbackRate=F)}};return e.jsxs(ke,{children:[e.jsx(Pe,{onClick:d,children:x?e.jsx(be,{}):e.jsx(we,{})}),e.jsx(Te,{onClick:g,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(Ce,{"data-testid":"play-pause-button",onClick:j,size:"small",children:t?e.jsx(ge,{"data-testid":"pause-icon"}):e.jsx(xe,{"data-testid":"play-icon"})}),e.jsx(Ie,{onClick:p,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(_e,{onClick:h,children:[c,"x"]})]})});Z.displayName="Controls";const ke=f(S).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${T.BG1};
  border-radius: 40px;
