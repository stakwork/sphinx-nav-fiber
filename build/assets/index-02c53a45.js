import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-6865c215.js";import{B as F}from"./index-41b2a75e.js";import{u as M}from"./index-27c0e8db.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-22bb4a54.js";import{B as f,T as R,a as L}from"./index-15aedafe.js";import{T as x}from"./index-e40a00bc.js";import"./useSlotProps-3d116945.js";import"./index.esm-6af15a5e.js";import"./InfoIcon-bad0ebb4.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
