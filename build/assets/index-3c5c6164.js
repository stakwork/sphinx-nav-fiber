import{s as i,F as n,T as g,j as e,b as w,c as p,r as A,u as B}from"./index-f76464f2.js";import{B as v}from"./index-47dde8aa.js";import{u as F}from"./index-9c3b490f.js";import{u as M,G as $,l as C,b,q as D,F as G}from"./react-toastify.esm-bb128754.js";import{B as f,T as k,a as R}from"./index-683f9056.js";import{T as x}from"./index-2c3c416b.js";import{C as L}from"./ClipLoader-634bea35.js";import"./useSlotProps-2c3c97df.js";import"./index.esm-a945e31d.js";import"./InfoIcon-d72751f5.js";const P=({onClose:s})=>{const[a]=M(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",a),s()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
