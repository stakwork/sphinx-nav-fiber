import{r as i,j as e,s as u,g as S,F as j,o as X,c as Y,A as oe,p as ie,i as ae,q as ce,H as le,t as pe,v as de}from"./index-4c8c9024.js";import{t as O,u as H,C as ue}from"./index-a1141f9b.js";import{U as fe}from"./index-1b9c13e7.js";import{u as T,a as me,b as ge,I as he,c as J,d as xe}from"./index-7b7eee1f.js";import{M as ye,V as be}from"./index-1fd63366.js";import{S as we,R as je,s as V,M as ve}from"./index-8ca71501.js";import"./string-a277709d.js";import"./index-8b5c471f.js";import"./three.module-976f5d36.js";import"./index-5488fe2c.js";import"./TextareaAutosize-64261df1.js";import"./CheckIcon-c10d3c27.js";import"./index-047585bf.js";import"./index-c5a57fbb.js";import"./ClipLoader-9d24884a.js";import"./clsx-cec8706d.js";import"./SourcesTableIcon-6857194d.js";import"./DeleteNodeIcon-53d0c4c0.js";import"./SoundIcon-4faadce6.js";import"./SucessFeedBackIcon-fcf6410f.js";import"./Skeleton-b97ad4be.js";import"./index-ff9bac9e.js";import"./Stack-a7ad34bc.js";import"./FormControlLabel-d8f85b78.js";import"./Typography-9e152a55.js";import"./createSvgIcon-0f25a291.js";import"./isPlainObject-fd354873.js";const K=i.memo(()=>{const r=T(n=>n.isPlaying),a=T(n=>n.setIsPlaying),s=T(n=>n.setVolume),t=T(n=>n.setPlaybackSpeed),c=T(n=>n.playbackSpeed),o=T(n=>n.playerRef),[d,g]=i.useState(!1),m=[.5,1,1.5,2],h=()=>{if(o){const n=o.getCurrentTime()-15;o.seekTo(n,"seconds")}},f=()=>{if(o){const n=o.getCurrentTime()+15;o.seekTo(n,"seconds")}},w=()=>{a(!r)},p=()=>{g(!d),s(d?1:0)},l=()=>{const x=(m.indexOf(c)+1)%m.length,P=m[x];if(t(P),o){const k=o.getInternalPlayer();k&&typeof k.playbackRate<"u"&&(k.playbackRate=P)}};return e.jsxs(Se,{children:[e.jsx(Pe,{onClick:p,children:d?e.jsx(ye,{}):e.jsx(be,{})}),e.jsx(Ce,{onClick:h,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(ke,{"data-testid":"play-pause-button",onClick:w,size:"small",children:r?e.jsx(me,{"data-testid":"pause-icon"}):e.jsx(ge,{"data-testid":"play-icon"})}),e.jsx(Ie,{onClick:f,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(_e,{onClick:l,children:[c,"x"]})]})});K.displayName="Controls";const Se=u(j).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${S.BG1};
  border-radius: 40px;
