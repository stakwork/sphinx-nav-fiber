import{ax as Z,Q as g,S as b,U as t,a5 as T,N as V,r as y,j as e,bC as ee,bD as te,ar as L,bG as se,a4 as ne,bH as oe,ad as $,M as re,O as ae,bE as I,bh as ie,ag as ce,ay as le}from"./index-064b2269.js";import{B as C,ai as U,ab as de,aN as pe,ae as xe,aK as F,aO as z,aP as ue,aQ as me,aR as he,af as fe,aG as ye,ag as ge}from"./index-d11298c8.js";import{S as je}from"./index-c84b6ab8.js";import{p as G}from"./index-bbc7c996.js";import{c as we}from"./index-64f1c910.js";import"./three.module-a2e04964.js";const be=async(o,i,c="")=>await Z.post(`/${o}`,JSON.stringify(i),{Authorization:c}),Se=async(o,i,c,u,d,r)=>{const x=o==="Create custom type"?"schema":"node",l={node_data:{...i,...o==="Image"&&{source_link:c}},node_type:o,name:u,pubkey:r};return be(x,l,d)},Ne=({onClick:o,loading:i,error:c})=>{const u=V(l=>l.budget),[d,r]=y.useState(10),x="node";return y.useEffect(()=>{(async()=>{try{const h=await te(x);r(h.data.price)}catch(h){console.error("cannot fetch",h)}})()},[x]),e.jsxs(t,{children:[e.jsx(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:e.jsx(t,{align:"center",direction:"row",children:e.jsx(ke,{children:"Approve Cost"})})}),e.jsxs(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:[e.jsxs(Te,{children:[e.jsx("div",{className:"title",children:"COST"}),e.jsxs("div",{className:"value","data-testid":"check-price",children:[d," sats"]})]}),e.jsxs(Ce,{children:[e.jsx("div",{className:"title",children:"BUDGET"}),e.jsxs("div",{className:"value",children:[ee(u)," sats"]})]})]}),e.jsx(t,{children:e.jsx(C,{color:"secondary","data-testid":"check-icon",disabled:i||!!c,onClick:o,size:"large",startIcon:i?e.jsx(R,{children:e.jsx(U,{color:b.lightGray,size:12})}):e.jsxs(R,{children:[" ",e.jsx(de,{})]}),type:"submit",variant:"contained",children:"Approve"})}),c?e.jsx(Be,{children:e.jsxs(ve,{children:[e.jsx(pe,{className:"errorIcon"}),e.jsx("span",{children:c})]})}):null]})},Te=g(t).attrs({direction:"column",align:"space-between",justify:"flex-start"})`
  width: 141px;
  height: 61px;
