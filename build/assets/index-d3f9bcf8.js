import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-1005f983.js";import{B as F}from"./index-a9d2b472.js";import{u as M}from"./index-63c4ce40.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-306d772f.js";import{B as f,T as R,a as L}from"./index-eb91dbf5.js";import{T as x}from"./index-29546285.js";import"./useSlotProps-764853bf.js";import"./index.esm-054e2413.js";import"./InfoIcon-8306866f.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
