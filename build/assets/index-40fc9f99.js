import{r as o,j as e,s as f,g as v,F as j,o as Y,c as J,A as ae,p as ie,i as ce,q as le,H as pe,t as de,v as ue}from"./index-90418f8c.js";import{t as U,u as G,C as me}from"./index-8cdf58f0.js";import{U as fe}from"./index-63662795.js";import{u as M,a as he,b as ge,I as xe,c as K,d as ye}from"./index-312d1386.js";import{M as we,V as be}from"./index-4de34ab5.js";import{S as je,R as ve,s as V,M as Se}from"./index-3c641349.js";import"./string-a277709d.js";import"./index-38fcb7fb.js";import"./three.module-9722a9fc.js";import"./isPlainObject-a8124a11.js";import"./TextareaAutosize-e6f12933.js";import"./CheckIcon-517ec471.js";import"./index-9adfcb97.js";import"./index-a34d3215.js";import"./index-1a1e19bd.js";import"./ClipLoader-e5369e07.js";import"./clsx-e2bc7cd8.js";import"./SourcesTableIcon-94f8e70e.js";import"./DeleteNodeIcon-c59ac025.js";import"./SoundIcon-a6e2a61a.js";import"./SucessFeedBackIcon-89488c7e.js";import"./Skeleton-6e61d5d3.js";import"./index-70808240.js";import"./Stack-15c634e0.js";import"./FormControlLabel-0ee48f76.js";import"./Typography-f8dfeb81.js";import"./createSvgIcon-128eaff2.js";const Q=o.memo(()=>{const r=M(s=>s.isPlaying),a=M(s=>s.setIsPlaying),n=M(s=>s.setVolume),t=M(s=>s.setPlaybackSpeed),c=M(s=>s.playbackSpeed),i=M(s=>s.playerRef),[d,g]=o.useState(!1),y=[.5,1,1.5,2],h=()=>{if(i){const s=i.getCurrentTime()-15;i.seekTo(s,"seconds")}},u=()=>{if(i){const s=i.getCurrentTime()+15;i.seekTo(s,"seconds")}},b=()=>{a(!r)},l=()=>{g(!d),n(d?1:0)},p=()=>{const m=(y.indexOf(c)+1)%y.length,P=y[m];if(t(P),i){const _=i.getInternalPlayer();_&&typeof _.playbackRate<"u"&&(_.playbackRate=P)}};return e.jsxs(ke,{children:[e.jsx(_e,{onClick:l,children:d?e.jsx(we,{}):e.jsx(be,{})}),e.jsx(Ie,{onClick:h,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(Ce,{"data-testid":"play-pause-button",onClick:b,size:"small",children:r?e.jsx(he,{"data-testid":"pause-icon"}):e.jsx(ge,{"data-testid":"play-icon"})}),e.jsx(Pe,{onClick:u,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(Te,{onClick:p,children:[c,"x"]})]})});Q.displayName="Controls";const ke=f(j).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${v.BG1};
  border-radius: 40px;
