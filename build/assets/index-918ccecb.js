import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,x as D,B as F}from"./index-06d8f5a2.js";import{B as M}from"./index-71a2e6a1.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-de833712.js";import{B as f,T as L,a as R}from"./index-800f9cf6.js";import{T as x}from"./index-29a0a75b.js";import"./useSlotProps-6eee4772.js";import"./index.esm-0a209726.js";import"./InfoIcon-bf5c827d.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
