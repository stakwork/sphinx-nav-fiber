import{s as r,F as n,T as g,j as e,h as w,b as c,r as A,g as B}from"./index-3a377fb0.js";import{B as v}from"./index-f2a8b71a.js";import{u as F}from"./index-f6686074.js";import{u as M,U as $,q as C,e as b,x as D,F as k,C as G}from"./react-toastify.esm-23f7cb33.js";import{B as f,T as R,a as L}from"./index-7932d59a.js";import{T as x}from"./index-1053b8c0.js";import"./useSlotProps-5fa7f045.js";import"./index.esm-867f3a85.js";import"./InfoIcon-eaed3ce8.js";const P=({onClose:s})=>{const[a]=M(t=>[t.graphStyle]),i=()=>{localStorage.setItem("graphStyle",a),s()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:i,children:"Save changes"})})]})},V=r(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=r(g)`
