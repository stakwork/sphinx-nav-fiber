import{f as m,h as c,T as B,j as e,F as o,C as w,r,a3 as V,z as $,D as A}from"./index-4a78cd26.js";import{B as P}from"./index-83dfab66.js";import{u as p}from"./index-999e7802.js";import{c as q,F as G,B as E,C as H}from"./react-toastify.esm-8990f63e.js";import{T as S}from"./index-1883a19d.js";import{S as O}from"./Skeleton-fd12a69e.js";import"./index.esm-2d76192c.js";import"./InfoIcon-3a7ceaf1.js";const _=/^https:\/\/.*\.(png|jpg|svg)$/;function C(s){return!!_.test(s)}const W=({isValidImageUrl:s})=>e.jsxs(o,{children:[e.jsx(o,{align:"center",direction:"row",justify:"space-between",mb:18,children:e.jsx(o,{align:"center",direction:"row",children:e.jsx(Y,{children:"Edit Node"})})}),e.jsxs(o,{mb:18,children:[e.jsx(T,{style:{marginBottom:8},children:"Node Name"}),e.jsx(S,{id:"cy-topic",maxLength:50,name:"name",placeholder:"Node name",rules:{...w}})]}),e.jsxs(o,{mb:36,children:[e.jsx(T,{style:{marginBottom:8},children:"image_url"}),e.jsx(S,{id:"cy-image_url",maxLength:500,name:"image_url",placeholder:"image_url",rules:{...w,...s?{}:{pattern:{message:"Please enter a valid URL",value:_},validate:{source:C}}}})]})]}),Y=m(B)`
  font-size: 22px;
  font-weight: 600;
  font-family: 'Barlow';
`,T=m(B)`
