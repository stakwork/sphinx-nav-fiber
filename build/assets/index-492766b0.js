import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,x as D,B as F}from"./index-b4ddddac.js";import{B as M}from"./index-f60f6389.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-3101a61e.js";import{B as f,T as L,a as R}from"./index-e86ca227.js";import{T as x}from"./index-778511c4.js";import"./useSlotProps-967ff6fc.js";import"./index.esm-655f6b56.js";import"./InfoIcon-2c3fee8b.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
