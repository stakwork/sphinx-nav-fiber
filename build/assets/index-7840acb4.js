import{s as r,F as n,T as g,j as e,b as w,c,r as A,u as B}from"./index-725cd71c.js";import{B as v}from"./index-c7317d75.js";import{u as F}from"./index-c3e60fc6.js";import{u as M,G as $,l as C,b,r as D,F as G}from"./react-toastify.esm-2b45af49.js";import{B as f,T as k,a as R}from"./index-88bd09b5.js";import{T as x}from"./index-858be4ee.js";import{C as L}from"./ClipLoader-0a48de47.js";import"./useSlotProps-cf3ec1f9.js";import"./index.esm-665ada5a.js";import"./InfoIcon-2b7bba01.js";const P=({onClose:s})=>{const[a]=M(t=>[t.graphStyle]),i=()=>{localStorage.setItem("graphStyle",a),s()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:i,children:"Save changes"})})]})},V=r(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=r(g)`
