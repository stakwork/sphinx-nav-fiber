import{r as o,j as e,s as f,g as v,F as j,o as Y,c as J,A as ae,p as ie,i as ce,q as le,H as pe,t as de,v as ue}from"./index-baea693d.js";import{t as U,u as G,C as me}from"./index-2f41dd77.js";import{U as fe}from"./index-0aa89cad.js";import{u as M,a as he,b as ge,I as xe,c as K,d as ye}from"./index-ddc9dc34.js";import{M as we,V as be}from"./index-469f6fef.js";import{S as je,R as ve,s as V,M as Se}from"./index-b5c03f29.js";import"./string-a277709d.js";import"./index-783f51ec.js";import"./three.module-9722a9fc.js";import"./index-19ec3296.js";import"./TextareaAutosize-d8a936e3.js";import"./CheckIcon-d71f9c08.js";import"./index-6f91c8d8.js";import"./index-7325c5e4.js";import"./ClipLoader-4f76fc03.js";import"./clsx-6fe4b563.js";import"./SourcesTableIcon-d62bfc41.js";import"./DeleteNodeIcon-2b54e967.js";import"./SoundIcon-fea36cbd.js";import"./SucessFeedBackIcon-a8dc9d44.js";import"./Skeleton-45a8de9f.js";import"./index-96f0bc5e.js";import"./Stack-aeba9b1b.js";import"./FormControlLabel-a452b1e4.js";import"./Typography-3448bb99.js";import"./createSvgIcon-11d7f0f6.js";import"./isPlainObject-45a24ec1.js";const Q=o.memo(()=>{const r=M(s=>s.isPlaying),a=M(s=>s.setIsPlaying),n=M(s=>s.setVolume),t=M(s=>s.setPlaybackSpeed),c=M(s=>s.playbackSpeed),i=M(s=>s.playerRef),[d,g]=o.useState(!1),y=[.5,1,1.5,2],h=()=>{if(i){const s=i.getCurrentTime()-15;i.seekTo(s,"seconds")}},u=()=>{if(i){const s=i.getCurrentTime()+15;i.seekTo(s,"seconds")}},b=()=>{a(!r)},l=()=>{g(!d),n(d?1:0)},p=()=>{const m=(y.indexOf(c)+1)%y.length,P=y[m];if(t(P),i){const _=i.getInternalPlayer();_&&typeof _.playbackRate<"u"&&(_.playbackRate=P)}};return e.jsxs(ke,{children:[e.jsx(_e,{onClick:l,children:d?e.jsx(we,{}):e.jsx(be,{})}),e.jsx(Ie,{onClick:h,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(Ce,{"data-testid":"play-pause-button",onClick:b,size:"small",children:r?e.jsx(he,{"data-testid":"pause-icon"}):e.jsx(ge,{"data-testid":"play-icon"})}),e.jsx(Pe,{onClick:u,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(Te,{onClick:p,children:[c,"x"]})]})});Q.displayName="Controls";const ke=f(j).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${v.BG1};
  border-radius: 40px;
