import{f as o,F as s,T as g,i as y,j as e,k as b,L as S,D as w,h as x,r as T,x as v,B as m}from"./index-add05fa5.js";import{B}from"./index-64624ff4.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-ac073886.js";import{B as f,T as $,a as k}from"./index-474d4761.js";import{T as u}from"./index-f569f26e.js";import"./useSlotProps-40587b81.js";import"./index.esm-40911bdd.js";import"./InfoIcon-f87f0f10.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
