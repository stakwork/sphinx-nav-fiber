import{N as Q,f as y,h as b,F as t,T,y as G,r as f,j as e,aY as X,aZ as ee,D as F,b0 as te,J as se,b1 as ne,B as $,i as oe,a_ as I,b2 as re,o as ie,O as ae}from"./index-b6108083.js";import{B as C,C as V,i as ce,c as le,F as de}from"./react-toastify.esm-c0530dd4.js";import{B as pe}from"./index-39729091.js";import{S as me}from"./index-129b3a01.js";import{i as xe}from"./index.esm-b73d5dc3.js";import{C as ue}from"./CheckIcon-0d94708a.js";import{n as z,a as he,i as fe}from"./index-2e25e21e.js";import{p as ye}from"./index-d168dae0.js";import{T as L}from"./index-ac63d031.js";import{A as ge}from"./index-3f480ccb.js";import{c as je}from"./index-64f1c910.js";import"./generateCategoricalChart-ac5dd28f.js";import"./Popover-92c88e38.js";import"./useSlotProps-6dadf3cc.js";import"./InfoIcon-7ccedac5.js";import"./NoFilterResultIcon-63fd5b76.js";import"./index-dd4138e9.js";import"./index-df890381.js";import"./PlusIcon-df582db2.js";import"./index-bec9d99c.js";import"./Popper-50d19aad.js";const we=async(o,i,a="")=>await Q.post(`/${o}`,JSON.stringify(i),{Authorization:a}),be=async(o,i,a,x,d,r)=>{const m=o==="Create custom type"?"schema":"node",l={node_data:{...i,...o==="Image"&&{source_link:a}},node_type:o,name:x,pubkey:r};return we(m,l,d)},Se=({onClick:o,loading:i,error:a})=>{const x=G(l=>l.budget),[d,r]=f.useState(10),m="node";return f.useEffect(()=>{(async()=>{try{const u=await ee(m);r(u.data.price)}catch(u){console.error("cannot fetch",u)}})()},[m]),e.jsxs(t,{children:[e.jsx(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:e.jsx(t,{align:"center",direction:"row",children:e.jsx(Ce,{children:"Approve Cost"})})}),e.jsxs(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:[e.jsxs(Ne,{children:[e.jsx("div",{className:"title",children:"COST"}),e.jsxs("div",{className:"value","data-testid":"check-price",children:[d," sats"]})]}),e.jsxs(Te,{children:[e.jsx("div",{className:"title",children:"BUDGET"}),e.jsxs("div",{className:"value",children:[X(x)," sats"]})]})]}),e.jsx(t,{children:e.jsx(C,{color:"secondary","data-testid":"check-icon",disabled:i||!!a,onClick:o,size:"large",startIcon:i?e.jsx(R,{children:e.jsx(V,{color:b.lightGray,size:12})}):e.jsxs(R,{children:[" ",e.jsx(ue,{})]}),type:"submit",variant:"contained",children:"Approve"})}),a?e.jsx(ve,{children:e.jsxs(ke,{children:[e.jsx(xe,{className:"errorIcon"}),e.jsx("span",{children:a})]})}):null]})},Ne=y(t).attrs({direction:"column",align:"space-between",justify:"flex-start"})`
  width: 141px;
  height: 61px;
