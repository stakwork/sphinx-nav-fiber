...
`,ir=v.lazy(()=>ke(()=>import("./index-dfacdb2a.js"),["assets/index-dfacdb2a.js","assets/index-d485b6c2.js","assets/index-b4d03b7b.css","assets/index-a9f15ae2.js","assets/SourcesTableIcon-c0866f58.js","assets/index-eb2a6a9a.js","assets/CheckIcon-ee5c643e.js","assets/DeleteNodeIcon-98340730.js","assets/SoundIcon-2c2de975.js","assets/SucessFeedBackIcon-9b9fd80e.js","assets/ClipLoader-bd473af5.js","assets/TableRow-5ff76788.js"]).then(({TweetAnalyze:e})=>({default:e}))),ar=()=>{const e=$(o=>o.setSelectedTweet),t=$(o=>o.selectedTweet),{tweetId:a}=fe(),[r,n]=v.useState(""),{open:i}=De("tweetAnalyze"),l=(a==null?void 0:a.split("&"))||[],c=o=>{i(),n(o)};return s.jsxs(or,{align:"stretch",basis:"100%",grow:1,shrink:1,children:[l.length>1?s.jsx(sr,{onClick:()=>{c("summary")},children:"Summary Report"}):null,l.map(o=>s.jsx(cr,{className:t===o?"selected":"",onClick:()=>e(o),children:s.jsx(Vt,{handleAnalyzeClick:()=>{c(o)},nodeId:o})},o)),s.jsx(ir,{tweetId:r})]})},sr=f.button`
  width: 100%;
  background: ${y.ANALYTICS_CARD_BG};
  color: ${y.white};
  padding: 16px 16px;
