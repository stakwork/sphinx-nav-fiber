...
`,ar=v.lazy(()=>Re(()=>import("./index-aa6b9b01.js"),["assets/index-aa6b9b01.js","assets/index-054d527d.js","assets/index-b4d03b7b.css","assets/index-ab5fe31c.js","assets/SourcesTableIcon-44e80d77.js","assets/index-432cb653.js","assets/CheckIcon-db30f160.js","assets/DeleteNodeIcon-f43b93ae.js","assets/SoundIcon-427f484b.js","assets/SucessFeedBackIcon-a0f54e05.js","assets/ClipLoader-2ed7a2d8.js","assets/TableRow-903e8f19.js"]).then(({TweetAnalyze:e})=>({default:e}))),sr=()=>{const e=$(o=>o.setSelectedTweet),t=$(o=>o.selectedTweet),{tweetId:a}=ge(),[r,n]=v.useState(""),{open:i}=$e("tweetAnalyze"),l=(a==null?void 0:a.split("&"))||[],c=o=>{i(),n(o)};return s.jsxs(cr,{align:"stretch",basis:"100%",grow:1,shrink:1,children:[l.length>1?s.jsx(or,{onClick:()=>{c("summary")},children:"Summary Report"}):null,l.map(o=>s.jsx(lr,{className:t===o?"selected":"",onClick:()=>e(o),children:s.jsx(Ut,{handleAnalyzeClick:()=>{c(o)},nodeId:o})},o)),s.jsx(ar,{tweetId:r})]})},or=f.button`
  width: 100%;
  background: ${y.ANALYTICS_CARD_BG};
  color: ${y.white};
  padding: 16px 16px;
