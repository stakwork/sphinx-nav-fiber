import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,x as D,B as F}from"./index-0d55564a.js";import{B as M}from"./index-75e8f2b4.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-5e3664be.js";import{B as f,T as L,a as R}from"./index-1960735d.js";import{T as x}from"./index-d9c51261.js";import"./useSlotProps-a04e0176.js";import"./index.esm-2f01c5d3.js";import"./InfoIcon-0ee4e51d.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
