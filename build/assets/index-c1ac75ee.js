import{r as o,j as e,s as f,g as v,F as j,o as Y,c as J,A as ae,p as ie,i as ce,q as le,H as pe,t as de,v as ue}from"./index-344dd3fe.js";import{t as U,u as G,C as me}from"./index-47103ea7.js";import{U as fe}from"./index-854d9b68.js";import{u as M,a as he,b as ge,I as xe,c as K,d as ye}from"./index-cbd09cde.js";import{M as we,V as be}from"./index-47b5b545.js";import{S as je,R as ve,s as V,M as Se}from"./index-96f04947.js";import"./string-a277709d.js";import"./index-28512270.js";import"./three.module-9722a9fc.js";import"./isPlainObject-9dd8e6b7.js";import"./TextareaAutosize-d405a689.js";import"./CheckIcon-1ac57090.js";import"./index-1c4c086a.js";import"./index-a5a55535.js";import"./index-06144d43.js";import"./ClipLoader-b67af509.js";import"./clsx-77f4f1a7.js";import"./SourcesTableIcon-35d993d4.js";import"./DeleteNodeIcon-d3f23b72.js";import"./SoundIcon-5abadb28.js";import"./SucessFeedBackIcon-ab1b0aa4.js";import"./Skeleton-6c2c547c.js";import"./index-300b5558.js";import"./Stack-98ec01b1.js";import"./FormControlLabel-664f67a8.js";import"./Typography-4dabc187.js";import"./createSvgIcon-60b80ffb.js";const Q=o.memo(()=>{const r=M(s=>s.isPlaying),a=M(s=>s.setIsPlaying),n=M(s=>s.setVolume),t=M(s=>s.setPlaybackSpeed),c=M(s=>s.playbackSpeed),i=M(s=>s.playerRef),[d,g]=o.useState(!1),y=[.5,1,1.5,2],h=()=>{if(i){const s=i.getCurrentTime()-15;i.seekTo(s,"seconds")}},u=()=>{if(i){const s=i.getCurrentTime()+15;i.seekTo(s,"seconds")}},b=()=>{a(!r)},l=()=>{g(!d),n(d?1:0)},p=()=>{const m=(y.indexOf(c)+1)%y.length,P=y[m];if(t(P),i){const _=i.getInternalPlayer();_&&typeof _.playbackRate<"u"&&(_.playbackRate=P)}};return e.jsxs(ke,{children:[e.jsx(_e,{onClick:l,children:d?e.jsx(we,{}):e.jsx(be,{})}),e.jsx(Ie,{onClick:h,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(Ce,{"data-testid":"play-pause-button",onClick:b,size:"small",children:r?e.jsx(he,{"data-testid":"pause-icon"}):e.jsx(ge,{"data-testid":"play-icon"})}),e.jsx(Pe,{onClick:u,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(Te,{onClick:p,children:[c,"x"]})]})});Q.displayName="Controls";const ke=f(j).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${v.BG1};
  border-radius: 40px;
