import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,x as D,B as F}from"./index-9a37bc59.js";import{B as M}from"./index-490c634f.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-81e38af5.js";import{B as f,T as L,a as R}from"./index-9c3745a9.js";import{T as x}from"./index-c318460a.js";import"./useSlotProps-bf29779c.js";import"./index.esm-3a436922.js";import"./InfoIcon-70b1ef6b.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
