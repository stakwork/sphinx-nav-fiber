...
`,ks=d.span`
  margin-top: 2px;
`,_s=()=>e.jsxs(g,{children:[e.jsx(g,{align:"center",direction:"row",justify:"space-between",mb:18,children:e.jsx(g,{align:"center",direction:"row",children:e.jsx(Ns,{children:"Edit topic"})})}),e.jsx(g,{mb:12,children:e.jsx(Vt,{id:"cy-topic",maxLength:50,name:"name",placeholder:"Add your topic",rules:{...Ct}})})]}),Ns=d(N)`
  font-size: 22px;
  font-weight: 600;
  font-family: 'Barlow';
