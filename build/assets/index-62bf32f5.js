import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,C as B,h as c,r as v,x as C}from"./index-dc2b30e2.js";import{B as F}from"./index-a857ee6f.js";import{u as M}from"./index-47a131a3.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-cca37f49.js";import{B as f,T as L,a as R}from"./index-24c2fada.js";import{T as x}from"./index-430abe0f.js";import"./useSlotProps-8e9fe8c5.js";import"./index.esm-a6183753.js";import"./InfoIcon-3161f250.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
