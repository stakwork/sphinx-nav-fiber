import{s as h,b as f,g as E,r as m,j as e,F as o,T as u,h as N,B as U,v as V,ak as J,q as Y,aj as S,e as H,a4 as K}from"./index-fbea16ad.js";import{aC as Q,B as w,aD as W,q as X,F as Z,aE as ee}from"./react-toastify.esm-ee4152bf.js";import{B as te}from"./index-7b5195df.js";import{n as y}from"./toastMessage-63eefe97.js";import{a as C}from"./index-1be71d28.js";import{u as oe}from"./index-73d5b24f.js";import{C as ne}from"./CheckIcon-190c4154.js";import{T as _}from"./index-c28e550d.js";import{A as se}from"./index-a62f11e2.js";import"./index.esm-08135425.js";import"./index-9a7877cb.js";import"./InfoIcon-8f72a8b2.js";import"./index-451ca961.js";import"./Popover-29078010.js";import"./useSlotProps-22211fec.js";import"./Select-29bc5b44.js";import"./Stack-6ea30c66.js";import"./Popper-f1095716.js";const re=({onClick:n,loading:a})=>{const i=E(l=>l.budget),[c,p]=m.useState(10),r="node";return m.useEffect(()=>{(async()=>{try{const t=await W(r);p(t.data.price)}catch(t){console.error("cannot fetch",t)}})()},[r]),e.jsxs(o,{children:[e.jsx(o,{align:"center",direction:"row",justify:"space-between",mb:20,children:e.jsx(o,{align:"center",direction:"row",children:e.jsx(ce,{children:"Approve Cost"})})}),e.jsxs(o,{align:"center",direction:"row",justify:"space-between",mb:20,children:[e.jsxs(ae,{children:[e.jsx("div",{className:"title",children:"COST"}),e.jsxs("div",{className:"value","data-testid":"check-price",children:[c," sats"]})]}),e.jsxs(ie,{children:[e.jsx("div",{className:"title",children:"BUDGET"}),e.jsxs("div",{className:"value",children:[Q(i)," sats"]})]})]}),e.jsx(o,{children:e.jsx(w,{color:"secondary","data-testid":"check-icon",disabled:a,onClick:n,size:"large",startIcon:e.jsx(ne,{}),type:"submit",variant:"contained",children:"Approve"})})]})},ae=h(o).attrs({direction:"column",align:"space-between",justify:"flex-start"})`
  width: 141px;
  height: 61px;
