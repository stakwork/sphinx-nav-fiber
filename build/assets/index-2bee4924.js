import{s as c,a as N,T as _,F as r,e as x,q as O,r as d,j as e,aV as V,aW as P,t as k,u as q,v as G,B as F,bt as Y,bu as H,aY as J}from"./index-ed830d07.js";import{n as I,aC as K}from"./index-a295d989.js";import{T as Q}from"./index-07fb4cdb.js";import{S as X}from"./Skeleton-c2d3d30f.js";import{C as Z}from"./ClipLoader-ce2e517a.js";const ee=/^https:\/\/\S+\.(png|jpe?g|svg)$/;function te(i){return!!ee.test(i)}function ae(i){return i.split("_").map(p=>p.charAt(0).toUpperCase()+p.slice(1)).join(" ")}const oe=()=>{const{open:i}=x("changeNodeType"),{close:p}=x("editNodeName"),{changeNodeTypeFeatureFlag:y}=O(o=>({changeNodeTypeFeatureFlag:o.changeNodeTypeFeatureFlag})),a=I(),j=a==null?void 0:a.node_type,[m,g]=d.useState({});d.useEffect(()=>{a!=null&&a.properties&&g(a.properties)},[a]);const b=()=>{p(),i()},h=(o,n)=>{g(C=>({...C,[o]:n}))};return e.jsxs(r,{children:[e.jsx(r,{align:"center",direction:"row",justify:"space-between",mb:18,children:e.jsxs(r,{align:"center",direction:"row",children:[e.jsx(ne,{children:"Edit Node"}),e.jsxs(re,{children:[e.jsx(Q,{type:j}),y&&e.jsx(ie,{onClick:b,children:e.jsx(K,{})})]})]})}),e.jsx(ce,{children:Object.keys(m).map(o=>e.jsxs(r,{mb:18,children:[e.jsx(se,{style:{marginBottom:8},children:ae(o)}),e.jsx(V,{id:`cy-${o}`,maxLength:50,name:`properties.${o}`,onChange:n=>h(o,n),placeholder:`Please Enter the ${o}`,rules:o==="name"?{...P}:{}})]},o))})]})},ne=c(_)`
  font-size: 22px;
  font-weight: 600;
  font-family: 'Barlow';
`,se=c(_)`
