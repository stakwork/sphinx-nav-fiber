import{s as i,a as t,F as c,j as e,e as j,r as l,u as $,B as w,bt as C,bu as R,aY as I}from"./index-5bfd82ef.js";import{aP as z,i as D,p as E}from"./index-7af6297a.js";import{S as L}from"./Skeleton-02447ffa.js";import{C as T}from"./ClipLoader-bf6eab3e.js";const G=({nodeName:p})=>e.jsx(c,{children:e.jsxs(c,{align:"center",direction:"column",justify:"space-between",children:[e.jsx(A,{children:e.jsx(z,{})}),e.jsxs(M,{children:["Are you sure you want to delete ",p||"this item","?"]})]})}),M=i(c)`
  color: ${t.white};
  font-family: 'Barlow';
  font-size: 20px;
  font-weight: 400;
