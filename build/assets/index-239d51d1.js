import{f as c,h as i,T as N,j as e,F as s,C as k,r as n,a3 as z,z as F,D as M}from"./index-7ef32cb4.js";import{B as A}from"./index-ef5f20bc.js";import{u as p}from"./index-9ed22c96.js";import{e as I,F as V,B as w,C as _}from"./react-toastify.esm-b2ab4bbb.js";import{T as $}from"./index-e6ae8043.js";import{S as P}from"./Skeleton-43f992ed.js";import"./index.esm-53a37048.js";import"./InfoIcon-8e3a9b20.js";const q=()=>e.jsxs(s,{children:[e.jsx(s,{align:"center",direction:"row",justify:"space-between",mb:18,children:e.jsx(s,{align:"center",direction:"row",children:e.jsx(G,{children:"Edit Node"})})}),e.jsxs(s,{mb:36,children:[e.jsx(H,{style:{marginBottom:8},children:"Node Name"}),e.jsx($,{id:"cy-topic",maxLength:50,name:"topic",placeholder:"Node name",rules:{...k}})]})]}),G=c(N)`
  font-size: 22px;
  font-weight: 600;
  font-family: 'Barlow';
`,H=c(N)`
