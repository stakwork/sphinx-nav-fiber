import{f as m,h as d,T,j as e,F as o,C as b,r as i,a4 as V,E as $,D as A,i as P}from"./index-03c75c64.js";import{B as q}from"./index-056e2cbb.js";import{u as f}from"./index-f400f1e7.js";import{c as G,F as H,B,C as O}from"./react-toastify.esm-7abf1b0a.js";import{T as w}from"./index-7d3a55f9.js";import{S as W}from"./Skeleton-85e88ed2.js";import"./index.esm-492b5654.js";import"./InfoIcon-f2ed8d86.js";const _=/^https:\/\/.*\.(png|jpg|svg)$/;function C(s){return!!_.test(s)}const Y=({isValidImageUrl:s})=>e.jsxs(o,{children:[e.jsx(o,{align:"center",direction:"row",justify:"space-between",mb:18,children:e.jsx(o,{align:"center",direction:"row",children:e.jsx(J,{children:"Edit Node"})})}),e.jsxs(o,{mb:18,children:[e.jsx(E,{style:{marginBottom:8},children:"Node Name"}),e.jsx(w,{id:"cy-topic",maxLength:50,name:"name",placeholder:"Node name",rules:{...b}})]}),e.jsxs(o,{mb:36,children:[e.jsx(E,{style:{marginBottom:8},children:"image_url"}),e.jsx(w,{id:"cy-image_url",maxLength:500,name:"image_url",placeholder:"image_url",rules:{...b,...s?{}:{pattern:{message:"Please enter a valid URL",value:_},validate:{source:C}}}})]})]}),J=m(T)`
  font-size: 22px;
  font-weight: 600;
  font-family: 'Barlow';
`,E=m(T)`
