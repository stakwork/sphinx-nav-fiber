import{r as i,j as e,s as u,g as S,F as j,o as X,c as Y,A as oe,p as ie,i as ae,q as ce,H as le,t as pe,v as de}from"./index-c69fe57e.js";import{t as O,u as H,C as ue}from"./index-67bb2bd7.js";import{U as fe}from"./index-fec7ce59.js";import{u as T,a as me,b as ge,I as he,c as J,d as xe}from"./index-b47ec561.js";import{M as ye,V as be}from"./index-da697d34.js";import{S as we,R as je,s as V,M as ve}from"./index-a1fd586b.js";import"./string-a277709d.js";import"./index-0313d175.js";import"./three.module-976f5d36.js";import"./index-471b70e1.js";import"./TextareaAutosize-cb898d21.js";import"./CheckIcon-747d78f9.js";import"./index-55146115.js";import"./index-d2889ff0.js";import"./ClipLoader-27ca2b5c.js";import"./clsx-fce1412f.js";import"./SourcesTableIcon-f247b63c.js";import"./DeleteNodeIcon-fccf9115.js";import"./SoundIcon-2cf7775b.js";import"./SucessFeedBackIcon-9dd8dfec.js";import"./Skeleton-9d9578b1.js";import"./index-5dd6f6ca.js";import"./Stack-88eb8316.js";import"./FormControlLabel-47f35427.js";import"./Typography-2c164d99.js";import"./createSvgIcon-18f79ca9.js";import"./isPlainObject-c0e85e6d.js";const K=i.memo(()=>{const r=T(n=>n.isPlaying),a=T(n=>n.setIsPlaying),s=T(n=>n.setVolume),t=T(n=>n.setPlaybackSpeed),c=T(n=>n.playbackSpeed),o=T(n=>n.playerRef),[d,g]=i.useState(!1),m=[.5,1,1.5,2],h=()=>{if(o){const n=o.getCurrentTime()-15;o.seekTo(n,"seconds")}},f=()=>{if(o){const n=o.getCurrentTime()+15;o.seekTo(n,"seconds")}},w=()=>{a(!r)},p=()=>{g(!d),s(d?1:0)},l=()=>{const x=(m.indexOf(c)+1)%m.length,P=m[x];if(t(P),o){const k=o.getInternalPlayer();k&&typeof k.playbackRate<"u"&&(k.playbackRate=P)}};return e.jsxs(Se,{children:[e.jsx(Pe,{onClick:p,children:d?e.jsx(ye,{}):e.jsx(be,{})}),e.jsx(Ce,{onClick:h,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(ke,{"data-testid":"play-pause-button",onClick:w,size:"small",children:r?e.jsx(me,{"data-testid":"pause-icon"}):e.jsx(ge,{"data-testid":"play-icon"})}),e.jsx(Ie,{onClick:f,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(_e,{onClick:l,children:[c,"x"]})]})});K.displayName="Controls";const Se=u(j).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${S.BG1};
  border-radius: 40px;
