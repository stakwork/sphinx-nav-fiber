import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-6aa05c43.js";import{B as F}from"./index-b5fe8996.js";import{u as M}from"./index-627697ac.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-a0143063.js";import{B as f,T as R,a as L}from"./index-5479c931.js";import{T as x}from"./index-354d8e35.js";import"./useSlotProps-e48b7d15.js";import"./index.esm-632e3ea4.js";import"./InfoIcon-cd8e8135.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
