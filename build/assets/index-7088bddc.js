import{f as r,F as i,T as g,i as y,j as e,k as b,L as S,D as w,h as x,r as T,x as v,B as m}from"./index-00c8de1c.js";import{B}from"./index-546477a8.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-1974ae2a.js";import{B as f,T as $,a as k}from"./index-aaf85693.js";import{T as u}from"./index-762f880d.js";import"./useSlotProps-bb3c3a09.js";import"./index.esm-d29a00f0.js";import"./InfoIcon-5f6968ca.js";const F=({onClose:t})=>{const[s]=y(n=>[n.graphStyle]),o=()=>{localStorage.setItem("graphStyle",s),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(L,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(i,{mt:308,children:e.jsx(f,{kind:"big",onClick:o,children:"Save Changes"})})]})},G=r(i)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,L=r(g)`
