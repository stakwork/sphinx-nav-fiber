import{s as r,F as n,T as g,j as e,b as w,c,r as A,u as B}from"./index-89a3f7cf.js";import{B as v}from"./index-373f5dda.js";import{u as F}from"./index-06055e2a.js";import{u as M,G as $,l as C,b,r as D,F as G}from"./react-toastify.esm-2901fbc8.js";import{B as f,T as k,a as R}from"./index-b7489838.js";import{T as x}from"./index-d03f8245.js";import{C as L}from"./ClipLoader-60d11628.js";import"./useSlotProps-bf7ea326.js";import"./index.esm-fe20163c.js";import"./InfoIcon-e27207b6.js";const P=({onClose:s})=>{const[a]=M(t=>[t.graphStyle]),i=()=>{localStorage.setItem("graphStyle",a),s()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:i,children:"Save changes"})})]})},V=r(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=r(g)`
