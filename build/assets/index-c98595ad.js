import{s as n,b as i,F as s,r as f,g as be,j as e,T as k,P as Q,e as ke,q as ve,p as L}from"./index-96b41805.js";import{e as I,h as E,E as $e,ay as Se,B as R,R as _,A as z,O as Te,I as q,T as G,U,az as K,W as X,C as J,Y as _e,i as ze,n as Be,o as Ce}from"./react-toastify.esm-4df78b0d.js";import{S as Ie}from"./index-1b356825.js";import{a as Pe}from"./index-d58f7f38.js";import{M as Ee,R as Ae,a as Me,S as Re,b as Ge,m as De,N as Z,G as ee,L as H,B as Fe,H as Ye,C as Le,D as te,c as se,d as He,f as We,g as oe,e as Oe,P as Ve,h as ie,s as O,V as Ne,F as Qe,E as qe,i as Ue,j as Ke,k as Xe,l as Je}from"./ChevronRightIcon-73660583.js";import{o as re,n as Ze,X as et,Y as tt,T as st,D as ot,f as ne,S as W,q as ae}from"./generateCategoricalChart-614408a4.js";import{g as it,d as rt}from"./index.esm-ff9ef8aa.js";import{T as nt,F as at}from"./Popover-0ad01b0d.js";import{I as lt,S as ct,O as xt}from"./Select-78c428f5.js";import{C as dt}from"./ChevronDownIcon-6ac23e65.js";import{T as M}from"./index-76bcddd3.js";import{C as pt}from"./CheckIcon-db269fba.js";import{I as ht}from"./InfoIcon-5fcce5a0.js";import"./useSlotProps-df85f21c.js";const yt=48,ut=8,ft={PaperProps:{style:{maxHeight:yt*4.5+ut,width:250}}},gt=["Beginner","Intermediate","Advanced","Expert"],mt=()=>{const t=I(p=>p.data),[o,r]=f.useState(""),[a,l]=f.useState("Beginner"),d=E(p=>p.currentSearch),c=$e(),[h]=be(p=>[p.setBudget]),[u,x,g,b,y]=re(p=>[p.askedQuestions,p.askedQuestionsAnswers,p.setAskedQuestion,p.setAskedQuestionAnswer,p.hasQuestionInProgress]),w=f.useCallback(p=>{b(p.answer)},[b]);f.useEffect(()=>{c&&w&&c.on("askquestionhook",w)},[w,c]);const S=async()=>{o&&(g(o),r(""));try{const p=t==null?void 0:t.nodes.filter(C=>C.text),T=p==null?void 0:p.slice(0,5),F=(T!=null&&T.length?T.map(C=>C.text).join(" "):"").substring(0,2500).replace(/[?&=+/#]/g,C=>`\\${C}`);d&&(await ke.enable(),await Se({expertise_level:a,question_text:o,search_term:d,transcripts:F},h),await ve(h))}catch(p){console.error(p)}},m=a&&o.trim()&&!y,v=p=>{l(p.target.value)},B=async p=>{if(y){p.preventDefault();return}p.keyCode===13&&p.shiftKey===!1&&m&&(p.preventDefault(),S())};return e.jsxs(jt,{children:[e.jsx(s,{children:e.jsx(s,{children:e.jsxs(at,{component:"div",children:[e.jsx(bt,{id:"select-label",size:"small",children:"Expertise level"}),e.jsx(kt,{id:"demo-multiple-name",input:e.jsx(xt,{label:"Expertise level"}),labelId:"select-label",MenuProps:ft,onChange:v,size:"small",value:a,children:gt.map(p=>e.jsx(Ee,{component:"li",value:p,children:p},p))})]})})}),e.jsx(St,{children:u==null?void 0:u.map((p,T)=>e.jsxs(s,{className:"response",py:12,children:[e.jsx(k,{kind:"medium",children:p}),e.jsx(s,{py:12,children:(x==null?void 0:x[T])!==void 0?e.jsx(k,{color:"unreadMsgText",children:x[T]}):e.jsxs(s,{align:"center",py:12,children:[e.jsx(s,{align:"center",py:12,children:e.jsx(Q,{color:i.white})}),e.jsx(s,{align:"center",py:12,children:e.jsx(k,{children:"Generating response"})})]})})]},p))}),e.jsxs(vt,{onKeyDown:B,py:12,tabIndex:-1,children:[e.jsx(wt,{disabled:y,onChange:p=>r(p.target.value),placeholder:"Enter your question",value:o}),e.jsx($t,{children:e.jsx(it,{color:m?i.white:i.gray300,size:"18"})})]})]})},jt=n.div`
  margin-top: 20px;
`,wt=n(nt)`
...
`,Pt=({stateless:t,node:o})=>e.jsxs(s,{grow:1,shrink:1,children:[e.jsx(At,{children:t&&e.jsxs(Et,{children:[e.jsx("div",{className:"icon",children:e.jsx(Z,{})}),e.jsx("div",{className:"title",children:"Description"})]})}),e.jsx(Mt,{children:o!=null&&o.description?`"${o==null?void 0:o.description}"`:"..."})]}),Et=n(s).attrs({direction:"row",align:"center"})`
  .icon {
    font-size: 16px;
    color: ${i.GRAY3};
    margin-right: 7px;
...
`,ss=({stateless:t,node:o})=>{var S;const[r,a]=E(m=>[m.transcriptIsOpen,m.setTranscriptOpen]),[l,d]=f.useState(!1),[c,h]=f.useState(""),[u,x]=f.useState(!1);if(!t&&!r)return null;const g="https://knowledge-graph.sphinx.chat",b=async m=>{try{const v=await fetch(`${g}/node/text/${m}`);if(!v.ok)throw new Error("Network response was not ok");const B=await v.json();h(B.data.text),x(!0)}catch(v){console.error("Error fetching full transcript",v)}},y=()=>{u?x(!1):o!=null&&o.ref_id&&b(o.ref_id)},w=m=>{m!==void 0&&(navigator.clipboard.writeText(m),d(!0))};return e.jsxs(s,{grow:1,shrink:1,children:[e.jsxs(is,{children:[t&&e.jsxs(os,{children:[e.jsx("div",{className:"icon",children:e.jsx(Z,{})}),e.jsx("div",{className:"title",children:"Transcript"})]}),o!=null&&o.text?e.jsx(e.Fragment,{children:l?e.jsxs(as,{align:"center",direction:"row",justify:"flex-start",children:[e.jsx("div",{className:"icon",children:e.jsx(pt,{})}),e.jsx("div",{className:"text",children:"Copied"})]}):e.jsx(R,{endIcon:e.jsx(Le,{}),onPointerDown:()=>w(o==null?void 0:o.text),size:"small",variant:"outlined",children:"Copy"})}):e.jsx("div",{}),!t&&e.jsx(rs,{onClick:()=>{a(!1)},children:e.jsx(rt,{fontSize:35})})]}),e.jsxs(ns,{children:[u?c:`${(S=o==null?void 0:o.text)==null?void 0:S.substring(0,100)}...`,e.jsx(ts,{onClick:y,children:u?"less":"more"})]})]})},os=n(s).attrs({direction:"row",align:"center"})`
  .icon {
    font-size: 16px;
    color: ${i.GRAY3};
    margin-right: 7px;
...
`,Zs=n(R)`
  width: 100%;
`,eo=()=>{var c,h;const[t,o]=f.useState(!1),r=_(),a=!!(r!=null&&r.source_link),l=f.useRef(null),d=u=>{u.stopPropagation(),u.currentTarget.blur(),o(!t)};return f.useEffect(()=>{var u,x;t?(u=l.current)==null||u.play():(x=l.current)==null||x.pause()},[t]),e.jsxs(s,{align:"flex-start",basis:"100%",direction:"column",grow:1,justify:"center",pt:a?62:0,shrink:1,children:[a&&e.jsxs(to,{children:[e.jsx(ee,{color:i.GRAY6}),e.jsx(io,{children:r==null?void 0:r.source_link}),e.jsx(so,{href:r==null?void 0:r.source_link,onClick:u=>u.stopPropagation(),target:"_blank",children:e.jsx(H,{})})]}),(c=r==null?void 0:r.audio)!=null&&c.length?e.jsxs(s,{justify:"flex-start",p:12,children:[e.jsx(R,{onClick:u=>d(u),startIcon:t?e.jsx(K,{}):e.jsx(X,{}),children:t?"Pause":"Play"}),e.jsx(ro,{ref:l,src:((h=r.audio[0])==null?void 0:h.link)||"",children:e.jsx("track",{kind:"captions"})})]}):null,e.jsx(oo,{grow:1,justify:"flex-start",p:12,shrink:1,children:e.jsx(k,{color:"primaryText1",kind:"regular",children:r==null?void 0:r.text})})]})},to=n(s)`
  top: 0px;
  position: absolute;
