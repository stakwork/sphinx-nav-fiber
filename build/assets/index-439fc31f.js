import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-ca52fe9e.js";import{B as F}from"./index-3606614f.js";import{u as M}from"./index-78f387f4.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-e01834ad.js";import{B as f,T as R,a as L}from"./index-511b276b.js";import{T as x}from"./index-475a69e5.js";import"./useSlotProps-79985c29.js";import"./index.esm-fc1c9a6c.js";import"./InfoIcon-f5723498.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
