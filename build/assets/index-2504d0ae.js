import{t as i,v as N,T as E,F as s,N as U,r as c,j as e,aA as W,a_ as P,aY as V,q as k}from"./index-0d0410ed.js";import{B as q}from"./index-b4e6b364.js";import{u as h,e as F,T as G,aZ as Y,$ as H,a0 as Z,B as I}from"./index-e8fd92b3.js";import{T as J}from"./index-2851a497.js";import{S as K}from"./Skeleton-f8c28806.js";import{C as Q}from"./ClipLoader-bb9106f0.js";import"./index.esm-b5f55779.js";const X=/^https:\/\/\S+\.(png|jpe?g|svg)$/;function ee(l){return!!X.test(l)}const te=()=>{const{open:l}=h("changeNodeType"),{close:x}=h("editNodeName"),{changeNodeTypeFeatureFlag:f}=U(a=>({changeNodeTypeFeatureFlag:a.changeNodeTypeFeatureFlag})),o=F(),j=o==null?void 0:o.node_type,[p,m]=c.useState({});c.useEffect(()=>{o!=null&&o.properties&&m(o.properties)},[o]);const y=()=>{x(),l()},g=(a,n)=>{m(T=>({...T,[a]:n}))};return e.jsxs(s,{children:[e.jsx(s,{align:"center",direction:"row",justify:"space-between",mb:18,children:e.jsxs(s,{align:"center",direction:"row",children:[e.jsx(oe,{children:"Edit Node"}),e.jsxs(ne,{children:[e.jsx(G,{type:j}),f&&e.jsx(se,{onClick:y,children:e.jsx(Y,{})})]})]})}),e.jsx(re,{children:Object.keys(p).map(a=>e.jsxs(s,{mb:18,children:[e.jsx(ae,{style:{marginBottom:8},children:a}),e.jsx(J,{id:`cy-${a}`,maxLength:50,name:`properties.${a}`,onChange:n=>g(a,n),placeholder:`Please Enter the ${a}`,rules:a==="name"?{...W}:{}})]},a))})]})},oe=i(E)`
  font-size: 22px;
  font-weight: 600;
  font-family: 'Barlow';
`,ae=i(E)`
