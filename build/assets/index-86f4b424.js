import{Y as i,X as n,Z as m,j as e,ab as T,a0 as p,r as A,a1 as v}from"./index-32144865.js";import{aA as M,cf as $,cg as b,ch as k,aK as j,ci as B,cj as D,ck as x,aS as C,cl as F,cm as G,u as R,ca as L}from"./index-a820256c.js";const P=({onClose:a})=>{const[s]=M(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(b,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(m)`
