import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-2d3ee110.js";import{B}from"./index-d35ce9ec.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-7ae93696.js";import{B as f,T as $,a as k}from"./index-9937aba5.js";import{T as u}from"./index-7d05f8cf.js";import"./useSlotProps-7d67fc74.js";import"./index.esm-9ab25bf0.js";import"./InfoIcon-8ff3338a.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
