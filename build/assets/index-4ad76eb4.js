import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-bf817944.js";import{B}from"./index-6580f146.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-e242efec.js";import{B as f,T as $,a as k}from"./index-21a7903e.js";import{T as u}from"./index-2b5f4101.js";import"./useSlotProps-1f7f153d.js";import"./index.esm-7a8df79a.js";import"./InfoIcon-aa3fbeee.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
