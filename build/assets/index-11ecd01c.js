import{r as n,j as e,s as m,g as T,F as S,o as K,c as U,A as ae,p as ce,i as le,q as pe,H as de,t as ue,v as fe,f as q}from"./index-a33abcae.js";import{Universe as me}from"./index-a785990c.js";import{u as he}from"./index-ee26b3d8.js";import{u as W,a as ge,b as xe,I as ye,c as Q,d as V}from"./index-d94cb2f1.js";import{M as be,V as we}from"./VolumeIcon-63f99747.js";import{S as je,R as ve,s as X,M as Se}from"./index-a334632f.js";import"./index-26286e74.js";import"./VisibilityOn-9694e19f.js";import"./SourcesTableIcon-2c13ba24.js";import"./NodeCircleIcon-8e2b8ae0.js";import"./CheckIcon-2c8e5e69.js";import"./DeleteNodeIcon-f7f7f890.js";import"./EditNodeIcon-d5647ef6.js";import"./SearchIcon-1c24b032.js";import"./SoundIcon-94211bc8.js";import"./SucessFeedBackIcon-b0659fe7.js";import"./three.module-4d3d7244.js";import"./TextareaAutosize-78203c7a.js";import"./index-7765e0be.js";import"./index-9c10a88c.js";import"./index-068f19f3.js";import"./ClipLoader-982e9569.js";import"./Skeleton-befd2d8b.js";import"./Stack-bc0965fa.js";import"./index-c46a0a37.js";import"./FormControlLabel-78ac4ce3.js";import"./Typography-f5e6f5ec.js";import"./createSvgIcon-ed5f79f9.js";import"./isPlainObject-d81a50f4.js";function D(r){const[i,t,s]=r.split(":").map(Number);return Number((i*60*60*1e3+t*60*1e3+s*1e3).toFixed(6))}const Z=n.memo(()=>{const r=W(a=>a.isPlaying),i=W(a=>a.setIsPlaying),t=W(a=>a.setVolume),s=W(a=>a.setPlaybackSpeed),c=W(a=>a.playbackSpeed),o=W(a=>a.playerRef),[x,b]=n.useState(!1),h=[.5,1,1.5,2],g=()=>{if(o){const a=o.getCurrentTime()-15;o.seekTo(a,"seconds")}},p=()=>{if(o){const a=o.getCurrentTime()+15;o.seekTo(a,"seconds")}},j=()=>{i(!r)},d=()=>{b(!x),t(x?1:0)},f=()=>{const I=(h.indexOf(c)+1)%h.length,F=h[I];if(s(F),o){const P=o.getInternalPlayer();P&&typeof P.playbackRate<"u"&&(P.playbackRate=F)}};return e.jsxs(ke,{children:[e.jsx(Pe,{onClick:d,children:x?e.jsx(be,{}):e.jsx(we,{})}),e.jsx(Te,{onClick:g,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(Ce,{"data-testid":"play-pause-button",onClick:j,size:"small",children:r?e.jsx(ge,{"data-testid":"pause-icon"}):e.jsx(xe,{"data-testid":"play-icon"})}),e.jsx(Ie,{onClick:p,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(_e,{onClick:f,children:[c,"x"]})]})});Z.displayName="Controls";const ke=m(S).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${T.BG1};
  border-radius: 40px;
