import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h as x,r as T,x as v,B as m}from"./index-ea6fef52.js";import{B}from"./index-fcdf8fc4.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-b69ddf8d.js";import{B as f,T as $,a as k}from"./index-5e425efa.js";import{T as u}from"./index-420f842a.js";import"./useSlotProps-810ada0c.js";import"./index.esm-0a18346d.js";import"./InfoIcon-dfcda8b4.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
