import{f as d,h as n,T as _,F as p,R as J,v as X,Y as Z,i as F,r as h,j as e,o as Fe,p as Pe,q as we,l as z,t as ye,w as Me,x as be,z as Se,E as ve,y as Oe,B as Ge,C as De,D as Te,G as We,H as de,J as Ye}from"./index-7731e15f.js";import{B as P}from"./index-434f5d73.js";import{u as E}from"./index-22980c99.js";import{T as Ue,a as M,b as Ve,F as ee,M as te,C as Ce,N as He,c as qe,D as se}from"./NoFilterResultIcon-544c95a6.js";import{B,C as T,I as R,b as A,S as O,c as ne,F as oe}from"./react-toastify.esm-6d93bcb9.js";import{M as $e,a as _e,b as Qe,c as Ke,d as Je,e as Xe}from"./index.esm-02511f32.js";import{P as G,I as D,a as re,F as ke}from"./Popover-958d913e.js";import{B as Ze,T as et}from"./index-1b1d8084.js";import{A as ze,u as $}from"./index-727aee19.js";import{P as Ee}from"./Popper-1d618f8f.js";import{C as Ne}from"./CheckIcon-059dfb49.js";import{C as Be}from"./ChevronDownIcon-10be06d3.js";import{C as Ae}from"./ChevronUpIcon-a2ff8bfb.js";import{S as tt}from"./SettingsIcon-bf4fc400.js";import{T as st,a as nt}from"./index-d252726d.js";import"./dividerClasses-9e5b09ff.js";import"./useSlotProps-8ec9e42a.js";import"./InfoIcon-2db118f8.js";const j=d(Ue)`
  && {
    color: ${n.white};
    border: none;
...
`,I={[J]:"RSS link",[X]:"Twitter Handle",[Z]:"Youtube channel"},ot="date",rt="edge_count",lt="alphabetically",W={[ot]:"Date",[rt]:"Edge Count",[lt]:"Alphabetically"},Ie="https://twitter.com",Re="IS_ALIAS",it=({data:t})=>{const a=F(o=>o.setQueuedSources),[r,l]=h.useState(""),x=async o=>{if(t!=null&&t.length)try{const s=await Fe.enable();await Pe(o,s.pubkey),a(t.filter(i=>i.ref_id!==o))}catch(s){console.warn(s)}},f=async o=>{if(!(!o||!(t!=null&&t.length))){l(o);try{await we(o),a(t==null?void 0:t.filter(s=>s.ref_id!==o))}catch(s){console.warn(s)}finally{l("")}}};return t!=null&&t.length?e.jsxs(te,{component:"table",children:[e.jsx(ie,{children:e.jsxs(M,{component:"tr",children:[e.jsx(j,{className:"empty"}),e.jsx(j,{children:"Type"}),e.jsx(j,{children:"Source"}),e.jsx(j,{}),e.jsx(j,{className:"empty"})]})}),(t==null?void 0:t.length)&&e.jsx("tbody",{children:t==null?void 0:t.map(o=>e.jsxs(le,{children:[e.jsx(j,{className:"empty"}),e.jsx(j,{children:I[o.source_type]}),e.jsx(j,{width:"268px",children:o.source_type==="twitter_handle"?e.jsxs(xe,{href:`${Ie}/${o.source}?open=system`,target:"_blank",children:["@",o.source]}):e.jsx(xe,{href:`${o.source}?open=system`,target:"_blank",children:o.source})}),e.jsx(j,{className:"cell-center",children:e.jsxs(p,{direction:"row",justify:"space-between",children:[e.jsx("div",{className:"approve-wrapper",children:e.jsx(he,{className:"centered",onClick:()=>x(o.ref_id),children:e.jsx($e,{color:n.primaryGreen,fontSize:24})})}),e.jsx("div",{className:"delete-wrapper",children:r===o.ref_id?e.jsx(T,{color:n.white,size:16}):e.jsx(Ce,{message:"Are you sure ?",onConfirm:()=>f(o.ref_id),children:e.jsx(he,{className:"centered",children:e.jsx(_e,{color:n.primaryRed,fontSize:24})})})})]})}),e.jsx(j,{className:"empty"})]},o.source))})]}):e.jsxs(p,{children:[e.jsx(_,{children:"There is not any results for selected filters"}),e.jsx(ee,{})]})},he=d(p)`
  width: 20px;
  height: 20px;
  border-radius: 50%;
  cursor: pointer;
...
`,ue=d(R)`
  font-size: 24px;
`,kt=({selectedType:t,setSelectedType:a})=>{const[r,l]=h.useState(null),[x,f]=h.useState([]);h.useEffect(()=>{(async()=>{try{const{data:g}=await Oe();f(g.edge_types)}catch(g){console.warn(g)}})()},[f]);const o=c=>{l(c.currentTarget)},s=()=>{l(null)},i=c=>{a(c),s()};return e.jsxs("div",{children:[e.jsxs(zt,{onClick:o,children:[e.jsx("div",{className:"text",children:"Type"}),e.jsx("div",{className:"value",children:t}),e.jsx("div",{className:"icon",children:r?e.jsx(Ae,{}):e.jsx(Be,{})})]}),e.jsx(Nt,{anchorEl:r,anchorOrigin:{vertical:"bottom",horizontal:"left"},anchorPosition:{top:62,left:0},onClose:s,open:!!r,transformOrigin:{vertical:"top",horizontal:"left"},children:e.jsx(ke,{children:x.map(c=>e.jsxs(Et,{className:z({active:c===t}),onClick:()=>i(c),children:[e.jsx("span",{className:"icon",children:c===t?e.jsx(Ne,{}):null}),e.jsx("span",{children:c})]},c))})})]})},zt=d(p).attrs({direction:"row",align:"center"})`
  cursor: pointer;
  flex-grow: 1;
  color: ${n.GRAY6};
  font-family: Barlow;
...
`,Vt=({topic:t,onClose:a})=>{const{close:r}=E("mergeTopic"),[l,x,f]=$(S=>[S.data,S.ids,S.total]),o=ne({mode:"onChange"}),{watch:s,setValue:i,reset:c}=o,[g,m]=h.useState(!1),[w,y]=h.useState(null);h.useEffect(()=>(t&&i("name",t==null?void 0:t.name),()=>{c()}),[t,i,c]);const b=s("name"),u=()=>{a(),r()},v=async()=>{if(!(!w||!l)){m(!0);try{await We({from:t.ref_id,to:w==null?void 0:w.ref_id});const{ref_id:S}=t;if(l[S]={...l[S],edgeList:[Re],edgeCount:l[S].edgeCount-1},$.setState({ids:x.filter(k=>k!==w.ref_id),total:f-1}),l){const k={...l};k[t==null?void 0:t.ref_id].name=b.trim(),$.setState({data:k})}u()}catch(S){console.warn(S)}finally{m(!1)}}};return e.jsx(P,{id:"mergeTopic",kind:"regular",onClose:u,preventOutsideClose:!0,children:e.jsxs(oe,{...o,children:[e.jsx(Wt,{from:t.name,onSelect:y,selectedTopic:w}),e.jsxs(B,{color:"secondary",disabled:g,onClick:v,size:"large",variant:"contained",children:["Merge topics",g&&e.jsx(T,{color:n.BLUE_PRESS_STATE,size:10})]})]})})},Ht=()=>{const[t,a]=$(o=>[o.filters,o.setFilters]),[r,l]=h.useState(""),x=o=>{o.preventDefault(),a({search:r})},f=()=>{l(""),t.search&&a({search:""})};return e.jsxs(G,{component:"form",onSubmit:x,sx:{p:"2px 4px",display:"flex",alignItems:"center",width:300},children:[e.jsx(D,{autoComplete:"off",autoCorrect:"off",inputProps:{"aria-label":"search topic"},onChange:o=>l(o.target.value),placeholder:"Search",size:"small",spellCheck:"false",sx:{ml:1,flex:1},value:r}),r&&e.jsxs(e.Fragment,{children:[e.jsx(ge,{"aria-label":"search",onClick:f,type:"button",children:e.jsx(A,{})}),e.jsx(se,{orientation:"vertical",sx:{height:28,m:.5}})]}),e.jsx(ge,{"aria-label":"search",onClick:x,type:"button",children:e.jsx(O,{})})]})},ge=d(R)`
  font-size: 24px;
`,qt=({onChangeFilter:t,currentFilter:a})=>{const[r,l]=h.useState(null),x=s=>{l(s.currentTarget)},f=()=>{l(null)},o=s=>{t(s),f()};return e.jsxs("div",{children:[e.jsxs(Qt,{onClick:x,children:[e.jsx("div",{className:"text",children:"Sort By"}),e.jsx("div",{className:"value",children:W[a]}),e.jsx("div",{className:"icon",children:r?e.jsx(Ae,{}):e.jsx(Be,{})})]}),e.jsx(Jt,{anchorEl:r,anchorOrigin:{vertical:"bottom",horizontal:"left"},anchorPosition:{top:62,left:0},onClose:f,open:!!r,transformOrigin:{vertical:"top",horizontal:"left"},children:e.jsx(ke,{children:Object.keys(W).map(s=>e.jsxs(Kt,{className:z({active:s===a}),onClick:()=>o(s),children:[e.jsx("span",{className:"icon",children:s===a?e.jsx(Ne,{}):null}),e.jsx("span",{children:W[s]})]},s))})})]})},Qt=d(p).attrs({direction:"row",align:"center"})`
  cursor: pointer;
  flex-grow: 1;
  color: ${n.GRAY6};
  font-family: Barlow;
...
`,Xt=({topic:t,onClick:a})=>{const[r,l]=$(i=>[i.ids,i.total]),[x,f]=h.useState(!1),o=t.date_added_to_graph.toString(),s=async(i,c)=>{f(!0);try{await Te(i,{is_muted:c}),$.setState({ids:r.filter(g=>g!==i),total:l-1})}catch(g){console.warn(g)}};return e.jsxs(le,{children:[e.jsx(j,{className:"empty"}),e.jsx(j,{children:t.name}),e.jsx(j,{children:t.edgeCount}),e.jsx(j,{children:t.edgeList.join(", ")}),e.jsx(j,{children:e.jsx("span",{children:new Date(Number(o)*1e3).toDateString()})}),e.jsx(j,{className:"cell-center",children:e.jsx(p,{direction:"row",justify:"space-between",children:e.jsx("div",{className:"approve-wrapper",children:x?e.jsx(T,{color:n.white,size:16}):e.jsx(e.Fragment,{children:t.is_muted?e.jsx(je,{className:"centered",onClick:()=>s(t.ref_id,!1),children:e.jsx($e,{color:n.primaryGreen,fontSize:24})}):e.jsx(je,{className:"centered",onClick:()=>s(t.ref_id,!0),children:e.jsx(_e,{color:n.primaryRed,fontSize:24})})})})})}),e.jsx(j,{children:e.jsx(R,{onClick:i=>a(i,t.ref_id),children:e.jsx(tt,{})})})]},t.name)},je=d(p)`
  width: 20px;
  height: 20px;
  border-radius: 50%;
  cursor: pointer;
...
`,ss=()=>{const[t,a]=h.useState(!1),[r,l,x,f,o,s,i]=$(C=>[C.data,C.ids,C.total,C.setTopics,C.filters,C.setFilters,C.terminate]),{open:c}=E("editTopic"),{open:g}=E("mergeTopic"),{open:m}=E("addEdge"),[w,y]=h.useState(null),b={editTopic:c,mergeTopic:g,addEdge:m},u=h.useRef([]);h.useEffect(()=>{l.length&&(u.current=l)},[l]),h.useEffect(()=>{(async()=>{try{a(!0),await f()}catch{console.error("err")}finally{a(!1)}})()},[f,o]);const v=async()=>{try{a(!0),s({page:o.page+1})}catch(C){console.error("Error loading more data:",C)}finally{a(!1)}};h.useEffect(()=>()=>{i()},[i]);const S=C=>{s({sortBy:C})},k=()=>{y(null)},Le=(C,ce)=>{r&&(y(r[C]),typeof b[ce]=="function"&&b[ce]())};return e.jsxs(e.Fragment,{children:[e.jsxs(ns,{direction:"column",justify:"flex-end",children:[e.jsxs(ae,{align:"flex-start",direction:"row",justify:"space-between",children:[e.jsx(_,{className:"title",children:"Topics"}),e.jsxs(B,{disabled:t,onClick:()=>s({is_muted:!o.is_muted}),size:"medium",children:[o.is_muted?"Show Unmuted":"Show Muted",t&&e.jsx(T,{color:n.BLUE_PRESS_STATE,size:10})]})]}),e.jsxs(rs,{children:[e.jsx(Ht,{}),e.jsx(qt,{currentFilter:o.sortBy,onChangeFilter:S})]}),e.jsx(os,{align:"center",justify:t&&!r?"center":"flex-start",children:t&&!r?e.jsx(T,{color:n.white}):e.jsxs(e.Fragment,{children:[e.jsx(es,{onTopicEdit:Le,showMuted:o.is_muted}),x>l.length?e.jsxs(B,{className:"load-more",disabled:t,onClick:v,children:["Load more",t&&e.jsx(T,{color:n.BLUE_PRESS_STATE,size:10})]}):null]})})]}),w&&e.jsx(Vt,{onClose:k,topic:w}),w&&e.jsx(Pt,{onClose:k,topic:w}),w&&e.jsx(Rt,{onClose:k,topic:w})]})},ns=d(p)`
  flex: 1;
...
`,cs=d(p)`
  min-height: 0;
  flex: 1;
`,ks=()=>{const{close:t}=E("sourcesTable");return e.jsx(P,{background:"BG1",id:"sourcesTable",kind:"large",noWrap:!0,onClose:t,children:e.jsx(ls,{})})};export{ks as SourcesTableModal};
