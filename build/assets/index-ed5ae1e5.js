import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,x as D,B as F}from"./index-e0a0c085.js";import{B as M}from"./index-7cba63f0.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-faf2155f.js";import{B as f,T as L,a as R}from"./index-bdae7508.js";import{T as x}from"./index-4b0f9252.js";import"./useSlotProps-55b3051f.js";import"./index.esm-8f3804c8.js";import"./InfoIcon-9fe7a1d6.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
