import{r as i,j as e,s as u,g as S,F as j,o as X,c as Y,A as oe,p as ie,i as ae,q as ce,H as le,t as pe,v as de}from"./index-b5ecf585.js";import{t as O,u as H,C as ue}from"./index-bab23bce.js";import{U as fe}from"./index-560fc11a.js";import{u as T,a as me,b as ge,I as he,c as J,d as xe}from"./index-37d766d2.js";import{M as ye,V as be}from"./index-df73ba4d.js";import{S as we,R as je,s as V,M as ve}from"./index-58e59a35.js";import"./string-a277709d.js";import"./index-53cf2bda.js";import"./three.module-976f5d36.js";import"./index-362a76b4.js";import"./TextareaAutosize-43932985.js";import"./CheckIcon-397d6076.js";import"./index-63d41b98.js";import"./index-be838982.js";import"./ClipLoader-ebec20fb.js";import"./clsx-6afd75e8.js";import"./SourcesTableIcon-76623bd8.js";import"./DeleteNodeIcon-294007fa.js";import"./SoundIcon-6d509bc3.js";import"./SucessFeedBackIcon-04cd4db4.js";import"./Skeleton-1a768cc0.js";import"./index-8b0c1302.js";import"./Stack-ff6a6a00.js";import"./FormControlLabel-fbab41b1.js";import"./Typography-27aca46d.js";import"./createSvgIcon-84909391.js";import"./isPlainObject-5c5e7d38.js";const K=i.memo(()=>{const r=T(n=>n.isPlaying),a=T(n=>n.setIsPlaying),s=T(n=>n.setVolume),t=T(n=>n.setPlaybackSpeed),c=T(n=>n.playbackSpeed),o=T(n=>n.playerRef),[d,g]=i.useState(!1),m=[.5,1,1.5,2],h=()=>{if(o){const n=o.getCurrentTime()-15;o.seekTo(n,"seconds")}},f=()=>{if(o){const n=o.getCurrentTime()+15;o.seekTo(n,"seconds")}},w=()=>{a(!r)},p=()=>{g(!d),s(d?1:0)},l=()=>{const x=(m.indexOf(c)+1)%m.length,P=m[x];if(t(P),o){const k=o.getInternalPlayer();k&&typeof k.playbackRate<"u"&&(k.playbackRate=P)}};return e.jsxs(Se,{children:[e.jsx(Pe,{onClick:p,children:d?e.jsx(ye,{}):e.jsx(be,{})}),e.jsx(Ce,{onClick:h,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(ke,{"data-testid":"play-pause-button",onClick:w,size:"small",children:r?e.jsx(me,{"data-testid":"pause-icon"}):e.jsx(ge,{"data-testid":"play-icon"})}),e.jsx(Ie,{onClick:f,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(_e,{onClick:l,children:[c,"x"]})]})});K.displayName="Controls";const Se=u(j).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${S.BG1};
  border-radius: 40px;
