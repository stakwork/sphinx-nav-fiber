import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-3f86c6ed.js";import{B as F}from"./index-7c1c97a4.js";import{u as M}from"./index-8c22864e.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-0ea58a14.js";import{B as f,T as R,a as L}from"./index-c6780d8b.js";import{T as x}from"./index-725b98e8.js";import"./useSlotProps-74d3aa0d.js";import"./index.esm-18d63a86.js";import"./InfoIcon-eab5a829.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
