import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-7581c61b.js";import{B as M}from"./index-757c305d.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-faf00f02.js";import{B as f,T as L,a as R}from"./index-de10eb26.js";import{T as x}from"./index-c4429dc0.js";import"./useSlotProps-a387145b.js";import"./index.esm-e417f1f8.js";import"./InfoIcon-faa9e813.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
