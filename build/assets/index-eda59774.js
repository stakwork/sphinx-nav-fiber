...
`,xo=d.div`
  ...
  color: #6b7a8d;
  line-height: 1;
`,uo=({topic:t,onClose:s})=>{const{close:n}=E("addEdge"),[r]=I(j=>[j.data]),a=ye({mode:"onChange"}),[l,i]=h.useState(!1),[o,c]=h.useState(!1),[u,m]=h.useState(""),[p,b]=h.useState(null),C=()=>{s(),n()},y=async()=>{if(!(!p||!r)){c(!0);try{await jt({from:t.ref_id,to:p==null?void 0:p.ref_id,relationship:u});const{ref_id:j}=t,{ref_id:S}=p;if(r){const k={...r};k[j]={...k[j],edgeList:[...k[j].edgeList,u]},k[S]&&(k[S]={...k[S],edgeList:[...k[S].edgeList,u]}),I.setState({data:k})}C()}catch(j){console.warn(j)}finally{c(!1)}}},w=o||!p||!u;return e.jsx(le,{id:"addEdge",kind:"small",onClose:C,preventOutsideClose:!0,children:e.jsxs(we,{...a,children:[e.jsx(so,{from:t,isSwapped:l,onSelect:b,selectedToNode:p,selectedType:u,setIsSwapped:()=>i(!l),setSelectedType:m}),e.jsxs(go,{color:"secondary",disabled:w,onClick:y,size:"large",variant:"contained",children:["Confirm",o&&e.jsx(fo,{children:e.jsx(M,{color:x.lightGray,size:12})})]})]})})},go=d(W)`
...
`,Zo=d.span`
  ...
  align-items: center;
  justify-content: center;
`,Yo=h.memo(Wo),Qo=({setShowMuteUnmute:t,showMuted:s,onTopicEdit:n,onChangeFilter:r,checkedStates:a,setCheckedStates:l})=>{const{close:i}=E("sourcesTable"),[o,c]=h.useState(!1),[u,m]=oe.useState(null),[p,b]=oe.useState(""),C=Object.values(a).filter(v=>v).length,[y,w]=vt(v=>[v.setSearchFormValue,v.setCurrentSearch]),[j,S,k]=I(v=>[v.data,v.ids,v.total]),A=h.useCallback((v,R)=>{m(v.currentTarget),b(R)},[]),F=()=>{m(null)},z=v=>{y(v),w(v),i()},B=v=>{n(p,v),F()},O=v=>{r(v)},$=!!u,T=$?"simple-popover":void 0,_=async()=>{c(!0);try{const v=Object.keys(a).map(async G=>{if(a[G])try{return await ae(G,{node_data:{is_muted:!s}}),G}catch(ht){return console.error("Error updating node data:",ht),null}return null}),R=await Promise.all(v);I.setState({ids:S.filter(G=>!R.includes(G)),total:k-R.length}),l({}),c(!1)}catch(v){console.error("Error:",v),c(!1)}};return j?e.jsx(e.Fragment,{children:Object.keys(j).length?e.jsx(on,{align:"center",justify:o?"center":"flex-start",children:o?e.jsx(M,{color:x.white}):e.jsxs(e.Fragment,{children:[e.jsxs(ce,{component:"table",children:[C>0?e.jsx(vs,{children:e.jsxs(V,{component:"tr",children:[e.jsx(f,{children:e.jsx(Y,{onClick:()=>l({}),children:e.jsx(te,{})})}),e.jsx(f,{colSpan:12,children:e.jsxs(sn,{children:[e.jsxs(tn,{children:[e.jsx(en,{children:C}),"selected"]}),e.jsx(f,{className:"empty"}),e.jsx(De,{onClick:_,role:"button",children:s?e.jsxs(e.Fragment,{children:[e.jsx(Ue,{})," Unmute ALL"]}):e.jsxs(e.Fragment,{children:[e.jsx(Pe,{})," Mute ALL"]})}),e.jsx(f,{className:"empty"}),e.jsxs(De,{onClick:()=>B("mergeTopic"),children:[e.jsx(ze,{})," Merge"]})]})}),e.jsx(f,{className:"empty"})]})}):e.jsx(he,{children:e.jsxs(V,{component:"tr",children:[e.jsx(f,{className:"empty"}),e.jsx(f,{children:e.jsxs(me,{onClick:()=>O(ve),children:["Name ",e.jsx(fe,{})]})}),e.jsx(f,{children:"Type"}),e.jsx(f,{children:e.jsxs(me,{onClick:()=>O(kt),children:["Count ",e.jsx(fe,{})]})}),e.jsx(f,{children:"Edge list"}),e.jsx(f,{children:e.jsxs(me,{onClick:()=>O($t),children:["Date ",e.jsx(fe,{})]})}),e.jsx(f,{children:e.jsx(g,{px:8,children:e.jsxs(Xo,{onClick:t,children:[e.jsx(qo,{checked:s,children:e.jsx(Ko,{children:s&&e.jsx(it,{})})}),"Muted"]})})})]})}),j&&e.jsx("tbody",{children:S==null?void 0:S.map(v=>e.jsx(Yo,{checkedStates:a,isMuteDisabled:Object.values(a).filter(R=>R).length>1,onClick:A,onSearch:z,setCheckedStates:l,topic:j[v]},v))})]}),p?e.jsxs(Jo,{anchorEl:u,anchorOrigin:{vertical:"bottom",horizontal:"right"},id:T,onClose:F,open:$,transformOrigin:{vertical:"top",horizontal:"right"},children:[s?e.jsxs(Z,{"data-testid":"unmute",onClick:()=>B("unMute"),children:[" ",e.jsx(Ue,{"data-testid":""})," Unmute"]}):e.jsxs(Z,{"data-testid":"mute",onClick:()=>B("mute"),children:[" ",e.jsx(Pe,{"data-testid":"VisibilityOff"})," Mute"]}),e.jsxs(Z,{"data-testid":"rename",onClick:()=>B("editTopic"),children:[e.jsx(Ao,{"data-testid":"EditTopicIcon"})," Rename"]}),e.jsxs(Z,{"data-testid":"merge",onClick:()=>B("mergeTopic"),children:[e.jsx(ze,{"data-testid":"MergeIcon"})," Merge"]}),e.jsxs(Z,{"data-testid":"add_edge",onClick:()=>B("addEdge"),children:[e.jsx(Pt,{"data-testid":"AddCircleIcon"})," Add edge"]})]}):null]})}):e.jsxs(g,{children:[e.jsx(L,{children:"There is not any results for selected filters"}),e.jsx(be,{})]})}):e.jsxs(g,{children:[e.jsx(L,{children:"There is not any results for selected filters"}),e.jsx(be,{})]})},Xo=d.td`
  cursor: pointer;
  display: flex;
  align-items: center;
`,qo=d.div`
...
`,on=d(g)`
  ...
  width: 100%;
  position: relative;
`,nn=()=>{const[t,s,n,r,a,l,i,o]=I(T=>[T.data,T.ids,T.total,T.setTopics,T.filters,T.setFilters,T.terminate,T.loading]),{open:c}=E("editTopic"),{open:u}=E("mergeTopic"),{open:m}=E("addEdge"),[p,b]=h.useState(null),[C,y]=h.useState([]),[w,j]=h.useState({}),S={editTopic:c,mergeTopic:u,addEdge:m},k=h.useRef([]);h.useEffect(()=>{s.length&&(k.current=s)},[s]),h.useEffect(()=>{(async()=>{try{await r()}catch{console.error("err")}})()},[r,a]);const A=async()=>{l({page:a.page+1})};h.useEffect(()=>()=>{i()},[i]);const F=T=>{l({sortBy:T})},z=()=>{b(null),y([])},B=async(T,_)=>{try{await ae(T,{node_data:{is_muted:_==="mute"}}),I.setState({ids:s.filter(v=>v!==T),total:n-1})}catch(v){console.warn(v)}},O=async(T,_)=>{if(t)if(_==="mergeTopic")if(Object.values(w).filter(v=>v).length>0){const v=Object.entries(w).filter(([,R])=>R).map(([R])=>t[R]);y(v),u()}else y([t[T]]),b(t[T]),u();else["mute","unMute"].includes(_)&&await B(T,_),typeof S[_]=="function"&&S[_](),b(t[T])},$=T=>{l({...a,search:T})};return e.jsxs(e.Fragment,{children:[e.jsxs(rn,{direction:"column",justify:"flex-end",children:[e.jsx(xe,{align:"flex-start",direction:"row",justify:"space-between",children:e.jsx(L,{className:"title",children:"Topics"})}),e.jsx(ln,{"data-testid":"topic-search-container",children:e.jsx(dt,{activeIcon:e.jsx(te,{}),defaultIcon:e.jsx(ot,{}),loading:o,loadingIcon:e.jsx(M,{color:x.lightGray,size:24}),onSearch:$,placeholder:"Search ..."})}),e.jsx(an,{align:"center",justify:o&&!t?"center":"flex-start",children:o&&!t?e.jsx(M,{color:x.white}):e.jsxs(e.Fragment,{children:[e.jsx(Qo,{checkedStates:w,onChangeFilter:F,onTopicEdit:O,setCheckedStates:j,setShowMuteUnmute:()=>l({is_muted:!a.is_muted}),showMuted:a.is_muted}),n>s.length?e.jsxs(W,{className:"load-more",disabled:o,onClick:A,children:["Load more",o&&e.jsx(M,{color:x.lightGray,size:10})]}):null]})})]}),C.length>0&&e.jsx(Io,{multiTopics:C,onClose:z}),p&&e.jsx(bo,{onClose:z,topic:p}),p&&e.jsx(uo,{onClose:z,topic:p})]})},rn=d(g)`
  flex: 1;
