import{o as v,q,T as F,F as n,r as x,j as e,aU as J,b7 as U,C as K,y as $,b8 as Q,N as D,b2 as O,bj as X,bm as Z}from"./index-20d5a758.js";import{h as V,B as E,i as N,F as ee}from"./index-ec312d21.js";import{B as te}from"./index-50f7e1fc.js";import{T as re}from"./index-97850cd9.js";import{p as G}from"./index-44e303ef.js";import{n as ne,A as W}from"./index-4a26890c.js";import{C as Y}from"./ClipLoader-756624ae.js";import{c as oe}from"./index-64f1c910.js";import"./index.esm-522fb52e.js";import"./InfoIcon-69194e55.js";import"./three.module-2ce81f73.js";import"./index-ee8b950d.js";import"./Stack-758ee1de.js";import"./useSlotProps-42ca79ec.js";import"./Popover-e9d8d719.js";import"./createSvgIcon-334b79d5.js";import"./TextareaAutosize-97e318d6.js";const M=s=>s.charAt(0).toUpperCase()+s.slice(1).replace(/_/g," "),k=s=>s?[...s].sort((l,m)=>Number(m.required)-Number(l.required)):[],H=s=>s?s.filter(l=>l.key!=="node_key"):[],se=({handleSelectType:s,skipToStep:l,nodeType:m,selectedValues:r})=>{const[f,w]=x.useState(!1),[h,C]=x.useState(),{watch:j,formState:{isValid:t}}=V();x.useEffect(()=>{(async()=>{w(!0);const o=await U(m),T=G(o),A=H(T);C(A),w(!1)})()},[m,j]);const i=c=>c.charAt(0).toUpperCase()+c.slice(1).replace(/_/g," "),p=(h?[...h].sort((c,o)=>c.required&&!o.required?-1:!c.required&&o.required?1:0):[]).filter(c=>!!(c.required&&!Object.values(r).includes(c.key))),S=()=>{s(""),l("sourceType")},b=!t||f||p.some(c=>{var o;return c.required&&!((o=j(c.key))!=null&&o.trim())});return e.jsxs(n,{children:[e.jsx(n,{align:"center",direction:"row",justify:"space-between",mb:18,children:e.jsx(n,{align:"center",direction:"row",children:e.jsx(ie,{children:"Required Properties"})})}),e.jsx(ae,{children:f?e.jsx(n,{style:{margin:"auto"},children:e.jsx(Y,{color:q.SECONDARY_BLUE})}):e.jsx(n,{className:"input__wrapper",children:p==null?void 0:p.map(({key:c,required:o})=>e.jsx(e.Fragment,{children:e.jsxs(ce,{children:[e.jsx(F,{children:i(c)}),e.jsx(re,{id:"item-name",maxLength:50,name:c,placeholder:o?"Required":"Optional",rules:{...o?{...J,pattern:{message:"No leading whitespace allowed",value:ne}}:{}}})]})}))})}),e.jsxs(n,{direction:"row",children:[e.jsx(n,{grow:1,children:e.jsx(E,{color:"secondary",onClick:S,size:"large",variant:"contained",children:"Prev"})}),e.jsx(n,{grow:1,ml:20,children:e.jsx(E,{color:"secondary",disabled:b,onClick:()=>l("createConfirmation"),size:"large",variant:"contained",children:"Next"})})]})]})},ie=v(F)`
  font-size: 22px;
  font-weight: 600;
  font-family: 'Barlow';
`,ae=v(n)`
