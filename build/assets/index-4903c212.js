import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,x as D,B as F}from"./index-b7228c1a.js";import{B as M}from"./index-155ead8e.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-8496e00c.js";import{B as f,T as L,a as R}from"./index-e6a60da5.js";import{T as x}from"./index-ac6ab740.js";import"./useSlotProps-fcaa0769.js";import"./index.esm-0c7d80df.js";import"./InfoIcon-f4782b5c.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
