import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-b2ff16a5.js";import{B as M}from"./index-199b4cde.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-01a5e0c7.js";import{B as f,T as L,a as R}from"./index-658208c4.js";import{T as x}from"./index-79e8d037.js";import"./useSlotProps-ce221909.js";import"./index.esm-ed5215c3.js";import"./InfoIcon-25e60a0e.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
