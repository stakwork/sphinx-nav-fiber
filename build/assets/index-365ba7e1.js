import{s as r,F as n,T as g,j as e,b as w,c,r as A,u as B}from"./index-acf86df8.js";import{B as v}from"./index-f58c2ff2.js";import{u as F}from"./index-709a04ec.js";import{u as M,G as $,l as C,b,q as D,F as G}from"./react-toastify.esm-9e975f1c.js";import{B as f,T as k,a as R}from"./index-1658b0e9.js";import{T as x}from"./index-4c09a329.js";import{C as L}from"./ClipLoader-930b6314.js";import"./useSlotProps-6fcf1e83.js";import"./index.esm-fdb798ec.js";import"./InfoIcon-221d62e1.js";const P=({onClose:s})=>{const[a]=M(t=>[t.graphStyle]),i=()=>{localStorage.setItem("graphStyle",a),s()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:i,children:"Save changes"})})]})},V=r(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=r(g)`
