import{f as r,F as i,T as g,i as y,j as e,k as b,L as S,D as w,h as x,r as T,x as v,B as m}from"./index-ba8c0023.js";import{B}from"./index-71a91213.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-44014407.js";import{B as f,T as $,a as k}from"./index-9863df48.js";import{T as u}from"./index-b48b96cc.js";import"./useSlotProps-177046b3.js";import"./index.esm-d5767846.js";import"./InfoIcon-a633aee4.js";const F=({onClose:t})=>{const[s]=y(n=>[n.graphStyle]),o=()=>{localStorage.setItem("graphStyle",s),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(L,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(i,{mt:308,children:e.jsx(f,{kind:"big",onClick:o,children:"Save Changes"})})]})},G=r(i)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,L=r(g)`
