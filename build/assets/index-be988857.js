import{r as l,x as fe,c as he,j as e,s as y,a as j,F as C,T as xe,u as G,d as re,y as me,N as J,z as ge,A as ye,D as se,E as we}from"./index-6d1c598d.js";import{Universe as be}from"./index-3b6e25a9.js";import{b as oe,c as k,M as je,V as Ce,d as ve,e as _e,f as Se,g as Ee,h as Te,a as Ie}from"./index-69caa640.js";import{S as Re,R as Pe,s as K,M as ke}from"./index-147c5750.js";import{u as L,a as ne,m as $e,T as ze,f as Me,H as Ae,C as Le}from"./index-eaba9367.js";import{W as We,L as Q,H as He,D as Fe,F as Be,V as M,S as De}from"./three.module-10ab52a5.js";import{T as Ne}from"./index-9d7b691a.js";import"./index-a546f3e2.js";import"./TextareaAutosize-74e2d52c.js";import"./index-8951e32c.js";import"./ClipLoader-1810c314.js";import"./Skeleton-66289933.js";import"./Stack-8bf0c769.js";import"./isPlainObject-354b41df.js";import"./Typography-b588d478.js";import"./createSvgIcon-19d7d360.js";import"./index-424b4cf9.js";function Ge(t,s,r){const{gl:n,size:i,viewport:u}=L(),x=typeof t=="number"?t:i.width*u.dpr,c=typeof s=="number"?s:i.height*u.dpr,o=(typeof t=="number"?r:t)||{},{samples:a=0,depth:m,...g}=o,p=l.useMemo(()=>{let f;return f=new We(x,c,{minFilter:Q,magFilter:Q,encoding:n.outputEncoding,type:He,...g}),m&&(f.depthTexture=new Fe(x,c,Be)),f.samples=a,f},[]);return l.useLayoutEffect(()=>{p.setSize(x,c),a&&(p.samples=a)},[a,p,x,c]),l.useEffect(()=>()=>p.dispose(),[]),p}const Ze=t=>typeof t=="function",Oe=l.forwardRef(({envMap:t,resolution:s=256,frames:r=1/0,children:n,makeDefault:i,...u},x)=>{const c=L(({set:h})=>h),o=L(({camera:h})=>h),a=L(({size:h})=>h),m=l.useRef(null),g=l.useRef(null),p=Ge(s);l.useLayoutEffect(()=>{u.manual||m.current.updateProjectionMatrix()},[a,u]),l.useLayoutEffect(()=>{m.current.updateProjectionMatrix()}),l.useLayoutEffect(()=>{if(i){const h=o;return c(()=>({camera:m.current})),()=>c(()=>({camera:h}))}},[m,i,c]);let f=0,d=null;const w=Ze(n);return ne(h=>{w&&(r===1/0||f<r)&&(g.current.visible=!1,h.gl.setRenderTarget(p),d=h.scene.background,t&&(h.scene.background=t),h.gl.render(h.scene,m.current),h.scene.background=d,h.gl.setRenderTarget(null),g.current.visible=!0,f++)}),l.createElement(l.Fragment,null,l.createElement("orthographicCamera",fe({left:a.width/-2,right:a.width/2,top:a.height/2,bottom:a.height/-2,ref:$e([m,x])},u),!w&&n),l.createElement("group",{ref:g},w&&n(p.texture)))}),Ve={selectedEpisodeId:"",selectedEpisodeLink:"",selectedEpisode:null},Z=he(t=>({...Ve,setSelectedEpisodeId:s=>t({selectedEpisodeId:s}),setSelectedEpisodeLink:s=>t({selectedEpisodeLink:s}),setSelectedEpisode:s=>t({selectedEpisode:s})})),Ye=t=>e.jsxs("svg",{width:"1em",height:"1em",viewBox:"0 0 30 28",fill:"currentColor",xmlns:"http://www.w3.org/2000/svg",children:[e.jsx("path",{d:"M7.2998 2.55199C7.2998 1.51094 8.11675 0.666992 9.1245 0.666992H12.1299C13.1376 0.666992 13.9546 1.51094 13.9546 2.55199C13.9546 3.59305 13.1376 4.43699 12.1299 4.43699H9.1245C8.11675 4.43699 7.2998 3.59305 7.2998 2.55199Z",fill:"currentColor"}),e.jsx("path",{d:"M7.2998 25.449C7.2998 26.49 8.11675 27.334 9.1245 27.334H12.1299C13.1376 27.334 13.9546 26.49 13.9546 25.449C13.9546 24.4079 13.1376 23.564 12.1299 23.564H9.1245C8.11675 23.564 7.2998 24.4079 7.2998 25.449Z",fill:"currentColor"}),e.jsx("path",{d:"M2.79102 8.29613C2.79102 7.25508 3.60796 6.41113 4.61571 6.41113H12.1292C13.1369 6.41113 13.9539 7.25508 13.9539 8.29613C13.9539 9.33719 13.1369 10.1811 12.1292 10.1811H4.61571C3.60796 10.1811 2.79102 9.33719 2.79102 8.29613Z",fill:"currentColor"}),e.jsx("path",{d:"M2.79102 19.7039C2.79102 20.7449 3.60796 21.5889 4.61571 21.5889H12.1292C13.1369 21.5889 13.9539 20.7449 13.9539 19.7039C13.9539 18.6628 13.1369 17.8189 12.1292 17.8189H4.61571C3.60796 17.8189 2.79102 18.6628 2.79102 19.7039Z",fill:"currentColor"}),e.jsx("path",{d:"M0 14.094C0 13.0529 0.816945 12.209 1.8247 12.209H12.1289C13.1366 12.209 13.9536 13.0529 13.9536 14.094C13.9536 15.135 13.1366 15.979 12.1289 15.979H1.8247C0.816946 15.979 0 15.135 0 14.094Z",fill:"currentColor"}),e.jsx("path",{d:"M22.7002 25.448C22.7002 26.4891 21.8833 27.333 20.8755 27.333H17.8701C16.8624 27.333 16.0454 26.4891 16.0454 25.448C16.0454 24.407 16.8624 23.563 17.8701 23.563H20.8755C21.8832 23.563 22.7002 24.407 22.7002 25.448Z",fill:"currentColor"}),e.jsx("path",{d:"M22.7002 2.55199C22.7002 1.51094 21.8833 0.666992 20.8755 0.666992H17.8701C16.8624 0.666992 16.0454 1.51094 16.0454 2.55199C16.0454 3.59305 16.8624 4.43699 17.8701 4.43699H20.8755C21.8832 4.43699 22.7002 3.59305 22.7002 2.55199Z",fill:"currentColor"}),e.jsx("path",{d:"M27.209 19.7029C27.209 20.7439 26.392 21.5879 25.3843 21.5879H17.8708C16.8631 21.5879 16.0461 20.7439 16.0461 19.7029C16.0461 18.6618 16.8631 17.8179 17.8708 17.8179H25.3843C26.392 17.8179 27.209 18.6618 27.209 19.7029Z",fill:"currentColor"}),e.jsx("path",{d:"M27.209 8.29613C27.209 7.25508 26.392 6.41113 25.3843 6.41113H17.8708C16.8631 6.41113 16.0461 7.25508 16.0461 8.29613C16.0461 9.33719 16.8631 10.1811 17.8708 10.1811H25.3843C26.392 10.1811 27.209 9.33719 27.209 8.29613Z",fill:"currentColor"}),e.jsx("path",{d:"M30 14.093C30 13.052 29.1831 12.208 28.1753 12.208H17.8711C16.8634 12.208 16.0464 13.052 16.0464 14.093C16.0464 15.1341 16.8634 15.978 17.8711 15.978H28.1753C29.1831 15.978 30 15.1341 30 14.093Z",fill:"currentColor"})]}),qe=()=>e.jsxs(Ue,{children:[e.jsx(Je,{children:e.jsx(Ke,{children:e.jsx(Ye,{})})}),e.jsx(Qe,{children:"Graph Mindset"})]}),Ue=y(C).attrs({align:"center",direction:"row",grow:1,justify:"flex-start"})`
  height: 64px;
...
`,kt=y.button`
  ...
  cursor: pointer;
  transition: background-color 0.3s ease;
`,ce=l.memo(({type:t,left:s,img:r})=>{var o,a;const n=re(m=>m.normalizedSchemasByType),i=(o=n[t])==null?void 0:o.primary_color,u=(a=n[t])==null?void 0:a.icon,x=u?`svg-icons/${u}.svg`:"",c={iconStart:r||x,color:i??j.THING};return e.jsx(zt,{style:{left:`${s}%`},children:e.jsx(le,{...c,label:t})})});ce.displayName="Marker";const le=l.memo(({iconStart:t,color:s,label:r})=>e.jsx($t,{color:s,children:t&&e.jsx("img",{alt:r,className:"badge__img",src:t})}));le.displayName="Badge";const $t=y(C).attrs({direction:"row"})`
  cursor: pointer;
...
`,Wt=({markers:t})=>{const{playingNode:s,playerRef:r}=k(o=>o),[n,i]=l.useState(0),u=s,x=l.useCallback((o,a)=>{const m=Array.isArray(a)?a[0]:a;r&&r.seekTo(m,"seconds")},[r]);l.useEffect(()=>{const o=setInterval(()=>{if(r&&i){const a=r.getCurrentTime();i(a)}},500);return()=>clearInterval(o)},[r,i]);const c=(r==null?void 0:r.getDuration())||0;return u?e.jsxs(Ht,{children:[e.jsx(ae,{}),e.jsx(Mt,{duration:c,handleProgressChange:x,markers:t,playingTIme:n})]}):null},Ht=y(C).attrs({direction:"row",align:"center",justify:"space-between"})`
  padding: 20px;
  background: ${j.BG2};
  height: 96px;
  margin-top: 16px;
  border-radius: 8px;
  box-sizing: border-box;
`,Ft=({sourcePosition:t,targetPosition:s,color:r="white",arrowSize:n=1,label:i="label"})=>{const{points:u,textPosition:x}=l.useMemo(()=>{const c=new M(t.x,t.y,t.z),o=new M(s.x,s.y,s.z),a=new M().subVectors(o,c).normalize(),m=new M().addVectors(c,o).multiplyScalar(.5),g=new M().copy(a).multiplyScalar(-n).applyAxisAngle(new M(0,0,1),Math.PI/6),p=new M().copy(a).multiplyScalar(-n).applyAxisAngle(new M(0,0,1),-Math.PI/6);return{points:[c,o,o.clone(),o.clone().add(g),o.clone(),o.clone().add(p)],textPosition:m}},[t,s,n]);return e.jsxs(e.Fragment,{children:[e.jsxs("line",{children:[e.jsx("bufferGeometry",{children:e.jsx("bufferAttribute",{array:new Float32Array(u.flatMap(c=>[c.x,c.y,c.z])),attach:"attributes-position",count:u.length,itemSize:3})}),e.jsx("lineBasicMaterial",{color:r})]}),i&&e.jsx(ze,{anchorX:"center",anchorY:"middle",color:r,...Me,position:x,children:i})]})},Bt=(t,s,r)=>{const n=new De;return n.moveTo(-t/2+r,-s/2),n.lineTo(t/2-r,-s/2),n.quadraticCurveTo(t/2,-s/2,t/2,-s/2+r),n.lineTo(t/2,s/2-r),n.quadraticCurveTo(t/2,s/2,t/2-r,s/2),n.lineTo(-t/2+r,s/2),n.quadraticCurveTo(-t/2,s/2,-t/2,s/2-r),n.lineTo(-t/2,-s/2+r),n.quadraticCurveTo(-t/2,-s/2,-t/2+r,-s/2),n},Dt=({width:t,height:s,radius:r,color:n})=>{const i=Bt(t,s,r);return e.jsxs("mesh",{children:[e.jsx("shapeGeometry",{args:[i]}),e.jsx("meshBasicMaterial",{color:n,opacity:.9,transparent:!0})]})},Nt=({name:t,url:s,type:r})=>e.jsxs(Gt,{children:[s&&e.jsx("img",{alt:"",className:"image",src:s}),e.jsx("div",{className:"title",children:t}),e.jsx("div",{className:"badge",children:e.jsx(Ne,{type:r})}),e.jsx("div",{className:"action-btn",children:e.jsx(Ee,{})})]}),Gt=y(C)`
  position: relative;
  padding: 14px;
  padding-right: 28px;
  flex: 1;
