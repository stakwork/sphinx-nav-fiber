import{s as r,F as n,T as g,j as e,B as b,b as w,c as p,r as A,u as B}from"./index-5306a408.js";import{B as v}from"./index-b028ef43.js";import{u as F}from"./index-4f2243af.js";import{u as M,l as $,b as f,q as C,F as D}from"./react-toastify.esm-2eb26066.js";import{G}from"./index-3bea8afa.js";import{T as x}from"./index-a98a75bd.js";import{C as k}from"./ClipLoader-9a18032d.js";import{T as R,a as L}from"./Tabs-8909515e.js";import"./index.esm-86aae897.js";import"./InfoIcon-63dc394a.js";import"./useSlotProps-93ea3d7c.js";const P=({onClose:s})=>{const[a]=M(t=>[t.graphStyle]),i=()=>{localStorage.setItem("graphStyle",a),s()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(G,{}),e.jsx(n,{mt:308,children:e.jsx(b,{kind:"big",onClick:i,children:"Save changes"})})]})},V=r(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=r(g)`
