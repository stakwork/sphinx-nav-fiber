import{o as s,F as o,T as w,p as C,r as f,j as e,q as c,A as S,aU as A,aV as b,aW as M,M as z,Q as y}from"./index-3821af61.js";import{B as D}from"./index-71a82496.js";import{G,B as v,i as $,F as B}from"./index-e31587f6.js";import{C as T}from"./ClipLoader-915eb755.js";import{T as j}from"./index-03875d31.js";import{S as E}from"./index-b09eaee3.js";import{e as I}from"./index.esm-d0c0fad4.js";import{T as k,a as F}from"./Tabs-b090c48c.js";import"./InfoIcon-c4744513.js";import"./useSlotProps-401cc822.js";import"./createSvgIcon-f73c428a.js";const R=({onClose:a})=>{const[l]=C(d=>[d.graphStyle]),[r,i]=f.useState(!1),p=()=>{i(!0),localStorage.setItem("graphStyle",l),i(!1),a()};return e.jsxs(W,{direction:"column",children:[e.jsx(V,{children:"Default graph view:"}),e.jsx(G,{}),e.jsx(o,{mt:308,py:24,children:e.jsx(v,{color:"secondary",disabled:r,id:"add-node-submit-cta",onClick:p,size:"large",startIcon:r&&e.jsx(L,{children:e.jsx(T,{color:c.lightGray,size:12})}),type:"submit",variant:"contained",children:"Save Changes"})})]})},W=s(o)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,V=s(w)`
