import{r as i,j as e,s as u,g as S,F as j,o as X,c as Y,A as oe,p as ie,i as ae,q as ce,H as le,t as pe,v as de}from"./index-3bf90c5a.js";import{t as O,u as H,C as ue}from"./index-bb9390b7.js";import{U as fe}from"./index-f514a901.js";import{u as T,a as me,b as ge,I as he,c as J,d as xe}from"./index-6ba99f54.js";import{M as ye,V as be}from"./index-edfd4bb9.js";import{S as we,R as je,s as V,M as ve}from"./index-16481d5e.js";import"./string-a277709d.js";import"./index-9d88d5fb.js";import"./three.module-976f5d36.js";import"./index-6eca2e88.js";import"./TextareaAutosize-5946c693.js";import"./CheckIcon-72019afd.js";import"./index-ec410005.js";import"./index-eb6d4cfe.js";import"./ClipLoader-3ec478ef.js";import"./clsx-a693ceb7.js";import"./SourcesTableIcon-f490b20b.js";import"./DeleteNodeIcon-f26104cf.js";import"./SoundIcon-b07b8abe.js";import"./SucessFeedBackIcon-3e93f19d.js";import"./Skeleton-c74ff386.js";import"./index-0f541144.js";import"./Stack-7e7a7a4a.js";import"./FormControlLabel-9ba5b14f.js";import"./Typography-e4266781.js";import"./createSvgIcon-1bf6d287.js";import"./isPlainObject-e4caa484.js";const K=i.memo(()=>{const r=T(n=>n.isPlaying),a=T(n=>n.setIsPlaying),s=T(n=>n.setVolume),t=T(n=>n.setPlaybackSpeed),c=T(n=>n.playbackSpeed),o=T(n=>n.playerRef),[d,g]=i.useState(!1),m=[.5,1,1.5,2],h=()=>{if(o){const n=o.getCurrentTime()-15;o.seekTo(n,"seconds")}},f=()=>{if(o){const n=o.getCurrentTime()+15;o.seekTo(n,"seconds")}},w=()=>{a(!r)},p=()=>{g(!d),s(d?1:0)},l=()=>{const x=(m.indexOf(c)+1)%m.length,P=m[x];if(t(P),o){const k=o.getInternalPlayer();k&&typeof k.playbackRate<"u"&&(k.playbackRate=P)}};return e.jsxs(Se,{children:[e.jsx(Pe,{onClick:p,children:d?e.jsx(ye,{}):e.jsx(be,{})}),e.jsx(Ce,{onClick:h,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(ke,{"data-testid":"play-pause-button",onClick:w,size:"small",children:r?e.jsx(me,{"data-testid":"pause-icon"}):e.jsx(ge,{"data-testid":"play-icon"})}),e.jsx(Ie,{onClick:f,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(_e,{onClick:l,children:[c,"x"]})]})});K.displayName="Controls";const Se=u(j).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${S.BG1};
  border-radius: 40px;
