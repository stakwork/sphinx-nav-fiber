import{s as h,b as f,g as E,r as m,j as e,F as o,T as u,h as N,B as U,v as V,ak as J,q as Y,aj as S,e as H,a4 as K}from"./index-84e0b589.js";import{aC as Q,B as w,aD as W,q as X,F as Z,aE as ee}from"./react-toastify.esm-1ef9dd2a.js";import{B as te}from"./index-42cc1ddd.js";import{n as y}from"./toastMessage-fa439be9.js";import{a as C}from"./index-f82429c7.js";import{u as oe}from"./index-6ab12e0f.js";import{C as ne}from"./CheckIcon-5c2b157b.js";import{T as _}from"./index-ec028522.js";import{A as se}from"./index-e7cc784a.js";import"./index.esm-8b73d840.js";import"./index-bee64ca9.js";import"./InfoIcon-ce270097.js";import"./index-f8569c04.js";import"./Popover-d66dbbb1.js";import"./useSlotProps-636ece8e.js";import"./Select-ea38c162.js";import"./Stack-3e3b0a93.js";import"./Popper-c754a1b2.js";const re=({onClick:n,loading:a})=>{const i=E(l=>l.budget),[c,p]=m.useState(10),r="node";return m.useEffect(()=>{(async()=>{try{const t=await W(r);p(t.data.price)}catch(t){console.error("cannot fetch",t)}})()},[r]),e.jsxs(o,{children:[e.jsx(o,{align:"center",direction:"row",justify:"space-between",mb:20,children:e.jsx(o,{align:"center",direction:"row",children:e.jsx(ce,{children:"Approve Cost"})})}),e.jsxs(o,{align:"center",direction:"row",justify:"space-between",mb:20,children:[e.jsxs(ae,{children:[e.jsx("div",{className:"title",children:"COST"}),e.jsxs("div",{className:"value","data-testid":"check-price",children:[c," sats"]})]}),e.jsxs(ie,{children:[e.jsx("div",{className:"title",children:"BUDGET"}),e.jsxs("div",{className:"value",children:[Q(i)," sats"]})]})]}),e.jsx(o,{children:e.jsx(w,{color:"secondary","data-testid":"check-icon",disabled:a,onClick:n,size:"large",startIcon:e.jsx(ne,{}),type:"submit",variant:"contained",children:"Approve"})})]})},ae=h(o).attrs({direction:"column",align:"space-between",justify:"flex-start"})`
  width: 141px;
  height: 61px;
