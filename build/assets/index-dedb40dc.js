import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,C as B,h as c,r as v,x as C}from"./index-c3091316.js";import{B as F}from"./index-6fd19dcf.js";import{u as M}from"./index-4da64e1a.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-fad7643a.js";import{B as f,T as L,a as R}from"./index-dd416f27.js";import{T as x}from"./index-569ac69e.js";import"./useSlotProps-d60ec24e.js";import"./index.esm-ca764106.js";import"./InfoIcon-88c27bc6.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
