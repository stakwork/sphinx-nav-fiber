import{Y as i,X as n,Z as m,j as e,ac as T,a0 as p,r as A,a1 as v}from"./index-728fd10a.js";import{aA as M,ch as $,ci as b,cj as k,aK as j,ck as B,cl as D,cm as x,cb as C,cn as F,co as G,u as R,cc as L}from"./index-155cec3b.js";const P=({onClose:a})=>{const[s]=M(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(b,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(m)`
