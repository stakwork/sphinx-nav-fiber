import{s as v,g as q,T as F,F as n,r as m,aw as $,j as e,b2 as J,b3 as K,bj as Q,B as E,bk as U,k as X,bl as Z,D as L,l as N,b1 as O,b5 as ee,n as te,bC as re,bH as ne}from"./index-d7e51bed.js";import{p as V}from"./index-b4a141ad.js";import{C as G}from"./ClipLoader-81a03b2a.js";import{e as H}from"./index-ab61dac3.js";import{A as W}from"./index-c6f6d32e.js";import{c as oe}from"./index-64f1c910.js";import"./three.module-9722a9fc.js";import"./index-6dbe525d.js";import"./SourcesTableIcon-b2b16a20.js";import"./CheckIcon-55d5e3f4.js";import"./DeleteNodeIcon-d7905546.js";import"./SoundIcon-d4dbeaa3.js";import"./SucessFeedBackIcon-0a9d6e2f.js";import"./Stack-e12604a9.js";import"./clsx-bf87f8e9.js";import"./createSvgIcon-2e9bea4b.js";import"./TextareaAutosize-b25655b5.js";const B=s=>s.charAt(0).toUpperCase()+s.slice(1).replace(/_/g," "),R=s=>s?[...s].sort((l,x)=>Number(x.required)-Number(l.required)):[],Y=s=>s?s.filter(l=>l.key!=="node_key"):[],se=({handleSelectType:s,skipToStep:l,nodeType:x,selectedValues:r})=>{const[f,w]=m.useState(!1),[h,C]=m.useState(),{watch:j,formState:{isValid:t}}=$();m.useEffect(()=>{(async()=>{w(!0);const o=await U(x),T=V(o),A=Y(T);C(A),w(!1)})()},[x,j]);const a=c=>c.charAt(0).toUpperCase()+c.slice(1).replace(/_/g," "),p=(h?[...h].sort((c,o)=>c.required&&!o.required?-1:!c.required&&o.required?1:0):[]).filter(c=>!!(c.required&&!Object.values(r).includes(c.key))),S=()=>{s(""),l("sourceType")},b=!t||f||p.some(c=>{var o;return c.required&&!((o=j(c.key))!=null&&o.trim())});return e.jsxs(n,{children:[e.jsx(n,{align:"center",direction:"row",justify:"space-between",mb:18,children:e.jsx(n,{align:"center",direction:"row",children:e.jsx(ae,{children:"Required Properties"})})}),e.jsx(ie,{children:f?e.jsx(n,{style:{margin:"auto"},children:e.jsx(G,{color:q.SECONDARY_BLUE})}):e.jsx(n,{className:"input__wrapper",children:p==null?void 0:p.map(({key:c,required:o})=>e.jsx(e.Fragment,{children:e.jsxs(ce,{children:[e.jsx(F,{children:a(c)}),e.jsx(J,{id:"item-name",maxLength:50,name:c,placeholder:o?"Required":"Optional",rules:{...o?{...K,pattern:{message:"No leading whitespace allowed",value:Q}}:{}}})]})}))})}),e.jsxs(n,{direction:"row",children:[e.jsx(n,{grow:1,children:e.jsx(E,{color:"secondary",onClick:S,size:"large",variant:"contained",children:"Prev"})}),e.jsx(n,{grow:1,ml:20,children:e.jsx(E,{color:"secondary",disabled:b,onClick:()=>l("createConfirmation"),size:"large",variant:"contained",children:"Next"})})]})]})},ae=v(F)`
  font-size: 22px;
  font-weight: 600;
  font-family: 'Barlow';
`,ie=v(n)`
