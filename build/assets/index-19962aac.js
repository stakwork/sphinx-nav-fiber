import{f as y,h as w,F as t,T as S,x as M,r as f,j as e,bd as V,be as W,C as z,b1 as H,J as K,b3 as Q,i as X,b2 as N,W as F,bi as Z,o as ee,bg as te}from"./index-a862a11c.js";import{B as T,C as O,i as se,c as oe,F as ne}from"./react-toastify.esm-e850364a.js";import{B as re}from"./index-1e0a9031.js";import{u as I}from"./index-c73e4a58.js";import{S as ie}from"./index-60e7a5f0.js";import{g as ae}from"./index.esm-0a823913.js";import{C as ce}from"./CheckIcon-c20bd123.js";import{T as E}from"./index-dcf21e2a.js";import{p as le}from"./index-30d16895.js";import{A as de}from"./index-e7c74e91.js";import{d as pe,i as me}from"./index-edfe7d38.js";import"./InfoIcon-b0d8fabf.js";import"./index-09ded96e.js";import"./Popover-4e566a5f.js";import"./useSlotProps-59b36d6b.js";import"./Popper-4feceb0e.js";import"./generateCategoricalChart-6840531e.js";import"./NoFilterResultIcon-c49e2c1f.js";import"./dividerClasses-6d306919.js";import"./index-a2251863.js";import"./index-4318d2ed.js";import"./PlusIcon-125293b9.js";const xe=({onClick:s,loading:p,error:c})=>{const u=M(i=>i.budget),[x,o]=f.useState(10),a="node";return f.useEffect(()=>{(async()=>{try{const h=await W(a);o(h.data.price)}catch(h){console.error("cannot fetch",h)}})()},[a]),e.jsxs(t,{children:[e.jsx(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:e.jsx(t,{align:"center",direction:"row",children:e.jsx(fe,{children:"Approve Cost"})})}),e.jsxs(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:[e.jsxs(ue,{children:[e.jsx("div",{className:"title",children:"COST"}),e.jsxs("div",{className:"value","data-testid":"check-price",children:[x," sats"]})]}),e.jsxs(he,{children:[e.jsx("div",{className:"title",children:"BUDGET"}),e.jsxs("div",{className:"value",children:[V(u)," sats"]})]})]}),e.jsx(t,{children:e.jsx(T,{color:"secondary","data-testid":"check-icon",disabled:p||!!c,onClick:s,size:"large",startIcon:p?e.jsx(O,{size:24}):e.jsx(ce,{}),type:"submit",variant:"contained",children:"Approve"})}),c?e.jsxs(ge,{role:"tooltip",children:[e.jsxs(ye,{children:[e.jsx(ae,{fontSize:13}),e.jsx("span",{children:c})]}),e.jsx("div",{className:"tooltip",children:c})]}):null]})},ue=y(t).attrs({direction:"column",align:"space-between",justify:"flex-start"})`
  width: 141px;
  height: 61px;
...
`,ve=s=>s.charAt(0).toUpperCase()+s.slice(1),ke=({skipToStep:s,allowNextStep:p,onSelectType:c,selectedType:u})=>{const[x]=K(m=>[m.customSchemaFlag]),[o,a]=f.useState(null),[i,h]=f.useState(!1);f.useEffect(()=>{(async()=>{if(x){h(!0);try{const n=await Q(),r=["about","schema"],l=n.schemas.filter(j=>j.ref_id&&!r.includes(j.type)&&!j.is_deleted).map(j=>({label:ve(j.type),value:j.type,action:()=>s("setAttribues")}));a(l)}catch(n){console.warn(n)}finally{h(!1)}}else a([...pe,me])})()},[u,x,s]);const g=m=>{c((m==null?void 0:m.label)||"")};return e.jsxs(t,{children:[e.jsx(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:e.jsx(t,{align:"center",direction:"row",children:e.jsx(Be,{children:"Select Type"})})}),e.jsx(t,{direction:"row",mb:20,children:e.jsx(de,{autoFocus:!0,isLoading:i,onSelect:g,options:o})}),e.jsx(t,{children:e.jsx(T,{color:"secondary",disabled:!p,onClick:()=>s("source"),size:"large",type:"button",variant:"contained",children:"Next"})})]})},Be=y(S)`
  ...
  font-weight: 600;
  font-family: 'Barlow';
`,ze=async(s,p,c)=>{var u,x;if(s.nodeType==="Create custom type"){s.type;try{const o=await F.post("/schema",JSON.stringify(s),{});if(o.error){const{message:a}=o.error;throw new Error(a)}c(s,(u=o==null?void 0:o.data)==null?void 0:u.ref_id),close()}catch(o){let a=N;if(o.status===400){const i=await o.json();a=i.errorCode||(i==null?void 0:i.status)||N}else o instanceof Error&&(a=o.message);throw new Error(a)}}else{const o="node",{nodeType:a,typeName:i,...h}=s,g={node_data:{...h},node_type:a,name:i};s.nodeType==="Image"&&(g.node_data={...s.node_data,source_link:s.sourceLink});let m="";await Z(async()=>{const n=await ee.enable();g.pubkey=n==null?void 0:n.pubkey,m=await te()});try{const n=await F.post(`/${o}`,JSON.stringify(g),{Authorization:m});if(n.error){const{message:r}=n.error;throw new Error(r)}c(s,(x=n==null?void 0:n.data)==null?void 0:x.ref_id),close()}catch(n){let r=N;if(n.status===400)try{const l=await n.json();r=l.message||l.errorCode||(l==null?void 0:l.status)||N}catch{r=N}else n instanceof Error&&(r=n.message);throw new Error(r)}}},Xe=()=>{const[s,p]=f.useState("sourceType"),{close:c,visible:u}=I("addItem"),{open:x}=I("addType"),[o]=M(d=>[d.setBudget]),a=oe({mode:"onChange"}),{watch:i,setValue:h,reset:g}=a,[m,n]=f.useState(!1),[r,l]=f.useState(""),[j,P]=X(d=>[d.addNewNode,d.setSelectedNode]);f.useEffect(()=>()=>{p("sourceType"),g()},[u,g]);const k=i("nodeType"),D=i("typeName"),R=i("sourceLink"),q=i("type");i("title");const L=()=>{c()},B=d=>{p(d)},U=(d,b)=>{const v=b||`new-id-${Math.random()}`,C=d.nodeType.toLocaleLowerCase(),A={name:d.typeName,type:C,label:d.typeName,node_type:C,id:v,ref_id:v,x:Math.random(),y:Math.random(),z:Math.random(),date:parseInt((new Date().getTime()/1e3).toFixed(0),10),weight:4,...d.sourceLink?{source_link:d.sourceLink}:{}};j(A),P(A)},G=a.handleSubmit(async d=>{n(!0);try{await ze(d,o,U),ie("Item Added"),L()}catch(b){let v=N;if((b==null?void 0:b.status)===400){const C=await b.json();v=C.errorCode||(C==null?void 0:C.status)||N}else b instanceof Error&&(v=b.message);l(String(v))}finally{n(!1)}}),_=d=>{d==="Create custom type"?x():h("nodeType",d)},J={sourceType:e.jsx(ke,{allowNextStep:!!k,onSelectType:_,selectedType:k,skipToStep:B}),source:e.jsx(Ce,{name:D,skipToStep:B,sourceLink:R||"",type:k}),setBudget:e.jsx(xe,{loading:m,onClick:()=>null}),createConfirmation:e.jsx(je,{onclose:L,type:q}),setAttribues:e.jsx(we,{handleSelectType:_,nodeType:k,skipToStep:B})},Y="small";return e.jsx(re,{id:"addItem",kind:Y,onClose:c,preventOutsideClose:!0,children:e.jsx(ne,{...a,children:e.jsx("form",{id:"add-node-form",onSubmit:G,children:J[s]})})})};export{Xe as AddItemModal};
