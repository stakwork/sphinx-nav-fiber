...
`,Hs=c.div`
  ...
  font-family: Barlow;
  font-size: 14px;
`,Ds=({kind:t,shape:s})=>{switch(t){case"small":return se`
        padding: 4px 8px;
      ...
      `;default:return se`
        ...
        height: 64px;
      `}},Ps=({kind:t})=>{switch(t){case"small":return"regularBold";case"big":return"mediumBold";default:return"regularBold"}},Us=c(g).attrs({align:"center",direction:"row",justify:"center"})`
  border: none;
  cursor: pointer;
  pointer-events: auto;
