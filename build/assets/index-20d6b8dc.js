import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-97d10828.js";import{B as F}from"./index-b19a4f62.js";import{u as M}from"./index-4abfb697.js";import{j as $,e as k,F as D,C as G}from"./react-toastify.esm-ae0ca7c4.js";import{B as f,T as R,a as L}from"./index-f5f58506.js";import{T as x}from"./index-5a68c77e.js";import"./useSlotProps-01652d22.js";import"./index.esm-a2445b22.js";import"./InfoIcon-fafb4dc2.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
