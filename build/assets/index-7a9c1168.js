import{o as s,F as o,T as w,p as C,r as f,j as e,q as c,A as S,aU as A,aV as b,aW as z,J as D,O as y}from"./index-d05c4a2e.js";import{B as G}from"./index-db57362f.js";import{G as M,B as v,i as $,F as B}from"./index-7b61edf4.js";import{C as T}from"./ClipLoader-6ab2c7fa.js";import{T as j}from"./index-1579a784.js";import{S as E}from"./index-17fd86cc.js";import{e as I}from"./index.esm-1b47139f.js";import{T as k,a as F}from"./Tabs-f23860af.js";import"./InfoIcon-873198eb.js";import"./useSlotProps-bd0c42bf.js";import"./createSvgIcon-c8d54e17.js";const R=({onClose:a})=>{const[l]=C(d=>[d.graphStyle]),[r,i]=f.useState(!1),p=()=>{i(!0),localStorage.setItem("graphStyle",l),i(!1),a()};return e.jsxs(W,{direction:"column",children:[e.jsx(V,{children:"Default graph view:"}),e.jsx(M,{}),e.jsx(o,{mt:308,py:24,children:e.jsx(v,{color:"secondary",disabled:r,id:"add-node-submit-cta",onClick:p,size:"large",startIcon:r&&e.jsx(L,{children:e.jsx(T,{color:c.lightGray,size:12})}),type:"submit",variant:"contained",children:"Save Changes"})})]})},W=s(o)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,V=s(w)`
