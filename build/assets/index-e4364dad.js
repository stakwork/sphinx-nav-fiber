import{s as f,c as y,u as z,r as p,j as e,F as t,T as h,b as N,x as R,o as U,ad as V,ae as g,d as G,a2 as q}from"./index-56a19120.js";import{ak as J,B as j,al as Y,l as H,u as K,F as Q}from"./react-toastify.esm-943194c6.js";import{B as W}from"./index-7de98fdb.js";import{n as S}from"./toastMessage-4e7c3a14.js";import{u as X}from"./index-eda8d570.js";import{C as Z}from"./CheckIcon-6d999bdf.js";import{C as ee}from"./ClipLoader-fbb11b80.js";import{T as B}from"./index-fc21fb19.js";import{A as te}from"./index-0aae735f.js";import{i as v,O as L}from"./constants-84edb5fc.js";import"./index.esm-2a1100f5.js";import"./InfoIcon-ecf7fa88.js";import"./index-6bd66fa3.js";import"./Popover-61c9f885.js";import"./useSlotProps-9ca51873.js";import"./Select-c5ec75f9.js";import"./Stack-8146bfd3.js";import"./Popper-1d2096de.js";const ne=({onClick:n,loading:a})=>{const d=z(l=>l.budget),[c,m]=p.useState(10),s="node";return p.useEffect(()=>{(async()=>{try{const r=await Y(s);m(r.data.price)}catch(r){console.error("cannot fetch",r)}})()},[s]),e.jsxs(t,{children:[e.jsx(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:e.jsx(t,{align:"center",direction:"row",children:e.jsx(re,{children:"Approve Cost"})})}),e.jsxs(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:[e.jsxs(oe,{children:[e.jsx("div",{className:"title",children:"COST"}),e.jsxs("div",{className:"value","data-testid":"check-price",children:[c," sats"]})]}),e.jsxs(se,{children:[e.jsx("div",{className:"title",children:"BUDGET"}),e.jsxs("div",{className:"value",children:[J(d)," sats"]})]})]}),e.jsx(t,{children:e.jsx(j,{color:"secondary","data-testid":"check-icon",disabled:a,onClick:n,size:"large",startIcon:a?e.jsx(ee,{size:24}):e.jsx(Z,{}),type:"submit",variant:"contained",children:"Approve"})})]})},oe=f(t).attrs({direction:"column",align:"space-between",justify:"flex-start"})`
  width: 141px;
  height: 61px;
