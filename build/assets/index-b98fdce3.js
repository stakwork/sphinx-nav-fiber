import{o as s,F as o,T as w,p as C,r as f,j as e,q as c,A as S,aU as A,aV as b,aW as z,J as D,O as y}from"./index-1f7d2a80.js";import{B as G}from"./index-300d2cb1.js";import{G as M,B as v,i as $,F as B}from"./index-7201cee1.js";import{C as T}from"./ClipLoader-d8e0c2e4.js";import{T as j}from"./index-3fe3fc6a.js";import{S as E}from"./index-73f16123.js";import{e as I}from"./index.esm-119229fc.js";import{T as k,a as F}from"./Tabs-47f54b9a.js";import"./InfoIcon-9b66b8a7.js";import"./useSlotProps-b0712be4.js";import"./createSvgIcon-e19b600d.js";const R=({onClose:a})=>{const[l]=C(d=>[d.graphStyle]),[r,i]=f.useState(!1),p=()=>{i(!0),localStorage.setItem("graphStyle",l),i(!1),a()};return e.jsxs(W,{direction:"column",children:[e.jsx(V,{children:"Default graph view:"}),e.jsx(M,{}),e.jsx(o,{mt:308,py:24,children:e.jsx(v,{color:"secondary",disabled:r,id:"add-node-submit-cta",onClick:p,size:"large",startIcon:r&&e.jsx(L,{children:e.jsx(T,{color:c.lightGray,size:12})}),type:"submit",variant:"contained",children:"Save Changes"})})]})},W=s(o)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,V=s(w)`
