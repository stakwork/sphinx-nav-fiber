import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,x as D,B as F}from"./index-ad87d72e.js";import{B as M}from"./index-fcb3f91b.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-4995e73d.js";import{B as f,T as L,a as R}from"./index-5c1df593.js";import{T as x}from"./index-b02aa989.js";import"./useSlotProps-8a0094ed.js";import"./index.esm-00f01a9e.js";import"./InfoIcon-4679738c.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
