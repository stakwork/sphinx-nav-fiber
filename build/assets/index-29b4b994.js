import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h as x,r as T,x as v,B as m}from"./index-098ddbcf.js";import{B}from"./index-a7b1abe8.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-896961cd.js";import{B as f,T as $,a as k}from"./index-fe30444c.js";import{T as u}from"./index-742d0467.js";import"./useSlotProps-8fa59e2c.js";import"./index.esm-dbc85712.js";import"./InfoIcon-3c28434f.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
