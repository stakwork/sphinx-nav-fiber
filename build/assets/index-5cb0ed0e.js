import{f as d,h as l,T as B,j as e,F as a,C as w,r as n,a3 as V,z as $,D as A}from"./index-6aa05c43.js";import{B as P}from"./index-b5fe8996.js";import{u as g}from"./index-627697ac.js";import{c as q,F as G,B as E,C as H}from"./react-toastify.esm-a0143063.js";import{T as S}from"./index-354d8e35.js";import{S as O}from"./Skeleton-a076ac79.js";import"./index.esm-632e3ea4.js";import"./InfoIcon-cd8e8135.js";const _=/^https:\/\/.*\.(png|jpg|svg)$/;function C(s){return!!_.test(s)}const W=({isValidImageUrl:s})=>e.jsxs(a,{children:[e.jsx(a,{align:"center",direction:"row",justify:"space-between",mb:18,children:e.jsx(a,{align:"center",direction:"row",children:e.jsx(Y,{children:"Edit Node"})})}),e.jsxs(a,{mb:18,children:[e.jsx(T,{style:{marginBottom:8},children:"Node Name"}),e.jsx(S,{id:"cy-topic",maxLength:50,name:"topic",placeholder:"Node name",rules:{...w}})]}),e.jsxs(a,{mb:36,children:[e.jsx(T,{style:{marginBottom:8},children:"image_url"}),e.jsx(S,{id:"cy-image_url",maxLength:500,name:"image_url",placeholder:"image_url",rules:{...w,...s?{}:{pattern:{message:"Please enter a valid URL",value:_},validate:{source:C}}}})]})]}),Y=d(B)`
  font-size: 22px;
  font-weight: 600;
  font-family: 'Barlow';
`,T=d(B)`
