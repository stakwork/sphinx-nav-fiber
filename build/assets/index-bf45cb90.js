import{p as s,q as l,F as n,t as w,j as e,v as T,w as G,E as S,r as f,C as v,aJ as I,aK as b,aL as A,D as B,Q as y}from"./index-e82037e4.js";import{B as z}from"./index-9d4abae5.js";import{u as D,H as M,C as k,x as E,J as R,B as $,q as F,F as W}from"./index-67f729b8.js";import{C}from"./ClipLoader-4d3d230b.js";import{T as j}from"./index-9ec44c07.js";import{S as L}from"./index-82f56d9f.js";import{e as P}from"./index.esm-2dfb6114.js";import{T as V,a as N}from"./Tabs-b7ff3de2.js";import"./createSvgIcon-79dcd67f.js";const q={split:e.jsx(M,{}),force:e.jsx(k,{}),sphere:e.jsx(E,{}),earth:e.jsx(R,{})},H=()=>{const[i,p]=w(D(t=>[t.graphStyle,t.setGraphStyle])),r=t=>{p(t)};return e.jsx(O,{direction:"column",children:T.map(t=>e.jsx(n,{className:G("icon",{active:i===t}),onClick:()=>r(t),children:q[t]},t))})},O=s(n).attrs({direction:"row",align:"center",justify:"space-between"})`
  width: 447px;
  height: 48px;
