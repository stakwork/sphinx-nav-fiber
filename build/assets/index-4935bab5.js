import{f as o,F as s,T as g,i as y,j as e,k as b,L as S,D as w,h as x,r as T,x as v,B as m}from"./index-b7228c1a.js";import{B}from"./index-155ead8e.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-8496e00c.js";import{B as f,T as $,a as k}from"./index-e6a60da5.js";import{T as u}from"./index-ac6ab740.js";import"./useSlotProps-fcaa0769.js";import"./index.esm-0c7d80df.js";import"./InfoIcon-f4782b5c.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
