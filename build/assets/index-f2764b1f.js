import{f as o,F as s,T as g,i as y,j as e,k as b,L as S,D as w,h as x,r as T,x as v,B as m}from"./index-a51c1203.js";import{B}from"./index-ef995c38.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-8f6319a9.js";import{B as f,T as $,a as k}from"./index-0335a7a4.js";import{T as u}from"./index-af0e9ad5.js";import"./useSlotProps-505825b2.js";import"./index.esm-f2605fed.js";import"./InfoIcon-806a9320.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
