import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-382466ac.js";import{B}from"./index-13ebb6fc.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-544b3ad9.js";import{B as f,T as $,a as k}from"./index-7123bf58.js";import{T as u}from"./index-43f46160.js";import"./useSlotProps-f9180805.js";import"./index.esm-effff289.js";import"./InfoIcon-c480a4d1.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
