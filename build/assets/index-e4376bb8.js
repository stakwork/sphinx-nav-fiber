import{o as s,F as o,T as w,p as C,r as f,j as e,q as c,A as S,aU as A,aV as b,aW as z,J as D,O as y}from"./index-faed4556.js";import{B as G}from"./index-6045f48c.js";import{G as M,B as v,h as $,F as B}from"./index-7f4a37d8.js";import{C as T}from"./ClipLoader-5bbc9b28.js";import{T as j}from"./index-aca03bee.js";import{S as E}from"./index-aafb4ad4.js";import{e as I}from"./index.esm-1d600030.js";import{T as k,a as F}from"./Tabs-ddd42dc8.js";import"./InfoIcon-02117548.js";import"./useSlotProps-2b6f705a.js";import"./createSvgIcon-c0ebbc42.js";const R=({onClose:a})=>{const[l]=C(d=>[d.graphStyle]),[r,i]=f.useState(!1),p=()=>{i(!0),localStorage.setItem("graphStyle",l),i(!1),a()};return e.jsxs(W,{direction:"column",children:[e.jsx(V,{children:"Default graph view:"}),e.jsx(M,{}),e.jsx(o,{mt:308,py:24,children:e.jsx(v,{color:"secondary",disabled:r,id:"add-node-submit-cta",onClick:p,size:"large",startIcon:r&&e.jsx(L,{children:e.jsx(T,{color:c.lightGray,size:12})}),type:"submit",variant:"contained",children:"Save Changes"})})]})},W=s(o)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,V=s(w)`
