import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-c638bc9b.js";import{B as F}from"./index-bd1e827e.js";import{u as M}from"./index-223abcd5.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-ce1e09ea.js";import{B as f,T as R,a as L}from"./index-82b30fdd.js";import{T as x}from"./index-5ef66a02.js";import"./useSlotProps-d3250adc.js";import"./index.esm-e6dd1f6b.js";import"./InfoIcon-6f87a854.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
