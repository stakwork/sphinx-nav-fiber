import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-986d962a.js";import{B as M}from"./index-c3b56469.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-92e86b41.js";import{B as f,T as L,a as R}from"./index-b18db625.js";import{T as x}from"./index-5c585d1d.js";import"./useSlotProps-491486b1.js";import"./index.esm-417c9ec0.js";import"./InfoIcon-ec8ed478.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
