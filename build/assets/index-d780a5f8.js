import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-3fb2e077.js";import{B}from"./index-a5fae7df.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-c151614c.js";import{B as f,T as $,a as k}from"./index-28dab58a.js";import{T as u}from"./index-4bdbc90a.js";import"./useSlotProps-f7128b91.js";import"./index.esm-7917f03c.js";import"./InfoIcon-69394f20.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
