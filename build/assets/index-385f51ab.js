import{s as r,c as i,F as s,j as e,T as $,h as ee,r as d,u as xe,P as de,d as Ie,g as Ee,f as Re}from"./index-01782a69.js";import{A as E,u as R,b as A,ad as pe,ae as Ae,B as I,s as Pe,af as X,ag as Me,a as P,E as Le,I as he,c as U,v as ue,P as te,ah as Ge,ai as ge,aj as De,e as Fe,d as Ne}from"./react-toastify.esm-d4c7807c.js";import{G as ye,L as se,B as oe,H as Ye,u as Oe,S as We,a as He,D as Ve,M as Ue,R as Qe,b as qe,c as Ke,d as Xe,N as fe,C as Ze,e as me,f as we,g as Je,h as et,i as je,j as tt,P as st,k as be,s as re,V as ot,F as it,E as nt,l as rt,m as at,n as ke,o as lt,p as ct,q as xt,r as dt,t as pt,v as ht,w as ut,x as gt,y as yt}from"./SoundIcon-98ccbb45.js";import{C as ft,S as mt}from"./ChevronUpIcon-782bc13e.js";import{f as V,o as ve,n as wt,X as jt,Y as bt,T as kt,D as vt,S as ie,q as Ce,P as Q}from"./generateCategoricalChart-44bb7e25.js";import{T as W}from"./index-d463d61e.js";import{S as Ct}from"./Skeleton-962854dc.js";import{T as ae}from"./toastMessage-71cf2792.js";import{g as St,d as $t}from"./index.esm-b2fe6b9a.js";import{T as _t,F as Tt}from"./Popover-b826ddf0.js";import{I as Bt,S as zt,O as It}from"./Select-150c9580.js";import{C as Et}from"./CheckIcon-cabeb6b1.js";import{I as Rt}from"./InfoIcon-7fd329ae.js";import{C as ne}from"./ClipLoader-e8b8ddb1.js";import{P as At}from"./PlusIcon-691820ed.js";import{u as J}from"./index-aba16a9a.js";import{B as Pt}from"./index-aa46beb1.js";import"./useSlotProps-2c201f6d.js";const Mt=({imageUrl:t,name:o})=>e.jsxs(s,{align:"center",direction:"row",children:[t&&e.jsx(Lt,{children:e.jsx(E,{rounded:!0,size:64,src:t||"",type:"image"})}),o&&e.jsx(Gt,{children:o})]}),Lt=r(s)`
  img {
    width: 64px;
    height: 64px
    border-radius: 50%;
...
`,Es=({stateless:t,node:o})=>{var k;const[n,a]=A(j=>[j.transcriptIsOpen,j.setTranscriptOpen]),[l,x]=d.useState(!1),[c,y]=d.useState(""),[g,p]=d.useState(!1);if(!t&&!n)return null;const f="https://knowledge-graph.sphinx.chat",v=async j=>{try{const b=await fetch(`${f}/node/text/${j}`);if(!b.ok)throw new Error("Network response was not ok");const h=await b.json();y(h.data.text),p(!0)}catch(b){console.error("Error fetching full transcript",b)}},u=()=>{C(o==null?void 0:o.text),setTimeout(()=>{x(!1)},2e3)},w=()=>{g?p(!1):o!=null&&o.ref_id&&v(o.ref_id)},C=j=>{j!==void 0&&(navigator.clipboard.writeText(j),x(!0))};return e.jsxs(s,{grow:1,shrink:1,children:[e.jsxs(As,{children:[t&&e.jsxs(Rs,{children:[e.jsx("div",{className:"icon",children:e.jsx(fe,{})}),e.jsx("div",{className:"title",children:"Transcript"})]}),o!=null&&o.text?e.jsx(e.Fragment,{children:l?e.jsxs(Ls,{align:"center",direction:"row",justify:"flex-start",children:[e.jsx("div",{className:"icon",children:e.jsx(Et,{})}),e.jsx("div",{className:"text",children:"Copied"})]}):e.jsx(I,{endIcon:e.jsx(Ze,{}),onPointerDown:()=>u(),size:"small",variant:"outlined",children:"Copy"})}):e.jsx("div",{}),!t&&e.jsx(Ps,{onClick:()=>{a(!1)},children:e.jsx($t,{fontSize:35})})]}),e.jsxs(Ms,{children:[g?c:`${(k=o==null?void 0:o.text)==null?void 0:k.substring(0,100)}...`,e.jsx(Is,{onClick:w,children:g?"less":"more"})]})]})},Rs=r(s).attrs({direction:"row",align:"center"})`
  .icon {
    font-size: 16px;
    color: ${i.GRAY3};
    margin-right: 7px;
