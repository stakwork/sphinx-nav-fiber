import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,C as B,h as c,r as v,x as C}from"./index-6e8bad83.js";import{B as F}from"./index-ca94c6d7.js";import{u as M}from"./index-3b4e56fc.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-3a360dcb.js";import{B as f,T as L,a as R}from"./index-57f59967.js";import{T as x}from"./index-19b3fdb0.js";import"./useSlotProps-d61c8ba6.js";import"./index.esm-bc67c355.js";import"./InfoIcon-3467a98d.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
