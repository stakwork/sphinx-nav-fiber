import{r as n,j as e,s as f,g as T,F as S,o as K,c as U,A as ae,p as ce,i as le,q as pe,H as de,t as ue,v as fe,f as q}from"./index-f832f812.js";import{Universe as me}from"./index-bdab996f.js";import{a as W,b as he,c as ge,I as xe,d as Q,e as V,u as ye}from"./index-3301c4a8.js";import{M as be,V as we}from"./VolumeIcon-0ea64070.js";import{S as je,R as ve,s as X,M as Se}from"./index-b4ce6b17.js";import"./index-87d4d0a2.js";import"./VisibilityOn-b4e54c68.js";import"./SourcesTableIcon-3b0db6fa.js";import"./NodeCircleIcon-f47f8130.js";import"./CheckIcon-98f1b777.js";import"./DeleteNodeIcon-63718696.js";import"./EditNodeIcon-d108ec39.js";import"./SearchIcon-c2acb9f7.js";import"./SoundIcon-7a9d151b.js";import"./SucessFeedBackIcon-641208b8.js";import"./three.module-1c1ec8b9.js";import"./TextareaAutosize-e8374dad.js";import"./index-6e05f88f.js";import"./index-39a08cf5.js";import"./index-68b667bb.js";import"./ClipLoader-0f0655b0.js";import"./Skeleton-200028ef.js";import"./Stack-e80aa11c.js";import"./index-88de4a0f.js";import"./FormControlLabel-5105cb7a.js";import"./Typography-976c682d.js";import"./createSvgIcon-5a724303.js";import"./isPlainObject-1ddc029b.js";function D(t){const[i,s,r]=t.split(":").map(Number);return Number((i*60*60*1e3+s*60*1e3+r*1e3).toFixed(6))}const Z=n.memo(()=>{const t=W(a=>a.isPlaying),i=W(a=>a.setIsPlaying),s=W(a=>a.setVolume),r=W(a=>a.setPlaybackSpeed),c=W(a=>a.playbackSpeed),o=W(a=>a.playerRef),[x,b]=n.useState(!1),m=[.5,1,1.5,2],g=()=>{if(o){const a=o.getCurrentTime()-15;o.seekTo(a,"seconds")}},p=()=>{if(o){const a=o.getCurrentTime()+15;o.seekTo(a,"seconds")}},j=()=>{i(!t)},d=()=>{b(!x),s(x?1:0)},h=()=>{const I=(m.indexOf(c)+1)%m.length,F=m[I];if(r(F),o){const P=o.getInternalPlayer();P&&typeof P.playbackRate<"u"&&(P.playbackRate=F)}};return e.jsxs(ke,{children:[e.jsx(Pe,{onClick:d,children:x?e.jsx(be,{}):e.jsx(we,{})}),e.jsx(Te,{onClick:g,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(Ce,{"data-testid":"play-pause-button",onClick:j,size:"small",children:t?e.jsx(he,{"data-testid":"pause-icon"}):e.jsx(ge,{"data-testid":"play-icon"})}),e.jsx(Ie,{onClick:p,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(_e,{onClick:h,children:[c,"x"]})]})});Z.displayName="Controls";const ke=f(S).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${T.BG1};
  border-radius: 40px;
