import { g as y, r as b } from './index-82f7f87b.js'
function v(r, e) {
    ...
    if (typeof n != 'string' && !Array.isArray(n)) {
      for (const a in n)
        if (a !== 'default' && !(a in r)) {
          ...
          o && Object.defineProperty(r, a, o.get ? o : { enumerable: !0, get: () => n[a] })
        }
    }
  }
...
var w = Object.create,
  ...
  j = (r, e, t) => (e in r ? i(r, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : (r[e] = t)),
  E = (r, e) => {
  ...
  h = (r, e, t, n) => {
    if ((e && typeof e == 'object') || typeof e == 'function')
      for (let a of O(e))
        !I.call(r, a) && a !== t && i(r, a, { get: () => e[a], enumerable: !(n = P(e, a)) || n.enumerable })
    return r
  },
  S = (r, e, t) => (
    (t = r != null ? w(x(r)) : {}), h(e || !r || !r.__esModule ? i(t, 'default', { value: r, enumerable: !0 }) : t, r)
  ),
  C = (r) => h(i({}, '__esModule', { value: !0 }), r),
  p = (r, e, t) => (j(r, typeof e != 'symbol' ? e + '' : e, t), t),
  _ = {}
E(_, { default: () => N })
var g = C(_),
  s = S(b)
...
class N extends s.Component {
  ...
  render() {
    const { light: e, onClick: t, playIcon: n, previewTabIndex: a } = this.props,
      { image: o } = this.state,
      ...
      m = s.default.createElement(
        ...
        s.default.createElement('div', { style: c.playIcon, className: 'react-player__play-icon' }),
      )
...
const k = y(g),
  M = v({ __proto__: null, default: k }, [g])
export { M as P }
