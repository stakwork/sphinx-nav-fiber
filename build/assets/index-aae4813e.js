import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-cb5b9da6.js";import{B}from"./index-27475982.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-8128126b.js";import{B as f,T as $,a as k}from"./index-c0ad54f0.js";import{T as u}from"./index-b2f20657.js";import"./useSlotProps-d6f63e25.js";import"./index.esm-76465f52.js";import"./InfoIcon-903c3034.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
