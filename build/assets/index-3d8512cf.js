import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-79be52f7.js";import{B as F}from"./index-b2ed1446.js";import{u as M}from"./index-d9abaa64.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-92d758b1.js";import{B as f,T as R,a as L}from"./index-1cb0886e.js";import{T as x}from"./index-f660200f.js";import"./useSlotProps-ef7e3d2a.js";import"./index.esm-9c1f273c.js";import"./InfoIcon-3525ee23.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
