...
`,nr=b.lazy(()=>De(()=>import("./index-e235a9b5.js"),["assets/index-e235a9b5.js","assets/index-05040ffc.js","assets/index-b4d03b7b.css","assets/index-5f40edb3.js","assets/SourcesTableIcon-aa7650f8.js","assets/index-0180aa9e.js","assets/CheckIcon-1d49e168.js","assets/DeleteNodeIcon-023eb7bd.js","assets/SoundIcon-d05d58c3.js","assets/SucessFeedBackIcon-802194d9.js","assets/ClipLoader-0fd36237.js","assets/TableRow-166fefa2.js"]).then(({TweetAnalyze:e})=>({default:e}))),ir=()=>{const e=$(p=>p.setSelectedTweet),t=$(p=>p.selectedTweet),{tweetId:a}=ge(),[r,n]=b.useState(""),{open:i}=Re("tweetAnalyze"),l=(a==null?void 0:a.split("&"))||[],o=p=>{i(),n(p)};return s.jsx(s.Fragment,{children:s.jsxs(sr,{align:"stretch",basis:"100%",grow:1,shrink:1,children:[l.length>1?s.jsx(ar,{onClick:()=>{o("summary")},children:"Summary Report"}):null,l.map(p=>s.jsx(or,{className:t===p?"selected":"",onClick:()=>e(p),children:s.jsx(Vt,{handleAnalyzeClick:()=>{o(p)},nodeId:p})},p)),s.jsx(nr,{tweetId:r})]})})},ar=h.button`
  width: 100%;
  background: ${y.ANALYTICS_CARD_BG};
  color: ${y.white};
  padding: 16px 16px;
