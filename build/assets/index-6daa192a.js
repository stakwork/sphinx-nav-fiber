import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h as x,r as T,x as v,B as m}from"./index-31ef6bc7.js";import{B}from"./index-569ad940.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-efe85912.js";import{B as f,T as $,a as k}from"./index-152f7d12.js";import{T as u}from"./index-888b82dd.js";import"./useSlotProps-8fec50db.js";import"./index.esm-75403a40.js";import"./InfoIcon-52eb573f.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
