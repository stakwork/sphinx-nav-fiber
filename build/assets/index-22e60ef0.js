import{r as o,j as e,s as f,g as v,F as j,o as Y,c as J,A as ae,p as ie,i as ce,q as le,H as pe,t as de,v as ue}from"./index-3e423de1.js";import{t as U,u as G,C as me}from"./index-52d4b5d7.js";import{U as fe}from"./index-b367058e.js";import{u as M,a as he,b as ge,I as xe,c as K,d as ye}from"./index-3a7d80d5.js";import{M as we,V as be}from"./index-3bd2e583.js";import{S as je,R as ve,s as V,M as Se}from"./index-74c6c955.js";import"./string-a277709d.js";import"./index-17d2b743.js";import"./three.module-9722a9fc.js";import"./isPlainObject-79031aec.js";import"./TextareaAutosize-2a4da7f6.js";import"./CheckIcon-74713451.js";import"./index-c0ba4d67.js";import"./index-d637ee76.js";import"./index-a5768123.js";import"./ClipLoader-6fc4a312.js";import"./clsx-2b162be9.js";import"./SourcesTableIcon-8bf2d6c4.js";import"./DeleteNodeIcon-825dd73b.js";import"./SoundIcon-b80419e2.js";import"./SucessFeedBackIcon-c3dded47.js";import"./Skeleton-8686826a.js";import"./index-cc2db711.js";import"./Stack-6b666188.js";import"./FormControlLabel-e7965422.js";import"./Typography-24d17260.js";import"./createSvgIcon-eb3ef8b8.js";const Q=o.memo(()=>{const r=M(s=>s.isPlaying),a=M(s=>s.setIsPlaying),n=M(s=>s.setVolume),t=M(s=>s.setPlaybackSpeed),c=M(s=>s.playbackSpeed),i=M(s=>s.playerRef),[d,g]=o.useState(!1),y=[.5,1,1.5,2],h=()=>{if(i){const s=i.getCurrentTime()-15;i.seekTo(s,"seconds")}},u=()=>{if(i){const s=i.getCurrentTime()+15;i.seekTo(s,"seconds")}},b=()=>{a(!r)},l=()=>{g(!d),n(d?1:0)},p=()=>{const m=(y.indexOf(c)+1)%y.length,P=y[m];if(t(P),i){const _=i.getInternalPlayer();_&&typeof _.playbackRate<"u"&&(_.playbackRate=P)}};return e.jsxs(ke,{children:[e.jsx(_e,{onClick:l,children:d?e.jsx(we,{}):e.jsx(be,{})}),e.jsx(Ie,{onClick:h,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(Ce,{"data-testid":"play-pause-button",onClick:b,size:"small",children:r?e.jsx(he,{"data-testid":"pause-icon"}):e.jsx(ge,{"data-testid":"play-icon"})}),e.jsx(Pe,{onClick:u,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(Te,{onClick:p,children:[c,"x"]})]})});Q.displayName="Controls";const ke=f(j).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${v.BG1};
  border-radius: 40px;
