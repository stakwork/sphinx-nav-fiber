import{s as a,a as r,F as i,j as e,D as B,T as S,r as b,B as v,t as I,k as $,b as C,aT as k,aU as A,N as y,w as z,aV as w,aW as D,aX as M,e as j,aY as E}from"./index-9ea548bf.js";import{h as T,r as R,aB as L,aC as W,C as P,aD as V,aE as F}from"./index-21ff39de.js";import{C as G}from"./ClipLoader-93320b77.js";import{T as U,a as N}from"./Tabs-f0f0b23c.js";import"./createSvgIcon-fa820abb.js";const Y={split:e.jsx(W,{}),force:e.jsx(P,{}),sphere:e.jsx(V,{}),earth:e.jsx(F,{})},O=()=>{const[n,c]=T(R(t=>[t.graphStyle,t.setGraphStyle])),l=t=>{c(t)};return e.jsx(_,{direction:"column",children:L.map(t=>e.jsx(i,{className:B("icon",{active:n===t}),onClick:()=>l(t),children:Y[t]},t))})},_=a(i).attrs({direction:"row",align:"center",justify:"space-between"})`
  width: 447px;
  height: 48px;
