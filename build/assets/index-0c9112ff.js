import{s as r,c as i,F as s,j as e,T as $,h as ee,r as d,u as xe,P as de,d as ze,f as Ee}from"./index-5ae80368.js";import{A as E,u as R,b as P,ai as pe,aj as Re,B as z,s as Pe,ak as X,al as Ae,a as A,M as Me,I as he,c as U,v as ue,P as te,J as Le,am as ye,an as Ge,e as De,d as Ne}from"./react-toastify.esm-3af80b55.js";import{G as fe,L as se,B as oe,H as Fe,u as Ye,S as Oe,a as He,D as Ve,M as We,R as Ue,b as Qe,c as qe,d as Ke,N as ge,C as Xe,e as me,f as we,g as Je,h as Ze,i as je,j as et,P as tt,k as be,s as re,V as st,F as ot,E as it,l as nt,m as rt,n as ke,o as at,p as lt,q as ct,r as xt,t as dt,v as pt,w as ht,x as ut,y as yt}from"./SoundIcon-bc6270f9.js";import{C as ft,S as gt}from"./ChevronUpIcon-204df61d.js";import{f as W,o as ve,n as mt,X as wt,Y as jt,T as bt,D as kt,S as ie,q as Ce,P as Q}from"./generateCategoricalChart-33eb1dac.js";import{T as H}from"./index-7e3602c9.js";import{S as vt}from"./Skeleton-1be1934e.js";import{T as ae}from"./toastMessage-d5a023ae.js";import{g as Ct,d as St}from"./index.esm-2d8a98d7.js";import{T as $t,F as _t}from"./Popover-1b4b5002.js";import{I as Tt,S as Bt,O as It}from"./Select-6a7d2b02.js";import{C as zt}from"./CheckIcon-78faca24.js";import{I as Et}from"./InfoIcon-8316e2b6.js";import{C as ne}from"./ClipLoader-eb0bddd2.js";import{P as Rt}from"./PlusIcon-55342665.js";import{u as Z}from"./index-26a2bf18.js";import{B as Pt}from"./index-b2b0359c.js";import"./useSlotProps-e6584029.js";const At=({imageUrl:t,name:o})=>e.jsxs(s,{align:"center",direction:"row",children:[t&&e.jsx(Mt,{children:e.jsx(E,{rounded:!0,size:64,src:t||"",type:"image"})}),o&&e.jsx(Lt,{children:o})]}),Mt=r(s)`
  img {
    width: 64px;
    height: 64px
    border-radius: 50%;
...
`,Lt=r(s)`
  ...
  font-weight: 600;
  line-height: 17px;
`,Gt=({text:t,type:o,sourceLink:n})=>e.jsxs(s,{direction:"column",children:[e.jsx(s,{align:"center",direction:"row",children:e.jsx(H,{type:o})}),e.jsx($e,{"data-testid":"episode-description",children:t}),e.jsx(s,{align:"center",direction:"row",justify:"flex-start",children:n&&e.jsxs(Dt,{href:n,onClick:a=>a.stopPropagation(),target:"_blank",children:[e.jsx(fe,{}),e.jsx(Nt,{children:n})]})})]}),Dt=r.a`
  color: ${i.GRAY6};
  font-size: 16px;
  height: 16px;
  display: flex;
...
`,Ot=r(s)`
  ...
  font-weight: 600;
  line-height: 17px;
`,Ht=({text:t,imageUrl:o,date:n,twitterHandle:a,name:c,verified:x})=>e.jsxs(s,{direction:"column",children:[e.jsxs(s,{align:"center",direction:"row",pr:16,children:[e.jsx(Vt,{children:e.jsx(E,{rounded:!0,size:27,src:o||"",type:"person"})}),e.jsxs(s,{children:[e.jsxs(Wt,{align:"center",direction:"row",children:[c,x&&e.jsx("div",{className:"verification",children:e.jsx("img",{alt:"verified",src:"verified_twitter.svg"})})]}),a&&e.jsxs(Ut,{children:["@",a]})]})]}),e.jsxs(s,{grow:1,shrink:1,children:[e.jsx(Qt,{"data-testid":"episode-description",children:t}),e.jsx(s,{"data-testid":"date-text",direction:"row",justify:"flex-start",children:!!n&&e.jsx(q,{children:ee.unix(n).fromNow()})})]})]}),Vt=r(s)`
  img {
    width: 64px;
    height: 64px;
    border-radius: 50%;
...
`,Se=({boostCount:t,date:o,episodeTitle:n,isSelectedView:a=!1,imageUrl:c,showTitle:x,type:l,text:f,name:y,profilePicture:p,sourceLink:m,verified:b=!1,twitterHandle:u,className:j="episode-wrapper",onClick:k})=>{const g=l==="show"?x:n,_=l==="show"?"":x,v=["tweet","person","guest","topic","document"],h=l==="youtube"?"video":"audio";return l?e.jsx(qt,{className:j,onClick:k,children:v.includes(l)?e.jsxs(e.Fragment,{children:[l==="topic"&&e.jsxs(Kt,{children:[e.jsx(Fe,{}),e.jsx("p",{children:_})]}),["person","guest"].includes(l)&&e.jsx(Ft,{imageUrl:c,name:y||"",title:x||""}),["image"].includes(l)&&e.jsx(At,{imageUrl:m,name:y||""}),l==="tweet"&&e.jsx(Ht,{date:o,imageUrl:p,name:y||"",text:f||"",twitterHandle:u,verified:b}),l==="document"&&e.jsx(Gt,{sourceLink:m||"",text:f||"",type:l})]}):e.jsxs(s,{direction:"row",children:[!a&&e.jsx(s,{align:"center",pr:16,children:e.jsx(E,{size:64,src:c||`${h}_default.svg`,type:l||""})}),e.jsxs(s,{grow:1,shrink:1,children:[e.jsxs(s,{align:"center",direction:"row",justify:"space-between",children:[e.jsx(s,{align:"center",direction:"row",children:l&&e.jsx(H,{type:l})}),l==="youtube"&&m?e.jsx(Jt,{href:`${m}?open=system`,onClick:T=>T.stopPropagation(),children:e.jsx(se,{})}):null]}),e.jsx($e,{"data-testid":"episode-description",children:g}),e.jsxs(s,{align:"center",direction:"row",justify:"flex-start",children:[!!o&&e.jsx(q,{children:ee.unix(o).fromNow()}),!!_&&e.jsx(Xt,{children:_}),!a&&t>0&&e.jsx(s,{style:{marginLeft:"auto"},children:e.jsx(oe,{amt:t})})]})]})]})}):null},$e=r(s)`
  font-family: Barlow;
  font-size: 13px;
  font-style: normal;
  font-weight: 400;
...
`,Jt=r.a`
  ...
  font-size: 16px;
  height: 16px;
`,Zt=({isSearchResult:t})=>{const o=d.useRef(null),n=t?80:10,{setSelectedNode:a,setSelectedTimestamp:c}=R(v=>v),{currentSearch:x,setSidebarOpen:l,setRelevanceSelected:f}=P(v=>v),[y,p]=d.useState(0),m=pe(),u=y*n+n,j=m&&m.length>0?m.length-1>u:!1,k=Ye("sm","down"),g=d.useMemo(()=>{if(m){const v=[...m].sort((h,T)=>(T.date||0)-(h.date||0));return x&&v.sort((h,T)=>{const M=h.node_type==="topic"&&h.name.toLowerCase()===x.toLowerCase()?1:0;return(T.node_type==="topic"&&T.name.toLowerCase()===x.toLowerCase()?1:0)-M}),v.slice(0,u)}return[]},[m,u,x]),_=d.useCallback(v=>{Re(v),c(v),f(!0),a(v),k&&l(!1)},[a,f,l,c,k]);return e.jsx(e.Fragment,{children:e.jsxs(Oe,{ref:o,id:"search-result-list",shrink:1,children:[(g??[]).map((v,h)=>{const{image_url:T,date:M,boost:I,type:Y,episode_title:O,show_title:D,node_type:w,text:S,source_link:N,link:F,name:G,profile_picture:C,verified:B=!1,twitter_handle:L}=v||{};return e.jsx(Se,{boostCount:I||0,date:M||0,episodeTitle:W(O),imageUrl:T||"",link:F,name:G||"",onClick:()=>{_(v)},profilePicture:C,showTitle:W(D),sourceLink:N,text:S||"",twitterHandle:L,type:w||Y,verified:B},h.toString())}),e.jsx(ts,{align:"center",background:"BG1",direction:"row",justify:"center",children:j&&e.jsx(z,{onClick:()=>{j&&p(y+1)},size:"medium",children:"Load More"})})]})})},es=d.memo(Zt),ts=r(s)`
  flex: 0 0 86px;
`,ss=({isSearchResult:t})=>{const{nodeCount:o,setNodeCount:n,setBudget:a}=xe(l=>l),{fetchData:c}=R(l=>l),x=async()=>{o<1||(await c(a,{skip_cache:"true"}),n("CLEAR"))};return e.jsxs(ns,{children:[!t&&e.jsxs("div",{className:"heading-container",children:[e.jsxs("div",{className:"heading",children:[e.jsx("span",{className:"heading__title",children:"Latest"}),e.jsx("span",{className:"heading__icon",children:e.jsx(He,{})})]}),o?e.jsx("div",{className:"button_container",children:e.jsx(os,{className:"button",onClick:x,startIcon:e.jsx(Ve,{}),children:`See Latest (${o})`})}):null]}),e.jsx(es,{isSearchResult:t})]})},os=r(z)`
  && {
    width: 100%;
    margin-top: 1.2rem;
    font-weight: 500;
...
`,as=()=>e.jsx(e.Fragment,{children:Array(7).fill(null).map((t,o)=>e.jsx(rs,{children:e.jsxs(s,{direction:"row",children:[e.jsx(s,{align:"center",pr:16,children:e.jsx(V,{animation:"wave",height:64,variant:"rectangular",width:64})}),e.jsxs(s,{grow:1,shrink:1,children:[e.jsx(V,{height:10,variant:"rectangular",width:56}),e.jsx(V,{className:"title",height:10,variant:"rectangular",width:262}),e.jsx(V,{height:10,variant:"rectangular",width:149})]})]})},o))});r(s)`
  font-family: Barlow;
  font-size: 13px;
  font-style: normal;
  font-weight: 500;
...
`;const cs=48,xs=8,ds={PaperProps:{style:{maxHeight:cs*4.5+xs,width:250}}},ps=["Beginner","Intermediate","Advanced","Expert"],hs=()=>{const t=R(h=>h.data),[o,n]=d.useState(""),[a,c]=d.useState("Beginner"),x=P(h=>h.currentSearch),l=Pe(),[f]=xe(h=>[h.setBudget]),[y,p,m,b,u]=ve(h=>[h.askedQuestions,h.askedQuestionsAnswers,h.setAskedQuestion,h.setAskedQuestionAnswer,h.hasQuestionInProgress]),j=d.useCallback(h=>{b(h.answer),X(e.jsx(ae,{message:"Response is ready"}),{position:X.POSITION.BOTTOM_CENTER,type:"success"})},[b]);d.useEffect(()=>{l&&j&&l.on("askquestionhook",j)},[j,l]);const k=async()=>{o&&(m(o),n(""));try{const h=t==null?void 0:t.nodes.filter(I=>I.text),T=h==null?void 0:h.slice(0,5),M=(T!=null&&T.length?T.map(I=>I.text).join(" "):"").substring(0,2500).replace(/[?&=+/#]/g,I=>`\\${I}`);x&&(await ze.enable(),await Ae({expertise_level:a,question_text:o,search_term:x,transcripts:M},f),await Ee(f),X(e.jsx(ae,{message:"We started preparing response for you"}),{type:"success"}))}catch(h){console.error(h)}},g=a&&o.trim()&&!u,_=h=>{c(h.target.value)},v=async h=>{if(u){h.preventDefault();return}h.keyCode===13&&h.shiftKey===!1&&g&&(h.preventDefault(),k())};return e.jsxs(us,{children:[e.jsx(s,{children:e.jsx(s,{children:e.jsxs(_t,{component:"div",children:[e.jsx(fs,{id:"select-label",size:"small",children:"Expertise level"}),e.jsx(gs,{id:"demo-multiple-name",input:e.jsx(It,{label:"Expertise level"}),labelId:"select-label",MenuProps:ds,onChange:_,size:"small",value:a,children:ps.map(h=>e.jsx(We,{component:"li",value:h,children:h},h))})]})})}),e.jsx(js,{children:y==null?void 0:y.map((h,T)=>e.jsxs(s,{className:"response",py:12,children:[e.jsx($,{kind:"medium",children:h}),e.jsx(s,{py:12,children:(p==null?void 0:p[T])!==void 0?e.jsx($,{color:"unreadMsgText",children:p[T]}):e.jsxs(s,{align:"center",py:12,children:[e.jsx(s,{align:"center",py:12,children:e.jsx(de,{color:i.white})}),e.jsx(s,{align:"center",py:12,children:e.jsx($,{children:"Generating response"})})]})})]},h))}),e.jsxs(ms,{onKeyDown:v,py:12,tabIndex:-1,children:[e.jsx(ys,{disabled:u,onChange:h=>n(h.target.value),placeholder:"Enter your question",value:o}),e.jsx(ws,{children:e.jsx(Ct,{color:g?i.white:i.gray300,size:"18"})})]})]})},us=r.div`
  margin-top: 20px;
`,ys=r($t)`
...
`;function K(t,o){if(!(o!=null&&o.trim()))return t;const n=new RegExp(`(${o})`,"gi"),a=t.split(n);return e.jsx(e.Fragment,{children:a.map((c,x)=>n.test(c)?e.jsx($s,{children:c},x):c)})}const $s=r.span`
  ...
  border-radius: 3px;
  color: inherit;
`,_s=({stateless:t,node:o,searchTerm:n})=>e.jsxs(s,{grow:1,shrink:1,children:[e.jsx(Bs,{children:t&&e.jsxs(Ts,{children:[e.jsx("div",{className:"icon",children:e.jsx(ge,{})}),e.jsx("div",{className:"title",children:"Description"})]})}),e.jsx($,{children:o!=null&&o.description?K(o.description,n):"..."})]}),Ts=r(s).attrs({direction:"row",align:"center"})`
  .icon {
    font-size: 16px;
    color: ${i.GRAY3};
    margin-right: 7px;
...
`,zs=({stateless:t,node:o})=>{var k;const[n,a]=P(g=>[g.transcriptIsOpen,g.setTranscriptOpen]),[c,x]=d.useState(!1),[l,f]=d.useState(""),[y,p]=d.useState(!1);if(!t&&!n)return null;const m="https://knowledge-graph.sphinx.chat",b=async g=>{try{const _=await fetch(`${m}/node/text/${g}`);if(!_.ok)throw new Error("Network response was not ok");const v=await _.json();f(v.data.text),p(!0)}catch(_){console.error("Error fetching full transcript",_)}},u=()=>{y?p(!1):o!=null&&o.ref_id&&b(o.ref_id)},j=g=>{g!==void 0&&(navigator.clipboard.writeText(g),x(!0))};return e.jsxs(s,{grow:1,shrink:1,children:[e.jsxs(Rs,{children:[t&&e.jsxs(Es,{children:[e.jsx("div",{className:"icon",children:e.jsx(ge,{})}),e.jsx("div",{className:"title",children:"Transcript"})]}),o!=null&&o.text?e.jsx(e.Fragment,{children:c?e.jsxs(Ms,{align:"center",direction:"row",justify:"flex-start",children:[e.jsx("div",{className:"icon",children:e.jsx(zt,{})}),e.jsx("div",{className:"text",children:"Copied"})]}):e.jsx(z,{endIcon:e.jsx(Xe,{}),onPointerDown:()=>j(o==null?void 0:o.text),size:"small",variant:"outlined",children:"Copy"})}):e.jsx("div",{}),!t&&e.jsx(Ps,{onClick:()=>{a(!1)},children:e.jsx(St,{fontSize:35})})]}),e.jsxs(As,{children:[y?l:`${(k=o==null?void 0:o.text)==null?void 0:k.substring(0,100)}...`,e.jsx(Is,{onClick:u,children:y?"less":"more"})]})]})},Es=r(s).attrs({direction:"row",align:"center"})`
  .icon {
    font-size: 16px;
    color: ${i.GRAY3};
    margin-right: 7px;
...
`,_e=({node:t})=>{const o=R(g=>g.selectedNode),n=P(g=>g.currentSearch),{link:a,image_url:c,date:x,boost:l,node_type:f,type:y,id:p,show_title:m,episode_title:b,ref_id:u}=t||o||{},[j,k]=d.useState(l||0);return o?e.jsx("div",{style:{overflow:"auto",flex:1,width:"100%"},children:e.jsxs(Ls,{children:[e.jsx(Ds,{boostCount:j||0,date:x||0,episodeTitle:W(b),imageUrl:c,isSelectedView:!0,link:a,onClick:()=>null,showTitle:m,type:f||y}),e.jsx(J,{}),e.jsxs(Gs,{children:[e.jsx(oe,{amt:j}),e.jsx(we,{content:o,count:j,refId:u,updateCount:k})]}),e.jsx(J,{}),e.jsx(ce,{children:e.jsx(_s,{node:o,searchTerm:n,stateless:!0})}),e.jsx(J,{}),e.jsx(ce,{children:e.jsx(zs,{node:o,stateless:!0},p)})]})}):null},Ls=r(s)`
  flex: 1;
  min-height: 100%;
  flex-direction: column;
...
`,so=({onClick:t,timestamp:o,isSelected:n,setOpenClip:a})=>e.jsxs(to,{align:"center","data-testid":"wrapper",direction:"row",isSelected:n,justify:"flex-start",onClick:t,px:20,py:20,children:[e.jsxs("div",{children:[e.jsx(he,{className:"play-pause",children:n?e.jsx(eo,{}):e.jsx(Je,{})}),!1]}),e.jsxs(oo,{align:"flex-start",direction:"column",justify:"center",children:[o.timestamp&&e.jsx("span",{className:"timestamp",children:Ze(o.timestamp)}),e.jsx("span",{className:"title",children:W(o.show_title)})]}),e.jsx("div",{className:"info",children:e.jsx(s,{"data-testid":"info-icon-wrapper",onClick:()=>a(o),pt:4,children:e.jsx(Et,{})})})]}),oo=r(s)`
  font-size: 13px;
  color: ${i.white};
  font-family: 'Barlow';
  margin: 0 16px;
...
`,no=()=>{const t=A(),o=Ce(),[n,a]=d.useState(null),[c,x]=d.useState(null),[l,f,y]=U(u=>[u.playingNode,u.setPlayingNodeLink,u.setPlayingTime]),p=d.useMemo(()=>je((o==null?void 0:o.nodes)||[],t),[o==null?void 0:o.nodes,t]),m=d.useMemo(()=>o==null?void 0:o.nodes.find(u=>u.node_type==="show"&&u.show_title===(t==null?void 0:t.show_title)),[o==null?void 0:o.nodes,t]),b=d.useCallback(u=>{var j;l&&u.link&&(l==null?void 0:l.link)!==u.link&&f(u.link),y(ue(((j=u==null?void 0:u.timestamp)==null?void 0:j.split("-")[0])||"00:00:01")),x(u)},[l,f,x,y]);return d.useEffect(()=>{p!=null&&p.length&&!p.some(u=>u.ref_id===(c==null?void 0:c.ref_id))&&b(p[0])},[p,c,b]),t?e.jsx("div",{style:{overflow:"auto",flex:1,width:"100%"},children:e.jsxs(ao,{children:[n&&e.jsx(lo,{className:"slide-me",direction:"up",in:!!n,children:e.jsxs(ro,{children:[e.jsx(s,{className:"close-info",onClick:()=>a(null),children:e.jsx(ft,{})}),n&&e.jsx(_e,{node:n})]})}),e.jsx(Fs,{selectedNodeShow:m}),!!(p!=null&&p.length)&&e.jsx(io,{children:e.jsx(s,{pb:20,children:p==null?void 0:p.map((u,j)=>e.jsx(so,{isSelected:(c==null?void 0:c.ref_id)===u.ref_id,onClick:()=>b(u),setOpenClip:a,timestamp:u},`${u.episode_title}_${j}`))})})]})}):null},ro=r(s)`
  border-radius: 20px;
  overflow: hidden;
  height: 100%;
...
`,jo=r($)`
  ...
  display: -webkit-box;
  -webkit-line-clamp: 2;
`,bo=()=>{const[t,o]=R(l=>[l.selectedNode,l.setSelectedNode]),n=Ce(),[a,c]=d.useState([]),x=d.useMemo(()=>{var y;const l=new Set,f={};if((y=t==null?void 0:t.children)!=null&&y.length){t.children.forEach((m,b)=>{var k,g,_,v;const u=je((n==null?void 0:n.nodes)||[],t)||[],j=n==null?void 0:n.nodes.find(h=>h.ref_id===m);if(j){j.timestamp=(k=u[0])==null?void 0:k.timestamp;const h=(v=(_=(g=u[b])==null?void 0:g.hosts)==null?void 0:_[0])==null?void 0:v.name;h&&l.add(h),f[m]=j,f[m]=j}});const p=Array.from(l);c(p)}return Object.values(f).filter(p=>p.node_type==="episode").sort((p,m)=>(m.weight||0)-(p.weight||0))},[n==null?void 0:n.nodes,t]);return e.jsxs(mo,{children:[e.jsx(wo,{children:e.jsxs(s,{direction:"row",children:[e.jsx(s,{pr:24,children:e.jsx(E,{size:80,src:(t==null?void 0:t.image_url)||"audio_default.svg",type:"show"})}),e.jsx(s,{direction:"column",children:e.jsxs(s,{direction:"column",grow:1,justify:"space-between",children:[e.jsxs(s,{align:"center",direction:"row",justify:"flex-start",mb:16,children:[e.jsx(H,{type:"show"})," ",e.jsxs("div",{className:"subtitle",children:["by ",a.join(", ")||(t==null?void 0:t.show_title)]})]}),e.jsx(jo,{kind:"bigHeading",title:(t==null?void 0:t.show_title)||"Unknown",children:(t==null?void 0:t.show_title)||"Unknown"})]})})]})}),e.jsxs(s,{direction:"column",children:[e.jsx(s,{p:24,children:e.jsx($,{className:"relatedHeader",kind:"medium",children:"Related Episodes"})}),x.map(l=>e.jsx(fo,{node:l,onClick:()=>o(l)},l.ref_id))]})]})},ko=()=>{const t=A();return e.jsx(s,{align:"center",justify:"center",children:e.jsx($,{color:"primaryText1",kind:"hugeHeading",children:t==null?void 0:t.label})})},vo=()=>{const t=A(),{date:o,boost:n,text:a,name:c,verified:x,profile_picture:l,twitter_handle:f,ref_id:y}=t||{},p=(t==null?void 0:t.tweet_id)||"",[m,b]=d.useState(n||0),u=P(j=>j.currentSearch);return t&&e.jsxs(e.Fragment,{children:[e.jsxs(s,{direction:"column",p:24,children:[e.jsxs(s,{align:"center",direction:"row",pr:16,children:[e.jsx(Co,{children:e.jsx(E,{rounded:!0,size:58,src:l||"",type:"person"})}),e.jsxs(s,{children:[e.jsxs(So,{align:"center",direction:"row",children:[c,x&&e.jsx("div",{className:"verification",children:e.jsx("img",{alt:"verified",src:"verified_twitter.svg"})})]}),f&&e.jsxs($o,{children:["@",f]})]})]}),e.jsxs(s,{grow:1,shrink:1,children:[e.jsx(_o,{"data-testid":"episode-description",children:K(a||"",u)}),e.jsx(s,{direction:"row",justify:"flex-start",children:!!o&&e.jsx(q,{children:ee.unix(o).format("ll")})})]}),e.jsx(s,{align:"stretch",mt:22,children:e.jsx("a",{href:`https://twitter.com/Interior/status/${p}?open=system`,children:e.jsx(Bo,{endIcon:e.jsx(se,{}),children:"View Tweet "})})})]}),e.jsx(To,{}),e.jsxs(s,{direction:"row",justify:"space-between",pt:14,px:24,children:[e.jsx(oe,{amt:m}),e.jsx(we,{content:t,count:m,refId:y,updateCount:b})]})]})},Co=r(s)`
  img {
    width: 64px;
    height: 64px
    border-radius: 50%;
...
`,Ao=r.audio`
  height: 0;
  width: 0;
`,Mo=["clip","twitter_space","youtube","episode","podcast"],Lo=()=>{const t=A(),{showTeachMe:o}=R(a=>a),{setPlayingNode:n}=U(a=>a);if(d.useEffect(()=>{Mo.includes((t==null?void 0:t.node_type)||"")&&n(t)},[n,t]),o)return e.jsx(bs,{});switch(t==null?void 0:t.node_type){case"guest":case"person":return e.jsx(yo,{});case"data_series":return e.jsx(Cs,{});case"tribe_message":return e.jsx(xo,{});case"tweet":return e.jsx(vo,{});case"topic":return e.jsx(ko,{});case"show":return e.jsx(bo,{});case"youtube":case"podcast":case"clip":case"twitter_space":return e.jsx(_e,{});case"document":return e.jsx(Io,{});case"episode":return e.jsx(no,{},t.ref_id);case"image":return e.jsx(co,{});default:return null}},Go=d.memo(Lo),Do=({isPlaying:t,setIsPlaying:o,playingTime:n,duration:a,handleProgressChange:c,handleVolumeChange:x,onFullScreenClick:l,showToolbar:f})=>e.jsxs(s,{children:[!f&&e.jsx(Ho,{"aria-label":"Small",max:a,onChange:c,size:"small",value:n}),e.jsxs(No,{align:"center",direction:"row",showToolbar:f,children:[e.jsx(Fo,{onClick:o,size:"small",children:t?e.jsx(Q,{}):e.jsx(te,{})}),e.jsxs(Vo,{direction:"row",children:[e.jsx("span",{children:re(n)}),e.jsx("span",{className:"separator",children:"/"}),e.jsx("span",{className:"duration",children:re(a)})]}),e.jsxs(Yo,{direction:"row",px:9,children:[e.jsx(be,{className:"volume-slider",defaultValue:.5,max:1,min:0,onChange:x,size:"small",step:.1}),e.jsx(st,{})]}),e.jsx(Oo,{onClick:()=>l(),children:f?e.jsx(it,{}):e.jsx(ot,{})})]})]}),No=r(s)`
  height: 60px;
  padding: 12px 16px;
  ${t=>t.showToolbar&&`
    position: fixed;
...
`,Wo=({hidden:t})=>{const o=d.useRef(null),n=d.useRef(null),[a,c]=d.useState(!1),[x,l]=d.useState(!1),[f,y]=d.useState("ready"),[p,m,b,u,j,k,g,_,v,h,T]=U(C=>[C.isPlaying,C.playingTime,C.duration,C.setIsPlaying,C.setPlayingTime,C.setDuration,C.playingNode,C.volume,C.setVolume,C.setHasError,C.resetPlayer]);d.useEffect(()=>()=>T(),[T]);const M=()=>{u(!p)},I=()=>{u(!0)},Y=()=>{u(!1)},O=(C,B)=>{const L=Array.isArray(B)?B[0]:B;o.current&&(o.current.seekTo(L),j(L))},D=(C,B)=>{const L=Array.isArray(B)?B[0]:B;v(L)},w=()=>{h(!0),y("error")},S=C=>{const B=C.playedSeconds;j(B)},N=()=>{if(o.current){y("ready");const C=o.current.getDuration();k(C)}},F=()=>{n.current&&(document.fullscreenElement?(document.exitFullscreen(),c(!1)):n.current.requestFullscreen().then(()=>{document.addEventListener("fullscreenchange",G)}))},G=()=>{c(!!document.fullscreenElement),document.removeEventListener("fullscreenchange",G)};return d.useEffect(()=>()=>{document.removeEventListener("fullscreenchange",G)}),d.useEffect(()=>{const C=B=>{if(a){const L=window.screen.height,Be=B.clientY,Ie=L-Be;l(Ie<=50)}};return document.addEventListener("mousemove",C),()=>{document.removeEventListener("mousemove",C)}},[a,x]),d.useEffect(()=>{const C=B=>{a&&B.key==="Escape"&&(B.preventDefault(),B.stopPropagation())};return document.addEventListener("fullscreenchange",G),document.addEventListener("keydown",C),()=>{document.removeEventListener("fullscreenchange",G),document.removeEventListener("keydown",C)}}),g!=null&&g.link?e.jsxs(Uo,{ref:n,hidden:t,children:[e.jsx(Qo,{children:e.jsx(E,{size:120,src:(g==null?void 0:g.image_url)||"",type:"clip"})}),e.jsx(nt,{ref:o,controls:!1,height:a?window.screen.height:"200px",onBuffer:()=>y("buffering"),onBufferEnd:()=>y("ready"),onError:w,onPause:Y,onPlay:I,onProgress:S,onReady:N,playing:p,url:(g==null?void 0:g.link)||"",volume:_,width:"100%"}),f==="error"?e.jsx(Ko,{className:"error-wrapper",children:"Error happened, please try later"}):null,f==="ready"?e.jsx(Do,{duration:b,handleProgressChange:O,handleVolumeChange:D,isPlaying:p,onFullScreenClick:F,playingTime:m,setIsPlaying:M,showToolbar:x&&a}):null,f==="buffering"?e.jsx(qo,{children:e.jsx(ne,{color:i.lightGray})}):null]}):null},Uo=r(s)`
...
`,gi=r.audio`
  height: 0;
  width: 0;
`,mi=390,wi=d.forwardRef(({onSubmit:t,subViewOpen:o},n)=>{const{isFetching:a,setTeachMe:c,setSidebarFilter:x}=R(g=>g),l=pe(),{setSidebarOpen:f,currentSearch:y,clearSearch:p,searchFormValue:m}=P(g=>g),{setValue:b}=ye(),u=d.useRef(null),[j,k]=d.useState(!1);return d.useEffect(()=>{b("search",m)},[b,m]),d.useEffect(()=>{const g=u.current;if(!g)return;const _=()=>{k((g==null?void 0:g.scrollTop)>0)};g.addEventListener("scroll",_)},[]),e.jsxs(ki,{ref:n,id:"sidebar-wrapper",children:[e.jsx(Ti,{}),e.jsxs(Te,{className:De({"has-shadow":j}),children:[e.jsxs(vi,{children:[e.jsx(ht,{onSubmit:t}),e.jsx(Si,{onClick:()=>{if(y){b("search",""),p(),x("all");return}t==null||t()},children:a?e.jsx(ne,{color:i.SECONDARY_BLUE,"data-testid":"loader",size:"20"}):e.jsx(e.Fragment,{children:y?e.jsx(Ne,{}):e.jsx(gt,{})})})]}),y&&e.jsx(Ci,{children:a?e.jsx(ut,{}):e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"left",children:[e.jsx("span",{className:"count",children:l.length}),e.jsx("span",{className:"label",children:" results"})]}),e.jsx("div",{className:"right",style:{alignItems:"center"},children:e.jsx(yt,{})})]})})]}),!o&&e.jsx($i,{onClick:()=>{f(!1),c(!1)},children:e.jsx(ke,{})}),e.jsxs(_i,{ref:u,children:[!y&&e.jsx(Bi,{children:e.jsx(pi,{onSubmit:t})}),e.jsx(s,{children:a?e.jsx(as,{}):e.jsx(is,{isSearchResult:!!y})})]})]})}),ji=["topic","person","guest","event","organization","place","project","software"],bi=({onSubmit:t})=>{const{sidebarIsOpen:o}=P(x=>x),n=A(),a=!!n&&o&&!ji.includes(n.node_type),{showTeachMe:c}=R(x=>x);return e.jsxs(e.Fragment,{children:[e.jsx(ie,{direction:"right",in:o,mountOnEnter:!0,unmountOnExit:!0,children:e.jsx(wi,{onSubmit:t,subViewOpen:a})}),e.jsx(Jo,{open:a||!!c}),!o&&e.jsx(oi,{})]})},ki=r(s)(({theme:t})=>({position:"relative",background:i.BG1,height:"100vh",width:"100%",zIndex:30,[t.breakpoints.up("sm")]:{width:mi}})),Te=r(s).attrs({direction:"column",justify:"center",align:"stretch"})(({theme:t})=>({padding:t.spacing(3.75,2),[t.breakpoints.up("sm")]:{padding:"12px"},"&.has-shadow":{borderBottom:"1px solid rgba(0, 0, 0, 0.25)",background:i.BG1,boxShadow:"0px 1px 6px 0px rgba(0, 0, 0, 0.20)"}})),vi=r(s).attrs({direction:"row",justify:"center",align:"center"})`
  flex-grow: 1;
