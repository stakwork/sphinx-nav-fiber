import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,x as D,B as F}from"./index-8f0fe879.js";import{B as M}from"./index-d20a2c64.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-1cafe5b3.js";import{B as f,T as L,a as R}from"./index-1afba01d.js";import{T as x}from"./index-b2d69e89.js";import"./useSlotProps-24d3a778.js";import"./index.esm-eaea2432.js";import"./InfoIcon-c57ee9a7.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
