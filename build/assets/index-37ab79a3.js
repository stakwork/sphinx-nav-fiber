...
`,Ks=({hidden:e})=>{var m,oe;const t=z.useRef(null),n=z.useRef(null),[r,i]=z.useState(!1),[o,l]=z.useState(!1),[a,u]=z.useState(!1),[c,p]=z.useState("ready"),{isPlaying:d,playingTime:f,duration:h,setIsPlaying:w,setPlayingTime:b,setDuration:E,playingNode:k,volume:S,setVolume:I,setHasError:O,resetPlayer:L,isSeeking:v,setIsSeeking:D}=at(Z=>Z),q=((m=k==null?void 0:k.link)==null?void 0:m.includes("youtube"))||((oe=k==null?void 0:k.link)==null?void 0:oe.includes("youtu.be"));z.useEffect(()=>()=>L(),[L]),z.useEffect(()=>{v&&t.current&&(t.current.seekTo(f,"seconds"),D(!1))},[f,v,D]);const N=()=>{w(!d)},V=()=>{w(!0)},_=()=>{w(!1)},P=(Z,x)=>{const ne=Array.isArray(x)?x[0]:x;t.current&&(t.current.seekTo(ne),b(ne))},H=(Z,x)=>{const ne=Array.isArray(x)?x[0]:x;I(ne)},Y=()=>{O(!0),p("error")},F=Z=>{if(!v){const x=Z.playedSeconds;b(x)}},te=()=>{if(t.current){p("ready");const Z=t.current.getDuration();E(Z)}},J=()=>{n.current&&(document.fullscreenElement?(document.exitFullscreen(),setTimeout(()=>l(!1),300)):n.current.requestFullscreen().then(()=>{document.addEventListener("fullscreenchange",re)}))},re=()=>{l(!!document.fullscreenElement),document.removeEventListener("fullscreenchange",re)};z.useEffect(()=>()=>{document.removeEventListener("fullscreenchange",re)}),z.useEffect(()=>{const Z=x=>{if(o){const ne=window.screen.height,Ce=x.clientY,ee=ne-Ce;u(ee<=50)}};return document.addEventListener("mousemove",Z),()=>{document.removeEventListener("mousemove",Z)}},[o,a]),z.useEffect(()=>{const Z=x=>{o&&x.key==="Escape"?(x.preventDefault(),x.stopPropagation()):r&&x.key===" "&&(x.preventDefault(),N())};return document.addEventListener("fullscreenchange",re),document.addEventListener("keydown",Z),()=>{document.removeEventListener("fullscreenchange",re),document.removeEventListener("keydown",Z)}});const me=()=>{N()};return k!=null&&k.link?s.jsxs(Js,{ref:n,hidden:e,onBlur:()=>i(!1),onFocus:()=>i(!0),tabIndex:0,children:[s.jsx(ea,{isFullScreen:o,children:s.jsx(we,{size:120,src:(k==null?void 0:k.image_url)||"",type:"clip"})}),s.jsx(ra,{onClick:me,children:s.jsx(eo,{ref:t,controls:!1,height:o?window.screen.height:"200px",onBuffer:()=>p("buffering"),onBufferEnd:()=>p("ready"),onError:Y,onPause:_,onPlay:V,onProgress:F,onReady:te,playing:d,url:(k==null?void 0:k.link)||"",volume:S,width:"100%"})}),c==="error"?s.jsx(na,{className:"error-wrapper",children:"Error happened, please try later"}):null,c==="ready"?s.jsx(Gs,{duration:h,handleProgressChange:P,handleVolumeChange:H,isFullScreen:o,isPlaying:d,onFullScreenClick:J,playingTime:f,setIsPlaying:N,showToolbar:a&&o}):null,c==="buffering"&&!q?s.jsx(ta,{isFullScreen:o,children:s.jsx(Vt,{color:y.lightGray})}):null]}):null},Js=j(g)`
