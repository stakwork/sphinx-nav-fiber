import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-cb5b9da6.js";import{B as M}from"./index-27475982.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-8128126b.js";import{B as f,T as L,a as R}from"./index-c0ad54f0.js";import{T as x}from"./index-b2f20657.js";import"./useSlotProps-d6f63e25.js";import"./index.esm-76465f52.js";import"./InfoIcon-903c3034.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
