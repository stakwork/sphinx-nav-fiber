import{s as t,a as o,F as n,T as S,r as b,j as e,B as v,t as C,k as $,b as T,aU as G,aV as k,aW as y,v as z,aX as w,aY as M,aZ as D,e as j,a_ as I}from"./index-c8c56f3b.js";import{f as A,s as R}from"./index-9dde51d0.js";import{C as B}from"./ClipLoader-a0d00a72.js";import{T as E,a as L}from"./Tabs-6aa64ba0.js";import"./createSvgIcon-bc5466d8.js";const V=()=>(A(R(a=>[a.graphStyle,a.setGraphStyle])),null);t(n).attrs({direction:"row",align:"center",justify:"space-between"})`
  width: 447px;
  height: 48px;
...
`,ce=()=>{const{close:a}=j("settings"),{visible:d}=j("addItem");return d?null:e.jsx(I,{background:"BG1",id:"settings",noWrap:!0,onClose:a,preventOutsideClose:!0,children:e.jsx(Q,{onClose:a})})};export{ce as SettingsModal};
