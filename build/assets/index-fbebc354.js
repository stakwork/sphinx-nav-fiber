...
`,I={[X]:"RSS link",[Z]:"Twitter Handle",[ee]:"Youtube channel"},gt="date",jt="edge_count",wt="alphabetically",Y={[gt]:"Date",[jt]:"Edge Count",[wt]:"Alphabetically"},Pe="https://twitter.com",Fe="IS_ALIAS",bt=({data:t})=>{const n=F(i=>i.setQueuedSources),[s,l]=h.useState(""),d=async i=>{if(t!=null&&t.length)try{const r=await Ue.enable();await Ve(i,r.pubkey),n(t.filter(a=>a.ref_id!==i))}catch(r){console.warn(r)}},x=async i=>{if(!(!i||!(t!=null&&t.length))){l(i);try{await ye(i),n(t==null?void 0:t.filter(r=>r.ref_id!==i))}catch(r){console.warn(r)}finally{l("")}}};return t!=null&&t.length?e.jsxs(re,{component:"table",children:[e.jsx(ae,{children:e.jsxs(D,{component:"tr",children:[e.jsx(j,{className:"empty"}),e.jsx(j,{children:"Type"}),e.jsx(j,{children:"Source"}),e.jsx(j,{}),e.jsx(j,{className:"empty"})]})}),(t==null?void 0:t.length)&&e.jsx("tbody",{children:t==null?void 0:t.map(i=>e.jsxs(le,{children:[e.jsx(j,{className:"empty"}),e.jsx(j,{children:I[i.source_type]}),e.jsx(j,{width:"268px",children:i.source_type==="twitter_handle"?e.jsxs(xe,{href:`${Pe}/${i.source}?open=system`,target:"_blank",children:["@",i.source]}):e.jsx(xe,{href:`${i.source}?open=system`,target:"_blank",children:i.source})}),e.jsx(j,{className:"cell-center",children:e.jsxs(f,{direction:"row",justify:"space-between",children:[e.jsx("div",{className:"approve-wrapper",children:e.jsx(pe,{className:"centered",onClick:()=>d(i.ref_id),children:e.jsx(ke,{color:o.primaryGreen,fontSize:24})})}),e.jsx("div",{className:"delete-wrapper",children:s===i.ref_id?e.jsx(C,{color:o.white,size:16}):e.jsx(_e,{message:"Are you sure ?",onConfirm:()=>x(i.ref_id),children:e.jsx(pe,{className:"centered",children:e.jsx(ze,{color:o.primaryRed,fontSize:24})})})})]})}),e.jsx(j,{className:"empty"})]},i.source))})]}):e.jsxs(f,{children:[e.jsx(_,{children:"There is not any results for selected filters"}),e.jsx(te,{})]})},pe=p(f)`
  width: 20px;
  height: 20px;
  border-radius: 50%;
  cursor: pointer;
...
`,yt=()=>{const[t,n]=h.useState(!0),[s,l]=h.useState(""),[d,x]=F(a=>[a.queuedSources,a.setQueuedSources]);h.useEffect(()=>{(async()=>{n(!0);try{const c=await ve({approved:"False"});x(c.data)}catch(c){console.warn(c)}finally{n(!1)}})()},[x]);const i=a=>{l(s===a||!a?"":a)},r=d==null?void 0:d.filter(a=>!s||a.source_type===s);return e.jsxs(vt,{align:"stretch",direction:"column",justify:"flex-end",children:[e.jsxs(ce,{align:"flex-start",justify:"space-between",children:[e.jsx(_,{className:"title",children:"Queued Sources"}),e.jsx(_,{className:"subtitle",children:"This is a queue of pending sources waiting for approval or denial from graph users. If you think a source will provide good content for the graph, you can pay to approve it. Think of this as an investment: you pay to add it to the source table, and if the content is popular you will earn from it. If content is not relevant to the graph, you should deny it."})]}),e.jsxs(f,{className:"filters",direction:"row",pb:16,px:36,children:[e.jsx(P,{className:N({selected:!s}),onClick:()=>i(""),size:"small",children:"All"}),Object.keys(I).map(a=>e.jsx(P,{className:N({selected:a===s}),onClick:()=>i(a),size:"small",children:I[a]},a))]}),e.jsx(St,{align:"center",justify:t?"center":"flex-start",children:t?e.jsx(C,{color:o.white}):e.jsx(bt,{data:r})})]})},vt=p(f)`
  flex: 1;
...
`,Pt=({onSelect:t,selectedTopic:n})=>{const[s,l]=h.useState(!1),[d,x]=h.useState(""),[i,r]=h.useState([]),[a,c]=h.useState(!1),g=h.useRef(null);h.useEffect(()=>()=>r([]),[r]);const m=async u=>{const v={is_muted:"False",sort_by:Ae,search:u,skip:"0",limit:"1000"};c(!0);try{const S=await Te(v);r(S.data)}catch{r([])}finally{c(!1)}},w=h.useMemo(()=>Ce.debounce(m,300),[]),b=u=>{t(u)},y=u=>{if(x(u),!u){r([]);return}u.length>2&&w(u)};return n?e.jsxs(Dt,{children:[e.jsx("div",{className:"value",children:n.name}),e.jsx(f,{className:"icon",onClick:()=>t(null),children:e.jsx(R,{})})]}):e.jsxs(e.Fragment,{children:[e.jsxs(W,{ref:g,component:"form",onSubmit:u=>u.preventDefault(),sx:{p:"2px 4px",display:"flex",alignItems:"center",width:200},children:[e.jsx(G,{inputProps:{"aria-label":"search topic"},onChange:u=>y(u.target.value),onFocus:()=>l(!0),placeholder:"Search",size:"small",sx:{ml:1,flex:1},value:d}),d&&e.jsxs(e.Fragment,{children:[e.jsx(fe,{"aria-label":"search",onClick:()=>y(""),type:"button",children:e.jsx(R,{})}),e.jsx(ie,{orientation:"vertical",sx:{height:28,m:.5}})]}),e.jsx(fe,{"aria-label":"search",type:"button",children:a?e.jsx(C,{color:o.white,size:24}):e.jsx(O,{})})]}),g.current&&i.length?e.jsx(Mt,{anchorEl:g.current,open:s,placement:"bottom",children:e.jsx(e.Fragment,{children:i.map(u=>e.jsx(Ft,{className:N({active:n===u.ref_id}),onClick:()=>b(u),children:u.name},"option"))})}):null]})},Ft=p(f).attrs({direction:"row",align:"center"})`
  font-family: Barlow;
  font-size: 13px;
  font-style: normal;
  font-weight: 500;
...
`,Ut=({from:t,onSelect:n,selectedTopic:s,selectedType:l,setSelectedType:d})=>e.jsxs(f,{children:[e.jsx(f,{align:"center",direction:"row",justify:"space-between",mb:18,children:e.jsx(f,{align:"center",direction:"row",children:e.jsx(Vt,{children:"Add edge"})})}),e.jsxs(Ht,{mb:12,children:[e.jsxs(H,{children:[e.jsx("div",{className:"label",children:"From"}),e.jsx("div",{children:t})]}),e.jsx(H,{children:e.jsx(Ot,{selectedType:l,setSelectedType:d})}),e.jsxs(H,{children:[e.jsx("div",{className:"label",children:"To"}),e.jsx(Pt,{onSelect:n,selectedTopic:s})]})]})]}),Vt=p(_)`
  font-size: 22px;
  font-weight: 600;
  font-family: 'Barlow';
...
`,jr=p(f).attrs({direction:"row",align:"center",justify:"space-between"})`
  padding: 0 36px;
  margin-bottom: 32px;
`,Q=t=>{const{children:n,value:s,index:l,...d}=t;return s===l?e.jsx(yr,{"aria-labelledby":`simple-tab-${l}`,hidden:s!==l,id:`simple-tabpanel-${l}`,role:"tabpanel",...d,children:n}):null};function K(t){return{id:`simple-tab-${t}`,"aria-controls":`simple-tabpanel-${t}`}}const wr=()=>{const[t,n]=h.useState(0),[s]=Se(x=>[x.isAdmin]),[l]=Xe(x=>[x.queuedSourcesFlag]),d=(x,i)=>{n(i)};return e.jsxs(vr,{direction:"column",children:[e.jsxs(br,{"aria-label":"sources tabs",onChange:d,value:t,children:[e.jsx(J,{disableRipple:!0,label:"Sources table",...K(0)}),s&&l?e.jsx(J,{color:o.white,disableRipple:!0,label:"Queued sources",...K(1)}):null,s&&e.jsx(J,{color:o.white,disableRipple:!0,label:"Topics",...K(1)})]}),e.jsx(Q,{index:0,value:t,children:e.jsx(Bt,{})}),e.jsx(Q,{index:1,value:t,children:e.jsx(yt,{})}),e.jsx(Q,{index:2,value:t,children:e.jsx(fr,{})})]})},br=p(ht)`
  && {
...
`,vr=p(f)`
  min-height: 0;
  flex: 1;
`,Dr=()=>{const{close:t}=A("sourcesTable");return e.jsx(M,{background:"BG1",id:"sourcesTable",kind:"large",noWrap:!0,onClose:t,children:e.jsx(wr,{})})};export{Dr as SourcesTableModal};
