import { g as b, r as _, u as O, p as A } from './index-82f7f87b.js'
function R(s, e) {
...
var I = Object.create,
  ...
  U = (s, e, t) => (e in s ? u(s, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : (s[e] = t)),
  N = (s, e) => {
  ...
  j = (s, e, t) => (
    (t = s != null ? I(M(s)) : {}), E(e || !s || !s.__esModule ? u(t, 'default', { value: s, enumerable: !0 }) : t, s)
  ),
...
class P extends c.Component {
  constructor() {
    super(...arguments),
      ...
      r(this, 'renderTrack', (e, t) => c.default.createElement('track', { key: t, ...e })),
      r(this, 'ref', (e) => {
        ...
        (0, a.getSDK)(B.replace('VERSION', n), x).then((o) => {
          ;(this.dash = o.MediaPlayer().create()),
            ...
            parseInt(n) < 3
              ...
              : this.dash.updateSettings({ debug: { logLevel: o.Debug.LOG_LEVEL_NONE } }),
            this.props.onLoaded()
        }),
      this.shouldUseFLV(e) &&
  ...
  render() {
    const { url: e, playing: t, loop: i, controls: n, muted: l, config: o, width: h, height: p } = this.props,
      ...
      S = { width: h === 'auto' ? h : '100%', height: p === 'auto' ? p : '100%' }
