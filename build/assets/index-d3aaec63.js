import{r as n,j as e,s as f,g as T,F as S,o as K,c as U,A as ae,p as ce,i as le,q as pe,H as de,t as ue,v as fe,f as q}from"./index-a72a3fe9.js";import{Universe as me}from"./index-7fb1ccb9.js";import{u as he}from"./index-0b73dc0d.js";import{u as W,a as ge,b as xe,I as ye,c as Q,d as V}from"./index-e5a87bfd.js";import{M as be,V as we}from"./VolumeIcon-e73d29ab.js";import{S as je,R as ve,s as X,M as Se}from"./index-9d59050d.js";import"./index-437c3c9c.js";import"./VisibilityOn-4728559d.js";import"./SourcesTableIcon-86a3fd49.js";import"./NodeCircleIcon-708ee0d9.js";import"./CheckIcon-99b09b2b.js";import"./DeleteNodeIcon-6724a560.js";import"./EditNodeIcon-5a702f6a.js";import"./SearchIcon-2010f2d3.js";import"./SoundIcon-9640e42c.js";import"./SucessFeedBackIcon-2fd3b983.js";import"./three.module-1c1ec8b9.js";import"./TextareaAutosize-ffe3cd5b.js";import"./index-6edd3579.js";import"./index-6d5dff4a.js";import"./index-e9989fdf.js";import"./ClipLoader-00d306a8.js";import"./Skeleton-6cc6c357.js";import"./Stack-9d698970.js";import"./index-a159aa01.js";import"./FormControlLabel-5d1dba3d.js";import"./Typography-292357da.js";import"./createSvgIcon-4a9fa9e0.js";import"./isPlainObject-ba0519bb.js";function D(t){const[i,s,r]=t.split(":").map(Number);return Number((i*60*60*1e3+s*60*1e3+r*1e3).toFixed(6))}const Z=n.memo(()=>{const t=W(a=>a.isPlaying),i=W(a=>a.setIsPlaying),s=W(a=>a.setVolume),r=W(a=>a.setPlaybackSpeed),c=W(a=>a.playbackSpeed),o=W(a=>a.playerRef),[x,b]=n.useState(!1),m=[.5,1,1.5,2],g=()=>{if(o){const a=o.getCurrentTime()-15;o.seekTo(a,"seconds")}},p=()=>{if(o){const a=o.getCurrentTime()+15;o.seekTo(a,"seconds")}},j=()=>{i(!t)},d=()=>{b(!x),s(x?1:0)},h=()=>{const I=(m.indexOf(c)+1)%m.length,F=m[I];if(r(F),o){const P=o.getInternalPlayer();P&&typeof P.playbackRate<"u"&&(P.playbackRate=F)}};return e.jsxs(ke,{children:[e.jsx(Pe,{onClick:d,children:x?e.jsx(be,{}):e.jsx(we,{})}),e.jsx(Te,{onClick:g,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(Ce,{"data-testid":"play-pause-button",onClick:j,size:"small",children:t?e.jsx(ge,{"data-testid":"pause-icon"}):e.jsx(xe,{"data-testid":"play-icon"})}),e.jsx(Ie,{onClick:p,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(_e,{onClick:h,children:[c,"x"]})]})});Z.displayName="Controls";const ke=f(S).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${T.BG1};
  border-radius: 40px;
