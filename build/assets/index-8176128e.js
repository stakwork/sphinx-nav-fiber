...
`,ir=v.lazy(()=>ke(()=>import("./index-3be608b2.js"),["assets/index-3be608b2.js","assets/index-5d91095a.js","assets/index-b4d03b7b.css","assets/index-68ee0ada.js","assets/SourcesTableIcon-d0f9046e.js","assets/index-0824eecd.js","assets/CheckIcon-675f17ec.js","assets/DeleteNodeIcon-636b7b24.js","assets/SoundIcon-afae563b.js","assets/SucessFeedBackIcon-c817e6a8.js","assets/ClipLoader-8427fdc9.js","assets/TableRow-2ac54758.js"]).then(({TweetAnalyze:e})=>({default:e}))),ar=()=>{const e=$(o=>o.setSelectedTweet),t=$(o=>o.selectedTweet),{tweetId:a}=fe(),[r,n]=v.useState(""),{open:i}=De("tweetAnalyze"),l=(a==null?void 0:a.split("&"))||[],c=o=>{i(),n(o)};return s.jsxs(or,{align:"stretch",basis:"100%",grow:1,shrink:1,children:[l.length>1?s.jsx(sr,{onClick:()=>{c("summary")},children:"Summary Report"}):null,l.map(o=>s.jsx(cr,{className:t===o?"selected":"",onClick:()=>e(o),children:s.jsx(Vt,{handleAnalyzeClick:()=>{c(o)},nodeId:o})},o)),s.jsx(ir,{tweetId:r})]})},sr=f.button`
  width: 100%;
  background: ${y.ANALYTICS_CARD_BG};
  color: ${y.white};
  padding: 16px 16px;
