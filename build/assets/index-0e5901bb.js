import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-2c9fb007.js";import{B as F}from"./index-45f399ac.js";import{u as M}from"./index-30b13236.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-df671410.js";import{B as f,T as R,a as L}from"./index-321c0f3c.js";import{T as x}from"./index-07934e38.js";import"./useSlotProps-174bcdd4.js";import"./index.esm-93c5249f.js";import"./InfoIcon-c2aebd55.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
