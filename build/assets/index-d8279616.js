import{r as o,j as e,s as f,g as v,F as j,o as Y,c as J,A as ae,p as ie,i as ce,q as le,H as pe,t as de,v as ue}from"./index-20edceed.js";import{t as U,u as G,C as me}from"./index-3ad32d77.js";import{U as fe}from"./index-90f6d8b4.js";import{u as M,a as he,b as ge,I as xe,c as K,d as ye}from"./index-0354bf1b.js";import{M as we,V as be}from"./index-80995083.js";import{S as je,R as ve,s as V,M as Se}from"./index-fe5063c5.js";import"./string-a277709d.js";import"./index-87940bd8.js";import"./three.module-9722a9fc.js";import"./index-9463cdb2.js";import"./TextareaAutosize-9097434a.js";import"./CheckIcon-2af25782.js";import"./index-9d025e0d.js";import"./index-48c2e0fa.js";import"./ClipLoader-466545e4.js";import"./clsx-35d1f629.js";import"./SourcesTableIcon-aab0b193.js";import"./DeleteNodeIcon-2683a992.js";import"./SoundIcon-6a261a8f.js";import"./SucessFeedBackIcon-cdd30cd3.js";import"./Skeleton-63773ef0.js";import"./index-1c22c1ec.js";import"./Stack-0478efad.js";import"./FormControlLabel-c38213c7.js";import"./Typography-ce3e4f8b.js";import"./createSvgIcon-c3418fd4.js";import"./isPlainObject-0528d171.js";const Q=o.memo(()=>{const r=M(s=>s.isPlaying),a=M(s=>s.setIsPlaying),n=M(s=>s.setVolume),t=M(s=>s.setPlaybackSpeed),c=M(s=>s.playbackSpeed),i=M(s=>s.playerRef),[d,g]=o.useState(!1),y=[.5,1,1.5,2],h=()=>{if(i){const s=i.getCurrentTime()-15;i.seekTo(s,"seconds")}},u=()=>{if(i){const s=i.getCurrentTime()+15;i.seekTo(s,"seconds")}},b=()=>{a(!r)},l=()=>{g(!d),n(d?1:0)},p=()=>{const m=(y.indexOf(c)+1)%y.length,P=y[m];if(t(P),i){const _=i.getInternalPlayer();_&&typeof _.playbackRate<"u"&&(_.playbackRate=P)}};return e.jsxs(ke,{children:[e.jsx(_e,{onClick:l,children:d?e.jsx(we,{}):e.jsx(be,{})}),e.jsx(Ie,{onClick:h,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(Ce,{"data-testid":"play-pause-button",onClick:b,size:"small",children:r?e.jsx(he,{"data-testid":"pause-icon"}):e.jsx(ge,{"data-testid":"play-icon"})}),e.jsx(Pe,{onClick:u,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(Te,{onClick:p,children:[c,"x"]})]})});Q.displayName="Controls";const ke=f(j).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${v.BG1};
  border-radius: 40px;
