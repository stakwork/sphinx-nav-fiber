...
`,ir=v.lazy(()=>ke(()=>import("./index-5f8d85ae.js"),["assets/index-5f8d85ae.js","assets/index-aa147a39.js","assets/index-b4d03b7b.css","assets/index-64bf63a3.js","assets/SourcesTableIcon-548e89ba.js","assets/index-dee2e50f.js","assets/CheckIcon-e95d0922.js","assets/DeleteNodeIcon-c2327e61.js","assets/SoundIcon-7051b901.js","assets/SucessFeedBackIcon-63951ce1.js","assets/ClipLoader-dab7b1fa.js","assets/TableRow-01b0d223.js"]).then(({TweetAnalyze:e})=>({default:e}))),ar=()=>{const e=$(o=>o.setSelectedTweet),t=$(o=>o.selectedTweet),{tweetId:a}=fe(),[r,n]=v.useState(""),{open:i}=De("tweetAnalyze"),l=(a==null?void 0:a.split("&"))||[],c=o=>{i(),n(o)};return s.jsxs(or,{align:"stretch",basis:"100%",grow:1,shrink:1,children:[l.length>1?s.jsx(sr,{onClick:()=>{c("summary")},children:"Summary Report"}):null,l.map(o=>s.jsx(cr,{className:t===o?"selected":"",onClick:()=>e(o),children:s.jsx(Vt,{handleAnalyzeClick:()=>{c(o)},nodeId:o})},o)),s.jsx(ir,{tweetId:r})]})},sr=f.button`
  width: 100%;
  background: ${y.ANALYTICS_CARD_BG};
  color: ${y.white};
  padding: 16px 16px;
