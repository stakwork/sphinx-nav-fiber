import{C as s,Q as x,r as y,O as R,E as S,j as _}from"./index-5306a408.js";import{bO as $,bN as U,b$ as b,bP as M,c0 as u,bS as j,bT as A}from"./react-toastify.esm-2eb26066.js";function N(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function X(t){return parseFloat(t)}function E(t){return $("MuiSkeleton",t)}U("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const O=["animation","className","component","height","style","variant","width"];let r=t=>t,p,m,g,f;const P=t=>{const{classes:a,variant:e,animation:i,hasChildren:n,width:l,height:o}=t;return A({root:["root",e,i,n&&"withChildren",n&&!l&&"fitContent",n&&!o&&"heightAuto"]},E,a)},T=b(p||(p=r`
  0% {
    opacity: 1;
  }
