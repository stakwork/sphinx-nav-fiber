import{s as n,g as a,F as p,r as x,j as t,o as z,w as U,x as Y,A as q,c as H,i as V,q as O,H as X,t as K,y as Q}from"./index-1d72d4f1.js";import{F,a as J,b as Z,U as ee}from"./index-ee389888.js";import{I as te,d as y,a as re,b as se}from"./index-b9fb2bb5.js";import{S as ie,M as ne}from"./index-05e0cafc.js";import{C as oe}from"./CheckIcon-6d87020c.js";import{L as ae}from"./VolumeIcon-9a00d38c.js";import{P as ce}from"./index-c6a8b6a6.js";import"./TextareaAutosize-a1e07134.js";import"./three.module-4d3d7244.js";import"./index-ea22c5fb.js";import"./index-70348306.js";import"./VisibilityOn-ed4abd07.js";import"./SearchIcon-dc227165.js";import"./index-b86b195a.js";import"./ClipLoader-ef240031.js";import"./Skeleton-a09b3cfb.js";import"./Stack-c5b45686.js";import"./index-bf8d7a9e.js";import"./SoundIcon-a50f64af.js";import"./FormControlLabel-519487c5.js";import"./Typography-33e4eb62.js";import"./createSvgIcon-5aec6e44.js";import"./isPlainObject-917fc9b9.js";import"./SourcesTableIcon-09ee37d8.js";import"./NodeCircleIcon-424f7c8d.js";import"./DeleteNodeIcon-eb5fcad6.js";import"./EditNodeIcon-81ed866f.js";import"./SucessFeedBackIcon-4035084c.js";const I=3e4,N=({onPlaybackRestart:e})=>{const r=y(l=>l.tweetIsPlaying),o=y(l=>l.setTweetIsPlaying),s=()=>{},c=()=>{},i=x.useCallback(()=>{e&&e(),o(!r)},[r,o,e]);return t.jsxs(le,{children:[t.jsx(de,{onClick:s,children:t.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),t.jsx(pe,{"data-testid":"play-pause-button",onClick:i,size:"small",children:r?t.jsx(re,{"data-testid":"pause-icon"}):t.jsx(se,{"data-testid":"play-icon"})}),t.jsx(me,{onClick:c,children:t.jsx("img",{alt:"",src:"/ForwardIcon.svg"})})]})};N.displayName="Controls";const le=n(p).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${a.BG1};
  border-radius: 40px;
...
`,Re=({node:e})=>{const r=e?Y(e):null,{text:o,name:s,verified:c,image_url:i,twitter_handle:l}=r||{};let d="";return(r==null?void 0:r.node_type)==="Tweet"?d=`https://x.com/${l}/status/${r==null?void 0:r.tweet_id}`:(r==null?void 0:r.node_type)==="User"&&(d=`https://x.com/${l}`),t.jsx(Se,{children:t.jsxs(Me,{children:[t.jsx(Ie,{children:i?t.jsx(q,{rounded:!0,size:58,src:i,type:"person"}):t.jsx(Ce,{children:t.jsx(ce,{})})}),t.jsxs(De,{children:[t.jsxs(Be,{children:[t.jsxs(Fe,{children:[s&&t.jsx(ze,{children:s}),!c&&t.jsx(Ge,{children:t.jsx(oe,{})})]}),t.jsx(Ee,{href:d,target:"_blank",children:t.jsx(ae,{})})]}),l&&t.jsxs(Ne,{children:["@",l]}),t.jsx(We,{children:o})]})]})})},Se=n(p)`
  background: ${a.ANALYTICS_CARD_BG};
  border-radius: 16px;
  padding: 10px;
  width: 100%;
...
`,Le=()=>{const e=y(r=>r.selectedTweet);return e?t.jsxs(Ue,{align:"stretch",basis:"100%",grow:1,shrink:1,children:[t.jsx(Ye,{children:e&&t.jsx(Re,{node:e})}),t.jsx(ve,{node:e})]}):null},Ue=n(p)(({theme:e})=>({position:"relative",display:"flex",padding:"0 20px 0 20px",background:"transparent",width:"100%",height:"calc(100vh - 180px)",overflow:"auto",[e.breakpoints.up("sm")]:{width:ne,gap:"10px"}})),Ye=n(p)(({theme:e})=>({width:"100%",marginBottom:"20px",[e.breakpoints.up("sm")]:{width:"390px",margin:"0 auto"}})),qe=e=>{const r=e.edges.filter(s=>{var c;return((c=s==null?void 0:s.properties)==null?void 0:c.start)&&typeof s.properties.start=="string"}).map(s=>({source:s.source,target:s.target,start:s.properties.start}));return e.nodes.filter(s=>e.edges.some(c=>c.source===s.ref_id||c.target===s.ref_id)).map(s=>{const c=r.find(i=>s.ref_id===i.source||s.ref_id===i.target);return{...s,start:(c==null?void 0:c.start)||0}}).filter(s=>s&&typeof s.start=="string"&&s.node_type!=="Clip"&&s.node_type!=="Episode"&&s.node_type!=="Show")},_t=()=>{const e=H(f=>f.addNewNode),r=x.useRef(null),o=x.useRef(null),s=x.useRef(null),[c,i]=x.useState([]),{setSchemas:l}=z(f=>f),d=y(f=>f.setSelectedTweet),w=V(),{tweetId:g}=O();return x.useEffect(()=>{(async()=>{try{const h=await K();l(h.schemas.filter(m=>!m.is_deleted))}catch(h){console.error("Error fetching schema:",h)}})()},[l]),x.useEffect(()=>{g&&(async h=>{try{const m=await Q(h),k=m.nodes.find(M=>M.ref_id===g);k&&(d(k),e({nodes:[k],edges:[]}));const $=qe({nodes:m.nodes,edges:m.edges});i($),s.current={nodes:m.nodes,edges:m.edges}}catch(m){w("/"),console.error(m)}})(g)},[e,w,g,d]),x.useEffect(()=>{const f=h=>{const{tweetPlayingTime:m,tweetDuration:k}=y.getState(),$=k/I*3e3;if(o.current!==null){if(h-o.current>1e3){if(s.current){const{nodes:u,edges:j}=s.current,_=m,[T,v]=j.reduce(([P,R],b)=>{var B;const S=typeof((B=b==null?void 0:b.properties)==null?void 0:B.start)=="string"?new Date(b.properties.start||0).getTime():0;return S!==0&&S<=_+$?P.push(b):R.push(b),[P,R]},[[],[]]),[A,L]=u.reduce(([P,R],b)=>(T.some(S=>S.target===b.ref_id||S.source===b.ref_id)?P.push(b):R.push(b),[P,R]),[[],[]]);s.current={nodes:L,edges:v},(A.length||T.length)&&e({nodes:A,edges:T})}o.current=h}}else o.current=h;r.current=requestAnimationFrame(f)};return r.current=requestAnimationFrame(f),()=>{r.current&&cancelAnimationFrame(r.current)}},[s,e]),t.jsxs(He,{children:[t.jsx(Ve,{direction:"row",children:t.jsxs(t.Fragment,{children:[t.jsxs(p,{children:[t.jsx(X,{}),t.jsx(Le,{})]}),t.jsx(Oe,{children:t.jsx(p,{basis:"100%",grow:1,shrink:1,children:t.jsx(ee,{})})})]})}),t.jsx(Xe,{children:t.jsx(je,{markers:c})})]})},He=n.div`
  display: flex;
  flex-direction: column;
  height: 100vh;
  width: 100%;
