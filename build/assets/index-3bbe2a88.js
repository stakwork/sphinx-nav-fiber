import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-698b182e.js";import{B as F}from"./index-40b71e0c.js";import{u as M}from"./index-ccdeaaab.js";import{j as $,e as k,F as D,C as G}from"./react-toastify.esm-6e39d4d1.js";import{B as f,T as R,a as L}from"./index-bc4d82e1.js";import{T as x}from"./index-da24c8b1.js";import"./useSlotProps-857c23a1.js";import"./index.esm-e2795ecd.js";import"./InfoIcon-80b049e6.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
