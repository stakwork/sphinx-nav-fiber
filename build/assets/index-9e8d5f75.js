import{s as i,a as t,F as c,j as e,a0 as j,r as l,u as $,B as w,br as C,bt as R,aW as D}from"./index-92866164.js";import{e as I,f as z}from"./index-d2d5ee01.js";import{D as E}from"./DeleteNodeIcon-373b83d1.js";import{S as L}from"./Skeleton-dc5ae6d5.js";import{C as T}from"./ClipLoader-1643ba29.js";const G=({nodeName:p})=>e.jsx(c,{children:e.jsxs(c,{align:"center",direction:"column",justify:"space-between",children:[e.jsx(W,{children:e.jsx(E,{})}),e.jsxs(M,{children:["Are you sure you want to delete ",p||"this item","?"]})]})}),M=i(c)`
  color: ${t.white};
  font-family: 'Barlow';
  font-size: 20px;
  font-weight: 400;
