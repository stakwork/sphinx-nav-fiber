import{s as x,c as f,u as P,r as m,j as e,F as o,T as u,b as N,x as V,o as q,ad as J,g as Y,ae as S,d as H,a2 as K}from"./index-56a19120.js";import{ak as Q,B as w,al as W,l as X,F as Z,am as ee}from"./react-toastify.esm-943194c6.js";import{B as te}from"./index-7de98fdb.js";import{n as y}from"./toastMessage-4e7c3a14.js";import{a as C}from"./index-7a174319.js";import{u as oe}from"./index-eda8d570.js";import{C as ne}from"./CheckIcon-6d999bdf.js";import{T as _}from"./index-fc21fb19.js";import{A as se}from"./index-0aae735f.js";import"./index.esm-2a1100f5.js";import"./InfoIcon-ecf7fa88.js";import"./index-6bd66fa3.js";import"./Popover-61c9f885.js";import"./useSlotProps-9ca51873.js";import"./Select-c5ec75f9.js";import"./Stack-8146bfd3.js";import"./Popper-1d2096de.js";const ae=({onClick:n,loading:r})=>{const i=P(l=>l.budget),[c,p]=m.useState(10),a="node";return m.useEffect(()=>{(async()=>{try{const t=await W(a);p(t.data.price)}catch(t){console.error("cannot fetch",t)}})()},[a]),e.jsxs(o,{children:[e.jsx(o,{align:"center",direction:"row",justify:"space-between",mb:20,children:e.jsx(o,{align:"center",direction:"row",children:e.jsx(ce,{children:"Approve Cost"})})}),e.jsxs(o,{align:"center",direction:"row",justify:"space-between",mb:20,children:[e.jsxs(re,{children:[e.jsx("div",{className:"title",children:"COST"}),e.jsxs("div",{className:"value","data-testid":"check-price",children:[c," sats"]})]}),e.jsxs(ie,{children:[e.jsx("div",{className:"title",children:"BUDGET"}),e.jsxs("div",{className:"value",children:[Q(i)," sats"]})]})]}),e.jsx(o,{children:e.jsx(w,{color:"secondary","data-testid":"check-icon",disabled:r,onClick:n,size:"large",startIcon:e.jsx(ne,{}),type:"submit",variant:"contained",children:"Approve"})})]})},re=x(o).attrs({direction:"column",align:"space-between",justify:"flex-start"})`
  width: 141px;
  height: 61px;
