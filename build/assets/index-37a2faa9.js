import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,x as D,B as F}from"./index-ce9eea71.js";import{B as M}from"./index-e83a796e.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-02c4cf81.js";import{B as f,T as L,a as R}from"./index-35107dc5.js";import{T as x}from"./index-8c9f9a3f.js";import"./useSlotProps-817fc2b7.js";import"./index.esm-59f7d1cc.js";import"./InfoIcon-2e95a383.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
