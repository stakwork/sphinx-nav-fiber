import{r as i,j as e,s as u,g as h,F as y,o as Z,c as ee,A as pe,p as X,i as de,q as ue,H as me,t as fe,v as he}from"./index-0e71550c.js";import{t as Y,u as F,C as ge}from"./index-a192b67c.js";import{U as xe}from"./index-b2c0f533.js";import{u as P,a as ye,b as be,I as we,c as te,d as je}from"./index-cc42c491.js";import{M as ve,V as ke}from"./index-c6eb4ffc.js";import{S as Se,R as Ce,s as U,M as Te}from"./index-d971c9de.js";import"./index-b0dcb7dd.js";import"./string-a277709d.js";import"./index-8b31d10f.js";import"./three.module-a9c166f5.js";import"./isPlainObject-4a21074c.js";import"./TextareaAutosize-982d3f42.js";import"./CheckIcon-22fc4102.js";import"./index-69272743.js";import"./index-5174a3ad.js";import"./index-5742026c.js";import"./ClipLoader-39b0e414.js";import"./clsx-45ad0b2f.js";import"./SourcesTableIcon-733f4b62.js";import"./DeleteNodeIcon-c15a0339.js";import"./SoundIcon-348b8e0c.js";import"./SucessFeedBackIcon-3537b830.js";import"./Skeleton-ec0a698f.js";import"./index-fe176efd.js";import"./Stack-b78ed822.js";import"./FormControlLabel-3a0d6c05.js";import"./Typography-727d228b.js";import"./createSvgIcon-8cb8232a.js";const re=i.memo(()=>{const s=P(a=>a.isPlaying),c=P(a=>a.setIsPlaying),t=P(a=>a.setVolume),r=P(a=>a.setPlaybackSpeed),l=P(a=>a.playbackSpeed),n=P(a=>a.playerRef),[p,g]=i.useState(!1),b=[.5,1,1.5,2],f=()=>{if(n){const a=n.getCurrentTime()-15;n.seekTo(a,"seconds")}},m=()=>{if(n){const a=n.getCurrentTime()+15;n.seekTo(a,"seconds")}},v=()=>{c(!s)},d=()=>{g(!p),t(p?1:0)},o=()=>{const j=(b.indexOf(l)+1)%b.length,C=b[j];if(r(C),n){const E=n.getInternalPlayer();E&&typeof E.playbackRate<"u"&&(E.playbackRate=C)}};return e.jsxs($e,{children:[e.jsx(Re,{onClick:d,children:p?e.jsx(ve,{}):e.jsx(ke,{})}),e.jsx(Ie,{onClick:f,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(Pe,{"data-testid":"play-pause-button",onClick:v,size:"small",children:s?e.jsx(ye,{"data-testid":"pause-icon"}):e.jsx(be,{"data-testid":"play-icon"})}),e.jsx(_e,{onClick:m,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(Ee,{onClick:o,children:[l,"x"]})]})});re.displayName="Controls";const $e=u(y).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${h.BG1};
  border-radius: 40px;
