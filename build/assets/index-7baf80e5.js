import{o as s,F as o,T as w,p as C,r as f,j as e,q as c,A as S,aU as A,aV as b,aW as z,J as D,O as y}from"./index-6cf558a2.js";import{B as G}from"./index-11d02a60.js";import{G as M,B as v,i as $,F as B}from"./index-abdac321.js";import{C as T}from"./ClipLoader-a49c8582.js";import{T as j}from"./index-82d5b499.js";import{S as E}from"./index-9d434b94.js";import{e as I}from"./index.esm-1306a002.js";import{T as k,a as F}from"./Tabs-bcf6c917.js";import"./InfoIcon-a7505bce.js";import"./useSlotProps-5890e8c5.js";import"./createSvgIcon-9ff3d99b.js";const R=({onClose:a})=>{const[l]=C(d=>[d.graphStyle]),[r,i]=f.useState(!1),p=()=>{i(!0),localStorage.setItem("graphStyle",l),i(!1),a()};return e.jsxs(W,{direction:"column",children:[e.jsx(V,{children:"Default graph view:"}),e.jsx(M,{}),e.jsx(o,{mt:308,py:24,children:e.jsx(v,{color:"secondary",disabled:r,id:"add-node-submit-cta",onClick:p,size:"large",startIcon:r&&e.jsx(L,{children:e.jsx(T,{color:c.lightGray,size:12})}),type:"submit",variant:"contained",children:"Save Changes"})})]})},W=s(o)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,V=s(w)`
