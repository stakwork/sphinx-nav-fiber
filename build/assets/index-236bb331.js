import{r as i,j as e,s as u,g as h,F as y,o as Z,c as ee,A as pe,p as X,i as de,q as ue,H as me,t as fe,v as he}from"./index-054d527d.js";import{ClaimsModal as ge}from"./index-ef7ff1d6.js";import{U as xe}from"./index-8e43f6e3.js";import{t as Y,u as F}from"./index-96899cfe.js";import{u as P,a as ye,b as be,I as we,c as te,d as je}from"./index-432cb653.js";import{M as ve,V as ke}from"./index-ab5fe31c.js";import{S as Se,R as Ce,s as U,M as Te}from"./index-b39ccdc5.js";import"./string-a277709d.js";import"./index-1a41ba5f.js";import"./three.module-9722a9fc.js";import"./isPlainObject-c0b60b7d.js";import"./TextareaAutosize-01755d22.js";import"./CheckIcon-db30f160.js";import"./index-903735c4.js";import"./index-bb566c75.js";import"./index-0087cb29.js";import"./ClipLoader-2ed7a2d8.js";import"./clsx-160a0785.js";import"./SourcesTableIcon-44e80d77.js";import"./DeleteNodeIcon-f43b93ae.js";import"./SoundIcon-427f484b.js";import"./SucessFeedBackIcon-a0f54e05.js";import"./Skeleton-1c1c8bcc.js";import"./index-86c2b247.js";import"./Stack-bd526104.js";import"./FormControlLabel-3b8b8d1a.js";import"./Typography-082b4dac.js";import"./createSvgIcon-cdeb652d.js";const re=i.memo(()=>{const s=P(a=>a.isPlaying),c=P(a=>a.setIsPlaying),t=P(a=>a.setVolume),r=P(a=>a.setPlaybackSpeed),l=P(a=>a.playbackSpeed),n=P(a=>a.playerRef),[p,g]=i.useState(!1),b=[.5,1,1.5,2],f=()=>{if(n){const a=n.getCurrentTime()-15;n.seekTo(a,"seconds")}},m=()=>{if(n){const a=n.getCurrentTime()+15;n.seekTo(a,"seconds")}},v=()=>{c(!s)},d=()=>{g(!p),t(p?1:0)},o=()=>{const j=(b.indexOf(l)+1)%b.length,C=b[j];if(r(C),n){const E=n.getInternalPlayer();E&&typeof E.playbackRate<"u"&&(E.playbackRate=C)}};return e.jsxs($e,{children:[e.jsx(Re,{onClick:d,children:p?e.jsx(ve,{}):e.jsx(ke,{})}),e.jsx(Ie,{onClick:f,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(Pe,{"data-testid":"play-pause-button",onClick:v,size:"small",children:s?e.jsx(ye,{"data-testid":"pause-icon"}):e.jsx(be,{"data-testid":"play-icon"})}),e.jsx(_e,{onClick:m,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(Ee,{onClick:o,children:[l,"x"]})]})});re.displayName="Controls";const $e=u(y).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${h.BG1};
  border-radius: 40px;
