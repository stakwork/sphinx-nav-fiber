import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-9f975889.js";import{B}from"./index-284735c6.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-069fa716.js";import{B as f,T as $,a as k}from"./index-e66ee42b.js";import{T as u}from"./index-39d3ead8.js";import"./useSlotProps-a7d6430a.js";import"./index.esm-b8208375.js";import"./InfoIcon-a417ded5.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
