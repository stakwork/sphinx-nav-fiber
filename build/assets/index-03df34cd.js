import{o as s,F as o,T as w,p as C,r as f,j as e,q as c,A as S,aU as A,aV as b,aW as M,M as z,Q as y}from"./index-fe10be9a.js";import{B as D}from"./index-e3cbf01d.js";import{G,B as v,i as $,F as B}from"./index-e899aa8e.js";import{C as T}from"./ClipLoader-50b829f9.js";import{T as j}from"./index-f20f5b51.js";import{S as E}from"./index-221d6c63.js";import{e as I}from"./index.esm-0ac2ceb3.js";import{T as k,a as F}from"./Tabs-f68a0eb8.js";import"./InfoIcon-583a8812.js";import"./useSlotProps-f53f6b67.js";import"./createSvgIcon-50c8c7ef.js";const R=({onClose:a})=>{const[l]=C(d=>[d.graphStyle]),[r,i]=f.useState(!1),p=()=>{i(!0),localStorage.setItem("graphStyle",l),i(!1),a()};return e.jsxs(W,{direction:"column",children:[e.jsx(V,{children:"Default graph view:"}),e.jsx(G,{}),e.jsx(o,{mt:308,py:24,children:e.jsx(v,{color:"secondary",disabled:r,id:"add-node-submit-cta",onClick:p,size:"large",startIcon:r&&e.jsx(L,{children:e.jsx(T,{color:c.lightGray,size:12})}),type:"submit",variant:"contained",children:"Save Changes"})})]})},W=s(o)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,V=s(w)`
