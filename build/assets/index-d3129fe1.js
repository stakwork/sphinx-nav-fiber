import{s as r,c as i,F as s,j as e,T as $,h as ee,r as d,u as xe,P as de,d as Ie,g as Ee,f as Re}from"./index-725cd71c.js";import{A as E,u as R,b as A,af as pe,ag as Ae,B as I,w as Pe,ah as X,ai as Me,a as P,J as Le,I as he,c as U,v as ue,P as te,aj as Ge,ak as ge,al as De,e as Fe,d as Ne}from"./react-toastify.esm-2b45af49.js";import{G as ye,L as se,B as oe,H as Ye,u as Oe,S as We,a as He,D as Ve,M as Ue,R as Qe,b as qe,c as Ke,d as Xe,N as fe,C as Je,e as me,f as we,g as Ze,h as et,i as je,j as tt,P as st,k as be,s as re,V as ot,F as it,E as nt,l as rt,m as at,n as ke,o as lt,p as ct,q as xt,r as dt,t as pt,v as ht,w as ut,x as gt,y as yt}from"./SoundIcon-1e17bccb.js";import{C as ft,S as mt}from"./ChevronUpIcon-179dbe87.js";import{f as V,o as ve,n as wt,X as jt,Y as bt,T as kt,D as vt,S as ie,q as Ce,P as Q}from"./generateCategoricalChart-756a6d80.js";import{T as W}from"./index-48369ed0.js";import{S as Ct}from"./Skeleton-5cdaafa2.js";import{T as ae}from"./toastMessage-e30a9a05.js";import{g as St,d as $t}from"./index.esm-665ada5a.js";import{T as _t,F as Tt}from"./Popover-653b2d14.js";import{I as Bt,S as zt,O as It}from"./Select-e2ea12e5.js";import{C as Et}from"./CheckIcon-c6ceecd9.js";import{I as Rt}from"./InfoIcon-2b7bba01.js";import{C as ne}from"./ClipLoader-0a48de47.js";import{P as At}from"./PlusIcon-1cd6bc68.js";import{u as Z}from"./index-c3e60fc6.js";import{B as Pt}from"./index-c7317d75.js";import"./useSlotProps-cf3ec1f9.js";const Mt=({imageUrl:t,name:o})=>e.jsxs(s,{align:"center",direction:"row",children:[t&&e.jsx(Lt,{children:e.jsx(E,{rounded:!0,size:64,src:t||"",type:"image"})}),o&&e.jsx(Gt,{children:o})]}),Lt=r(s)`
  img {
    width: 64px;
    height: 64px
    border-radius: 50%;
...
`,pi=r.audio`
  height: 0;
  width: 0;
`,hi=["Drivechain","Ordinals","L402","Nostr","AI"],ui=({onSubmit:t})=>{var D;const{open:o}=Z("addContent"),[n,a]=d.useState(!1),[l,x]=d.useState(!1),[c,y]=d.useState(null),g=d.useRef(null),[p,f]=d.useState(0),[v,u]=d.useState(!1),{open:w}=Z("briefDescription"),{trendingTopics:C,setTrendingTopics:k}=R(m=>m),{setValue:j}=ge(),b=d.useCallback(async()=>{a(!0),x(!1);try{const m=await De();m.length&&Array.isArray(m)&&k(m)}catch{k(hi.map(S=>({topic:S,count:0})))}finally{a(!1)}},[k,x]);d.useEffect(()=>{C.length||b()},[b,C.length]),d.useEffect(()=>{const m=setTimeout(()=>{x(!0)},5e3);return()=>clearTimeout(m)},[x,n]);const h=m=>{j("search",m),t==null||t()},_=(m,S)=>{m.stopPropagation(),m.currentTarget.blur(),S!=null&&S.tldr&&(y(S),w())},M=()=>{y(null)},z=m=>{m.stopPropagation(),m.currentTarget.blur(),u(!v)};d.useEffect(()=>{var m,S;v?(m=g.current)==null||m.play():(S=g.current)==null||S.pause()},[p,v]);const Y=()=>{f(m=>{var F,N;let S=(m+1)%C.length;for(;S!==m&&!((F=C[S])!=null&&F.audio_EN);)S=(S+1)%C.length;return S===m?(u(!1),S):((N=g.current)==null||N.load(),S===0&&(u(!1),f(0)),S)})},O=n?"Loading":"No new trending topics in the last 24 hours";return e.jsxs(yi,{"data-testid":"trending-component",children:[e.jsxs("div",{children:[e.jsxs("div",{className:"heading-container",children:[e.jsxs("div",{className:"heading",children:[e.jsx("span",{className:"heading__title",children:"Trending Topics"}),e.jsx("span",{className:"heading__icon",children:n?e.jsx(ne,{color:i.white,size:16}):e.jsx(e.Fragment,{children:l?e.jsx(mi,{onClick:b,size:"small",startIcon:e.jsx(ai,{})}):e.jsx(dt,{})})})]}),pt(C)?e.jsxs("div",{children:[e.jsx(I,{onClick:m=>z(m),startIcon:v?e.jsx(Q,{}):e.jsx(te,{}),children:v?"Pause":"Play All"}),e.jsx(wi,{ref:g,onEnded:Y,src:(D=C[p])==null?void 0:D.audio_EN,children:e.jsx("track",{kind:"captions"})})]}):null]}),C.length===0?e.jsxs("div",{className:"trending-empty",children:[e.jsx(fi,{children:O}),e.jsx(I,{color:"secondary",disabled:n,onClick:o,size:"medium",startIcon:e.jsx(At,{}),sx:{alignSelf:"flex-end",m:"0 36px 16px 0"},variant:"contained",children:"Add Content"})]}):e.jsx("ul",{className:"list",children:C.map(m=>e.jsxs(s,{align:"center",className:"list-item",direction:"row",justify:"space-between",onClick:()=>h(m.topic),children:[e.jsxs(gi,{children:[" #",ht(m)]}),m.tldr&&e.jsx(I,{onClick:S=>_(S,m),children:"TLDR"})]},m.topic))})]}),c&&e.jsx(li,{onClose:M,selectTrending:h,trend:c})]})},gi=r.div`
  width: 300px;
  overflow: hidden;
  text-overflow: ellipsis;
  line-height: 1.5;
