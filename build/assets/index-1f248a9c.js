import{s as a,a as r,F as i,j as e,E as B,T as S,r as b,B as v,t as I,k as $,b as C,aU as k,aV as A,N as y,w as z,aW as w,aX as M,aY as D,e as j,aZ as E}from"./index-0a6ee7ee.js";import{h as T,r as R,aB as L,aC as W,C as P,aD as V,aE as F}from"./index-0994fbe2.js";import{C as G}from"./ClipLoader-bad459b5.js";import{T as U,a as N}from"./Tabs-63f2b6c4.js";import"./createSvgIcon-e31fde8c.js";const Y={split:e.jsx(W,{}),force:e.jsx(P,{}),sphere:e.jsx(V,{}),earth:e.jsx(F,{})},O=()=>{const[n,c]=T(R(t=>[t.graphStyle,t.setGraphStyle])),l=t=>{c(t)};return e.jsx(_,{direction:"column",children:L.map(t=>e.jsx(i,{className:B("icon",{active:n===t}),onClick:()=>l(t),children:Y[t]},t))})},_=a(i).attrs({direction:"row",align:"center",justify:"space-between"})`
  width: 447px;
  height: 48px;
