...
`,On=({parent:t})=>{const s=t;return o.jsxs(k,{children:[o.jsx(k,{direction:"row",mb:10,children:o.jsxs(ie,{container:!0,spacing:2,children:[o.jsx(ie,{item:!0,xs:5,children:o.jsx(Ie,{style:{marginRight:180},children:"Attributes"})}),o.jsx(ie,{item:!0,xs:4,children:o.jsx(Ie,{style:{marginRight:130},children:"Type"})}),o.jsx(ie,{item:!0,xs:3,children:o.jsx(Ie,{children:"Required"})})]})}),s&&o.jsx(Tn,{parentParam:s},s)]})},Ie=$(q)`
  font-size: 15px;
  color: gray;
`,Mn={type:"",parent:""},An=async(t,s=!1)=>{try{const{attributes:i,...e}=t,a={...e,attributes:Lo(i)};let l;if(s?l=await Ce.put("/schema",JSON.stringify(a),{}):l=await Ce.post("/schema",JSON.stringify({...a,node_key:"name"}),{}),l.status!=="success")throw new Error("error");return l==null?void 0:l.ref_id}catch(i){let e=pe;if(i.status===400){const a=await i.json();e=a.errorCode||(a==null?void 0:a.status)||pe}else i instanceof Error&&(e=i.message);throw new Error(e)}},Nn=t=>t.charAt(0).toUpperCase()+t.slice(1),yt=async(t,s)=>{try{const l=((await _t()).schemas||[]).filter(f=>!f.is_deleted&&f.type&&(!s||s(f))).map(f=>f.type==="thing"?{label:"No Parent",value:f.type}:{label:Nn(f.type),value:f.type});t(l)}catch(i){console.warn(i)}},Ln=({graphLoading:t,onSchemaCreate:s,selectedSchema:i,onDelete:e,setSelectedSchemaId:a,setGraphLoading:l,setIsCreateNew:f,onSchemaUpdate:c})=>{const{close:d,visible:y}=Lt("addType"),r=Ge({mode:"onChange",defaultValues:i?{type:i.type,parent:i.parent}:Mn}),{watch:h,setValue:p,reset:v,getValues:S}=r,[b,P]=x.useState(!1),[C,T]=x.useState(!1),[N,m]=x.useState(null),[g,O]=x.useState(!1),[z,I]=x.useState(null),[D,w]=x.useState(""),[_,he]=x.useState(null);x.useEffect(()=>()=>{v()},[y,v]);const ne=()=>{f(!1),a("")};x.useEffect(()=>{i||(T(!0),yt(m).finally(()=>T(!1)))},[i]),x.useEffect(()=>{i&&(p("type",i==null?void 0:i.type),p("parent",i.parent),yt(I,M=>M.type!==i.type&&M.type!==i.parent))},[i,p]);const G=h("parent"),Z=()=>{d()},le=async()=>{if(i!=null&&i.type)try{await Ce.delete(`/schema/${i.ref_id}`),e(i.type),d()}catch(M){let Y=pe;if((M==null?void 0:M.status)===400){const U=await M.json();Y=U.errorCode||(U==null?void 0:U.status)||pe}else M instanceof Error&&(Y=M.message);he(Y)}finally{f(!1)}},Q=r.handleSubmit(async M=>{if(!G){O(!0);return}P(!0);try{if(M.type!==(i==null?void 0:i.type)||S().parent!==(i==null?void 0:i.parent)){const U=S().parent??(i==null?void 0:i.parent);l(!0),await Ce.put(`/schema/${i==null?void 0:i.ref_id}`,JSON.stringify({type:M.type,parent:U})),await c()}const Y=await An({...M,...i?{ref_id:i==null?void 0:i.ref_id}:{}},!!i);s({type:M.type,parent:G||"",ref_id:(i==null?void 0:i.ref_id)||Y||"new"}),Z()}catch(Y){let U=pe;if((Y==null?void 0:Y.status)===400){const re=await Y.json();U=re.errorCode||(re==null?void 0:re.status)||pe}else Y instanceof Error&&(U=Y.message);w(U)}finally{P(!1),l(!1),f(!1)}}),H=()=>N==null?void 0:N.find(M=>M.value===G),V=()=>z==null?void 0:z.find(M=>M.value===G);return o.jsxs(k,{children:[o.jsx(k,{direction:"row",justify:"flex-end",children:o.jsx($n,{"data-testid":"close-sidebar-sub-view",onClick:ne,children:o.jsx(He,{})})}),o.jsx(k,{children:o.jsx($t,{...r,children:o.jsxs("form",{id:"add-type-form",onSubmit:Q,children:[o.jsx(k,{children:i?o.jsxs(o.Fragment,{children:[o.jsxs(k,{mb:12,children:[o.jsx(k,{mb:12,children:o.jsx(q,{children:"Name"})}),o.jsx(k,{mb:12,children:o.jsx(Se,{defaultValue:i==null?void 0:i.type,id:"cy-item-name",maxLength:250,name:"type",placeholder:"Enter type name",rules:{...Pe},value:G})})]}),o.jsxs(k,{mb:12,children:[o.jsx(k,{mb:12,children:o.jsx(q,{children:"Parent"})}),o.jsx(Te,{isLoading:C||t,onSelect:M=>{p("parent",(M==null?void 0:M.value)||""),O(!1)},options:z||[],selectedValue:V()}),D&&o.jsx(De,{children:D})]})]}):o.jsxs(o.Fragment,{children:[o.jsxs(k,{mb:12,children:[o.jsx(k,{mb:12,children:o.jsx(q,{children:"Select Parent"})}),o.jsx(Te,{isLoading:C,onSelect:M=>{p("parent",(M==null?void 0:M.value)||""),O(!1)},options:N,selectedValue:H()}),g&&o.jsx(De,{children:"A parent type must be selected"})]}),o.jsxs(k,{children:[o.jsx(k,{mb:12,children:o.jsx(q,{children:"Type name"})}),o.jsx(k,{mb:12,children:o.jsx(Se,{id:"cy-item-name",maxLength:250,name:"type",placeholder:"Enter type name",rules:{...Pe},value:G})})]})]})}),o.jsx(On,{parent:i?i.type:G}),o.jsxs(k,{direction:"row",justify:"space-between",mt:20,children:[i?o.jsxs(k,{direction:"column",children:[o.jsx(_n,{color:"secondary",onClick:le,size:"large",style:{marginRight:20},variant:"contained",children:"Delete"}),_&&o.jsx(De,{children:_})]}):null,o.jsx(Me,{color:"secondary",disabled:b||g,onClick:Q,size:"large",startIcon:b?o.jsx(be,{color:R.white,size:10}):null,variant:"contained",children:"Save"})]})]})})})]})},_n=$(Me)`
  && {
    color: ${R.primaryRed};
...
`,De=$(k)`
  ...
  margin-top: 12px;
  padding-top: 20px;
`;var In=Object.defineProperty,Dn=(t,s,i)=>s in t?In(t,s,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[s]=i,j=(t,s,i)=>(Dn(t,typeof s!="symbol"?s+"":s,i),i);const ke=new co,wt=new lo,zn=Math.cos(70*(Math.PI/180)),jt=(t,s)=>(t%s+s)%s;let Rn=class extends uo{constructor(s,i){super(),j(this,"object"),j(this,"domElement"),j(this,"enabled",!0),j(this,"target",new L),j(this,"minDistance",0),j(this,"maxDistance",1/0),j(this,"minZoom",0),j(this,"maxZoom",1/0),j(this,"minPolarAngle",0),j(this,"maxPolarAngle",Math.PI),j(this,"minAzimuthAngle",-1/0),j(this,"maxAzimuthAngle",1/0),j(this,"enableDamping",!1),j(this,"dampingFactor",.05),j(this,"enableZoom",!0),j(this,"zoomSpeed",1),j(this,"enableRotate",!0),j(this,"rotateSpeed",1),j(this,"enablePan",!0),j(this,"panSpeed",1),j(this,"screenSpacePanning",!0),j(this,"keyPanSpeed",7),j(this,"zoomToCursor",!1),j(this,"autoRotate",!1),j(this,"autoRotateSpeed",2),j(this,"reverseOrbit",!1),j(this,"reverseHorizontalOrbit",!1),j(this,"reverseVerticalOrbit",!1),j(this,"keys",{LEFT:"ArrowLeft",UP:"ArrowUp",RIGHT:"ArrowRight",BOTTOM:"ArrowDown"}),j(this,"mouseButtons",{LEFT:de.ROTATE,MIDDLE:de.DOLLY,RIGHT:de.PAN}),j(this,"touches",{ONE:ue.ROTATE,TWO:ue.DOLLY_PAN}),j(this,"target0"),j(this,"position0"),j(this,"zoom0"),j(this,"_domElementKeyEvents",null),j(this,"getPolarAngle"),j(this,"getAzimuthalAngle"),j(this,"setPolarAngle"),j(this,"setAzimuthalAngle"),j(this,"getDistance"),j(this,"listenToKeyEvents"),j(this,"stopListenToKeyEvents"),j(this,"saveState"),j(this,"reset"),j(this,"update"),j(this,"connect"),j(this,"dispose"),this.object=s,this.domElement=i,this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this.getPolarAngle=()=>r.phi,this.getAzimuthalAngle=()=>r.theta,this.setPolarAngle=n=>{let u=jt(n,2*Math.PI),E=r.phi;E<0&&(E+=2*Math.PI),u<0&&(u+=2*Math.PI);let A=Math.abs(u-E);2*Math.PI-A<A&&(u<E?u+=2*Math.PI:E+=2*Math.PI),h.phi=u-E,e.update()},this.setAzimuthalAngle=n=>{let u=jt(n,2*Math.PI),E=r.theta;E<0&&(E+=2*Math.PI),u<0&&(u+=2*Math.PI);let A=Math.abs(u-E);2*Math.PI-A<A&&(u<E?u+=2*Math.PI:E+=2*Math.PI),h.theta=u-E,e.update()},this.getDistance=()=>e.object.position.distanceTo(e.target),this.listenToKeyEvents=n=>{n.addEventListener("keydown",_e),this._domElementKeyEvents=n},this.stopListenToKeyEvents=()=>{this._domElementKeyEvents.removeEventListener("keydown",_e),this._domElementKeyEvents=null},this.saveState=()=>{e.target0.copy(e.target),e.position0.copy(e.object.position),e.zoom0=e.object.zoom},this.reset=()=>{e.target.copy(e.target0),e.object.position.copy(e.position0),e.object.zoom=e.zoom0,e.object.updateProjectionMatrix(),e.dispatchEvent(a),e.update(),d=c.NONE},this.update=(()=>{const n=new L,u=new L(0,1,0),E=new lt().setFromUnitVectors(s.up,u),A=E.clone().invert(),B=new L,J=new lt,se=2*Math.PI;return function(){const at=e.object.position;E.setFromUnitVectors(s.up,u),A.copy(E).invert(),n.copy(at).sub(e.target),n.applyQuaternion(E),r.setFromVector3(n),e.autoRotate&&d===c.NONE&&G(he()),e.enableDamping?(r.theta+=h.theta*e.dampingFactor,r.phi+=h.phi*e.dampingFactor):(r.theta+=h.theta,r.phi+=h.phi);let ee=e.minAzimuthAngle,te=e.maxAzimuthAngle;isFinite(ee)&&isFinite(te)&&(ee<-Math.PI?ee+=se:ee>Math.PI&&(ee-=se),te<-Math.PI?te+=se:te>Math.PI&&(te-=se),ee<=te?r.theta=Math.max(ee,Math.min(te,r.theta)):r.theta=r.theta>(ee+te)/2?Math.max(ee,r.theta):Math.min(te,r.theta)),r.phi=Math.max(e.minPolarAngle,Math.min(e.maxPolarAngle,r.phi)),r.makeSafe(),e.enableDamping===!0?e.target.addScaledVector(v,e.dampingFactor):e.target.add(v),e.zoomToCursor&&D||e.object.isOrthographicCamera?r.radius=U(r.radius):r.radius=U(r.radius*p),n.setFromSpherical(r),n.applyQuaternion(A),at.copy(e.target).add(n),e.object.matrixAutoUpdate||e.object.updateMatrix(),e.object.lookAt(e.target),e.enableDamping===!0?(h.theta*=1-e.dampingFactor,h.phi*=1-e.dampingFactor,v.multiplyScalar(1-e.dampingFactor)):(h.set(0,0,0),v.set(0,0,0));let we=!1;if(e.zoomToCursor&&D){let me=null;if(e.object instanceof ve&&e.object.isPerspectiveCamera){const ge=n.length();me=U(ge*p);const je=ge-me;e.object.position.addScaledVector(z,je),e.object.updateMatrixWorld()}else if(e.object.isOrthographicCamera){const ge=new L(I.x,I.y,0);ge.unproject(e.object),e.object.zoom=Math.max(e.minZoom,Math.min(e.maxZoom,e.object.zoom/p)),e.object.updateProjectionMatrix(),we=!0;const je=new L(I.x,I.y,0);je.unproject(e.object),e.object.position.sub(je).add(ge),e.object.updateMatrixWorld(),me=n.length()}else console.warn("WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled."),e.zoomToCursor=!1;me!==null&&(e.screenSpacePanning?e.target.set(0,0,-1).transformDirection(e.object.matrix).multiplyScalar(me).add(e.object.position):(ke.origin.copy(e.object.position),ke.direction.set(0,0,-1).transformDirection(e.object.matrix),Math.abs(e.object.up.dot(ke.direction))<zn?s.lookAt(e.target):(wt.setFromNormalAndCoplanarPoint(e.object.up,e.target),ke.intersectPlane(wt,e.target))))}else e.object instanceof Ee&&e.object.isOrthographicCamera&&(e.object.zoom=Math.max(e.minZoom,Math.min(e.maxZoom,e.object.zoom/p)),e.object.updateProjectionMatrix(),we=!0);return p=1,D=!1,we||B.distanceToSquared(e.object.position)>y||8*(1-J.dot(e.object.quaternion))>y?(e.dispatchEvent(a),B.copy(e.object.position),J.copy(e.object.quaternion),we=!1,!0):!1}})(),this.connect=n=>{n===document&&console.error('THREE.OrbitControls: "document" should not be used as the target "domElement". Please use "renderer.domElement" instead.'),e.domElement=n,e.domElement.style.touchAction="none",e.domElement.addEventListener("contextmenu",st),e.domElement.addEventListener("pointerdown",tt),e.domElement.addEventListener("pointercancel",ot),e.domElement.addEventListener("wheel",nt)},this.dispose=()=>{var n,u,E,A,B,J;(n=e.domElement)==null||n.removeEventListener("contextmenu",st),(u=e.domElement)==null||u.removeEventListener("pointerdown",tt),(E=e.domElement)==null||E.removeEventListener("pointercancel",ot),(A=e.domElement)==null||A.removeEventListener("wheel",nt),(B=e.domElement)==null||B.ownerDocument.removeEventListener("pointermove",Ne),(J=e.domElement)==null||J.ownerDocument.removeEventListener("pointerup",Le),e._domElementKeyEvents!==null&&e._domElementKeyEvents.removeEventListener("keydown",_e)};const e=this,a={type:"change"},l={type:"start"},f={type:"end"},c={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6};let d=c.NONE;const y=1e-6,r=new dt,h=new dt;let p=1;const v=new L,S=new X,b=new X,P=new X,C=new X,T=new X,N=new X,m=new X,g=new X,O=new X,z=new L,I=new X;let D=!1;const w=[],_={};function he(){return 2*Math.PI/60/60*e.autoRotateSpeed}function ne(){return Math.pow(.95,e.zoomSpeed)}function G(n){e.reverseOrbit||e.reverseHorizontalOrbit?h.theta+=n:h.theta-=n}function Z(n){e.reverseOrbit||e.reverseVerticalOrbit?h.phi+=n:h.phi-=n}const le=(()=>{const n=new L;return function(E,A){n.setFromMatrixColumn(A,0),n.multiplyScalar(-E),v.add(n)}})(),Q=(()=>{const n=new L;return function(E,A){e.screenSpacePanning===!0?n.setFromMatrixColumn(A,1):(n.setFromMatrixColumn(A,0),n.crossVectors(e.object.up,n)),n.multiplyScalar(E),v.add(n)}})(),H=(()=>{const n=new L;return function(E,A){const B=e.domElement;if(B&&e.object instanceof ve&&e.object.isPerspectiveCamera){const J=e.object.position;n.copy(J).sub(e.target);let se=n.length();se*=Math.tan(e.object.fov/2*Math.PI/180),le(2*E*se/B.clientHeight,e.object.matrix),Q(2*A*se/B.clientHeight,e.object.matrix)}else B&&e.object instanceof Ee&&e.object.isOrthographicCamera?(le(E*(e.object.right-e.object.left)/e.object.zoom/B.clientWidth,e.object.matrix),Q(A*(e.object.top-e.object.bottom)/e.object.zoom/B.clientHeight,e.object.matrix)):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."),e.enablePan=!1)}})();function V(n){e.object instanceof ve&&e.object.isPerspectiveCamera||e.object instanceof Ee&&e.object.isOrthographicCamera?p/=n:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),e.enableZoom=!1)}function M(n){e.object instanceof ve&&e.object.isPerspectiveCamera||e.object instanceof Ee&&e.object.isOrthographicCamera?p*=n:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),e.enableZoom=!1)}function Y(n){if(!e.zoomToCursor||!e.domElement)return;D=!0;const u=e.domElement.getBoundingClientRect(),E=n.clientX-u.left,A=n.clientY-u.top,B=u.width,J=u.height;I.x=E/B*2-1,I.y=-(A/J)*2+1,z.set(I.x,I.y,1).unproject(e.object).sub(e.object.position).normalize()}function U(n){return Math.max(e.minDistance,Math.min(e.maxDistance,n))}function re(n){S.set(n.clientX,n.clientY)}function Ft(n){Y(n),m.set(n.clientX,n.clientY)}function Xe(n){C.set(n.clientX,n.clientY)}function Vt(n){b.set(n.clientX,n.clientY),P.subVectors(b,S).multiplyScalar(e.rotateSpeed);const u=e.domElement;u&&(G(2*Math.PI*P.x/u.clientHeight),Z(2*Math.PI*P.y/u.clientHeight)),S.copy(b),e.update()}function Yt(n){g.set(n.clientX,n.clientY),O.subVectors(g,m),O.y>0?V(ne()):O.y<0&&M(ne()),m.copy(g),e.update()}function Wt(n){T.set(n.clientX,n.clientY),N.subVectors(T,C).multiplyScalar(e.panSpeed),H(N.x,N.y),C.copy(T),e.update()}function Ut(n){Y(n),n.deltaY<0?M(ne()):n.deltaY>0&&V(ne()),e.update()}function Gt(n){let u=!1;switch(n.code){case e.keys.UP:H(0,e.keyPanSpeed),u=!0;break;case e.keys.BOTTOM:H(0,-e.keyPanSpeed),u=!0;break;case e.keys.LEFT:H(e.keyPanSpeed,0),u=!0;break;case e.keys.RIGHT:H(-e.keyPanSpeed,0),u=!0;break}u&&(n.preventDefault(),e.update())}function Ze(){if(w.length==1)S.set(w[0].pageX,w[0].pageY);else{const n=.5*(w[0].pageX+w[1].pageX),u=.5*(w[0].pageY+w[1].pageY);S.set(n,u)}}function Ke(){if(w.length==1)C.set(w[0].pageX,w[0].pageY);else{const n=.5*(w[0].pageX+w[1].pageX),u=.5*(w[0].pageY+w[1].pageY);C.set(n,u)}}function qe(){const n=w[0].pageX-w[1].pageX,u=w[0].pageY-w[1].pageY,E=Math.sqrt(n*n+u*u);m.set(0,E)}function Ht(){e.enableZoom&&qe(),e.enablePan&&Ke()}function Xt(){e.enableZoom&&qe(),e.enableRotate&&Ze()}function Qe(n){if(w.length==1)b.set(n.pageX,n.pageY);else{const E=$e(n),A=.5*(n.pageX+E.x),B=.5*(n.pageY+E.y);b.set(A,B)}P.subVectors(b,S).multiplyScalar(e.rotateSpeed);const u=e.domElement;u&&(G(2*Math.PI*P.x/u.clientHeight),Z(2*Math.PI*P.y/u.clientHeight)),S.copy(b)}function Je(n){if(w.length==1)T.set(n.pageX,n.pageY);else{const u=$e(n),E=.5*(n.pageX+u.x),A=.5*(n.pageY+u.y);T.set(E,A)}N.subVectors(T,C).multiplyScalar(e.panSpeed),H(N.x,N.y),C.copy(T)}function et(n){const u=$e(n),E=n.pageX-u.x,A=n.pageY-u.y,B=Math.sqrt(E*E+A*A);g.set(0,B),O.set(0,Math.pow(g.y/m.y,e.zoomSpeed)),V(O.y),m.copy(g)}function Zt(n){e.enableZoom&&et(n),e.enablePan&&Je(n)}function Kt(n){e.enableZoom&&et(n),e.enableRotate&&Qe(n)}function tt(n){var u,E;e.enabled!==!1&&(w.length===0&&((u=e.domElement)==null||u.ownerDocument.addEventListener("pointermove",Ne),(E=e.domElement)==null||E.ownerDocument.addEventListener("pointerup",Le)),to(n),n.pointerType==="touch"?Jt(n):qt(n))}function Ne(n){e.enabled!==!1&&(n.pointerType==="touch"?eo(n):Qt(n))}function Le(n){var u,E,A;it(n),w.length===0&&((u=e.domElement)==null||u.releasePointerCapture(n.pointerId),(E=e.domElement)==null||E.ownerDocument.removeEventListener("pointermove",Ne),(A=e.domElement)==null||A.ownerDocument.removeEventListener("pointerup",Le)),e.dispatchEvent(f),d=c.NONE}function ot(n){it(n)}function qt(n){let u;switch(n.button){case 0:u=e.mouseButtons.LEFT;break;case 1:u=e.mouseButtons.MIDDLE;break;case 2:u=e.mouseButtons.RIGHT;break;default:u=-1}switch(u){case de.DOLLY:if(e.enableZoom===!1)return;Ft(n),d=c.DOLLY;break;case de.ROTATE:if(n.ctrlKey||n.metaKey||n.shiftKey){if(e.enablePan===!1)return;Xe(n),d=c.PAN}else{if(e.enableRotate===!1)return;re(n),d=c.ROTATE}break;case de.PAN:if(n.ctrlKey||n.metaKey||n.shiftKey){if(e.enableRotate===!1)return;re(n),d=c.ROTATE}else{if(e.enablePan===!1)return;Xe(n),d=c.PAN}break;default:d=c.NONE}d!==c.NONE&&e.dispatchEvent(l)}function Qt(n){if(e.enabled!==!1)switch(d){case c.ROTATE:if(e.enableRotate===!1)return;Vt(n);break;case c.DOLLY:if(e.enableZoom===!1)return;Yt(n);break;case c.PAN:if(e.enablePan===!1)return;Wt(n);break}}function nt(n){e.enabled===!1||e.enableZoom===!1||d!==c.NONE&&d!==c.ROTATE||(n.preventDefault(),e.dispatchEvent(l),Ut(n),e.dispatchEvent(f))}function _e(n){e.enabled===!1||e.enablePan===!1||Gt(n)}function Jt(n){switch(rt(n),w.length){case 1:switch(e.touches.ONE){case ue.ROTATE:if(e.enableRotate===!1)return;Ze(),d=c.TOUCH_ROTATE;break;case ue.PAN:if(e.enablePan===!1)return;Ke(),d=c.TOUCH_PAN;break;default:d=c.NONE}break;case 2:switch(e.touches.TWO){case ue.DOLLY_PAN:if(e.enableZoom===!1&&e.enablePan===!1)return;Ht(),d=c.TOUCH_DOLLY_PAN;break;case ue.DOLLY_ROTATE:if(e.enableZoom===!1&&e.enableRotate===!1)return;Xt(),d=c.TOUCH_DOLLY_ROTATE;break;default:d=c.NONE}break;default:d=c.NONE}d!==c.NONE&&e.dispatchEvent(l)}function eo(n){switch(rt(n),d){case c.TOUCH_ROTATE:if(e.enableRotate===!1)return;Qe(n),e.update();break;case c.TOUCH_PAN:if(e.enablePan===!1)return;Je(n),e.update();break;case c.TOUCH_DOLLY_PAN:if(e.enableZoom===!1&&e.enablePan===!1)return;Zt(n),e.update();break;case c.TOUCH_DOLLY_ROTATE:if(e.enableZoom===!1&&e.enableRotate===!1)return;Kt(n),e.update();break;default:d=c.NONE}}function st(n){e.enabled!==!1&&n.preventDefault()}function to(n){w.push(n)}function it(n){delete _[n.pointerId];for(let u=0;u<w.length;u++)if(w[u].pointerId==n.pointerId){w.splice(u,1);return}}function rt(n){let u=_[n.pointerId];u===void 0&&(u=new X,_[n.pointerId]=u),u.set(n.pageX,n.pageY)}function $e(n){const u=n.pointerId===w[0].pointerId?w[1]:w[0];return _[u.pointerId]}i!==void 0&&this.connect(i),this.update()}};const Bn=new L,vt=x.forwardRef(function({start:s=[0,0,0],end:i=[0,0,0],mid:e,segments:a=20,...l},f){const c=x.useRef(null),[d]=x.useState(()=>new po(void 0,void 0,void 0)),y=x.useCallback((h,p,v,S=20)=>(h instanceof L?d.v0.copy(h):d.v0.set(...h),p instanceof L?d.v2.copy(p):d.v2.set(...p),v instanceof L?d.v1.copy(v):d.v1.copy(d.v0.clone().add(d.v2.clone().sub(d.v0)).add(Bn.set(0,d.v0.y-d.v2.y,0))),d.getPoints(S)),[]);x.useLayoutEffect(()=>{c.current.setPoints=(h,p,v)=>{const S=y(h,p,v);c.current.geometry&&c.current.geometry.setPositions(S.map(b=>b.toArray()).flat())}},[]);const r=x.useMemo(()=>y(s,i,e,a),[s,i,e,a]);return x.createElement(Do,F({ref:zo([c,f]),points:r},l))}),Fn=x.forwardRef(({makeDefault:t,camera:s,regress:i,domElement:e,enableDamping:a=!0,onChange:l,onStart:f,onEnd:c,...d},y)=>{const r=K(g=>g.invalidate),h=K(g=>g.camera),p=K(g=>g.gl),v=K(g=>g.events),S=K(g=>g.setEvents),b=K(g=>g.set),P=K(g=>g.get),C=K(g=>g.performance),T=s||h,N=e||v.connected||p.domElement,m=x.useMemo(()=>new Rn(T),[T]);return Ae(()=>{m.enabled&&m.update()},-1),x.useEffect(()=>(m.connect(N),()=>void m.dispose()),[N,i,m,r]),x.useEffect(()=>{const g=I=>{r(),i&&C.regress(),l&&l(I)},O=I=>{f&&f(I)},z=I=>{c&&c(I)};return m.addEventListener("change",g),m.addEventListener("start",O),m.addEventListener("end",z),()=>{m.removeEventListener("start",O),m.removeEventListener("end",z),m.removeEventListener("change",g)}},[l,f,c,m,r,S]),x.useEffect(()=>{if(t){const g=P().controls;return b({controls:m}),()=>b({controls:g})}},[t,m]),x.createElement("primitive",F({ref:y,object:m,enableDamping:a},d))});function Vn(t){const s=t+"Geometry";return x.forwardRef(({args:i,children:e,...a},l)=>x.createElement("mesh",F({ref:l},a),x.createElement(s,{attach:"geometry",args:i}),e))}const Yn=Vn("circle"),Et=t=>{const s=x.useRef();return x.useEffect(()=>{s.current=t}),s.current},oe=10,Wn=2,kt=2,Pt=10,Un=(t,s,i)=>{const l=new L().subVectors(s,t).normalize().multiplyScalar(i);return new L().addVectors(t,l)},Rt=({links:t,nodes:s})=>{const i=x.useRef(null),{camera:e}=K(),a=new L,l=new L,f=new L,c=new L,d=new L,y=new L,r=new L,h=new L;return Ae(()=>{i.current&&s&&i.current.children.forEach((p,v)=>{var g,O,z,I;const S=t[v];if(!S)return;const b=s.find(D=>D.ref_id===S.source),P=s.find(D=>D.ref_id===S.target);a.set((P==null?void 0:P.x)||0,(P==null?void 0:P.y)||0,(P==null?void 0:P.z)||0),l.set((b==null?void 0:b.x)||0,(b==null?void 0:b.y)||0,(b==null?void 0:b.z)||0);const C=p.children[0],T=p.children[1],N=p.children[2],m=p.children[3];if((P==null?void 0:P.ref_id)===(b==null?void 0:b.ref_id)){const[D,w,_]=_o(a);(g=C.setPoints)==null||g.call(C,a,_,D),(O=T.setPoints)==null||O.call(T,_,l,D),N.position.set(_.x,_.y,w.z),N.lookAt(D),N.rotateX(-Math.PI/2),m.position.set(_.x,_.y,w.z),m.lookAt(e.position)}else{r.copy(Un(l,a,oe+kt)),h.copy(a),f.lerpVectors(h,r,.5);const D=30;c.subVectors(r,h).normalize().multiplyScalar(D/2),d.subVectors(f,c),y.addVectors(f,c),(z=C.setPoints)==null||z.call(C,h,d,f),(I=T.setPoints)==null||I.call(T,y,r,f),N.position.set(r.x,r.y,r.z),N.lookAt(h),N.rotateX(-Math.PI/2),m.position.set(f.x,f.y,f.z),m.lookAt(e.position);const w=Math.atan2(r.y-h.y,r.x-h.x);w>Math.PI/2||w<-Math.PI/2?m.rotation.set(Math.PI,0,-w):m.rotation.set(0,0,w),h.distanceTo(r)<D?m.text=Re(S.edge_type,Pt):m.text=S.edge_type}})}),o.jsx("group",{ref:i,children:t.map(p=>o.jsxs("group",{children:[o.jsx(vt,{color:"white",end:[0,0,0],lineWidth:2,start:[0,0,0]}),o.jsx(vt,{color:"white",end:[0,0,0],lineWidth:2,start:[0,0,0]}),o.jsxs("mesh",{position:new L(0,0,0),children:[o.jsx("coneGeometry",{args:[Wn,kt,32]}),o.jsx("meshBasicMaterial",{color:"white"})]}),o.jsx(It,{anchorX:"center",anchorY:"middle",color:"white",fontSize:4,lineHeight:1,maxWidth:20,rotation:[0,0,0],textAlign:"center",children:Re(p.edge_type,Pt)})]},p.ref_id))})};Rt.displayName="Lines";const Gn=["#ff13c9","#5af0ff","#3233ff","#c2f0c2","#ff6666","#99ccff","#ffb3b3"],Hn=$.div`
  color: white;
