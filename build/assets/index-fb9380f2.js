import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,C as B,h as c,r as v,x as C}from"./index-ef08f87d.js";import{B as F}from"./index-44e2e7d0.js";import{u as M}from"./index-47c55900.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-2422183e.js";import{B as f,T as L,a as R}from"./index-edbbfe0a.js";import{T as x}from"./index-c348bff7.js";import"./useSlotProps-af29d3fd.js";import"./index.esm-69d1c68d.js";import"./InfoIcon-a9668fe1.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
