import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-299e7590.js";import{B as F}from"./index-e55329f0.js";import{u as M}from"./index-39d7c398.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-56bc85ec.js";import{B as f,T as R,a as L}from"./index-bf2b547c.js";import{T as x}from"./index-a299a54f.js";import"./useSlotProps-1358bf37.js";import"./index.esm-6b3a2fad.js";import"./InfoIcon-40959b24.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
