import{r as n,j as e,s as f,g as T,F as S,o as K,c as U,A as ae,p as ce,i as le,q as pe,H as de,t as ue,v as fe,f as q}from"./index-ccadd545.js";import{Universe as me}from"./index-0587d5d4.js";import{a as W,b as he,c as ge,I as xe,d as Q,e as V,u as ye}from"./index-54e99eba.js";import{M as be,V as we}from"./VolumeIcon-4c5bac6d.js";import{S as je,R as ve,s as X,M as Se}from"./index-151da9de.js";import"./index-21526dda.js";import"./VisibilityOn-6aab4d11.js";import"./SourcesTableIcon-34c09991.js";import"./NodeCircleIcon-ea5e96a6.js";import"./CheckIcon-745d458d.js";import"./DeleteNodeIcon-ac38206b.js";import"./EditNodeIcon-c919f7d0.js";import"./SearchIcon-403f6842.js";import"./SoundIcon-f384ca15.js";import"./SucessFeedBackIcon-5f51986b.js";import"./three.module-1c1ec8b9.js";import"./TextareaAutosize-e83e8f38.js";import"./index-086381ab.js";import"./index-c41120a6.js";import"./index-56498069.js";import"./ClipLoader-64524d2a.js";import"./Skeleton-5c8668bc.js";import"./Stack-05b08b14.js";import"./index-fa50d549.js";import"./FormControlLabel-2ab5b81a.js";import"./Typography-a368d4f6.js";import"./createSvgIcon-43b57de1.js";import"./isPlainObject-5ad1de38.js";function D(t){const[i,s,r]=t.split(":").map(Number);return Number((i*60*60*1e3+s*60*1e3+r*1e3).toFixed(6))}const Z=n.memo(()=>{const t=W(a=>a.isPlaying),i=W(a=>a.setIsPlaying),s=W(a=>a.setVolume),r=W(a=>a.setPlaybackSpeed),c=W(a=>a.playbackSpeed),o=W(a=>a.playerRef),[x,b]=n.useState(!1),m=[.5,1,1.5,2],g=()=>{if(o){const a=o.getCurrentTime()-15;o.seekTo(a,"seconds")}},p=()=>{if(o){const a=o.getCurrentTime()+15;o.seekTo(a,"seconds")}},j=()=>{i(!t)},d=()=>{b(!x),s(x?1:0)},h=()=>{const I=(m.indexOf(c)+1)%m.length,F=m[I];if(r(F),o){const P=o.getInternalPlayer();P&&typeof P.playbackRate<"u"&&(P.playbackRate=F)}};return e.jsxs(ke,{children:[e.jsx(Pe,{onClick:d,children:x?e.jsx(be,{}):e.jsx(we,{})}),e.jsx(Te,{onClick:g,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(Ce,{"data-testid":"play-pause-button",onClick:j,size:"small",children:t?e.jsx(he,{"data-testid":"pause-icon"}):e.jsx(ge,{"data-testid":"play-icon"})}),e.jsx(Ie,{onClick:p,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(_e,{onClick:h,children:[c,"x"]})]})});Z.displayName="Controls";const ke=f(S).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${T.BG1};
  border-radius: 40px;
