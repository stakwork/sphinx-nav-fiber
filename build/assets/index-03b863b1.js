import{r as i,j as e,s as u,g as h,F as y,o as Z,c as ee,A as pe,p as X,i as de,q as ue,H as me,t as fe,v as he}from"./index-d485b6c2.js";import{t as Y,u as F,C as ge}from"./index-41ec9e72.js";import{U as xe}from"./index-928b361f.js";import{u as P,a as ye,b as be,I as we,c as te,d as je}from"./index-eb2a6a9a.js";import{M as ve,V as ke}from"./index-a9f15ae2.js";import{S as Se,R as Ce,s as U,M as Te}from"./index-4b226799.js";import"./index-5306dbca.js";import"./string-a277709d.js";import"./index-2ec69b51.js";import"./three.module-a9c166f5.js";import"./isPlainObject-887da352.js";import"./TextareaAutosize-80cf7b85.js";import"./CheckIcon-ee5c643e.js";import"./index-402e5f68.js";import"./index-367bf172.js";import"./index-262e3d57.js";import"./ClipLoader-bd473af5.js";import"./clsx-1001a10e.js";import"./SourcesTableIcon-c0866f58.js";import"./DeleteNodeIcon-98340730.js";import"./SoundIcon-2c2de975.js";import"./SucessFeedBackIcon-9b9fd80e.js";import"./Skeleton-154f0677.js";import"./index-185adb5a.js";import"./Stack-0ca6a735.js";import"./FormControlLabel-8689a50e.js";import"./Typography-e9917f52.js";import"./createSvgIcon-fb31c78c.js";const re=i.memo(()=>{const s=P(a=>a.isPlaying),c=P(a=>a.setIsPlaying),t=P(a=>a.setVolume),r=P(a=>a.setPlaybackSpeed),l=P(a=>a.playbackSpeed),n=P(a=>a.playerRef),[p,g]=i.useState(!1),b=[.5,1,1.5,2],f=()=>{if(n){const a=n.getCurrentTime()-15;n.seekTo(a,"seconds")}},m=()=>{if(n){const a=n.getCurrentTime()+15;n.seekTo(a,"seconds")}},v=()=>{c(!s)},d=()=>{g(!p),t(p?1:0)},o=()=>{const j=(b.indexOf(l)+1)%b.length,C=b[j];if(r(C),n){const E=n.getInternalPlayer();E&&typeof E.playbackRate<"u"&&(E.playbackRate=C)}};return e.jsxs($e,{children:[e.jsx(Re,{onClick:d,children:p?e.jsx(ve,{}):e.jsx(ke,{})}),e.jsx(Ie,{onClick:f,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(Pe,{"data-testid":"play-pause-button",onClick:v,size:"small",children:s?e.jsx(ye,{"data-testid":"pause-icon"}):e.jsx(be,{"data-testid":"play-icon"})}),e.jsx(_e,{onClick:m,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(Ee,{onClick:o,children:[l,"x"]})]})});re.displayName="Controls";const $e=u(y).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${h.BG1};
  border-radius: 40px;
