import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,C as B,h as c,r as v,x as C}from"./index-75ed2023.js";import{B as F}from"./index-061fe9e0.js";import{u as M}from"./index-5c5bb66a.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-9550ec0d.js";import{B as f,T as L,a as R}from"./index-6b3c0cf2.js";import{T as x}from"./index-e9e048aa.js";import"./useSlotProps-d105a2a1.js";import"./index.esm-63a15d9b.js";import"./InfoIcon-adddb0ca.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
