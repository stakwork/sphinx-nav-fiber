import{f as m,h as c,T,j as e,F as o,C as w,r,a4 as V,E as $,D as A}from"./index-cd0b1e97.js";import{B as P}from"./index-d143d916.js";import{u as p}from"./index-355ecf0b.js";import{c as q,F as G,B,C as H}from"./react-toastify.esm-dd8bbc41.js";import{T as E}from"./index-c35025f1.js";import{S as O}from"./Skeleton-36955f1c.js";import"./index.esm-75a7e6db.js";import"./InfoIcon-54e44c70.js";const _=/^https:\/\/.*\.(png|jpg|svg)$/;function C(s){return!!_.test(s)}const W=({isValidImageUrl:s})=>e.jsxs(o,{children:[e.jsx(o,{align:"center",direction:"row",justify:"space-between",mb:18,children:e.jsx(o,{align:"center",direction:"row",children:e.jsx(Y,{children:"Edit Node"})})}),e.jsxs(o,{mb:18,children:[e.jsx(S,{style:{marginBottom:8},children:"Node Name"}),e.jsx(E,{id:"cy-topic",maxLength:50,name:"name",placeholder:"Node name",rules:{...w}})]}),e.jsxs(o,{mb:36,children:[e.jsx(S,{style:{marginBottom:8},children:"image_url"}),e.jsx(E,{id:"cy-image_url",maxLength:500,name:"image_url",placeholder:"image_url",rules:{...w,...s?{}:{pattern:{message:"Please enter a valid URL",value:_},validate:{source:C}}}})]})]}),Y=m(T)`
  font-size: 22px;
  font-weight: 600;
  font-family: 'Barlow';
`,S=m(T)`
