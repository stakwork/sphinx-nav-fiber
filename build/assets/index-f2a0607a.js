import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h as x,r as T,x as v,B as m}from"./index-691b8c4d.js";import{B}from"./index-d0f2742e.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-434dbc20.js";import{B as f,T as $,a as k}from"./index-3d13a698.js";import{T as u}from"./index-c6b11564.js";import"./useSlotProps-9e2514e4.js";import"./index.esm-b23f86d3.js";import"./InfoIcon-0b045cc0.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
