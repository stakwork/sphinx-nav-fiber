import{r as n,j as e,s as f,g as T,F as S,o as K,c as U,A as ae,p as ce,i as le,q as pe,H as de,t as ue,v as fe,f as q}from"./index-e07bb5e7.js";import{Universe as me}from"./index-10ecc80a.js";import{u as he}from"./index-b07e07a7.js";import{u as W,a as ge,b as xe,I as ye,c as Q,d as V}from"./index-d30d79c1.js";import{M as be,V as we}from"./VolumeIcon-b4a113f1.js";import{S as je,R as ve,s as X,M as Se}from"./index-d30bb8cd.js";import"./index-e47f3b09.js";import"./VisibilityOn-dcae1bc7.js";import"./SourcesTableIcon-acd8f77c.js";import"./NodeCircleIcon-091c716b.js";import"./CheckIcon-ae78e463.js";import"./DeleteNodeIcon-026d14ca.js";import"./EditNodeIcon-74db3d19.js";import"./SearchIcon-ca3b63be.js";import"./SoundIcon-98b4b42e.js";import"./SucessFeedBackIcon-8af11088.js";import"./three.module-4d3d7244.js";import"./TextareaAutosize-d50ed970.js";import"./index-4267f67e.js";import"./index-35697d19.js";import"./index-44073914.js";import"./ClipLoader-fa83eee7.js";import"./Skeleton-3b6c9129.js";import"./Stack-ea702d5a.js";import"./index-a6ab80a4.js";import"./FormControlLabel-ab8bac97.js";import"./Typography-6b5a0860.js";import"./createSvgIcon-ba964867.js";import"./isPlainObject-d9f67d91.js";function D(t){const[i,s,r]=t.split(":").map(Number);return Number((i*60*60*1e3+s*60*1e3+r*1e3).toFixed(6))}const Z=n.memo(()=>{const t=W(a=>a.isPlaying),i=W(a=>a.setIsPlaying),s=W(a=>a.setVolume),r=W(a=>a.setPlaybackSpeed),c=W(a=>a.playbackSpeed),o=W(a=>a.playerRef),[x,b]=n.useState(!1),m=[.5,1,1.5,2],g=()=>{if(o){const a=o.getCurrentTime()-15;o.seekTo(a,"seconds")}},p=()=>{if(o){const a=o.getCurrentTime()+15;o.seekTo(a,"seconds")}},j=()=>{i(!t)},d=()=>{b(!x),s(x?1:0)},h=()=>{const I=(m.indexOf(c)+1)%m.length,F=m[I];if(r(F),o){const P=o.getInternalPlayer();P&&typeof P.playbackRate<"u"&&(P.playbackRate=F)}};return e.jsxs(ke,{children:[e.jsx(Pe,{onClick:d,children:x?e.jsx(be,{}):e.jsx(we,{})}),e.jsx(Te,{onClick:g,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(Ce,{"data-testid":"play-pause-button",onClick:j,size:"small",children:t?e.jsx(ge,{"data-testid":"pause-icon"}):e.jsx(xe,{"data-testid":"play-icon"})}),e.jsx(Ie,{onClick:p,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(_e,{onClick:h,children:[c,"x"]})]})});Z.displayName="Controls";const ke=f(S).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${T.BG1};
  border-radius: 40px;
