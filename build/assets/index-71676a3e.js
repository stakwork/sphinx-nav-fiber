import{r as n,j as e,s as f,g as T,F as S,o as K,c as U,A as ae,p as ce,i as le,q as pe,H as de,t as ue,v as fe,f as q}from"./index-84587b0b.js";import{Universe as me}from"./index-28222bd7.js";import{u as he}from"./index-260d4ba1.js";import{u as W,a as ge,b as xe,I as ye,c as Q,d as V}from"./index-f2a2cc46.js";import{M as be,V as we}from"./VolumeIcon-cef1a9a1.js";import{S as je,R as ve,s as X,M as Se}from"./index-f55481fa.js";import"./index-47d2b93e.js";import"./VisibilityOn-4beb82bc.js";import"./SourcesTableIcon-400c56f2.js";import"./NodeCircleIcon-0248a864.js";import"./CheckIcon-9eafd192.js";import"./DeleteNodeIcon-3fc18938.js";import"./EditNodeIcon-4bce0b48.js";import"./SearchIcon-d01a5991.js";import"./SoundIcon-b7042f56.js";import"./SucessFeedBackIcon-e3b11636.js";import"./three.module-1c1ec8b9.js";import"./TextareaAutosize-0c083e2b.js";import"./index-bf37d98f.js";import"./index-8d793b11.js";import"./index-92507fc6.js";import"./ClipLoader-607065d5.js";import"./Skeleton-cc0ebb26.js";import"./Stack-e8d8b3fe.js";import"./index-2d960a89.js";import"./FormControlLabel-bf377359.js";import"./Typography-f12478f1.js";import"./createSvgIcon-d7ac8fdc.js";import"./isPlainObject-ad8c1ab0.js";function D(t){const[i,s,r]=t.split(":").map(Number);return Number((i*60*60*1e3+s*60*1e3+r*1e3).toFixed(6))}const Z=n.memo(()=>{const t=W(a=>a.isPlaying),i=W(a=>a.setIsPlaying),s=W(a=>a.setVolume),r=W(a=>a.setPlaybackSpeed),c=W(a=>a.playbackSpeed),o=W(a=>a.playerRef),[x,b]=n.useState(!1),m=[.5,1,1.5,2],g=()=>{if(o){const a=o.getCurrentTime()-15;o.seekTo(a,"seconds")}},p=()=>{if(o){const a=o.getCurrentTime()+15;o.seekTo(a,"seconds")}},j=()=>{i(!t)},d=()=>{b(!x),s(x?1:0)},h=()=>{const I=(m.indexOf(c)+1)%m.length,F=m[I];if(r(F),o){const P=o.getInternalPlayer();P&&typeof P.playbackRate<"u"&&(P.playbackRate=F)}};return e.jsxs(ke,{children:[e.jsx(Pe,{onClick:d,children:x?e.jsx(be,{}):e.jsx(we,{})}),e.jsx(Te,{onClick:g,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(Ce,{"data-testid":"play-pause-button",onClick:j,size:"small",children:t?e.jsx(ge,{"data-testid":"pause-icon"}):e.jsx(xe,{"data-testid":"play-icon"})}),e.jsx(Ie,{onClick:p,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(_e,{onClick:h,children:[c,"x"]})]})});Z.displayName="Controls";const ke=f(S).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${T.BG1};
  border-radius: 40px;
