import{s as v,g as q,T as z,F as n,r as x,az as $,j as e,b3 as J,b4 as K,bk as Q,B as A,bl as U,k as X,bm as Z,E as L,l as N,b2 as O,b6 as ee,n as te,bD as re,bI as ne}from"./index-1a2e2dfa.js";import{p as V}from"./index-b4a141ad.js";import{C as G}from"./ClipLoader-514d990e.js";import{e as W}from"./index-a9b5b35b.js";import{A as Y}from"./index-0f8ad1f4.js";import{c as oe}from"./index-64f1c910.js";import"./three.module-9722a9fc.js";import"./index-1ec66a13.js";import"./SourcesTableIcon-0fdd279c.js";import"./CheckIcon-9b72cbb4.js";import"./DeleteNodeIcon-c92b86fa.js";import"./SoundIcon-cd12f044.js";import"./SucessFeedBackIcon-6893c0de.js";import"./Stack-f791a033.js";import"./clsx-b097d45b.js";import"./createSvgIcon-e470db97.js";import"./TextareaAutosize-09afa932.js";const B=s=>s.charAt(0).toUpperCase()+s.slice(1).replace(/_/g," "),R=s=>s?[...s].sort((l,m)=>Number(m.required)-Number(l.required)):[],H=s=>s?s.filter(l=>l.key!=="node_key"):[],se=({handleSelectType:s,skipToStep:l,nodeType:m,selectedValues:r})=>{const[f,w]=x.useState(!1),[h,C]=x.useState(),{watch:j,formState:{isValid:t}}=$();x.useEffect(()=>{(async()=>{w(!0);const o=await U(m),T=V(o),E=H(T);C(E),w(!1)})()},[m,j]);const a=c=>c.charAt(0).toUpperCase()+c.slice(1).replace(/_/g," "),p=(h?[...h].sort((c,o)=>c.required&&!o.required?-1:!c.required&&o.required?1:0):[]).filter(c=>!!(c.required&&!Object.values(r).includes(c.key))),S=()=>{s(""),l("sourceType")},b=!t||f||p.some(c=>{var o;return c.required&&!((o=j(c.key))!=null&&o.trim())});return e.jsxs(n,{children:[e.jsx(n,{align:"center",direction:"row",justify:"space-between",mb:18,children:e.jsx(n,{align:"center",direction:"row",children:e.jsx(ae,{children:"Required Properties"})})}),e.jsx(ie,{children:f?e.jsx(n,{style:{margin:"auto"},children:e.jsx(G,{color:q.SECONDARY_BLUE})}):e.jsx(n,{className:"input__wrapper",children:p==null?void 0:p.map(({key:c,required:o})=>e.jsx(e.Fragment,{children:e.jsxs(ce,{children:[e.jsx(z,{children:a(c)}),e.jsx(J,{id:"item-name",maxLength:50,name:c,placeholder:o?"Required":"Optional",rules:{...o?{...K,pattern:{message:"No leading whitespace allowed",value:Q}}:{}}})]})}))})}),e.jsxs(n,{direction:"row",children:[e.jsx(n,{grow:1,children:e.jsx(A,{color:"secondary",onClick:S,size:"large",variant:"contained",children:"Prev"})}),e.jsx(n,{grow:1,ml:20,children:e.jsx(A,{color:"secondary",disabled:b,onClick:()=>l("createConfirmation"),size:"large",variant:"contained",children:"Next"})})]})]})},ae=v(z)`
  font-size: 22px;
  font-weight: 600;
  font-family: 'Barlow';
`,ie=v(n)`
...
`,le=({nodeType:s,onclose:l,selectedNodeType:m})=>e.jsxs(n,{children:[e.jsx(n,{mb:20,children:e.jsx(k,{children:"Confirm Type Change"})}),e.jsx(n,{mb:25,children:e.jsxs(k,{children:["From: ",m]})}),e.jsx(n,{mb:25,children:e.jsxs(k,{children:["To: ",s]})}),e.jsxs(n,{direction:"row",children:[e.jsx(n,{grow:1,children:e.jsx(A,{color:"secondary",onClick:l,size:"large",variant:"contained",children:"Cancel"})}),e.jsx(n,{grow:1,ml:20,children:e.jsx(A,{color:"secondary",size:"large",type:"submit",variant:"contained",children:"Confirm"})})]})]}),k=v(z)`
  font-size: 22px;
  font-weight: 600;
  font-family: 'Barlow';
`,pe=({handleSelectType:s,skipToStep:l,selectedNodeType:m,nodeType:r,selectedValues:f,setSelectedValues:w})=>{const[h,C]=x.useState(!1),[j,t]=x.useState(),[a,i]=x.useState(),{watch:p}=$();x.useEffect(()=>{const d=async(u,y)=>{C(!0);const g=await U(u),F=V(g),_=H(F);y(_),C(!1)};r&&d(r,t),m&&d(m,i)},[r,m,p]);const S=x.useMemo(()=>R(j),[j]),b=x.useMemo(()=>R(a),[a]),c=()=>{s(""),l("sourceType")};x.useEffect(()=>{if(j&&a){const d=a.reduce((u,y)=>{const g=j.find(F=>F.key===y.key);return u[y.key]=g?y.key:"none",u},{});w(d)}},[j,a,w]);const o=(d,u)=>{w(y=>({...y,[d]:u}))},T=()=>{const d=S.every(({key:u,required:y})=>!y||y&&f[u]&&f[u]!=="none");l(d?"createConfirmation":"requiredProperties")},E=x.useMemo(()=>b.map(({key:d})=>{const u=f[d]||"none",y=S.filter(g=>!Object.values(f).includes(g.key)||g.key===u).map(g=>({label:B(g.key),value:g.key}));return y.unshift({label:"None",value:"none"}),{key:d,autoCompleteOptions:y,selectedValue:u}}),[b,S,f]);return e.jsxs(n,{children:[e.jsx(n,{align:"center",direction:"row",justify:"space-between",mb:18,children:e.jsx(n,{align:"center",direction:"row",children:e.jsx(de,{children:"Map Properties"})})}),e.jsx(ue,{children:h?e.jsx(n,{style:{margin:"auto"},children:e.jsx(G,{color:q.lightGray})}):e.jsxs(me,{children:[e.jsxs(xe,{children:[e.jsx(I,{children:B(m)}),b.map(({key:d})=>e.jsx(fe,{children:e.jsx(z,{children:B(d)})},d))]}),e.jsxs(he,{children:[e.jsx(I,{children:B(r)}),E.map(({key:d,autoCompleteOptions:u,selectedValue:y})=>e.jsx(n,{children:e.jsx(Y,{isLoading:h,onSelect:g=>o(d,g?g.value:"none"),options:u,selectedValue:u.find(g=>g.value===y)})},d))]})]})}),e.jsxs(n,{direction:"row",children:[e.jsx(n,{grow:1,children:e.jsx(A,{color:"secondary",onClick:c,size:"large",variant:"contained",children:"Prev"})}),e.jsx(n,{grow:1,ml:20,children:e.jsx(A,{color:"secondary",disabled:h,onClick:T,size:"large",variant:"contained",children:"Next"})})]})]})},de=v(z)`
  font-size: 22px;
  font-weight: 600;
  font-family: 'Barlow';
`,ue=v(n)`
