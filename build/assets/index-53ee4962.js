import{f as y,h as w,F as t,T as S,x as M,r as f,j as e,bd as V,be as W,C as z,b1 as H,I as K,b3 as Q,i as X,b2 as N,U as I,bi as Z,o as ee,bg as te}from"./index-769d9852.js";import{B as T,C as O,i as se,c as oe,F as ne}from"./react-toastify.esm-6379dc0c.js";import{B as re}from"./index-53820041.js";import{u as F}from"./index-24be33dd.js";import{S as ie}from"./index-5fba9d48.js";import{g as ae}from"./index.esm-22585c24.js";import{C as ce}from"./CheckIcon-fb470be5.js";import{p as le}from"./index-30d16895.js";import{T as E}from"./index-87285af1.js";import{A as de}from"./index-dc9e980b.js";import{d as pe,i as me}from"./index-cfda11fa.js";import"./InfoIcon-e424ef9e.js";import"./index-b9ec1c99.js";import"./Popover-111cf632.js";import"./useSlotProps-88e99761.js";import"./Popper-24a78320.js";import"./generateCategoricalChart-a1187b0d.js";import"./NoFilterResultIcon-2692a530.js";import"./index-8a3051c0.js";import"./index-87ff0657.js";import"./PlusIcon-6bb73f18.js";const xe=({onClick:s,loading:p,error:c})=>{const u=M(i=>i.budget),[x,o]=f.useState(10),a="node";return f.useEffect(()=>{(async()=>{try{const h=await W(a);o(h.data.price)}catch(h){console.error("cannot fetch",h)}})()},[a]),e.jsxs(t,{children:[e.jsx(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:e.jsx(t,{align:"center",direction:"row",children:e.jsx(fe,{children:"Approve Cost"})})}),e.jsxs(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:[e.jsxs(ue,{children:[e.jsx("div",{className:"title",children:"COST"}),e.jsxs("div",{className:"value","data-testid":"check-price",children:[x," sats"]})]}),e.jsxs(he,{children:[e.jsx("div",{className:"title",children:"BUDGET"}),e.jsxs("div",{className:"value",children:[V(u)," sats"]})]})]}),e.jsx(t,{children:e.jsx(T,{color:"secondary","data-testid":"check-icon",disabled:p||!!c,onClick:s,size:"large",startIcon:p?e.jsx(O,{size:24}):e.jsx(ce,{}),type:"submit",variant:"contained",children:"Approve"})}),c?e.jsxs(ge,{role:"tooltip",children:[e.jsxs(ye,{children:[e.jsx(ae,{fontSize:13}),e.jsx("span",{children:c})]}),e.jsx("div",{className:"tooltip",children:c})]}):null]})},ue=y(t).attrs({direction:"column",align:"space-between",justify:"flex-start"})`
  width: 141px;
  height: 61px;
