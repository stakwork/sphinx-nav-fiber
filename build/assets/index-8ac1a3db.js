import{s as r,F as s,T as m,j as e,b as w,c as u,r as T,u as B,f as A}from"./index-912a006b.js";import{B as F}from"./index-a8906cb4.js";import{u as G}from"./index-c8b55d33.js";import{u as M,M as $,k as v,b as g,q as k,F as C,C as D}from"./react-toastify.esm-5fb76b52.js";import{B as b,T as z,a as L}from"./index-0156e352.js";import{T as x}from"./index-65abfc9f.js";import"./useSlotProps-4d777221.js";import"./index.esm-b4803265.js";import"./InfoIcon-600b59a0.js";const P=({onClose:n})=>{const[i]=M(a=>[a.graphStyle]),o=()=>{localStorage.setItem("graphStyle",i),n()};return e.jsxs(R,{direction:"column",children:[e.jsx(V,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(s,{mt:308,children:e.jsx(b,{kind:"big",onClick:o,children:"Save changes"})})]})},R=r(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,V=r(m)`
