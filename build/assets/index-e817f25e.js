import{r as n,j as e,s as f,g as T,F as S,o as K,c as U,A as ae,p as ce,i as le,q as pe,H as de,t as ue,v as fe,f as q}from"./index-773fe714.js";import{Universe as me}from"./index-464f93a1.js";import{u as he}from"./index-797920cb.js";import{u as W,a as ge,b as xe,I as ye,c as Q,d as V}from"./index-931729be.js";import{M as be,V as we}from"./VolumeIcon-c8166714.js";import{S as je,R as ve,s as X,M as Se}from"./index-e99cebe6.js";import"./index-23bd6c58.js";import"./VisibilityOn-7447c145.js";import"./SourcesTableIcon-1df61d3e.js";import"./NodeCircleIcon-349d9ab6.js";import"./CheckIcon-9de632ab.js";import"./DeleteNodeIcon-8dd1425f.js";import"./EditNodeIcon-3f2f22da.js";import"./SearchIcon-e0420f8b.js";import"./SoundIcon-fe03f442.js";import"./SucessFeedBackIcon-8f2ee5a9.js";import"./three.module-4d3d7244.js";import"./TextareaAutosize-b0eaa8d6.js";import"./index-6a5cffd1.js";import"./index-342f7e2e.js";import"./index-263148aa.js";import"./ClipLoader-5244711f.js";import"./Skeleton-0029b171.js";import"./Stack-4d6145ac.js";import"./index-5efdc782.js";import"./FormControlLabel-e5d47133.js";import"./Typography-bb2e46e0.js";import"./createSvgIcon-6dcef5af.js";import"./isPlainObject-a2228b46.js";function D(t){const[i,s,r]=t.split(":").map(Number);return Number((i*60*60*1e3+s*60*1e3+r*1e3).toFixed(6))}const Z=n.memo(()=>{const t=W(a=>a.isPlaying),i=W(a=>a.setIsPlaying),s=W(a=>a.setVolume),r=W(a=>a.setPlaybackSpeed),c=W(a=>a.playbackSpeed),o=W(a=>a.playerRef),[x,b]=n.useState(!1),m=[.5,1,1.5,2],g=()=>{if(o){const a=o.getCurrentTime()-15;o.seekTo(a,"seconds")}},p=()=>{if(o){const a=o.getCurrentTime()+15;o.seekTo(a,"seconds")}},j=()=>{i(!t)},d=()=>{b(!x),s(x?1:0)},h=()=>{const I=(m.indexOf(c)+1)%m.length,F=m[I];if(r(F),o){const P=o.getInternalPlayer();P&&typeof P.playbackRate<"u"&&(P.playbackRate=F)}};return e.jsxs(ke,{children:[e.jsx(Pe,{onClick:d,children:x?e.jsx(be,{}):e.jsx(we,{})}),e.jsx(Te,{onClick:g,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(Ce,{"data-testid":"play-pause-button",onClick:j,size:"small",children:t?e.jsx(ge,{"data-testid":"pause-icon"}):e.jsx(xe,{"data-testid":"play-icon"})}),e.jsx(Ie,{onClick:p,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(_e,{onClick:h,children:[c,"x"]})]})});Z.displayName="Controls";const ke=f(S).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${T.BG1};
  border-radius: 40px;
