import{s as i,a as t,F as c,j as e,e as j,r as l,u as $,B as w,bu as C,bv as R,aZ as I}from"./index-05b5ccb4.js";import{aT as T,h as z,p as D}from"./index-defaf9d2.js";import{S as E}from"./Skeleton-ae5168f6.js";import{C as L}from"./ClipLoader-1e8f69ba.js";const G=({nodeName:p})=>e.jsx(c,{children:e.jsxs(c,{align:"center",direction:"column",justify:"space-between",children:[e.jsx(A,{children:e.jsx(T,{})}),e.jsxs(M,{children:["Are you sure you want to delete ",p||"this item","?"]})]})}),M=i(c)`
  color: ${t.white};
  font-family: 'Barlow';
  font-size: 20px;
  font-weight: 400;
