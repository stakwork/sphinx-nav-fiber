import{f as m,h as c,T,j as e,F as o,C as w,r,a4 as V,E as $,D as A}from"./index-6e8bad83.js";import{B as P}from"./index-ca94c6d7.js";import{u as p}from"./index-3b4e56fc.js";import{c as q,F as G,B,C as H}from"./react-toastify.esm-3a360dcb.js";import{T as E}from"./index-19b3fdb0.js";import{S as O}from"./Skeleton-151964c4.js";import"./index.esm-bc67c355.js";import"./InfoIcon-3467a98d.js";const _=/^https:\/\/.*\.(png|jpg|svg)$/;function C(s){return!!_.test(s)}const W=({isValidImageUrl:s})=>e.jsxs(o,{children:[e.jsx(o,{align:"center",direction:"row",justify:"space-between",mb:18,children:e.jsx(o,{align:"center",direction:"row",children:e.jsx(Y,{children:"Edit Node"})})}),e.jsxs(o,{mb:18,children:[e.jsx(S,{style:{marginBottom:8},children:"Node Name"}),e.jsx(E,{id:"cy-topic",maxLength:50,name:"name",placeholder:"Node name",rules:{...w}})]}),e.jsxs(o,{mb:36,children:[e.jsx(S,{style:{marginBottom:8},children:"image_url"}),e.jsx(E,{id:"cy-image_url",maxLength:500,name:"image_url",placeholder:"image_url",rules:{...w,...s?{}:{pattern:{message:"Please enter a valid URL",value:_},validate:{source:C}}}})]})]}),Y=m(T)`
  font-size: 22px;
  font-weight: 600;
  font-family: 'Barlow';
`,S=m(T)`
