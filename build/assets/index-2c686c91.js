...
`,ir=v.lazy(()=>ke(()=>import("./index-e580ca83.js"),["assets/index-e580ca83.js","assets/index-90b40932.js","assets/index-b4d03b7b.css","assets/index-0779cd2a.js","assets/SourcesTableIcon-c2ca82b7.js","assets/index-e704322b.js","assets/CheckIcon-c876fcd0.js","assets/DeleteNodeIcon-14b8d438.js","assets/SoundIcon-5b4925f1.js","assets/SucessFeedBackIcon-1e3cdd17.js","assets/ClipLoader-b126851a.js","assets/TableRow-415399df.js"]).then(({TweetAnalyze:e})=>({default:e}))),ar=()=>{const e=$(o=>o.setSelectedTweet),t=$(o=>o.selectedTweet),{tweetId:a}=fe(),[r,n]=v.useState(""),{open:i}=De("tweetAnalyze"),l=(a==null?void 0:a.split("&"))||[],c=o=>{i(),n(o)};return s.jsxs(or,{align:"stretch",basis:"100%",grow:1,shrink:1,children:[l.length>1?s.jsx(sr,{onClick:()=>{c("summary")},children:"Summary Report"}):null,l.map(o=>s.jsx(cr,{className:t===o?"selected":"",onClick:()=>e(o),children:s.jsx(Vt,{handleAnalyzeClick:()=>{c(o)},nodeId:o})},o)),s.jsx(ir,{tweetId:r})]})},sr=f.button`
  width: 100%;
  background: ${y.ANALYTICS_CARD_BG};
  color: ${y.white};
  padding: 16px 16px;
