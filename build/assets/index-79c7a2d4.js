import{s as i,a as t,F as c,j as e,e as j,r as l,u as $,B as w,bu as C,bw as R,aZ as z}from"./index-208bba45.js";import{az as I,f as D,l as E}from"./index-5582130e.js";import{S as L}from"./Skeleton-316051e7.js";import{C as T}from"./ClipLoader-4680bbf8.js";const G=({nodeName:p})=>e.jsx(c,{children:e.jsxs(c,{align:"center",direction:"column",justify:"space-between",children:[e.jsx(A,{children:e.jsx(I,{})}),e.jsxs(M,{children:["Are you sure you want to delete ",p||"this item","?"]})]})}),M=i(c)`
  color: ${t.white};
  font-family: 'Barlow';
  font-size: 20px;
  font-weight: 400;
