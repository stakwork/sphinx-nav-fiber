...
`,rr=b.lazy(()=>De(()=>import("./index-818f1810.js"),["assets/index-818f1810.js","assets/index-042300e8.js","assets/index-b4d03b7b.css","assets/index-f91efa52.js","assets/SourcesTableIcon-3e95cc08.js","assets/index-c359d33b.js","assets/CheckIcon-d38df98b.js","assets/DeleteNodeIcon-8fceabfe.js","assets/SoundIcon-28291abe.js","assets/SucessFeedBackIcon-8c59e050.js","assets/ClipLoader-8d568c68.js","assets/TableRow-1ca3c4ea.js"]).then(({TweetAnalyze:e})=>({default:e}))),nr=()=>{const e=O(p=>p.setSelectedTweet),t=O(p=>p.selectedTweet),{tweetId:a}=ge(),[r,n]=b.useState(""),{open:i}=Re("tweetAnalyze"),l=(a==null?void 0:a.split("&"))||[],o=p=>{i(),n(p)};return s.jsx(s.Fragment,{children:s.jsxs(ar,{align:"stretch",basis:"100%",grow:1,shrink:1,children:[l.length>1?s.jsx(ir,{onClick:()=>{o("summary")},children:"Summary Report"}):null,l.map(p=>s.jsx(sr,{className:t===p?"selected":"",onClick:()=>e(p),children:s.jsx(Gt,{handleAnalyzeClick:()=>{o(p)},nodeId:p})},p)),s.jsx(rr,{tweetId:r})]})})},ir=h.button`
  width: 100%;
  background: ${x.ANALYTICS_CARD_BG};
  color: ${x.white};
  padding: 16px 16px;
