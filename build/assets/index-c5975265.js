import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,C as B,h as c,r as v,x as C}from"./index-1334f63c.js";import{B as F}from"./index-77e9d3fa.js";import{u as M}from"./index-09ba0aa8.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-c0b4df14.js";import{B as f,T as L,a as R}from"./index-c3515a88.js";import{T as x}from"./index-be4ef23b.js";import"./useSlotProps-d8ce2c91.js";import"./index.esm-cd7d1f4d.js";import"./InfoIcon-ed7d30eb.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
