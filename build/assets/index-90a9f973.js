import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-250def76.js";import{B}from"./index-170d05c7.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-6411ef97.js";import{B as f,T as $,a as k}from"./index-882edfa2.js";import{T as u}from"./index-ad0b45db.js";import"./useSlotProps-80fa8401.js";import"./index.esm-bb22e3c3.js";import"./InfoIcon-0963be15.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
