import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-26ac0dae.js";import{B as F}from"./index-04182e17.js";import{u as M}from"./index-4844e4b5.js";import{j as $,e as k,F as D,C as G}from"./react-toastify.esm-22478e2f.js";import{B as f,T as R,a as L}from"./index-9c16b9df.js";import{T as x}from"./index-cd3cddf6.js";import"./useSlotProps-dc95fabe.js";import"./index.esm-1b8c4fc1.js";import"./InfoIcon-c29a86af.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
