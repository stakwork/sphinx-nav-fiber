import{bz as C,ac as v,ab as b,bA as I,aa as E,bB as U,bC as G,Q as x,S as l,N as D,r as h,j as e,U as n,bD as J,a5 as j,bE as Q,ar as X,ad as ee,bF as p,aw as te,ag as se,bG as ne,ay as oe,ax as re,az as ie,b0 as ae}from"./index-913b9948.js";import{B as w,ai as ce,ab as le,aN as de,aK as B,af as ue,aG as xe,ag as ge}from"./index-1a8501fe.js";import{S as he}from"./index-909925f8.js";const R=/\b(?:twitter\.com|x\.com)\/(?:@)?([\w_]+)(?:$|\?[^/]*$)/,fe=/(https?:\/\/)?(www\.)?youtube\.com\/watch\?v=([A-Za-z0-9_-]+)/,pe=/(https?:\/\/)?(www\.)?youtube\.com\/live\/([A-Za-z0-9_-]+)/,we=/(https?:\/\/)?(www\.)?youtu\.be\/([A-Za-z0-9_-]+)/,me=/https:\/\/twitter\.com\/i\/spaces\/([A-Za-z0-9_-]+)/,be=/https:\/\/(twitter\.com|x\.com)\/[^/]+\/status\/(\d+)/,je=/(https?:\/\/)?([A-Za-z0-9_-]+)\.mp3/,ye=/(https?:\/\/)?(.*\.)?.+\/(feed|rss|rss.xml|.*.rss|.*\?(feed|format)=rss)$/,Se=/https?:\/\/(www\.)?youtube\.com\/(user\/)?(@)?([\w-]+)/,ve=/^(https?|ftp):\/\/[^\s/$.?#].[^\s]*$/,Ee=/https:\/\/twitter\.com\/i\/broadcasts\/([A-Za-z0-9_-]+)/;function _e(t){return[pe,Ee,fe,we,me,je].some(i=>i.test(t))?C:Se.test(t)?v:R.test(t)?b:be.test(t)?I:ye.test(t)?E:ve.test(t)?U:G}const $e=(t,s="")=>{const o=(s===b?R:/@(\w+)/).exec(t);return o?o[1]:null},N=t=>!!t&&[b,v,E].includes(t),ze=({onClick:t,loading:s,type:i,error:o})=>{const r=D(u=>u.budget),[g,d]=h.useState(10),a=N(i)?"radar":"add_node";return h.useEffect(()=>{(async()=>{try{const c=await Q(a);d(c.data.price)}catch(c){console.error("cannot fetch",c)}})()},[a]),e.jsxs(n,{children:[e.jsx(n,{align:"center",direction:"row",justify:"space-between",mb:20,children:e.jsx(n,{align:"center",direction:"row",children:e.jsx(Ce,{children:"Approve Cost"})})}),e.jsxs(n,{align:"center",direction:"row",justify:"space-between",mb:20,children:[e.jsxs(ke,{children:[e.jsx("div",{className:"title",children:"COST"}),e.jsxs("div",{className:"value","data-testid":"check-price",children:[g," sats"]})]}),e.jsxs(Be,{children:[e.jsx("div",{className:"title",children:"BUDGET"}),e.jsxs("div",{className:"value",children:[J(r)," sats"]})]})]}),e.jsx(n,{children:e.jsx(w,{color:"secondary","data-testid":"check-icon",disabled:s||!!o,onClick:t,size:"large",startIcon:s?e.jsx(P,{children:e.jsx(ce,{color:l.lightGray,size:12})}):e.jsxs(P,{children:[" ",e.jsx(le,{})]}),type:"submit",variant:"contained",children:"Approve"})}),o?e.jsx(Ne,{children:e.jsxs(Re,{children:[e.jsx(de,{className:"errorIcon"}),e.jsx("span",{children:o})]})}):null]})},ke=x(n).attrs({direction:"column",align:"space-between",justify:"flex-start"})`
  width: 141px;
  height: 61px;
...
`,F=async(t,s,i)=>{const o=N(s)?"radar":"add_node",r={};if(s===C)r.media_url=t.source,r.content_type="audio_video";else if(s===I){if(/(?:https?:\/\/)?(?:www\.)?(twitter|x)\.com\/\w+\/status\/(\d+)/s.test(t.source)){const u=/\/status\/(\d+)/,c=t.source.match(u);if(c!=null&&c[1]){const[,y]=c;r.tweet_id=y}}else r.tweet_id=t.source;r.content_type="tweet"}else if(s===U)r.content_type="webpage",r.web_page=t.source;else if(s===G)r.content_type="document",r.text=t.source;else if(s===b){const[,a]=(t.source||"").match(R)||[];if(a)r.source=a,r.source_type=s;else return}else(s===v||s===E)&&(r.source=t.source,r.source_type=s);t.latitude&&t.longitude&&(r.latitude=t.latitude,r.longitude=t.longitude);let g="",d;te?d=await ne.enable():d=await se.enable(),r.pubkey=d==null?void 0:d.pubkey,g=await oe();try{const a=await re.post(`/${o}`,JSON.stringify(r),{Authorization:g});if(a.error){const{message:u}=a.error;throw new Error(u)}}catch(a){if(a.status===402)await ie(i),await ae(i),await F(t,s,i);else{let u=p;if(a.status===400)try{const c=await a.json();u=c.message||c.status||(c==null?void 0:c.errorCode)||p}catch{u=p}else a instanceof Error&&(u=a.message||p);throw new Error(u)}}},nt=()=>{const[t,s]=h.useState(0),{close:i,visible:o}=ee("addContent"),[r]=D($=>[$.setBudget]),g=ue({mode:"onChange"}),{watch:d,setValue:a,reset:u}=g,[c,y]=h.useState(!1),[M,A]=h.useState("");h.useEffect(()=>()=>{A(""),s(0),u()},[o,u]);const m=d("inputType"),L=d("source"),W=d("longitude"),V=d("latitude"),T=d("source"),Y=Z(L);h.useEffect(()=>{a("inputType",_e(T))},[T,a]);const q=()=>{i()},_=()=>{s(t+1)},H=()=>{s(t-1)},K=g.handleSubmit(async $=>{y(!0);try{await F($,m,r),he("Content Added"),q()}catch(f){let z=p;if((f==null?void 0:f.status)===400){const S=await f.json();z=S.errorCode||(S==null?void 0:S.status)||p}else f instanceof Error&&(z=f.message);A(String(z))}finally{y(!1)}});return e.jsx(xe,{id:"addContent",kind:"small",onClose:i,preventOutsideClose:!0,children:e.jsx(ge,{...g,children:e.jsxs("form",{id:"add-node-form",onSubmit:K,children:[t===0&&e.jsx(Ve,{allowNextStep:Y,onNextStep:_,type:m}),t===1&&e.jsx(e.Fragment,{children:N(m)?e.jsx(qe,{onNextStep:_,onPrevStep:H,type:m,value:L}):e.jsx(Ie,{form:g,latitude:V,longitude:W,onNextStep:_})}),t===2&&e.jsx(ze,{error:M,loading:c,onClick:()=>null,type:m})]})})})};export{nt as AddContentModal};
