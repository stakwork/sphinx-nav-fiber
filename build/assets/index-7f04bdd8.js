...
`,rr=b.lazy(()=>De(()=>import("./index-40390d22.js"),["assets/index-40390d22.js","assets/index-8452208a.js","assets/index-b4d03b7b.css","assets/index-fba206b7.js","assets/SourcesTableIcon-cf08c1a0.js","assets/index-ee8e2aa0.js","assets/CheckIcon-89a39472.js","assets/DeleteNodeIcon-848e0e4c.js","assets/SoundIcon-f8446ca1.js","assets/SucessFeedBackIcon-7f77f21b.js","assets/ClipLoader-1b2e01da.js","assets/TableRow-c03dd08e.js"]).then(({TweetAnalyze:e})=>({default:e}))),nr=()=>{const e=O(p=>p.setSelectedTweet),t=O(p=>p.selectedTweet),{tweetId:a}=ge(),[r,n]=b.useState(""),{open:i}=Re("tweetAnalyze"),l=(a==null?void 0:a.split("&"))||[],o=p=>{i(),n(p)};return s.jsx(s.Fragment,{children:s.jsxs(ar,{align:"stretch",basis:"100%",grow:1,shrink:1,children:[l.length>1?s.jsx(ir,{onClick:()=>{o("summary")},children:"Summary Report"}):null,l.map(p=>s.jsx(sr,{className:t===p?"selected":"",onClick:()=>e(p),children:s.jsx(Gt,{handleAnalyzeClick:()=>{o(p)},nodeId:p})},p)),s.jsx(rr,{tweetId:r})]})})},ir=h.button`
  width: 100%;
  background: ${x.ANALYTICS_CARD_BG};
  color: ${x.white};
  padding: 16px 16px;
