import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-25ff8c5b.js";import{B as M}from"./index-39363332.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-efd20f3a.js";import{B as f,T as L,a as R}from"./index-879c83d4.js";import{T as x}from"./index-b400a8e4.js";import"./useSlotProps-4463c482.js";import"./index.esm-3976a41d.js";import"./InfoIcon-3ed5933c.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
