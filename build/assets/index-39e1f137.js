import{s as r,F as n,T as g,j as e,h as w,b as c,r as A,g as B}from"./index-46d141aa.js";import{B as v}from"./index-46fe460b.js";import{u as F}from"./index-d3539116.js";import{e as M,X as $,t as C,h as b,z as D,F as k,C as G}from"./react-toastify.esm-b72bdd97.js";import{B as f,T as R,a as z}from"./index-8235a399.js";import{T as x}from"./index-029e5c8b.js";import"./useSlotProps-ef777a65.js";import"./index.esm-9dacb6fc.js";import"./InfoIcon-b93d2538.js";const L=({onClose:s})=>{const[a]=M(t=>[t.graphStyle]),i=()=>{localStorage.setItem("graphStyle",a),s()};return e.jsxs(P,{direction:"column",children:[e.jsx(V,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:i,children:"Save changes"})})]})},P=r(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,V=r(g)`
