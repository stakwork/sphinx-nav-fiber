import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-3d529579.js";import{B as F}from"./index-fecb082c.js";import{u as M}from"./index-d711a7c6.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-78a3d92b.js";import{B as f,T as R,a as L}from"./index-617bf2cf.js";import{T as x}from"./index-a6815892.js";import"./useSlotProps-222b5b1d.js";import"./index.esm-857085de.js";import"./InfoIcon-37ad32a2.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
