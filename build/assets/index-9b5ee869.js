import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-424b4312.js";import{B as M}from"./index-802ba261.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-ecfee1d0.js";import{B as f,T as L,a as R}from"./index-58f2a380.js";import{T as x}from"./index-e2daefe8.js";import"./useSlotProps-de1f26a0.js";import"./index.esm-43956ff5.js";import"./InfoIcon-ff1ffccb.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
