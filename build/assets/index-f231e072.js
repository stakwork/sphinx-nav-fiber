import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,x as D,B as F}from"./index-12ff6bcc.js";import{B as M}from"./index-38368720.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-6640765e.js";import{B as f,T as L,a as R}from"./index-a89dae4a.js";import{T as x}from"./index-03247c12.js";import"./useSlotProps-96fdb33b.js";import"./index.esm-5ff6ef30.js";import"./InfoIcon-8fb68dab.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
