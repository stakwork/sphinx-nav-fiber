import{s as r,F as n,T as g,j as e,B as b,b as w,c as p,r as A,u as B}from"./index-63250ce8.js";import{B as v}from"./index-a35ac1b8.js";import{u as F}from"./index-d14291b1.js";import{u as M,l as $,b as f,q as C,F as D}from"./react-toastify.esm-47c4d49e.js";import{G}from"./index-02dae95d.js";import{T as x}from"./index-154e6f7a.js";import{C as k}from"./ClipLoader-14f8878e.js";import{T as R,a as L}from"./Tabs-cb9a7c92.js";import"./index.esm-e5a952b5.js";import"./InfoIcon-814ef8a2.js";import"./useSlotProps-76a0b95d.js";const P=({onClose:s})=>{const[a]=M(t=>[t.graphStyle]),i=()=>{localStorage.setItem("graphStyle",a),s()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(G,{}),e.jsx(n,{mt:308,children:e.jsx(b,{kind:"big",onClick:i,children:"Save changes"})})]})},V=r(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=r(g)`
