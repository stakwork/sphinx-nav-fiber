import{Y as i,X as s,Z as b,j as e,ab as h,a0 as p,r as A,a1 as M}from"./index-905a8f83.js";import{aA as v,cf as $,cg as j,ch as k,aK as y,ci as B,cj as D,ck as x,aS as C,cl as F,cm as G,u as L,ca as R}from"./index-0c145e9c.js";const P=({onClose:a})=>{const[n]=v(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",n),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(s,{mt:308,children:e.jsx(j,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(b)`
