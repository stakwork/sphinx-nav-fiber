import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,C as B,h as c,r as v,x as C}from"./index-7731e15f.js";import{B as F}from"./index-434f5d73.js";import{u as M}from"./index-22980c99.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-6d93bcb9.js";import{B as f,T as L,a as R}from"./index-d252726d.js";import{T as x}from"./index-1b1d8084.js";import"./useSlotProps-8ec9e42a.js";import"./index.esm-02511f32.js";import"./InfoIcon-2db118f8.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
