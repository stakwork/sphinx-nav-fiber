import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,x as D,B as F}from"./index-58d1ac52.js";import{B as M}from"./index-bd7f0f5d.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-d30eefbb.js";import{B as f,T as L,a as R}from"./index-8159c227.js";import{T as x}from"./index-ecd38180.js";import"./useSlotProps-1d301f31.js";import"./index.esm-864f7b20.js";import"./InfoIcon-d983fb82.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
