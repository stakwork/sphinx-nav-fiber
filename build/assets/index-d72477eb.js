import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-b6108083.js";import{B}from"./index-39729091.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-c0530dd4.js";import{B as f,T as $,a as k}from"./index-dd4138e9.js";import{T as u}from"./index-ac63d031.js";import"./useSlotProps-6dadf3cc.js";import"./index.esm-b73d5dc3.js";import"./InfoIcon-7ccedac5.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
