import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-0be95a0b.js";import{B as M}from"./index-63adb6de.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-8047c6c1.js";import{B as f,T as L,a as R}from"./index-c69ff232.js";import{T as x}from"./index-d97174fd.js";import"./useSlotProps-2df1bc54.js";import"./index.esm-576dc558.js";import"./InfoIcon-036e38f2.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
