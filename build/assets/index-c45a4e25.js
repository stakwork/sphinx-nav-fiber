import{s as c,g as N,T as F,F as s,y as x,k as W,r as d,j as e,b4 as k,b5 as P,l as V,c as G,n as q,B as _,bE as H,bF as Y,b7 as J}from"./index-73e2b65b.js";import{f as I}from"./index-95005c71.js";import{T as K,a0 as Q}from"./index-5dc36765.js";import{S as X}from"./Skeleton-f5b4af25.js";import{C as Z}from"./ClipLoader-6cf32f5e.js";import"./SourcesTableIcon-6108b94d.js";import"./CheckIcon-e97ebd70.js";import"./DeleteNodeIcon-ca556ff4.js";import"./SoundIcon-583f294d.js";import"./SucessFeedBackIcon-f00718dd.js";const ee=/^https:\/\/\S+\.(png|jpe?g|svg)$/;function te(i){return!!ee.test(i)}function oe(i){return i.split("_").map(p=>p.charAt(0).toUpperCase()+p.slice(1)).join(" ")}const ae=()=>{const{open:i}=x("changeNodeType"),{close:p}=x("editNodeName"),{changeNodeTypeFeatureFlag:y}=W(a=>({changeNodeTypeFeatureFlag:a.changeNodeTypeFeatureFlag})),o=I(),j=o==null?void 0:o.node_type,[m,g]=d.useState({});d.useEffect(()=>{o!=null&&o.properties&&g(o.properties)},[o]);const b=()=>{p(),i()},h=(a,n)=>{g(T=>({...T,[a]:n}))};return e.jsxs(s,{children:[e.jsx(s,{align:"center",direction:"row",justify:"space-between",mb:18,children:e.jsxs(s,{align:"center",direction:"row",children:[e.jsx(ne,{children:"Edit Node"}),e.jsxs(se,{children:[e.jsx(K,{type:j}),y&&e.jsx(ie,{onClick:b,children:e.jsx(Q,{})})]})]})}),e.jsx(ce,{children:Object.keys(m).map(a=>e.jsxs(s,{mb:18,children:[e.jsx(re,{style:{marginBottom:8},children:oe(a)}),e.jsx(k,{id:`cy-${a}`,maxLength:50,name:`properties.${a}`,onChange:n=>h(a,n),placeholder:`Please Enter the ${a}`,rules:a==="name"?{...P}:{}})]},a))})]})},ne=c(F)`
  font-size: 22px;
  font-weight: 600;
  font-family: 'Barlow';
`,re=c(F)`
