...
`,ir=v.lazy(()=>ke(()=>import("./index-6d4f7a91.js"),["assets/index-6d4f7a91.js","assets/index-2f9ba739.js","assets/index-b4d03b7b.css","assets/index-b76e5e95.js","assets/SourcesTableIcon-eeef6f8c.js","assets/index-ee48d8c5.js","assets/CheckIcon-34970b68.js","assets/DeleteNodeIcon-ad156892.js","assets/SoundIcon-458a3f0d.js","assets/SucessFeedBackIcon-9e33e8ff.js","assets/ClipLoader-1d602055.js","assets/TableRow-08259d79.js"]).then(({TweetAnalyze:e})=>({default:e}))),ar=()=>{const e=$(o=>o.setSelectedTweet),t=$(o=>o.selectedTweet),{tweetId:a}=fe(),[r,n]=v.useState(""),{open:i}=De("tweetAnalyze"),l=(a==null?void 0:a.split("&"))||[],c=o=>{i(),n(o)};return s.jsxs(or,{align:"stretch",basis:"100%",grow:1,shrink:1,children:[l.length>1?s.jsx(sr,{onClick:()=>{c("summary")},children:"Summary Report"}):null,l.map(o=>s.jsx(cr,{className:t===o?"selected":"",onClick:()=>e(o),children:s.jsx(Vt,{handleAnalyzeClick:()=>{c(o)},nodeId:o})},o)),s.jsx(ir,{tweetId:r})]})},sr=f.button`
  width: 100%;
  background: ${y.ANALYTICS_CARD_BG};
  color: ${y.white};
  padding: 16px 16px;
