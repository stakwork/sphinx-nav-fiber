import{r as n,j as e,s as f,g as T,F as S,o as K,c as U,A as ae,p as ce,i as le,q as pe,H as de,t as ue,v as fe,f as q}from"./index-401280d9.js";import{Universe as me}from"./index-27119db9.js";import{u as he}from"./index-04c7593a.js";import{u as W,a as ge,b as xe,I as ye,c as Q,d as V}from"./index-4b768973.js";import{M as be,V as we}from"./VolumeIcon-70e59c13.js";import{S as je,R as ve,s as X,M as Se}from"./index-6c9ec53b.js";import"./index-6bdd24fa.js";import"./VisibilityOn-d8a81973.js";import"./SourcesTableIcon-e94e077e.js";import"./NodeCircleIcon-c61b6d09.js";import"./CheckIcon-c006a81e.js";import"./DeleteNodeIcon-edb40353.js";import"./EditNodeIcon-5a0306ea.js";import"./SearchIcon-d4246d31.js";import"./SoundIcon-881ba7b8.js";import"./SucessFeedBackIcon-48f96d57.js";import"./three.module-4d3d7244.js";import"./TextareaAutosize-e9a3d034.js";import"./index-57154734.js";import"./index-ee59aa57.js";import"./index-44427afa.js";import"./ClipLoader-b11c0843.js";import"./Skeleton-48b57248.js";import"./Stack-35fe0025.js";import"./index-5357279c.js";import"./FormControlLabel-c2fa70a0.js";import"./Typography-53076fa6.js";import"./createSvgIcon-59b6d22a.js";import"./isPlainObject-118f6b78.js";function D(t){const[i,s,r]=t.split(":").map(Number);return Number((i*60*60*1e3+s*60*1e3+r*1e3).toFixed(6))}const Z=n.memo(()=>{const t=W(a=>a.isPlaying),i=W(a=>a.setIsPlaying),s=W(a=>a.setVolume),r=W(a=>a.setPlaybackSpeed),c=W(a=>a.playbackSpeed),o=W(a=>a.playerRef),[x,b]=n.useState(!1),m=[.5,1,1.5,2],g=()=>{if(o){const a=o.getCurrentTime()-15;o.seekTo(a,"seconds")}},p=()=>{if(o){const a=o.getCurrentTime()+15;o.seekTo(a,"seconds")}},j=()=>{i(!t)},d=()=>{b(!x),s(x?1:0)},h=()=>{const I=(m.indexOf(c)+1)%m.length,F=m[I];if(r(F),o){const P=o.getInternalPlayer();P&&typeof P.playbackRate<"u"&&(P.playbackRate=F)}};return e.jsxs(ke,{children:[e.jsx(Pe,{onClick:d,children:x?e.jsx(be,{}):e.jsx(we,{})}),e.jsx(Te,{onClick:g,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(Ce,{"data-testid":"play-pause-button",onClick:j,size:"small",children:t?e.jsx(ge,{"data-testid":"pause-icon"}):e.jsx(xe,{"data-testid":"play-icon"})}),e.jsx(Ie,{onClick:p,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(_e,{onClick:h,children:[c,"x"]})]})});Z.displayName="Controls";const ke=f(S).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${T.BG1};
  border-radius: 40px;
