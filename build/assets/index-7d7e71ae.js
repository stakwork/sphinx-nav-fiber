import{s as x,c as f,u as P,r as m,j as e,F as o,T as u,b as N,x as V,o as q,ad as J,g as Y,ae as S,d as H,a2 as K}from"./index-f76464f2.js";import{ak as Q,B as w,al as W,l as X,F as Z,am as ee}from"./react-toastify.esm-bb128754.js";import{B as te}from"./index-47dde8aa.js";import{n as y}from"./toastMessage-3f5b8d92.js";import{a as C}from"./index-861660b7.js";import{u as oe}from"./index-9c3b490f.js";import{C as ne}from"./CheckIcon-455b6076.js";import{T as _}from"./index-2c3c416b.js";import{A as se}from"./index-4c19b844.js";import"./index.esm-a945e31d.js";import"./InfoIcon-d72751f5.js";import"./index-c4f67241.js";import"./Popover-e081ddff.js";import"./useSlotProps-2c3c97df.js";import"./Select-f31fbaee.js";import"./Stack-9daff4b0.js";import"./Popper-0477edac.js";const ae=({onClick:n,loading:r})=>{const i=P(l=>l.budget),[c,p]=m.useState(10),a="node";return m.useEffect(()=>{(async()=>{try{const t=await W(a);p(t.data.price)}catch(t){console.error("cannot fetch",t)}})()},[a]),e.jsxs(o,{children:[e.jsx(o,{align:"center",direction:"row",justify:"space-between",mb:20,children:e.jsx(o,{align:"center",direction:"row",children:e.jsx(ce,{children:"Approve Cost"})})}),e.jsxs(o,{align:"center",direction:"row",justify:"space-between",mb:20,children:[e.jsxs(re,{children:[e.jsx("div",{className:"title",children:"COST"}),e.jsxs("div",{className:"value","data-testid":"check-price",children:[c," sats"]})]}),e.jsxs(ie,{children:[e.jsx("div",{className:"title",children:"BUDGET"}),e.jsxs("div",{className:"value",children:[Q(i)," sats"]})]})]}),e.jsx(o,{children:e.jsx(w,{color:"secondary","data-testid":"check-icon",disabled:r,onClick:n,size:"large",startIcon:e.jsx(ne,{}),type:"submit",variant:"contained",children:"Approve"})})]})},re=x(o).attrs({direction:"column",align:"space-between",justify:"flex-start"})`
  width: 141px;
  height: 61px;
