import{s as x,c as f,u as P,r as m,j as e,F as o,T as u,b as N,x as V,o as q,ad as J,g as Y,ae as S,d as H,a2 as K}from"./index-71257a51.js";import{ak as Q,B as w,al as W,l as X,F as Z,am as ee}from"./react-toastify.esm-80f7abc3.js";import{B as te}from"./index-fcf46a2b.js";import{n as y}from"./toastMessage-204e825c.js";import{a as C}from"./index-c8697d14.js";import{u as oe}from"./index-81b7e2b0.js";import{C as ne}from"./CheckIcon-1df7b8a8.js";import{T as _}from"./index-905dce1b.js";import{A as se}from"./index-bfeb668a.js";import"./index.esm-5156b765.js";import"./InfoIcon-b5d1954e.js";import"./index-c1388cf9.js";import"./Popover-750f866a.js";import"./useSlotProps-e0213659.js";import"./Select-f9d2f4e0.js";import"./Stack-f8f836ce.js";import"./Popper-52fdc8f0.js";const ae=({onClick:n,loading:r})=>{const i=P(l=>l.budget),[c,p]=m.useState(10),a="node";return m.useEffect(()=>{(async()=>{try{const t=await W(a);p(t.data.price)}catch(t){console.error("cannot fetch",t)}})()},[a]),e.jsxs(o,{children:[e.jsx(o,{align:"center",direction:"row",justify:"space-between",mb:20,children:e.jsx(o,{align:"center",direction:"row",children:e.jsx(ce,{children:"Approve Cost"})})}),e.jsxs(o,{align:"center",direction:"row",justify:"space-between",mb:20,children:[e.jsxs(re,{children:[e.jsx("div",{className:"title",children:"COST"}),e.jsxs("div",{className:"value","data-testid":"check-price",children:[c," sats"]})]}),e.jsxs(ie,{children:[e.jsx("div",{className:"title",children:"BUDGET"}),e.jsxs("div",{className:"value",children:[Q(i)," sats"]})]})]}),e.jsx(o,{children:e.jsx(w,{color:"secondary","data-testid":"check-icon",disabled:r,onClick:n,size:"large",startIcon:e.jsx(ne,{}),type:"submit",variant:"contained",children:"Approve"})})]})},re=x(o).attrs({direction:"column",align:"space-between",justify:"flex-start"})`
  width: 141px;
  height: 61px;
