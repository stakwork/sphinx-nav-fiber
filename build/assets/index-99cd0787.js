import{r as n,j as e,s as f,g as T,F as S,o as K,c as U,A as ae,p as ce,i as le,q as pe,H as de,t as ue,v as fe,f as q}from"./index-58097f5b.js";import{Universe as me}from"./index-e0a5005f.js";import{u as he}from"./index-b4f1c7a4.js";import{u as W,a as ge,b as xe,I as ye,c as Q,d as V}from"./index-d04fc0b6.js";import{M as be,V as we}from"./VolumeIcon-495207a3.js";import{S as je,R as ve,s as X,M as Se}from"./index-fcf59dad.js";import"./index-78b029a2.js";import"./VisibilityOn-3e6077e4.js";import"./SourcesTableIcon-eae70fca.js";import"./NodeCircleIcon-fa423c30.js";import"./CheckIcon-b42190d7.js";import"./DeleteNodeIcon-17244472.js";import"./EditNodeIcon-6ed4a95a.js";import"./SearchIcon-ca832aff.js";import"./SoundIcon-1b49f390.js";import"./SucessFeedBackIcon-addeb332.js";import"./three.module-4d3d7244.js";import"./TextareaAutosize-d68e6b53.js";import"./index-73293a28.js";import"./index-a0d3df73.js";import"./index-3ae0e9d1.js";import"./ClipLoader-ceb78197.js";import"./Skeleton-ad7f133a.js";import"./Stack-c9ad25ff.js";import"./index-a598af11.js";import"./FormControlLabel-d4d9c88a.js";import"./Typography-b547f60e.js";import"./createSvgIcon-2ef4c677.js";import"./isPlainObject-ffb58207.js";function D(t){const[i,s,r]=t.split(":").map(Number);return Number((i*60*60*1e3+s*60*1e3+r*1e3).toFixed(6))}const Z=n.memo(()=>{const t=W(a=>a.isPlaying),i=W(a=>a.setIsPlaying),s=W(a=>a.setVolume),r=W(a=>a.setPlaybackSpeed),c=W(a=>a.playbackSpeed),o=W(a=>a.playerRef),[x,b]=n.useState(!1),m=[.5,1,1.5,2],g=()=>{if(o){const a=o.getCurrentTime()-15;o.seekTo(a,"seconds")}},p=()=>{if(o){const a=o.getCurrentTime()+15;o.seekTo(a,"seconds")}},j=()=>{i(!t)},d=()=>{b(!x),s(x?1:0)},h=()=>{const I=(m.indexOf(c)+1)%m.length,F=m[I];if(r(F),o){const P=o.getInternalPlayer();P&&typeof P.playbackRate<"u"&&(P.playbackRate=F)}};return e.jsxs(ke,{children:[e.jsx(Pe,{onClick:d,children:x?e.jsx(be,{}):e.jsx(we,{})}),e.jsx(Te,{onClick:g,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(Ce,{"data-testid":"play-pause-button",onClick:j,size:"small",children:t?e.jsx(ge,{"data-testid":"pause-icon"}):e.jsx(xe,{"data-testid":"play-icon"})}),e.jsx(Ie,{onClick:p,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(_e,{onClick:h,children:[c,"x"]})]})});Z.displayName="Controls";const ke=f(S).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${T.BG1};
  border-radius: 40px;
