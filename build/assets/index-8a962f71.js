import{s as i,F as n,T as g,j as e,b as w,c as p,r as A,u as B}from"./index-324d51ec.js";import{B as v}from"./index-14a3a191.js";import{u as F}from"./index-9edcc142.js";import{u as M,G as $,l as C,b,q as D,F as G}from"./react-toastify.esm-31fcbb2e.js";import{B as f,T as k,a as R}from"./index-34a7c7a3.js";import{T as x}from"./index-9ad82c31.js";import{C as L}from"./ClipLoader-a5b03afd.js";import"./useSlotProps-6ca3381f.js";import"./index.esm-b5625140.js";import"./InfoIcon-9f2b633d.js";const P=({onClose:s})=>{const[a]=M(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",a),s()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
