import{f as r,F as i,T as g,i as y,j as e,k as b,L as S,D as w,h as x,r as T,x as v,B as m}from"./index-4cb4a5af.js";import{B}from"./index-34da1bd7.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-637e09eb.js";import{B as f,T as $,a as k}from"./index-d861b9cb.js";import{T as u}from"./index-c192a354.js";import"./useSlotProps-419e62d5.js";import"./index.esm-8c75acaf.js";import"./InfoIcon-93659641.js";const F=({onClose:t})=>{const[s]=y(n=>[n.graphStyle]),o=()=>{localStorage.setItem("graphStyle",s),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(L,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(i,{mt:308,children:e.jsx(f,{kind:"big",onClick:o,children:"Save Changes"})})]})},G=r(i)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,L=r(g)`
