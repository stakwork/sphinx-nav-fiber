import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-99f11686.js";import{B as F}from"./index-0886e7d7.js";import{u as M}from"./index-f9a77ab8.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-f1624ab4.js";import{B as f,T as R,a as L}from"./index-6d08e3a5.js";import{T as x}from"./index-67a9ff4c.js";import"./useSlotProps-932f2e7d.js";import"./index.esm-5df8faff.js";import"./InfoIcon-f5fa8d12.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
