import{o,F as s,T as g,p as y,j as e,A as b,aT as w,aU as S,q as x,r as T,I as v,N as m}from"./index-9ed00b45.js";import{B as A}from"./index-ee656c59.js";import{G as C,i as B,F as G}from"./index-a0c05d54.js";import{B as f,T as M,a as $}from"./index-206ea303.js";import{T as u}from"./index-701a8232.js";import{C as k}from"./ClipLoader-4fe51d2c.js";import"./useSlotProps-ab1ddab6.js";import"./createSvgIcon-c90ffb3f.js";import"./index.esm-d0d93fcc.js";import"./InfoIcon-27c69869.js";const D=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(F,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},F=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
