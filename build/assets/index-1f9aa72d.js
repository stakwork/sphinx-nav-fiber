import{s as r,F as n,T as g,j as e,h as w,b as c,r as A,g as B}from"./index-1f2b463a.js";import{B as v}from"./index-7cd1068f.js";import{u as F}from"./index-450d0403.js";import{e as M,X as $,t as C,h as b,z as D,F as k,C as G}from"./react-toastify.esm-8467f46c.js";import{B as f,T as R,a as z}from"./index-e41b01e5.js";import{T as x}from"./index-89f763de.js";import"./useSlotProps-c0c65900.js";import"./index.esm-886d4e00.js";import"./InfoIcon-d5429fff.js";const L=({onClose:s})=>{const[a]=M(t=>[t.graphStyle]),i=()=>{localStorage.setItem("graphStyle",a),s()};return e.jsxs(P,{direction:"column",children:[e.jsx(V,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:i,children:"Save changes"})})]})},P=r(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,V=r(g)`
