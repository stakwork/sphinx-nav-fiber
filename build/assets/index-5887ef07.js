...
`,$n=({setIsAddEdgeNode:t,edgeData:n,setGraphLoading:s})=>{const e=()=>{t(!1)};return o.jsxs(v,{children:[o.jsxs(kn,{align:"center",direction:"row",justify:"space-between",children:[o.jsx(_n,{children:n!=null&&n.refId?"Edit Edge":"Add Edge"}),o.jsx(Sn,{"data-testid":"close-sidebar-sub-view",onClick:e,children:o.jsx(xt,{})})]}),o.jsx(On,{}),o.jsx(Tn,{edgeLinkData:n,onCancel:e,setGraphLoading:s})]})},Sn=k(v)`
  font-size: 32px;
  color: ${T.white};
  cursor: pointer;
