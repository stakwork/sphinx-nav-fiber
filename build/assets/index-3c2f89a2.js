import{s as r,F as n,T as g,j as e,B as b,b as w,c as p,r as A,u as B}from"./index-5ae80368.js";import{B as v}from"./index-b2b0359c.js";import{u as F}from"./index-26a2bf18.js";import{u as M,l as $,b as f,q as C,F as D}from"./react-toastify.esm-3af80b55.js";import{G}from"./index-e92b1fb6.js";import{T as x}from"./index-47c1efd9.js";import{C as k}from"./ClipLoader-eb0bddd2.js";import{T as R,a as L}from"./Tabs-816c3afe.js";import"./index.esm-2d8a98d7.js";import"./InfoIcon-8316e2b6.js";import"./useSlotProps-e6584029.js";const P=({onClose:s})=>{const[a]=M(t=>[t.graphStyle]),i=()=>{localStorage.setItem("graphStyle",a),s()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(G,{}),e.jsx(n,{mt:308,children:e.jsx(b,{kind:"big",onClick:i,children:"Save changes"})})]})},V=r(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=r(g)`
