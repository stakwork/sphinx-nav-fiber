import{aL as Ci,r as z,f as k,h as y,i as fe,j as s,l as Ie,F as g,T as J,O as $t,k as pe,aM as cr,aN as Si,x as pr,o as vi,aO as Ei,P as Ti,a4 as xe,aP as fn,a2 as Ii,aQ as xn,ad as _i,B as At,aR as Ai,J as Pi}from"./index-dae18a7b.js";import{l as zi,m as mt,A as be,B as we,d as Li,I as hr,f as at,g as dr,n as ut,P as Ht,C as Vt,o as Bi,i as fr,b as Mi,S as Oi}from"./react-toastify.esm-b2fbd024.js";import{C as xr}from"./CheckIcon-9542b389.js";import{C as mr}from"./ChevronDownIcon-e1e8e004.js";import{C as Ri}from"./ChevronUpIcon-296ae94f.js";import{F as gr,a as Di,T as Fi}from"./Popover-f019cc00.js";import{G as yr,L as Ut,B as Gt,H as Ni,M as $i,R as Hi,a as Vi,S as Ui,b as Gi,N as wr,C as Yi,D as Yt,c as br,d as qi,f as Wi,g as kr,e as Qi,P as Xi,h as jr,s as mn,V as Ki,F as Zi,E as Ji,i as eo,j as to,k as Cr,l as no}from"./ChevronRightIcon-d80fc98f.js";import{S as ro}from"./index-f0c9e0da.js";import{f as rt,o as Sr,P as vr,n as io,X as oo,Y as lo,T as so,D as ao,S as qt,q as Er}from"./generateCategoricalChart-7e80de8d.js";import{T as Ne,I as uo,S as co,O as po}from"./index-4cfd9203.js";import{S as ho}from"./Skeleton-ce6f13dd.js";import{f as fo,c as xo,g as mo,h as go}from"./index.esm-f388d3bf.js";import{I as yo}from"./InfoIcon-4b1a98c3.js";import{P as wo}from"./PlusIcon-07a56cc5.js";import{B as bo}from"./index-4459d726.js";import"./useSlotProps-25d62d1d.js";const ko=(e,t="down")=>{const n=Ci(),[r,i]=z.useState(!1),o=n.breakpoints[t](e).split("@media")[1].trim();return z.useEffect(()=>{const l=()=>{const{matches:a}=window.matchMedia(o);i(a)};return l(),window.addEventListener("resize",l),()=>window.removeEventListener("resize",l)},[o]),r},jo=e=>e.filter(t=>t.tldr).length>=2&&e.some(t=>t.audio_EN);function Co(e){return e.tldr_topic??e.name}var it=globalThis&&globalThis.__assign||function(){return it=Object.assign||function(e){for(var t,n=1,r=arguments.length;n<r;n++){t=arguments[n];for(var i in t)Object.prototype.hasOwnProperty.call(t,i)&&(e[i]=t[i])}return e},it.apply(this,arguments)},So=globalThis&&globalThis.__rest||function(e,t){var n={};for(var r in e)Object.prototype.hasOwnProperty.call(e,r)&&t.indexOf(r)<0&&(n[r]=e[r]);if(e!=null&&typeof Object.getOwnPropertySymbols=="function")for(var i=0,r=Object.getOwnPropertySymbols(e);i<r.length;i++)t.indexOf(r[i])<0&&Object.prototype.propertyIsEnumerable.call(e,r[i])&&(n[r[i]]=e[r[i]]);return n},vo=zi("BeatLoader","50% {transform: scale(0.75);opacity: 0.2} 100% {transform: scale(1);opacity: 1}","beat");function Eo(e){var t=e.loading,n=t===void 0?!0:t,r=e.color,i=r===void 0?"#000000":r,o=e.speedMultiplier,l=o===void 0?1:o,a=e.cssOverride,u=a===void 0?{}:a,c=e.size,h=c===void 0?15:c,d=e.margin,f=d===void 0?2:d,p=So(e,["loading","color","speedMultiplier","cssOverride","size","margin"]),w=it({display:"inherit"},u),b=function(_){return{display:"inline-block",backgroundColor:i,width:mt(h),height:mt(h),margin:mt(f),borderRadius:"100%",animation:"".concat(vo," ").concat(.7/l,"s ").concat(_%2?"0s":"".concat(.35/l,"s")," infinite linear"),animationFillMode:"both"}};return n?z.createElement("span",it({style:w},p),z.createElement("span",{style:b(1)}),z.createElement("span",{style:b(2)}),z.createElement("span",{style:b(3)})):null}const To=()=>{var d;const[e,t]=z.useState(null),{sidebarFilter:n,setSidebarFilter:r,sidebarFilterCounts:i}=fe(f=>f),o=n==="undefined"?"":n.toLowerCase(),l=((d=i.find(f=>f.name===o))==null?void 0:d.count)||0,a=f=>f?f.charAt(0).toUpperCase()+f.slice(1):"",u=f=>{t(f.currentTarget)},c=()=>{t(null)},h=f=>{r(f),c()};return s.jsxs("div",{children:[s.jsxs(Io,{onClick:u,children:[s.jsx("div",{className:"text",children:"Show"}),s.jsx("div",{className:"value","data-testid":"value",children:`${a(o)} (${l})`}),s.jsx("div",{className:"icon",children:e?s.jsx(Ri,{}):s.jsx(mr,{})})]}),s.jsx(Ao,{anchorEl:e,anchorOrigin:{vertical:"bottom",horizontal:"left"},anchorPosition:{top:62,left:0},onClose:c,open:!!e,transformOrigin:{vertical:"top",horizontal:"left"},children:s.jsx(gr,{children:i.filter(({name:f})=>f).map(({name:f,count:p})=>s.jsxs(_o,{className:Ie({active:f===n}),onClick:w=>{w.preventDefault(),h(f)},children:[s.jsx("span",{className:"icon",children:f===n?s.jsx(xr,{}):null}),s.jsx("span",{children:`${a(f)} (${p})`})]},f))})})]})},Io=k(g).attrs({direction:"row",align:"center"})`
  cursor: pointer;
  flex-grow: 1;
  color: ${y.GRAY6};
  font-family: Barlow;
...
`,_o=k(g).attrs({direction:"row",align:"center"})`
  font-family: Barlow;
  font-size: 13px;
  font-style: normal;
  font-weight: 500;
...
`,gt=[["Searching","Podcast Index"],["Finding","Transcripts"],["Loading","Audio Clips"],["Loading","Video Clips"],["Preparing","Results"]],Po=()=>{const[e,t]=z.useState(0);return z.useEffect(()=>{if(e===gt.length-1)return;const n=setTimeout(()=>t(r=>(r+1)%gt.length),2e3);return()=>clearTimeout(n)},[e]),s.jsx(zo,{direction:"column",children:gt.map((n,r)=>s.jsxs(g,{className:Ie("raw-wrapper",{show:e===r}),direction:"row",children:[s.jsx("div",{className:Ie("action"),children:n[0]}),s.jsx("div",{className:Ie("entity"),children:n[1]}),s.jsx("div",{children:s.jsx(Eo,{color:y.SECONDARY_BLUE,size:2})})]},n[1]))})},zo=k(g)`
  overflow: hidden;
  height: 20px;
  position: relative;
  .action {
...
`,Do=k(g)`
  ...
  font-weight: 600;
  line-height: 17px;
`,Fo=({text:e,type:t,sourceLink:n})=>s.jsxs(g,{direction:"column",children:[s.jsx(g,{align:"center",direction:"row",children:s.jsx(Ne,{type:t})}),s.jsx(Pt,{"data-testid":"episode-description",children:e}),s.jsx(g,{align:"center",direction:"row",justify:"flex-start",children:n&&s.jsxs(No,{href:n,onClick:r=>r.stopPropagation(),target:"_blank",children:[s.jsx(yr,{}),s.jsx($o,{children:n})]})})]}),No=k.a`
  color: ${y.GRAY6};
  font-size: 16px;
  height: 16px;
  display: flex;
...
`,$o=k(J)`
  ...
  font-weight: 400;
  line-height: 18px;
`,Ho=({title:e,imageUrl:t,name:n})=>s.jsxs(g,{align:"center",direction:"row",children:[s.jsx(Vo,{children:s.jsx(be,{rounded:!0,size:64,src:t||"",type:"person"})}),(e||n)&&s.jsx(Uo,{children:e||n})]}),Vo=k(g)`
  img {
    width: 64px;
    height: 64px
    border-radius: 50%;
...
`,Uo=k(g)`
  ...
  font-weight: 600;
  line-height: 17px;
`,Go=({text:e,imageUrl:t,date:n,twitterHandle:r,name:i,verified:o})=>s.jsxs(g,{direction:"column",children:[s.jsxs(g,{align:"center",direction:"row",pr:16,children:[s.jsx(Yo,{children:s.jsx(be,{rounded:!0,size:27,src:t||"",type:"person"})}),s.jsxs(g,{children:[s.jsxs(qo,{align:"center",direction:"row",children:[i,o&&s.jsx("div",{className:"verification",children:s.jsx("img",{alt:"verified",src:"verified_twitter.svg"})})]}),r&&s.jsxs(Wo,{children:["@",r]})]})]}),s.jsxs(g,{grow:1,shrink:1,children:[s.jsx(Qo,{"data-testid":"episode-description",children:e}),s.jsx(g,{"data-testid":"date-text",direction:"row",justify:"flex-start",children:!!n&&s.jsx(ct,{children:$t.unix(n).fromNow()})})]})]}),Yo=k(g)`
  img {
    width: 64px;
    height: 64px;
    border-radius: 50%;
...
`,Tr=({boostCount:e,date:t,episodeTitle:n,isSelectedView:r=!1,imageUrl:i,showTitle:o,type:l,text:a,name:u,sourceLink:c,verified:h=!1,twitterHandle:d,className:f="episode-wrapper",onClick:p})=>{const w=l==="show"?o:n,b=l==="show"?"":o,_=["tweet","person","guest","topic","document"],S=l==="video"?"video":"audio";return l?s.jsx(Xo,{className:f,onClick:p,children:_.includes(l)?s.jsxs(s.Fragment,{children:[l==="topic"&&s.jsxs(Ko,{children:[s.jsx(Ni,{}),s.jsx("p",{children:b})]}),["person","guest"].includes(l)&&s.jsx(Ho,{imageUrl:i,name:u||"",title:o||""}),["image"].includes(l)&&s.jsx(Oo,{imageUrl:c,name:u||""}),l==="tweet"&&s.jsx(Go,{date:t,imageUrl:i,name:u||"",text:a||"",twitterHandle:d,verified:h}),l==="document"&&s.jsx(Fo,{sourceLink:c||"",text:a||"",type:l})]}):s.jsxs(g,{align:"center",direction:"row",justify:"center",children:[!r&&s.jsx(g,{align:"center",pr:16,children:s.jsx(be,{size:80,src:i||`${S}_default.svg`,type:l||""})}),s.jsxs(g,{grow:1,shrink:1,children:[s.jsxs(g,{align:"center",direction:"row",justify:"space-between",children:[s.jsx(g,{align:"center",direction:"row",children:l&&s.jsx(Ne,{type:l})}),l==="video"&&c?s.jsx(Jo,{href:`${c}${c.includes("?")?"&":"?"}open=system`,onClick:j=>j.stopPropagation(),target:"_blank",children:s.jsx(Ut,{})}):null]}),u&&s.jsx(Pt,{"data-testid":"episode-name",children:u}),s.jsx(Pt,{"data-testid":"episode-description",children:w}),s.jsxs(g,{align:"center",direction:"row",justify:"flex-start",children:[!!t&&s.jsx(ct,{children:$t.unix(t).fromNow()}),!!b&&s.jsx(Zo,{children:b}),!r&&e>0&&s.jsx(g,{style:{marginLeft:"auto"},children:s.jsx(Gt,{amt:e})})]})]})]})}):null},Pt=k(g)`
  font-family: Barlow;
  font-size: 13px;
  font-style: normal;
  font-weight: 400;
...
`,Jo=k.a`
  ...
  font-size: 16px;
  height: 16px;
`,el=({isSearchResult:e})=>{const t=z.useRef(null),n=e?80:10,{setSelectedNode:r,setSelectedTimestamp:i}=fe(L=>L),{currentSearch:o,setSidebarOpen:l,setRelevanceSelected:a}=pe(L=>L),[u,c]=z.useState(0),[h,d]=z.useState(0),f=cr(),w=u*n+n,b=f&&f.length>0?f.length-1>w:!1,_=ko("sm","down"),S=z.useCallback(L=>{Si(L),i(L),a(!0),r(L),_&&l(!1)},[r,a,l,i,_]),j=()=>{b&&(c(u+1),d(L=>L+1))},E=z.useMemo(()=>{if(f){const L=[...f].sort((B,v)=>(v.date||0)-(B.date||0));return o&&L.sort((B,v)=>{const D=B.node_type==="topic"&&B.name.toLowerCase()===o.toLowerCase()?1:0;return(v.node_type==="topic"&&v.name.toLowerCase()===o.toLowerCase()?1:0)-D}),L.slice(0,w)}return[]},[f,o,w]);return s.jsx(s.Fragment,{children:s.jsxs(Mo,{ref:t,id:"search-result-list",shrink:1,children:[(E??[]).map((L,B)=>{const{image_url:v,date:D,boost:G,type:$,episode_title:V,show_title:I,node_type:P,text:H,source_link:q,link:F,name:te,verified:ee=!1,twitter_handle:ie}=L||{};return s.jsx(Tr,{boostCount:G||0,date:D||0,episodeTitle:rt(V),imageUrl:v||"",link:F,name:te||"",onClick:()=>{S(L)},showTitle:rt(I),sourceLink:q,text:H||"",twitterHandle:ie,type:P||$,verified:ee},B.toString())}),s.jsx(nl,{align:"center",background:"BG1",direction:"row",justify:"center",children:b&&s.jsx(we,{onClick:j,size:"medium",children:"Load More"},h)})]})})},tl=z.memo(el),nl=k(g)`
  flex: 0 0 86px;
...
`,al=()=>s.jsx(s.Fragment,{children:Array(7).fill(null).map((e,t)=>s.jsx(sl,{children:s.jsxs(g,{direction:"row",children:[s.jsx(g,{align:"center",pr:16,children:s.jsx(Ke,{animation:"wave",height:64,variant:"rectangular",width:64})}),s.jsxs(g,{grow:1,shrink:1,children:[s.jsx(Ke,{height:10,variant:"rectangular",width:56}),s.jsx(Ke,{className:"title",height:10,variant:"rectangular",width:262}),s.jsx(Ke,{height:10,variant:"rectangular",width:149})]})]})},t))});k(g)`
  font-family: Barlow;
  font-size: 13px;
  font-style: normal;
  font-weight: 500;
...
`;const cl=48,pl=8,hl={PaperProps:{style:{maxHeight:cl*4.5+pl,width:250}}},dl=["Beginner","Intermediate","Advanced","Expert"],fl=()=>{const e=fe(j=>j.data),[t,n]=z.useState(""),[r,i]=z.useState("Beginner"),o=pe(j=>j.currentSearch),l=Li(),[a]=pr(j=>[j.setBudget]),[u,c,h,d,f]=Sr(j=>[j.askedQuestions,j.askedQuestionsAnswers,j.setAskedQuestion,j.setAskedQuestionAnswer,j.hasQuestionInProgress]),p=z.useCallback(j=>{d(j.answer)},[d]);z.useEffect(()=>{l&&p&&l.on("askquestionhook",p)},[p,l]);const w=async()=>{t&&(h(t),n(""));try{const j=e==null?void 0:e.nodes.filter(B=>B.text),E=j==null?void 0:j.slice(0,5),L=(E!=null&&E.length?E.map(B=>B.text).join(" "):"").substring(0,2500).replace(/[?&=+/#]/g,B=>`\\${B}`);o&&(await vi.enable(),await Ei({expertise_level:r,question_text:t,search_term:o,transcripts:L},a),await Ti(a))}catch(j){console.error(j)}},b=r&&t.trim()&&!f,_=j=>{i(j.target.value)},S=async j=>{if(f){j.preventDefault();return}j.keyCode===13&&j.shiftKey===!1&&b&&(j.preventDefault(),w())};return s.jsxs(xl,{children:[s.jsx(g,{children:s.jsx(g,{children:s.jsxs(gr,{component:"div",children:[s.jsx(gl,{id:"select-label",size:"small",children:"Expertise level"}),s.jsx(yl,{id:"demo-multiple-name",input:s.jsx(po,{label:"Expertise level"}),labelId:"select-label",MenuProps:hl,onChange:_,size:"small",value:r,children:dl.map(j=>s.jsx($i,{component:"li",value:j,children:j},j))})]})})}),s.jsx(kl,{children:u==null?void 0:u.map((j,E)=>s.jsxs(g,{className:"response",py:12,children:[s.jsx(J,{kind:"medium",children:j}),s.jsx(g,{py:12,children:(c==null?void 0:c[E])!==void 0?s.jsx(J,{color:"unreadMsgText",children:c[E]}):s.jsxs(g,{align:"center",py:12,children:[s.jsx(g,{align:"center",py:12,children:s.jsx(vr,{color:y.white})}),s.jsx(g,{align:"center",py:12,children:s.jsx(J,{children:"Generating response"})})]})})]},j))}),s.jsxs(wl,{onKeyDown:S,py:12,tabIndex:-1,children:[s.jsx(ml,{disabled:f,onChange:j=>n(j.target.value),placeholder:"Enter your question",value:t}),s.jsx(bl,{children:s.jsx(fo,{color:b?y.white:y.gray300,size:"18"})})]})]})},xl=k.div`
  margin-top: 20px;
`,ml=k(Fi)`
...
`;function pt(e,t){if(!(t!=null&&t.trim()))return e;const n=new RegExp(`(${t})`,"gi"),r=e.split(n);return s.jsx(s.Fragment,{children:r.map((i,o)=>n.test(i)?s.jsx(Tl,{children:i},o):i)})}const Tl=k.span`
  ...
  border-radius: 3px;
  color: inherit;
`,Il=({stateless:e,node:t,searchTerm:n})=>s.jsxs(g,{grow:1,shrink:1,children:[s.jsx(Al,{children:e&&s.jsxs(_l,{children:[s.jsx("div",{className:"icon",children:s.jsx(wr,{})}),s.jsx("div",{className:"title",children:"Description"})]})}),s.jsx(J,{children:t!=null&&t.description?pt(t.description,n):"..."})]}),_l=k(g).attrs({direction:"row",align:"center"})`
  .icon {
    font-size: 16px;
    color: ${y.GRAY3};
    margin-right: 7px;
...
`,Al=k(g).attrs({direction:"row",align:"center",justify:"space-between"})`
  margin-bottom: 18px;
`,Pl=k.span`
  color: ${y.white};
  cursor: pointer;
...
`,Bl=k(g).attrs({direction:"row",align:"center",justify:"space-between"})`
  margin-bottom: 18px;
`,Ml=k(g).attrs({})`
  color: ${y.mainBottomIcons};
  cursor: pointer;
...
`,Ir=({node:e})=>{const t=fe(b=>b.selectedNode),n=pe(b=>b.currentSearch),{link:r,image_url:i,date:o,boost:l,node_type:a,type:u,id:c,show_title:h,episode_title:d,ref_id:f}=e||t||{},[p,w]=z.useState(l||0);return z.useEffect(()=>{w(l??0)},[l]),!e&&!t?null:s.jsx("div",{style:{overflow:"auto",flex:1,width:"100%"},children:s.jsxs(Dl,{children:[s.jsx(Nl,{boostCount:p||0,date:o||0,episodeTitle:rt(d),imageUrl:i,isSelectedView:!0,link:r,onClick:()=>null,showTitle:h,type:a||u}),s.jsx(yt,{}),s.jsxs(Fl,{children:[s.jsx(Gt,{amt:p}),s.jsx(br,{content:e||t,count:p,refId:f,updateCount:w})]}),s.jsx(yt,{}),s.jsx(yn,{children:s.jsx(Il,{node:e||t,searchTerm:n,stateless:!0})}),((t==null?void 0:t.text)||(e==null?void 0:e.text))&&s.jsxs(s.Fragment,{children:[s.jsx(yt,{}),s.jsx(yn,{children:s.jsx(zl,{node:e||t,stateless:!0},c)})]})]})})},Dl=k(g)`
  flex: 1;
  min-height: 100%;
  flex-direction: column;
...
`,As=k(we)`
  width: 100%;
`,Ps=()=>{const e=xe();if(!e)return null;const t=!!e.image_url,n=e.properties||{};return s.jsxs(Ds,{children:[t?s.jsx(Ms,{children:s.jsx("img",{alt:"img_a11y",src:e.image_url})}):null,s.jsxs(Ls,{grow:1,justify:"flex-start",pt:t?0:8,shrink:1,children:[s.jsx(g,{ml:24,mt:20,style:{width:"fit-content"},children:s.jsx(Ne,{type:e.type||""})}),s.jsx(Bs,{children:Object.entries(n).map(([r,i])=>s.jsx(zs,{label:r,value:i},r))})]})]})},zs=({label:e,value:t})=>{const n=t.length>140;return s.jsxs(s.Fragment,{children:[s.jsxs(Os,{className:Ie("node-detail",{"node-detail__long":n}),children:[s.jsx(J,{className:"node-detail__label",children:e}),s.jsx(J,{className:"node-detail__value",children:t})]}),s.jsx(Rs,{})]})},Ls=k(g)`
  overflow: auto;
  width: 100%;
  flex-grow: 1;
  padding-top: 16px;
...
`,Us=k.audio`
  height: 0;
  width: 0;
`,Gs=["clip","twitter_space","video","episode","podcast"],Ys=()=>{const e=xe(),{showTeachMe:t}=fe(r=>r),{setPlayingNode:n}=at(r=>r);if(z.useEffect(()=>{Gs.includes((e==null?void 0:e.node_type)||"")&&n(e)},[n,e]),t)return s.jsx(jl,{});switch(e==null?void 0:e.node_type){case"guest":case"person":return s.jsx(xs,{});case"data_series":return s.jsx(vl,{});case"tribe_message":return s.jsx(ps,{});case"tweet":return s.jsx(Ss,{});case"topic":return s.jsx(Cs,{});case"show":return s.jsx(js,{});case"video":case"podcast":case"clip":case"twitter_space":return s.jsx(Ir,{});case"document":return s.jsx(Fs,{});case"episode":return s.jsx(ls,{},e.ref_id);case"image":return s.jsx(cs,{});default:return s.jsx(Ps,{})}},qs=z.memo(Ys),Ws=({isPlaying:e,isFullScreen:t,setIsPlaying:n,playingTime:r,duration:i,handleProgressChange:o,handleVolumeChange:l,onFullScreenClick:a,showToolbar:u})=>s.jsxs(g,{children:[(!u||t)&&s.jsx(Js,{"aria-label":"Small","data-testid":"progress-bar",isFullScreen:t,max:i,onChange:o,size:"small",value:r}),s.jsxs(Qs,{align:"center",direction:"row",showToolbar:u||t,children:[s.jsx(Xs,{onClick:n,size:"small",children:e?s.jsx(ut,{}):s.jsx(Ht,{})}),s.jsxs(ea,{direction:"row",children:[s.jsx("span",{children:mn(r)}),s.jsx("span",{className:"separator",children:"/"}),s.jsx("span",{className:"duration",children:mn(i)})]}),s.jsxs(Ks,{direction:"row",px:9,children:[s.jsx(jr,{className:"volume-slider",defaultValue:.5,max:1,min:0,onChange:l,size:"small",step:.1}),s.jsx(Ki,{})]}),s.jsx(Zs,{"data-testid":"fullscreen-button",onClick:()=>a(),children:t?s.jsx(Ji,{}):s.jsx(Zi,{})})]})]}),Qs=k(g)`
  height: 60px;
  padding: 12px 16px;
  ${e=>e.showToolbar&&`
    position: fixed;
...
`,ta=({hidden:e})=>{var he,m;const t=z.useRef(null),n=z.useRef(null),[r,i]=z.useState(!1),[o,l]=z.useState(!1),[a,u]=z.useState(!1),[c,h]=z.useState("ready"),[d,f]=z.useState(!1),{isPlaying:p,playingTime:w,duration:b,setIsPlaying:_,setPlayingTime:S,setDuration:j,playingNode:E,volume:L,setVolume:B,setHasError:v,resetPlayer:D,isSeeking:G,setIsSeeking:$}=at(X=>X),V=((he=E==null?void 0:E.link)==null?void 0:he.includes("youtube"))||((m=E==null?void 0:E.link)==null?void 0:m.includes("youtu.be"));z.useEffect(()=>()=>D(),[D]),z.useEffect(()=>{E&&!d&&(S(0),j(0),f(!1))},[E,S,j,f,d]),z.useEffect(()=>{G&&t.current&&(t.current.seekTo(w,"seconds"),$(!1))},[w,G,$]);const I=()=>{_(!p)},P=()=>{_(!0)},H=()=>{_(!1)},q=(X,K)=>{const Z=Array.isArray(K)?K[0]:K;t.current&&(t.current.seekTo(Z),S(Z))},F=(X,K)=>{const Z=Array.isArray(K)?K[0]:K;B(Z)},te=()=>{v(!0),h("error")},ee=X=>{if(!G){const K=X.playedSeconds;S(K)}},ie=()=>{if(t.current){h("ready");const X=t.current.getDuration();j(X)}},ge=()=>{n.current&&(document.fullscreenElement?(document.exitFullscreen(),setTimeout(()=>l(!1),300)):n.current.requestFullscreen().then(()=>{document.addEventListener("fullscreenchange",x)}))},x=()=>{l(!!document.fullscreenElement),document.removeEventListener("fullscreenchange",x)};z.useEffect(()=>()=>{document.removeEventListener("fullscreenchange",x)}),z.useEffect(()=>{const X=K=>{if(o){const Z=window.screen.height,Ae=K.clientY,ke=Z-Ae;u(ke<=50)}};return document.addEventListener("mousemove",X),()=>{document.removeEventListener("mousemove",X)}},[o,a]),z.useEffect(()=>{const X=K=>{o&&K.key==="Escape"?(K.preventDefault(),K.stopPropagation()):r&&K.key===" "&&(K.preventDefault(),I())};return document.addEventListener("fullscreenchange",x),document.addEventListener("keydown",X),()=>{document.removeEventListener("fullscreenchange",x),document.removeEventListener("keydown",X)}});const se=()=>{I()};return E!=null&&E.link?s.jsxs(na,{ref:n,hidden:e,onBlur:()=>i(!1),onFocus:()=>i(!0),tabIndex:0,children:[s.jsx(ra,{isFullScreen:o,children:s.jsx(be,{size:120,src:(E==null?void 0:E.image_url)||"",type:"clip"})}),s.jsx(la,{onClick:se,children:s.jsx(eo,{ref:t,controls:!1,height:o?window.screen.height:"200px",onBuffer:()=>h("buffering"),onBufferEnd:()=>h("ready"),onError:te,onPause:H,onPlay:P,onProgress:ee,onReady:ie,playing:p,url:(E==null?void 0:E.link)||"",volume:L,width:"100%"})}),c==="error"?s.jsx(oa,{className:"error-wrapper",children:"Error happened, please try later"}):null,c==="ready"?s.jsx(Ws,{duration:b,handleProgressChange:q,handleVolumeChange:F,isFullScreen:o,isPlaying:p,onFullScreenClick:ge,playingTime:w,setIsPlaying:I,showToolbar:a&&o}):null,c==="buffering"&&!V?s.jsx(ia,{isFullScreen:o,children:s.jsx(Vt,{color:y.lightGray})}):null]}):null},na=k(g)`
...
`,l0=k.audio`
  height: 0;
  width: 0;
`,s0=390,a0=z.forwardRef(({onSubmit:e,subViewOpen:t},n)=>{const{isFetching:r,setTeachMe:i,setSidebarFilter:o}=fe(j=>j),l=cr(),{setSidebarOpen:a,currentSearch:u,clearSearch:c,searchFormValue:h}=pe(j=>j),[d]=Pi(j=>[j.trendingTopicsFeatureFlag]),{setValue:f,watch:p}=fr(),w=z.useRef(null),[b,_]=z.useState(!1);z.useEffect(()=>{f("search",h)},[f,h]),z.useEffect(()=>{const j=w.current;if(!j)return;const E=()=>{_((j==null?void 0:j.scrollTop)>0)};j.addEventListener("scroll",E)},[]);const S=p("search");return s.jsxs(p0,{ref:n,id:"sidebar-wrapper",children:[s.jsx(g0,{}),s.jsxs(fi,{className:Ie({"has-shadow":b}),children:[s.jsxs(h0,{children:[s.jsx(ro,{onSubmit:e}),s.jsx(f0,{"data-testid":"search_action_icon",onClick:()=>{if(u){f("search",""),c(),o("all");return}S.trim()!==""&&(e==null||e())},children:r?s.jsx(Vt,{color:y.SECONDARY_BLUE,"data-testid":"loader",size:"20"}):s.jsx(s.Fragment,{children:u!=null&&u.trim()?s.jsx(Mi,{}):s.jsx(Oi,{})})})]}),u&&s.jsx(d0,{children:r?s.jsx(Po,{}):s.jsxs(s.Fragment,{children:[s.jsxs("div",{className:"left",children:[s.jsx("span",{className:"count",children:l.length}),s.jsx("span",{className:"label",children:" results"})]}),s.jsx("div",{className:"right",style:{alignItems:"center"},children:s.jsx(To,{})})]})})]}),!t&&s.jsx(x0,{onClick:()=>{a(!1),i(!1)},children:s.jsx(Cr,{})}),s.jsxs(m0,{ref:w,children:[!u&&d&&s.jsx(y0,{children:s.jsx(Jh,{onSubmit:e})}),s.jsx(g,{children:r?s.jsx(al,{}):s.jsx(ol,{isSearchResult:!!u})})]})]})}),u0=["topic","person","guest","event","organization","place","project","software"],c0=({onSubmit:e})=>{const{sidebarIsOpen:t}=pe(o=>o),n=xe(),r=!!n&&t&&!u0.includes(n.node_type),{showTeachMe:i}=fe(o=>o);return s.jsxs(s.Fragment,{children:[s.jsx(qt,{direction:"right",in:t,mountOnEnter:!0,unmountOnExit:!0,children:s.jsx(a0,{onSubmit:e,subViewOpen:r})}),s.jsx(aa,{open:r||!!i}),!t&&s.jsx(da,{})]})},p0=k(g)(({theme:e})=>({position:"relative",background:y.BG1,height:"100vh",width:"100%",zIndex:30,[e.breakpoints.up("sm")]:{width:s0}})),fi=k(g).attrs({direction:"column",justify:"center",align:"stretch"})(({theme:e})=>({padding:e.spacing(3.75,2),[e.breakpoints.up("sm")]:{padding:"12px"},"&.has-shadow":{borderBottom:"1px solid rgba(0, 0, 0, 0.25)",background:y.BG1,boxShadow:"0px 1px 6px 0px rgba(0, 0, 0, 0.20)"}})),h0=k(g).attrs({direction:"row",justify:"center",align:"center"})`
  flex-grow: 1;
`,d0=k(g).attrs({direction:"row",justify:"space-between",align:"center"})`
  flex-grow: 1;
  color: ${y.GRAY6};
  font-family: Barlow;
  font-size: 13px;
...
`,f0=k(g).attrs({align:"center",justify:"center",p:5})`
  font-size: 32px;
  color: ${y.mainBottomIcons};
  cursor: pointer;
...
`,x0=k(g).attrs({align:"center",justify:"center",p:8})(({theme:e})=>({backgroundColor:y.BG1_NORMAL,cursor:"pointer",transitionDuration:"0.2s",position:"absolute",right:"0px",top:"50%",zIndex:1,width:"24px",height:"48px",transform:"translateY(-50%)",borderRadius:"0px 6px 6px 0px",boxShadow:"2px 0px 6px 0px rgba(0, 0, 0, 0.25) inset",color:y.white,[e.breakpoints.up("sm")]:{left:"100%"},"&:hover":{backgroundColor:y.BG1_HOVER},"&:active":{backgroundColor:y.BG1_PRESS,color:y.GRAY6}})),m0=k(g)(()=>({overflow:"auto",flex:1,width:"100%"})),g0=k(g)`
  height: 64px;
  background: ${y.BG2};
`,y0=k(g)`
  padding: 0;
