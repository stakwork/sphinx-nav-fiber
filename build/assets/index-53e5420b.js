...
`,rr=b.lazy(()=>De(()=>import("./index-10c8261e.js"),["assets/index-10c8261e.js","assets/index-f1202dc9.js","assets/index-b4d03b7b.css","assets/index-42d24848.js","assets/SourcesTableIcon-434efae1.js","assets/index-703425a7.js","assets/CheckIcon-db9c99a8.js","assets/DeleteNodeIcon-dac6017b.js","assets/SoundIcon-c1702a10.js","assets/SucessFeedBackIcon-a4b3015c.js","assets/ClipLoader-159af143.js","assets/TableRow-57f35bbd.js"]).then(({TweetAnalyze:e})=>({default:e}))),nr=()=>{const e=O(p=>p.setSelectedTweet),t=O(p=>p.selectedTweet),{tweetId:a}=ge(),[r,n]=b.useState(""),{open:i}=Re("tweetAnalyze"),l=(a==null?void 0:a.split("&"))||[],o=p=>{i(),n(p)};return s.jsx(s.Fragment,{children:s.jsxs(ar,{align:"stretch",basis:"100%",grow:1,shrink:1,children:[l.length>1?s.jsx(ir,{onClick:()=>{o("summary")},children:"Summary Report"}):null,l.map(p=>s.jsx(sr,{className:t===p?"selected":"",onClick:()=>e(p),children:s.jsx(Gt,{handleAnalyzeClick:()=>{o(p)},nodeId:p})},p)),s.jsx(rr,{tweetId:r})]})})},ir=h.button`
  width: 100%;
  background: ${x.ANALYTICS_CARD_BG};
  color: ${x.white};
  padding: 16px 16px;
