...
`,ar=v.lazy(()=>Re(()=>import("./index-f022af21.js"),["assets/index-f022af21.js","assets/index-90418f8c.js","assets/index-b4d03b7b.css","assets/index-4de34ab5.js","assets/SourcesTableIcon-94f8e70e.js","assets/index-312d1386.js","assets/CheckIcon-517ec471.js","assets/DeleteNodeIcon-c59ac025.js","assets/SoundIcon-a6e2a61a.js","assets/SucessFeedBackIcon-89488c7e.js","assets/ClipLoader-e5369e07.js","assets/TableRow-f9af746a.js"]).then(({TweetAnalyze:e})=>({default:e}))),sr=()=>{const e=$(o=>o.setSelectedTweet),t=$(o=>o.selectedTweet),{tweetId:a}=ge(),[r,n]=v.useState(""),{open:i}=$e("tweetAnalyze"),l=(a==null?void 0:a.split("&"))||[],c=o=>{i(),n(o)};return s.jsxs(cr,{align:"stretch",basis:"100%",grow:1,shrink:1,children:[l.length>1?s.jsx(or,{onClick:()=>{c("summary")},children:"Summary Report"}):null,l.map(o=>s.jsx(lr,{className:t===o?"selected":"",onClick:()=>e(o),children:s.jsx(Ut,{handleAnalyzeClick:()=>{c(o)},nodeId:o})},o)),s.jsx(ar,{tweetId:r})]})},or=f.button`
  width: 100%;
  background: ${y.ANALYTICS_CARD_BG};
  color: ${y.white};
  padding: 16px 16px;
