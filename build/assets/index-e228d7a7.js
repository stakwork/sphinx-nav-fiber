import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-f83c07d7.js";import{B}from"./index-f421e98d.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-e027ecdc.js";import{B as f,T as $,a as k}from"./index-65bec831.js";import{T as u}from"./index-9c815080.js";import"./useSlotProps-5ba61589.js";import"./index.esm-e0dc085e.js";import"./InfoIcon-5d651515.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
