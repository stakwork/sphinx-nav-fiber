import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-16e685e8.js";import{B as F}from"./index-9185e5ca.js";import{u as M}from"./index-4f0dded3.js";import{j as $,e as k,F as D,C as G}from"./react-toastify.esm-56119586.js";import{B as f,T as R,a as L}from"./index-94a1425a.js";import{T as x}from"./index-e9cf248c.js";import"./useSlotProps-43a4688e.js";import"./index.esm-03e7ba11.js";import"./InfoIcon-42e419e3.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
