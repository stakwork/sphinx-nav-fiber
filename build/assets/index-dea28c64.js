import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-d939ea8c.js";import{B as M}from"./index-7bef8ad5.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-cf8782e0.js";import{B as f,T as L,a as R}from"./index-134efb9a.js";import{T as x}from"./index-6fe2dc08.js";import"./useSlotProps-e80d3e5c.js";import"./index.esm-289835b5.js";import"./InfoIcon-d7130bbb.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
