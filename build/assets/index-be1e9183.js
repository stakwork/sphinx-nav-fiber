import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,C as B,h as c,r as v,x as C}from"./index-088295c2.js";import{B as F}from"./index-6e76736b.js";import{u as M}from"./index-3918d71a.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-65e13871.js";import{B as f,T as L,a as R}from"./index-7f4efe6a.js";import{T as x}from"./index-ea06565d.js";import"./useSlotProps-5f5901c0.js";import"./index.esm-8bda1089.js";import"./InfoIcon-18edb8cb.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
