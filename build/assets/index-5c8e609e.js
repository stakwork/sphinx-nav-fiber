import{aT as C,Y as S,v as b,aU as P,R as $,aV as I,aW as U,f as x,h as l,x as D,r as f,j as e,F as o,aX as X,T as y,aY as J,D as K,B as Q,aZ as h,X as ee,o as te,a_ as se,a$ as oe,W as ne,b0 as ie,P as re}from"./index-9a37bc59.js";import{B as w,C as ae,c as le,F as ce}from"./react-toastify.esm-81e38af5.js";import{B as de}from"./index-490c634f.js";import{S as ue}from"./index-b890ef13.js";import{i as xe}from"./index.esm-3a436922.js";import{C as pe}from"./CheckIcon-8d6b6a3f.js";import{T as B}from"./index-c318460a.js";import"./InfoIcon-70b1ef6b.js";const R=/\btwitter\.com\/(?:@)?([\w_]+)(?:$|\?[^/]*$)/,fe=/(https?:\/\/)?(www\.)?youtube\.com\/watch\?v=([A-Za-z0-9_-]+)/,ge=/(https?:\/\/)?(www\.)?youtube\.com\/live\/([A-Za-z0-9_-]+)/,he=/(https?:\/\/)?(www\.)?youtu\.be\/([A-Za-z0-9_-]+)/,we=/https:\/\/twitter\.com\/i\/spaces\/([A-Za-z0-9_-]+)/,me=/https:\/\/twitter\.com\/[^/]+\/status\/(\d+)/,be=/(https?:\/\/)?([A-Za-z0-9_-]+)\.mp3/,ye=/(https?:\/\/)?(.*\.)?.+\/(feed|rss|rss.xml|.*.rss|.*\?(feed|format)=rss)$/,je=/https?:\/\/(www\.)?youtube\.com\/(user\/)?(@)?([\w-]+)/,ve=/^(https?|ftp):\/\/[^\s/$.?#].[^\s]*$/,Se=/https:\/\/twitter\.com\/i\/broadcasts\/([A-Za-z0-9_-]+)/;function $e(t){return[ge,Se,fe,he,we,be].some(i=>i.test(t))?C:je.test(t)?S:R.test(t)?b:me.test(t)?P:ye.test(t)?$:ve.test(t)?I:U}const _e=(t,s="")=>{const r=(s===b?R:/@(\w+)/).exec(t);return r?r[1]:null},N=t=>!!t&&[b,S,$].includes(t),Ee=({onClick:t,loading:s,type:i,error:r})=>{const n=D(d=>d.budget),[p,c]=f.useState(10),a=N(i)?"radar":"add_node";return f.useEffect(()=>{(async()=>{try{const u=await J(a);c(u.data.price)}catch(u){console.error("cannot fetch",u)}})()},[a]),e.jsxs(o,{children:[e.jsx(o,{align:"center",direction:"row",justify:"space-between",mb:20,children:e.jsx(o,{align:"center",direction:"row",children:e.jsx(Be,{children:"Approve Cost"})})}),e.jsxs(o,{align:"center",direction:"row",justify:"space-between",mb:20,children:[e.jsxs(ke,{children:[e.jsx("div",{className:"title",children:"COST"}),e.jsxs("div",{className:"value","data-testid":"check-price",children:[p," sats"]})]}),e.jsxs(ze,{children:[e.jsx("div",{className:"title",children:"BUDGET"}),e.jsxs("div",{className:"value",children:[X(n)," sats"]})]})]}),e.jsx(o,{children:e.jsx(w,{color:"secondary","data-testid":"check-icon",disabled:s||!!r,onClick:t,size:"large",startIcon:s?e.jsx(ae,{size:24}):e.jsx(pe,{}),type:"submit",variant:"contained",children:"Approve"})}),r?e.jsxs(Re,{role:"tooltip",children:[e.jsxs(Ce,{children:[e.jsx(xe,{className:"errorIcon"}),e.jsx("span",{children:r})]}),e.jsx("div",{className:"tooltip",children:r})]}):null]})},ke=x(o).attrs({direction:"column",align:"space-between",justify:"flex-start"})`
  width: 141px;
  height: 61px;
...
`,De=/^(https?:\/\/)/g,Ze=/(www\.)?/g,Oe=/[\w-]+(\.[\w-]+)*/g,Fe=/(?:\.[a-zA-Z0-9][a-zA-Z0-9-]{0,61})[a-zA-Z0-9](?:\.[a-zA-Z]{2,})/g,Ge=/(\/[^\s?]*)?/g,Me=/(\?[^\s]*)?/g,Z=new RegExp(`${De.source}${Ze.source}${Oe.source}${Fe.source}?${Ge.source}${Me.source}$`,"i"),O=t=>Z.test(t),Ye=({type:t,onNextStep:s,allowNextStep:i})=>e.jsxs(o,{children:[e.jsx(o,{align:"center",direction:"row",justify:"space-between",mb:18,children:e.jsx(o,{align:"center",direction:"row",children:e.jsx(Ve,{children:"Add Content"})})}),e.jsx(o,{mb:12,children:e.jsx(B,{id:"cy-youtube-channel-id",maxLength:250,name:"source",placeholder:"Paste your url here...",rules:{...K,...t!==C?{pattern:{message:"Please enter a valid URL",value:Z},validate:{source:O}}:{}}})}),e.jsx(o,{children:e.jsx(w,{color:"secondary","data-testid":"add-content-btn",disabled:!i,onClick:s,size:"large",variant:"contained",children:"Next"})})]}),Ve=x(y)`
  font-size: 22px;
  font-weight: 600;
  font-family: 'Barlow';
`,z={[b]:{label:"Twitter handle",img:"twitter_default.svg"},[S]:{label:"Youtube channel",img:"youtube_default.svg"},[$]:{label:"RSS Feed",img:"rss_feed.svg"}},We=({onNextStep:t,onPrevStep:s,type:i,value:r})=>e.jsxs(o,{children:[e.jsx(o,{align:"center",direction:"row",justify:"space-between",mb:20,children:e.jsx(o,{align:"center",direction:"row",children:e.jsx(He,{children:"Source Type"})})}),e.jsxs(o,{mb:20,children:[e.jsxs(Je,{children:[e.jsx("img",{alt:z[i].label,className:"badge__img",src:z[i].img}),e.jsx(Xe,{children:z[i].label})]}),e.jsx(qe,{children:_e(r,i)??r})]}),e.jsxs(o,{direction:"row",children:[e.jsx(o,{grow:1,children:e.jsx(Ke,{color:"secondary",disabled:!1,onClick:()=>s(),size:"large",variant:"contained",children:"Cancel"})}),e.jsx(o,{grow:1,ml:20,children:e.jsx(w,{color:"secondary","data-testid":"source_next_btn",onClick:()=>t(),size:"large",variant:"contained",children:"Next"})})]})]}),qe=x(o)`
  font-family: Barlow;
  font-size: 14px;
  font-weight: 400;
  line-height: 16px;
