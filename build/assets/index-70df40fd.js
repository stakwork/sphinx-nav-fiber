import{s as v,g as q,T as F,F as n,r as x,aA as $,j as e,b3 as J,b4 as K,bk as Q,B as E,bl as U,k as X,bm as Z,E as L,l as N,b2 as O,b6 as ee,n as te,bD as re,bI as ne}from"./index-a2c8d9e8.js";import{p as V}from"./index-b4a141ad.js";import{C as G}from"./ClipLoader-40c52708.js";import{e as W}from"./index-3bc9014e.js";import{A as Y}from"./index-3c4c2653.js";import{c as oe}from"./index-64f1c910.js";import"./three.module-9722a9fc.js";import"./index-5cb2056c.js";import"./SourcesTableIcon-47084140.js";import"./CheckIcon-0cb79077.js";import"./DeleteNodeIcon-f4bc9209.js";import"./SoundIcon-7148f7e9.js";import"./SucessFeedBackIcon-d7c64501.js";import"./Stack-071c32d6.js";import"./clsx-703a72e2.js";import"./createSvgIcon-585840d0.js";import"./TextareaAutosize-16ed010b.js";const B=s=>s.charAt(0).toUpperCase()+s.slice(1).replace(/_/g," "),R=s=>s?[...s].sort((l,m)=>Number(m.required)-Number(l.required)):[],H=s=>s?s.filter(l=>l.key!=="node_key"):[],se=({handleSelectType:s,skipToStep:l,nodeType:m,selectedValues:r})=>{const[f,w]=x.useState(!1),[h,C]=x.useState(),{watch:j,formState:{isValid:t}}=$();x.useEffect(()=>{(async()=>{w(!0);const o=await U(m),T=V(o),A=H(T);C(A),w(!1)})()},[m,j]);const a=c=>c.charAt(0).toUpperCase()+c.slice(1).replace(/_/g," "),p=(h?[...h].sort((c,o)=>c.required&&!o.required?-1:!c.required&&o.required?1:0):[]).filter(c=>!!(c.required&&!Object.values(r).includes(c.key))),S=()=>{s(""),l("sourceType")},b=!t||f||p.some(c=>{var o;return c.required&&!((o=j(c.key))!=null&&o.trim())});return e.jsxs(n,{children:[e.jsx(n,{align:"center",direction:"row",justify:"space-between",mb:18,children:e.jsx(n,{align:"center",direction:"row",children:e.jsx(ae,{children:"Required Properties"})})}),e.jsx(ie,{children:f?e.jsx(n,{style:{margin:"auto"},children:e.jsx(G,{color:q.SECONDARY_BLUE})}):e.jsx(n,{className:"input__wrapper",children:p==null?void 0:p.map(({key:c,required:o})=>e.jsx(e.Fragment,{children:e.jsxs(ce,{children:[e.jsx(F,{children:a(c)}),e.jsx(J,{id:"item-name",maxLength:50,name:c,placeholder:o?"Required":"Optional",rules:{...o?{...K,pattern:{message:"No leading whitespace allowed",value:Q}}:{}}})]})}))})}),e.jsxs(n,{direction:"row",children:[e.jsx(n,{grow:1,children:e.jsx(E,{color:"secondary",onClick:S,size:"large",variant:"contained",children:"Prev"})}),e.jsx(n,{grow:1,ml:20,children:e.jsx(E,{color:"secondary",disabled:b,onClick:()=>l("createConfirmation"),size:"large",variant:"contained",children:"Next"})})]})]})},ae=v(F)`
  font-size: 22px;
  font-weight: 600;
  font-family: 'Barlow';
`,ie=v(n)`
