import{f as y,h as w,F as t,T as S,x as M,r as f,j as e,bd as V,be as W,C as z,b1 as H,I as K,b3 as Q,i as X,b2 as N,U as I,bi as Z,o as ee,bg as te}from"./index-868deac8.js";import{B as T,C as O,i as se,c as oe,F as ne}from"./react-toastify.esm-101dcdbf.js";import{B as re}from"./index-713b4898.js";import{u as F}from"./index-14b3611b.js";import{S as ie}from"./index-b3e0ec32.js";import{g as ae}from"./index.esm-c1669f03.js";import{C as ce}from"./CheckIcon-49294084.js";import{p as le}from"./index-30d16895.js";import{T as E}from"./index-b551a24c.js";import{A as de}from"./index-706096d9.js";import{d as pe,i as me}from"./index-56036316.js";import"./InfoIcon-c3976789.js";import"./index-5d4f2051.js";import"./Popover-e899d7aa.js";import"./useSlotProps-482ef632.js";import"./Popper-80161bbf.js";import"./generateCategoricalChart-46b83d2f.js";import"./NoFilterResultIcon-8a7e73ef.js";import"./index-acea9d31.js";import"./index-734804c1.js";import"./PlusIcon-5e677cb2.js";const xe=({onClick:s,loading:p,error:c})=>{const u=M(i=>i.budget),[x,o]=f.useState(10),a="node";return f.useEffect(()=>{(async()=>{try{const h=await W(a);o(h.data.price)}catch(h){console.error("cannot fetch",h)}})()},[a]),e.jsxs(t,{children:[e.jsx(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:e.jsx(t,{align:"center",direction:"row",children:e.jsx(fe,{children:"Approve Cost"})})}),e.jsxs(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:[e.jsxs(ue,{children:[e.jsx("div",{className:"title",children:"COST"}),e.jsxs("div",{className:"value","data-testid":"check-price",children:[x," sats"]})]}),e.jsxs(he,{children:[e.jsx("div",{className:"title",children:"BUDGET"}),e.jsxs("div",{className:"value",children:[V(u)," sats"]})]})]}),e.jsx(t,{children:e.jsx(T,{color:"secondary","data-testid":"check-icon",disabled:p||!!c,onClick:s,size:"large",startIcon:p?e.jsx(O,{size:24}):e.jsx(ce,{}),type:"submit",variant:"contained",children:"Approve"})}),c?e.jsxs(ge,{role:"tooltip",children:[e.jsxs(ye,{children:[e.jsx(ae,{fontSize:13}),e.jsx("span",{children:c})]}),e.jsx("div",{className:"tooltip",children:c})]}):null]})},ue=y(t).attrs({direction:"column",align:"space-between",justify:"flex-start"})`
  width: 141px;
  height: 61px;
