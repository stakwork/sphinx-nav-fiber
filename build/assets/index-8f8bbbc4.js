import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-3fb2e077.js";import{B as M}from"./index-a5fae7df.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-c151614c.js";import{B as f,T as L,a as R}from"./index-28dab58a.js";import{T as x}from"./index-4bdbc90a.js";import"./useSlotProps-f7128b91.js";import"./index.esm-7917f03c.js";import"./InfoIcon-69394f20.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
