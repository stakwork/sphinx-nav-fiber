import{s as r,F as n,T as g,j as e,b as w,c as p,r as A,u as B}from"./index-0f2842f8.js";import{B as v}from"./index-71db722a.js";import{u as F}from"./index-f4237ea6.js";import{u as M,l as $,b,q as C,F as D}from"./react-toastify.esm-d78d06ca.js";import{G}from"./index-5112fe59.js";import{B as f,T as k,a as R}from"./index-58ab0eb3.js";import{T as x}from"./index-cd30f246.js";import{C as L}from"./ClipLoader-4f278958.js";import"./useSlotProps-1dfe6bde.js";import"./index.esm-90dac6c5.js";import"./InfoIcon-94a478fc.js";const P=({onClose:s})=>{const[a]=M(t=>[t.graphStyle]),i=()=>{localStorage.setItem("graphStyle",a),s()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(G,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:i,children:"Save changes"})})]})},V=r(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=r(g)`
