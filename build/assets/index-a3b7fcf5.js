import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-50ecd99b.js";import{B}from"./index-f08526e2.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-fd33ffdd.js";import{B as f,T as $,a as k}from"./index-15cd7d9f.js";import{T as u}from"./index-6c0fbac2.js";import"./useSlotProps-b7404ee0.js";import"./index.esm-559d8ba1.js";import"./InfoIcon-960f3051.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
