import{s as i,g as t,F as c,j as e,a6 as j,r as l,c as C,B as w,bx as S,bz as R,b0 as z}from"./index-a72a3fe9.js";import{g as D,e as I}from"./index-e5a87bfd.js";import{D as T}from"./DeleteNodeIcon-6724a560.js";import{S as E}from"./Skeleton-6cc6c357.js";import{C as L}from"./ClipLoader-00d306a8.js";const M=({nodeName:p})=>e.jsx(c,{children:e.jsxs(c,{align:"center",direction:"column",justify:"space-between",children:[e.jsx(G,{children:e.jsx(T,{})}),e.jsxs(A,{children:["Are you sure you want to delete ",p||"this item","?"]})]})}),A=i(c)`
  color: ${t.white};
  font-family: 'Barlow';
  font-size: 20px;
  font-weight: 400;
