import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-6e53b845.js";import{B}from"./index-1641e3f9.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-6f404510.js";import{B as f,T as $,a as k}from"./index-2ed6b8a3.js";import{T as u}from"./index-08ed1ddf.js";import"./useSlotProps-c04af8a9.js";import"./index.esm-6d9dcba1.js";import"./InfoIcon-975a9ea1.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
