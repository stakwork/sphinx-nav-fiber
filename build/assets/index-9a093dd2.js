import{o as s,q as l,F as n,p as w,j as e,t as G,v as C,T as S,r as f,A as v,aU as A,aV as b,aW as I,J as B,O as y}from"./index-be10f8ce.js";import{B as z}from"./index-50e8b44f.js";import{u as M,G as k,C as D,l as E,o as R,B as T,i as W,F}from"./index-0e3965b5.js";import{C as $}from"./ClipLoader-389c5e78.js";import{T as j}from"./index-ac0f5dbc.js";import{S as P}from"./index-61c9660f.js";import{e as V}from"./index.esm-ae1c96be.js";import{T as L,a as N}from"./Tabs-169e63e5.js";import"./InfoIcon-2bf67538.js";import"./useSlotProps-740ca19a.js";import"./createSvgIcon-6b2f6e6a.js";const O={split:e.jsx(k,{}),force:e.jsx(D,{}),sphere:e.jsx(E,{}),earth:e.jsx(R,{})},Y=()=>{const[i,p]=w(M(t=>[t.graphStyle,t.setGraphStyle])),r=t=>{p(t)};return e.jsx(q,{direction:"column",children:G.map(t=>e.jsx(n,{className:C("icon",{active:i===t}),onClick:()=>r(t),children:O[t]},t))})},q=s(n).attrs({direction:"row",align:"center",justify:"space-between"})`
  width: 447px;
  height: 48px;
