import{o as s,q as l,F as n,p as w,j as e,t as G,v as C,T as S,r as f,A as v,aU as A,aV as b,aW as I,J as B,O as y}from"./index-25c57a6f.js";import{B as z}from"./index-361d19fd.js";import{u as M,G as k,C as D,l as E,o as R,B as T,i as W,F}from"./index-32a7e40b.js";import{C as $}from"./ClipLoader-6e8d703b.js";import{T as j}from"./index-bd2a728a.js";import{S as P}from"./index-d9a33623.js";import{e as V}from"./index.esm-39f663a2.js";import{T as L,a as N}from"./Tabs-04d846d0.js";import"./InfoIcon-18853efe.js";import"./useSlotProps-cf69f366.js";import"./createSvgIcon-4ca87f7d.js";const O={split:e.jsx(k,{}),force:e.jsx(D,{}),sphere:e.jsx(E,{}),earth:e.jsx(R,{})},Y=()=>{const[i,p]=w(M(t=>[t.graphStyle,t.setGraphStyle])),r=t=>{p(t)};return e.jsx(q,{direction:"column",children:G.map(t=>e.jsx(n,{className:C("icon",{active:i===t}),onClick:()=>r(t),children:O[t]},t))})},q=s(n).attrs({direction:"row",align:"center",justify:"space-between"})`
  width: 447px;
  height: 48px;
