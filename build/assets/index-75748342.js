import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-6073401a.js";import{B as M}from"./index-13a2d914.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-dc7c60da.js";import{B as f,T as L,a as R}from"./index-44c0478b.js";import{T as x}from"./index-b8f3fc2b.js";import"./useSlotProps-4ac496cf.js";import"./index.esm-3262925e.js";import"./InfoIcon-9b7fc1c3.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
