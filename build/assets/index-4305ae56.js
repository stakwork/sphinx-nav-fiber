import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,C as B,h as c,r as v,x as C}from"./index-1300f0ef.js";import{B as F}from"./index-d1cd1b9e.js";import{u as M}from"./index-ba5348db.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-75d66889.js";import{B as f,T as L,a as R}from"./index-526e2883.js";import{T as x}from"./index-46be9622.js";import"./useSlotProps-c9ef76fb.js";import"./index.esm-a491eb8d.js";import"./InfoIcon-5c7eabc5.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
