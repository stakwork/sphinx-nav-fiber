import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-868deac8.js";import{B as F}from"./index-713b4898.js";import{u as M}from"./index-14b3611b.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-101dcdbf.js";import{B as f,T as R,a as L}from"./index-acea9d31.js";import{T as x}from"./index-b551a24c.js";import"./useSlotProps-482ef632.js";import"./index.esm-c1669f03.js";import"./InfoIcon-c3976789.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
