import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-a077ec8a.js";import{B as F}from"./index-a3fc54ec.js";import{u as M}from"./index-c7fa7ded.js";import{j as $,e as k,F as D,C as G}from"./react-toastify.esm-2e85d31b.js";import{B as f,T as R,a as L}from"./index-9c873f5f.js";import{T as x}from"./index-01b39df6.js";import"./useSlotProps-05454b58.js";import"./index.esm-fdc46f52.js";import"./InfoIcon-cf5027b4.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
