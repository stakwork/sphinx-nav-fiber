import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,C as B,h as c,r as v,x as C}from"./index-de65a059.js";import{B as F}from"./index-3537682f.js";import{u as M}from"./index-1facabef.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-b3f3bada.js";import{B as f,T as L,a as R}from"./index-bf931a83.js";import{T as x}from"./index-907346e7.js";import"./useSlotProps-e6feb908.js";import"./index.esm-12eb68ed.js";import"./InfoIcon-b76b65b4.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
