import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,C as B,h as c,r as v,x as C}from"./index-cd0b1e97.js";import{B as F}from"./index-d143d916.js";import{u as M}from"./index-355ecf0b.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-dd8bbc41.js";import{B as f,T as L,a as R}from"./index-cdb57877.js";import{T as x}from"./index-c35025f1.js";import"./useSlotProps-48f60287.js";import"./index.esm-75a7e6db.js";import"./InfoIcon-54e44c70.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
