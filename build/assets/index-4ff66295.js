import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h as x,r as T,x as v,B as m}from"./index-9a37bc59.js";import{B}from"./index-490c634f.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-81e38af5.js";import{B as f,T as $,a as k}from"./index-9c3745a9.js";import{T as u}from"./index-c318460a.js";import"./useSlotProps-bf29779c.js";import"./index.esm-3a436922.js";import"./InfoIcon-70b1ef6b.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
