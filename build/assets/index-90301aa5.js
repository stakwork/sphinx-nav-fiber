import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,x as D,B as F}from"./index-4cb4a5af.js";import{B as M}from"./index-34da1bd7.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-637e09eb.js";import{B as f,T as L,a as R}from"./index-d861b9cb.js";import{T as x}from"./index-c192a354.js";import"./useSlotProps-419e62d5.js";import"./index.esm-8c75acaf.js";import"./InfoIcon-93659641.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
