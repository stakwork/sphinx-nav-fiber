import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-473e9613.js";import{B as M}from"./index-e0df1c4d.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-8ea40dcb.js";import{B as f,T as L,a as R}from"./index-caf2152c.js";import{T as x}from"./index-081eea88.js";import"./useSlotProps-20963a6a.js";import"./index.esm-8fbb4ed1.js";import"./InfoIcon-097fd6c3.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
