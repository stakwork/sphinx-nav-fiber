import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,x as D,B as F}from"./index-6f683887.js";import{B as M}from"./index-fd6fe90b.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-00724a2d.js";import{B as f,T as L,a as R}from"./index-be7e134c.js";import{T as x}from"./index-69d18388.js";import"./useSlotProps-7b782c1a.js";import"./index.esm-f608fb77.js";import"./InfoIcon-6cbc83e0.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
