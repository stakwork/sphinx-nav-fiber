import{r as i,j as e,s as u,g as h,F as y,o as Z,c as ee,A as pe,p as X,i as de,q as ue,H as me,t as fe,v as he}from"./index-90b40932.js";import{ClaimsModal as ge}from"./index-e09bc42a.js";import{U as xe}from"./index-dbe10d2e.js";import{t as Y,u as F}from"./index-869e7090.js";import{u as P,a as ye,b as be,I as we,c as te,d as je}from"./index-e704322b.js";import{M as ve,V as ke}from"./index-0779cd2a.js";import{S as Se,R as Ce,s as U,M as Te}from"./index-0cec472d.js";import"./string-a277709d.js";import"./index-af4be033.js";import"./three.module-9722a9fc.js";import"./isPlainObject-928598a1.js";import"./TextareaAutosize-3b31c3b2.js";import"./CheckIcon-c876fcd0.js";import"./index-08656954.js";import"./index-8f70e394.js";import"./index-cfccb09f.js";import"./ClipLoader-b126851a.js";import"./clsx-c0cead1b.js";import"./SourcesTableIcon-c2ca82b7.js";import"./DeleteNodeIcon-14b8d438.js";import"./SoundIcon-5b4925f1.js";import"./SucessFeedBackIcon-1e3cdd17.js";import"./Skeleton-7b0e53d5.js";import"./index-2bb97cc0.js";import"./Stack-34f6f9c8.js";import"./FormControlLabel-66dfc46b.js";import"./Typography-5231a50f.js";import"./createSvgIcon-b966d941.js";const re=i.memo(()=>{const s=P(a=>a.isPlaying),c=P(a=>a.setIsPlaying),t=P(a=>a.setVolume),r=P(a=>a.setPlaybackSpeed),l=P(a=>a.playbackSpeed),n=P(a=>a.playerRef),[p,g]=i.useState(!1),b=[.5,1,1.5,2],f=()=>{if(n){const a=n.getCurrentTime()-15;n.seekTo(a,"seconds")}},m=()=>{if(n){const a=n.getCurrentTime()+15;n.seekTo(a,"seconds")}},v=()=>{c(!s)},d=()=>{g(!p),t(p?1:0)},o=()=>{const j=(b.indexOf(l)+1)%b.length,C=b[j];if(r(C),n){const E=n.getInternalPlayer();E&&typeof E.playbackRate<"u"&&(E.playbackRate=C)}};return e.jsxs($e,{children:[e.jsx(Re,{onClick:d,children:p?e.jsx(ve,{}):e.jsx(ke,{})}),e.jsx(Ie,{onClick:f,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(Pe,{"data-testid":"play-pause-button",onClick:v,size:"small",children:s?e.jsx(ye,{"data-testid":"pause-icon"}):e.jsx(be,{"data-testid":"play-icon"})}),e.jsx(_e,{onClick:m,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(Ee,{onClick:o,children:[l,"x"]})]})});re.displayName="Controls";const $e=u(y).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${h.BG1};
  border-radius: 40px;
