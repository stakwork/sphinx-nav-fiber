import{Q as n,j as e,U as r,ar as b,a5 as a,S as i,ad as w,r as m,ax as j}from"./index-0a03077a.js";import{aK as C,B as S,af as y,aG as k,ag as v}from"./index-a683effe.js";import{S as F}from"./index-3e2fdae0.js";const B=({allowNextStep:t})=>e.jsxs(r,{p:12,children:[e.jsx(r,{align:"center",direction:"row",justify:"space-between",mb:25,children:e.jsx(r,{align:"center",direction:"row",children:e.jsx(E,{children:"Feedback"})})}),e.jsx(r,{mb:30,children:e.jsx(C,{id:"feedback-message",isTextArea:!0,maxLength:500,name:"message",placeholder:"Leave your feedback here ...",rules:b})}),e.jsx(r,{children:e.jsx(S,{color:"secondary","data-testid":"submit-feedback-btn",disabled:!t,size:"large",type:"submit",variant:"contained",children:"Submit"})})]}),E=n(a)`
  font-size: 22px;
  font-weight: 600;
  font-family: 'Barlow';
