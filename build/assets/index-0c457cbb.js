import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-44236261.js";import{B as F}from"./index-1b6390ff.js";import{u as M}from"./index-00f176fd.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-6fa51cf6.js";import{B as f,T as R,a as L}from"./index-ba7a6ec7.js";import{T as x}from"./index-57a0a997.js";import"./useSlotProps-6641d2c4.js";import"./index.esm-aaf3f4f3.js";import"./InfoIcon-387675be.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
