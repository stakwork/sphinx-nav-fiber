import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,x as D,B as F}from"./index-ca78a1e8.js";import{B as M}from"./index-0e79c332.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-533078ce.js";import{B as f,T as L,a as R}from"./index-f8f0027b.js";import{T as x}from"./index-e03020cb.js";import"./useSlotProps-9a8d89a0.js";import"./index.esm-905457dc.js";import"./InfoIcon-b39381d2.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
