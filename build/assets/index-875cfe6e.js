import{f as d,h as l,T as B,j as e,F as a,C as w,r as n,a3 as V,z as $,D as A}from"./index-52024500.js";import{B as P}from"./index-cc66ee43.js";import{u as g}from"./index-2e55df55.js";import{c as q,F as G,B as E,C as H}from"./react-toastify.esm-739c0953.js";import{T as S}from"./index-e83f96cb.js";import{S as O}from"./Skeleton-9ce17550.js";import"./index.esm-63ae20b6.js";import"./InfoIcon-3a6553a6.js";const _=/^https:\/\/.*\.(png|jpg|svg)$/;function C(s){return!!_.test(s)}const W=({isValidImageUrl:s})=>e.jsxs(a,{children:[e.jsx(a,{align:"center",direction:"row",justify:"space-between",mb:18,children:e.jsx(a,{align:"center",direction:"row",children:e.jsx(Y,{children:"Edit Node"})})}),e.jsxs(a,{mb:18,children:[e.jsx(T,{style:{marginBottom:8},children:"Node Name"}),e.jsx(S,{id:"cy-topic",maxLength:50,name:"topic",placeholder:"Node name",rules:{...w}})]}),e.jsxs(a,{mb:36,children:[e.jsx(T,{style:{marginBottom:8},children:"image_url"}),e.jsx(S,{id:"cy-image_url",maxLength:500,name:"image_url",placeholder:"image_url",rules:{...w,...s?{}:{pattern:{message:"Please enter a valid URL",value:_},validate:{source:C}}}})]})]}),Y=d(B)`
  font-size: 22px;
  font-weight: 600;
  font-family: 'Barlow';
`,T=d(B)`
