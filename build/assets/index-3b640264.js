import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-7b36ec6a.js";import{B as M}from"./index-79b780a4.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-df410821.js";import{B as f,T as L,a as R}from"./index-75c4da1f.js";import{T as x}from"./index-7460f01a.js";import"./useSlotProps-84a66985.js";import"./index.esm-8348f3bd.js";import"./InfoIcon-09093f00.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
