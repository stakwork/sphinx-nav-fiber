import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-ed80bd96.js";import{B as M}from"./index-c51e0ecb.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-5f8b7feb.js";import{B as f,T as L,a as R}from"./index-32999536.js";import{T as x}from"./index-2560aa4e.js";import"./useSlotProps-69db817a.js";import"./index.esm-7e88b758.js";import"./InfoIcon-401223be.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
