import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-58e9a183.js";import{B}from"./index-f002045f.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-50279b0f.js";import{B as f,T as $,a as k}from"./index-b7ac6a29.js";import{T as u}from"./index-303653b7.js";import"./useSlotProps-5b636426.js";import"./index.esm-408adbb5.js";import"./InfoIcon-651c99cc.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
