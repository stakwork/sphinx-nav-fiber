import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-84dcd456.js";import{B as F}from"./index-ba9d5983.js";import{u as M}from"./index-9a70c8a3.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-d4bb52c4.js";import{B as f,T as R,a as L}from"./index-1864ffb0.js";import{T as x}from"./index-f2858eeb.js";import"./useSlotProps-1cfec523.js";import"./index.esm-0b011f67.js";import"./InfoIcon-10592c24.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
