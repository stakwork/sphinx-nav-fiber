import{f as y,h as w,F as t,T as S,x as M,r as f,j as e,be as W,bf as H,D as E,b2 as K,J as Q,b4 as X,B as I,i as Z,b3 as C,W as P,bj as ee,o as te,bh as se}from"./index-fb31d390.js";import{B as T,C as O,i as oe,c as ne,F as re}from"./react-toastify.esm-57f40ec2.js";import{B as ie}from"./index-7e2f0a96.js";import{S as ae}from"./index-c5a5b6df.js";import{g as ce}from"./index.esm-519381f7.js";import{C as le}from"./CheckIcon-6ed5f7bb.js";import{p as de}from"./index-30d16895.js";import{T as L}from"./index-7a31d9a5.js";import{n as pe,d as z,e as me,i as xe}from"./index-2dd1d20a.js";import{A as ue}from"./index-c5235d62.js";import{c as he}from"./index-64f1c910.js";import"./InfoIcon-20459dc9.js";import"./generateCategoricalChart-3ba225ca.js";import"./Popover-f212ad72.js";import"./useSlotProps-ce20eba7.js";import"./NoFilterResultIcon-d6475d4b.js";import"./index-55fe2d6c.js";import"./index-73c70fd7.js";import"./PlusIcon-cfbbaa85.js";import"./index-aa3a1823.js";import"./Popper-aca8c8d0.js";const fe=({onClick:o,loading:p,error:c})=>{const u=M(a=>a.budget),[m,s]=f.useState(10),i="node";return f.useEffect(()=>{(async()=>{try{const h=await H(i);s(h.data.price)}catch(h){console.error("cannot fetch",h)}})()},[i]),e.jsxs(t,{children:[e.jsx(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:e.jsx(t,{align:"center",direction:"row",children:e.jsx(je,{children:"Approve Cost"})})}),e.jsxs(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:[e.jsxs(ye,{children:[e.jsx("div",{className:"title",children:"COST"}),e.jsxs("div",{className:"value","data-testid":"check-price",children:[m," sats"]})]}),e.jsxs(ge,{children:[e.jsx("div",{className:"title",children:"BUDGET"}),e.jsxs("div",{className:"value",children:[W(u)," sats"]})]})]}),e.jsx(t,{children:e.jsx(T,{color:"secondary","data-testid":"check-icon",disabled:p||!!c,onClick:o,size:"large",startIcon:p?e.jsx(O,{size:24}):e.jsx(le,{}),type:"submit",variant:"contained",children:"Approve"})}),c?e.jsxs(be,{role:"tooltip",children:[e.jsxs(we,{children:[e.jsx(ce,{fontSize:13}),e.jsx("span",{children:c})]}),e.jsx("div",{className:"tooltip",children:c})]}):null]})},ye=y(t).attrs({direction:"column",align:"space-between",justify:"flex-start"})`
  width: 141px;
  height: 61px;
