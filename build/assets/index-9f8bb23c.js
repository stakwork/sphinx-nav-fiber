import{o as s,F as o,T as w,p as C,r as f,j as e,q as c,A as S,aU as A,aV as b,aW as z,J as D,O as y}from"./index-1e07c6e6.js";import{B as G}from"./index-a3ef1307.js";import{G as M,B as v,h as $,F as B}from"./index-5f76aef8.js";import{C as T}from"./ClipLoader-79e437be.js";import{T as j}from"./index-827a4deb.js";import{S as E}from"./index-526ae08e.js";import{e as I}from"./index.esm-9bc5b588.js";import{T as k,a as F}from"./Tabs-e582c0c2.js";import"./InfoIcon-d3d33dec.js";import"./useSlotProps-5c7d8a26.js";import"./createSvgIcon-6319588a.js";const R=({onClose:a})=>{const[l]=C(d=>[d.graphStyle]),[r,i]=f.useState(!1),p=()=>{i(!0),localStorage.setItem("graphStyle",l),i(!1),a()};return e.jsxs(W,{direction:"column",children:[e.jsx(V,{children:"Default graph view:"}),e.jsx(M,{}),e.jsx(o,{mt:308,py:24,children:e.jsx(v,{color:"secondary",disabled:r,id:"add-node-submit-cta",onClick:p,size:"large",startIcon:r&&e.jsx(L,{children:e.jsx(T,{color:c.lightGray,size:12})}),type:"submit",variant:"contained",children:"Save Changes"})})]})},W=s(o)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,V=s(w)`
