import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-383e0c8b.js";import{B as M}from"./index-80cb1ac9.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-064ddb25.js";import{B as f,T as L,a as R}from"./index-76264462.js";import{T as x}from"./index-b9c662ce.js";import"./useSlotProps-39eda9f8.js";import"./index.esm-32fe5a81.js";import"./InfoIcon-00f7404d.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
