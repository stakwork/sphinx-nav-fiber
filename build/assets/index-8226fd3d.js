import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,C as B,h as c,r as v,x as C}from"./index-659df10a.js";import{B as F}from"./index-3652260a.js";import{u as M}from"./index-53b0bc65.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-6120373c.js";import{B as f,T as L,a as R}from"./index-17c113fd.js";import{T as x}from"./index-fdaf0b4c.js";import"./useSlotProps-ff692886.js";import"./index.esm-581f5c21.js";import"./InfoIcon-b4da5800.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
