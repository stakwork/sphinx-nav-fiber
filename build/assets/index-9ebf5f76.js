import{r as o,j as e,s as f,g as v,F as j,o as Y,c as J,A as ae,p as ie,i as ce,q as le,H as pe,t as de,v as ue}from"./index-59a682e9.js";import{t as U,u as G,C as me}from"./index-d6c718b3.js";import{U as fe}from"./index-c483e239.js";import{u as M,a as he,b as ge,I as xe,c as K,d as ye}from"./index-5721889e.js";import{M as we,V as be}from"./index-e82db91d.js";import{S as je,R as ve,s as V,M as Se}from"./index-7f49a6c7.js";import"./string-a277709d.js";import"./index-3b47b10c.js";import"./three.module-9722a9fc.js";import"./isPlainObject-8a8197e0.js";import"./TextareaAutosize-8a77c498.js";import"./CheckIcon-b13a8e38.js";import"./index-7fe89f36.js";import"./index-2bbd0b61.js";import"./index-f214e675.js";import"./ClipLoader-16d3ade8.js";import"./clsx-e135f8b2.js";import"./SourcesTableIcon-a9fc3bff.js";import"./DeleteNodeIcon-8dd9e418.js";import"./SoundIcon-313ef194.js";import"./SucessFeedBackIcon-27cfd902.js";import"./Skeleton-57980856.js";import"./index-4bd21014.js";import"./Stack-c00e2122.js";import"./FormControlLabel-31a6b5f3.js";import"./Typography-7d11222d.js";import"./createSvgIcon-a17b63c2.js";const Q=o.memo(()=>{const r=M(s=>s.isPlaying),a=M(s=>s.setIsPlaying),n=M(s=>s.setVolume),t=M(s=>s.setPlaybackSpeed),c=M(s=>s.playbackSpeed),i=M(s=>s.playerRef),[d,g]=o.useState(!1),y=[.5,1,1.5,2],h=()=>{if(i){const s=i.getCurrentTime()-15;i.seekTo(s,"seconds")}},u=()=>{if(i){const s=i.getCurrentTime()+15;i.seekTo(s,"seconds")}},b=()=>{a(!r)},l=()=>{g(!d),n(d?1:0)},p=()=>{const m=(y.indexOf(c)+1)%y.length,P=y[m];if(t(P),i){const _=i.getInternalPlayer();_&&typeof _.playbackRate<"u"&&(_.playbackRate=P)}};return e.jsxs(ke,{children:[e.jsx(_e,{onClick:l,children:d?e.jsx(we,{}):e.jsx(be,{})}),e.jsx(Ie,{onClick:h,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(Ce,{"data-testid":"play-pause-button",onClick:b,size:"small",children:r?e.jsx(he,{"data-testid":"pause-icon"}):e.jsx(ge,{"data-testid":"play-icon"})}),e.jsx(Pe,{onClick:u,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(Te,{onClick:p,children:[c,"x"]})]})});Q.displayName="Controls";const ke=f(j).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${v.BG1};
  border-radius: 40px;
