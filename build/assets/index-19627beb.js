import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-02dfa4a2.js";import{B}from"./index-d3f304eb.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-38d31a46.js";import{B as f,T as $,a as k}from"./index-6a640f5b.js";import{T as u}from"./index-82eace29.js";import"./useSlotProps-15b68baf.js";import"./index.esm-ca635697.js";import"./InfoIcon-aee6b701.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
