import{r as o,j as e,s as f,g as v,F as j,o as Y,c as J,A as ae,p as ie,i as ce,q as le,H as pe,t as de,v as ue}from"./index-1b71a057.js";import{t as U,u as G,C as me}from"./index-6a8d4d52.js";import{U as fe}from"./index-9a902ddb.js";import{u as M,a as he,b as ge,I as xe,c as K,d as ye}from"./index-0d251521.js";import{M as we,V as be}from"./index-425c2f5b.js";import{S as je,R as ve,s as V,M as Se}from"./index-7c340d70.js";import"./string-a277709d.js";import"./index-509adaac.js";import"./three.module-9722a9fc.js";import"./index-df86bcb5.js";import"./TextareaAutosize-7ae53699.js";import"./CheckIcon-df27193d.js";import"./index-f1729483.js";import"./index-31f7e06b.js";import"./ClipLoader-58db09d5.js";import"./clsx-06d5be43.js";import"./SourcesTableIcon-a755ddc3.js";import"./DeleteNodeIcon-3aade908.js";import"./SoundIcon-31319fe1.js";import"./SucessFeedBackIcon-dd3de416.js";import"./Skeleton-642bd6db.js";import"./index-e70a137a.js";import"./Stack-6886350b.js";import"./FormControlLabel-62011a13.js";import"./Typography-88c9c377.js";import"./createSvgIcon-3fe7de21.js";import"./isPlainObject-11a8c139.js";const Q=o.memo(()=>{const r=M(s=>s.isPlaying),a=M(s=>s.setIsPlaying),n=M(s=>s.setVolume),t=M(s=>s.setPlaybackSpeed),c=M(s=>s.playbackSpeed),i=M(s=>s.playerRef),[d,g]=o.useState(!1),y=[.5,1,1.5,2],h=()=>{if(i){const s=i.getCurrentTime()-15;i.seekTo(s,"seconds")}},u=()=>{if(i){const s=i.getCurrentTime()+15;i.seekTo(s,"seconds")}},b=()=>{a(!r)},l=()=>{g(!d),n(d?1:0)},p=()=>{const m=(y.indexOf(c)+1)%y.length,P=y[m];if(t(P),i){const _=i.getInternalPlayer();_&&typeof _.playbackRate<"u"&&(_.playbackRate=P)}};return e.jsxs(ke,{children:[e.jsx(_e,{onClick:l,children:d?e.jsx(we,{}):e.jsx(be,{})}),e.jsx(Ie,{onClick:h,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(Ce,{"data-testid":"play-pause-button",onClick:b,size:"small",children:r?e.jsx(he,{"data-testid":"pause-icon"}):e.jsx(ge,{"data-testid":"play-icon"})}),e.jsx(Pe,{onClick:u,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(Te,{onClick:p,children:[c,"x"]})]})});Q.displayName="Controls";const ke=f(j).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${v.BG1};
  border-radius: 40px;
