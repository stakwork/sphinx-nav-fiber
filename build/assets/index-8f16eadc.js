import{f as y,h as w,F as t,T as S,x as M,r as f,j as e,be as V,bf as W,D as z,b2 as H,J as K,b4 as Q,B as A,i as X,b3 as N,W as I,bj as Z,o as ee,bh as te}from"./index-7a5d5012.js";import{B as T,C as O,i as se,c as oe,F as ne}from"./react-toastify.esm-c046aa1a.js";import{B as re}from"./index-7b0476c6.js";import{S as ie}from"./index-9ed7acbd.js";import{g as ae}from"./index.esm-3ce2f4b9.js";import{C as ce}from"./CheckIcon-cf59b780.js";import{p as le}from"./index-30d16895.js";import{T as E}from"./index-53f859b4.js";import{A as de}from"./index-5fa192ee.js";import{c as pe}from"./index-64f1c910.js";import{d as me,i as xe}from"./index-767cb578.js";import"./InfoIcon-bc59d455.js";import"./index-5ad10923.js";import"./Popover-bd80e400.js";import"./useSlotProps-51b9a9ac.js";import"./Popper-4f0e5d8a.js";import"./generateCategoricalChart-ee3d740d.js";import"./NoFilterResultIcon-0858e6a2.js";import"./index-7c5635c1.js";import"./index-83dffad8.js";import"./PlusIcon-18bf95fb.js";const ue=({onClick:s,loading:p,error:c})=>{const u=M(i=>i.budget),[x,o]=f.useState(10),a="node";return f.useEffect(()=>{(async()=>{try{const h=await W(a);o(h.data.price)}catch(h){console.error("cannot fetch",h)}})()},[a]),e.jsxs(t,{children:[e.jsx(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:e.jsx(t,{align:"center",direction:"row",children:e.jsx(ye,{children:"Approve Cost"})})}),e.jsxs(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:[e.jsxs(he,{children:[e.jsx("div",{className:"title",children:"COST"}),e.jsxs("div",{className:"value","data-testid":"check-price",children:[x," sats"]})]}),e.jsxs(fe,{children:[e.jsx("div",{className:"title",children:"BUDGET"}),e.jsxs("div",{className:"value",children:[V(u)," sats"]})]})]}),e.jsx(t,{children:e.jsx(T,{color:"secondary","data-testid":"check-icon",disabled:p||!!c,onClick:s,size:"large",startIcon:p?e.jsx(O,{size:24}):e.jsx(ce,{}),type:"submit",variant:"contained",children:"Approve"})}),c?e.jsxs(je,{role:"tooltip",children:[e.jsxs(ge,{children:[e.jsx(ae,{fontSize:13}),e.jsx("span",{children:c})]}),e.jsx("div",{className:"tooltip",children:c})]}):null]})},he=y(t).attrs({direction:"column",align:"space-between",justify:"flex-start"})`
  width: 141px;
  height: 61px;
