import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-76a52179.js";import{B as F}from"./index-16fdbeb6.js";import{u as M}from"./index-b5a2eb40.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-5c17218b.js";import{B as f,T as R,a as L}from"./index-2d39d47e.js";import{T as x}from"./index-d725a3c2.js";import"./useSlotProps-89371064.js";import"./index.esm-0646bd27.js";import"./InfoIcon-32b44e5c.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
