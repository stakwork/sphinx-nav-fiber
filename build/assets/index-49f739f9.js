import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-4b808054.js";import{B}from"./index-a890e1ee.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-b6b87b8c.js";import{B as f,T as $,a as k}from"./index-3c500b0b.js";import{T as u}from"./index-da02ad42.js";import"./useSlotProps-b300d459.js";import"./index.esm-2a83afce.js";import"./InfoIcon-9cda504a.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
