import{f as y,h as w,F as t,T as S,x as M,r as f,j as e,bd as V,be as W,C as z,b1 as H,I as K,b3 as Q,i as X,b2 as N,U as A,bi as Z,o as ee,bg as te}from"./index-76a52179.js";import{B as T,C as O,i as oe,c as se,F as re}from"./react-toastify.esm-5c17218b.js";import{B as ne}from"./index-16fdbeb6.js";import{u as I}from"./index-b5a2eb40.js";import{S as ie}from"./index-70076660.js";import{g as ae}from"./index.esm-0646bd27.js";import{C as ce}from"./CheckIcon-99bcd0fe.js";import{p as le}from"./index-30d16895.js";import{T as E}from"./index-d725a3c2.js";import{A as de}from"./index-b4697d28.js";import{c as pe}from"./index-64f1c910.js";import{d as me,i as xe}from"./index-e92aa59c.js";import"./InfoIcon-32b44e5c.js";import"./index-030d258a.js";import"./Popover-e38f54e5.js";import"./useSlotProps-89371064.js";import"./Popper-248ecc0c.js";import"./generateCategoricalChart-80f90bea.js";import"./NoFilterResultIcon-b0d5b737.js";import"./index-2d39d47e.js";import"./index-bdd23e38.js";import"./PlusIcon-d7013ac6.js";const ue=({onClick:o,loading:p,error:c})=>{const u=M(i=>i.budget),[x,s]=f.useState(10),a="node";return f.useEffect(()=>{(async()=>{try{const h=await W(a);s(h.data.price)}catch(h){console.error("cannot fetch",h)}})()},[a]),e.jsxs(t,{children:[e.jsx(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:e.jsx(t,{align:"center",direction:"row",children:e.jsx(ye,{children:"Approve Cost"})})}),e.jsxs(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:[e.jsxs(he,{children:[e.jsx("div",{className:"title",children:"COST"}),e.jsxs("div",{className:"value","data-testid":"check-price",children:[x," sats"]})]}),e.jsxs(fe,{children:[e.jsx("div",{className:"title",children:"BUDGET"}),e.jsxs("div",{className:"value",children:[V(u)," sats"]})]})]}),e.jsx(t,{children:e.jsx(T,{color:"secondary","data-testid":"check-icon",disabled:p||!!c,onClick:o,size:"large",startIcon:p?e.jsx(O,{size:24}):e.jsx(ce,{}),type:"submit",variant:"contained",children:"Approve"})}),c?e.jsxs(je,{role:"tooltip",children:[e.jsxs(ge,{children:[e.jsx(ae,{fontSize:13}),e.jsx("span",{children:c})]}),e.jsx("div",{className:"tooltip",children:c})]}):null]})},he=y(t).attrs({direction:"column",align:"space-between",justify:"flex-start"})`
  width: 141px;
  height: 61px;
