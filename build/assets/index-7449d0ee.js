import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,x as D,B as F}from"./index-7db479c4.js";import{B as M}from"./index-29c651f1.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-2a3173e7.js";import{B as f,T as L,a as R}from"./index-c1ff6617.js";import{T as x}from"./index-2ad151d6.js";import"./useSlotProps-a6d6f46a.js";import"./index.esm-03fb1f26.js";import"./InfoIcon-c95557bd.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
