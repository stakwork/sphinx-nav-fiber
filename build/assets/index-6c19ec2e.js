import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-126e8d6c.js";import{B}from"./index-756d12f6.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-c1afeea3.js";import{B as f,T as $,a as k}from"./index-a343af12.js";import{T as u}from"./index-fd0bf0d0.js";import"./useSlotProps-70ad245a.js";import"./index.esm-e6fc98a8.js";import"./InfoIcon-f9e1801f.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
