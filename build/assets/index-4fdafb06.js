import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-aa01c52c.js";import{B as F}from"./index-0df42892.js";import{u as M}from"./index-5a3b2997.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-13fbb65f.js";import{B as f,T as R,a as L}from"./index-b095d26f.js";import{T as x}from"./index-b6324c61.js";import"./useSlotProps-1faa8db1.js";import"./index.esm-0053ad53.js";import"./InfoIcon-f3b6451c.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
