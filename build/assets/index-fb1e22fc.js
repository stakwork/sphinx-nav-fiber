import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h as x,r as T,x as v,B as m}from"./index-7f808302.js";import{B}from"./index-9ec5ecf7.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-4df52b04.js";import{B as f,T as $,a as k}from"./index-3882507e.js";import{T as u}from"./index-2d8fa5f2.js";import"./useSlotProps-e49bab01.js";import"./index.esm-af752bfc.js";import"./InfoIcon-09d33252.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
