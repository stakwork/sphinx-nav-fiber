<<<<<<<< HEAD:build/assets/index-4d7eabd8.js
...
========
import{s as d,b as o,T as _,F as x,R as J,f as X,Y as Z,r as h,j as e,e as Fe,g as we,l as ye,h as Pe,i as de,k as Me}from"./index-3638940b.js";import{B as F}from"./index-5c254ae2.js";import{u as E}from"./index-f5d6928d.js";import{B,u as P,C as T,i as Oe,j as be,f as z,k as Se,I as R,p as Ge,l as A,m as M,n as ve,o as De,q as te,F as se,r as We,t as Te,v as Ye}from"./react-toastify.esm-885db80e.js";import{T as Ue,a as O,b as Ve,F as ee,M as oe,C as Ce,N as He,c as qe,D as ne,d as $e}from"./ChevronUpIcon-4003a75a.js";import{M as _e,a as ke,b as Qe,c as Ke,d as Je,e as Xe}from"./index.esm-8c22296c.js";import{P as G,I as D,a as re,F as ze}from"./Popover-4d2d4bf1.js";import{B as Ze,T as et}from"./index-a5de62c3.js";import{A as Ee,u as $}from"./index-7f73ce3c.js";import{P as Ne}from"./Popper-18a8fcf1.js";import{C as Be}from"./CheckIcon-26dd4570.js";import{C as Ae}from"./ChevronDownIcon-778d142b.js";import{S as tt}from"./SettingsIcon-eaa1db82.js";import{T as st,a as ot}from"./index-1726f8a3.js";import"./useSlotProps-18af0602.js";import"./InfoIcon-697d06d1.js";const j=d(Ue)`
>>>>>>>> fc7e1949f4075d3ee2f2600735b6b2b045e7e5de:build/assets/index-40df8cd5.js
  && {
    color: ${o.white};
    border: none;
...
`,Tt=({onSelect:t,selectedTopic:a})=>{const[r,i]=h.useState(!1),[p,f]=h.useState(""),[n,s]=h.useState([]),[l,c]=h.useState(!1),g=h.useRef(null);h.useEffect(()=>()=>s([]),[s]);const m=async u=>{const v={muted:"False",sort_by:Ee,search:u,skip:"0",limit:"1000"};c(!0);try{const S=await ve(v);s(S.data)}catch{s([])}finally{c(!1)}},w=h.useMemo(()=>ye.debounce(m,300),[]),y=u=>{t(u)},b=u=>{if(f(u),!u){s([]);return}u.length>2&&w(u)};return a?e.jsxs(_t,{children:[e.jsx("div",{className:"value",children:a.topic}),e.jsx(x,{className:"icon",onClick:()=>t(null),children:e.jsx(A,{})})]}):e.jsxs(e.Fragment,{children:[e.jsxs(G,{ref:g,component:"form",onSubmit:u=>u.preventDefault(),sx:{p:"2px 4px",display:"flex",alignItems:"center",width:200},children:[e.jsx(D,{inputProps:{"aria-label":"search topic"},onChange:u=>b(u.target.value),onFocus:()=>i(!0),placeholder:"Search",size:"small",sx:{ml:1,flex:1},value:p}),p&&e.jsxs(e.Fragment,{children:[e.jsx(ue,{"aria-label":"search",onClick:()=>b(""),type:"button",children:e.jsx(A,{})}),e.jsx(ne,{orientation:"vertical",sx:{height:28,m:.5}})]}),e.jsx(ue,{"aria-label":"search",type:"button",children:l?e.jsx(T,{color:o.white,size:24}):e.jsx(M,{})})]}),g.current&&n.length?e.jsx($t,{anchorEl:g.current,open:r,placement:"bottom",children:e.jsx(e.Fragment,{children:n.map(u=>e.jsx(Ct,{className:z({active:a===u.ref_id}),onClick:()=>y(u),children:u.topic},"option"))})}):null]})},Ct=d(x).attrs({direction:"row",align:"center"})`
  font-family: Barlow;
  font-size: 13px;
  font-style: normal;
  font-weight: 500;
