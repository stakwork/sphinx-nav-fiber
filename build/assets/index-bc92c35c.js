import{s as i,a as t,F as c,j as e,a0 as j,r as l,u as $,B as w,bt as C,bv as R,aY as D}from"./index-62a02cd0.js";import{e as I,f as z}from"./index-4b01f94a.js";import{D as E}from"./DeleteNodeIcon-e6333d02.js";import{S as L}from"./Skeleton-db27dc98.js";import{C as T}from"./ClipLoader-ffd12d7e.js";const G=({nodeName:p})=>e.jsx(c,{children:e.jsxs(c,{align:"center",direction:"column",justify:"space-between",children:[e.jsx(A,{children:e.jsx(E,{})}),e.jsxs(M,{children:["Are you sure you want to delete ",p||"this item","?"]})]})}),M=i(c)`
  color: ${t.white};
  font-family: 'Barlow';
  font-size: 20px;
  font-weight: 400;
