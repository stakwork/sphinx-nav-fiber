import{r as i,j as e,s as u,g as S,F as j,o as X,c as Y,A as oe,p as ie,i as ae,q as ce,H as le,t as pe,v as de}from"./index-7935f0ec.js";import{t as O,u as H,C as ue}from"./index-fcae30be.js";import{U as fe}from"./index-80a8f376.js";import{u as T,a as me,b as ge,I as he,c as J,d as xe}from"./index-043cf24b.js";import{M as ye,V as be}from"./index-ccb3410d.js";import{S as we,R as je,s as V,M as ve}from"./index-d28a2402.js";import"./string-a277709d.js";import"./index-0ce95c78.js";import"./three.module-976f5d36.js";import"./index-6cd698d9.js";import"./TextareaAutosize-9f82ff04.js";import"./CheckIcon-246f306e.js";import"./index-f379eebb.js";import"./index-c1d73d4a.js";import"./ClipLoader-57186340.js";import"./clsx-b23f28de.js";import"./SourcesTableIcon-85ca8f1f.js";import"./DeleteNodeIcon-38fa9971.js";import"./SoundIcon-9b82afaf.js";import"./SucessFeedBackIcon-cb3e3439.js";import"./Skeleton-851ed4cc.js";import"./index-974de984.js";import"./Stack-48b346e5.js";import"./FormControlLabel-83259b65.js";import"./Typography-1c4fa44f.js";import"./createSvgIcon-95e52767.js";import"./isPlainObject-ee477e95.js";const K=i.memo(()=>{const r=T(n=>n.isPlaying),a=T(n=>n.setIsPlaying),s=T(n=>n.setVolume),t=T(n=>n.setPlaybackSpeed),c=T(n=>n.playbackSpeed),o=T(n=>n.playerRef),[d,g]=i.useState(!1),m=[.5,1,1.5,2],h=()=>{if(o){const n=o.getCurrentTime()-15;o.seekTo(n,"seconds")}},f=()=>{if(o){const n=o.getCurrentTime()+15;o.seekTo(n,"seconds")}},w=()=>{a(!r)},p=()=>{g(!d),s(d?1:0)},l=()=>{const x=(m.indexOf(c)+1)%m.length,P=m[x];if(t(P),o){const k=o.getInternalPlayer();k&&typeof k.playbackRate<"u"&&(k.playbackRate=P)}};return e.jsxs(Se,{children:[e.jsx(Pe,{onClick:p,children:d?e.jsx(ye,{}):e.jsx(be,{})}),e.jsx(Ce,{onClick:h,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(ke,{"data-testid":"play-pause-button",onClick:w,size:"small",children:r?e.jsx(me,{"data-testid":"pause-icon"}):e.jsx(ge,{"data-testid":"play-icon"})}),e.jsx(Ie,{onClick:f,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(_e,{onClick:l,children:[c,"x"]})]})});K.displayName="Controls";const Se=u(j).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${S.BG1};
  border-radius: 40px;
