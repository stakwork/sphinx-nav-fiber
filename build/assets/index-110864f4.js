import{s as f,c as y,u as z,r as x,j as e,F as t,T as h,b as N,w as R,n as U,ad as V,ae as g,d as G,a1 as q}from"./index-2dc20e7d.js";import{ak as J,B as j,al as Y,l as H,u as K,F as Q}from"./react-toastify.esm-56d4c274.js";import{B as W}from"./index-bc676046.js";import{n as S}from"./toastMessage-b6d55549.js";import{u as X}from"./index-f893b044.js";import{C as Z}from"./CheckIcon-62430267.js";import{C as ee}from"./ClipLoader-1a6edc53.js";import{T as B}from"./index-ee192526.js";import{A as te}from"./index-49e18f6b.js";import{i as v,O as L}from"./constants-84edb5fc.js";import"./index.esm-67eceb68.js";import"./InfoIcon-925c8f4d.js";import"./index-b8661733.js";import"./Popover-58a261ca.js";import"./useSlotProps-dfe63508.js";import"./Select-d6b9fe17.js";import"./Stack-bffa1738.js";import"./Popper-aa3aada7.js";const ne=({onClick:n,loading:a})=>{const d=z(l=>l.budget),[c,m]=x.useState(10),s="node";return x.useEffect(()=>{(async()=>{try{const r=await Y(s);m(r.data.price)}catch(r){console.error("cannot fetch",r)}})()},[s]),e.jsxs(t,{children:[e.jsx(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:e.jsx(t,{align:"center",direction:"row",children:e.jsx(re,{children:"Approve Cost"})})}),e.jsxs(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:[e.jsxs(oe,{children:[e.jsx("div",{className:"title",children:"COST"}),e.jsxs("div",{className:"value","data-testid":"check-price",children:[c," sats"]})]}),e.jsxs(se,{children:[e.jsx("div",{className:"title",children:"BUDGET"}),e.jsxs("div",{className:"value",children:[J(d)," sats"]})]})]}),e.jsx(t,{children:e.jsx(j,{color:"secondary","data-testid":"check-icon",disabled:a,onClick:n,size:"large",startIcon:a?e.jsx(ee,{size:24}):e.jsx(Z,{}),type:"submit",variant:"contained",children:"Approve"})})]})},oe=f(t).attrs({direction:"column",align:"space-between",justify:"flex-start"})`
  width: 141px;
  height: 61px;
