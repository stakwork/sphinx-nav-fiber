import{s as r,F as n,T as g,j as e,h as w,b as c,r as A,g as B}from"./index-c2b1a8c4.js";import{B as v}from"./index-b7734c3e.js";import{u as F}from"./index-6d3b281c.js";import{u as M,T as $,o as C,e as b,w as D,F as k,C as G}from"./react-toastify.esm-39b5cc7c.js";import{B as f,T as R,a as L}from"./index-31beba8b.js";import{T as x}from"./index-4615d738.js";import"./useSlotProps-23afc333.js";import"./index.esm-4d3d224b.js";import"./InfoIcon-29245caa.js";const P=({onClose:s})=>{const[a]=M(t=>[t.graphStyle]),i=()=>{localStorage.setItem("graphStyle",a),s()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:i,children:"Save changes"})})]})},V=r(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=r(g)`
