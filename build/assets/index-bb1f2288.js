...
`,Er=({boostCount:e,date:t,episodeTitle:n,isSelectedView:r=!1,imageUrl:i,showTitle:o,type:l,text:a,name:u,sourceLink:c,verified:p=!1,twitterHandle:d,className:f="episode-wrapper",onClick:h})=>{const y=l==="show"?o:n,k=l==="show"?"":o,I=["tweet","person","guest","topic","document"],b=l==="youtube"?"video":"audio";return l?s.jsx(qo,{className:f,onClick:h,children:I.includes(l)?s.jsxs(s.Fragment,{children:[l==="topic"&&s.jsxs(Wo,{children:[s.jsx(Fi,{}),s.jsx("p",{children:k})]}),["person","guest"].includes(l)&&s.jsx(Fo,{imageUrl:i,name:u||"",title:o||""}),["image"].includes(l)&&s.jsx(Lo,{imageUrl:c,name:u||""}),l==="tweet"&&s.jsx(Ho,{date:t,imageUrl:i,name:u||"",text:a||"",twitterHandle:d,verified:p}),l==="document"&&s.jsx(Mo,{sourceLink:c||"",text:a||"",type:l})]}):s.jsxs(g,{direction:"row",children:[!r&&s.jsx(g,{align:"center",pr:16,children:s.jsx(we,{size:64,src:i||`${b}_default.svg`,type:l||""})}),s.jsxs(g,{grow:1,shrink:1,children:[s.jsxs(g,{align:"center",direction:"row",justify:"space-between",children:[s.jsx(g,{align:"center",direction:"row",children:l&&s.jsx(We,{type:l})}),l==="youtube"&&c?s.jsx(Xo,{href:`${c}${c.includes("?")?"&":"?"}open=system`,onClick:S=>S.stopPropagation(),target:"_blank",children:s.jsx(Ut,{})}):null]}),s.jsx(zt,{"data-testid":"episode-name",children:u}),s.jsx(zt,{"data-testid":"episode-description",children:y}),s.jsxs(g,{align:"center",direction:"row",justify:"flex-start",children:[!!t&&s.jsx(ct,{children:$t.unix(t).fromNow()}),!!k&&s.jsx(Qo,{children:k}),!r&&e>0&&s.jsx(g,{style:{marginLeft:"auto"},children:s.jsx(Gt,{amt:e})})]})]})]})}):null},zt=C(g)`
  font-family: Barlow;
  font-size: 13px;
  font-style: normal;
  font-weight: 400;
