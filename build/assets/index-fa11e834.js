import{f as m,h as c,T,j as e,F as o,C as w,r,a4 as V,E as $,D as A}from"./index-7731e15f.js";import{B as P}from"./index-434f5d73.js";import{u as p}from"./index-22980c99.js";import{c as q,F as G,B,C as H}from"./react-toastify.esm-6d93bcb9.js";import{T as E}from"./index-1b1d8084.js";import{S as O}from"./Skeleton-dfd97bc9.js";import"./index.esm-02511f32.js";import"./InfoIcon-2db118f8.js";const _=/^https:\/\/.*\.(png|jpg|svg)$/;function C(s){return!!_.test(s)}const W=({isValidImageUrl:s})=>e.jsxs(o,{children:[e.jsx(o,{align:"center",direction:"row",justify:"space-between",mb:18,children:e.jsx(o,{align:"center",direction:"row",children:e.jsx(Y,{children:"Edit Node"})})}),e.jsxs(o,{mb:18,children:[e.jsx(S,{style:{marginBottom:8},children:"Node Name"}),e.jsx(E,{id:"cy-topic",maxLength:50,name:"name",placeholder:"Node name",rules:{...w}})]}),e.jsxs(o,{mb:36,children:[e.jsx(S,{style:{marginBottom:8},children:"image_url"}),e.jsx(E,{id:"cy-image_url",maxLength:500,name:"image_url",placeholder:"image_url",rules:{...w,...s?{}:{pattern:{message:"Please enter a valid URL",value:_},validate:{source:C}}}})]})]}),Y=m(T)`
  font-size: 22px;
  font-weight: 600;
  font-family: 'Barlow';
`,S=m(T)`
