import{s as n,c as i,F as s,j as e,T,h as Z,r as h,u as le,P as ce,d as Ie,g as Re}from"./index-2a9d3beb.js";import{A as I,u as R,b as G,an as xe,ao as Ae,B as z,t as Pe,ap as ie,aq as Ee,H as A,D as Me,I as de,J as W,K as pe,ar as H,P as ee,C as F,as as Ge,at as he,au as Le,c as Ne,h as De}from"./react-toastify.esm-07017734.js";import{G as ue,L as te,B as Ye,H as Fe,u as Oe,S as We,a as He,D as Ve,M as Ue,R as Qe,b as qe,c as Ke,d as Xe,z as Je,N as ye,C as Ze,e as fe,f as ge,g as et,h as tt,i as me,j as st,P as it,k as we,s as oe,V as ot,F as nt,E as rt,l as at,m as lt,n as je,o as ct,p as xt,q as dt,r as pt,t as ht,v as ut,w as yt,x as ft,y as gt}from"./SoundIcon-05eadb42.js";import{C as mt,S as wt}from"./ChevronUpIcon-48a035e3.js";import{f as O,o as be,n as jt,X as bt,Y as kt,T as vt,D as St,S as se,q as ke}from"./generateCategoricalChart-d45aba97.js";import{T as D}from"./index-69eec19b.js";import{S as ve}from"./Skeleton-5f3e0afb.js";import{T as ne}from"./toastMessage-b961f51d.js";import{g as $t,d as Tt}from"./index.esm-7c2c6137.js";import{T as _t,F as Bt}from"./Popover-dabdecb4.js";import{I as Ct,S as zt,O as It}from"./Select-cbc0a71e.js";import{C as Rt}from"./CheckIcon-820446e3.js";import{I as At}from"./InfoIcon-fa5df30b.js";import{P as Pt}from"./PlusIcon-746d7811.js";import{u as J}from"./index-82f4c095.js";import{B as Et}from"./index-5c9cd044.js";import"./useSlotProps-28bca2ab.js";const Mt=({imageUrl:t,name:o})=>e.jsxs(s,{align:"center",direction:"row",children:[t&&e.jsx(Gt,{children:e.jsx(I,{rounded:!0,size:64,src:t||"",type:"image"})}),o&&e.jsx(Lt,{children:o})]}),Gt=n(s)`
  img {
    width: 64px;
    height: 64px
    border-radius: 50%;
...
`,Lt=n(s)`
  ...
  font-weight: 600;
  line-height: 17px;
`,Nt=({text:t,type:o,sourceLink:r})=>e.jsxs(s,{direction:"column",children:[e.jsx(s,{align:"center",direction:"row",children:e.jsx(D,{type:o})}),e.jsx($e,{"data-testid":"episode-description",children:t}),e.jsx(s,{align:"center",direction:"row",justify:"flex-start",children:r&&e.jsxs(Dt,{href:r,onClick:a=>a.stopPropagation(),target:"_blank",children:[e.jsx(ue,{}),e.jsx(Yt,{children:r})]})})]}),Dt=n.a`
  color: ${i.GRAY6};
  font-size: 16px;
  height: 16px;
  display: flex;
...
`,Se=({boostCount:t,date:o,episodeTitle:r,isSelectedView:a=!1,imageUrl:c,showTitle:d,type:l,text:y,name:u,profilePicture:x,sourceLink:k,verified:S=!1,twitterHandle:p,className:j="episode-wrapper",onClick:b})=>{const m=l==="show"?d:r,w=l==="show"?"":d,B=["tweet","person","guest","topic","document"],f=l==="youtube"?"video":"audio";return l?e.jsx(Kt,{className:j,onClick:b,children:B.includes(l)?e.jsxs(e.Fragment,{children:[l==="topic"&&e.jsxs(Xt,{children:[e.jsx(Fe,{}),e.jsx("p",{children:w})]}),["person","guest"].includes(l)&&e.jsx(Ft,{imageUrl:c,name:u||"",title:d||""}),["image"].includes(l)&&e.jsx(Mt,{imageUrl:k,name:u||""}),l==="tweet"&&e.jsx(Ht,{date:o,imageUrl:x,name:u||"",text:y||"",twitterHandle:p,verified:S}),l==="document"&&e.jsx(Nt,{sourceLink:k||"",text:y||"",type:l})]}):e.jsxs(s,{direction:"row",children:[!a&&e.jsx(s,{align:"center",pr:16,children:e.jsx(I,{size:64,src:c||`${f}_default.svg`,type:l||""})}),e.jsxs(s,{grow:1,shrink:1,children:[e.jsxs(s,{align:"center",direction:"row",justify:"space-between",children:[e.jsx(s,{align:"center",direction:"row",children:l&&e.jsx(D,{type:l})}),l==="youtube"&&k?e.jsx(Zt,{href:`${k}?open=system`,onClick:C=>C.stopPropagation(),children:e.jsx(te,{})}):null]}),e.jsx($e,{"data-testid":"episode-description",children:m}),e.jsxs(s,{align:"center",direction:"row",justify:"flex-start",children:[!!o&&e.jsx(V,{children:Z.unix(o).fromNow()}),!!w&&e.jsx(Jt,{children:w}),!a&&t>0&&e.jsx(s,{style:{marginLeft:"auto"},children:e.jsx(Ye,{amt:t})})]})]})]})}):null},$e=n(s)`
  font-family: Barlow;
  font-size: 13px;
  font-style: normal;
  font-weight: 400;
...
`,Zt=n.a`
  ...
  font-size: 16px;
  height: 16px;
`,es=({isSearchResult:t})=>{const o=h.useRef(null),r=t?80:10,[a,c]=R(w=>[w.setSelectedNode,w.setSelectedTimestamp]),[d,l]=G(w=>[w.setSidebarOpen,w.setRelevanceSelected]),[y,u]=h.useState(0),x=xe(),S=y*r+r,p=x&&x.length>0?x.length-1>S:!1,j=Oe("sm","down"),b=h.useMemo(()=>x&&[...x].sort((w,B)=>(B.date||0)-(w.date||0)).slice(0,S),[x,S]),m=h.useCallback(w=>{Ae(w),c(w),l(!0),a(w),j&&d(!1)},[a,l,d,c,j]);return e.jsx(e.Fragment,{children:e.jsxs(We,{ref:o,id:"search-result-list",shrink:1,children:[(b??[]).map((w,B)=>{const{image_url:f,date:C,boost:P,type:g,episode_title:v,show_title:E,node_type:L,text:U,source_link:Q,link:q,name:K,profile_picture:M,verified:$=!1,twitter_handle:_}=w||{};return e.jsx(Se,{boostCount:P||0,date:C||0,episodeTitle:O(v),imageUrl:f||"",link:q,name:K||"",onClick:()=>m(w),profilePicture:M,showTitle:O(E),sourceLink:Q,text:U||"",twitterHandle:_,type:L||g,verified:$},B.toString())}),e.jsx(ss,{align:"center",background:"BG1",direction:"row",justify:"center",children:p&&e.jsx(z,{onClick:()=>{p&&u(y+1)},size:"medium",children:"Load More"})})]})})},ts=h.memo(es),ss=n(s)`
  flex: 0 0 86px;
...
`,As=({stateless:t,node:o})=>{var b;const[r,a]=G(m=>[m.transcriptIsOpen,m.setTranscriptOpen]),[c,d]=h.useState(!1),[l,y]=h.useState(""),[u,x]=h.useState(!1);if(!t&&!r)return null;const k="https://knowledge-graph.sphinx.chat",S=async m=>{try{const w=await fetch(`${k}/node/text/${m}`);if(!w.ok)throw new Error("Network response was not ok");const B=await w.json();y(B.data.text),x(!0)}catch(w){console.error("Error fetching full transcript",w)}},p=()=>{u?x(!1):o!=null&&o.ref_id&&S(o.ref_id)},j=m=>{m!==void 0&&(navigator.clipboard.writeText(m),d(!0))};return e.jsxs(s,{grow:1,shrink:1,children:[e.jsxs(Es,{children:[t&&e.jsxs(Ps,{children:[e.jsx("div",{className:"icon",children:e.jsx(ye,{})}),e.jsx("div",{className:"title",children:"Transcript"})]}),o!=null&&o.text?e.jsx(e.Fragment,{children:c?e.jsxs(Ls,{align:"center",direction:"row",justify:"flex-start",children:[e.jsx("div",{className:"icon",children:e.jsx(Rt,{})}),e.jsx("div",{className:"text",children:"Copied"})]}):e.jsx(z,{endIcon:e.jsx(Ze,{}),onPointerDown:()=>j(o==null?void 0:o.text),size:"small",variant:"outlined",children:"Copy"})}):e.jsx("div",{}),!t&&e.jsx(Ms,{onClick:()=>{a(!1)},children:e.jsx(Tt,{fontSize:35})})]}),e.jsxs(Gs,{children:[u?l:`${(b=o==null?void 0:o.text)==null?void 0:b.substring(0,100)}...`,e.jsx(Rs,{onClick:p,children:u?"less":"more"})]})]})},Ps=n(s).attrs({direction:"row",align:"center"})`
  .icon {
    font-size: 16px;
    color: ${i.GRAY3};
    margin-right: 7px;
...
`,Es=n(s).attrs({direction:"row",align:"center",justify:"space-between"})`
  margin-bottom: 18px;
`,Ms=n(s).attrs({})`
  color: ${i.mainBottomIcons};
  cursor: pointer;
...
`,_e=({node:t})=>{const o=R(b=>b.selectedNode),{link:r,image_url:a,date:c,boost:d,node_type:l,type:y,id:u,show_title:x,episode_title:k,ref_id:S}=t||o||{},[p,j]=h.useState(d||0);return o?e.jsx("div",{style:{overflow:"auto",flex:1,width:"100%"},children:e.jsxs(Ns,{children:[e.jsx(Ys,{boostCount:p||0,date:c||0,episodeTitle:O(k),imageUrl:a,isSelectedView:!0,link:r,onClick:()=>null,showTitle:x,type:l||y}),e.jsx(X,{}),e.jsxs(Ds,{children:[e.jsx(Te,{amt:p}),e.jsx(ge,{content:o,count:p,refId:S,updateCount:j})]}),e.jsx(X,{}),e.jsx(ae,{children:e.jsx(Bs,{node:o,stateless:!0})}),e.jsx(X,{}),e.jsx(ae,{children:e.jsx(As,{node:o,stateless:!0},u)})]})}):null},Ns=n(s)`
  flex: 1;
  min-height: 100%;
  flex-direction: column;
...
`,oi=({onClick:t,timestamp:o,isSelected:r,setOpenClip:a})=>e.jsxs(ii,{align:"center","data-testid":"wrapper",direction:"row",isSelected:r,justify:"flex-start",onClick:t,px:20,py:20,children:[e.jsxs("div",{children:[e.jsx(de,{className:"play-pause",children:r?e.jsx(si,{}):e.jsx(et,{})}),!1]}),e.jsxs(ni,{align:"flex-start",direction:"column",justify:"center",children:[o.timestamp&&e.jsx("span",{className:"timestamp",children:tt(o.timestamp)}),e.jsx("span",{className:"title",children:O(o.show_title)})]}),e.jsx("div",{className:"info",children:e.jsx(s,{"data-testid":"info-icon-wrapper",onClick:()=>a(o),pt:4,children:e.jsx(At,{})})})]}),ni=n(s)`
  font-size: 13px;
  color: ${i.white};
  font-family: 'Barlow';
  margin: 0 16px;
...
`,di=()=>{const t=A(),o=t==null?void 0:t.name;return e.jsxs(s,{direction:"column",px:24,py:16,children:[e.jsx(I,{"data-testid":"person-image",size:80,src:(t==null?void 0:t.source_link)||"",type:"image"}),e.jsx(s,{py:20,children:e.jsx(T,{color:"primaryText1",kind:"bigHeading",children:o})})]})},pi=()=>{const{sender_pic:t,sender_alias:o,date:r,message_content:a}=A()||{};return e.jsxs(s,{direction:"row",children:[e.jsx(yi,{src:t}),e.jsxs(hi,{children:[e.jsxs(s,{align:"flex-end",className:"info",direction:"row",children:[o&&e.jsx("span",{className:"info__name",children:o}),r&&e.jsx("span",{className:"info__date",children:r})]}),a&&e.jsx(ui,{dangerouslySetInnerHTML:{__html:st(a)}})]})]})},hi=n(s)`
  color: ${i.black};
  border-radius: 8px;
  font-size: 20px;
  margin-left: 8px;
...
`,zi=n(z)`
  width: 100%;
`,Ii=()=>{var l,y;const[t,o]=h.useState(!1),r=A(),a=!!(r!=null&&r.source_link),c=h.useRef(null),d=u=>{u.stopPropagation(),u.currentTarget.blur(),o(!t)};return h.useEffect(()=>{var u,x;t?(u=c.current)==null||u.play():(x=c.current)==null||x.pause()},[t]),e.jsxs(s,{align:"flex-start",basis:"100%",direction:"column",grow:1,justify:"center",pt:a?62:0,shrink:1,children:[a&&e.jsxs(Ri,{children:[e.jsx(ue,{color:i.GRAY6}),e.jsx(Ei,{children:r==null?void 0:r.source_link}),e.jsx(Ai,{href:r==null?void 0:r.source_link,onClick:u=>u.stopPropagation(),target:"_blank",children:e.jsx(te,{})})]}),(l=r==null?void 0:r.audio)!=null&&l.length?e.jsxs(s,{justify:"flex-start",p:12,children:[e.jsx(z,{onClick:u=>d(u),startIcon:t?e.jsx(H,{}):e.jsx(ee,{}),children:t?"Pause":"Play"}),e.jsx(Mi,{ref:c,src:((y=r.audio[0])==null?void 0:y.link)||"",children:e.jsx("track",{kind:"captions"})})]}):null,e.jsx(Pi,{grow:1,justify:"flex-start",p:12,shrink:1,children:e.jsx(T,{color:"primaryText1",kind:"regular",children:r==null?void 0:r.text})})]})},Ri=n(s)`
  top: 0px;
  position: absolute;
...
`,Mi=n.audio`
  height: 0;
  width: 0;
`,Gi=["clip","twitter_space","youtube","episode","podcast"],Li=()=>{const t=A(),[o]=R(a=>[a.showTeachMe]),[r]=W(a=>[a.setPlayingNode]);if(h.useEffect(()=>{Gi.includes((t==null?void 0:t.node_type)||"")&&r(t)},[r,t]),o)return e.jsx(ks,{});switch(t==null?void 0:t.node_type){case"guest":case"person":return e.jsx(fi,{});case"data_series":return e.jsx($s,{});case"tribe_message":return e.jsx(pi,{});case"tweet":return e.jsx(Si,{});case"topic":return e.jsx(vi,{});case"show":return e.jsx(ki,{});case"youtube":case"podcast":case"clip":case"twitter_space":return e.jsx(_e,{});case"document":return e.jsx(Ii,{});case"episode":return e.jsx(ai,{},t.ref_id);case"image":return e.jsx(di,{});default:return null}},Ni=h.memo(Li),Di=({isPlaying:t,setIsPlaying:o,playingTime:r,duration:a,handleProgressChange:c,handleVolumeChange:d,onFullScreenClick:l,showToolbar:y})=>e.jsxs(s,{children:[!y&&e.jsx(Hi,{"aria-label":"Small",max:a,onChange:c,size:"small",value:r}),e.jsxs(Yi,{align:"center",direction:"row",showToolbar:y,children:[e.jsx(Fi,{onClick:o,size:"small",children:t?e.jsx(H,{}):e.jsx(ee,{})}),e.jsxs(Vi,{direction:"row",children:[e.jsx("span",{children:oe(r)}),e.jsx("span",{className:"separator",children:"/"}),e.jsx("span",{className:"duration",children:oe(a)})]}),e.jsxs(Oi,{direction:"row",px:9,children:[e.jsx(we,{className:"volume-slider",defaultValue:.5,max:1,min:0,onChange:d,size:"small",step:.1}),e.jsx(ot,{})]}),e.jsx(Wi,{onClick:()=>l(),children:y?e.jsx(rt,{}):e.jsx(nt,{})})]})]}),Yi=n(s)`
  height: 60px;
  padding: 12px 16px;
  ${t=>t.showToolbar&&`
    position: fixed;
...
`,Ui=({hidden:t})=>{const o=h.useRef(null),r=h.useRef(null),[a,c]=h.useState(!1),[d,l]=h.useState(!1),[y,u]=h.useState("ready"),[x,k,S,p,j,b,m,w,B,f,C]=W($=>[$.isPlaying,$.playingTime,$.duration,$.setIsPlaying,$.setPlayingTime,$.setDuration,$.playingNode,$.volume,$.setVolume,$.setHasError,$.resetPlayer]);h.useEffect(()=>()=>C(),[C]);const P=()=>{p(!x)},g=()=>{p(!0)},v=()=>{p(!1)},E=($,_)=>{const N=Array.isArray(_)?_[0]:_;o.current&&(o.current.seekTo(N),j(N))},L=($,_)=>{const N=Array.isArray(_)?_[0]:_;B(N)},U=()=>{f(!0),u("error")},Q=$=>{const _=$.playedSeconds;j(_)},q=()=>{if(o.current){u("ready");const $=o.current.getDuration();b($)}},K=()=>{r.current&&(document.fullscreenElement?(document.exitFullscreen(),c(!1)):r.current.requestFullscreen().then(()=>{document.addEventListener("fullscreenchange",M)}))},M=()=>{c(!!document.fullscreenElement),document.removeEventListener("fullscreenchange",M)};return h.useEffect(()=>()=>{document.removeEventListener("fullscreenchange",M)}),h.useEffect(()=>{const $=_=>{if(a){const N=window.screen.height,Ce=_.clientY,ze=N-Ce;l(ze<=50)}};return document.addEventListener("mousemove",$),()=>{document.removeEventListener("mousemove",$)}},[a,d]),h.useEffect(()=>{const $=_=>{a&&_.key==="Escape"&&(_.preventDefault(),_.stopPropagation())};return document.addEventListener("fullscreenchange",M),document.addEventListener("keydown",$),()=>{document.removeEventListener("fullscreenchange",M),document.removeEventListener("keydown",$)}}),m!=null&&m.link?e.jsxs(Qi,{ref:r,hidden:t,children:[e.jsx(qi,{children:e.jsx(I,{size:120,src:(m==null?void 0:m.image_url)||"",type:"clip"})}),e.jsx(at,{ref:o,controls:!1,height:a?window.screen.height:"200px",onBuffer:()=>u("buffering"),onBufferEnd:()=>u("ready"),onError:U,onPause:v,onPlay:g,onProgress:Q,onReady:q,playing:x,url:(m==null?void 0:m.link)||"",volume:w,width:"100%"}),y==="error"?e.jsx(Xi,{className:"error-wrapper",children:"Error happened, please try later"}):null,y==="ready"?e.jsx(Di,{duration:S,handleProgressChange:E,handleVolumeChange:L,isPlaying:x,onFullScreenClick:K,playingTime:k,setIsPlaying:P,showToolbar:d&&a}):null,y==="buffering"?e.jsx(Ki,{children:e.jsx(F,{color:i.lightGray})}):null]}):null},Qi=n(s)`
...
`,Xi=n(s)`
  ...
  padding: 12px 16px;
  color: ${i.primaryRed};
`,Ji=h.memo(Ui),Zi=({open:t})=>{const[o,r,a]=R(y=>[y.setSelectedNode,y.setTeachMe,y.showTeachMe]),c=A(),[d]=G(y=>[y.setSidebarOpen]),[l]=W(y=>[y.playingNode]);return e.jsx(se,{direction:"right",in:t,style:{width:a?"700px":"",position:t?"relative":"absolute"},children:e.jsxs(eo,{children:[e.jsx(Ji,{hidden:(c==null?void 0:c.ref_id)!==(l==null?void 0:l.ref_id)},l==null?void 0:l.ref_id),e.jsx(so,{children:e.jsx(Ni,{})}),e.jsx(to,{onClick:()=>{o(null),r(!1)},children:e.jsx(lt,{})}),e.jsx(io,{onClick:()=>{d(!1)},children:e.jsx(je,{})})]})})},eo=n(s)(({theme:t})=>({position:"relative",background:i.BG1,width:"100%",margin:"64px auto 20px 10px",borderRadius:"16px",zIndex:29,[t.breakpoints.up("sm")]:{width:"390px"}})),to=n(s)`
  font-size: 32px;
  color: ${i.white};
  cursor: pointer;
  position: absolute;
...
`,xo=n.audio`
  height: 0;
  width: 0;
`,po=["Drivechain","Ordinals","L402","Nostr","AI"],ho=({onSubmit:t})=>{var P;const{open:o}=J("addContent"),[r,a]=h.useState(!1),[c,d]=h.useState(null),l=h.useRef(null),[y,u]=h.useState(0),[x,k]=h.useState(!1),{open:S}=J("briefDescription"),[p,j]=R(g=>[g.trendingTopics,g.setTrendingTopics]),{setValue:b}=he();h.useEffect(()=>{const g=async()=>{a(!0);try{const v=await Le();v.length&&Array.isArray(v)&&j(v)}catch{j(po.map(E=>({topic:E,count:0})))}finally{a(!1)}};p.length||g()},[p,j]);const m=g=>{b("search",g),t==null||t()},w=(g,v)=>{g.stopPropagation(),g.currentTarget.blur(),v!=null&&v.tldr&&(d(v),S())},B=()=>{d(null)},f=g=>{g.stopPropagation(),g.currentTarget.blur(),k(!x)};h.useEffect(()=>{var g,v;x?(g=l.current)==null||g.play():(v=l.current)==null||v.pause()},[y,x]);const C=()=>{u(g=>{var E,L;let v=(g+1)%p.length;for(;v!==g&&!((E=p[v])!=null&&E.audio_EN);)v=(v+1)%p.length;return v===g?(k(!1),v):((L=l.current)==null||L.load(),v===0&&(k(!1),u(0)),v)})};return e.jsxs(yo,{children:[e.jsxs("div",{children:[e.jsxs("div",{className:"heading-container",children:[e.jsxs("div",{className:"heading",children:[e.jsx("span",{className:"heading__title",children:"Trending Topics"}),e.jsx("span",{className:"heading__icon",children:r?e.jsx(F,{color:i.PRIMARY_BLUE,size:16}):e.jsx(pt,{})})]}),ht(p)?e.jsxs("div",{children:[e.jsx(z,{onClick:g=>f(g),startIcon:x?e.jsx(H,{}):e.jsx(ee,{}),children:x?"Pause":"Play All"}),e.jsx(wo,{ref:l,onEnded:C,src:(P=p[y])==null?void 0:P.audio_EN,children:e.jsx("track",{kind:"captions"})})]}):null]}),p.length===0&&!r?e.jsxs("div",{className:"Trendingwrapper",children:[e.jsx(go,{children:"No new trending topics in the last 24 hours"}),e.jsx(mo,{color:"secondary",onClick:o,size:"medium",startIcon:e.jsx(Pt,{}),sx:{alignSelf:"flex-end",m:"0 36px 16px 0"},variant:"contained",children:"Add Content"})]}):e.jsx("ul",{className:"list",children:r?e.jsxs("div",{children:[e.jsx(F,{color:i.PRIMARY_BLUE,size:16}),[...Array(5)].map((g,v)=>e.jsx(fo,{animation:"wave","data-testid":"loading-skeleton",height:47,variant:"rectangular",width:382},v))]}):e.jsx(e.Fragment,{children:p.map(g=>e.jsxs(s,{align:"center",className:"list-item",direction:"row",justify:"space-between",onClick:()=>m(g.topic),children:[e.jsxs(uo,{children:[" #",ut(g)]}),g.tldr&&e.jsx(z,{onClick:v=>w(v,g),children:"TLDR"})]},g.topic))})})]}),c&&e.jsx(ro,{onClose:B,selectTrending:m,trend:c})]})},uo=n.div`
  width: 300px;
  overflow: hidden;
  text-overflow: ellipsis;
  line-height: 1.5;
