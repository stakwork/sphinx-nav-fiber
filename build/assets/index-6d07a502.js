import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-df064103.js";import{B}from"./index-ff675c0b.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-ce8a56f6.js";import{B as f,T as $,a as k}from"./index-ec247264.js";import{T as u}from"./index-b470549c.js";import"./useSlotProps-53ce33e6.js";import"./index.esm-df329d64.js";import"./InfoIcon-8635b005.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
