import{Q as o,U as s,a5 as g,O as y,j as e,a3 as b,av as w,ar as S,S as x,r as v,N as T,ad as m}from"./index-22552d5f.js";import{aI as A,aJ as f,af as C,ag as M,aK as u,aF as G,aL as $,aM as B,aG as k}from"./index-70532ac1.js";const D=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(z,{direction:"column",children:[e.jsx(F,{children:"Default graph view:"}),e.jsx(A,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},z=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,F=o(g)`
