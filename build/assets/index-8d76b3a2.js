import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-2b2e50af.js";import{B}from"./index-8896a668.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-52859160.js";import{B as f,T as $,a as k}from"./index-6f897188.js";import{T as u}from"./index-f05ece84.js";import"./useSlotProps-e8abd4ce.js";import"./index.esm-12a2c494.js";import"./InfoIcon-e1d5caeb.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
