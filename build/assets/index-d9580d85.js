import{f as o,F as s,T as g,i as y,j as e,k as b,L as S,D as w,h as x,r as T,x as v,B as m}from"./index-06d8f5a2.js";import{B}from"./index-71a2e6a1.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-de833712.js";import{B as f,T as $,a as k}from"./index-800f9cf6.js";import{T as u}from"./index-29a0a75b.js";import"./useSlotProps-6eee4772.js";import"./index.esm-0a209726.js";import"./InfoIcon-bf5c827d.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
