import{ac as Q,s as g,g as b,F as t,T,a as V,r as y,j as e,B as C,a$ as ee,b9 as te,aq as se,aZ as L,a_ as F,be as B,bf as ne,k as oe,bg as re,bh as ie,bi as ae,a6 as O,l as ce,c as le,aX as de,aY as I,b0 as pe,n as xe,ak as me,aj as ue,bc as he}from"./index-33d20918.js";import{g as fe}from"./index-800db796.js";import{C as ye}from"./CheckIcon-b1296d72.js";import{f as ge}from"./index-717b1eb9.js";import{C as Y}from"./ClipLoader-7825dac3.js";import{p as q}from"./index-348f31a0.js";import{A as je}from"./index-b6cca8bd.js";import{c as we}from"./index-64f1c910.js";import"./three.module-1c1ec8b9.js";import"./index-df9b5920.js";import"./Stack-4c05965e.js";import"./createSvgIcon-4e46db87.js";import"./TextareaAutosize-58bdd08c.js";const be=async(o,i,a="")=>await Q.post(`/${o}`,JSON.stringify(i),{Authorization:a}),Se=async(o,i,a,m,d,r)=>{const x=o==="Create custom type"?"schema":"node",c={node_data:{...i,...o==="Image"&&{source_link:a}},node_type:o,name:m,pubkey:r};return be(x,c,d)},Ne=({onClick:o,loading:i,error:a})=>{const m=V(c=>c.budget),[d,r]=y.useState(10),x="node";return y.useEffect(()=>{(async()=>{try{const h=await te(x);r(h.data.price)}catch(h){console.error("cannot fetch",h)}})()},[x]),e.jsxs(t,{children:[e.jsx(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:e.jsx(t,{align:"center",direction:"row",children:e.jsx(ke,{children:"Approve Cost"})})}),e.jsxs(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:[e.jsxs(Te,{children:[e.jsx("div",{className:"title",children:"COST"}),e.jsxs("div",{className:"value","data-testid":"check-price",children:[d," sats"]})]}),e.jsxs(Ce,{children:[e.jsx("div",{className:"title",children:"BUDGET"}),e.jsxs("div",{className:"value",children:[ge(m)," sats"]})]})]}),e.jsx(t,{children:e.jsx(C,{color:"secondary","data-testid":"check-icon",disabled:i||!!a,onClick:o,size:"large",startIcon:i?e.jsx(R,{children:e.jsx(Y,{color:b.lightGray,size:12})}):e.jsxs(R,{children:[" ",e.jsx(ye,{})]}),type:"submit",variant:"contained",children:"Approve"})}),a?e.jsx(ze,{children:e.jsxs(ve,{children:[e.jsx(ee,{className:"errorIcon"}),e.jsx("span",{children:a})]})}):null]})},Te=g(t).attrs({direction:"column",align:"space-between",justify:"flex-start"})`
  width: 141px;
  height: 61px;
