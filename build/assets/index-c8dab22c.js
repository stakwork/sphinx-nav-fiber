import{aR as Ci,r as z,f as j,h as y,i as de,j as s,l as Te,F as g,T as X,N as $t,k as ce,aS as cr,aT as Si,x as pr,o as vi,aU as Ei,O as Ti,a3 as fe,aV as fn,a1 as Ii,aW as xn,ac as _i,aX as Ai,I as Pi}from"./index-84dcd456.js";import{k as zi,l as mt,A as we,B as ye,d as Li,I as hr,f as at,g as dr,m as ut,P as Ht,C as Vt,n as Bi,i as fr,b as Oi,S as Mi}from"./react-toastify.esm-d4bb52c4.js";import{C as xr}from"./CheckIcon-68e6ad26.js";import{C as mr}from"./ChevronDownIcon-aed326e0.js";import{C as Ri}from"./ChevronUpIcon-197c0d6e.js";import{F as gr,a as Di,T as Fi}from"./Popover-c2906c30.js";import{G as yr,L as Ut,B as Gt,H as Ni,M as $i,R as Hi,a as Vi,S as Ui,b as Gi,N as wr,C as Yi,D as Yt,c as br,d as qi,f as Wi,g as kr,e as Qi,P as Xi,h as jr,s as mn,V as Ki,F as Zi,E as Ji,i as eo,j as to,k as Cr,l as no}from"./ChevronRightIcon-e85e2233.js";import{S as ro}from"./index-8010af95.js";import{f as rt,o as Sr,P as vr,n as io,X as oo,Y as lo,T as so,D as ao,S as qt,q as Er}from"./generateCategoricalChart-1061b2de.js";import{T as Fe,I as uo,S as co,O as po}from"./index-993df9b8.js";import{S as ho}from"./Skeleton-225b7b27.js";import{f as fo,c as xo}from"./index.esm-0b011f67.js";import{I as mo}from"./InfoIcon-10592c24.js";import{P as go}from"./PlusIcon-a066bec4.js";import{u as At}from"./index-9a70c8a3.js";import{B as yo}from"./index-ba9d5983.js";import"./useSlotProps-1cfec523.js";const wo=(e,t="down")=>{const n=Ci(),[r,i]=z.useState(!1),o=n.breakpoints[t](e).split("@media")[1].trim();return z.useEffect(()=>{const l=()=>{const{matches:a}=window.matchMedia(o);i(a)};return l(),window.addEventListener("resize",l),()=>window.removeEventListener("resize",l)},[o]),r},bo=e=>e.filter(t=>t.tldr).length>=2&&e.some(t=>t.audio_EN);function ko(e){return e.tldr_topic??e.name}var it=globalThis&&globalThis.__assign||function(){return it=Object.assign||function(e){for(var t,n=1,r=arguments.length;n<r;n++){t=arguments[n];for(var i in t)Object.prototype.hasOwnProperty.call(t,i)&&(e[i]=t[i])}return e},it.apply(this,arguments)},jo=globalThis&&globalThis.__rest||function(e,t){var n={};for(var r in e)Object.prototype.hasOwnProperty.call(e,r)&&t.indexOf(r)<0&&(n[r]=e[r]);if(e!=null&&typeof Object.getOwnPropertySymbols=="function")for(var i=0,r=Object.getOwnPropertySymbols(e);i<r.length;i++)t.indexOf(r[i])<0&&Object.prototype.propertyIsEnumerable.call(e,r[i])&&(n[r[i]]=e[r[i]]);return n},Co=zi("BeatLoader","50% {transform: scale(0.75);opacity: 0.2} 100% {transform: scale(1);opacity: 1}","beat");function So(e){var t=e.loading,n=t===void 0?!0:t,r=e.color,i=r===void 0?"#000000":r,o=e.speedMultiplier,l=o===void 0?1:o,a=e.cssOverride,u=a===void 0?{}:a,c=e.size,p=c===void 0?15:c,d=e.margin,f=d===void 0?2:d,h=jo(e,["loading","color","speedMultiplier","cssOverride","size","margin"]),w=it({display:"inherit"},u),b=function(E){return{display:"inline-block",backgroundColor:i,width:mt(p),height:mt(p),margin:mt(f),borderRadius:"100%",animation:"".concat(Co," ").concat(.7/l,"s ").concat(E%2?"0s":"".concat(.35/l,"s")," infinite linear"),animationFillMode:"both"}};return n?z.createElement("span",it({style:w},h),z.createElement("span",{style:b(1)}),z.createElement("span",{style:b(2)}),z.createElement("span",{style:b(3)})):null}const vo=()=>{var d;const[e,t]=z.useState(null),{sidebarFilter:n,setSidebarFilter:r,sidebarFilterCounts:i}=de(f=>f),o=n==="undefined"?"Other":n,l=((d=i.find(f=>f.name===o))==null?void 0:d.count)||0,a=f=>f?f.charAt(0).toUpperCase()+f.slice(1):"",u=f=>{t(f.currentTarget)},c=()=>{t(null)},p=f=>{r(f),c()};return s.jsxs("div",{children:[s.jsxs(Eo,{onClick:u,children:[s.jsx("div",{className:"text",children:"Show"}),s.jsx("div",{className:"value","data-testid":"value",children:`${a(o)} (${l})`}),s.jsx("div",{className:"icon",children:e?s.jsx(Ri,{}):s.jsx(mr,{})})]}),s.jsx(Io,{anchorEl:e,anchorOrigin:{vertical:"bottom",horizontal:"left"},anchorPosition:{top:62,left:0},onClose:c,open:!!e,transformOrigin:{vertical:"top",horizontal:"left"},children:s.jsx(gr,{children:i.map(({name:f,count:h})=>s.jsxs(To,{className:Te({active:f===n}),onClick:()=>p(f),children:[s.jsx("span",{className:"icon",children:f===n?s.jsx(xr,{}):null}),s.jsx("span",{children:`${a(f)} (${h})`})]},f))})})]})},Eo=j(g).attrs({direction:"row",align:"center"})`
  cursor: pointer;
  flex-grow: 1;
  color: ${y.GRAY6};
  font-family: Barlow;
...
`,gt=[["Searching","Podcast Index"],["Searching","YouTube"],["Searching","Twitter Spaces"],["Finding","Transcripts"],["Loading","Audio Clips"],["Loading","Video Clips"],["Preparing","Results"]],_o=()=>{const[e,t]=z.useState(0);return z.useEffect(()=>{if(e===gt.length-1)return;const n=setTimeout(()=>t(r=>(r+1)%gt.length),2e3);return()=>clearTimeout(n)},[e]),s.jsx(Ao,{direction:"column",children:gt.map((n,r)=>s.jsxs(g,{className:Te("raw-wrapper",{show:e===r}),direction:"row",children:[s.jsx("div",{className:Te("action"),children:n[0]}),s.jsx("div",{className:Te("entity"),children:n[1]}),s.jsx("div",{children:s.jsx(So,{color:y.SECONDARY_BLUE,size:2})})]},n[1]))})},Ao=j(g)`
  overflow: hidden;
  height: 20px;
  position: relative;
  .action {
...
`,Mo=j(g)`
  ...
  font-weight: 600;
  line-height: 17px;
`,Ro=({text:e,type:t,sourceLink:n})=>s.jsxs(g,{direction:"column",children:[s.jsx(g,{align:"center",direction:"row",children:s.jsx(Fe,{type:t})}),s.jsx(Pt,{"data-testid":"episode-description",children:e}),s.jsx(g,{align:"center",direction:"row",justify:"flex-start",children:n&&s.jsxs(Do,{href:n,onClick:r=>r.stopPropagation(),target:"_blank",children:[s.jsx(yr,{}),s.jsx(Fo,{children:n})]})})]}),Do=j.a`
  color: ${y.GRAY6};
  font-size: 16px;
  height: 16px;
  display: flex;
...
`,Tr=({boostCount:e,date:t,episodeTitle:n,isSelectedView:r=!1,imageUrl:i,showTitle:o,type:l,text:a,name:u,sourceLink:c,verified:p=!1,twitterHandle:d,className:f="episode-wrapper",onClick:h})=>{const w=l==="show"?o:n,b=l==="show"?"":o,E=["tweet","person","guest","topic","document"],k=l==="youtube"?"video":"audio";return l?s.jsx(Wo,{className:f,onClick:h,children:E.includes(l)?s.jsxs(s.Fragment,{children:[l==="topic"&&s.jsxs(Qo,{children:[s.jsx(Ni,{}),s.jsx("p",{children:b})]}),["person","guest"].includes(l)&&s.jsx(No,{imageUrl:i,name:u||"",title:o||""}),["image"].includes(l)&&s.jsx(Bo,{imageUrl:c,name:u||""}),l==="tweet"&&s.jsx(Vo,{date:t,imageUrl:i,name:u||"",text:a||"",twitterHandle:d,verified:p}),l==="document"&&s.jsx(Ro,{sourceLink:c||"",text:a||"",type:l})]}):s.jsxs(g,{align:"center",direction:"row",justify:"center",children:[!r&&s.jsx(g,{align:"center",pr:16,children:s.jsx(we,{size:80,src:i||`${k}_default.svg`,type:l||""})}),s.jsxs(g,{grow:1,shrink:1,children:[s.jsxs(g,{align:"center",direction:"row",justify:"space-between",children:[s.jsx(g,{align:"center",direction:"row",children:l&&s.jsx(Fe,{type:l})}),l==="youtube"&&c?s.jsx(Ko,{href:`${c}${c.includes("?")?"&":"?"}open=system`,onClick:S=>S.stopPropagation(),target:"_blank",children:s.jsx(Ut,{})}):null]}),u&&s.jsx(Pt,{"data-testid":"episode-name",children:u}),s.jsx(Pt,{"data-testid":"episode-description",children:w}),s.jsxs(g,{align:"center",direction:"row",justify:"flex-start",children:[!!t&&s.jsx(ct,{children:$t.unix(t).fromNow()}),!!b&&s.jsx(Xo,{children:b}),!r&&e>0&&s.jsx(g,{style:{marginLeft:"auto"},children:s.jsx(Gt,{amt:e})})]})]})]})}):null},Pt=j(g)`
  font-family: Barlow;
  font-size: 13px;
  font-style: normal;
  font-weight: 400;
...
`,Ko=j.a`
  ...
  font-size: 16px;
  height: 16px;
`,Zo=({isSearchResult:e})=>{const t=z.useRef(null),n=e?80:10,{setSelectedNode:r,setSelectedTimestamp:i}=de(k=>k),{currentSearch:o,setSidebarOpen:l,setRelevanceSelected:a}=ce(k=>k),[u,c]=z.useState(0),p=cr(),f=u*n+n,h=p&&p.length>0?p.length-1>f:!1,w=wo("sm","down"),b=z.useCallback(k=>{Si(k),i(k),a(!0),r(k),w&&l(!1)},[r,a,l,i,w]),E=z.useMemo(()=>{if(p){const k=[...p].sort((S,I)=>(I.date||0)-(S.date||0));return o&&k.sort((S,I)=>{const O=S.node_type==="topic"&&S.name.toLowerCase()===o.toLowerCase()?1:0;return(I.node_type==="topic"&&I.name.toLowerCase()===o.toLowerCase()?1:0)-O}),k.slice(0,f)}return[]},[p,o,f]);return s.jsx(s.Fragment,{children:s.jsxs(Lo,{ref:t,id:"search-result-list",shrink:1,children:[(E??[]).map((k,S)=>{const{image_url:I,date:O,boost:L,type:v,episode_title:D,show_title:G,node_type:$,text:V,source_link:_,link:P,name:H,verified:q=!1,twitter_handle:F}=k||{};return s.jsx(Tr,{boostCount:L||0,date:O||0,episodeTitle:rt(D),imageUrl:I||"",link:P,name:H||"",onClick:()=>{b(k)},showTitle:rt(G),sourceLink:_,text:V||"",twitterHandle:F,type:$||v,verified:q},S.toString())}),s.jsx(el,{align:"center",background:"BG1",direction:"row",justify:"center",children:h&&s.jsx(ye,{onClick:()=>{h&&c(u+1)},size:"medium",children:"Load More"})})]})})},Jo=z.memo(Zo),el=j(g)`
  flex: 0 0 86px;
...
`,Is=j(ye)`
  width: 100%;
`,_s=new Set(["id","image_url","index","node_type","ref_id","scale","type","vx","vy","vz","x","y","z","properties","weight"]),As=e=>e.split("_").map(t=>t.charAt(0).toUpperCase()+t.slice(1)).join(" "),Ps=e=>Object.entries(e).filter(([t])=>!_s.has(t)).reduce((t,[n,r])=>({...t,[As(n)]:r}),{}),zs=()=>{const e=fe();if(!e)return null;const t=Ps(e),n=!!e.image_url;return s.jsxs(Bs,{grow:1,justify:"flex-start",pt:n?0:8,shrink:1,children:[n?s.jsx(Ms,{children:s.jsx("img",{alt:"img_a11y",src:e.image_url})}):null,s.jsx(g,{ml:24,mt:20,style:{width:"fit-content"},children:s.jsx(Fe,{type:e.type||""})}),s.jsx(Os,{children:Object.entries(t).map(([r,i])=>s.jsx(Ls,{label:r,value:i},r))})]})},Ls=({label:e,value:t})=>{const n=t.length>140;return s.jsxs(s.Fragment,{children:[s.jsxs(Rs,{className:Te("node-detail",{"node-detail__long":n}),children:[s.jsx(X,{className:"node-detail__label",children:e}),s.jsx(X,{className:"node-detail__value",children:t})]}),s.jsx(Ds,{})]})},Bs=j(g)`
  overflow: auto;
  width: 100%;
`,Os=j(g)`
  padding: 4px 24px;
...
`,Ds=j(Yt)`
  margin: auto 0px 2px 0px;
  opacity: 0.75;
`,Fs=()=>{var a,u;const[e,t]=z.useState(!1),n=fe(),r=!!(n!=null&&n.source_link),i=z.useRef(null),o=ce(c=>c.currentSearch),l=c=>{c.stopPropagation(),c.currentTarget.blur(),t(!e)};return z.useEffect(()=>{var c,p;e?(c=i.current)==null||c.play():(p=i.current)==null||p.pause()},[e]),s.jsxs(g,{align:"flex-start",basis:"100%",direction:"column",grow:1,justify:"center",pt:r?62:0,shrink:1,children:[r&&s.jsxs(Ns,{children:[s.jsx(yr,{color:y.GRAY6}),s.jsx(Vs,{children:n==null?void 0:n.source_link}),s.jsx($s,{href:`${n==null?void 0:n.source_link}?open=system`,onClick:c=>c.stopPropagation(),target:"_blank",children:s.jsx(Ut,{})})]}),(a=n==null?void 0:n.audio)!=null&&a.length?s.jsxs(g,{justify:"flex-start",p:12,children:[s.jsx(ye,{onClick:c=>l(c),startIcon:e?s.jsx(ut,{}):s.jsx(Ht,{}),children:e?"Pause":"Play"}),s.jsx(Us,{ref:i,src:((u=n.audio[0])==null?void 0:u.link)||"",children:s.jsx("track",{kind:"captions"})})]}):null,s.jsx(Hs,{grow:1,justify:"flex-start",p:12,shrink:1,children:s.jsx(X,{color:"primaryText1",kind:"regular",children:pt((n==null?void 0:n.text)||"",o)})})]})},Ns=j(g)`
  top: 0px;
  position: absolute;
...
`,ta=({hidden:e})=>{const t=z.useRef(null),n=z.useRef(null),[r,i]=z.useState(!1),[o,l]=z.useState(!1),[a,u]=z.useState(!1),[c,p]=z.useState("ready"),{isPlaying:d,playingTime:f,duration:h,setIsPlaying:w,setPlayingTime:b,setDuration:E,playingNode:k,volume:S,setVolume:I,setHasError:O,resetPlayer:L,isSeeking:v,setIsSeeking:D}=at(Z=>Z);z.useEffect(()=>()=>L(),[L]),z.useEffect(()=>{v&&t.current&&(t.current.seekTo(f,"seconds"),D(!1))},[f,v,D]);const G=()=>{w(!d)},$=()=>{w(!0)},V=()=>{w(!1)},_=(Z,x)=>{const te=Array.isArray(x)?x[0]:x;t.current&&(t.current.seekTo(te),b(te))},P=(Z,x)=>{const te=Array.isArray(x)?x[0]:x;I(te)},H=()=>{O(!0),p("error")},q=Z=>{if(!v){const x=Z.playedSeconds;b(x)}},F=()=>{if(t.current){p("ready");const Z=t.current.getDuration();E(Z)}},ee=()=>{n.current&&(document.fullscreenElement?(document.exitFullscreen(),setTimeout(()=>l(!1),300)):n.current.requestFullscreen().then(()=>{document.addEventListener("fullscreenchange",K)}))},K=()=>{l(!!document.fullscreenElement),document.removeEventListener("fullscreenchange",K)};z.useEffect(()=>()=>{document.removeEventListener("fullscreenchange",K)}),z.useEffect(()=>{const Z=x=>{if(o){const te=window.screen.height,me=x.clientY,m=te-me;u(m<=50)}};return document.addEventListener("mousemove",Z),()=>{document.removeEventListener("mousemove",Z)}},[o,a]),z.useEffect(()=>{const Z=x=>{o&&x.key==="Escape"?(x.preventDefault(),x.stopPropagation()):r&&x.key===" "&&(x.preventDefault(),G())};return document.addEventListener("fullscreenchange",K),document.addEventListener("keydown",Z),()=>{document.removeEventListener("fullscreenchange",K),document.removeEventListener("keydown",Z)}});const le=()=>{G()};return k!=null&&k.link?s.jsxs(na,{ref:n,hidden:e,onBlur:()=>i(!1),onFocus:()=>i(!0),tabIndex:0,children:[s.jsx(ra,{children:s.jsx(we,{size:120,src:(k==null?void 0:k.image_url)||"",type:"clip"})}),s.jsx(la,{onClick:le,children:s.jsx(eo,{ref:t,controls:!1,height:o?window.screen.height:"200px",onBuffer:()=>p("buffering"),onBufferEnd:()=>p("ready"),onError:H,onPause:V,onPlay:$,onProgress:q,onReady:F,playing:d,url:(k==null?void 0:k.link)||"",volume:S,width:"100%"})}),c==="error"?s.jsx(oa,{className:"error-wrapper",children:"Error happened, please try later"}):null,c==="ready"?s.jsx(Ws,{duration:h,handleProgressChange:_,handleVolumeChange:P,isFullScreen:o,isPlaying:d,onFullScreenClick:ee,playingTime:f,setIsPlaying:G,showToolbar:a&&o}):null,c==="buffering"?s.jsx(ia,{children:s.jsx(Vt,{color:y.lightGray})}):null]}):null},na=j(g)`
