...
`,ra=j.div`
  width: 100%;
  cursor: pointer;
`,ia=z.memo(Ks),oa=({open:e})=>{const{setSelectedNode:t,setTeachMe:n,showTeachMe:r}=fe(a=>a),i=xe(),{setSidebarOpen:o}=pe(a=>a),{playingNode:l}=at(a=>a);return s.jsx(qt,{"data-testid":"sidebar-sub-view",direction:"right",in:e,style:{width:r?"700px":"",position:e?"relative":"absolute"},children:s.jsxs(la,{children:[s.jsx(ia,{hidden:(i==null?void 0:i.ref_id)!==(l==null?void 0:l.ref_id)},l==null?void 0:l.ref_id),s.jsx(aa,{children:s.jsx(Us,{})}),s.jsx(sa,{"data-testid":"close-sidebar-sub-view",onClick:()=>{t(null),n(!1)},children:s.jsx(to,{})}),s.jsx(ua,{onClick:()=>{o(!1)},children:s.jsx(Cr,{})})]})})},la=j(g)(({theme:e})=>({position:"relative",background:y.BG1,width:"100%",margin:"64px auto 20px 10px",borderRadius:"16px",zIndex:29,[e.breakpoints.up("sm")]:{width:"390px"}})),sa=j(g)`
  font-size: 32px;
  color: ${y.white};
  cursor: pointer;
  position: absolute;
