import{o as s,p as l,F as n,q as w,j as e,t as C,v as G,T as S,r as f,B as v,aU as B,aV as b,aW as I,C as A,O as y}from"./index-83d55f33.js";import{B as z}from"./index-bce962ef.js";import{u as M,G as k,C as D,l as E,o as R,B as T,i as W,F}from"./index-c3a89a83.js";import{C as $}from"./ClipLoader-ccc0f90e.js";import{T as j}from"./index-5b3a7da6.js";import{S as P}from"./index-0aa81bde.js";import{e as V}from"./index.esm-c515702c.js";import{T as L,a as N}from"./Tabs-ca70b0c3.js";import"./InfoIcon-842d52dc.js";import"./useSlotProps-a98a182e.js";import"./createSvgIcon-c4265c93.js";const O={split:e.jsx(k,{}),force:e.jsx(D,{}),sphere:e.jsx(E,{}),earth:e.jsx(R,{})},Y=()=>{const[i,p]=w(M(t=>[t.graphStyle,t.setGraphStyle])),r=t=>{p(t)};return e.jsx(q,{direction:"column",children:C.map(t=>e.jsx(n,{className:G("icon",{active:i===t}),onClick:()=>r(t),children:O[t]},t))})},q=s(n).attrs({direction:"row",align:"center",justify:"space-between"})`
  width: 447px;
  height: 48px;
...
`,H=({onClose:i})=>{const[p]=w(d=>[d.graphStyle]),[r,t]=f.useState(!1),c=()=>{t(!0),localStorage.setItem("graphStyle",p),t(!1),i()};return e.jsxs(U,{direction:"column",children:[e.jsx(_,{children:"Default graph view:"}),e.jsx(Y,{}),e.jsx(n,{mt:308,py:8,children:e.jsx(T,{color:"secondary",disabled:r,id:"add-node-submit-cta",onClick:c,size:"large",startIcon:r&&e.jsx(K,{children:e.jsx($,{color:l.lightGray,size:12})}),type:"submit",variant:"contained",children:"Save Changes"})})]})},U=s(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,_=s(S)`
