import{s as i,F as n,T as g,j as e,b as w,c as p,r as A,u as B}from"./index-71257a51.js";import{B as v}from"./index-fcf46a2b.js";import{u as F}from"./index-81b7e2b0.js";import{u as M,G as $,l as C,b,q as D,F as G}from"./react-toastify.esm-80f7abc3.js";import{B as f,T as k,a as R}from"./index-f7b92541.js";import{T as x}from"./index-905dce1b.js";import{C as L}from"./ClipLoader-954a7bed.js";import"./useSlotProps-e0213659.js";import"./index.esm-5156b765.js";import"./InfoIcon-b5d1954e.js";const P=({onClose:s})=>{const[a]=M(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",a),s()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
