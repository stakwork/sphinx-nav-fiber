import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,x as D,B as F}from"./index-011ab68b.js";import{B as M}from"./index-9ef2a83d.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-f2080000.js";import{B as f,T as L,a as R}from"./index-97e284b8.js";import{T as x}from"./index-fdc4e7e5.js";import"./useSlotProps-34f386f9.js";import"./index.esm-37e26b1f.js";import"./InfoIcon-3232bd96.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
