import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-98c785fb.js";import{B as F}from"./index-b3379933.js";import{u as M}from"./index-898d0fd9.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-685afd98.js";import{B as f,T as R,a as L}from"./index-1c2b4de8.js";import{T as x}from"./index-866ebce5.js";import"./useSlotProps-d52c7a00.js";import"./index.esm-77f594c9.js";import"./InfoIcon-87c4626a.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
