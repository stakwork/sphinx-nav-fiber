...
`,ie=({nodeType:i,onclose:x,selectedNodeType:d})=>e.jsxs(r,{children:[e.jsx(r,{mb:20,children:e.jsx(D,{children:"Confirm Type Change"})}),e.jsx(r,{mb:25,children:e.jsxs(D,{children:["From: ",d]})}),e.jsx(r,{mb:25,children:e.jsxs(D,{children:["To: ",i]})}),e.jsxs(r,{direction:"row",children:[e.jsx(r,{grow:1,children:e.jsx(_,{color:"secondary",onClick:x,size:"large",variant:"contained",children:"Cancel"})}),e.jsx(r,{grow:1,ml:20,children:e.jsx(_,{color:"secondary",size:"large",type:"submit",variant:"contained",children:"Confirm"})})]})]}),D=v(P)`
  ...
  font-weight: 600;
  font-family: 'Barlow';
`,M=i=>i.charAt(0).toUpperCase()+i.slice(1).replace(/_/g," "),I=i=>i?[...i].sort((x,d)=>Number(d.required)-Number(x.required)):[],ce=({handleSelectType:i,skipToStep:x,selectedNodeType:d,nodeType:n,selectedValues:h,setSelectedValues:w})=>{const[f,C]=u.useState(!1),[j,t]=u.useState(),[a,s]=u.useState(),{watch:c}=V();u.useEffect(()=>{const l=async(p,y)=>{C(!0);const g=await U(p),z=W(g);y(z),C(!1)};n&&l(n,t),d&&l(d,s)},[n,d,c]);const S=u.useMemo(()=>I(j),[j]),o=u.useMemo(()=>I(a),[a]),b=()=>{i(""),x("sourceType")};u.useEffect(()=>{if(j&&a){const l=a.reduce((p,y)=>{const g=j.find(z=>z.key===y.key);return p[y.key]=g?y.key:"none",p},{});w(l)}},[j,a,w]);const m=(l,p)=>{w(y=>({...y,[l]:p}))},A=()=>{const l=S.every(({key:p,required:y})=>!y||y&&h[p]&&h[p]!=="none");x(l?"createConfirmation":"requiredProperties")},O=u.useMemo(()=>o.map(({key:l})=>{const p=h[l]||"none",y=S.filter(g=>!Object.values(h).includes(g.key)||g.key===p).map(g=>({label:M(g.key),value:g.key}));return y.unshift({label:"None",value:"none"}),{key:l,autoCompleteOptions:y,selectedValue:p}}),[o,S,h]);return e.jsxs(r,{children:[e.jsx(r,{align:"center",direction:"row",justify:"space-between",mb:18,children:e.jsx(r,{align:"center",direction:"row",children:e.jsx(le,{children:"Map Properties"})})}),e.jsx(pe,{children:f?e.jsx(r,{style:{margin:"auto"},children:e.jsx(G,{color:q.lightGray})}):e.jsxs(de,{children:[e.jsxs(ue,{children:[e.jsx(k,{children:M(d)}),o.map(({key:l})=>e.jsx(xe,{children:e.jsx(P,{children:M(l)})},l))]}),e.jsxs(he,{children:[e.jsx(k,{children:M(n)}),O.map(({key:l,autoCompleteOptions:p,selectedValue:y})=>e.jsx(r,{children:e.jsx(H,{isLoading:f,onSelect:g=>m(l,g?g.value:"none"),options:p,selectedValue:p.find(g=>g.value===y)})},l))]})]})}),e.jsxs(r,{direction:"row",children:[e.jsx(r,{grow:1,children:e.jsx(_,{color:"secondary",onClick:b,size:"large",variant:"contained",children:"Prev"})}),e.jsx(r,{grow:1,ml:20,children:e.jsx(_,{color:"secondary",disabled:f,onClick:A,size:"large",variant:"contained",children:"Next"})})]})]})},le=v(P)`
  font-size: 22px;
  font-weight: 600;
  font-family: 'Barlow';
`,pe=v(r)`
