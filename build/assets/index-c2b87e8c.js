import{r as n,j as e,s as f,g as T,F as S,o as K,c as U,A as ae,p as ce,i as le,q as pe,H as de,t as ue,v as fe,f as q}from"./index-07180195.js";import{Universe as me}from"./index-3328131d.js";import{u as he}from"./index-1657be70.js";import{u as W,a as ge,b as xe,I as ye,c as Q,d as V}from"./index-850e3272.js";import{M as be,V as we}from"./VolumeIcon-aed50125.js";import{S as je,R as ve,s as X,M as Se}from"./index-5769e09c.js";import"./index-a0fa7756.js";import"./VisibilityOn-15a6e1ba.js";import"./SourcesTableIcon-ed3b8a64.js";import"./NodeCircleIcon-08ddeb71.js";import"./CheckIcon-ad28cb78.js";import"./DeleteNodeIcon-598321cb.js";import"./EditNodeIcon-455aa0ba.js";import"./SearchIcon-3d3b7b7c.js";import"./SoundIcon-de38b986.js";import"./SucessFeedBackIcon-41296bcb.js";import"./three.module-1c1ec8b9.js";import"./TextareaAutosize-0a9f9d01.js";import"./index-14e951bc.js";import"./index-2d2feee2.js";import"./index-5ac05b62.js";import"./ClipLoader-29df03f2.js";import"./Skeleton-3b68f86c.js";import"./Stack-b36fa4f0.js";import"./index-57403e2a.js";import"./FormControlLabel-62d43932.js";import"./Typography-29a87229.js";import"./createSvgIcon-0f0c8bae.js";import"./isPlainObject-9804f5ae.js";function D(t){const[i,s,r]=t.split(":").map(Number);return Number((i*60*60*1e3+s*60*1e3+r*1e3).toFixed(6))}const Z=n.memo(()=>{const t=W(a=>a.isPlaying),i=W(a=>a.setIsPlaying),s=W(a=>a.setVolume),r=W(a=>a.setPlaybackSpeed),c=W(a=>a.playbackSpeed),o=W(a=>a.playerRef),[x,b]=n.useState(!1),m=[.5,1,1.5,2],g=()=>{if(o){const a=o.getCurrentTime()-15;o.seekTo(a,"seconds")}},p=()=>{if(o){const a=o.getCurrentTime()+15;o.seekTo(a,"seconds")}},j=()=>{i(!t)},d=()=>{b(!x),s(x?1:0)},h=()=>{const I=(m.indexOf(c)+1)%m.length,F=m[I];if(r(F),o){const P=o.getInternalPlayer();P&&typeof P.playbackRate<"u"&&(P.playbackRate=F)}};return e.jsxs(ke,{children:[e.jsx(Pe,{onClick:d,children:x?e.jsx(be,{}):e.jsx(we,{})}),e.jsx(Te,{onClick:g,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(Ce,{"data-testid":"play-pause-button",onClick:j,size:"small",children:t?e.jsx(ge,{"data-testid":"pause-icon"}):e.jsx(xe,{"data-testid":"play-icon"})}),e.jsx(Ie,{onClick:p,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(_e,{onClick:h,children:[c,"x"]})]})});Z.displayName="Controls";const ke=f(S).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${T.BG1};
  border-radius: 40px;
