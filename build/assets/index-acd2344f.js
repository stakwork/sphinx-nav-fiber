import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,C as B,h as c,r as v,x as C}from"./index-a862a11c.js";import{B as F}from"./index-1e0a9031.js";import{u as M}from"./index-c73e4a58.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-e850364a.js";import{B as f,T as L,a as R}from"./index-a2251863.js";import{T as x}from"./index-dcf21e2a.js";import"./useSlotProps-59b36d6b.js";import"./index.esm-0a823913.js";import"./InfoIcon-b0d8fabf.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
