import{f as n,h as i,F as s,i as I,r as f,k as A,y as be,j as e,T as k,o as ke,V as ve,a5 as _,U as L,a3 as $e,l as Se}from"./index-d939ea8c.js";import{d as Te,B as R,A as z,I as Q,f as G,g as q,n as U,P as K,C as X,i as _e,b as ze,S as Be}from"./react-toastify.esm-cf8782e0.js";import{S as Ce}from"./index-3cbc9bcb.js";import{a as Ie}from"./index-8f303e13.js";import{M as Pe,p as Ae,R as Ee,a as Me,S as Re,b as Ge,m as De,N as J,G as Z,L as H,B as Fe,H as Ye,C as Le,D as ee,c as te,d as He,f as We,g as se,e as Oe,P as Ve,h as oe,s as O,V as Ne,F as Qe,E as qe,i as Ue,j as Ke,k as Xe,l as Je}from"./ChevronRightIcon-c782357b.js";import{o as ie,P as re,n as Ze,X as et,Y as tt,T as st,D as ot,f as ne,S as W,q as ae}from"./generateCategoricalChart-3c01134b.js";import{f as it,c as rt,g as nt,h as at}from"./index.esm-289835b5.js";import{T as lt,F as ct}from"./Popover-144bfca7.js";import{I as xt,S as dt,O as pt,T as M}from"./index-e0c3cdc4.js";import{C as ht}from"./ChevronDownIcon-711ae1f1.js";import{C as yt}from"./CheckIcon-299d14a4.js";import{I as ut}from"./InfoIcon-d7130bbb.js";import"./useSlotProps-e80d3e5c.js";const ft=48,gt=8,mt={PaperProps:{style:{maxHeight:ft*4.5+gt,width:250}}},jt=["Beginner","Intermediate","Advanced","Expert"],wt=()=>{const t=I(p=>p.data),[o,r]=f.useState(""),[a,l]=f.useState("Beginner"),d=A(p=>p.currentSearch),c=Te(),[h]=be(p=>[p.setBudget]),[u,x,g,b,y]=ie(p=>[p.askedQuestions,p.askedQuestionsAnswers,p.setAskedQuestion,p.setAskedQuestionAnswer,p.hasQuestionInProgress]),w=f.useCallback(p=>{b(p.answer)},[b]);f.useEffect(()=>{c&&w&&c.on("askquestionhook",w)},[w,c]);const S=async()=>{o&&(g(o),r(""));try{const p=t==null?void 0:t.nodes.filter(C=>C.text),T=p==null?void 0:p.slice(0,5),F=(T!=null&&T.length?T.map(C=>C.text).join(" "):"").substring(0,2500).replace(/[?&=+/#]/g,C=>`\\${C}`);d&&(await ke.enable(),await Ae({expertise_level:a,question_text:o,search_term:d,transcripts:F},h),await ve(h))}catch(p){console.error(p)}},m=a&&o.trim()&&!y,v=p=>{l(p.target.value)},B=async p=>{if(y){p.preventDefault();return}p.keyCode===13&&p.shiftKey===!1&&m&&(p.preventDefault(),S())};return e.jsxs(bt,{children:[e.jsx(s,{children:e.jsx(s,{children:e.jsxs(ct,{component:"div",children:[e.jsx(vt,{id:"select-label",size:"small",children:"Expertise level"}),e.jsx($t,{id:"demo-multiple-name",input:e.jsx(pt,{label:"Expertise level"}),labelId:"select-label",MenuProps:mt,onChange:v,size:"small",value:a,children:jt.map(p=>e.jsx(Pe,{component:"li",value:p,children:p},p))})]})})}),e.jsx(_t,{children:u==null?void 0:u.map((p,T)=>e.jsxs(s,{className:"response",py:12,children:[e.jsx(k,{kind:"medium",children:p}),e.jsx(s,{py:12,children:(x==null?void 0:x[T])!==void 0?e.jsx(k,{color:"unreadMsgText",children:x[T]}):e.jsxs(s,{align:"center",py:12,children:[e.jsx(s,{align:"center",py:12,children:e.jsx(re,{color:i.white})}),e.jsx(s,{align:"center",py:12,children:e.jsx(k,{children:"Generating response"})})]})})]},p))}),e.jsxs(St,{onKeyDown:B,py:12,tabIndex:-1,children:[e.jsx(kt,{disabled:y,onChange:p=>r(p.target.value),placeholder:"Enter your question",value:o}),e.jsx(Tt,{children:e.jsx(it,{color:m?i.white:i.gray300,size:"18"})})]})]})},bt=n.div`
  margin-top: 20px;
`,kt=n(lt)`
...
`,Bs=({onClick:t,timestamp:o,isSelected:r,setOpenClip:a})=>{const l=r?"blueTextAccent":"placeholderText";return r?(nt,i[l]):(at,i[l]),e.jsxs(zs,{align:"center","data-testid":"wrapper",direction:"row",isSelected:r,justify:"flex-start",onClick:t,px:20,py:20,children:[e.jsxs("div",{children:[e.jsx(Q,{className:"play-pause",children:r?e.jsx(_s,{}):e.jsx(He,{})}),!1]}),e.jsxs(Cs,{align:"flex-start",direction:"column",justify:"center",children:[o.timestamp&&e.jsx("span",{className:"timestamp",children:We(o.timestamp)}),e.jsx("span",{className:"title",children:ne(o.show_title)})]}),e.jsx("div",{className:"info",children:e.jsx(s,{"data-testid":"info-icon-wrapper",onClick:()=>a(o),pt:4,children:e.jsx(ut,{})})})]})},Cs=n(s)`
  font-size: 13px;
  color: ${i.white};
  font-family: 'Barlow';
  margin: 0 16px;
...
`,Ys=n.img`
  ...
  border-radius: 50%;
  background: green;
`,Ls=()=>{const t=_(),o=(t==null?void 0:t.name)||(t==null?void 0:t.label);return e.jsxs(s,{direction:"row",px:24,py:16,children:[e.jsx(z,{"data-testid":"person-image",size:80,src:(t==null?void 0:t.image_url)||"person_placeholder_img.png",type:"person"}),e.jsx(s,{p:20,children:e.jsx(k,{color:"primaryText1",kind:"bigHeading",children:o})})]})},Hs=({node:t,onClick:o})=>{var l,d;const r=q(t.timestamp||""),a=Math.ceil(r/60);return e.jsx(Ws,{onClick:o,p:24,children:e.jsxs("div",{children:[e.jsxs(s,{align:"flex-start",direction:"row",justify:"flex-start",children:[e.jsx(s,{align:"center",children:e.jsx(z,{size:64,src:(t==null?void 0:t.image_url)||"",type:(t==null?void 0:t.node_type)||"episode"})}),e.jsxs("div",{className:"content",children:[e.jsxs(s,{align:"center",direction:"row",children:[e.jsx(M,{type:"episode"}),a>0&&e.jsxs("div",{className:"subtitle",children:[a," ",a===1?"min":"mins"]})]}),e.jsx(k,{className:"title",color:"primaryText1",kind:"regular",children:t.episode_title})]})]}),e.jsxs(s,{align:"center",direction:"row",justify:"flex-end",pt:4,children:[e.jsxs(k,{className:"clipText",color:"mainBottomIcons",kind:"regular",children:[((l=t==null?void 0:t.children)==null?void 0:l.length)||0," ",((d=t==null?void 0:t.children)==null?void 0:d.length)===1?"Clip":"Clips"]}),e.jsx(Ve,{style:{color:i.white}})]})]})})},Ws=n(s).attrs({})`
  direction: row;
  cursor: pointer;
  color: ${i.primaryText1};
  border-bottom: 1px solid #101317;
