import{N as Q,f as y,h as b,F as t,T,y as G,r as f,j as e,aY as X,aZ as ee,D as F,b0 as te,J as se,b1 as ne,B as $,i as oe,a_ as I,b2 as re,o as ie,O as ae}from"./index-764dd9e8.js";import{B as C,C as V,i as ce,c as le,F as de}from"./react-toastify.esm-f273c043.js";import{B as pe}from"./index-871e0036.js";import{S as me}from"./index-c46b7ab1.js";import{i as xe}from"./index.esm-493909c5.js";import{C as ue}from"./CheckIcon-28f4029d.js";import{n as z,a as he,i as fe}from"./index-eed7df3f.js";import{p as ye}from"./index-432f8540.js";import{T as L}from"./index-b660f407.js";import{A as ge}from"./index-7cbb7bc6.js";import{c as je}from"./index-64f1c910.js";import"./generateCategoricalChart-acd9200a.js";import"./Popover-04da5681.js";import"./useSlotProps-4dea8ecb.js";import"./InfoIcon-607a1426.js";import"./NoFilterResultIcon-d43ff6f3.js";import"./index-24db84f5.js";import"./index-684a63ae.js";import"./PlusIcon-785d1109.js";import"./index-f535dfe9.js";import"./Popper-afa8be10.js";const we=async(o,i,a="")=>await Q.post(`/${o}`,JSON.stringify(i),{Authorization:a}),be=async(o,i,a,x,d,r)=>{const m=o==="Create custom type"?"schema":"node",l={node_data:{...i,...o==="Image"&&{source_link:a}},node_type:o,name:x,pubkey:r};return we(m,l,d)},Se=({onClick:o,loading:i,error:a})=>{const x=G(l=>l.budget),[d,r]=f.useState(10),m="node";return f.useEffect(()=>{(async()=>{try{const u=await ee(m);r(u.data.price)}catch(u){console.error("cannot fetch",u)}})()},[m]),e.jsxs(t,{children:[e.jsx(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:e.jsx(t,{align:"center",direction:"row",children:e.jsx(Ce,{children:"Approve Cost"})})}),e.jsxs(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:[e.jsxs(Ne,{children:[e.jsx("div",{className:"title",children:"COST"}),e.jsxs("div",{className:"value","data-testid":"check-price",children:[d," sats"]})]}),e.jsxs(Te,{children:[e.jsx("div",{className:"title",children:"BUDGET"}),e.jsxs("div",{className:"value",children:[X(x)," sats"]})]})]}),e.jsx(t,{children:e.jsx(C,{color:"secondary","data-testid":"check-icon",disabled:i||!!a,onClick:o,size:"large",startIcon:i?e.jsx(R,{children:e.jsx(V,{color:b.lightGray,size:12})}):e.jsxs(R,{children:[" ",e.jsx(ue,{})]}),type:"submit",variant:"contained",children:"Approve"})}),a?e.jsx(ve,{children:e.jsxs(ke,{children:[e.jsx(xe,{className:"errorIcon"}),e.jsx("span",{children:a})]})}):null]})},Ne=y(t).attrs({direction:"column",align:"space-between",justify:"flex-start"})`
  width: 141px;
  height: 61px;
