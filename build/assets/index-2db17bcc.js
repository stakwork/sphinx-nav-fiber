import{s as f,c as y,u as z,r as p,j as e,F as t,T as h,b as N,x as R,o as U,ad as V,ae as g,d as G,a2 as q}from"./index-71257a51.js";import{ak as J,B as j,al as Y,l as H,u as K,F as Q}from"./react-toastify.esm-80f7abc3.js";import{B as W}from"./index-fcf46a2b.js";import{n as S}from"./toastMessage-204e825c.js";import{u as X}from"./index-81b7e2b0.js";import{C as Z}from"./CheckIcon-1df7b8a8.js";import{C as ee}from"./ClipLoader-954a7bed.js";import{T as B}from"./index-905dce1b.js";import{A as te}from"./index-bfeb668a.js";import{i as v,O as L}from"./constants-84edb5fc.js";import"./index.esm-5156b765.js";import"./InfoIcon-b5d1954e.js";import"./index-c1388cf9.js";import"./Popover-750f866a.js";import"./useSlotProps-e0213659.js";import"./Select-f9d2f4e0.js";import"./Stack-f8f836ce.js";import"./Popper-52fdc8f0.js";const ne=({onClick:n,loading:a})=>{const d=z(l=>l.budget),[c,m]=p.useState(10),s="node";return p.useEffect(()=>{(async()=>{try{const r=await Y(s);m(r.data.price)}catch(r){console.error("cannot fetch",r)}})()},[s]),e.jsxs(t,{children:[e.jsx(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:e.jsx(t,{align:"center",direction:"row",children:e.jsx(re,{children:"Approve Cost"})})}),e.jsxs(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:[e.jsxs(oe,{children:[e.jsx("div",{className:"title",children:"COST"}),e.jsxs("div",{className:"value","data-testid":"check-price",children:[c," sats"]})]}),e.jsxs(se,{children:[e.jsx("div",{className:"title",children:"BUDGET"}),e.jsxs("div",{className:"value",children:[J(d)," sats"]})]})]}),e.jsx(t,{children:e.jsx(j,{color:"secondary","data-testid":"check-icon",disabled:a,onClick:n,size:"large",startIcon:a?e.jsx(ee,{size:24}):e.jsx(Z,{}),type:"submit",variant:"contained",children:"Approve"})})]})},oe=f(t).attrs({direction:"column",align:"space-between",justify:"flex-start"})`
  width: 141px;
  height: 61px;
