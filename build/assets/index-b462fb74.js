import{b9 as z,Y as b,v as m,ba as k,R as j,bb as E,bc as L,f as u,h as d,x as N,r as f,j as e,F as n,bd as M,T as y,be as V,C as Y,b2 as W,bi as q,W as H,bh as J,P as K,o as Q,bg as X}from"./index-c3091316.js";import{B as w,c as ee,F as te}from"./react-toastify.esm-fad7643a.js";import{B as ne}from"./index-6fd19dcf.js";import{u as se}from"./index-4da64e1a.js";import{C as oe}from"./CheckIcon-e88736d1.js";import{T as _}from"./index-569ac69e.js";import"./index.esm-ca764106.js";import"./InfoIcon-88c27bc6.js";const C=/\btwitter\.com\/(?:@)?([\w_]+)(?:$|\?[^/]*$)/,re=/(https?:\/\/)?(www\.)?youtube\.com\/watch\?v=([A-Za-z0-9_-]+)/,ie=/(https?:\/\/)?(www\.)?youtube\.com\/live\/([A-Za-z0-9_-]+)/,ae=/https:\/\/twitter\.com\/i\/spaces\/([A-Za-z0-9_-]+)/,ce=/https:\/\/twitter\.com\/[^/]+\/status\/(\d+)/,de=/(https?:\/\/)?([A-Za-z0-9_-]+)\.mp3/,le=/(https?:\/\/)?(.*\.)?.+\/(feed|rss|rss.xml|.*.rss|.*\?(feed|format)=rss)$/,ue=/https?:\/\/(www\.)?youtube\.com\/(user\/)?(@)?([\w-]+)/,xe=/^(https?|ftp):\/\/[^\s/$.?#].[^\s]*$/,he=/https:\/\/twitter\.com\/i\/broadcasts\/([A-Za-z0-9_-]+)/;function fe(t){return[ie,he,re,ae,de].some(s=>s.test(t))?z:ue.test(t)?b:C.test(t)?m:ce.test(t)?k:le.test(t)?j:xe.test(t)?E:L}const we=(t,r="")=>{const a=(r===m?C:/@(\w+)/).exec(t);return a?a[1]:null},B=t=>!!t&&[m,b,j].includes(t),ge=({onClick:t,loading:r,type:s})=>{const a=N(i=>i.budget),[x,o]=f.useState(10),c=B(s)?"radar":"add_node";return f.useEffect(()=>{(async()=>{try{const l=await V(c);o(l.data.price)}catch(l){console.error("cannot fetch",l)}})()},[c]),e.jsxs(n,{children:[e.jsx(n,{align:"center",direction:"row",justify:"space-between",mb:20,children:e.jsx(n,{align:"center",direction:"row",children:e.jsx(be,{children:"Approve Cost"})})}),e.jsxs(n,{align:"center",direction:"row",justify:"space-between",mb:20,children:[e.jsxs(me,{children:[e.jsx("div",{className:"title",children:"COST"}),e.jsxs("div",{className:"value","data-testid":"check-price",children:[x," sats"]})]}),e.jsxs(pe,{children:[e.jsx("div",{className:"title",children:"BUDGET"}),e.jsxs("div",{className:"value",children:[M(a)," sats"]})]})]}),e.jsx(n,{children:e.jsx(w,{color:"secondary","data-testid":"check-icon",disabled:r,onClick:t,size:"large",startIcon:e.jsx(oe,{}),type:"submit",variant:"contained",children:"Approve"})})]})},me=u(n).attrs({direction:"column",align:"space-between",justify:"flex-start"})`
  width: 141px;
  height: 61px;
...
`,P=/^(https?:\/\/)?(((?:[a-zA-Z\d](?:[a-zA-Z\d-]*[a-zA-Z\d])*)\.)+[a-zA-Z]{2,}|((\d{1,3}\.){3}\d{1,3}))(:\d+)?(\/[-a-zA-Z\d%_.~+]*)*(\?[;&a-zA-Z\d%_.~+=-]*)?(#[-a-zA-Z\d_]*)?(@[a-zA-Z\d-]+)?$/i;function T(t){return!!P.test(t)}const Be=({type:t,onNextStep:r,allowNextStep:s})=>e.jsxs(n,{children:[e.jsx(n,{align:"center",direction:"row",justify:"space-between",mb:18,children:e.jsx(n,{align:"center",direction:"row",children:e.jsx(Re,{children:"Add Content"})})}),e.jsx(n,{mb:12,children:e.jsx(_,{id:"cy-youtube-channel-id",maxLength:250,name:"source",placeholder:"Paste your url here...",rules:{...Y,...t!==z?{pattern:{message:"Please enter a valid URL",value:P},validate:{source:T}}:{}}})}),e.jsx(n,{children:e.jsx(w,{color:"secondary","data-testid":"add-content-btn",disabled:!s,onClick:r,size:"large",variant:"contained",children:"Next"})})]}),Re=u(y)`
  font-size: 22px;
  font-weight: 600;
  font-family: 'Barlow';
...
`,Z=async(t,r,s,a)=>{const x=B(s)?"radar":"add_node",o={};if(s===z)o.media_url=t.source,o.content_type="audio_video";else if(s===k){if(/(?:https?:\/\/)?(?:www\.)?twitter\.com\/\w+\/status\/\d+/s.test(t.source)){const l=/\/status\/(\d+)/,h=t.source.match(l);if(h!=null&&h[1]){const[,p]=h;o.tweet_id=p}}else o.tweet_id=t.source;o.content_type="tweet"}else if(s===E)o.content_type="webpage",o.web_page=t.source;else if(s===L)o.content_type="document",o.text=t.source;else if(s===m){const[,i]=(t.source||"").match(C)||[];if(i)o.source=i,o.source_type=s;else return}else(s===b||s===j)&&(o.source=t.source,o.source_type=s);t.latitude&&t.longitude&&(o.latitude=t.latitude,o.longitude=t.longitude);let c="";await q(async()=>{const i=await Q.enable();o.pubkey=i==null?void 0:i.pubkey,c=await X()});try{const i=await H.post(`/${x}`,JSON.stringify(o),{Authorization:c});if(i.error){const{message:l}=i.error;throw new Error(l)}r()}catch(i){i.status===402&&(await J(a),await K(a),await Z(t,r,s,a)),i.status===400&&(await i.json(),r()),i instanceof Error&&r()}},Oe=()=>{const[t,r]=f.useState(0),{close:s,visible:a}=se("addContent"),[x]=N(v=>[v.setBudget]),o=ee({mode:"onChange"}),{watch:c,setValue:i,reset:l}=o,[h,p]=f.useState(!1);f.useEffect(()=>()=>{r(0),l()},[a,l]);const g=c("inputType"),R=c("source"),I=c("longitude"),U=c("latitude"),A=c("source"),O=T(R);f.useEffect(()=>{i("inputType",fe(A))},[A,i]);const F=()=>{s()},S=()=>{r(t+1)},G=()=>{r(t-1)},D=o.handleSubmit(async v=>{p(!0);try{await Z(v,F,g,x)}catch{console.error(W)}finally{p(!1)}});return e.jsx(ne,{id:"addContent",kind:"small",onClose:s,preventOutsideClose:!0,children:e.jsx(te,{...o,children:e.jsxs("form",{id:"add-node-form",onSubmit:D,children:[t===0&&e.jsx(Be,{allowNextStep:O,onNextStep:S,type:g}),t===1&&e.jsx(e.Fragment,{children:B(g)?e.jsx($e,{onNextStep:S,onPrevStep:G,type:g,value:R}):e.jsx(_e,{form:o,latitude:U,longitude:I,onNextStep:S})}),t===2&&e.jsx(ge,{loading:h,onClick:()=>null,type:g})]})})})};export{Oe as AddContentModal};
