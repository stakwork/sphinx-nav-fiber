import{f as r,F as i,T as g,i as y,j as e,k as b,L as S,D as w,h as x,r as T,x as v,B as m}from"./index-b4ddddac.js";import{B}from"./index-f60f6389.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-3101a61e.js";import{B as f,T as $,a as k}from"./index-e86ca227.js";import{T as u}from"./index-778511c4.js";import"./useSlotProps-967ff6fc.js";import"./index.esm-655f6b56.js";import"./InfoIcon-2c3fee8b.js";const F=({onClose:t})=>{const[s]=y(n=>[n.graphStyle]),o=()=>{localStorage.setItem("graphStyle",s),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(L,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(i,{mt:308,children:e.jsx(f,{kind:"big",onClick:o,children:"Save Changes"})})]})},G=r(i)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,L=r(g)`
