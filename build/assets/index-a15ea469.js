import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-473e9613.js";import{B}from"./index-e0df1c4d.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-8ea40dcb.js";import{B as f,T as $,a as k}from"./index-caf2152c.js";import{T as u}from"./index-081eea88.js";import"./useSlotProps-20963a6a.js";import"./index.esm-8fbb4ed1.js";import"./InfoIcon-097fd6c3.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
