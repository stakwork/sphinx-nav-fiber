import{s as r,F as n,T as g,j as e,h as w,b as c,r as A,g as B}from"./index-3184f6a8.js";import{B as v}from"./index-fbbb7e8b.js";import{u as F}from"./index-499757a5.js";import{e as M,X as $,t as C,h as b,z as D,F as k,C as G}from"./react-toastify.esm-a665cfb0.js";import{B as f,T as R,a as z}from"./index-d8b579bd.js";import{T as x}from"./index-e4eae64b.js";import"./useSlotProps-0a22e092.js";import"./index.esm-be4952b8.js";import"./InfoIcon-23a04700.js";const L=({onClose:s})=>{const[a]=M(t=>[t.graphStyle]),i=()=>{localStorage.setItem("graphStyle",a),s()};return e.jsxs(P,{direction:"column",children:[e.jsx(V,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:i,children:"Save changes"})})]})},P=r(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,V=r(g)`
