import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,C as B,h as c,r as v,x as C}from"./index-90d9c910.js";import{B as F}from"./index-8edf2899.js";import{u as M}from"./index-af778059.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-6e96c1f6.js";import{B as f,T as L,a as R}from"./index-295585ea.js";import{T as x}from"./index-841795f6.js";import"./useSlotProps-bd2fecc8.js";import"./index.esm-4cd96d8a.js";import"./InfoIcon-3f45fbe1.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
