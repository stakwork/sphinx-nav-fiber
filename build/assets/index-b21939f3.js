...
`,Xr=v(y)`
  flex: 1 1 100%;
`,qr=()=>{const{close:t}=co("blueprintGraph"),r=()=>{t()};return o.jsx(Oo,{background:"black",id:"blueprintGraph",kind:"full",preventOutsideClose:!0,children:o.jsx(Zr,{Close:r})})},yi=m.memo(qr);export{yi as BlueprintModal};
