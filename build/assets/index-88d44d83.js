import{s as x,j as e,c as l,F as u,r as f,T as _,_ as B,m as It,d as Nt,a as Fe,Y as We,R as Ge,u as se,l as nt,b as Ot,e as E,B as ot,i as Lt,P as Dt,h as Bt,f as st,g as Rt}from"./index-a86e8971.js";import{B as F,u as z,C as Mt,I as Y,L as Ft,a as it,b as D,c as Wt,v as Gt,A as at,P as Vt,d as V,e as R,S as Yt,f as Ut,g as Ht,h as lt,i as ct,p as Kt,j as dt,k as qt,l as ie,F as ae,m as Xt,n as pt,o as Qt,q as Jt,r as Zt,T as er,s as tr,G as rr,t as nr,w as or,x as sr}from"./react-toastify.esm-a6c446c9.js";import{P as ir,f as Ve,G as ar,u as lr,c as Ye,D as ut,a as cr,E as dr,L as be,b as pe,C as pr,A as ur,i as re,d as hr,e as Ee,g as xr,h as fr,j as ht,k as Ue,l as mr,X as xt,Y as ft,m as gr,n as yr,T as jr,S as br,o as vr,p as wr}from"./generateCategoricalChart-cbb59bfc.js";import{G as Sr}from"./index-59bc6038.js";import{C as $}from"./ClipLoader-0c6875fc.js";import{M as mt,a as gt,b as Tr,c as _r,d as yt,e as Cr}from"./index.esm-0e15041a.js";import{T as Ar,a as fe,b as kr,F as Pe,M as Ne,C as jt,N as $r,c as Er,D as Oe}from"./NoFilterResultIcon-67f32ee8.js";import{s as q,T as bt,A as vt,u as O,I as wt,S as ve}from"./index-78248e32.js";import{S as me,C as St,a as Tt}from"./ChevronUpIcon-80d33a33.js";import{P as ge,I as ye,a as Le,F as _t}from"./Popover-6757eba1.js";import{B as Pr,T as ne}from"./index-be89188e.js";import{u as G}from"./index-d3885f89.js";import{B as De}from"./index-d8e76964.js";import{P as Ct}from"./Popper-4fafa957.js";import{C as At}from"./CheckIcon-c9d146f3.js";import{S as zr}from"./SettingsIcon-1fa2b6f4.js";import{T as Ir,a as Nr}from"./Tabs-2ce8db3f.js";import{S as Or}from"./Stack-7af311eb.js";const Lr=()=>{const[t,r]=z(n=>[n.cameraFocusTrigger,n.setCameraFocusTrigger]);return e.jsx(Dr,{href:"",onClick:()=>r(!t),size:"medium",startIcon:e.jsx(Mt,{})})},Dr=x(F)`
  && {
    padding: 0;
    width: 32px;
    min-width: auto;
...
`,Br=()=>{const t=f.useRef(null),[r,n]=f.useState(0),s=it(),i=z(T=>T.setSelectedNode),[c,a]=D(T=>[T.sidebarIsOpen,T.setSidebarOpen]),[o,p,d,h,g,y]=Wt(T=>[T.isPlaying,T.setIsPlaying,T.playingTime,T.playingNode,T.miniPlayerIsVisible,T.setMiniPlayerIsVisible]),[v,j]=h!=null&&h.timestamp?h.timestamp.split("-").map(T=>Gt(T)):[0,0],m=(d-v)/(j-v)*100;f.useEffect(()=>{var P,S;const T=((P=t.current)==null?void 0:P.offsetWidth)||0,k=((S=t.current)==null?void 0:S.scrollWidth)||0;n(k-T)},[]);const w=T=>{y(!1),T.stopPropagation()},b=()=>{i(h),a(!0)},A=c&&(s==null?void 0:s.ref_id)!==(h==null?void 0:h.ref_id)||h&&!c;return g&&h&&A?e.jsxs(Rr,{onClick:b,children:[e.jsxs(Mr,{children:[e.jsx(at,{src:h.image_url||"",type:h.node_type}),e.jsxs(Fr,{children:[e.jsxs(Ur,{ref:t,children:[e.jsx(Yr,{className:"title",scrollValue:r,children:h.episode_title}),e.jsx("div",{className:"subtitle",children:h.show_title})]}),e.jsx(Gr,{"data-testid":"play-pause-button",onClick:T=>{p(!o),T.stopPropagation()},size:"small",children:o?e.jsx(ir,{"data-testid":"pause-icon"}):e.jsx(Vt,{"data-testid":"play-icon"})})]}),e.jsx(Wr,{onClick:T=>w(T),children:e.jsx(V,{})})]}),e.jsx(Vr,{value:m,variant:"determinate"})]}):null},Rr=x(u).attrs({direction:"column",align:"stretch",justify:"space-between"})`
  padding: 8px;
  background: ${l.BG1};
  border-radius: 6px;
  width: 320px;
...
`,Ur=x(u)`
  overflow: hidden;
  flex: 1;
`,kt=()=>{const t=it(),r=z(n=>n.isFetching);return e.jsxs(Hr,{align:"flex-end",id:"actions-toolbar",children:[!r&&e.jsx(Lr,{}),!r&&e.jsx(Sr,{}),e.jsx(Br,{},t==null?void 0:t.ref_id)]})},Hr=x(u)`
  position: absolute;
  right: 20px;
  bottom: 20px;
  pointer-events: all;
...
`,Qr=({node:t})=>{if(!t)return null;const{node_type:r,show_title:n,episode_title:s,description:i,label:c,text:a,type:o,twitter_handle:p}=t,d=t.guests;let h=!1,g=!1;d&&(d.length&&d[0]!==null&&(h=!0),typeof d[0]=="object"&&(g=!0));let y=t.image_url;if(o==="twitter_space"&&(y="twitter_placeholder.png"),y==null)switch(r){case"guest":y="person_placeholder2.png";break;default:y="noimage.jpeg"}return r==="topic"?null:e.jsx(qr,{borderRadius:8,px:24,py:16,children:r==="tweet"?e.jsx(Kr,{twitterHandle:p}):e.jsxs(e.Fragment,{children:[e.jsxs(u,{direction:"row",children:[e.jsx(Xr,{}),e.jsx(u,{align:"flex-start",pb:12,children:e.jsx(_,{children:r==null?void 0:r.toUpperCase()})})]}),e.jsxs(u,{direction:"row",children:[e.jsx(u,{pr:12,children:e.jsx(at,{src:y,type:"person"})}),e.jsxs("div",{children:[o==="guest"?e.jsxs(u,{direction:"column",children:[e.jsx(_,{children:c}),a&&e.jsx(u,{pt:4,children:e.jsxs(_,{color:"primaryText1",kind:"tiny",children:["@",a]})})]}):e.jsx(_,{color:"primaryText1",kind:"tiny",children:n}),e.jsxs(u,{pt:4,children:[r==="clip"||r==="episode"&&e.jsx(_,{color:"primaryText1",children:"Episode"}),r==="clip"?e.jsx(_,{as:"div",kind:"regularBold",children:Ve(i)}):e.jsx(_,{color:"primaryText1",kind:"tiny",children:s})]}),e.jsxs(u,{pt:12,children:[r==="clip"&&e.jsx(_,{color:"primaryText1",children:"Episode"}),e.jsx(_,{color:"primaryText1",kind:"tiny",children:r==="clip"?s:Ve(i)})]}),h&&e.jsxs(u,{pt:12,children:[e.jsx(_,{color:"primaryText1",children:"People"}),e.jsx(u,{pt:4,children:e.jsx(_,{color:"primaryText1",kind:"tiny",children:g?d.map(v=>v.name?v.name:`@${v.twitter_handle}`).join(", "):d==null?void 0:d.join(", ")})})]})]})]})]})})},Jr=()=>{const[t]=z(r=>[r.hoveredNode]);return e.jsxs(Zr,{children:[t&&e.jsx("div",{id:"tooltip-portal",children:e.jsx(Qr,{node:t})}),e.jsx(kt,{})]})},Zr=x("div")(({theme:t})=>({position:"absolute",zIndex:1,top:0,left:0,userSelect:"none",pointerEvents:"none",display:"flex",justifyContent:"flex-end",alignItems:"flex-start",height:"100%",width:"100%",padding:"16px",[t.breakpoints.down("sm")]:{top:50}})),en=({fullSize:t=!0})=>{const r=D(n=>n.sidebarIsOpen);return e.jsx(tn,{align:"center",className:R({"sidebar-is-open":r&&!t}),justify:"center",children:e.jsx($,{color:l.SECONDARY_BLUE,size:64})})},tn=x(u)`
  ...
  z-index: 1;
`,rn=f.lazy(()=>B(()=>import("./index-b14c3ca0.js"),["assets/index-b14c3ca0.js","assets/index-a86e8971.js","assets/index-3f17fe3b.css","assets/index-d8e76964.js","assets/index-d3885f89.js","assets/react-toastify.esm-a6c446c9.js","assets/react-toastify-b67b3d0b.css","assets/index-59bc6038.js","assets/index-be89188e.js","assets/index.esm-0e15041a.js","assets/InfoIcon-172362a7.js","assets/ClipLoader-0c6875fc.js","assets/Tabs-2ce8db3f.js","assets/useSlotProps-0cc052d5.js"]).then(({SettingsModal:t})=>({default:t}))),nn=f.lazy(()=>B(()=>import("./index-941a1cae.js"),["assets/index-941a1cae.js","assets/index-a86e8971.js","assets/index-3f17fe3b.css","assets/react-toastify.esm-a6c446c9.js","assets/react-toastify-b67b3d0b.css","assets/index-d8e76964.js","assets/index-d3885f89.js","assets/toastMessage-be351725.js","assets/index.esm-0e15041a.js","assets/CheckIcon-c9d146f3.js","assets/ClipLoader-0c6875fc.js","assets/index-be89188e.js","assets/InfoIcon-172362a7.js"]).then(({AddContentModal:t})=>({default:t}))),on=f.lazy(()=>B(()=>import("./index-6a8ed562.js"),["assets/index-6a8ed562.js","assets/index-a86e8971.js","assets/index-3f17fe3b.css","assets/react-toastify.esm-a6c446c9.js","assets/react-toastify-b67b3d0b.css","assets/index-d8e76964.js","assets/index-d3885f89.js","assets/toastMessage-be351725.js","assets/index.esm-0e15041a.js","assets/CheckIcon-c9d146f3.js","assets/ClipLoader-0c6875fc.js","assets/index-be89188e.js","assets/InfoIcon-172362a7.js","assets/index-44b66f75.js","assets/index-1f82fe1c.js","assets/Popover-6757eba1.js","assets/useSlotProps-0cc052d5.js","assets/Select-67651f2d.js","assets/Stack-7af311eb.js","assets/Popper-4fafa957.js","assets/constants-84edb5fc.js"]).then(({AddItemModal:t})=>({default:t}))),sn=f.lazy(()=>B(()=>import("./index-b57c99a1.js"),["assets/index-b57c99a1.js","assets/index-a86e8971.js","assets/index-3f17fe3b.css","assets/index-d8e76964.js","assets/index-d3885f89.js","assets/react-toastify.esm-a6c446c9.js","assets/react-toastify-b67b3d0b.css","assets/generateCategoricalChart-cbb59bfc.js","assets/Popover-6757eba1.js","assets/useSlotProps-0cc052d5.js","assets/InfoIcon-172362a7.js","assets/index-59bc6038.js","assets/ClipLoader-0c6875fc.js","assets/index.esm-0e15041a.js","assets/NoFilterResultIcon-67f32ee8.js","assets/ChevronUpIcon-80d33a33.js","assets/index-78248e32.js","assets/index-be89188e.js","assets/Popper-4fafa957.js","assets/CheckIcon-c9d146f3.js","assets/SettingsIcon-1fa2b6f4.js","assets/Tabs-2ce8db3f.js","assets/Stack-7af311eb.js"]).then(({SourcesTableModal:t})=>({default:t}))),an=f.lazy(()=>B(()=>import("./index-a13f11df.js"),["assets/index-a13f11df.js","assets/index-a86e8971.js","assets/index-3f17fe3b.css","assets/index-d8e76964.js","assets/index-d3885f89.js","assets/react-toastify.esm-a6c446c9.js","assets/react-toastify-b67b3d0b.css","assets/index-78248e32.js","assets/index-be89188e.js","assets/index.esm-0e15041a.js","assets/InfoIcon-172362a7.js","assets/Skeleton-a005283b.js","assets/ClipLoader-0c6875fc.js"]).then(({EditNodeNameModal:t})=>({default:t}))),ln=f.lazy(()=>B(()=>import("./index-ee070a7f.js"),["assets/index-ee070a7f.js","assets/index-a86e8971.js","assets/index-3f17fe3b.css","assets/index-d8e76964.js","assets/index-d3885f89.js","assets/react-toastify.esm-a6c446c9.js","assets/react-toastify-b67b3d0b.css","assets/toastMessage-be351725.js","assets/index.esm-0e15041a.js","assets/Skeleton-a005283b.js","assets/ClipLoader-0c6875fc.js"]).then(({RemoveNodeModal:t})=>({default:t}))),cn=f.lazy(()=>B(()=>import("./index-3d165392.js"),["assets/index-3d165392.js","assets/index-a86e8971.js","assets/index-3f17fe3b.css","assets/index-d8e76964.js","assets/index-d3885f89.js","assets/react-toastify.esm-a6c446c9.js","assets/react-toastify-b67b3d0b.css","assets/toastMessage-be351725.js","assets/index.esm-0e15041a.js","assets/index-44b66f75.js","assets/index-1f82fe1c.js","assets/Popover-6757eba1.js","assets/useSlotProps-0cc052d5.js","assets/Select-67651f2d.js","assets/Stack-7af311eb.js","assets/Popper-4fafa957.js","assets/constants-84edb5fc.js","assets/index-78248e32.js","assets/ClipLoader-0c6875fc.js"]).then(({AddNodeEdgeModal:t})=>({default:t}))),dn=()=>e.jsxs(e.Fragment,{children:[e.jsx(on,{}),e.jsx(nn,{}),e.jsx(rn,{}),e.jsx(an,{}),e.jsx(ln,{}),e.jsx(sn,{}),e.jsx(cn,{})]}),pn=()=>{const t=D(r=>r.appMetaData);return e.jsxs(un,{children:[e.jsxs(hn,{children:[e.jsx(e.Fragment,{children:t.title&&e.jsx(_,{className:"title",color:"white",children:t.title})}),e.jsx(_,{className:"subtitle",children:" Second Brain"})]}),e.jsx(Yt,{})]})},un=x(u).attrs({align:"center",direction:"row",grow:1,justify:"flex-start"})`
  height: 64px;
  position: absolute;
  top: 0px;
  left: 64px;
...
`,jn=({data:t})=>{const r=z(a=>a.setQueuedSources),[n,s]=f.useState(""),i=async a=>{if(t!=null&&t.length)try{const o=await Nt.enable();await Ht(a,o.pubkey),r(t.filter(p=>p.ref_id!==a))}catch(o){console.warn(o)}},c=async a=>{if(!(!a||!(t!=null&&t.length))){s(a);try{await lt(a),r(t==null?void 0:t.filter(o=>o.ref_id!==a))}catch(o){console.warn(o)}finally{s("")}}};return t!=null&&t.length?e.jsxs(Ne,{component:"table",children:[e.jsx(Re,{children:e.jsxs(fe,{component:"tr",children:[e.jsx(C,{className:"empty"}),e.jsx(C,{children:"Type"}),e.jsx(C,{children:"Source"}),e.jsx(C,{}),e.jsx(C,{className:"empty"})]})}),(t==null?void 0:t.length)&&e.jsx("tbody",{children:t==null?void 0:t.map(a=>e.jsxs(Be,{children:[e.jsx(C,{className:"empty"}),e.jsx(C,{children:q[a.source_type]}),e.jsx(C,{width:"268px",children:a.source_type==="twitter_handle"?e.jsxs(Ke,{href:`${bt}/${a.source}?open=system`,target:"_blank",children:["@",a.source]}):e.jsx(Ke,{href:`${a.source}?open=system`,target:"_blank",children:a.source})}),e.jsx(C,{className:"cell-center",children:e.jsxs(u,{direction:"row",justify:"space-between",children:[e.jsx("div",{className:"approve-wrapper",children:e.jsx(He,{className:"centered",onClick:()=>i(a.ref_id),children:e.jsx(mt,{color:l.primaryGreen,fontSize:24})})}),e.jsx("div",{className:"delete-wrapper",children:n===a.ref_id?e.jsx($,{color:l.white,size:16}):e.jsx(jt,{message:"Are you sure ?",onConfirm:()=>c(a.ref_id),children:e.jsx(He,{className:"centered",children:e.jsx(gt,{color:l.primaryRed,fontSize:24})})})})]})}),e.jsx(C,{className:"empty"})]},a.source))})]}):e.jsxs(u,{children:[e.jsx(_,{children:"There is not any results for selected filters"}),e.jsx(Pe,{})]})},He=x(u)`
  width: 20px;
  height: 20px;
  border-radius: 50%;
  cursor: pointer;
...
`,_n=x(ye)`
  ...
  width: 100%;
`,Cn=({data:t,canEdit:r=!1})=>{const n=z(o=>o.setSources),[s,i]=f.useState(""),c=async(o,p)=>{if(t!=null&&t.length)try{await Kt(o,p);const d=t==null?void 0:t.findIndex(g=>g.ref_id===o),h=[...t];h[d]={...h[d],source:p.source},n(h)}catch(d){console.warn(d)}},a=async o=>{if(!(!o||!(t!=null&&t.length))){i(o);try{await lt(o),n(t==null?void 0:t.filter(p=>p.ref_id!==o))}catch(p){console.warn(p)}finally{i("")}}};return t!=null&&t.length?e.jsxs(Ne,{"aria-label":"a dense table",component:"table",id:"sources-table",size:"small",children:[e.jsx(Re,{children:e.jsxs(fe,{component:"tr",children:[e.jsx(C,{className:"empty"}),e.jsx(C,{children:"Type"}),e.jsx(C,{align:"left",children:"Source"}),r&&e.jsx(C,{align:"left"}),e.jsx(C,{className:"empty"})]})}),e.jsx(Er,{component:"tbody",children:t==null?void 0:t.map(o=>e.jsxs(Be,{children:[e.jsx(C,{className:"empty"}),e.jsx(C,{align:"left",children:q[o.source_type]}),e.jsx(C,{align:"left",children:e.jsx(An,{condition:r,wrapper:p=>e.jsx(kn,{id:o.ref_id,onSave:d=>c(o.ref_id,{source:d,source_type:o.source_type}),value:o.source,children:p}),children:o.source_type===Fe||o.source_type===We||o.source_type===Ge?e.jsxs(e.Fragment,{children:[o.source_type===Fe&&e.jsxs(Te,{href:`${bt}/${o.source}`,target:"_blank",children:["@",o.source]}),o.source_type===We&&e.jsx(Te,{href:`${o.source}${o.source.includes("?")?"&":"?"}open=system`,target:"_blank",children:o.source}),o.source_type===Ge&&e.jsx(Te,{href:o.source,target:"_blank",children:o.source})]}):e.jsx("div",{children:o.source})})}),r&&e.jsx(C,{align:"left",children:e.jsx("div",{className:"delete-wrapper",id:`delete-${o.source}`,children:s===o.ref_id?e.jsx($,{color:l.white}):e.jsx(jt,{message:"Are you sure ?",onConfirm:()=>a(o.ref_id),children:e.jsx(K,{className:"centered",children:e.jsx(Tr,{})})})})}),e.jsx(C,{className:"empty"})]},o.source))})]}):e.jsxs(En,{children:[e.jsx($r,{}),e.jsx(_,{className:"text",children:"There is not any results for selected filters"})]})};function An({condition:t,wrapper:r,children:n}){return t?r(n):n}const kn=({value:t,onSave:r,id:n,children:s})=>{const[i,c]=f.useState(!1),[a,o]=f.useState(t),[p,d]=f.useState(!1),h=async()=>{if(n){d(!0);try{await r(a),c(!1)}catch(g){console.warn(g)}finally{d(!1)}}};return e.jsx("div",{children:i?e.jsxs($n,{direction:"row",children:[e.jsx(Pr,{className:"editable-cell__input",name:"cell-input",onChange:g=>o(g),value:a}),e.jsx(K,{align:"center",justify:"center",children:p?e.jsx($,{}):e.jsx(_r,{onClick:h})}),e.jsx(K,{align:"center",className:"secondary",justify:"center",onClick:()=>c(!1),children:e.jsx(yt,{})})]}):e.jsxs(Pn,{direction:"row",children:[s,e.jsx(K,{onClick:()=>c(!0),children:e.jsx(Cr,{size:20})})]})})},$n=x(u)`
  display: flex;
  width: 250px;
...
`,Xe=x(Y)`
  font-size: 24px;
`,Mn=({selectedType:t,setSelectedType:r})=>{const[n,s]=f.useState(null),[i,c]=f.useState([]);f.useEffect(()=>{(async()=>{try{const{data:h}=await qt();c(h.edge_types)}catch(h){console.warn(h)}})()},[c]);const a=d=>{s(d.currentTarget)},o=()=>{s(null)},p=d=>{r(d),o()};return e.jsxs("div",{children:[e.jsxs(Fn,{onClick:a,children:[e.jsx("div",{className:"text",children:"Type"}),e.jsx("div",{className:"value",children:t}),e.jsx("div",{className:"icon",children:n?e.jsx(Tt,{}):e.jsx(St,{})})]}),e.jsx(Gn,{anchorEl:n,anchorOrigin:{vertical:"bottom",horizontal:"left"},anchorPosition:{top:62,left:0},onClose:o,open:!!n,transformOrigin:{vertical:"top",horizontal:"left"},children:e.jsx(_t,{children:i.map(d=>e.jsxs(Wn,{className:R({active:d===t}),onClick:()=>p(d),children:[e.jsx("span",{className:"icon",children:d===t?e.jsx(At,{}):null}),e.jsx("span",{children:d})]},d))})})]})},Fn=x(u).attrs({direction:"row",align:"center"})`
  cursor: pointer;
  flex-grow: 1;
  color: ${l.GRAY6};
  font-family: Barlow;
...
`,os=x(u)`
  ...
  font-size: 12px;
  opacity: 0.5;
`,ss=f.lazy(()=>B(()=>import("./index-f8fe8c51.js"),["assets/index-f8fe8c51.js","assets/index-a86e8971.js","assets/index-3f17fe3b.css","assets/SourcesTableIcon-324cd7fd.js","assets/SettingsIcon-1fa2b6f4.js","assets/index-d3885f89.js"]).then(({MainToolbar:t})=>({default:t}))),is=f.lazy(()=>B(()=>import("./index-fe3fe774.js"),["assets/index-fe3fe774.js","assets/index-a86e8971.js","assets/index-3f17fe3b.css","assets/EditIcon-aa3efde7.js","assets/react-toastify.esm-a6c446c9.js","assets/react-toastify-b67b3d0b.css","assets/generateCategoricalChart-cbb59bfc.js","assets/Popover-6757eba1.js","assets/useSlotProps-0cc052d5.js","assets/InfoIcon-172362a7.js","assets/index-1f82fe1c.js","assets/index.esm-0e15041a.js","assets/PlusIcon-2476200f.js","assets/index-d3885f89.js","assets/index-59bc6038.js","assets/ClipLoader-0c6875fc.js","assets/NoFilterResultIcon-67f32ee8.js","assets/ChevronUpIcon-80d33a33.js","assets/index-78248e32.js","assets/index-be89188e.js","assets/index-d8e76964.js","assets/Popper-4fafa957.js","assets/CheckIcon-c9d146f3.js","assets/SettingsIcon-1fa2b6f4.js","assets/Tabs-2ce8db3f.js","assets/Stack-7af311eb.js"]).then(({Universe:t})=>({default:t}))),as=f.lazy(()=>B(()=>import("./index-cddae2c3.js"),["assets/index-cddae2c3.js","assets/index-a86e8971.js","assets/index-3f17fe3b.css","assets/react-toastify.esm-a6c446c9.js","assets/react-toastify-b67b3d0b.css","assets/SoundIcon-d19b8eae.js","assets/Select-67651f2d.js","assets/Popover-6757eba1.js","assets/useSlotProps-0cc052d5.js","assets/ChevronUpIcon-80d33a33.js","assets/generateCategoricalChart-cbb59bfc.js","assets/InfoIcon-172362a7.js","assets/CheckIcon-c9d146f3.js","assets/index.esm-0e15041a.js","assets/toastMessage-be351725.js","assets/SoundIcon-6125620a.css","assets/index-1f82fe1c.js","assets/Skeleton-a005283b.js","assets/ClipLoader-0c6875fc.js","assets/PlusIcon-2476200f.js","assets/index-d3885f89.js","assets/index-d8e76964.js"]).then(({SideBar:t})=>({default:t}))),ls=()=>{const[t,r]=se(S=>[S.setBudget,S.setNodeCount]),[n,s]=f.useState(!1),[i,c,a,o,p]=[D(S=>S.setSidebarOpen),D(S=>S.currentSearch),D(S=>S.setCurrentSearch),D(S=>S.setRelevanceSelected),D(S=>S.setTranscriptOpen)],d=vr(S=>S.setTeachMeAnswer),[h,g,y,v,j,m]=[z(S=>S.data),z(S=>S.setData),z(S=>S.fetchData),z(S=>S.graphStyle),z(S=>S.setSelectedNode),z(S=>S.setCategoryFilter)],w=tr(),b=ie({mode:"onChange"}),A=b.handleSubmit(({search:S})=>{p(!1),j(null),o(!1),a(S),d(""),m(null)}),T=f.useCallback(async()=>{await y(t,{word:c??""}),i(!0),c&&await st(t)},[y,c,i,t]);f.useEffect(()=>{T()},[c,T]);const k=()=>{if(h){s(!0);const S=sr(v,h.nodes);setTimeout(()=>{g(S),s(!1)},1e3)}};f.useEffect(()=>{k()},[v]);const P=f.useCallback(()=>{r("INCREMENT")},[r]);return f.useEffect(()=>{w&&(w.on("connect_error",S=>{console.error("Socket connection error:",S)}),w.on("newnode",P))},[w,P]),f.useEffect(()=>()=>{w&&w.disconnect()},[w]),e.jsxs(e.Fragment,{children:[e.jsx(rr,{}),e.jsx(xn,{}),e.jsx(nr,{hidden:!Rt}),e.jsx(f.Suspense,{fallback:e.jsx("div",{children:"Loading..."}),children:e.jsxs(ns,{direction:"row",children:[e.jsx(wr,{children:e.jsxs(ae,{...b,children:[e.jsx(ss,{}),e.jsx(as,{onSubmit:A}),e.jsx(is,{}),n&&e.jsx(en,{fullSize:!1}),e.jsx(Jr,{}),e.jsx(Zo,{}),e.jsx(pn,{}),e.jsxs(os,{children:["v",or]}),e.jsx(kt,{})]})}),e.jsx(dn,{}),e.jsx(rs,{}),e.jsx(yn,{})]})})]})},As=Object.freeze(Object.defineProperty({__proto__:null,App:ls},Symbol.toStringTag,{value:"Module"}));export{Jr as O,en as P,bo as S,As as i};
