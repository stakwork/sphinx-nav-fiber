import{s as x,c as f,u as P,r as m,j as e,F as o,T as u,b as N,x as V,o as q,ad as J,g as Y,ae as S,d as H,a2 as K}from"./index-49995fa4.js";import{ak as Q,B as w,al as W,l as X,F as Z,am as ee}from"./react-toastify.esm-ed803d9a.js";import{B as te}from"./index-eb581935.js";import{n as y}from"./toastMessage-0b436248.js";import{a as C}from"./index-af00c73a.js";import{u as oe}from"./index-9b15cf03.js";import{C as ne}from"./CheckIcon-33762d0a.js";import{T as _}from"./index-948a2fc0.js";import{A as se}from"./index-444858ac.js";import"./index.esm-7e06d974.js";import"./InfoIcon-0d27e851.js";import"./index-f0d18353.js";import"./Popover-5ac08f1f.js";import"./useSlotProps-30fb75e9.js";import"./Select-d1b8b39d.js";import"./Stack-81f5dc40.js";import"./Popper-49501b06.js";const ae=({onClick:n,loading:r})=>{const i=P(l=>l.budget),[c,p]=m.useState(10),a="node";return m.useEffect(()=>{(async()=>{try{const t=await W(a);p(t.data.price)}catch(t){console.error("cannot fetch",t)}})()},[a]),e.jsxs(o,{children:[e.jsx(o,{align:"center",direction:"row",justify:"space-between",mb:20,children:e.jsx(o,{align:"center",direction:"row",children:e.jsx(ce,{children:"Approve Cost"})})}),e.jsxs(o,{align:"center",direction:"row",justify:"space-between",mb:20,children:[e.jsxs(re,{children:[e.jsx("div",{className:"title",children:"COST"}),e.jsxs("div",{className:"value","data-testid":"check-price",children:[c," sats"]})]}),e.jsxs(ie,{children:[e.jsx("div",{className:"title",children:"BUDGET"}),e.jsxs("div",{className:"value",children:[Q(i)," sats"]})]})]}),e.jsx(o,{children:e.jsx(w,{color:"secondary","data-testid":"check-icon",disabled:r,onClick:n,size:"large",startIcon:e.jsx(ne,{}),type:"submit",variant:"contained",children:"Approve"})})]})},re=x(o).attrs({direction:"column",align:"space-between",justify:"flex-start"})`
  width: 141px;
  height: 61px;
