import{f as r,F as i,T as g,i as y,j as e,k as b,L as S,D as w,h as x,r as T,x as v,B as m}from"./index-011ab68b.js";import{B}from"./index-9ef2a83d.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-f2080000.js";import{B as f,T as $,a as k}from"./index-97e284b8.js";import{T as u}from"./index-fdc4e7e5.js";import"./useSlotProps-34f386f9.js";import"./index.esm-37e26b1f.js";import"./InfoIcon-3232bd96.js";const F=({onClose:t})=>{const[s]=y(n=>[n.graphStyle]),o=()=>{localStorage.setItem("graphStyle",s),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(L,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(i,{mt:308,children:e.jsx(f,{kind:"big",onClick:o,children:"Save Changes"})})]})},G=r(i)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,L=r(g)`
