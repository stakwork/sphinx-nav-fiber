import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,x as D,B as F}from"./index-ea6fef52.js";import{B as M}from"./index-fcdf8fc4.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-b69ddf8d.js";import{B as f,T as L,a as R}from"./index-5e425efa.js";import{T as x}from"./index-420f842a.js";import"./useSlotProps-810ada0c.js";import"./index.esm-0a18346d.js";import"./InfoIcon-dfcda8b4.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
