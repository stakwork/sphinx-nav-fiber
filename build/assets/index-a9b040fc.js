import{N as Q,f as y,h as b,F as t,T,y as G,r as f,j as e,aW as Z,aX as ee,D as F,a_ as te,J as se,a$ as ne,B as P,i as oe,aY as I,b0 as re,o as ie,O as ae}from"./index-fdf7f64f.js";import{B as C,C as V,i as ce,c as le,F as de}from"./react-toastify.esm-a21689b0.js";import{B as pe}from"./index-3eef7e1d.js";import{S as me}from"./index-037826bd.js";import{i as xe}from"./index.esm-b2e306d3.js";import{C as ue}from"./CheckIcon-db54a8c6.js";import{n as z,a as he,i as fe}from"./index-b5d0ccc0.js";import{p as ye}from"./index-9c89612b.js";import{T as L}from"./index-31ef6a3c.js";import{A as ge}from"./index-ca2feee6.js";import{c as je}from"./index-64f1c910.js";import"./generateCategoricalChart-b60bff6c.js";import"./Popover-31c3cada.js";import"./useSlotProps-2bd0b107.js";import"./InfoIcon-9fa8c43b.js";import"./NoFilterResultIcon-4055a342.js";import"./index-f5d6bf52.js";import"./index-27bc35df.js";import"./PlusIcon-dfb3219f.js";import"./index-20bebddd.js";import"./Popper-46115029.js";const we=async(o,i,a="")=>await Q.post(`/${o}`,JSON.stringify(i),{Authorization:a}),be=async(o,i,a,x,d,r)=>{const m=o==="Create custom type"?"schema":"node",l={node_data:{...i,...o==="Image"&&{source_link:a}},node_type:o,name:x,pubkey:r};return we(m,l,d)},Se=({onClick:o,loading:i,error:a})=>{const x=G(l=>l.budget),[d,r]=f.useState(10),m="node";return f.useEffect(()=>{(async()=>{try{const u=await ee(m);r(u.data.price)}catch(u){console.error("cannot fetch",u)}})()},[m]),e.jsxs(t,{children:[e.jsx(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:e.jsx(t,{align:"center",direction:"row",children:e.jsx(Ce,{children:"Approve Cost"})})}),e.jsxs(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:[e.jsxs(Ne,{children:[e.jsx("div",{className:"title",children:"COST"}),e.jsxs("div",{className:"value","data-testid":"check-price",children:[d," sats"]})]}),e.jsxs(Te,{children:[e.jsx("div",{className:"title",children:"BUDGET"}),e.jsxs("div",{className:"value",children:[Z(x)," sats"]})]})]}),e.jsx(t,{children:e.jsx(C,{color:"secondary","data-testid":"check-icon",disabled:i||!!a,onClick:o,size:"large",startIcon:i?e.jsx(R,{children:e.jsx(V,{color:b.lightGray,size:12})}):e.jsxs(R,{children:[" ",e.jsx(ue,{})]}),type:"submit",variant:"contained",children:"Approve"})}),a?e.jsx(ve,{children:e.jsxs(ke,{children:[e.jsx(xe,{className:"errorIcon"}),e.jsx("span",{children:a})]})}):null]})},Ne=y(t).attrs({direction:"column",align:"space-between",justify:"flex-start"})`
  width: 141px;
  height: 61px;
