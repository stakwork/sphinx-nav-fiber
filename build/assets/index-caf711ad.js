import{x as u,j as t,T as e,f as a,h as o,F as c}from"./index-dab5a5eb.js";import{A as g,a as b,S as m}from"./SourcesTableIcon-1ecd699b.js";import{S as j}from"./SettingsIcon-77a69704.js";import{u as i}from"./index-7ce03c3e.js";const S=()=>{const{open:n}=i("sourcesTable"),{open:d}=i("addItem"),{open:l}=i("addContent"),{open:p}=i("settings"),[x]=u(h=>[h.isAdmin]);return t.jsxs(f,{children:[t.jsx(y,{children:t.jsx("img",{alt:"Second brain",src:"logo.svg"})}),x&&t.jsxs(s,{"data-testid":"add-item-modal",onClick:d,children:[t.jsx(r,{children:t.jsx(g,{})}),t.jsx(e,{children:"Add Item"})]}),t.jsxs(s,{"data-testid":"add-content-modal",onClick:l,children:[t.jsx(r,{children:t.jsx(b,{})}),t.jsx(e,{children:"Add Content"})]}),t.jsxs(s,{id:"cy-open-soure-table",onClick:n,children:[t.jsx(r,{children:t.jsx(m,{})}),t.jsx(e,{children:"Source Table"})]}),t.jsxs(s,{"data-testid":"settings-modal",onClick:p,children:[t.jsx(r,{children:t.jsx(j,{})}),t.jsx(e,{children:"Settings"})]})]})},f=a(c).attrs({align:"flex-start",direction:"column",justify:"flex-start"})`
  flex: 0 0 64px;
  z-index: 31;
