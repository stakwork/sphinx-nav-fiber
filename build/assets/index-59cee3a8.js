import{r as i,j as e,s as u,g as S,F as j,o as X,c as Y,A as oe,p as ie,i as ae,q as ce,H as le,t as pe,v as de}from"./index-8dd94ef7.js";import{t as O,u as H,C as ue}from"./index-2e85dc16.js";import{U as fe}from"./index-2736fe12.js";import{u as T,a as me,b as ge,I as he,c as J,d as xe}from"./index-1a07efe2.js";import{M as ye,V as be}from"./index-f091c68d.js";import{S as we,R as je,s as V,M as ve}from"./index-17fc481a.js";import"./string-a277709d.js";import"./index-4f555384.js";import"./three.module-9722a9fc.js";import"./index-9580141b.js";import"./TextareaAutosize-77fad4ab.js";import"./CheckIcon-d17b56b4.js";import"./index-3686a44e.js";import"./index-a979413a.js";import"./ClipLoader-9b46502d.js";import"./clsx-67dfa631.js";import"./SourcesTableIcon-d905794e.js";import"./DeleteNodeIcon-5beed15c.js";import"./SoundIcon-c1d3fc6d.js";import"./SucessFeedBackIcon-5aca0f14.js";import"./Skeleton-37113358.js";import"./index-7b2981a7.js";import"./Stack-d6a4ea85.js";import"./FormControlLabel-7fe48177.js";import"./Typography-f7341f56.js";import"./createSvgIcon-270c46cc.js";import"./isPlainObject-28284963.js";const K=i.memo(()=>{const r=T(n=>n.isPlaying),a=T(n=>n.setIsPlaying),s=T(n=>n.setVolume),t=T(n=>n.setPlaybackSpeed),c=T(n=>n.playbackSpeed),o=T(n=>n.playerRef),[d,g]=i.useState(!1),m=[.5,1,1.5,2],h=()=>{if(o){const n=o.getCurrentTime()-15;o.seekTo(n,"seconds")}},f=()=>{if(o){const n=o.getCurrentTime()+15;o.seekTo(n,"seconds")}},w=()=>{a(!r)},p=()=>{g(!d),s(d?1:0)},l=()=>{const x=(m.indexOf(c)+1)%m.length,P=m[x];if(t(P),o){const k=o.getInternalPlayer();k&&typeof k.playbackRate<"u"&&(k.playbackRate=P)}};return e.jsxs(Se,{children:[e.jsx(Pe,{onClick:p,children:d?e.jsx(ye,{}):e.jsx(be,{})}),e.jsx(Ce,{onClick:h,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(ke,{"data-testid":"play-pause-button",onClick:w,size:"small",children:r?e.jsx(me,{"data-testid":"pause-icon"}):e.jsx(ge,{"data-testid":"play-icon"})}),e.jsx(Ie,{onClick:f,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(_e,{onClick:l,children:[c,"x"]})]})});K.displayName="Controls";const Se=u(j).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${S.BG1};
  border-radius: 40px;
