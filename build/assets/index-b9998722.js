import{s as f,c as y,u as z,r as x,j as e,F as t,T as h,b as N,w as R,n as U,ad as V,ae as g,d as G,a1 as q}from"./index-0da5a7df.js";import{ak as J,B as j,al as Y,l as H,u as K,F as Q}from"./react-toastify.esm-46ba9299.js";import{B as W}from"./index-65045ab2.js";import{n as S}from"./toastMessage-62466901.js";import{u as X}from"./index-ccf23d9c.js";import{C as Z}from"./CheckIcon-40608fe2.js";import{C as ee}from"./ClipLoader-ff131482.js";import{T as B}from"./index-85601322.js";import{A as te}from"./index-879ed49b.js";import{i as v,O as L}from"./constants-84edb5fc.js";import"./index.esm-37caaf02.js";import"./InfoIcon-6afec7fe.js";import"./index-71cd600c.js";import"./Popover-83f8f498.js";import"./useSlotProps-aaa7b2e0.js";import"./Select-611c91a0.js";import"./Stack-2a3411a9.js";import"./Popper-51a43ee0.js";const ne=({onClick:n,loading:a})=>{const d=z(l=>l.budget),[c,m]=x.useState(10),s="node";return x.useEffect(()=>{(async()=>{try{const r=await Y(s);m(r.data.price)}catch(r){console.error("cannot fetch",r)}})()},[s]),e.jsxs(t,{children:[e.jsx(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:e.jsx(t,{align:"center",direction:"row",children:e.jsx(re,{children:"Approve Cost"})})}),e.jsxs(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:[e.jsxs(oe,{children:[e.jsx("div",{className:"title",children:"COST"}),e.jsxs("div",{className:"value","data-testid":"check-price",children:[c," sats"]})]}),e.jsxs(se,{children:[e.jsx("div",{className:"title",children:"BUDGET"}),e.jsxs("div",{className:"value",children:[J(d)," sats"]})]})]}),e.jsx(t,{children:e.jsx(j,{color:"secondary","data-testid":"check-icon",disabled:a,onClick:n,size:"large",startIcon:a?e.jsx(ee,{size:24}):e.jsx(Z,{}),type:"submit",variant:"contained",children:"Approve"})})]})},oe=f(t).attrs({direction:"column",align:"space-between",justify:"flex-start"})`
  width: 141px;
  height: 61px;
