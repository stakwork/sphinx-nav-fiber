import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-25ff8c5b.js";import{B}from"./index-39363332.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-efd20f3a.js";import{B as f,T as $,a as k}from"./index-879c83d4.js";import{T as u}from"./index-b400a8e4.js";import"./useSlotProps-4463c482.js";import"./index.esm-3976a41d.js";import"./InfoIcon-3ed5933c.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
