import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,C as B,h as c,r as v,x as C}from"./index-03c75c64.js";import{B as F}from"./index-056e2cbb.js";import{u as M}from"./index-f400f1e7.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-7abf1b0a.js";import{B as f,T as L,a as R}from"./index-cd10c42f.js";import{T as x}from"./index-7d3a55f9.js";import"./useSlotProps-2c8a046b.js";import"./index.esm-492b5654.js";import"./InfoIcon-f2ed8d86.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
