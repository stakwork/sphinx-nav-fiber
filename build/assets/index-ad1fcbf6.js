import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,x as D,B as F}from"./index-31ef6bc7.js";import{B as M}from"./index-569ad940.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-efe85912.js";import{B as f,T as L,a as R}from"./index-152f7d12.js";import{T as x}from"./index-888b82dd.js";import"./useSlotProps-8fec50db.js";import"./index.esm-75403a40.js";import"./InfoIcon-52eb573f.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
