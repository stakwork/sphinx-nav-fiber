import{s as r,F as n,T as g,j as e,h as w,b as c,r as A,g as B}from"./index-eb31564a.js";import{B as v}from"./index-82da4564.js";import{u as F}from"./index-a324bf8e.js";import{e as M,X as $,t as C,h as b,z as D,F as k,C as G}from"./react-toastify.esm-95cdac5c.js";import{B as f,T as R,a as z}from"./index-bf831edd.js";import{T as x}from"./index-b62e1346.js";import"./useSlotProps-08d8bf55.js";import"./index.esm-9a4823bc.js";import"./InfoIcon-108cbeff.js";const L=({onClose:s})=>{const[a]=M(t=>[t.graphStyle]),i=()=>{localStorage.setItem("graphStyle",a),s()};return e.jsxs(P,{direction:"column",children:[e.jsx(V,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:i,children:"Save changes"})})]})},P=r(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,V=r(g)`
