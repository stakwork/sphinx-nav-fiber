import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-fc1aaaf0.js";import{B}from"./index-83648741.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-c684bf66.js";import{B as f,T as $,a as k}from"./index-2f560094.js";import{T as u}from"./index-7c5e4be9.js";import"./useSlotProps-4def1bf0.js";import"./index.esm-5267ebda.js";import"./InfoIcon-d44e2789.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
