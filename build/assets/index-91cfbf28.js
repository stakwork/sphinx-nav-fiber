import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-50ecd99b.js";import{B as M}from"./index-f08526e2.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-fd33ffdd.js";import{B as f,T as L,a as R}from"./index-15cd7d9f.js";import{T as x}from"./index-6c0fbac2.js";import"./useSlotProps-b7404ee0.js";import"./index.esm-559d8ba1.js";import"./InfoIcon-960f3051.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
