import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-7581c61b.js";import{B}from"./index-757c305d.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-faf00f02.js";import{B as f,T as $,a as k}from"./index-de10eb26.js";import{T as u}from"./index-c4429dc0.js";import"./useSlotProps-a387145b.js";import"./index.esm-e417f1f8.js";import"./InfoIcon-faa9e813.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
