import{r as o,j as e,s as f,g as v,F as j,o as Y,c as J,A as ae,p as ie,i as ce,q as le,H as pe,t as de,v as ue}from"./index-173303f8.js";import{t as U,u as G,C as me}from"./index-56da99cf.js";import{U as fe}from"./index-aeea1b36.js";import{u as M,a as he,b as ge,I as xe,c as K,d as ye}from"./index-9ee3ad37.js";import{M as we,V as be}from"./index-e5c0464a.js";import{S as je,R as ve,s as V,M as Se}from"./index-6b4196b5.js";import"./string-a277709d.js";import"./index-7ba47109.js";import"./three.module-9722a9fc.js";import"./isPlainObject-10bac472.js";import"./TextareaAutosize-43f509f9.js";import"./CheckIcon-cd1c4c9f.js";import"./index-95a1ebb9.js";import"./index-4434621c.js";import"./index-76591fa3.js";import"./ClipLoader-378c66e1.js";import"./clsx-b9232f80.js";import"./SourcesTableIcon-0f01a151.js";import"./DeleteNodeIcon-8d3da3a3.js";import"./SoundIcon-4c05e2ed.js";import"./SucessFeedBackIcon-373f12bc.js";import"./Skeleton-62fec059.js";import"./index-12b44756.js";import"./Stack-30e40f8e.js";import"./FormControlLabel-6d14d442.js";import"./Typography-29f0d448.js";import"./createSvgIcon-e11e57d4.js";const Q=o.memo(()=>{const r=M(s=>s.isPlaying),a=M(s=>s.setIsPlaying),n=M(s=>s.setVolume),t=M(s=>s.setPlaybackSpeed),c=M(s=>s.playbackSpeed),i=M(s=>s.playerRef),[d,g]=o.useState(!1),y=[.5,1,1.5,2],h=()=>{if(i){const s=i.getCurrentTime()-15;i.seekTo(s,"seconds")}},u=()=>{if(i){const s=i.getCurrentTime()+15;i.seekTo(s,"seconds")}},b=()=>{a(!r)},l=()=>{g(!d),n(d?1:0)},p=()=>{const m=(y.indexOf(c)+1)%y.length,P=y[m];if(t(P),i){const _=i.getInternalPlayer();_&&typeof _.playbackRate<"u"&&(_.playbackRate=P)}};return e.jsxs(ke,{children:[e.jsx(_e,{onClick:l,children:d?e.jsx(we,{}):e.jsx(be,{})}),e.jsx(Ie,{onClick:h,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(Ce,{"data-testid":"play-pause-button",onClick:b,size:"small",children:r?e.jsx(he,{"data-testid":"pause-icon"}):e.jsx(ge,{"data-testid":"play-icon"})}),e.jsx(Pe,{onClick:u,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(Te,{onClick:p,children:[c,"x"]})]})});Q.displayName="Controls";const ke=f(j).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${v.BG1};
  border-radius: 40px;
