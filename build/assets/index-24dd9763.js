import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-5ef49d62.js";import{B as F}from"./index-c8995a48.js";import{u as M}from"./index-e99ac89a.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-aa1b4299.js";import{B as f,T as R,a as L}from"./index-4d709c6b.js";import{T as x}from"./index-8c217b7a.js";import"./useSlotProps-f03f2e4a.js";import"./index.esm-f0e46de8.js";import"./InfoIcon-68d98e01.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
