import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-3d20ff9a.js";import{B as F}from"./index-4abd6777.js";import{u as M}from"./index-7673e63f.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-14e72500.js";import{B as f,T as R,a as L}from"./index-39778afc.js";import{T as x}from"./index-f9307d96.js";import"./useSlotProps-c5c9b9a4.js";import"./index.esm-adc38578.js";import"./InfoIcon-c7ed135c.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
