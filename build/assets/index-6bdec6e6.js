import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-d7ba324c.js";import{B}from"./index-aecf6f59.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-54f99a09.js";import{B as f,T as $,a as k}from"./index-0c5828d4.js";import{T as u}from"./index-c8eb0ffe.js";import"./useSlotProps-dc4e15c3.js";import"./index.esm-75a1d543.js";import"./InfoIcon-62a74ee1.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
