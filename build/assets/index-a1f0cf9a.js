import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-3ea0d4f0.js";import{B as F}from"./index-fbeed36a.js";import{u as M}from"./index-a9063b00.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-370ab964.js";import{B as f,T as R,a as L}from"./index-c4db3fe3.js";import{T as x}from"./index-e4b69447.js";import"./useSlotProps-cd69e1e7.js";import"./index.esm-b5907073.js";import"./InfoIcon-cf9d2b2f.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
