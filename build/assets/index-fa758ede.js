import{s as r,F as n,T as g,j as e,b as w,c,r as A,u as B}from"./index-2dc07d34.js";import{B as v}from"./index-196a7a56.js";import{u as F}from"./index-d0a19889.js";import{u as M,G as $,l as C,b,q as D,F as G}from"./react-toastify.esm-8204b115.js";import{B as f,T as k,a as R}from"./index-271527cc.js";import{T as x}from"./index-4395af69.js";import{C as L}from"./ClipLoader-a01d94b5.js";import"./useSlotProps-de8da9de.js";import"./index.esm-554a6801.js";import"./InfoIcon-ccb1bb98.js";const P=({onClose:s})=>{const[a]=M(t=>[t.graphStyle]),i=()=>{localStorage.setItem("graphStyle",a),s()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:i,children:"Save changes"})})]})},V=r(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=r(g)`
