...
`,ar=v.lazy(()=>Re(()=>import("./index-37b4ee57.js"),["assets/index-37b4ee57.js","assets/index-1e93486a.js","assets/index-b4d03b7b.css","assets/index-dfaa87d3.js","assets/SourcesTableIcon-9fdf221c.js","assets/index-a5371f70.js","assets/CheckIcon-6bfc5225.js","assets/DeleteNodeIcon-b70f61a0.js","assets/SoundIcon-adb38010.js","assets/SucessFeedBackIcon-9825a892.js","assets/ClipLoader-244d42b1.js","assets/TableRow-2324043e.js"]).then(({TweetAnalyze:e})=>({default:e}))),sr=()=>{const e=$(o=>o.setSelectedTweet),t=$(o=>o.selectedTweet),{tweetId:a}=ge(),[r,n]=v.useState(""),{open:i}=$e("tweetAnalyze"),l=(a==null?void 0:a.split("&"))||[],c=o=>{i(),n(o)};return s.jsxs(cr,{align:"stretch",basis:"100%",grow:1,shrink:1,children:[l.length>1?s.jsx(or,{onClick:()=>{c("summary")},children:"Summary Report"}):null,l.map(o=>s.jsx(lr,{className:t===o?"selected":"",onClick:()=>e(o),children:s.jsx(Ut,{handleAnalyzeClick:()=>{c(o)},nodeId:o})},o)),s.jsx(ar,{tweetId:r})]})},or=f.button`
  width: 100%;
  background: ${y.ANALYTICS_CARD_BG};
  color: ${y.white};
  padding: 16px 16px;
