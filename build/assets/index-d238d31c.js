...
`,ar=b.lazy(()=>De(()=>import("./index-00b75e05.js"),["assets/index-00b75e05.js","assets/index-1a2e2dfa.js","assets/index-3165de01.css","assets/index-1ec66a13.js","assets/SourcesTableIcon-0fdd279c.js","assets/index-a9b5b35b.js","assets/CheckIcon-9b72cbb4.js","assets/DeleteNodeIcon-c92b86fa.js","assets/SoundIcon-cd12f044.js","assets/SucessFeedBackIcon-6893c0de.js","assets/ClipLoader-514d990e.js","assets/TableRow-a696103b.js"]).then(({TweetAnalyze:e})=>({default:e}))),sr=()=>{const e=$(o=>o.setSelectedTweet),t=$(o=>o.selectedTweet),{tweetId:a}=xe(),[r,n]=b.useState(""),{open:i}=Re("tweetAnalyze"),l=(a==null?void 0:a.split("&"))||[],c=o=>{i(),n(o)};return s.jsxs(cr,{align:"stretch",basis:"100%",grow:1,shrink:1,children:[l.length>1?s.jsx(or,{onClick:()=>{c("summary")},children:"Summary Report"}):null,l.map(o=>s.jsx(lr,{className:t===o?"selected":"",onClick:()=>e(o),children:s.jsx(Ht,{handleAnalyzeClick:()=>{c(o)},nodeId:o})},o)),s.jsx(ar,{tweetId:r})]})},or=f.button`
  width: 100%;
  background: ${y.ANALYTICS_CARD_BG};
  color: ${y.white};
  padding: 16px 16px;
