import{r as p,a8 as T,j as e,F as x,C as I,bc as _,bo as L,s as n,T as C,a0 as A,i as F,aX as B,k as E,a as N,br as k,B as M}from"./index-b2b122bb.js";import{f as O}from"./index-abe7064a.js";import{u as w}from"./index-29bc66c7.js";import{S as z,A as D,I as P}from"./constants-f4acab1d.js";import{N as X,F as Y,A as R}from"./NodeCircleIcon-25bdeb7d.js";import{A as H,T as W}from"./index-2738058f.js";import{C as U}from"./ClipLoader-d4018a4a.js";import"./index-05320fd1.js";import"./Stack-f01d8812.js";import"./createSvgIcon-f17edc50.js";import"./TextareaAutosize-724e4ba3.js";const $=({topicId:s,onSelect:r,selectedValue:d,dataId:c})=>{const[u,f]=p.useState([]),[g,h]=p.useState(!1),j=p.useMemo(()=>{const o=async i=>{const m={is_muted:"False",sort_by:D,search:i,skip:"0",limit:"1000"};h(!0);try{const v=(await L(m.search)).data.filter(y=>(y==null?void 0:y.ref_id)!==s);f(v)}catch{f([])}finally{h(!1)}};return T.debounce(o,300)},[s]),a=o=>{const i=o.trim();if(!i){f([]);return}i.length>2&&j(o)},b=o=>{const i=o?u.find(m=>m.ref_id===o.value):null;r(i||null)},t=o=>({label:o.search_value,value:o.ref_id,type:o.node_type}),S=o=>o.map(t);return d?e.jsxs(x,{align:"center",basis:"100%",direction:"row",grow:1,shrink:1,children:[e.jsx("span",{children:d.search_value}),e.jsx(z,{onClick:()=>r(null),size:"medium",children:e.jsx(I,{})})]}):e.jsx(H,{dataId:c,handleInputChange:a,isLoading:g,onSelect:b,options:S(u)||_,selectedValue:d?t(d):null})},q=({from:s,onSelect:r,selectedToNode:d,isSwapped:c,setIsSwapped:u})=>e.jsxs(x,{mb:20,children:[e.jsx(x,{align:"center",direction:"row",justify:"space-between",mb:18,children:e.jsx(x,{align:"center",direction:"row",children:e.jsx(G,{children:"Merge topic"})})}),e.jsxs(Q,{swap:c,children:[e.jsx(J,{children:e.jsx(V,{disabled:!0,label:c?"To":"From",swap:c,value:s==null?void 0:s.name})}),e.jsxs(x,{my:16,children:[e.jsx(ee,{children:"Type"}),e.jsx(C,{children:"IS ALIAS"})]}),e.jsx(x,{"data-testid":"to-section-container",children:e.jsxs(Z,{children:[e.jsx(te,{children:c?"From":"To"}),e.jsx($,{dataId:"to-node",onSelect:r,selectedValue:d,topicId:s==null?void 0:s.ref_id})]})}),e.jsxs(K,{children:[e.jsx(oe,{children:e.jsx(X,{})}),e.jsx(se,{"data-testid":"swap-icon",onClick:u,children:e.jsx(Y,{})}),e.jsx(ne,{children:e.jsx(R,{})})]})]})]}),G=n(C)`
  font-size: 22px;
  font-weight: 600;
  font-family: 'Barlow';
`,J=n(x)`
