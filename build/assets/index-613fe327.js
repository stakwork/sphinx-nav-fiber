import{s as r,c as i,F as s,j as e,T as $,h as ee,r as d,u as xe,P as de,d as Ie,f as Ee,a3 as Re}from"./index-2dc20e7d.js";import{A as E,u as R,b as A,ad as pe,ae as Ae,B as I,s as Pe,af as X,ag as Me,a as P,E as Le,I as he,c as U,v as ue,P as te,ah as Ge,ai as ge,aj as De,e as Fe,d as Ne}from"./react-toastify.esm-56d4c274.js";import{G as ye,L as se,B as oe,H as Ye,u as Oe,S as We,a as He,D as Ve,M as Ue,R as Qe,b as qe,c as Ke,d as Xe,N as fe,C as Ze,e as me,f as we,g as Je,h as et,i as je,j as tt,P as st,k as be,s as re,V as ot,F as it,E as nt,l as rt,m as at,n as ke,o as lt,p as ct,q as xt,r as dt,t as pt,v as ht,w as ut,x as gt,y as yt}from"./SoundIcon-d8f73007.js";import{C as ft,S as mt}from"./ChevronUpIcon-686bbeeb.js";import{f as V,o as ve,n as wt,X as jt,Y as bt,T as kt,D as vt,S as ie,q as Ce,P as Q}from"./generateCategoricalChart-777e49e8.js";import{T as W}from"./index-b8661733.js";import{S as Ct}from"./Skeleton-b2423f38.js";import{T as ae}from"./toastMessage-b6d55549.js";import{g as St,d as $t}from"./index.esm-67eceb68.js";import{T as _t,F as Tt}from"./Popover-58a261ca.js";import{I as Bt,S as zt,O as It}from"./Select-d6b9fe17.js";import{C as Et}from"./CheckIcon-62430267.js";import{I as Rt}from"./InfoIcon-925c8f4d.js";import{C as ne}from"./ClipLoader-1a6edc53.js";import{P as At}from"./PlusIcon-a7e5f1e3.js";import{u as J}from"./index-f893b044.js";import{B as Pt}from"./index-bc676046.js";import"./useSlotProps-dfe63508.js";const Mt=({imageUrl:t,name:o})=>e.jsxs(s,{align:"center",direction:"row",children:[t&&e.jsx(Lt,{children:e.jsx(E,{rounded:!0,size:64,src:t||"",type:"image"})}),o&&e.jsx(Gt,{children:o})]}),Lt=r(s)`
  img {
    width: 64px;
    height: 64px
    border-radius: 50%;
...
`,Jt=r.a`
  ...
  font-size: 16px;
  height: 16px;
`,es=({isSearchResult:t})=>{const o=d.useRef(null),n=t?80:10,{setSelectedNode:a,setSelectedTimestamp:l}=R(b=>b),{currentSearch:x,setSidebarOpen:c,setRelevanceSelected:y}=A(b=>b),[g,p]=d.useState(0),f=pe(),u=g*n+n,w=f&&f.length>0?f.length-1>u:!1,C=Oe("sm","down"),k=d.useMemo(()=>{if(f){const b=[...f].sort((h,_)=>(_.date||0)-(h.date||0));return x&&b.sort((h,_)=>{const M=h.node_type==="topic"&&h.name.toLowerCase()===x.toLowerCase()?1:0;return(_.node_type==="topic"&&_.name.toLowerCase()===x.toLowerCase()?1:0)-M}),b.slice(0,u)}return[]},[f,u,x]),j=d.useCallback(b=>{Ae(b),l(b),y(!0),a(b),C&&c(!1)},[a,y,c,l,C]);return e.jsx(e.Fragment,{children:e.jsxs(We,{ref:o,id:"search-result-list",shrink:1,children:[(k??[]).map((b,h)=>{const{image_url:_,date:M,boost:z,type:Y,episode_title:O,show_title:D,node_type:m,text:S,source_link:F,link:N,name:G,profile_picture:B,verified:T=!1,twitter_handle:L}=b||{};return e.jsx(Se,{boostCount:z||0,date:M||0,episodeTitle:V(O),imageUrl:_||"",link:N,name:G||"",onClick:()=>{j(b)},profilePicture:B,showTitle:V(D),sourceLink:F,text:S||"",twitterHandle:L,type:m||Y,verified:T},h.toString())}),e.jsx(ss,{align:"center",background:"BG1",direction:"row",justify:"center",children:w&&e.jsx(I,{onClick:()=>{w&&p(g+1)},size:"medium",children:"Load More"})})]})})},ts=d.memo(es),ss=r(s)`
  flex: 0 0 86px;
