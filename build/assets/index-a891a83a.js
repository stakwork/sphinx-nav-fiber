import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-f4ce4d75.js";import{B as M}from"./index-06bbdfed.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-642b5131.js";import{B as f,T as L,a as R}from"./index-26f90609.js";import{T as x}from"./index-c7fb02c3.js";import"./useSlotProps-ea87b3c6.js";import"./index.esm-c2010acf.js";import"./InfoIcon-7fae6bf5.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
