import{s as r,F as n,T as g,j as e,h as w,b as c,r as A,g as B}from"./index-22bb82b0.js";import{B as v}from"./index-5b70e3ee.js";import{u as F}from"./index-b9edae37.js";import{e as M,X as $,t as C,h as b,z as D,F as k,C as G}from"./react-toastify.esm-d7a5a863.js";import{B as f,T as R,a as z}from"./index-95a1cdaf.js";import{T as x}from"./index-35bc9e01.js";import"./useSlotProps-20bf7be8.js";import"./index.esm-72cd64c8.js";import"./InfoIcon-e7d8de4d.js";const L=({onClose:s})=>{const[a]=M(t=>[t.graphStyle]),i=()=>{localStorage.setItem("graphStyle",a),s()};return e.jsxs(P,{direction:"column",children:[e.jsx(V,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:i,children:"Save changes"})})]})},P=r(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,V=r(g)`
