import{r as i,j as e,s as u,g as h,F as y,o as Z,c as ee,A as pe,p as X,i as de,q as ue,H as me,t as fe,v as he}from"./index-1e93486a.js";import{ClaimsModal as ge}from"./index-76ac1579.js";import{U as xe}from"./index-0a9b3f60.js";import{t as Y,u as F}from"./index-94b4cd7f.js";import{u as P,a as ye,b as be,I as we,c as te,d as je}from"./index-a5371f70.js";import{M as ve,V as ke}from"./index-dfaa87d3.js";import{S as Se,R as Ce,s as U,M as Te}from"./index-951c27da.js";import"./string-a277709d.js";import"./index-780d8bc3.js";import"./three.module-9722a9fc.js";import"./isPlainObject-2e10868b.js";import"./TextareaAutosize-185af8f6.js";import"./CheckIcon-6bfc5225.js";import"./index-a58b41e9.js";import"./index-d51213fc.js";import"./index-e5cae69f.js";import"./ClipLoader-244d42b1.js";import"./clsx-ab173606.js";import"./SourcesTableIcon-9fdf221c.js";import"./DeleteNodeIcon-b70f61a0.js";import"./SoundIcon-adb38010.js";import"./SucessFeedBackIcon-9825a892.js";import"./Skeleton-c67d0b81.js";import"./index-d3006405.js";import"./Stack-69dc32c4.js";import"./FormControlLabel-fd719c83.js";import"./Typography-bca02397.js";import"./createSvgIcon-4ba17075.js";const re=i.memo(()=>{const s=P(a=>a.isPlaying),c=P(a=>a.setIsPlaying),t=P(a=>a.setVolume),r=P(a=>a.setPlaybackSpeed),l=P(a=>a.playbackSpeed),n=P(a=>a.playerRef),[p,g]=i.useState(!1),b=[.5,1,1.5,2],f=()=>{if(n){const a=n.getCurrentTime()-15;n.seekTo(a,"seconds")}},m=()=>{if(n){const a=n.getCurrentTime()+15;n.seekTo(a,"seconds")}},v=()=>{c(!s)},d=()=>{g(!p),t(p?1:0)},o=()=>{const j=(b.indexOf(l)+1)%b.length,C=b[j];if(r(C),n){const E=n.getInternalPlayer();E&&typeof E.playbackRate<"u"&&(E.playbackRate=C)}};return e.jsxs($e,{children:[e.jsx(Re,{onClick:d,children:p?e.jsx(ve,{}):e.jsx(ke,{})}),e.jsx(Ie,{onClick:f,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(Pe,{"data-testid":"play-pause-button",onClick:v,size:"small",children:s?e.jsx(ye,{"data-testid":"pause-icon"}):e.jsx(be,{"data-testid":"play-icon"})}),e.jsx(_e,{onClick:m,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(Ee,{onClick:o,children:[l,"x"]})]})});re.displayName="Controls";const $e=u(y).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${h.BG1};
  border-radius: 40px;
