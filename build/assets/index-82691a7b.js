<<<<<<<< HEAD:build/assets/index-82691a7b.js
...
========
import{a9 as Z,o as g,q as b,F as t,T,J as V,r as y,j as e,b3 as ee,b4 as te,aW as F,b9 as se,K as ne,ba as oe,O as D,B as re,p as ie,aV as I,ab as ae,aa as ce,b7 as le}from"./index-1e219a1f.js";import{B as C,h as de,i as pe,F as me}from"./index-c1584b59.js";import{B as xe}from"./index-856b83d2.js";import{S as ue}from"./index-af55868f.js";import{e as he}from"./index.esm-c4e73cdb.js";import{C as fe}from"./CheckIcon-9e558134.js";import{C as W}from"./ClipLoader-b30ea482.js";import{n as z,O as ye,i as ge}from"./constants-a6b58f4d.js";import{p as q}from"./index-44e303ef.js";import{T as L}from"./index-12a256a3.js";import{A as je}from"./index-8552125f.js";import{c as we}from"./index-64f1c910.js";import"./three.module-2ce81f73.js";import"./InfoIcon-b200b8ad.js";import"./Stack-47fc16b4.js";import"./useSlotProps-60b2a911.js";import"./Popover-a1439155.js";import"./createSvgIcon-261b988c.js";import"./TextareaAutosize-4b6b650e.js";const be=async(o,a,c="")=>await Z.post(`/${o}`,JSON.stringify(a),{Authorization:c}),Se=async(o,a,c,x,d,r)=>{const m=o==="Create custom type"?"schema":"node",l={node_data:{...a,...o==="Image"&&{source_link:c}},node_type:o,name:x,pubkey:r};return be(m,l,d)},Ne=({onClick:o,loading:a,error:c})=>{const x=V(l=>l.budget),[d,r]=y.useState(10),m="node";return y.useEffect(()=>{(async()=>{try{const h=await te(m);r(h.data.price)}catch(h){console.error("cannot fetch",h)}})()},[m]),e.jsxs(t,{children:[e.jsx(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:e.jsx(t,{align:"center",direction:"row",children:e.jsx(ke,{children:"Approve Cost"})})}),e.jsxs(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:[e.jsxs(Te,{children:[e.jsx("div",{className:"title",children:"COST"}),e.jsxs("div",{className:"value","data-testid":"check-price",children:[d," sats"]})]}),e.jsxs(Ce,{children:[e.jsx("div",{className:"title",children:"BUDGET"}),e.jsxs("div",{className:"value",children:[ee(x)," sats"]})]})]}),e.jsx(t,{children:e.jsx(C,{color:"secondary","data-testid":"check-icon",disabled:a||!!c,onClick:o,size:"large",startIcon:a?e.jsx(R,{children:e.jsx(W,{color:b.lightGray,size:12})}):e.jsxs(R,{children:[" ",e.jsx(fe,{})]}),type:"submit",variant:"contained",children:"Approve"})}),c?e.jsx(Be,{children:e.jsxs(ve,{children:[e.jsx(he,{className:"errorIcon"}),e.jsx("span",{children:c})]})}):null]})},Te=g(t).attrs({direction:"column",align:"space-between",justify:"flex-start"})`
>>>>>>>> origin:build/assets/index-110a6a6f.js
  width: 141px;
  height: 61px;
