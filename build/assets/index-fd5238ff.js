import{bw as C,ac as v,ab as b,bx as I,aa as _,by as U,bz as D,Q as x,S as l,N as G,r as p,j as e,U as n,bA as J,a5 as y,bB as Q,ar as X,ad as ee,bC as f,aw as te,ag as se,bD as ne,ay as oe,ax as re,az as ie,b0 as ae}from"./index-2ff05417.js";import{B as w,aF as ce,ab as le,aN as de,aK as B,af as ue,aG as xe,ag as ge}from"./index-fbe55b35.js";import{S as pe}from"./index-619062bd.js";const R=/\b(?:twitter\.com|x\.com)\/(?:@)?([\w_]+)(?:$|\?[^/]*$)/,he=/(https?:\/\/)?(www\.)?youtube\.com\/watch\?v=([A-Za-z0-9_-]+)/,fe=/(https?:\/\/)?(www\.)?youtube\.com\/live\/([A-Za-z0-9_-]+)/,we=/(https?:\/\/)?(www\.)?youtu\.be\/([A-Za-z0-9_-]+)/,me=/https:\/\/twitter\.com\/i\/spaces\/([A-Za-z0-9_-]+)/,be=/https:\/\/(twitter\.com|x\.com)\/[^/]+\/status\/(\d+)/,ye=/(https?:\/\/)?([A-Za-z0-9_-]+)\.mp3/,je=/(https?:\/\/)?(.*\.)?.+\/(feed|rss|rss.xml|.*.rss|.*\?(feed|format)=rss)$/,Se=/https?:\/\/(www\.)?youtube\.com\/(user\/)?(@)?([\w-]+)/,ve=/^(https?|ftp):\/\/[^\s/$.?#].[^\s]*$/,_e=/https:\/\/twitter\.com\/i\/broadcasts\/([A-Za-z0-9_-]+)/;function Ee(t){return[fe,_e,he,we,me,ye].some(r=>r.test(t))?C:Se.test(t)?v:R.test(t)?b:be.test(t)?I:je.test(t)?_:ve.test(t)?U:D}const $e=(t,s="")=>{const a=(s===b?R:/@(\w+)/).exec(t);return a?a[1]:null},N=t=>!!t&&[b,v,_].includes(t),ze=({onClick:t,loading:s,type:r,error:a})=>{const o=G(u=>u.budget),[g,d]=p.useState(10),i=N(r)?"radar":"add_node";return p.useEffect(()=>{(async()=>{try{const c=await Q(i);d(c.data.price)}catch(c){console.error("cannot fetch",c)}})()},[i]),e.jsxs(n,{children:[e.jsx(n,{align:"center",direction:"row",justify:"space-between",mb:20,children:e.jsx(n,{align:"center",direction:"row",children:e.jsx(Ce,{children:"Approve Cost"})})}),e.jsxs(n,{align:"center",direction:"row",justify:"space-between",mb:20,children:[e.jsxs(ke,{children:[e.jsx("div",{className:"title",children:"COST"}),e.jsxs("div",{className:"value","data-testid":"check-price",children:[g," sats"]})]}),e.jsxs(Be,{children:[e.jsx("div",{className:"title",children:"BUDGET"}),e.jsxs("div",{className:"value",children:[J(o)," sats"]})]})]}),e.jsx(n,{children:e.jsx(w,{color:"secondary","data-testid":"check-icon",disabled:s||!!a,onClick:t,size:"large",startIcon:s?e.jsx(P,{children:e.jsx(ce,{color:l.lightGray,size:12})}):e.jsxs(P,{children:[" ",e.jsx(le,{})]}),type:"submit",variant:"contained",children:"Approve"})}),a?e.jsx(Ne,{children:e.jsxs(Re,{children:[e.jsx(de,{className:"errorIcon"}),e.jsx("span",{children:a})]})}):null]})},ke=x(n).attrs({direction:"column",align:"space-between",justify:"flex-start"})`
  width: 141px;
  height: 61px;
