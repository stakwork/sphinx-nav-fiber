import{r as i,j as e,s as u,g as S,F as j,o as X,c as Y,A as oe,p as ie,i as ae,q as ce,H as le,t as pe,v as de}from"./index-4f62fa2e.js";import{t as O,u as H,C as ue}from"./index-4555ce0e.js";import{U as fe}from"./index-85f96fdc.js";import{u as T,a as me,b as ge,I as he,c as J,d as xe}from"./index-c8dccbe5.js";import{M as ye,V as be}from"./index-aeb19dec.js";import{S as we,R as je,s as V,M as ve}from"./index-585b81e2.js";import"./string-a277709d.js";import"./index-8833631d.js";import"./three.module-976f5d36.js";import"./index-52ac0b78.js";import"./TextareaAutosize-0edd83b6.js";import"./CheckIcon-252a916b.js";import"./index-43b07e99.js";import"./index-becdc970.js";import"./ClipLoader-2fb2d658.js";import"./clsx-2fca605f.js";import"./SourcesTableIcon-629212fc.js";import"./DeleteNodeIcon-ee17f57e.js";import"./SoundIcon-d70b2622.js";import"./SucessFeedBackIcon-1139aebd.js";import"./Skeleton-89ecd7a8.js";import"./index-d1ee902c.js";import"./Stack-f25abd91.js";import"./FormControlLabel-eb925856.js";import"./Typography-9d9a662a.js";import"./createSvgIcon-afa39f61.js";import"./isPlainObject-d91c16fb.js";const K=i.memo(()=>{const r=T(n=>n.isPlaying),a=T(n=>n.setIsPlaying),s=T(n=>n.setVolume),t=T(n=>n.setPlaybackSpeed),c=T(n=>n.playbackSpeed),o=T(n=>n.playerRef),[d,g]=i.useState(!1),m=[.5,1,1.5,2],h=()=>{if(o){const n=o.getCurrentTime()-15;o.seekTo(n,"seconds")}},f=()=>{if(o){const n=o.getCurrentTime()+15;o.seekTo(n,"seconds")}},w=()=>{a(!r)},p=()=>{g(!d),s(d?1:0)},l=()=>{const x=(m.indexOf(c)+1)%m.length,P=m[x];if(t(P),o){const k=o.getInternalPlayer();k&&typeof k.playbackRate<"u"&&(k.playbackRate=P)}};return e.jsxs(Se,{children:[e.jsx(Pe,{onClick:p,children:d?e.jsx(ye,{}):e.jsx(be,{})}),e.jsx(Ce,{onClick:h,children:e.jsx("img",{alt:"",src:"/RewindIcon.svg"})}),e.jsx(ke,{"data-testid":"play-pause-button",onClick:w,size:"small",children:r?e.jsx(me,{"data-testid":"pause-icon"}):e.jsx(ge,{"data-testid":"play-icon"})}),e.jsx(Ie,{onClick:f,children:e.jsx("img",{alt:"",src:"/ForwardIcon.svg"})}),e.jsxs(_e,{onClick:l,children:[c,"x"]})]})});K.displayName="Controls";const Se=u(j).attrs({direction:"row",align:"center",justify:"flex-start"})`
  width: 200px;
  height: 54px;
  background: ${S.BG1};
  border-radius: 40px;
