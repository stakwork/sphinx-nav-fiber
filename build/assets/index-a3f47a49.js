import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,x as D,B as F}from"./index-f84c5caa.js";import{B as M}from"./index-2eac630c.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-dd7332df.js";import{B as f,T as L,a as R}from"./index-9ebf036a.js";import{T as x}from"./index-d9e6bbd2.js";import"./useSlotProps-10a4f8ac.js";import"./index.esm-90978199.js";import"./InfoIcon-200eb276.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
