...
`,Tr=({node:e})=>{const t=pe(y=>y.selectedNode),n=ge(y=>y.currentSearch),{link:r,image_url:i,date:o,boost:l,node_type:a,type:u,id:c,show_title:h,episode_title:d,ref_id:f}=e||t||{},[p,w]=P.useState(l||0);return!e&&!t?null:s.jsx("div",{style:{overflow:"auto",flex:1,width:"100%"},children:s.jsxs(Ol,{children:[s.jsx(Rl,{boostCount:p||0,date:o||0,episodeTitle:rt(d),imageUrl:i,isSelectedView:!0,link:r,onClick:()=>null,showTitle:h,type:a||u}),s.jsx(yt,{}),s.jsxs(Ml,{children:[s.jsx(Gt,{amt:p}),s.jsx(wr,{content:e||t,count:p,refId:f,updateCount:w})]}),s.jsx(yt,{}),s.jsx(gn,{children:s.jsx(vl,{node:e||t,searchTerm:n,stateless:!0})}),((t==null?void 0:t.text)||(e==null?void 0:e.text))&&s.jsxs(s.Fragment,{children:[s.jsx(yt,{}),s.jsx(gn,{children:s.jsx(Al,{node:e||t,stateless:!0},c)})]})]})})},Ol=C(g)`
  flex: 1;
  min-height: 100%;
  flex-direction: column;
