import{u as i,F as a,T as b,j as e,M as x,v as d,r as A,w as M}from"./index-bbe6c7e6.js";import{ay as v,cx as B,cy as j,cz as D,aI as y,cA as $,cB as C,cC as h,aO as F,cD as k,cE as G,u as L,cs as R}from"./index-a64602ab.js";const z=({onClose:s})=>{const[n]=v(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",n),s()};return e.jsxs(P,{direction:"column",children:[e.jsx(V,{children:"Default graph view:"}),e.jsx(B,{}),e.jsx(a,{mt:308,children:e.jsx(j,{kind:"big",onClick:r,children:"Save changes"})})]})},P=i(a)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,V=i(b)`
