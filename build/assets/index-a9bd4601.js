import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-2dce50d4.js";import{B}from"./index-92200820.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-253bd08d.js";import{B as f,T as $,a as k}from"./index-d8e30e63.js";import{T as u}from"./index-8ff7815d.js";import"./useSlotProps-74b4f075.js";import"./index.esm-5aaa9399.js";import"./InfoIcon-f5c81c07.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
