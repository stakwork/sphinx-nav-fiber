import{s as r,c as i,F as s,j as e,T as $,h as Z,r as d,u as xe,P as de,d as Ie,g as Ee,f as Re}from"./index-2a9d3beb.js";import{A as E,u as R,b as A,an as pe,ao as Ae,B as I,t as Pe,ap as ne,aq as Me,H as P,D as Le,I as he,J as U,K as ue,ar as Q,P as ee,C as te,as as Ge,at as ge,au as De,c as Fe,h as Ne}from"./react-toastify.esm-07017734.js";import{G as ye,L as se,B as oe,H as Ye,u as We,S as He,a as Oe,D as Ve,M as Ue,R as Qe,b as qe,c as Ke,d as Xe,N as fe,C as Je,e as me,f as we,g as Ze,h as et,i as je,j as tt,P as st,k as be,s as re,V as ot,F as it,E as nt,l as rt,m as at,n as ke,o as lt,p as ct,q as xt,r as dt,t as pt,v as ht,w as ut,x as gt,y as yt}from"./SoundIcon-05eadb42.js";import{C as ft,S as mt}from"./ChevronUpIcon-48a035e3.js";import{f as V,o as ve,n as wt,X as jt,Y as bt,T as kt,D as vt,S as ie,q as Ce}from"./generateCategoricalChart-d45aba97.js";import{T as H}from"./index-69eec19b.js";import{S as Ct}from"./Skeleton-5f3e0afb.js";import{T as ae}from"./toastMessage-b961f51d.js";import{g as St,d as $t}from"./index.esm-7c2c6137.js";import{T as _t,F as Tt}from"./Popover-dabdecb4.js";import{I as Bt,S as zt,O as It}from"./Select-cbc0a71e.js";import{C as Et}from"./CheckIcon-820446e3.js";import{I as Rt}from"./InfoIcon-fa5df30b.js";import{P as At}from"./PlusIcon-746d7811.js";import{u as J}from"./index-82f4c095.js";import{B as Pt}from"./index-5c9cd044.js";import"./useSlotProps-28bca2ab.js";const Mt=({imageUrl:t,name:o})=>e.jsxs(s,{align:"center",direction:"row",children:[t&&e.jsx(Lt,{children:e.jsx(E,{rounded:!0,size:64,src:t||"",type:"image"})}),o&&e.jsx(Gt,{children:o})]}),Lt=r(s)`
  img {
    width: 64px;
    height: 64px
    border-radius: 50%;
...
`,Gt=r(s)`
  ...
  font-weight: 600;
  line-height: 17px;
`,Dt=({text:t,type:o,sourceLink:n})=>e.jsxs(s,{direction:"column",children:[e.jsx(s,{align:"center",direction:"row",children:e.jsx(H,{type:o})}),e.jsx($e,{"data-testid":"episode-description",children:t}),e.jsx(s,{align:"center",direction:"row",justify:"flex-start",children:n&&e.jsxs(Ft,{href:n,onClick:a=>a.stopPropagation(),target:"_blank",children:[e.jsx(ye,{}),e.jsx(Nt,{children:n})]})})]}),Ft=r.a`
  color: ${i.GRAY6};
  font-size: 16px;
  height: 16px;
  display: flex;
...
`,Nt=r($)`
  ...
  font-weight: 400;
  line-height: 18px;
`,Yt=({title:t,imageUrl:o,name:n})=>e.jsxs(s,{align:"center",direction:"row",children:[e.jsx(Wt,{children:e.jsx(E,{rounded:!0,size:64,src:o||"",type:"person"})}),(t||n)&&e.jsx(Ht,{children:t||n})]}),Wt=r(s)`
  img {
    width: 64px;
    height: 64px
    border-radius: 50%;
...
`,Ht=r(s)`
  ...
  font-weight: 600;
  line-height: 17px;
`,Ot=({text:t,imageUrl:o,date:n,twitterHandle:a,name:l,verified:x})=>e.jsxs(s,{direction:"column",children:[e.jsxs(s,{align:"center",direction:"row",pr:16,children:[e.jsx(Vt,{children:e.jsx(E,{rounded:!0,size:27,src:o||"",type:"person"})}),e.jsxs(s,{children:[e.jsxs(Ut,{align:"center",direction:"row",children:[l,x&&e.jsx("div",{className:"verification",children:e.jsx("img",{alt:"verified",src:"verified_twitter.svg"})})]}),a&&e.jsxs(Qt,{children:["@",a]})]})]}),e.jsxs(s,{grow:1,shrink:1,children:[e.jsx(qt,{"data-testid":"episode-description",children:t}),e.jsx(s,{"data-testid":"date-text",direction:"row",justify:"flex-start",children:!!n&&e.jsx(q,{children:Z.unix(n).fromNow()})})]})]}),Vt=r(s)`
  img {
    width: 64px;
    height: 64px;
    border-radius: 50%;
...
`,Se=({boostCount:t,date:o,episodeTitle:n,isSelectedView:a=!1,imageUrl:l,showTitle:x,type:c,text:y,name:g,profilePicture:p,sourceLink:f,verified:v=!1,twitterHandle:u,className:w="episode-wrapper",onClick:C})=>{const k=c==="show"?x:n,j=c==="show"?"":x,b=["tweet","person","guest","topic","document"],h=c==="youtube"?"video":"audio";return c?e.jsx(Kt,{className:w,onClick:C,children:b.includes(c)?e.jsxs(e.Fragment,{children:[c==="topic"&&e.jsxs(Xt,{children:[e.jsx(Ye,{}),e.jsx("p",{children:j})]}),["person","guest"].includes(c)&&e.jsx(Yt,{imageUrl:l,name:g||"",title:x||""}),["image"].includes(c)&&e.jsx(Mt,{imageUrl:f,name:g||""}),c==="tweet"&&e.jsx(Ot,{date:o,imageUrl:p,name:g||"",text:y||"",twitterHandle:u,verified:v}),c==="document"&&e.jsx(Dt,{sourceLink:f||"",text:y||"",type:c})]}):e.jsxs(s,{direction:"row",children:[!a&&e.jsx(s,{align:"center",pr:16,children:e.jsx(E,{size:64,src:l||`${h}_default.svg`,type:c||""})}),e.jsxs(s,{grow:1,shrink:1,children:[e.jsxs(s,{align:"center",direction:"row",justify:"space-between",children:[e.jsx(s,{align:"center",direction:"row",children:c&&e.jsx(H,{type:c})}),c==="youtube"&&f?e.jsx(Zt,{href:`${f}?open=system`,onClick:_=>_.stopPropagation(),children:e.jsx(se,{})}):null]}),e.jsx($e,{"data-testid":"episode-description",children:k}),e.jsxs(s,{align:"center",direction:"row",justify:"flex-start",children:[!!o&&e.jsx(q,{children:Z.unix(o).fromNow()}),!!j&&e.jsx(Jt,{children:j}),!a&&t>0&&e.jsx(s,{style:{marginLeft:"auto"},children:e.jsx(oe,{amt:t})})]})]})]})}):null},$e=r(s)`
  font-family: Barlow;
  font-size: 13px;
  font-style: normal;
  font-weight: 400;
...
`,Zt=r.a`
  ...
  font-size: 16px;
  height: 16px;
`,es=({isSearchResult:t})=>{const o=d.useRef(null),n=t?80:10,{setSelectedNode:a,setSelectedTimestamp:l}=R(b=>b),{currentSearch:x,setSidebarOpen:c,setRelevanceSelected:y}=A(b=>b),[g,p]=d.useState(0),f=pe(),u=g*n+n,w=f&&f.length>0?f.length-1>u:!1,C=We("sm","down"),k=d.useCallback(b=>{Ae(b),l(b),y(!0),a(b),C&&c(!1)},[a,y,c,l,C]),j=d.useMemo(()=>{if(f){const b=[...f].sort((h,_)=>(_.date||0)-(h.date||0));return x&&b.sort((h,_)=>{const M=h.node_type==="topic"&&h.name.toLowerCase()===x.toLowerCase()?1:0;return(_.node_type==="topic"&&_.name.toLowerCase()===x.toLowerCase()?1:0)-M}),b.slice(0,u)}return[]},[f,x,u]);return e.jsx(e.Fragment,{children:e.jsxs(He,{ref:o,id:"search-result-list",shrink:1,children:[(j??[]).map((b,h)=>{const{image_url:_,date:M,boost:z,type:Y,episode_title:W,show_title:D,node_type:m,text:S,source_link:F,link:N,name:G,profile_picture:B,verified:T=!1,twitter_handle:L}=b||{};return e.jsx(Se,{boostCount:z||0,date:M||0,episodeTitle:V(W),imageUrl:_||"",link:N,name:G||"",onClick:()=>{k(b)},profilePicture:B,showTitle:V(D),sourceLink:F,text:S||"",twitterHandle:L,type:m||Y,verified:T},h.toString())}),e.jsx(ss,{align:"center",background:"BG1",direction:"row",justify:"center",children:w&&e.jsx(I,{onClick:()=>{w&&p(g+1)},size:"medium",children:"Load More"})})]})})},ts=d.memo(es),ss=r(s)`
  flex: 0 0 86px;
`,os=({isSearchResult:t})=>{const{nodeCount:o,setNodeCount:n,setBudget:a}=xe(c=>c),{fetchData:l}=R(c=>c),x=async()=>{o<1||(await l(a,{skip_cache:"true"}),n("CLEAR"))};return e.jsxs(rs,{children:[!t&&e.jsxs("div",{className:"heading-container",children:[e.jsxs("div",{className:"heading",children:[e.jsx("span",{className:"heading__title",children:"Latest"}),e.jsx("span",{className:"heading__icon",children:e.jsx(Oe,{})})]}),o?e.jsx("div",{className:"button_container",children:e.jsx(is,{className:"button",onClick:x,startIcon:e.jsx(Ve,{}),children:`See Latest (${o})`})}):null]}),e.jsx(ts,{isSearchResult:t})]})},is=r(I)`
  && {
    width: 100%;
    margin-top: 1.2rem;
    font-weight: 500;
...
`,ls=()=>e.jsx(e.Fragment,{children:Array(7).fill(null).map((t,o)=>e.jsx(as,{children:e.jsxs(s,{direction:"row",children:[e.jsx(s,{align:"center",pr:16,children:e.jsx(O,{animation:"wave",height:64,variant:"rectangular",width:64})}),e.jsxs(s,{grow:1,shrink:1,children:[e.jsx(O,{height:10,variant:"rectangular",width:56}),e.jsx(O,{className:"title",height:10,variant:"rectangular",width:262}),e.jsx(O,{height:10,variant:"rectangular",width:149})]})]})},o))});r(s)`
  font-family: Barlow;
  font-size: 13px;
  font-style: normal;
  font-weight: 500;
...
`;const xs=48,ds=8,ps={PaperProps:{style:{maxHeight:xs*4.5+ds,width:250}}},hs=["Beginner","Intermediate","Advanced","Expert"],us=()=>{const t=R(h=>h.data),[o,n]=d.useState(""),[a,l]=d.useState("Beginner"),x=A(h=>h.currentSearch),c=Pe(),[y]=xe(h=>[h.setBudget]),[g,p,f,v,u]=ve(h=>[h.askedQuestions,h.askedQuestionsAnswers,h.setAskedQuestion,h.setAskedQuestionAnswer,h.hasQuestionInProgress]),w=d.useCallback(h=>{v(h.answer),ne(e.jsx(ae,{message:"Response is ready"}),{position:"bottom-center",type:"success"})},[v]);d.useEffect(()=>{c&&w&&c.on("askquestionhook",w)},[w,c]);const C=async()=>{o&&(f(o),n(""));try{const h=t==null?void 0:t.nodes.filter(z=>z.text),_=h==null?void 0:h.slice(0,5),M=(_!=null&&_.length?_.map(z=>z.text).join(" "):"").substring(0,2500).replace(/[?&=+/#]/g,z=>`\\${z}`);x&&(await Ie.enable(),await Me({expertise_level:a,question_text:o,search_term:x,transcripts:M},y),await Ee(y),ne(e.jsx(ae,{message:"We started preparing response for you"}),{type:"success"}))}catch(h){console.error(h)}},k=a&&o.trim()&&!u,j=h=>{l(h.target.value)},b=async h=>{if(u){h.preventDefault();return}h.keyCode===13&&h.shiftKey===!1&&k&&(h.preventDefault(),C())};return e.jsxs(gs,{children:[e.jsx(s,{children:e.jsx(s,{children:e.jsxs(Tt,{component:"div",children:[e.jsx(fs,{id:"select-label",size:"small",children:"Expertise level"}),e.jsx(ms,{id:"demo-multiple-name",input:e.jsx(It,{label:"Expertise level"}),labelId:"select-label",MenuProps:ps,onChange:j,size:"small",value:a,children:hs.map(h=>e.jsx(Ue,{component:"li",value:h,children:h},h))})]})})}),e.jsx(bs,{children:g==null?void 0:g.map((h,_)=>e.jsxs(s,{className:"response",py:12,children:[e.jsx($,{kind:"medium",children:h}),e.jsx(s,{py:12,children:(p==null?void 0:p[_])!==void 0?e.jsx($,{color:"unreadMsgText",children:p[_]}):e.jsxs(s,{align:"center",py:12,children:[e.jsx(s,{align:"center",py:12,children:e.jsx(de,{color:i.white})}),e.jsx(s,{align:"center",py:12,children:e.jsx($,{children:"Generating response"})})]})})]},h))}),e.jsxs(ws,{onKeyDown:b,py:12,tabIndex:-1,children:[e.jsx(ys,{disabled:u,onChange:h=>n(h.target.value),placeholder:"Enter your question",value:o}),e.jsx(js,{children:e.jsx(St,{color:k?i.white:i.gray300,size:"18"})})]})]})},gs=r.div`
  margin-top: 20px;
`,ys=r(_t)`
...
`,Es=({stateless:t,node:o})=>{var k;const[n,a]=A(j=>[j.transcriptIsOpen,j.setTranscriptOpen]),[l,x]=d.useState(!1),[c,y]=d.useState(""),[g,p]=d.useState(!1);if(!t&&!n)return null;const f="https://knowledge-graph.sphinx.chat",v=async j=>{try{const b=await fetch(`${f}/node/text/${j}`);if(!b.ok)throw new Error("Network response was not ok");const h=await b.json();y(h.data.text),p(!0)}catch(b){console.error("Error fetching full transcript",b)}},u=()=>{C(o==null?void 0:o.text),setTimeout(()=>{x(!1)},2e3)},w=()=>{g?p(!1):o!=null&&o.ref_id&&v(o.ref_id)},C=j=>{j!==void 0&&(navigator.clipboard.writeText(j),x(!0))};return e.jsxs(s,{grow:1,shrink:1,children:[e.jsxs(As,{children:[t&&e.jsxs(Rs,{children:[e.jsx("div",{className:"icon",children:e.jsx(fe,{})}),e.jsx("div",{className:"title",children:"Transcript"})]}),o!=null&&o.text?e.jsx(e.Fragment,{children:l?e.jsxs(Ls,{align:"center",direction:"row",justify:"flex-start",children:[e.jsx("div",{className:"icon",children:e.jsx(Et,{})}),e.jsx("div",{className:"text",children:"Copied"})]}):e.jsx(I,{endIcon:e.jsx(Je,{}),onPointerDown:()=>u(),size:"small",variant:"outlined",children:"Copy"})}):e.jsx("div",{}),!t&&e.jsx(Ps,{onClick:()=>{a(!1)},children:e.jsx($t,{fontSize:35})})]}),e.jsxs(Ms,{children:[g?c:`${(k=o==null?void 0:o.text)==null?void 0:k.substring(0,100)}...`,e.jsx(Is,{onClick:w,children:g?"less":"more"})]})]})},Rs=r(s).attrs({direction:"row",align:"center"})`
  .icon {
    font-size: 16px;
    color: ${i.GRAY3};
    margin-right: 7px;
...
`,_e=({node:t})=>{const o=R(k=>k.selectedNode),n=A(k=>k.currentSearch),{link:a,image_url:l,date:x,boost:c,node_type:y,type:g,id:p,show_title:f,episode_title:v,ref_id:u}=t||o||{},[w,C]=d.useState(c||0);return o?e.jsx("div",{style:{overflow:"auto",flex:1,width:"100%"},children:e.jsxs(Gs,{children:[e.jsx(Fs,{boostCount:w||0,date:x||0,episodeTitle:V(v),imageUrl:l,isSelectedView:!0,link:a,onClick:()=>null,showTitle:f,type:y||g}),e.jsx(X,{}),e.jsxs(Ds,{children:[e.jsx(oe,{amt:w}),e.jsx(we,{content:o,count:w,refId:u,updateCount:C})]}),e.jsx(X,{}),e.jsx(ce,{children:e.jsx(Ts,{node:o,searchTerm:n,stateless:!0})}),e.jsx(X,{}),e.jsx(ce,{children:e.jsx(Es,{node:o,stateless:!0},p)})]})}):null},Gs=r(s)`
  flex: 1;
  min-height: 100%;
  flex-direction: column;
...
`,ko=r.div`
  ...
  overflow-y: auto;
`,vo=()=>{const[t,o]=R(c=>[c.selectedNode,c.setSelectedNode]),n=Ce(),[a,l]=d.useState([]),x=d.useMemo(()=>{var g;const c=new Set,y={};if((g=t==null?void 0:t.children)!=null&&g.length){t.children.forEach((f,v)=>{var C,k,j,b;const u=je((n==null?void 0:n.nodes)||[],t)||[],w=n==null?void 0:n.nodes.find(h=>h.ref_id===f);if(w){w.timestamp=(C=u[0])==null?void 0:C.timestamp;const h=(b=(j=(k=u[v])==null?void 0:k.hosts)==null?void 0:j[0])==null?void 0:b.name;h&&c.add(h),y[f]=w,y[f]=w}});const p=Array.from(c);l(p)}return Object.values(y).filter(p=>p.node_type==="episode").sort((p,f)=>(f.weight||0)-(p.weight||0))},[n==null?void 0:n.nodes,t]);return e.jsxs(wo,{children:[e.jsx(jo,{children:e.jsxs(s,{direction:"row",children:[e.jsx(s,{pr:24,children:e.jsx(E,{size:80,src:(t==null?void 0:t.image_url)||"audio_default.svg",type:"show"})}),e.jsx(s,{direction:"column",children:e.jsxs(s,{direction:"column",grow:1,justify:"space-between",children:[e.jsxs(s,{align:"center",direction:"row",justify:"flex-start",mb:16,children:[e.jsx(H,{type:"show"})," ",e.jsxs("div",{className:"subtitle",children:["by ",a.join(", ")||(t==null?void 0:t.show_title)]})]}),e.jsx(bo,{kind:"bigHeading",title:(t==null?void 0:t.show_title)||"Unknown",children:(t==null?void 0:t.show_title)||"Unknown"})]})})]})}),e.jsxs(s,{direction:"column",children:[e.jsx(s,{p:24,children:e.jsx($,{className:"relatedHeader",kind:"medium",children:"Related Episodes"})}),e.jsx(ko,{children:x.map(c=>e.jsx(fo,{node:c,onClick:()=>o(c)},c.ref_id))})]})]})},Co=()=>{const t=P();return e.jsx(s,{align:"center",justify:"center",children:e.jsx($,{color:"primaryText1",kind:"hugeHeading",children:t==null?void 0:t.label})})},So=()=>{const t=P(),{date:o,boost:n,text:a,name:l,verified:x,profile_picture:c,twitter_handle:y,ref_id:g}=t||{},p=(t==null?void 0:t.tweet_id)||"",[f,v]=d.useState(n||0),u=A(w=>w.currentSearch);return t&&e.jsxs(e.Fragment,{children:[e.jsxs(s,{direction:"column",p:24,children:[e.jsxs(s,{align:"center",direction:"row",pr:16,children:[e.jsx($o,{children:e.jsx(E,{rounded:!0,size:58,src:c||"",type:"person"})}),e.jsxs(s,{children:[e.jsxs(_o,{align:"center",direction:"row",children:[l,x&&e.jsx("div",{className:"verification",children:e.jsx("img",{alt:"verified",src:"verified_twitter.svg"})})]}),y&&e.jsxs(To,{children:["@",y]})]})]}),e.jsxs(s,{grow:1,shrink:1,children:[e.jsx(Bo,{"data-testid":"episode-description",children:K(a||"",u)}),e.jsx(s,{direction:"row",justify:"flex-start",children:!!o&&e.jsx(q,{children:Z.unix(o).format("ll")})})]}),e.jsx(s,{align:"stretch",mt:22,children:e.jsx("a",{href:`https://twitter.com/Interior/status/${p}?open=system`,children:e.jsx(Io,{endIcon:e.jsx(se,{}),children:"View Tweet "})})})]}),e.jsx(zo,{}),e.jsxs(s,{direction:"row",justify:"space-between",pt:14,px:24,children:[e.jsx(oe,{amt:f}),e.jsx(we,{content:t,count:f,refId:g,updateCount:v})]})]})},$o=r(s)`
  img {
    width: 64px;
    height: 64px
    border-radius: 50%;
...
`,Io=r(I)`
  width: 100%;
`,Eo=()=>{var y,g;const[t,o]=d.useState(!1),n=P(),a=!!(n!=null&&n.source_link),l=d.useRef(null),x=A(p=>p.currentSearch),c=p=>{p.stopPropagation(),p.currentTarget.blur(),o(!t)};return d.useEffect(()=>{var p,f;t?(p=l.current)==null||p.play():(f=l.current)==null||f.pause()},[t]),e.jsxs(s,{align:"flex-start",basis:"100%",direction:"column",grow:1,justify:"center",pt:a?62:0,shrink:1,children:[a&&e.jsxs(Ro,{children:[e.jsx(ye,{color:i.GRAY6}),e.jsx(Mo,{children:n==null?void 0:n.source_link}),e.jsx(Ao,{href:n==null?void 0:n.source_link,onClick:p=>p.stopPropagation(),target:"_blank",children:e.jsx(se,{})})]}),(y=n==null?void 0:n.audio)!=null&&y.length?e.jsxs(s,{justify:"flex-start",p:12,children:[e.jsx(I,{onClick:p=>c(p),startIcon:t?e.jsx(Q,{}):e.jsx(ee,{}),children:t?"Pause":"Play"}),e.jsx(Lo,{ref:l,src:((g=n.audio[0])==null?void 0:g.link)||"",children:e.jsx("track",{kind:"captions"})})]}):null,e.jsx(Po,{grow:1,justify:"flex-start",p:12,shrink:1,children:e.jsx($,{color:"primaryText1",kind:"regular",children:K((n==null?void 0:n.text)||"",x)})})]})},Ro=r(s)`
  top: 0px;
  position: absolute;
...
`,Lo=r.audio`
  height: 0;
  width: 0;
`,Go=["clip","twitter_space","youtube","episode","podcast"],Do=()=>{const t=P(),{showTeachMe:o}=R(a=>a),{setPlayingNode:n}=U(a=>a);if(d.useEffect(()=>{Go.includes((t==null?void 0:t.node_type)||"")&&n(t)},[n,t]),o)return e.jsx(ks,{});switch(t==null?void 0:t.node_type){case"guest":case"person":return e.jsx(yo,{});case"data_series":return e.jsx(Ss,{});case"tribe_message":return e.jsx(po,{});case"tweet":return e.jsx(So,{});case"topic":return e.jsx(Co,{});case"show":return e.jsx(vo,{});case"youtube":case"podcast":case"clip":case"twitter_space":return e.jsx(_e,{});case"document":return e.jsx(Eo,{});case"episode":return e.jsx(ro,{},t.ref_id);case"image":return e.jsx(xo,{});default:return null}},Fo=d.memo(Do),No=({isPlaying:t,isFullScreen:o,setIsPlaying:n,playingTime:a,duration:l,handleProgressChange:x,handleVolumeChange:c,onFullScreenClick:y,showToolbar:g})=>e.jsxs(s,{children:[!g&&e.jsx(Vo,{"aria-label":"Small",max:l,onChange:x,size:"small",value:a}),e.jsxs(Yo,{align:"center",direction:"row",showToolbar:g,children:[e.jsx(Wo,{onClick:n,size:"small",children:t?e.jsx(Q,{}):e.jsx(ee,{})}),e.jsxs(Uo,{direction:"row",children:[e.jsx("span",{children:re(a)}),e.jsx("span",{className:"separator",children:"/"}),e.jsx("span",{className:"duration",children:re(l)})]}),e.jsxs(Ho,{direction:"row",px:9,children:[e.jsx(be,{className:"volume-slider",defaultValue:.5,max:1,min:0,onChange:c,size:"small",step:.1}),e.jsx(ot,{})]}),e.jsx(Oo,{onClick:()=>y(),children:o?e.jsx(nt,{}):e.jsx(it,{})})]})]}),Yo=r(s)`
  height: 60px;
  padding: 12px 16px;
  ${t=>t.showToolbar&&`
    position: fixed;
...
`,Qo=({hidden:t})=>{const o=d.useRef(null),n=d.useRef(null),[a,l]=d.useState(!1),[x,c]=d.useState(!1),[y,g]=d.useState("ready"),{isPlaying:p,playingTime:f,duration:v,setIsPlaying:u,setPlayingTime:w,setDuration:C,playingNode:k,volume:j,setVolume:b,setHasError:h,resetPlayer:_}=U(B=>B);d.useEffect(()=>()=>_(),[_]);const M=()=>{u(!p)},z=()=>{u(!0)},Y=()=>{u(!1)},W=(B,T)=>{const L=Array.isArray(T)?T[0]:T;o.current&&(o.current.seekTo(L),w(L))},D=(B,T)=>{const L=Array.isArray(T)?T[0]:T;b(L)},m=()=>{h(!0),g("error")},S=B=>{const T=B.playedSeconds;w(T)},F=()=>{if(o.current){g("ready");const B=o.current.getDuration();C(B)}},N=()=>{n.current&&(document.fullscreenElement?(document.exitFullscreen(),l(!1)):n.current.requestFullscreen().then(()=>{document.addEventListener("fullscreenchange",G)}))},G=()=>{l(!!document.fullscreenElement),document.removeEventListener("fullscreenchange",G)};return d.useEffect(()=>()=>{document.removeEventListener("fullscreenchange",G)}),d.useEffect(()=>{const B=T=>{if(a){const L=window.screen.height,Be=T.clientY,ze=L-Be;c(ze<=50)}};return document.addEventListener("mousemove",B),()=>{document.removeEventListener("mousemove",B)}},[a,x]),d.useEffect(()=>{const B=T=>{a&&T.key==="Escape"&&(T.preventDefault(),T.stopPropagation())};return document.addEventListener("fullscreenchange",G),document.addEventListener("keydown",B),()=>{document.removeEventListener("fullscreenchange",G),document.removeEventListener("keydown",B)}}),k!=null&&k.link?e.jsxs(qo,{ref:n,hidden:t,children:[e.jsx(Ko,{children:e.jsx(E,{size:120,src:(k==null?void 0:k.image_url)||"",type:"clip"})}),e.jsx(rt,{ref:o,controls:!1,height:a?window.screen.height:"200px",onBuffer:()=>g("buffering"),onBufferEnd:()=>g("ready"),onError:m,onPause:Y,onPlay:z,onProgress:S,onReady:F,playing:p,url:(k==null?void 0:k.link)||"",volume:j,width:"100%"}),y==="error"?e.jsx(Jo,{className:"error-wrapper",children:"Error happened, please try later"}):null,y==="ready"?e.jsx(No,{duration:v,handleProgressChange:W,handleVolumeChange:D,isFullScreen:a,isPlaying:p,onFullScreenClick:N,playingTime:f,setIsPlaying:M,showToolbar:x&&a}):null,y==="buffering"?e.jsx(Xo,{children:e.jsx(te,{color:i.lightGray})}):null]}):null},qo=r(s)`
...
`,Jo=r(s)`
  ...
  padding: 12px 16px;
  color: ${i.primaryRed};
`,Zo=d.memo(Qo),ei=({open:t})=>{const{setSelectedNode:o,setTeachMe:n,showTeachMe:a}=R(y=>y),l=P(),{setSidebarOpen:x}=A(y=>y),{playingNode:c}=U(y=>y);return e.jsx(ie,{"data-testid":"sidebar-sub-view",direction:"right",in:t,style:{width:a?"700px":"",position:t?"relative":"absolute"},children:e.jsxs(ti,{children:[e.jsx(Zo,{hidden:(l==null?void 0:l.ref_id)!==(c==null?void 0:c.ref_id)},c==null?void 0:c.ref_id),e.jsx(oi,{children:e.jsx(Fo,{})}),e.jsx(si,{onClick:()=>{o(null),n(!1)},children:e.jsx(at,{})}),e.jsx(ii,{onClick:()=>{x(!1)},children:e.jsx(ke,{})})]})})},ti=r(s)(({theme:t})=>({position:"relative",background:i.BG1,width:"100%",margin:"64px auto 20px 10px",borderRadius:"16px",zIndex:29,[t.breakpoints.up("sm")]:{width:"390px"}})),si=r(s)`
  font-size: 32px;
  color: ${i.white};
  cursor: pointer;
  position: absolute;
...
`,pi=r.audio`
  height: 0;
  width: 0;
`,hi=["Drivechain","Ordinals","L402","Nostr","AI"],ui=({onSubmit:t})=>{var D;const{open:o}=J("addContent"),[n,a]=d.useState(!1),[l,x]=d.useState(!1),[c,y]=d.useState(null),g=d.useRef(null),[p,f]=d.useState(0),[v,u]=d.useState(!1),{open:w}=J("briefDescription"),{trendingTopics:C,setTrendingTopics:k}=R(m=>m),{setValue:j}=ge(),b=d.useCallback(async()=>{a(!0),x(!1);try{const m=await De();m.length&&Array.isArray(m)&&k(m)}catch{k(hi.map(S=>({topic:S,count:0})))}finally{a(!1)}},[k,x]);d.useEffect(()=>{C.length||b()},[b,C.length]),d.useEffect(()=>{const m=setTimeout(()=>{x(!0)},5e3);return()=>clearTimeout(m)},[x,n]);const h=m=>{j("search",m),t==null||t()},_=(m,S)=>{m.stopPropagation(),m.currentTarget.blur(),S!=null&&S.tldr&&(y(S),w())},M=()=>{y(null)},z=m=>{m.stopPropagation(),m.currentTarget.blur(),u(!v)};d.useEffect(()=>{var m,S;v?(m=g.current)==null||m.play():(S=g.current)==null||S.pause()},[p,v]);const Y=()=>{f(m=>{var F,N;let S=(m+1)%C.length;for(;S!==m&&!((F=C[S])!=null&&F.audio_EN);)S=(S+1)%C.length;return S===m?(u(!1),S):((N=g.current)==null||N.load(),S===0&&(u(!1),f(0)),S)})},W=n?"Loading":"No new trending topics in the last 24 hours";return e.jsxs(yi,{"data-testid":"trending-component",children:[e.jsxs("div",{children:[e.jsxs("div",{className:"heading-container",children:[e.jsxs("div",{className:"heading",children:[e.jsx("span",{className:"heading__title",children:"Trending Topics"}),e.jsx("span",{className:"heading__icon",children:n?e.jsx(te,{color:i.white,size:16}):e.jsx(e.Fragment,{children:l?e.jsx(mi,{onClick:b,size:"small",startIcon:e.jsx(ai,{})}):e.jsx(dt,{})})})]}),pt(C)?e.jsxs("div",{children:[e.jsx(I,{onClick:m=>z(m),startIcon:v?e.jsx(Q,{}):e.jsx(ee,{}),children:v?"Pause":"Play All"}),e.jsx(wi,{ref:g,onEnded:Y,src:(D=C[p])==null?void 0:D.audio_EN,children:e.jsx("track",{kind:"captions"})})]}):null]}),C.length===0?e.jsxs("div",{className:"trending-empty",children:[e.jsx(fi,{children:W}),e.jsx(I,{color:"secondary",disabled:n,onClick:o,size:"medium",startIcon:e.jsx(At,{}),sx:{alignSelf:"flex-end",m:"0 36px 16px 0"},variant:"contained",children:"Add Content"})]}):e.jsx("ul",{className:"list",children:C.map(m=>e.jsxs(s,{align:"center",className:"list-item",direction:"row",justify:"space-between",onClick:()=>h(m.topic),children:[e.jsxs(gi,{children:[" #",ht(m)]}),m.tldr&&e.jsx(I,{onClick:S=>_(S,m),children:"TLDR"})]},m.topic))})]}),c&&e.jsx(li,{onClose:M,selectTrending:h,trend:c})]})},gi=r.div`
  width: 300px;
  overflow: hidden;
  text-overflow: ellipsis;
  line-height: 1.5;
...
`,wi=r.audio`
  height: 0;
  width: 0;
`,ji=390,bi=d.forwardRef(({onSubmit:t,subViewOpen:o},n)=>{const{isFetching:a,setTeachMe:l,setSidebarFilter:x}=R(j=>j),c=pe(),{setSidebarOpen:y,currentSearch:g,clearSearch:p,searchFormValue:f}=A(j=>j),[v]=Re(j=>[j.trendingTopicsFlag]),{setValue:u}=ge(),w=d.useRef(null),[C,k]=d.useState(!1);return d.useEffect(()=>{u("search",f)},[u,f]),d.useEffect(()=>{const j=w.current;if(!j)return;const b=()=>{k((j==null?void 0:j.scrollTop)>0)};j.addEventListener("scroll",b)},[]),e.jsxs(Ci,{ref:n,id:"sidebar-wrapper",children:[e.jsx(zi,{}),e.jsxs(Te,{className:Fe({"has-shadow":C}),children:[e.jsxs(Si,{children:[e.jsx(ut,{onSubmit:t}),e.jsx(_i,{onClick:()=>{if(g){u("search",""),p(),x("all");return}t==null||t()},children:a?e.jsx(te,{color:i.SECONDARY_BLUE,"data-testid":"loader",size:"20"}):e.jsx(e.Fragment,{children:g?e.jsx(Ne,{}):e.jsx(mt,{})})})]}),g&&e.jsx($i,{children:a?e.jsx(gt,{}):e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"left",children:[e.jsx("span",{className:"count",children:c.length}),e.jsx("span",{className:"label",children:" results"})]}),e.jsx("div",{className:"right",style:{alignItems:"center"},children:e.jsx(yt,{})})]})})]}),!o&&e.jsx(Ti,{onClick:()=>{y(!1),l(!1)},children:e.jsx(ke,{})}),e.jsxs(Bi,{ref:w,children:[!g&&v&&e.jsx(Ii,{children:e.jsx(ui,{onSubmit:t})}),e.jsx(s,{children:a?e.jsx(ls,{}):e.jsx(ns,{isSearchResult:!!g})})]})]})}),ki=["topic","person","guest","event","organization","place","project","software"],vi=({onSubmit:t})=>{const{sidebarIsOpen:o}=A(x=>x),n=P(),a=!!n&&o&&!ki.includes(n.node_type),{showTeachMe:l}=R(x=>x);return e.jsxs(e.Fragment,{children:[e.jsx(ie,{direction:"right",in:o,mountOnEnter:!0,unmountOnExit:!0,children:e.jsx(bi,{onSubmit:t,subViewOpen:a})}),e.jsx(ei,{open:a||!!l}),!o&&e.jsx(ni,{})]})},Ci=r(s)(({theme:t})=>({position:"relative",background:i.BG1,height:"100vh",width:"100%",zIndex:30,[t.breakpoints.up("sm")]:{width:ji}})),Te=r(s).attrs({direction:"column",justify:"center",align:"stretch"})(({theme:t})=>({padding:t.spacing(3.75,2),[t.breakpoints.up("sm")]:{padding:"12px"},"&.has-shadow":{borderBottom:"1px solid rgba(0, 0, 0, 0.25)",background:i.BG1,boxShadow:"0px 1px 6px 0px rgba(0, 0, 0, 0.20)"}})),Si=r(s).attrs({direction:"row",justify:"center",align:"center"})`
  flex-grow: 1;
