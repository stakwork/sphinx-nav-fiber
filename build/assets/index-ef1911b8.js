import{o as s,F as o,T as w,p as C,r as f,j as e,q as c,A as S,aU as A,aV as b,aW as z,J as D,O as y}from"./index-e99ee12d.js";import{B as G}from"./index-5b71f6c3.js";import{G as M,B as v,i as $,F as B}from"./index-37f82c39.js";import{C as T}from"./ClipLoader-ef3f07da.js";import{T as j}from"./index-eb7b709f.js";import{S as E}from"./index-bfbd55d0.js";import{e as I}from"./index.esm-26c56a67.js";import{T as k,a as F}from"./Tabs-f5aa27a0.js";import"./InfoIcon-b2cc1781.js";import"./useSlotProps-538d9c05.js";import"./createSvgIcon-2c0d88ef.js";const R=({onClose:a})=>{const[l]=C(d=>[d.graphStyle]),[r,i]=f.useState(!1),p=()=>{i(!0),localStorage.setItem("graphStyle",l),i(!1),a()};return e.jsxs(W,{direction:"column",children:[e.jsx(V,{children:"Default graph view:"}),e.jsx(M,{}),e.jsx(o,{mt:308,py:24,children:e.jsx(v,{color:"secondary",disabled:r,id:"add-node-submit-cta",onClick:p,size:"large",startIcon:r&&e.jsx(L,{children:e.jsx(T,{color:c.lightGray,size:12})}),type:"submit",variant:"contained",children:"Save Changes"})})]})},W=s(o)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,V=s(w)`
