import{s as a,g as d,r as p,D as S,b as I,a as N,c as _,j as e,p as z,F as f,T as w,B as L,e as M,b6 as R}from"./index-11b3d6c9.js";import{S as $}from"./index-41891942.js";import{a as F,J as G}from"./index-bc719ac8.js";import{S as q}from"./SoundIcon-af53df50.js";const H=({trend:t,onClose:n})=>{var m,g;const[r,l]=p.useState(!1),{close:h}=S("briefDescription"),{currentPlayingAudio:s,setCurrentPlayingAudio:u}=I(o=>o),[y]=N(o=>[o.setBudget]),{fetchData:C,setAbortRequests:k}=_(o=>o),i=p.useRef(null),E=async()=>{D(),await C(y,k,t.tldr_topic??t.name)},D=p.useCallback(()=>{n(),h()},[n,h]),v=()=>{i.current&&(r?i.current.pause():i.current.play(),l(!r))},T=()=>{var c,j,b;const o=!((c=s==null?void 0:s.current)!=null&&c.paused);o&&((j=s==null?void 0:s.current)==null||j.pause(),u(null)),(((b=s==null?void 0:s.current)==null?void 0:b.src)!==t.audio_EN||!o)&&v()};p.useEffect(()=>{const o=i.current,c=()=>{l(!1),u(null)};return o&&o.addEventListener("ended",c),()=>{o&&o.removeEventListener("ended",c)}},[u]);const x=((m=s==null?void 0:s.current)==null?void 0:m.src)===t.audio_EN&&!((g=s==null?void 0:s.current)!=null&&g.paused)||r;return e.jsxs(e.Fragment,{children:[t.audio_EN?e.jsxs(e.Fragment,{children:[e.jsxs(Y,{children:[e.jsx(B,{className:z("default",{play:x}),onClick:T,size:"small",startIcon:x?e.jsx(F,{}):e.jsx(q,{}),children:x?"Pause":"Listen"}),e.jsx(B,{className:"default",onClick:E,size:"small",startIcon:e.jsx(G,{}),children:"Learn More"})]}),e.jsx(W,{ref:i,src:t.audio_EN,children:e.jsx("track",{kind:"captions"})})]}):null,e.jsxs(f,{mt:75,children:[e.jsx(U,{children:t.tldr_topic??t.name}),e.jsx(J,{children:e.jsx(f,{children:e.jsx(O,{children:t.tldr&&e.jsx($,{children:t.tldr})})})})]})]})},J=a.div`
  max-height: 310px;
  overflow-y: auto;
  margin: 8px 0;
  padding: 0 20px;
