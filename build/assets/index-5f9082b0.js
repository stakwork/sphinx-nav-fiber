import{f as i,F as n,T as g,i as w,j as e,k as b,L as A,D as B,h as c,r as v,y as D,B as F}from"./index-72349e2a.js";import{B as M}from"./index-df6eaab1.js";import{h as $,c as k,F as C,C as G}from"./react-toastify.esm-9adf328e.js";import{B as f,T as L,a as R}from"./index-ae1df19e.js";import{T as x}from"./index-bdc9c5c3.js";import"./useSlotProps-a510a825.js";import"./index.esm-b0b56fa9.js";import"./InfoIcon-478ec4c6.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
