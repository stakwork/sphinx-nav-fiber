import{f as y,h as w,F as t,T as S,x as O,r as f,j as e,aX as W,aY as H,D as L,b1 as K,J as X,b2 as Z,B as P,i as Q,aZ as C,W as $,b3 as ee,o as te,a$ as se}from"./index-add05fa5.js";import{B as T,C as D,i as oe,c as re,F as ne}from"./react-toastify.esm-ac073886.js";import{B as ie}from"./index-64624ff4.js";import{S as ae}from"./index-94dc636a.js";import{i as ce}from"./index.esm-40911bdd.js";import{C as le}from"./CheckIcon-0399f8bb.js";import{p as de}from"./index-30d16895.js";import{T as _}from"./index-f569f26e.js";import{n as pe,a as E,b as me,i as xe}from"./index-1c8f0698.js";import{A as ue}from"./index-12f87235.js";import{c as he}from"./index-64f1c910.js";import"./InfoIcon-f87f0f10.js";import"./generateCategoricalChart-ff1ed5e8.js";import"./Popover-b6f91d93.js";import"./useSlotProps-40587b81.js";import"./NoFilterResultIcon-44c735b6.js";import"./index-474d4761.js";import"./index-81087535.js";import"./PlusIcon-a19d585c.js";import"./index-bd73c39a.js";import"./Popper-afa25a11.js";const fe=({onClick:o,loading:p,error:c})=>{const u=O(a=>a.budget),[m,s]=f.useState(10),i="node";return f.useEffect(()=>{(async()=>{try{const h=await H(i);s(h.data.price)}catch(h){console.error("cannot fetch",h)}})()},[i]),e.jsxs(t,{children:[e.jsx(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:e.jsx(t,{align:"center",direction:"row",children:e.jsx(we,{children:"Approve Cost"})})}),e.jsxs(t,{align:"center",direction:"row",justify:"space-between",mb:20,children:[e.jsxs(ye,{children:[e.jsx("div",{className:"title",children:"COST"}),e.jsxs("div",{className:"value","data-testid":"check-price",children:[m," sats"]})]}),e.jsxs(ge,{children:[e.jsx("div",{className:"title",children:"BUDGET"}),e.jsxs("div",{className:"value",children:[W(u)," sats"]})]})]}),e.jsx(t,{children:e.jsx(T,{color:"secondary","data-testid":"check-icon",disabled:p||!!c,onClick:o,size:"large",startIcon:p?e.jsx(D,{size:24}):e.jsx(le,{}),type:"submit",variant:"contained",children:"Approve"})}),c?e.jsxs(be,{role:"tooltip",children:[e.jsxs(je,{children:[e.jsx(ce,{fontSize:13}),e.jsx("span",{children:c})]}),e.jsx("div",{className:"tooltip",children:c})]}):null]})},ye=y(t).attrs({direction:"column",align:"space-between",justify:"flex-start"})`
  width: 141px;
  height: 61px;
