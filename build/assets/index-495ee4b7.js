import{s as i,F as n,T as g,j as e,b as w,c as p,r as A,u as B}from"./index-49995fa4.js";import{B as v}from"./index-eb581935.js";import{u as F}from"./index-9b15cf03.js";import{u as M,G as $,l as C,b,q as D,F as G}from"./react-toastify.esm-ed803d9a.js";import{B as f,T as k,a as R}from"./index-3650656f.js";import{T as x}from"./index-948a2fc0.js";import{C as L}from"./ClipLoader-744d61e7.js";import"./useSlotProps-30fb75e9.js";import"./index.esm-7e06d974.js";import"./InfoIcon-0d27e851.js";const P=({onClose:s})=>{const[a]=M(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",a),s()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
