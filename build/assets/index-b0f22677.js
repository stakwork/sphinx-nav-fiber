import{o as s,F as o,T as w,p as C,r as f,j as e,q as c,A as S,aU as A,aV as b,aW as M,M as z,Q as y}from"./index-b14c2607.js";import{B as D}from"./index-0fb7dc10.js";import{G,B as v,i as $,F as B}from"./index-0ac343fa.js";import{C as T}from"./ClipLoader-9dd1ae46.js";import{T as j}from"./index-b5f35085.js";import{S as E}from"./index-e49c98eb.js";import{e as I}from"./index.esm-d1068cd4.js";import{T as k,a as F}from"./Tabs-f1341342.js";import"./InfoIcon-5c28fb85.js";import"./useSlotProps-e5a40298.js";import"./createSvgIcon-6e1aaa3c.js";const R=({onClose:a})=>{const[l]=C(d=>[d.graphStyle]),[r,i]=f.useState(!1),p=()=>{i(!0),localStorage.setItem("graphStyle",l),i(!1),a()};return e.jsxs(W,{direction:"column",children:[e.jsx(V,{children:"Default graph view:"}),e.jsx(G,{}),e.jsx(o,{mt:308,py:24,children:e.jsx(v,{color:"secondary",disabled:r,id:"add-node-submit-cta",onClick:p,size:"large",startIcon:r&&e.jsx(L,{children:e.jsx(T,{color:c.lightGray,size:12})}),type:"submit",variant:"contained",children:"Save Changes"})})]})},W=s(o)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,V=s(w)`
