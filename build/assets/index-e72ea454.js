import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-e0ac65aa.js";import{B as F}from"./index-e749dffc.js";import{u as M}from"./index-a04b0a93.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-5e2ed92b.js";import{B as f,T as R,a as L}from"./index-d1d19edf.js";import{T as x}from"./index-79045176.js";import"./useSlotProps-e6a2e50b.js";import"./index.esm-612f4c9d.js";import"./InfoIcon-ef734dd1.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
