...
`,ie=d.div`
  ...
  color: #6b7a8d;
  line-height: 1;
`,ae=()=>{const{close:n}=_("addEdgeToNode"),l=N({mode:"onChange"}),[p,a]=i.useState(!1),[c,f]=i.useState(""),[o,x]=i.useState(!1),[y,b]=i.useState(!1),[r,j]=i.useState(null),[t,g]=i.useState(),s=O();i.useEffect(()=>{(async()=>{if(s){b(!0);try{if(s.type==="topic"){const{data:h}=await w(s==null?void 0:s.name,{exact_match:"true",node_type:"topic"}),S=h.find(B=>B.node_type==="topic");g(S)}}catch(h){console.log(h)}finally{b(!1)}}})()},[s]);const E=()=>{n()},I=async()=>{const m=t||s;if(!(!r||!(m!=null&&m.ref_id))){a(!0);try{await z({relationship:c,...o?{to:m.ref_id,from:r==null?void 0:r.ref_id}:{from:m.ref_id,to:r==null?void 0:r.ref_id}});const{ref_id:h}=m,{ref_id:S}=r;console.log(h,S),E()}catch(h){console.warn(h)}finally{a(!1)}}},L=p||!r||!c;return e.jsxs(R,{...l,children:[y?e.jsx(u,{align:"center",my:24,children:e.jsx(T,{color:v.BLUE_PRESS_STATE,size:24})}):e.jsx(Q,{from:t?t==null?void 0:t.search_value:(s==null?void 0:s.name)||"",isSwapped:o,onSelect:j,selectedToNode:r,selectedType:c,setIsSwapped:()=>x(!o),setSelectedType:f}),e.jsxs(Y,{color:"secondary",disabled:L,onClick:I,size:"large",variant:"contained",children:["Confirm",p&&e.jsx(T,{color:v.BLUE_PRESS_STATE,size:10})]})]})},Ie=()=>{const{close:n}=_("addEdgeToNode");return e.jsx(M,{id:"addEdgeToNode",kind:"small",onClose:n,preventOutsideClose:!0,children:e.jsx(ae,{})})};export{Ie as AddNodeEdgeModal};
