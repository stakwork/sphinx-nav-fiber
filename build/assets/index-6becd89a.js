import{f as u,h as m,T as w,j as e,F as o,C as V,r,a4 as $,E as A,D as P,i as q}from"./index-c3091316.js";import{B as G}from"./index-6fd19dcf.js";import{u as f}from"./index-4da64e1a.js";import{c as H,F as O,B as E,C as W}from"./react-toastify.esm-fad7643a.js";import{T as S}from"./index-569ac69e.js";import{S as Y}from"./Skeleton-d2e7d3c6.js";import"./index.esm-ca764106.js";import"./InfoIcon-88c27bc6.js";const T=/^https:\/\/.*\.(png|jpe?g|svg)$/;function B(i){return!!T.test(i)}const J=()=>e.jsxs(o,{children:[e.jsx(o,{align:"center",direction:"row",justify:"space-between",mb:18,children:e.jsx(o,{align:"center",direction:"row",children:e.jsx(K,{children:"Edit Node"})})}),e.jsxs(o,{mb:18,children:[e.jsx(b,{style:{marginBottom:8},children:"Node Name"}),e.jsx(S,{id:"cy-topic",maxLength:50,name:"name",placeholder:"Node name",rules:{...V}})]}),e.jsxs(o,{mb:36,children:[e.jsx(b,{style:{marginBottom:8},children:"image_url"}),e.jsx(S,{id:"cy-image_url",maxLength:500,name:"image_url",placeholder:"image_url",rules:{pattern:{message:"Please enter a valid URL",value:T},validate:{source:B}}})]})]}),K=u(w)`
  font-size: 22px;
  font-weight: 600;
  font-family: 'Barlow';
`,b=u(w)`
