import{f as o,F as s,T as g,i as y,j as e,k as b,L as w,D as S,h,r as T,y as v,B as m}from"./index-4d613fad.js";import{B}from"./index-92fc850f.js";import{h as C,c as A,F as D,C as M}from"./react-toastify.esm-875d11f8.js";import{B as f,T as $,a as k}from"./index-fe3ed52c.js";import{T as u}from"./index-c21c8d9e.js";import"./useSlotProps-cf7383ca.js";import"./index.esm-eaabd1f8.js";import"./InfoIcon-6d67f05a.js";const F=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(G,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},G=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
