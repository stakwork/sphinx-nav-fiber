...
`,ar=v.lazy(()=>Re(()=>import("./index-f54da9de.js"),["assets/index-f54da9de.js","assets/index-955e3483.js","assets/index-b4d03b7b.css","assets/index-42f17c08.js","assets/SourcesTableIcon-40bc7934.js","assets/index-40a0299c.js","assets/CheckIcon-5d4463f8.js","assets/DeleteNodeIcon-d05062e3.js","assets/SoundIcon-0dfae750.js","assets/SucessFeedBackIcon-56acdd4b.js","assets/ClipLoader-0e81d132.js","assets/TableRow-3b6bef4e.js"]).then(({TweetAnalyze:e})=>({default:e}))),sr=()=>{const e=$(o=>o.setSelectedTweet),t=$(o=>o.selectedTweet),{tweetId:a}=ge(),[r,n]=v.useState(""),{open:i}=$e("tweetAnalyze"),l=(a==null?void 0:a.split("&"))||[],c=o=>{i(),n(o)};return s.jsxs(cr,{align:"stretch",basis:"100%",grow:1,shrink:1,children:[l.length>1?s.jsx(or,{onClick:()=>{c("summary")},children:"Summary Report"}):null,l.map(o=>s.jsx(lr,{className:t===o?"selected":"",onClick:()=>e(o),children:s.jsx(Ut,{handleAnalyzeClick:()=>{c(o)},nodeId:o})},o)),s.jsx(ar,{tweetId:r})]})},or=f.button`
  width: 100%;
  background: ${y.ANALYTICS_CARD_BG};
  color: ${y.white};
  padding: 16px 16px;
