...
`,ir=v.lazy(()=>ke(()=>import("./index-ebdedc7a.js"),["assets/index-ebdedc7a.js","assets/index-0e71550c.js","assets/index-b4d03b7b.css","assets/index-c6eb4ffc.js","assets/SourcesTableIcon-733f4b62.js","assets/index-cc42c491.js","assets/CheckIcon-22fc4102.js","assets/DeleteNodeIcon-c15a0339.js","assets/SoundIcon-348b8e0c.js","assets/SucessFeedBackIcon-3537b830.js","assets/ClipLoader-39b0e414.js","assets/TableRow-a359d141.js"]).then(({TweetAnalyze:e})=>({default:e}))),ar=()=>{const e=$(o=>o.setSelectedTweet),t=$(o=>o.selectedTweet),{tweetId:a}=fe(),[r,n]=v.useState(""),{open:i}=De("tweetAnalyze"),l=(a==null?void 0:a.split("&"))||[],c=o=>{i(),n(o)};return s.jsxs(or,{align:"stretch",basis:"100%",grow:1,shrink:1,children:[l.length>1?s.jsx(sr,{onClick:()=>{c("summary")},children:"Summary Report"}):null,l.map(o=>s.jsx(cr,{className:t===o?"selected":"",onClick:()=>e(o),children:s.jsx(Vt,{handleAnalyzeClick:()=>{c(o)},nodeId:o})},o)),s.jsx(ir,{tweetId:r})]})},sr=f.button`
  width: 100%;
  background: ${y.ANALYTICS_CARD_BG};
  color: ${y.white};
  padding: 16px 16px;
