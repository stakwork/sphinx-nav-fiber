import{o as s,F as o,T as w,p as C,r as f,j as e,q as c,A as S,aU as A,aV as b,aW as z,J as D,O as y}from"./index-085947d3.js";import{B as G}from"./index-0ca3cd7f.js";import{G as M,B as v,i as $,F as B}from"./index-6c2c25a6.js";import{C as T}from"./ClipLoader-a61a640c.js";import{T as j}from"./index-47f5a723.js";import{S as E}from"./index-666f02a8.js";import{e as I}from"./index.esm-0c5ed7a8.js";import{T as k,a as F}from"./Tabs-72e7470e.js";import"./InfoIcon-3912de2c.js";import"./useSlotProps-b5c0fe44.js";import"./createSvgIcon-7ee86254.js";const R=({onClose:a})=>{const[l]=C(d=>[d.graphStyle]),[r,i]=f.useState(!1),p=()=>{i(!0),localStorage.setItem("graphStyle",l),i(!1),a()};return e.jsxs(W,{direction:"column",children:[e.jsx(V,{children:"Default graph view:"}),e.jsx(M,{}),e.jsx(o,{mt:308,py:24,children:e.jsx(v,{color:"secondary",disabled:r,id:"add-node-submit-cta",onClick:p,size:"large",startIcon:r&&e.jsx(L,{children:e.jsx(T,{color:c.lightGray,size:12})}),type:"submit",variant:"contained",children:"Save Changes"})})]})},W=s(o)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,V=s(w)`
