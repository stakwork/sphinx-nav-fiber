import{o,F as s,T as g,p as y,j as e,A as b,aT as w,aU as S,q as x,r as T,I as v,N as m}from"./index-6e775803.js";import{B as A}from"./index-d9990557.js";import{G as C,i as B,F as G}from"./index-73bc0219.js";import{B as f,T as M,a as $}from"./index-0fd8c24b.js";import{T as u}from"./index-6aca6ba3.js";import{C as k}from"./ClipLoader-f1290aa2.js";import"./useSlotProps-980abd99.js";import"./createSvgIcon-648278d4.js";import"./index.esm-de537634.js";import"./InfoIcon-57414106.js";const D=({onClose:t})=>{const[i]=y(n=>[n.graphStyle]),r=()=>{localStorage.setItem("graphStyle",i),t()};return e.jsxs(F,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx(C,{}),e.jsx(s,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save Changes"})})]})},F=o(s)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=o(g)`
