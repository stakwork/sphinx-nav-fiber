import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-2b91391e.js";import{B as F}from"./index-bd60ff9f.js";import{u as M}from"./index-3aa0ad3a.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-9f01c783.js";import{B as f,T as R,a as L}from"./index-30fa51d6.js";import{T as x}from"./index-e4f30b2b.js";import"./useSlotProps-82a4d62a.js";import"./index.esm-ebac90fc.js";import"./InfoIcon-2472f879.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
