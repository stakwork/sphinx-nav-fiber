import{f as i,F as n,T as g,i as w,j as e,k as b,K as A,C as B,h as c,r as v,x as C}from"./index-f899806e.js";import{B as F}from"./index-7868994c.js";import{u as M}from"./index-a5bd8b2c.js";import{h as $,c as k,F as D,C as G}from"./react-toastify.esm-21ba998d.js";import{B as f,T as R,a as L}from"./index-3893be8f.js";import{T as x}from"./index-7661c558.js";import"./useSlotProps-ffc29334.js";import"./index.esm-c9bc0f60.js";import"./InfoIcon-893a1873.js";const P=({onClose:a})=>{const[s]=w(t=>[t.graphStyle]),r=()=>{localStorage.setItem("graphStyle",s),a()};return e.jsxs(V,{direction:"column",children:[e.jsx(z,{children:"Default graph view:"}),e.jsx($,{}),e.jsx(n,{mt:308,children:e.jsx(f,{kind:"big",onClick:r,children:"Save changes"})})]})},V=i(n)`
  display: flex;
  gap: 10px;
  padding: 36px;
`,z=i(g)`
